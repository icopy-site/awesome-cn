...
- [LMQL](https://lmql.ai/) - LMQL 是一种用于大型语言模型的查询语言.
...
- [GenShare](https://www.genshare.io/)  - 在几秒钟内免费生成艺术作品. 拥有并分享您所创造的. 一个多媒体生成工作室，民主化设计和创造力.
- [Playground AI](https://playgroundai.com/)  - Playground AI 是一个免费使用的在线 AI 图像创建器. 用它来创作艺术、社交媒体帖子、演示文稿、海报、视频、徽标等.
- [Pixelz AI Art Generator](https://pixelz.ai/)  - Pixelz AI 艺术生成器使您能够从文本中创建令人难以置信的艺术. 提供稳定扩散、CLIP 引导扩散和 PXL·E 逼真算法.
...
- [The Generative AI Application Landscape](https://twitter.com/sonyatweetybird/status/1584580362339962880) - 绘制生成人工智能生态系统的信息图，作者： [Sonya Huang](https://twitter.com/sonyatweetybird) 红木资本.
