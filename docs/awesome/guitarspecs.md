...
-----------------------|--------------------| -----------
 ...
 真正的e1到E6弦的扩展不仅可以通过螺母宽度来控制，还可以通过螺母中的槽扩展来控制.  例如，44.5毫米宽的螺母可以具有35至37.5毫米的e1至E6距离.

 类别|  字符串间距|  e1 / E6 |  e1到edge |  颈部螺母宽度  
---------------------|----------------|--------------|----------- |-----------------
 窄弦传播|  7毫米|  35毫米|  4.75毫米|  44.5毫米（1-3 / 4“）
 中等字符串扩展|  7.3毫米|  36.5毫米|  4毫米|  44.5毫米（1-3 / 4“）
 宽字符串扩展|  7.5毫米|  37.5毫米|  3.5毫米|  44.5毫米（1-3 / 4“）
...
大多数吉他配件制造商采用了Fender&#39;s®颈部后跟和颈部口袋尺寸：
...
Strat脖子的脚后跟有一个圆形底座，Tele脖子的脚后跟有一个方形底座，这使得很难将两种类型的颈部交换成各种身体.
...
![Guitar Bodies](https://raw.githubusercontent.com/gitfrage/guitarspecs/master/./images/clip1_body.jpg)
 ...
 电吉他的声音主要取决于琴弦本身的振动特性和拾音器的再现特性.  弦的振动行为取决于（非常少）木材.  与颈部相比，身体本身非常厚，这就是为什么身体木材类型和形式对电吉他声音的影响非常有限.
...
#### Flat Mount Hardtail Strat
 ...
 型号|  E / e |  站点孔Ø|  站点洞距|  桥孔Ø|  桥孔距离
--------------------|------------------|-------------------|------------------|----------------|-------------------
 Strat Vintage |  57毫米（2 1/4英寸）| 3.18毫米（0.125英寸）|  10.5毫米（0.413英寸）| 3毫米（1/8英寸）|  21毫米（.827“）
 Strat Vintage Narrow |  54毫米（2 1/8英寸）| 4.78毫米（0.188英寸）|  10.5毫米（0.413英寸）| 3毫米（1/8英寸）|  21毫米（.827“）
 Strat标准|  52.83毫米（2.08英寸）| 3.18毫米（0.125英寸）|  11.3毫米（0.446英寸）| 3毫米（1/8英寸）|  22.6毫米（.89“）
...
--------------------|------------------|-------------------|-----------------------|--- 
 Schaller 47X |  51毫米 -  55.5毫米|  3.18mm（0.125“）|约X | 73×49×12（15）mm


#### Flat Mount Tele Style

                 老式Tele标准Tele         
    桥孔..o ... o ... o ... o ..站点洞... oooooo .. 
    遗址洞... oooooo ..桥洞..o ..... o ..... o .. 

 型号|  E / e |  站点孔Ø|  站点洞距|  桥孔Ø|  桥孔距离
--------------------|------------------|-------------------|----------------------|----------------|-------------
 Tele Vintage |  54毫米（2 1/8英寸）| 3.18毫米（0.125英寸）|  10.9毫米（.429英寸）| 3毫米（1/8英寸）|  21.6毫米（.85“）
 远程标准|  54毫米（2 1/8英寸）| 3.18毫米（0.125英寸）|  10.5毫米（0.413英寸）| 3毫米（1/8英寸）|  32.4毫米（1.267英寸）
...
#### Tremolo Vintage
 ...
 型号|  E / e |  孔距|  孔Ø
-----------------------|------------------- |------------------|--------------
 墨西哥Strat |  52,4毫米（2 1/16）|  52,4毫米（2 1/16）|  3毫米（1/8英寸）
 复古|  566毫米（2 7/32英寸）| 55.9毫米（2.2英寸）|  3毫米（1/8英寸）
...
#### Tremolo Standard
 ...
 型号|  E / e |  孔距|  孔Ø
-----------------------|------------------- |------------------|--------------
 美国标准|  52,83毫米（2.08英寸）| 55.9毫米（2.2英寸）|  9,5毫米（.375“）
 Floyd Rose（“凹进”）|  53毫米（2-3 / 32英寸）| 74毫米（2.913英寸）|  9,91毫米（.390“）
 Schaller 2000 |  53,5毫米|  56毫米|  10毫米
 Schaller vintage |  53,5毫米|  74,3毫米|  10毫米
 威尔金森（“凹陷”）|  54毫米（2-1 / 8“）| 55.9毫米（2.2”）|  9,7毫米（.382“）


#### Tune-O-Matic Gibson Style

                 Tune-O-Matic凹陷Tune-O-Matic“穿过身体的弦乐”
    尾巴.......... o ......
    Tailpiece .... ............ .... oooooo ..
    Bridge ..o .......... o ... ..o ............ o ..

 型号|  E / e |  桥|  尾部|  尾部上衣|  尾部底部|  尾部Ø
------------|------------|--------------|-------------------|-------------------|-------------------|------
...
调音机选项：
 - 配置：3L + 3R（Gibson风格），6-in-Line（Fender风格），4L / 2R（Musicman风格）
 - 比率 - 围绕轴头1x绕组 - 需要1x旋转.
...
>  [ABM](https://abm-guitarpartsshop.com/From-a-solid-Block-to-a-Bridge:_:206.html?language=en) - 表示贝尔黄铜和钢铁塑造吉他声音的特征，而铝在音调的转移中基本上是中性的.
...
![jackplate](https://raw.githubusercontent.com/gitfrage/guitarspecs/master/./images/clip9_jackplate.jpg)
 ...
 - 上述所有部件的螺钉
 - 控制板（仅用于标准电视）
 - 字符串套圈（String-thru顶部或底部 - 如果使用“穿过身体的绳索”而不是桥梁）
 - 字符串保留器. [Happy Little String Trees](https://www.premierguitar.com/articles/24295-guitar-shop-101-happy-little-string-trees)  
 - 表带固定器
...
> [EMG PA2 Preamp/Booster](http://www.emgpickups.com/pa2.html)  - 迷你开关，0-20dB升压.    
...
> [Thomastik](http://www.thomastik-infeld.com/fretted-instruments) - 良好的爵士乐和蓝调弦    
...
> [frudua.com](http://www.frudua.com/sound_of_electric_guitar_wood.htm) - 见页面底部 - 身体和颈部木材的图形示例，显示木材硬度，密度和色调之间的关系.
