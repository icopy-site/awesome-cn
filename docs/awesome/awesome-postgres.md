...
* [Patroni](https://github.com/zalando/patroni) -带ZooKeeper或etcd的PostgreSQL HA的模板.
...
* [pg\_probackup](https://github.com/postgrespro/pg_probackup) –由@PostgresPro改进的pg \ _arman分支，支持增量备份，副本副本备份，多线程备份和还原以及无存档命令的匿名备份.
...
* [PipelineDB](https://www.pipelinedb.com/) -PostgreSQL扩展，可在流上连续运行SQL查询，并将结果增量存储在表中.
...
* [PoWA](https://powa.readthedocs.io/en/latest/) -PostgreSQL Workload Analyzer收集性能统计数据并提供实时图表，以帮助监视和调整PostgreSQL服务器.
...
* [pg\_activity](https://github.com/julmon/pg_activity) -顶部类似PostgreSQL服务器活动监视的应用程序.
...
* [pgpool-II](http://www.pgpool.net/mediawiki/index.php/Main_Page) -中间件，提供连接池，复制，负载平衡和限制超连接.
...
* [pgmigrate](https://github.com/yandex/pgmigrate) -Yandex开发的用于发展模式迁移的CLI工具.
* [pgcmp](https://github.com/cbbrowne/pgcmp) -比较数据库模式的工具，具有接受某些持久性差异的能力
* [graphql-engine](https://github.com/hasura/graphql-engine) -通过PostgreSQL获取即时实时GraphQL API.
* [sqlcheck](https://github.com/jarulraj/sqlcheck-old)  -自动检测常见的SQL反模式.  这种反模式通常会使查询变慢.  因此，解决这些问题将有助于加快查询速度.
* [postgres-checkup](https://gitlab.com/postgres-ai/postgres-checkup) -新一代的诊断工具，可让用户收集对Postgres数据库运行状况的深入分析.
...
*红宝石： [pg](https://bitbucket.org/ged/ruby-pg/wiki/Home)
...
* [Compose](https://www.compose.com/databases/postgresql)  -PostgreSQL作为AWS，Google Cloud Platform和IBM Cloud中的服务；  计划的价格从每月17.5美元/月的1GB存储空间扩展到12美元/ GB.  免费试用30天.
* [Database Labs](https://www.databaselabs.io) -数分钟之内即可获得可立即投入生产的云PostgreSQL服务器，每月20美元起，包括备份，监控，补丁和24/7全天候技术支持.
...
* [ElephantSQL](https://www.elephantsql.com/)  -提供的数据库范围从小型项目的共享服务器和概念验证到企业级的多服务器设置.  有免费计划，最多可容纳5个DB，每个DB 20 MB.
...
* [Craig Kerstiens PostgreSQL posts](http://www.craigkerstiens.com/categories/postgres/) -有关PostgreSQL酷功能，技巧和窍门的一组帖子.
...
* [Postgres Weekly](https://postgresweekly.com/) -每周新闻通讯，其中包含与PostgreSQL有关的文章，新闻和回购.
...
* [Slack](https://postgres-slack.herokuapp.com/) -Postgres的松弛渠道，拥有近5000个用户
* [#postgresql on Freenode](https://github.com/dhamaniasad/awesome-postgres/blob/master/ttps://webchat.freenode.net/#postgresql) -Freenode上有关Postgres的最受欢迎的IRC频道，拥有近1000位用户 
* [Reddit](https://www.reddit.com/r/PostgreSQL/) -适用于PostgreSQL用户接近10000的reddit社区
