...
### Design
  ...
  - [Ladies Wine and Design](http://ladieswinedesign.com/)
    ...
    在200多个城市中的每月沙龙之夜，设计师被识别为女性，偶尔会有跨界编码活动.
...
### Java
  ...
  - [JDuchess](https://www.facebook.com/jduchess.org/)
     ...
     Duchess是Java技术领域的全球性女性组织，其成员遍布60多个国家.  Duchess提供了一个平台，通过该平台，使用Java的女性可以彼此联系并更多地参与Java社区.

### Javascript

  - [Js-Girls](http://js-girls.org/)

    Js-Girls是为期1天的研讨会，专门为那些想学习Javascript的女孩而设计.

  - [Js4Girls](https://raw.githubusercontent.com/Webschool-io/js4girls) -*地点：* <img src="https://upload.wikimedia.org/wikipedia/en/0/05/Flag_of_Brazil.svg" alt="Brazil" width="30"> -*语言：仅PT-BR *

    A Brazilian initiative to provide free javascript classes to women in a male-free environment.

  - [JsLadies BR](https://raw.githubusercontent.com/jsladiesbr) -*地点：* <img src="https://upload.wikimedia.org/wikipedia/en/0/05/Flag_of_Brazil.svg" alt="Brazil" width="30"> -*语言：仅PT-BR *

    一个针对网络开发和javascript感兴趣的女性的小组，提供公开和免费的会议，研讨会和讲座.
...
### Python
  ...
  - [Django Girls](https://djangogirls.org/)
    ...
    免费的Python和Django研讨会，他们还创建了开源在线教程，并策划了令人惊叹的技术初体验.

  - [PyLadies](http://www.pyladies.com/)

    一个国际指导小组，致力于帮助更多的女性成为Python开源社区的积极参与者和领导者.

### PHP

  - [PHPWomen](https://phpwomen.org/)

    一个包容各方的全球用户组，在PHP社区内提供支持网络.
...
### Ruby
  ...
  - [Rails Bridge](http://www.railsbridge.org/)
     ...
     研讨会是一种免费有趣的入门或升级Rails，Ruby和其他Web技术的方式.  我们的活动着重于增加技术的多样性，使所有背景的人都能在我们的行业中感到宾至如归.
  ...
  - [RailsGirls Summer of Code](http://railsgirlssummerofcode.org/)
      ...
      Rails Girls Summer of Code是面向女性和非二进制编码员的全球奖学金计划.  学生将获得为期三个月的奖学金，以从事现有的开放源代码项目并扩展技能.
...
## General
  ...
  - [Ada Lovelace Day](https://findingada.com/)
     ...
     Ada Lovelace日是每年的十月第二个星期二的节日，是庆祝STEM领域女性的国际节日.  这是庆祝妇女在STEM领域做出的贡献的一天，并通过提高对这些贡献的认识来鼓励其他妇女从事这些领域.  有一个主要活动在英格兰伦敦举行，但是任何人都可以通过组织活动或在线分享自己的故事来庆祝ALD.

  - [Anitas](http://anitas.com.br/) -*地点：* <img src="https://upload.wikimedia.org/wikipedia/en/0/05/Flag_of_Brazil.svg" alt="Brazil" width="30">

     Anitas是一群妇女，她们通过交流思想，知识和经验，在技术和企业家精神领域中增强女性权能.  为此，Anitas组织了课程，讲习班，讲座，还参加了旨在使妇女参与技术和创业活动的倡议.

  - [Bay Area Girls](http://girlgeek.io/about/)

     在旧金山主办的晚宴上，来自各地的女性被邀请与女性科技界的知名演讲者分享经验.  这些活动还提供了社交网络以及赞助公司的潜在招募.  它已经由100多家公司主办，并且每月有几次活动.

  - [Byte Girl](http://bytegirl.com.br/) -*地点：* <img src="https://upload.wikimedia.org/wikipedia/en/0/05/Flag_of_Brazil.svg" alt="Brazil" width="30"> -*语言：仅PT-BR *

     Byte Girl是一项非营利性，开放性活动，由志愿者组织，专注于喜欢科技的女性.  它的目标是通过分享专业技术知识和经验的专业人士的演讲来赋予妇女权力.
  ...
  - [Byte Hacks](http://bytehacks.org/) -*地点：* <img src="https://upload.wikimedia.org/wikipedia/en/a/a4/Flag_of_the_United_States.svg" alt="United States" width="30">
    ...
    ByteHacks是9月1日至2日在Thoughtworks纽约市举办的24小时黑客马拉松比赛，旨在鼓励各个年龄段和技能的女性组成团队并创建对社会产生积极影响的技术项目.
     黑客马拉松将举办研讨会，技术讲座，导师，赞助商和免费食品.  无论您是设计师，企业家，艺术家还是编码员，ByteHacks都欢迎您.  我们甚至还有Adafruit创始人兼首席执行官Limor Fried的主题演讲.

  - [Code Girl](http://www.codegirl.com.br/) -*地点：* <img src="https://upload.wikimedia.org/wikipedia/en/0/05/Flag_of_Brazil.svg" alt="Brazil" width="30"> -*语言：仅PT-BR *

     Code Girl是一项活动，旨在激发有关如何克服技术行业女性所面临挑战的演讲.  此次活动的特色是女性发言人，旨在激发行业内的女性.
  ...
  - [Geek Girls Carrots](http://gocarrots.org) -*地点：* <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e9/Flag_of_Poland_%28normative%29.svg/1280px-Flag_of_Poland_%28normative%29.svg.png" alt="Poland" width="30">
     ...
     Geek Girls Carrots是一家全球性基层组织，专注于科技领域的女性和女性企业家.  胡萝卜通过增加女性对新技术的参与来改变IT行业的当前状况.  团队内部的多样性有助于促进公司的创新和更好的经济成果.  GGC通过不断的团队支持，相互激励和友好的个人成长环境来创建国际社会.

  - [Girls4Tech](https://girls4tech.ebanx.com/) -*地点：* <img src="https://upload.wikimedia.org/wikipedia/en/0/05/Flag_of_Brazil.svg" alt="Brazil" width="30"> -*语言：仅PT-BR *

     Girls 4 Tech是一门在线编程课程，完全免费，由女性制作.  该语言可访问，不需要任何先验知识，并且对所有人开放.

  - [League of Women Coders](http://lwc.tech/)

     女编码员联盟（以前称为Ladies Who Code，成立于2011年6月）是一个聚会，着重于编码，黑客和协作学习.  该小组每月至少在纽约市和波士顿开会一次.  聚会着重于演讲，技术问题和想法，偶尔还会有女性演讲者参加.

  - [RodAda Hacker](http://rodadahacker.org/)  -*地点：* <img src="https://upload.wikimedia.org/wikipedia/en/0/05/Flag_of_Brazil.svg" alt="Brazil" width="30"> -*语言：仅PT-BR *

     RodAda Hacker是一个巴西网络，提供专门为女孩和妇女设计的协作编程研讨会.  对于那些想要梦想，构建出色项目并重新思考现有技术的人来说，这是一个空间.
  ...
  - [Tech Ladies Brasil](http://www.techladies.com.br/) -*地点：* <img src="https://upload.wikimedia.org/wikipedia/en/0/05/Flag_of_Brazil.svg" alt="Brazil" width="30">
     ...
     “巴西女性女士”网络是一个由女性驱动的空间，她们通过志愿工作奉献自己的时间，以交流知识，职业发展，个人发展和对女性的欣赏.  我们举办从女士到女士的研讨会和年度活动，涵盖三个方面：讲座，研讨会和圆桌会议；  讨论与“巴西女性女士”，“增强妇女技术能力”的宗旨相一致的主题.
  ...
  - [Women of Silicon Roundabout](http://www.women-in-technology.com/) -*地点：* <img src="https://upload.wikimedia.org/wikipedia/en/a/ae/Flag_of_the_United_Kingdom.svg" alt="United Kingdom" width="30">
    ...
    通过鼓舞人心的主题演讲，有关业务战略的小组讨论，技术课程以及职业发展研讨会，本次会议提供了在科技领域蓬勃发展所需的所有内容和交流机会.
  ...
  - [Wonder Women Tech Summit](https://wonderwomentech.com/)
     ...
     Wonder Women Tech的使命是突出，庆祝和教育女性以及STEM行业中代表性不足的女性.  会议活动和讲习班将变革者，开拓者，创新者，高级演讲者和与会人员聚集在一起，探讨为女性和弱势群体取得成功和蓬勃发展所需要的想法，讨论和解决方案.
...
### Academy/Camp
  ...
  - [App Camp 4 Girls](http://appcamp4girls.com/)
    ...
    App Camp for Girls是一个让女孩可以通过设计和构建应用程序来发挥创造力的地方，同时了解有关软件业务的更多信息并受到该领域女指导的启发.

  - [Black Girls Code](http://www.blackgirlscode.com/)

    黑人女孩法规的重点是通过授权7至17岁的颜色女孩成为STEM领域的创新者，所在社区的领导者以及通过接触计算机来创造自己的未来，从而增加数字空间中的有色女性人数科学和技术.

  - [BlackHoodie](https://www.blackhoodie.re/)

     BlackHoodie是一个免费的，仅限女性的逆向工程工作室.  该研讨会的目的是为女性工程师提供一个舒适的学习环境的前景.  大多数情况下，该主题很复杂，学习曲线陡峭，一开始常常使学生失去动力.  因此，举办活动可以支持信息安全少数群体之一女士们的想法.

  - [Chicas Poderosas](https://chicaspoderosas.org/home/)

     Chicas Poderosas是一个致力于将拉丁美洲的拉丁裔女性带入数字新闻事业最前沿的社区.  通过活动，聚会和指导，Chicas旨在吸引更多女性参与开发新闻应用程序，制作交互式内容并将新工具集成到其新闻编辑室.
  ...
  - [Code First Girl](http://www.codefirstgirls.org.uk) -*地点：* <img src="https://upload.wikimedia.org/wikipedia/en/a/ae/Flag_of_the_United_Kingdom.svg" alt="United Kingdom" width="30">
     ...
     Code First Girl开设了从圣安德鲁斯到南安普敦的面向英国年轻女性的免费兼职编码课程.  大多数课程都按大学的章节进行，研究生课程则在伦敦进行.
  ...
  - [Girl Develop It](https://www.girldevelopit.com/) -*地点：* <img src="https://upload.wikimedia.org/wikipedia/en/a/a4/Flag_of_the_United_States.svg" alt="United States" width="30">
    ...
    Girl Develop这是一个非营利性组织，为有兴趣在无判断力的环境中学习网络和软件开发的成年女性提供可负担的计划.
  ...
  - [Girls Can Code](https://gcc.prologin.org/) -*地点：* <img src="https://upload.wikimedia.org/wikipedia/en/thumb/c/c3/Flag_of_France.svg/250px-Flag_of_France.svg.png" alt="French" width="30">
     ...
     《女孩罐头代码》是在3个不同城市中开展的实习活动，是与其他受计划激励的女孩见面并按照自己的进度一起进步的绝好机会.  实习将包括编程练习和计算机科学领域的女性做的一些讲座.

  - [Girls In Tech](http://www.girlsintech.org/)

     GIT是一家全球性非营利性组织，致力于对技术充满热情的女孩和妇女的参与，教育和赋权.  我们的目标是加快进入高科技行业并建立成功创业公司的创新女性的成长.

  - [Girls Who Code](http://girlswhocode.com/)

    我们是一家全国性的非营利性组织，致力于缩小技术和工程领域的性别差距.夏季编程的女孩编程课程是为期7周的密集计算机科学课程，将课程嵌入技术公司和大学中.

  - [Hackbright Academy](https://hackbrightacademy.com/)

    哈克布赖特学院（Hackbright Academy）是一家领先的女性软件工程学院，于2012年在旧金山成立.该学院每年毕业的女性工程师人数超过斯坦福大学和加州大学伯克利分校.
  ...
  - [Ladies Learning Code](http://ladieslearningcode.com/) -*地点：* <img src="https://upload.wikimedia.org/wikipedia/en/c/cf/Flag_of_Canada.svg" alt="Canada" width="30">
    ...
    我们是一个非营利性组织，其使命是成为女性和青年人的主要资源，通过动手，社交和协作的方式学习技术技能，从而成为热情的技术建设者（不仅仅是消费者）.
  ...
  - [Tech Girlz](http://www.techgirlz.org/)
     ...
     我们是一家致力于减少（并且希望最终消除）技术职业中的性别差距的非营利组织.  我们举办讲习班和年度创业夏令营，旨在为中学生提供各种技术的实践经验，并使他们与在技术领域取得成功的女性互动.
...
### Linux/OpenSource
  ...
  - [Debian Women](https://www.debian.org/women/)
    ...
    Debian妇女项目成立于2004年5月.我们通过积极地与感兴趣的妇女接触并鼓励她们更多地参与Debian，寻求平衡和多样化Debian项目.
  ...
  - [KDE Women](https://community.kde.org/KDE_Women)
     ...
     KDE Women是KDE社区中的一群妇女.  我们在这里帮助增加开放源代码中的女性人数并互相支持.
...
### Conferences/Talks
  ...
  - [European Women In Technology](http://www.europeanwomenintech.com)
     ...
     旨在激励和联系从事科技行业的女性的会议.  它提供了由行业先驱提供的交互式面板和深入讨论会.  男女都可以参加会议，讨论与技术领导力中的女性，女性创始人，弥合性别差距，非技术性技术女性以及激励后代女孩进入该领域有关的问题.

  - [Female Founders Conference](http://www.femalefoundersconference.org/)

     由加速器Y Combinator组织的年度会议，针对女性创始人和企业家.  该活动的特色是讲座和小组讨论，包括女性创始人分享经验并提供创业指导的会议.

  - [Girls in Tech Catalyst Conference](http://catalystsf.girlsintech.org/)

     “技术催化剂中的女孩”的亮点是启发女性领导人的主题演讲.  这次会议还为与会者提供了真正的交流机会，一个交流思想并与其他启发女性联系的平台.  我们将在有意义的研讨会和晚间娱乐中分层活动，包括启动鸡尾酒会.

  - [Global Tech Women's Annual Voices Conference](http://www.globaltechwomen.com/voices-global-conference.html/)

     这项年度免费活动是在全球范围内举行的唯一一次技术女性会议，为所有人提供参与和参加的机会，包括身体上或实际上的参加，消除了所有参与障碍.  代表们分别或集体出席会议，讨论，合作和庆祝技术女性的贡献.
  ...
  - [Johnson Women in Technology Conference](http://www.johnsonwomenintech.com)
     ...
     约翰逊女性技术会议（JWiT）由康奈尔大学约翰逊管理学院的学生组织.  旨在吸引学生和专业人士的同时，该活动还包括有趣的小组讨论，有价值的社交活动，收入前沥青比赛等.
  ...
  - [She's Geeky](http://shesgeeky.org/)
    ...
    * unConference *供各种女性怪胎分享，连接，联网，学习，启发并获得很多乐趣.
  ...
  - [SWE](http://societyofwomenengineers.swe.org/)
     ...
     女工程师协会（SWE）是一个非营利性的教育和服务组织，它使妇女能够在工程领域取得成功和进步，并因其在工程师和领导者方面的毕生贡献而受到认可.  它促进了女工程师的年度会议.

  - [Tech Up for Women](https://corporatelearninghub.com/techupforwomen/)

     为妇女而设的技术培训是一项为期一天的活动，旨在通过教育，资源筹集和建立网络来提高妇女的技术水平.  本次活动将重点关注新技术进步，网络安全以及针对初创企业和私人公司的不同融资渠道.  该活动将为妇女提供资源和机会，以提高其数字素养，并成功竞争和打破工作环境中的性别不平衡.
  ...
  - [WECode](http://www.wecodeharvard.com/) -*地点：* <img src="https://upload.wikimedia.org/wikipedia/en/a/a4/Flag_of_the_United_States.svg" alt="United States" width="30">
     ...
     WECode是“每年2月在哈佛大学举行的由学生主持的最大的计算机科学女性会议.我们的任务是在全球范围内扩展技术女性的技能，网络和社区.我们在两天的时间里召集了女性，分享有关技术和创新的想法和对话.”  请于2月27日和2月28日在https://live.cs50.net/wecode上直播.
  ...
  - [Women in Tech Summit](http://www.innotechconferences.com/dallas/about/women-in-tech-summit)
     ...
     科技女性峰会是专门为IT女性设计的一项特殊活动.  该活动包括炉边聊天，两个小组介绍，午餐和社交活动.

  - [Women in Tech Summit Series](http://womenintechsummit.net/)

     “科技界女性峰会”是一系列活动，从学生到高级管理人员的各个层次，激发，教育和联系科技行业中的女性.  活动在丹佛，费城，罗利·达勒姆和华盛顿特区举行
...
### Communities/Groups
  ...
  - [Code Girls](http://codegirls.de/) -*地点：* <img src="https://upload.wikimedia.org/wikipedia/commons/b/ba/Flag_of_Germany.svg" alt="Germany" width="30"> -*长：仅德语*
  ...
  - [Women Hack For Non-Profits (WHFNP)](http://www.womenhackfornonprofits.com/)
     ...
     妇女非营利组织（WHFNP）是一个志愿者社区，旨在提高妇女的技术技能，支持其发展并为探索开源提供机会.  该小组将技术熟练的女性与开放源代码项目配对，这些项目正在为非营利组织，慈善机构和个人开发，以产生积极的社会影响.
...
### Mentorship
  ...
  - [Chick Tech](http://chicktech.org/) -*地点：* <img src="https://upload.wikimedia.org/wikipedia/en/a/a4/Flag_of_the_United_States.svg" alt="United States" width="30">
     ...
     我们促进以动手技术为中心的活动，以增强，支持和增强妇女和女孩的信心.  通过我们的活动，我们建立了社区，使参与者能够将自己视为领导者，并在快速发展的高科技行业中提供人脉和指导机会.

  - [OS4W](https://os4w.org/)

     OS4W是一种资源，用于将所有妇女（包括有色人种和变性妇女）与开源项目联系在一起，这些开源项目受欢迎，包容并赞赏其贡献者的多样性.  该站点设有一个目录，用于查找导师和配对伙伴，以及精选的带有行为准则的开源项目列表.

  - [She++](http://www.sheplusplus.org/)

     这是一个社会企业，使妇女有能力在科技行业留下自己的印记.  我们相信，当妇女在技术发展中享有平等的代表时，我们会为最需要的人加速创新.
...
### Hackerspace/Makerspace
  ...
  - [Maria Lab](https://www.programaria.org/) -*地点：* <img src="https://upload.wikimedia.org/wikipedia/en/a/a4/Flag_of_the_United_States.svg" alt="United States" width="30">
     ...
     它是一个黑客空间/创客空间，致力于在安全环境中以女性授权的形式进行教学和传播.  玛丽亚实验室（Maria Lab）促进女性的多样性和联合.
...
### Awards
  ...
  - [RedHat - Women in Open Source](https://www.redhat.com/en/about/women-in-open-source)
     ...
     荣誉.  庆祝.  启发.  我们相信开源是技术的未来，现在是时候承认女性所做的贡献了.
...
### Speakers
  ...
  - [Mulheres Palestrantes](http://insideoutproject.xyz/mulheres-palestrantes/) -*地点：* <img src="https://upload.wikimedia.org/wikipedia/en/0/05/Flag_of_Brazil.svg" alt="Brazil" width="30"> -*语言：仅PT-BR *

    鉴于在巴西举行的活动中（特别是技术方面）发言的妇女人数仍然很少，因此创建了一个电子表格以使这些妇女具有知名度并鼓励其他人开始.
    Mulheres Palestrantes是一个项目，该项目保留了一系列女性，她们通常谈论与编程，设计，企业家精神和技术相关的主题，该项目源于试图以更直观的方式来组织工作表的数据，以方便访问，减少重复并促进研究.
  ...
  - [Code it Like a Girl](http://www.codeitlikeagirl.com/?lang=en) -*地点：* <img src="https://upload.wikimedia.org/wikipedia/commons/5/5c/Flag_of_Greece.svg" alt="Greece" width="30">
     ...
     像女孩一样编码是一个数字媒体团体，其创建的内容旨在激发自我认同为女性的人们遵循梦想.  从技术新闻和操作方法，到世界各地非凡的故事，关于女权主义的文章或任何我们喜欢谈论写作，拍摄电影的事物，我们将在任何可以证明授权，有价值，有益于我们的听众.

  - [Global Fund for Women](http://ignite.globalfundforwomen.org/about)

     IGNITE讲述了在科学，技术，工程和数学领域处于领先和创新地位的妇女和女孩的故事.  该项目还强调了技术上的性别差距，并倡导妇女和女童更多地获得和控制技术.

  - [InspirAda na Computação](https://inspiradanacomputacao.com/) -*地点：* <img src="https://upload.wikimedia.org/wikipedia/en/0/05/Flag_of_Brazil.svg" alt="Brazil" width="30"> -*语言：仅PT-BR *
  ...
  - [PrograMaria](http://www.programaria.org/) -*地点：* <img src="https://upload.wikimedia.org/wikipedia/en/0/05/Flag_of_Brazil.svg" alt="Brazil" width="30"> -*语言：仅PT-BR *

     PrograMaria是一项倡议，旨在使更多的女孩和妇女参与技术和编程领域.  内容产生和事件产生于三个支柱：启发，讨论和学习.

  - [WomenTechmakers](https://www.womentechmakers.com/)

     Google的全球计划为技术女性提供可见度，社区和资源.  为开始职业生涯的妇女和在技术上已确立职业的妇女提供资源，以促进她们的成功.
...
### Documentaries/Movies
  ...
  - [Code Girls](http://www.codegirlmovie.com/)
    ...
    有关为技术创新挑战编写代码并开发应用程序创意的女孩的纪录片，旨在解决社区中的问题并尝试通过使用技术解决问题.

  - [She started it](http://www.shestarteditfilm.com/)

     结识五个决心追求创业梦想的年轻女性.  她开始了这部纪录片，由娜拉·波吉（Nora Poggi）和Insiyah Saeed跟随史黛西·费雷拉（Stacey Ferreira），图伊·特龙（Thuy Truong），布赖恩·加富法尔（Breenne Ghafourifar），谢娜·艾伦（Sheena Allen）和阿加特·莫利纳尔（Agathe Molinar）历时2年多，讲述了这些企业家在建立新业务时面临的跌宕起伏.
...
### Jobs
  ...
  - [Outreach Program for Women](https://www.gnome.org/opw/)
     ...
     妇女外联方案一直在帮助妇女（顺式和跨性别），跨性别男人和性趣化人群参与免费和开源软件.  它为整个一年中的任何时候提供捐助提供了支持性社区，并且每年与许多免费软件组织两次提供有针对性的实习机会.

  - [PowerToFly](https://www.powertofly.com/)

     将妇女与工作联系起来，实际上会导致工作与生活的平衡.  专门从事妇女的远程工作.  除了工作委员会之外，它还包含有关时间管理，自我效能感等的信息.

  - [Rewriting the Code](http://rewritingthecode.org)

    改写代码研究金是一项为期一年的计划，该计划为在各个行业的顶级科技公司实习提供了机会，并获得了精通科技行业所需的必要的个人和建立信任的技能.

  - [Women in Tech](http://www.womenintechnology.co.uk/)

    技术领域的女性是一家商业组织，致力于协助具有适当资质和经验的女性寻找信息技术的职业机会.
...
### Organisation toolkits
  ...
  - [AdaCamp Toolkit](https://adacamp.org/)
     ...
     Ada Camp曾经是一个受欢迎的会议，致力于增加妇女对开放技术和文化的参与，但现在不再举行.  但是，他们以开源AdaCamp Toolkit的形式发布了所有指南和资源，供那些想要组织自己的女权主义会议的人使用.
