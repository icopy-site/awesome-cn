...
- [Wearables Table](https://quantifyme.io/) -不错的人群来源可穿戴设备表.
...
- [QS Access](https://apps.apple.com/us/app/qs-access/id920297614) -将Apple Health数据导出为CSV表格式（iOS）.
...
- [Zero](https://www.zerofasting.com/) -一个简单的禁食追踪器，用于间歇性，昼夜节律和自定义禁食（iOS和Android）. 
...
### Habits
- [Habitica](https://habitica.com) -习惯跟踪应用程序，将您的目标像角色扮演游戏（Web，iOS和Android）一样对待.
...
- [Gadgetbridge](https://gadgetbridge.org/) -FOSS健身追踪器应用程序，可与多种可穿戴设备配合使用.
...
- [Awesome Biomarkers](https://github.com/markwk/awesome-biomarkers) -了解有关血液测试，生物标记和技术与服务的更多信息，以帮助量化（并改善）您的健康状况！
