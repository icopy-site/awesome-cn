...
- [Flowing Data](http://flowingdata.com/category/self-surveillance/) -自我监控和量化新闻.
- [Biohack Stack](https://biohackstack.com/) -具有著名科学家“堆”的Biohacker社区.
- [Wearables Database](http://vandrico.com/wearables/) -每个身体部位都提供可穿戴设备的令人敬畏的清单.
...
- [The Personal Analytics of My Life by Stephen Wolfram](http://blog.stephenwolfram.com/2012/03/the-personal-analytics-of-my-life/) -斯蒂芬·沃尔夫拉姆（Stephen Wolfram）探索了他利用时间收集的数据.
...
- [QS on Medium](https://medium.com/@quantifiedself) -量化的自我发布在中等.
- [QS on Venture Beat](http://venturebeat.com/tag/quantified-self/) -关于Venture Beat的“量化自我”文章.
- [QS on Wired](https://www.wired.com/tag/quantified-self/) -Wired.com上的“量化的自我”文章.
...
- [beepb00p](https://beepb00p.xyz) -撰写有关量化自我的文章，拥有数据并建立基础架构.
...
- [FitnessSyncer](https://www.fitnesssyncer.com/) -将健康和健身数据合并到一个集中式平台中.
- [IoTool](https://iotool.io/) -用于自动化和数据收集的智能手机物联网平台.
- [Tictrac](https://tictrac.com/) -用于健康和健身数据的仪表板（网络）.
- [QS Access](https://apps.apple.com/us/app/qs-access/id920297614) -将Apple Health数据导出为CSV表格格式（iOS）.
...
- [Taskade](https://taskade.com/)  -现代化的任务列表，可在您所有设备上同步.  （网络，iOS，Android，Chrome，Mac和PC）.
- [Productive](https://productiveapp.io/) -具有灵活的计划，提醒和数据导出（iOS）的习惯和每日目标跟踪器.
- [Everyday](https://everyday.app/)  -适用于Web，iOS和Android的简单美观的习惯跟踪器. 具有网络扩展程序，可将其添加到浏览器的新标签页中.
...
- [HistoryHound](https://www.stclairsoft.com/HistoryHound/) -可搜索的跨浏览器历史记录数据库，可以将其导出为HTML（MacOS）.
...
- [Daylio](http://daylio.webflow.io/)  -无需写下一行就可以捕捉美好的一天. 带有高级版的可导出数据.  （iOS和Android）.
...
- [Perspective](https://itunes.apple.com/us/app/perspective-daily-journal/id1186753097?mt=8)  -日志记录可以捕捉思想，心情和兴趣，目的是帮助您反映和发现观点.  （iOS）.
...
- [Aidlab](https://www.aidlab.com/) -聪明且易于破解的可穿戴设备，可与特殊的T恤和胸带兼容.
- [Gadgetbridge](https://gadgetbridge.org/) -FOSS健身追踪器应用程序，可与各种可穿戴设备一起使用.
- [Dreem](https://dreem.com/) 消费级脑电图，用于监测和优化睡眠； 它还具有脉搏血氧仪，骨传导音频，加速计和超声波计.
- [Foci](https://fociai.com/) -可穿戴（夹子），可自动跟踪焦点，流动，松弛，疲劳和压力.
...
- [BetterSelf](https://betterself.io) -追踪补品和习惯的开源应用程序
