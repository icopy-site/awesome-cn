...
这是一系列关于 CSS 的广受欢迎的讨论，涵盖 CSS Grid、flexbox、自定义变量、性能、框架、Sass、工具等主题.

 &gt; **喜欢 JavaScript？ 查看 [Must-Watch JavaScript](https://github.com/AllThingsSmitty/must-watch-javascript)!** 对于其他很棒的列表，请查看 [@sindresorhus](https://github.com/sindresorhus/)的精选清单 [awesome lists](https://github.com/sindresorhus/awesome/).
...
### 2020
1. [**10 Modern Layouts in 1 Line of CSS**](https://www.youtube.com/watch?v=qm0IfG1GyZU)：Una Kravets，（谷歌 Chrome 开发者 YouTube 频道）`21:38`
...
1. [**CSS Animation - Beyond Transitions**](https://www.youtube.com/watch?v=TYlA-eolzLs)：史蒂文·罗伯茨，布达佩斯 CSSConf `28:01`
...
### 2015
1. [**mdo-ular CSS**](http://jqueryuk.com/2015/videos.php?s=mdo-ular-css): Mark Otto，英国 jQuery `30:06`
1. [**PostCSS: The Future After Sass and LESS**](https://www.youtube.com/watch?v=1yUFTrAxTzg&list=PLUS3uVC08ZaqVEGFkl_dS_3FUzILkOIzA)：Andrey Sitnik，美国 CSSConf `29:09`
