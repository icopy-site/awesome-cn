...
#### Foundation in Web Development
 ...
 互联网上充斥着越来越多的课程，书籍和指南，供各种技能水平的程序员使用，以提高他们的技能.  不幸的是，这些资源要么难以找到，要么质量低劣.

 该清单旨在成为一系列高质量的教育资源.  该平台的成本与所涵盖的主要主题一起突出显示.

## Beginner

#### [Mozilla Webmaker](https://webmaker.org/)
**免费**社区和工具集，学习创建网页和应用程序\
*（HTML，CSS，JavaScript？）*

#### [Codecademy](https://www.codecademy.com/)
**免费**平台，用于学习编写Web技术的代码\
*（HTML，CSS，JavaScript，jQuery，Python，Ruby，Rails，PHP）*

#### [Khan Academy's Hour of Code](https://www.khanacademy.org/hourofcode)
**免费**互动1小时课程，学习网络开发的基础知识
...
**用于计算机编程的混合**策划学习轨道\
*（网站开发，JavaScript，AngularJS，Ruby，Rails，iOS，Haskell，计算机科学）*

#### Degreed [Web Development](https://degreed.com/learning/web%20development), [Programming](https://degreed.com/learning/programming)
 **混合**目录的课程，视频和其他学习资源，用于Web开发和编程.  质量可能会有所不同.
*（HTML，CSS，JavaScript，AngularJS，Rails）*

#### [Platzi](https://courses.platzi.com/)
 **免费**平台设计，营销，启动和代码课程.  了解网络的未来.
*（RethinkDB，SailsJs，NodeJS，Git，Startup Class等）*
...
**关于如何编程绘图，动画，游戏和网页以及更高级的计算机科学主题的免费**中级到高级课程
*（HTML，CSS，JavaScript，算法，加密）*

#### [Udacity](https://www.udacity.com/)
**免费的**计算机科学和网络开发课程平台\
*（HTML，CSS，JavaScript，数据科学，Python，计算机科学专题）*

#### [Learn Python the Hard Way](https://learnpythonthehardway.org/book/)
**免费** *（仅限图书）*适合初学者通过中级Python编程的书籍和课程
*（Python，面向对象的编程，Web开发）*

#### [Michael Hartl's Ruby on Rails Tutorial](https://www.railstutorial.org/book)
**免费的**在线书籍，涵盖了创建Ruby on Rails应用程序的所有阶段
...
**来自行业专家的商业**平台，用于指导网络和移动开发课程
*（网站开发，前端Web开发，AngularJS，Android，iOS）*
