...
- [fsf-gnat](https://www.getadanow.com/)  - Ada 编程语言的自由软件基金会编译器，构成 GNU 编译器集合的一部分. 它支持该语言的所有版本，即 Ada 2012、Ada 2005、Ada 95 和 Ada 83.
...
- [xgc](https://www.xgc.com/)  - XGC 提供基于 GCC 的裸机工具链，支持 Ada95 以支持航空航天特定目标，例如 MIL1750、ERC32 和 LEON. 以及遗留的 M68000 工具链.
...
### Text Modes
- [gnu-emacs-ada-mode](https://www.nongnu.org/ada-mode/) - 用于编辑 Ada 源代码的 Gnu Emacs 主要模式.
...
### VSCode Extensions
- [adacore-ada](https://marketplace.visualstudio.com/items?itemName=AdaCore.ada)  - 对 Ada 的语言支持. 它包括 [Ada 语言服务器][ada-language-server].
...
- [ada-runtime](https://github.com/Componolit/ada-runtime) - 可适应不同平台的精简版 Ada 运行时.
...
- [ada-kalinda-os](https://sourceforge.net/projects/sx-ada-kalinda/) - Ada KALINDA 是一种用 Ada95 编写的类似于 Mac Plus 的操作系统.
...
- [sal](https://www.stephe-leake.org/ada/sal.html) - SAL（Stephe 的 Ada 库）.
...
- [charles](https://web.archive.org/web/20161207211935/https://home.earthlink.net/~matthewjheaney/charles/) - Charles 是一个 Ada 95 容器库，是 Ada 2005+ 标准容器的前身.
...
[ada语言服务器]：https://github.com/AdaCore/ada_language_server
...
- [plplot](https://sourceforge.net/projects/plplot/) - 跨平台的科学图形绘图库，包括 Ada 绑定.
...
- [scala](https://www.huygens-fokker.org/scala) - Scala 是一款功能强大的软件工具，用于实验音乐调音，例如纯音调音阶、平均和历史音律、微调和大调音阶以及非西方音阶.
...
- [simple-logging](https://github.com/alire-project/simple_logging) - 易于使用的日志记录工具，用于输出到 Ada 程序中的控制台.
...
- [ada-bundler](https://github.com/flyx/ada-bundler)  - 用于在 Ada 应用程序中透明处理数据和配置文件访问的库和工具. 支持 macOS、Linux 和 Windows.
...
### Web
- [ironsides](https://ironsides.martincarlisle.com) - 由 SPARK/Ada 验证的权威 DNS 服务器.
...
- [max-home-automation](https://sourceforge.net/projects/max-home-automation/)  - [gtkada] 管理 ELV/eQ-3 MAX 的应用程序！ 用于家庭自动化的多维数据集.
...
- [yotroc](https://github.com/docandrew/YOTROC)  - 用于虚构 CPU 架构的汇编器/仿真器. 在 [gtkada] 中实现的 IDE.
...
- [whitakers-words](https://github.com/mk270/whitakers-words) - William Whitaker 的 WORDS，一本拉丁语词典.
- [ada-chess](https://www.adachess.com/) - 用 Ada 编写的国际象棋引擎.

## Bindings

- [pcsc-ada](https://www.codelabs.ch/pcscada)  - PCSC/Ada 提供到 PC/SC 中间件的厚 Ada 绑定. 该库允许用 Ada 编写的程序使用 SCard API 与智能卡通信.
...
- [tashy](https://github.com/thindil/tashy)  - Tashy 是 Tcl Ada SHell Younger 的简称. 它是 Tash 的衍生物，主要专注于 Tk 绑定.
- [tashy2](https://github.com/thindil/tashy2)  - Tashy2 是 Tcl Ada SHell Younger 的缩写. 它是 Tashy 的衍生版本，旨在更加地道并使用更宽松的许可证.
