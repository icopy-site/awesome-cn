...
- [scala](http://www.huygens-fokker.org/scala) -Scala是功能强大的软件工具，可用于进行音乐调律的实验，例如音准音阶，均等和历史气质，微音阶和大音阶音阶以及非西方音阶.
...
- [a-shell](https://github.com/charlie5/aShell) -有助于在Ada中编写类似shell的应用程序的组件.
