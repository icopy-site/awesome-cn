...
始终欢迎您提供意见和建议！ 请看看 [contribution guidelines and quality standard](https://github.com/ciconia/awesome-music/blob/master/CONTRIBUTING.md) 第一的.
...
* [Librosa](https://github.com/librosa/librosa) -用于音乐和音频分析的python软件包，提供创建音乐信息检索系统所需的构件.
...
* [MusicBrainz](https://musicbrainz.org) -开放式百科全书，提供音乐信息和元数据，为所有内容提供唯一的ID
...
* [IMSLP](http://imslp.org/) -国际音乐乐谱库项目是网络上最大的公共领域乐谱和部分作品的集合.
...
* [Inknote](https://github.com/MichalPaszkiewicz/inknote) -免费，开放源代码，基于浏览器的音乐符号和作曲软件.
...
* [MusicKit](https://github.com/venturemedia/musickit) -用于iOS和OSX的乐谱渲染.
...
* [Ripple](https://github.com/ciconia/ripple/) -对Lilypond进行DRY-产生分数和分数的要求不高.
...
* [Chuck](https://github.com/ccrma/chuck) -时间紧迫，并发且即时的音乐编程语言.
...
* [Leipzig](https://github.com/ctford/leipzig) -泛音的合成库.
...
* [OpenMusicTheory](http://openmusictheory.com/) -有关音乐理论和听觉技巧的在线日益增长的“教科书”.
...
* [MusicXML](http://www.musicxml.com/) -交换数字活页乐谱的标准开放格式.
...
* [Awesome Music Production](https://github.com/adius/awesome-music-production) -精选的用于创建音乐的软件和资源列表.
