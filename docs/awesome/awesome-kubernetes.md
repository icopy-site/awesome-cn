...
## Date of Birth:
 ...
 Kubernetes每年7月21日庆祝其生日.  Kubernetes 1.0于2015年7月21日首次向公众发布后发布 [Dockercon in June 2014](https://www.youtube.com/watch?v=YrxnVKZeqK8).
...
* Kubernetes的一些持久性卷提供商列表.查看 [Persistent Volume Providers](https://github.com/kubernetes/examples/tree/master/staging/persistent-volume-provisioning) 了解更多信息*
...
*您可能会发现有用的Kubernetes相关项目*


## Related Software

*旨在使Kubernetes生活更好，更强大，更具可扩展性的项目*
...
* [NexClipper](https://github.com/NexClipper/NexClipper) - 用于监控Kubernetes和容器的开源软件.
...
* [kube-monkey](https://github.com/asobti/kube-monkey) -  Chauber Monkey for Kubernetes集群
...
* [Minio](http://minio.io)
* [Vitess](http://vitess.io/) -  Youtube对MySql的水平缩放
...
* [Kamus](https://github.com/Soluto/kamus) - 用于秘密加密/解密解决方案的GitOps，零信任解决方案.
...
* [MetalLB](https://metallb.universe.tf/) - 使用标准路由协议实现裸机Kubernetes集群的负载均衡器.
...
* [kube-libsonnet](https://github.com/bitnami-labs/kube-libsonnet/blob/master/kube.libsonnet) - 用于Jsonnet / Kubecfg的Kubernetes对象的通用库，其中包含用于无痛覆盖的数组映射的对象.
* [kompose](https://github.com/kubernetes/kompose)
...
*书面或印刷作品，包括从一侧粘合或缝合在一起并装在盖子中的页面
我们有信息*
...
* [Cluster management with Kubernetes](http://www.slideshare.net/SatnamSingh67/2015-0605-cluster-management-with-kubernetes) 作者：Satnam Singh
...
* ["Managing Containers at Scale with CoreOS and Kubernetes" 通过 Kelsey Hightower](https://www.youtube.com/watch?v=pozC9rBvAIs) 通过 [Kelsey Hightower](https://twitter.com/kelseyhightower)
...
* [Ihor Dvoretskyi](https://twitter.com/idvoretskyi)，Cloud Native Computing Foundation的开发人员倡导者
* [Jessie Frazzelle](https://github.com/jessfraz)，微软的Cloud Developer Advocate
* [Joe Beda](https://twitter.com/jbeda)，Heptio的创始人兼首席技术官
* [Joseph Jacks](https://twitter.com/asynchio)，昆腾公司驻留企业家
