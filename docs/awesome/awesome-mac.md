...
* [Journey](https://journey.cloud/)  -具有许多功能的日记应用程序，以及适用于每个可用平台的应用程序.  [！[App Store] [app-store Icon]]（https://apps.apple.com/us/app/journey-diary-journal/id1265425422?mt=12）
...
* [Kindle App](https://www.amazon.com/l/16571048011) -亚马逊的Kindle官方阅读应用程序.
...
* [Scribus](https://www.scribus.net/)  -支持EPS和SVG导入/导出以及PDF支持的专业布局和发布软件.  [！[开源软件] [OSS图标]]（https://sourceforge.net/projects/scribus/）！[免费软件] [免费软件图标]
...
* [Spillo](https://bananafishsoftware.com/products/spillo/) -适用于OS X的强大，精美，快速的Pinboard客户端.
...
* [Espresso](http://espressoapp.com/)  -Mac版网络编辑器又回来了. 对于制作令人愉快，创新和快速的网站的人.
...
* [Cacher](https://www.cacher.io/) -具有Gist同步，VSCode / Atom / Sublime软件包和Mac / Windows / Linux / Web客户端的基于云的，基于团队的代码片段管理器.
...
* [PushMate](https://pushmate.app) PushMate是MacOS应用程序，可通过确保您的推送有效载荷正确来解决常见的推送通知问题.
...
* [SwitchHosts](https://oldj.github.io/SwitchHosts/)  -免费和开源的应用程序，用于主机管理和切换.  [！[开源软件] [OSS图标]]（https://github.com/oldj/SwitchHosts）！[免费软件] [免费软件图标]
...
* [autojump](https://github.com/wting/autojump/wiki)  -将`cd`替换为智能的自动跳转，以从命令行轻松浏览目录.  [！[开源软件] [OSS图标]]（https://github.com/wting/autojump）！[免费软件] [免费软件图标]
...
* [eureka](https://github.com/simeg/eureka)  -CLI工具，无需离开终端即可输入和存储您的想法.  ！[开源软件] [OSS图标]！[免费软件] [免费软件图标]
...
* [Glances](https://github.com/nicolargo/glances)  -Glances是一个基于curses的跨平台系统监视工具.  [！[开源软件] [OSS图标]！[免费软件] [免费软件图标]]（https://github.com/nicolargo/glances）
...
* [kitty](https://github.com/kovidgoyal/kitty)  -基于GPU的跨平台，快速，功能齐全的终端仿真器.  [！[开源软件] [OSS图标]]（https://github.com/kovidgoyal/kitty）！[免费软件] [免费软件图标]
...
* [silver searcher (ag)](https://github.com/ggreer/the_silver_searcher)  -与ack类似的代码搜索工具，着重于速度.  [！[开源软件] [OSS图标]]（https://github.com/ggreer/the_silver_searcher）！[免费软件] [免费软件图标]
...
* [Terminus](https://github.com/Eugeny/terminus)  -免费的终端工具，使用TypeScript构建，深受Hyper启发.  [！[开源软件] [OSS图标]]（https://github.com/Eugeny/terminus）！[免费软件] [免费软件图标]
...
* [tmux](https://github.com/tmux/tmux)  -“终端多路复用器”，它使多个终端（或窗口）可以从单个终端访问和控制.  tmux旨在成为BNU许可的简单，现代的替代程序，例如GNU屏幕.  [！[开源软件] [OSS图标]]（https://github.com/tmux/tmux）
...
* [Git Cola](https://git-cola.github.io/)  -强大，快速，轻巧且友好的Git GUI. 对于那些需要咖啡因的使用者.  ！[开源软件] [OSS图标]
...
* [Gitfox](https://www.gitfox.app)  -提交速度更快，使用出色的差异提高代码质量-看起来不错.  [！[App Store] [app-store Icon]]（https://apps.apple.com/app/gitfox/id1475511261）
...
* [OhMyStar](https://ohmystarapp.com/) 管理，探索和共享您的Github星的美丽而有效的方法.  ！[免费软件] [免费软件图标] [！[应用商店] [应用商店图标]]（https://itunes.apple.com/us/app/ohmystar2/id1218642292）
...
* [Sequel Pro](http://www.sequelpro.com/) -Mac OS X的MySQL数据库管理.[！[开源软件] [OSS图标]]（https://github.com/sequelpro/sequelpro）！[免费] [免费软件]
...
* [TinyPNG4Mac](https://github.com/kyleduo/TinyPNG4Mac)  -开源工具来压缩图像.  [！[开源软件] [OSS图标]！[免费软件] [免费软件图标]]（https://github.com/kyleduo/TinyPNG4Mac）
...
* [Adium](https://adium.im/)  -适用于Mac OS X的免费即时消息传递应用程序.连接到AIM，MSN，SMPP，Yahoo等.  ！[免费软件] [免费软件图标]
...
* [Gitter](https://gitter.im)  -开发人员和GitHub用户的即时消息传递和聊天室系统. 对Markdown语法的支持对开发人员友好.
...
* [Shift](https://tryshift.com/) -整理桌面工作空间并简化帐户，应用程序和工作流程.
...
* [Flow](http://fivedetails.com/flow/) -屡获殊荣的美观，快速，可靠的FTP + SFTP客户端.
...
* [Popcorn Time](https://popcorntime.sh)  -立即观看洪流电影，此“爆米花时间”服务将永远不会被删除. 下载并享受.  ！[免费软件] [免费软件图标]
...
* [Kawa](https://github.com/utatti/kawa) -OS X更好的输入源切换器.[！[开源软件] [OSS图标]]（https://github.com/utatti/kawa）！[免费软件] [免费软件图标]
...
* [Vivaldi](https://vivaldi.com)  -使您掌控一切的浏览器.  [！[开源软件] [OSS图标]]（https://vivaldi.com/source）！[免费软件] [免费软件图标]
...
* [Mate Translate](https://gikken.co/mate-translate/mac) -在Safari和macOS上的任何应用程序之间翻译103种语言.
...
* [BlockBlock](https://objective-see.com/products/blockblock.html)  -我：“只要永久安装任何组件，请提醒我.”  BlockBlock：“你明白了”
...
* [Tunnelbear](https://www.tunnelbear.com)  -真正简单的VPN，可安全私密地浏览网页. 使用适用于Mac，PC，iOS，Android和Chrome的应用程序解锁世界各地的网站.
...
* [eZip](http://ezip.awehunt.com)  -一个易于使用的，功能丰富的macOS存档器. 支持流行的格式，如RAR，ZIP，7Z，BZ2，GZ等.与Mojave暗模式和QuickLook搭配使用非常出色.  ！[免费软件] [免费软件图标]
...
* [muCommander](http://www.mucommander.com)  -具有双窗格界面的轻型文件管理器.  [！[开源软件] [OSS图标]]（https://github.com/mucommander/mucommander）！[免费软件] [免费软件图标]
...
* [Focus](https://masterbuilders.io)  -基于pomodoro的漂亮时间管理器.  [！[App Store] [app-store Icon]]（https://itunes.apple.com/us/app/focus-productivity-timer/id777233759?mt=12）
...
* [Things](https://culturedcode.com/things/)  -令人愉快且易于使用的任务管理器.  （**获奖应用**）
...
* [HazeOver](https://hazeover.com) 该应用可使您的后台应用窗口变暗，因此您可以将更多精力放在主要任务上！  [！[App Store] [app-store Icon]]（https://apps.apple.com/ph/app/hazeover-distraction-dimmer/id430798174?mt=12）
* [Hungrymark](https://zhengying.github.io/hungrymark) -有用的应用程序，可为您的文件，文件夹和网站添加书签，可通过菜单栏[！[App Store] [app-store图标]]快速访问您的书签（https://apps.apple.com/us/app/hungrymark/ id1482778901？l = zh-TW＆mt = 12）
* [iCMD](https://icmd.app) -模糊菜单栏搜索和vim / easymotion仿真，可在每个本地MacOS应用程序中全局使用.
* [Karabiner](https://pqrs.org/osx/karabiner/) -适用于OS X的强大而稳定的键盘定制程序.[！[开源软件] [OSS图标]！[免费软件] [免费软件图标]]（https://github.com/tekezo/Karabiner）
...
* [SensibleSideButtons](http://sensible-side-buttons.archagon.net)  –使用鼠标的侧面按钮可以在许多应用程序中向前和向后移动，例如Windows.  [！[开源软件] [OSS图标]]（https://github.com/archagon/sensible-side-buttons）
...
* [Strategr](https://khrykin.github.io/strategr/)  –轻松的时间管理应用程序.  Stategr帮助您最大程度地提高生产力，从而为您安排时间的最快，最有效的方式.  [！[开源软件] [OSS图标]！[免费软件] [免费软件图标]]（https://github.com/khrykin/StrategrDesktop）
* [Time Out](https://www.dejal.com/timeout/)  -轻松的休息提醒，如果需要，可以使用微休息和灵活的自定义.  ！[免费软件] [免费软件图标] [！[应用商店] [应用商店图标]]（https://itunes.apple.com/us/app/time-out-break-reminders/id402592703?mt=12）
...
* [Rectangle](https://rectangleapp.com)  -基于Swift的Spectacle窗口管理应用程序.  [！[开源软件] [OSS图标]]（https://github.com/rxhanson/Rectangle）！[免费软件] [免费软件图标]
...
* [Slate](https://github.com/jigish/slate)  -与Divvy和SizeUp类似的窗口管理应用程序（更好和免费的除外）.  （**需要配置文件**）[！[开源软件] [OSS图标]！[免费软件] [免费软件图标]]（https://github.com/jigish/slate）
...
* [Mounty](http://enjoygineering.com/mounty/)  -微型工具，用于以读写模式在Mac OS X 10.9+下重新安装受写保护的NTFS卷.  ！[免费软件] [免费软件图标]
...
* [OmniDiskSweeper](https://www.omnigroup.com/more)  -根据大小显示驱动器上的文件. 它可以用来查找和删除未使用的文件.  ！[免费软件] [免费软件图标]
...
* [Sensei](https://sensei.app/) -Sensei是用于Mac性能的多功能工具，其功能涵盖硬件和软件.
...
* [Flume](https://flumeapp.com)  -Mac的美丽Instagram体验. 如果您只想浏览而不是发布，那么免费版本就足够了.！[免费软件] [免费软件图标]
...
* [Setapp](https://setapp.com) -一台Mac上最好的应用程序.
