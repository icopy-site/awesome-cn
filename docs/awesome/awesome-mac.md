...
* [Pages](https://apps.apple.com/cn/app/pages/id409201541?mt=12)  分开的文件.  ！[Freeware] [Freeware Icon] [！[App Store] [app-store Icon]]（https://apps.apple.com/cn/app/pages/id409201541?mt=12）
...
* [Numbers](https://apps.apple.com/cn/app/numbers/id409203825?mt=12)  创建出色的电子表格.  ！[Freeware] [Freeware Icon] [！[App Store] [app-store Icon]]（https://apps.apple.com/cn/app/numbers/id409203825?mt=12）
* [Microsoft Office](https://products.office.com/en-us/mac/microsoft-office-for-mac)  毫无疑问是专为Mac设计的Office.  [！[App Store] [app-store Icon]]（https://apps.apple.com/cn/app/numbers/id409203825?mt=12）
...
* [Marp](https://marp.app)   - 具有跨平台支持的Markdown演示文稿作者.  [！[开源软件] [OSS图标]]（https://github.com/yhatt/marp）！[免费软件] [免费软件图标]
...
* [Notable](https://github.com/notable/notable) - 基于降价的笔记记录应用程序，不吸吮.
...
* [Feeds 2](https://github.com/nfarina/feeds/)   - 密切关注您最喜欢的网站和Mac的菜单栏中的RSS源.  [！[开源软件] [OSS图标]！[免费软件] [免费软件图标]]（https://github.com/nfarina/feeds）
* [Leaf](http://www.rockysandstudio.com/) - 令人惊叹的新闻阅读器致力于帮助您享受每日新闻并轻松管理您的订阅.
* [NetNewsWire](https://ranchero.com/netnewswire/)   - 它是macOS的免费开源阅读器.  [！[开源软件] [OSS图标]！[免费软件] [免费软件图标]]（https://github.com/brentsimmons/NetNewsWire）
...
* [kitty](https://github.com/kovidgoyal/kitty)   - 跨平台，快速，功能齐全，基于GPU的终端仿真器.  [！[开源软件] [OSS图标]]（https://github.com/kovidgoyal/kitty）！[免费软件] [免费软件图标]
...
* [Magic Wormhole](https://magic-wormhole.readthedocs.io/en/latest/)   - 安全地从一台计算机到另一台计算机.  [！[开源软件] [OSS图标]]（https://github.com/guarinogabriel/Mac-CLI）！[免费软件] [免费软件图标]
...
* [nushell](https://github.com/nushell/nushell)   -  nushell是一个用Rust编写的现代GitHub时代的shell.  [！[开源软件] [OSS图标]]（https://sourceforge.net/projects/zsh/）！[免费软件] [免费软件图标]
...
* [Simple Diagrams](https://www.simplediagrams.com/) - 一个桌面应用程序，用于创建手绘，快速，清晰的问题，流程，工作流程，想法等草图！
...
* [ScreenShot PSD](http://txtlabs.com/)   - 将屏幕捕获为分层PSD，以便于编辑.  ！[Freeware] [Freeware Icon] [！[App Store] [app-store Icon]]（https://itunes.apple.com/us/app/screenshot-psd/id489880259）
...
* [HEIC Converter](https://sindresorhus.com/heic-converter)   - 将HEIC图像转换为JPEG或PNG.  ！[Freeware] [Freeware Icon] [！[App Store] [app-store Icon]]（https://itunes.apple.com/us/app/heic-converter-to-jpeg-or-png/id1294126402）
...
* [Gifski](https://github.com/sindresorhus/gifski-app)   - 将视频转换为高品质的GIF.  ！[开源软件] [OSS图标]！[免费软件] [免费软件图标] [！[应用商店] [应用商店图标]]（https://itunes.apple.com/no/app/gifski/id1351639930 ？MT = 12）
...
* [Stremio](https://www.stremio.com/)   - 电影，电视节目，连续剧，电视直播或YouTube和Twitch.tv等网络频道 - 您可以在Stremio上找到所有这些.  ！[免费软件] [免费软件图标]
...
* [Motrix](https://motrix.app/) -  Motrix是一个功能齐全的下载管理器，支持下载HTTP，FTP，BitTorrent，磁铁，百度网盘等[！[开源软件] [OSS图标]]（https://github.com/agalwood/ Motrix）！[免费软件] [免费软件图标]
...
* [Microsoft Edge Canary](https://www.microsoftedgeinsider.com) -  Edge Canary，基于Chromium重新开发，但由MS建造！[免费软件] [免费软件图标]
...
* [BeardedSpice](https://github.com/beardedspice/beardedspice)   - 允许您使用Mac键盘上的媒体键控制基于Web的媒体播放器（SoundCloud，YouTube等）和一些本机应用程序.  [！[开源软件] [OSS图标]]（https://github.com/beardedspice/beardedspice）！[免费软件] [免费软件图标]
* [BitBar](https://getbitbar.com/)   - 将任何脚本或程序的输出放在Mac OS X菜单栏中.  [！[开源软件] [OSS图标]]（https://github.com/matryer/bitbar）！[免费软件] [免费软件图标]
...
* [Itsycal](https://www.mowglii.com/itsycal/)   -  Mac菜单栏的微小日历.  [！[开源软件] [OSS图标]！[免费软件] [免费软件图标]]（https://github.com/sfsam/itsycal）
* [Streaker](https://github.com/jamieweavis/streaker)   -  GitHub贡献条纹跟踪菜单应用程序.  [！[开源软件] [OSS图标]！[免费软件] [免费软件图标]]（https://github.com/jamieweavis/streaker）
* [Vanilla](http://vanilla.matthewpalmer.net)   - 隐藏Mac上的菜单栏图标.  ！[免费软件] [免费软件图标]
...
* [Memo](http://memo-app.net/)   - 简单而优雅的应用程序.  使用Touch ID更快地解锁备忘录.  ！[Freeware] [Freeware Icon] [！[App Store] [app-store Icon]]（https://itunes.apple.com/app/id1212409035）
* [Numi](http://numi.io/)   -  Mac的美丽计算器应用程序.  ！[免费软件] [免费软件图标]
* [SlowQuitApps](https://github.com/dteoh/SlowQuitApps)   -  OS X应用程序，为Cmd-Q快捷方式添加1秒的全局延迟.  [！[开源软件] [OSS图标]！[免费软件] [免费软件图标]]（https://github.com/dteoh/SlowQuitApps）
* [Torimori Sweeper](https://coffeeboo.itch.io/sweeper)   -  MacOS应用程序，让您一次整理一个文件的下载.  [！[免费软件] [免费软件图标]]（https://coffeeboo.itch.io/sweeper）

#### To-Do Lists

* [2Do](http://www.2doapp.com/) - 不错的所有应用程序
* [Day-O 2](http://www.shauninman.com/archive/2016/10/20/day_o_2_mac_menu_bar_clock)   - 使用内置日历替换菜单栏时钟.  ！[免费软件] [免费软件图标]
* [Fantastical](https://flexibits.com/fantastical) - 日历应用程序，你将无法生活.
...
* [BetterTouchTool](https://boastr.net)   - 功能强大的精彩应用程序，允许您为Magic Mouse，Macbook Trackpad，Magic Trackpad以及普通鼠标的鼠标手势配置许多手势.  ！[免费软件] [免费软件图标]
* [Choosy](https://www.choosyosx.com) - 用户界面，URL API和浏览器扩展集，用于管理规则以及如何打开链接.
* [Hammerspoon](http://www.hammerspoon.org/)   - 使用Lua脚本引擎实现强大OSX自动化的工具.  [！[开源软件] [OSS图标]]（https://github.com/Hammerspoon/hammerspoon）！[免费软件] [免费软件图标]
...
* [Karabiner](https://pqrs.org/osx/karabiner/) - 强大而稳定的OS X键盘定制器.[！[开源软件] [OSS图标]！[免费软件] [免费软件图标]]（https://github.com/tekezo/Karabiner）
* [Keyboard Maestro](http://www.keyboardmaestro.com) - 根据键盘，菜单，位置，添加的设备等触发器自动执行例行操作.
* [Keytty](http://keytty.com)   - 应用程序让你的手在键盘上.  用几个笔划移动，单击，滚动，拖动等等.
* [Mos](http://mos.u2sk.com/)   - 简单的工具可以在Mac上提供平滑滚动和反转鼠标滚动方向.  [！[开源软件] [OSS图标]]（https://github.com/Caldis/Mos）！[免费软件] [免费软件图标]
...
* [nnScreenshots](https://www.nearnorthsoftware.com/software/screenshots.php)   - 一种超级简单的方法，可以直观地记录您的工作效率，以便更轻松地填写时间表或帮助您查看当天.  内置时间表编辑器.
* [skhd](https://github.com/koekeishiya/skhd)   -  macOS的简单热键守护进程.  [！[开源软件] [OSS图标]！[免费软件] [免费软件图标]]（https://github.com/koekeishiya/skhd）
* [Time Out](https://www.dejal.com/timeout/)   - 轻松提醒，如果您需要，可以进行微休息和灵活定制.  ！[Freeware] [Freeware Icon] [！[App Store] [app-store Icon]]（https://itunes.apple.com/us/app/time-out-break-reminders/id402592703?mt=12）
* [Timing](https://timingapp.com/)   -  Mac的自动时间和生产力跟踪.  帮助您保持正常工作，并确保如果您按小时计费，则不会丢失计费时间.
* [Trello](https://trello.com) - 一个协作工具，将您的项目组织成看板.！[免费软件] [免费软件图标] [！[应用商店] [应用商店图标]]（https://itunes.apple.com/app/trello/id1278508951？ LS = 1＆MT = 12）
* [Ukelele](http://scripts.sil.org/ukelele) -  Unicode键盘布局编辑器.
* [xScope](http://xscopeapp.com/) - 功能强大的工具集，非常适合测量，检查和测试屏幕图形和布局.
* [Z](https://github.com/rupa/z) - 通过在终端中仅键入一串目录名称而不是键入导演的确切位置来轻松导航的强大方法.
...
* [SafeInCloud](https://safe-in-cloud.com/en/)   - 跨平台密码管理，低成本的应用程序！  [！[App Store] [app-store Icon]]（https://itunes.apple.com/cn/app/safeincloud-password-manager/id883070818）

#### Finder Tools

* [fman](https://fman.io) - 第一个用于集成Sublime Text功能的双窗格文件管理器.
* [ForkLift](http://binarynights.com/forklift/) - 用于macOS的最先进的双窗格文件管理器和文件传输客户端.
* [Path Finder](http://www.cocoatech.com/pathfinder/) - 文件管理应用程序.
* [QSpace](https://qspace.awehunt.com)   - 干净，高效的多视图文件管理器.  [！[App Store] [app-store Icon]]（https://apps.apple.com/us/app/id1469774098）
* [TotalFinder](http://totalfinder.binaryage.com/) -  Chrome风格的Finder替代品.
...
* [Amphetamine](https://itunes.apple.com/us/app/amphetamine/id937984704)   - 覆盖节能设置，让Mac保持清醒状态.  ！[Freeware] [Freeware Icon] [！[App Store] [app-store Icon]]（https://itunes.apple.com/us/app/amphetamine/id937984704）
* [AppCleaner](http://freemacsoft.net/appcleaner/)   - 小应用程序，允许您彻底卸载不需要的应用程序.  ！[免费软件] [免费软件图标]
* [Cleaner for Xcode](https://github.com/waylybaye/XcodeCleaner)   - 通过删除不需要的和已弃用的文件，帮助您提高Xcode的速度.  [！[开源软件] [OSS图标]]（https://github.com/waylybaye/XcodeCleaner）！[免费软件] [免费软件图标]
* [coconutBattery](https://www.coconut-flavour.com/coconutbattery/)   - 显示Mac中电池的实时信息.  包括：制造日期，容量，循环次数，电池状态，温度，放电功率.
...
* [OpenEmu](http://openemu.org/)   - 一个出色的视频游戏控制台模拟器，在单个应用程序中支持许多不同的模拟器.  （例如索尼PSP，GameBoy，NDS等）[！[开源软件] [OSS图标]！[免费软件] [免费软件图标]]（https://github.com/OpenEmu/OpenEmu）
* [PPSSPP](https://www.ppsspp.org)   - 适合您梦寐以求的任何操作系统的超棒PSP仿真器！  [！[开源软件] [OSS图标]！[免费软件] [免费软件图标]]（https://github.com/hrydgard/ppsspp）
...
* [Chirper](https://arguiot.com/Chirper/) - 一个简单而小巧的缓冲区/推特菜单栏应用程序，可以帮助您发送您的想法，而无需打开任何东西.
* [Flume](https://flumeapp.com)   - 为您的Mac带来美妙的Instagram体验.  免费版本足够好，如果你只想做浏览而不是发布.！[免费软件] [免费软件图标]
...
如果您遇到提供盗版软件或破解的网站，请发布 [HERE](https://github.com/jaywcjlove/awesome-mac/issues/17) .  我们喜欢应用，但只有真实的应用.  :)

* [Setapp](https://setapp.com) - 一个套件中适用于Mac的最佳应用程序.

#### Package Managers

*以下是一些主要的软件下载站点，有一些OSX Mac软件站点*
...
* [Homebrew](https://brew.sh/)   -  macOS缺少的包管理器.  ！[免费软件] [免费软件图标] [！[开源软件] [OSS图标]]（https://github.com/Homebrew/brew/）
* [MacPorts](https://www.macports.org/)   - 开源社区计划，旨在设计一个易于使用的系统，用于在Mac OS X操作系统上编译，安装和升级基于命令行，X11或Aqua的开源软件.  ！[免费软件] [免费软件图标] [！[开源软件] [OSS图标]]（https://github.com/macports/）
* [MacUpdate Desktop](https://www.macupdate.com/) - 简化为Mac查找，购买和安装应用程序的过程.
...
* [alternativeTo](http://alternativeto.net/)   - 也是一个非常好的社区.  如果您正在寻找一些替代应用程序** FOR ** Windows或其他平台，请查看此站点.
* [Slant](https://www.slant.co)   - 我个人推荐这个.  这是一个可以并排比较应用程序的平台，您可以通过查看其他用户的建议获得一个想法.  如果您从此列表中找到应用程序，请提供帮助！
...
*其他网站喜欢 [MacStories](https://www.macstories.net/), [LifeHacker](http://lifehacker.com/), [ProductHunt](https://www.producthunt.com/topics/mac) 是很好的资源.
...
* [Mac Power Users](https://www.relay.fm/mpu)   - 了解如何通过专注的主题和工作流程客户充分利用Apple技术.  ！[Freeware] [Freeware Icon] [！[App Store] [app-store Icon]]（https://itunes.apple.com/podcast/mac-power-users/id458066753）
...
## Sponsors
 ...
 成为赞助商支持这个项目.  您的徽标将显示在此处，其中包含指向您网站的链接. [Become a sponsor](https://opencollective.com/awesome-mac#sponsor)
