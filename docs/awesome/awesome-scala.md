...
[mainargs](https://github.com/com-lihaoyi/mainargs)  |  Scala中一个用于命令行参数解析的小型，便捷，无依赖的库 ![GitHub stars](https://img.shields.io/github/stars/com-lihaoyi/mainargs) ![GitHub commit activity](https://img.shields.io/github/commit-activity/y/com-lihaoyi/mainargs)
