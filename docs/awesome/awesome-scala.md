...
* **[better-files ★ 824 ⧗ 0](https://github.com/pathikrit/better-files) **-简单，安全和直观的Scala I / O.  Better-files是围绕Java NIO的无依赖实用的瘦Scala包装器.
...
* [Each ★ 146 ⧗ 0](https://github.com/ThoughtWorksInc/each) -宏库，将本机命令式语法转换为 [Scalaz](https://github.com/scalaz/scalaz)的单子表达式.
...
* [Resolvable ★ 0 ⧗ 94](https://github.com/stanch/resolvable) -用于优化从几种格式的多个端点获取不可变数据结构的库.
* [Squid ★ 88 ⧗ 9](https://github.com/epfldata/squid) -具有类型化，卫生的准引用的类型安全元编程框架.
...
* **[Shapeless ★ 2002 ⧗ 0](https://github.com/milessabin/shapeless)**-Scala的基于类型类和从属类型的通用编程库.
...
* **[sbt-native-packager ★ 811 ⧗ 3](https://github.com/sbt/sbt-native-packager)**-捆绑用于本地包装系统的Scala软件，例如deb，rpm，自制软件，msi.
...
* [sbt-sonatype ★ 221 ⧗ 4](https://github.com/xerial/sbt-sonatype) -一个sbt插件，用于将Scala / Java项目发布到Maven中央.
