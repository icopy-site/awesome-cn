...
* [lucene4s ★ 3 ⧗ 56](https://github.com/outr/lucene4s) -Lucene周围的轻巧便利包装，可简化复杂任务并添加Scala糖.
...
* [neo4akka ★ 6 ⧗ 117](https://github.com/outr/neo4akka) -Neo4j Scala客户端使用Akka HTTP和编译时查询插值，案例类支持，真正的非阻塞IO等.
...
* [Salat ★ 490 ⧗ 9](https://github.com/salat/salat/)  -适用于MongoDB的ORM.  也可以使用相关的Play插件.
...
* [Scanamo ★ 92 ⧗ 1](https://github.com/guardian/scanamo) -使DynamoDB与Scala一起使用更简单，更不易出错的库.
* [scredis ★ 149 ⧗ 29](https://github.com/Livestream/scredis) -建立在Akka IO之上的非阻塞Redis客户端（由Livestream使用）
* [Shade ★ 82 ⧗ 32](https://github.com/alexandru/shade) -基于Spymemcached的Scala的Memcached客户端
* **[Slick ★ 1795 ⧗ 0](https://github.com/slick/slick)**  - 现代数据库查询和访问库斯卡拉.
* [Slick-pg ★ 714](https://github.com/tminglei/slick-pg) -PostgreSQL的扩展.
* [Sorm ★ 239 ⧗ 2](https://github.com/sorm/sorm) - 一个功能免费的样板 - 斯卡拉ORM.
...
* [Tepkin ★ 86 ⧗ 251](https://github.com/fehmicansaglam/tepkin) -基于Akka IO和Akka Streams构建的Scala的Reactive MongoDB驱动程序.

## Messaging

* [Op-Rabbit ★ 153 ⧗ 2](https://github.com/SpinGo/op-rabbit) -Akka和Op-Rabbit的高级消息传递库.
...
* **[Finatra ★ 1558 ⧗ 0](https://github.com/twitter/finatra)**-受Sinatra启发的scala Web框架，在Finagle上运行.
...
* [youi ★ 81 ⧗ 12](https://github.com/outr/youi) -用于Scala和Scala.js的下一代用户界面框架和服务器引擎.
...
* [Udash](http://udash.io/)  -基于Scala.js的Web框架，支持属性绑定，前端路由，i18n等.  它还提供基于WebSockets的强类型客户端&lt;-&gt;服务器RPC系统.
* [Vert.x Web](http://vertx.io/docs/vertx-web/scala/) -用于构建反应式Web应用程序的工具包.
* [Widok](https://widok.github.io/) -用于JVM和Scala.js的反应式Web框架

## Data Binding and Validation

*用于数据绑定和验证的Scala库*

* [Accord ★ 379 ⧗ 0](https://github.com/wix/accord) -用于Scala的健全的验证库
...
* [TSec ★ 27 ⧗ 0](https://github.com/jmcardon/tsec) - 类型安全的，功能性，通用加密库
...
* **[ScalaTest ★ 532 ⧗ 5](https://github.com/scalatest/scalatest)**-针对Scala和Java开发人员的测试工具.
...
* [sbt-json](https://github.com/battermann/sbt-json) -sbt插件，可生成Scala案例类，以便轻松，静态类型化和隐式访问JSON文档
* [uJson](http://www.lihaoyi.com/upickle/#uJson) -Scala的快速，灵活和直观的JSON

## YAML

*用于YAML的库.*

* [MoultingYAML ★ 43 ⧗ 2](https://github.com/jcazevedo/moultingyaml) -基于SnakeYAML的基于类型类的YAML序列化和反序列化.
...
* [kantan.csv ★ 143 ⧗ 24](https://github.com/nrinaudo/kantan.csv) -  CSV处理库斯卡拉与多个后端.
* [Scala-CSV ★ 365 ⧗ 1](https://github.com/tototoshi/scala-csv) -Scala的CSV读取器/写入器.
...
* [µPickle](http://lihaoyi.github.io/upickle/) -适用于ScalaJS的Scala轻量级序列化库，允许在JVM和JavaScript之间传输结构化数据.
* [ScalaBuff ★ 218 ⧗ 1](https://github.com/SandroGrzicic/ScalaBuff) -  Scala的协议缓冲器（protobuf的）编译器
...
* [validation ★ 177 ⧗ 3](https://github.com/jto/validation) -JSON，HTML表单数据等的高级验证和序列化，在运行时不作任何反映.
...
* [ND4S ★ 201 ⧗ 0](https://github.com/deeplearning4j/nd4s)  -具有类似于Numpy的API的Scala的N维数组和线性代数.  ND4S是一个scala包装器 [ND4J](http://nd4j.org/).
...
* **[scrimage ★ 654 ⧗ 97](https://github.com/sksamuel/scrimage)**-图片io，调整大小，操作和缩略图.

## Sound processing and music

* [Chromaprint.scala ★ 31](https://github.com/mgdigital/Chromaprint.scala) -Chromaprint / AcoustID音频指纹识别算法的Scala实现.
* [ScalaCollider ★ 121 ⧗ 5](https://github.com/Sciss/ScalaCollider) - 声音合成和信号处理客户端SuperCollider.

## Functional Reactive Programming

*事件流，信号，可观察物等*

* **[fs2 ★ 1323 ⧗ 340](https://github.com/functional-streams-for-scala/fs2)**  - 组成，流式I / O库斯卡拉
...
* [SynapseGrid ★ 109 ⧗ 1](https://github.com/Primetalk/SynapseGrid)  -用于构建反应式实时不变数据流系统的FRP框架.  它实现了基于Petri网络运行和组织事件驱动系统的原始方式.  拓扑可以视为.dot图.  该库与Akka兼容，可以与其他参与者无缝通信.
...
* [SubCut ★ 403 ⧗ 9](https://github.com/dickwall/subcut) - 斯卡拉独特绑定类在性状.
...
* [Clump](http://getclump.io) -一个用于表达和高效服务组合的库
...
* **[Cassovary ★ 881 ⧗ 0](https://github.com/twitter/cassovary)**-Scala库是从头开始设计的，旨在提高空间效率，处理具有数十亿个节点和边的图形.
* **[cats ★ 1697 ⧗ 0](https://github.com/typelevel/cats)**-用于函数式编程的轻量级，模块化和可扩展的库.
* [Chimney ★ 92 ⧗ 5](https://github.com/scalalandio/chimney) -  Scala库免费样板数据转换.
* [chronoscala ★ 38 ⧗ 0](https://github.com/opt-tech/chronoscala) -Java日期/时间API的Scala包装器.
* [Dsl.scala](https://github.com/ThoughtWorksInc/Dsl.scala/) -在Scala中创建嵌入式领域特定语言的框架，以及一些内置的DSL，包括异步/等待，生成器，定界的延续，异步集合理解，RAII，猫和scala的monadic！标记等.
...
* [Lamma ★ 70 ⧗ 8](https://github.com/maxcellent/lamma) - 斯卡拉日期库日期和时间安排生成.
* [LArray ★ 225 ⧗ 25](https://github.com/xerial/larray) -大型堆外阵列（&gt; 2GB）和mmap文件.
* [Log4s](http://www.log4s.org/) -快速，易于Scala记录的绑定 [SLF4J](http://slf4j.org/) .  使用宏来获得最佳性能.
* [LogStage ★ 75 ⧗ 0](https://github.com/7mind/izumi) -具有[SLF4J]集成的Scala零努力结构记录器.
* **[Scala-Logging ★ 707](https://github.com/lightbend/Scala-Logging)**-用于Scala包装SLF4J的便捷且高性能的日志记录库.
* **[Monocle ★ 757 ⧗ 0](https://github.com/julien-truffaut/Monocle)**-光学/镜头库，用于对不可变对象进行纯功能操作.
* **[n-scala ★ 662 ⧗ 3](https://github.com/nscala-time/nscala-time)**-Joda Time的Scala包装器.
* [Persist-Logging ★ 33 ⧗ 48](https://github.com/nestorpersist/logging) -Scala的综合日志库.
* [Quicklens ★ 245 ⧗ 0](https://github.com/adamw/quicklens) -使用优雅的API修改深度嵌套的案例类字段
* [Rapture](http://rapture.io/) ([repo](https://github.com/propensive/rapture)）-用于日常日常编程任务（I / O，JSON，i18n等）的库的集合
...
* **[Scalaz ★ 3045 ⧗ 0](https://github.com/scalaz/scalaz)**-用于功能编程的核心Scala库的扩展.
* [scribe ★ 36 ⧗ 3](https://github.com/outr/scribe) -实用的日志记录框架，它不依赖于任何其他日志记录框架，并且可以通过编程完全配置.
...
* [Eclair ★ 469](https://github.com/ACINQ/eclair)  -用Scala编写的ACINQ的Lightning Network实现.  闪电网络是建立在比特币之上的第二层协议，旨在解决可扩展性，隐私，确认时间和许多其他问题.
...
* [media4s ★ 5 ⧗ 3](https://github.com/outr/media4s) -围绕ffmpeg，ffprobe，ImageMagick和其他与媒体有关的工具的Scala命令行包装.
...
* [powerscala ★ 11 ⧗ 80](https://github.com/outr/powerscala) -强大的框架在Scala语言之上提供了许多有用的实用程序和功能.
...
* [Tubesocks ★ 12 ⧗ 174](https://github.com/softprops/tubesocks) - 图书馆支持与网页套接字服务器的双向通信.
...
* [Scowl ★ 16 ⧗ 36](https://github.com/phenoscape/scowl) -Scala DSL允许使用OWL API的声明性方法来构成OWL表达式和公理.
...
* [Metrics-Scala ★ 335](https://github.com/erikvanoosten/metrics-scala) - 斯卡拉API为Dropwizard的指标库.
...
* **[sbteclipse ★ 632 ⧗ 0](https://github.com/typesafehub/sbteclipse)**-从sbt构建创建Eclipse项目定义.
...
* [sbt-hepek ★ 5 ⧗ 0](https://github.com/sake92/sbt-hepek) -使用Scala代码制作静态网站（将“ object”渲染为文件！）.
* [splain ★ 234 ⧗ 0](https://github.com/tek/splain) -更好的Scala隐式错误.
...
* [xs4s ★ 29 ⧗ 47](https://github.com/ScalaWilliam/xs4s) -用于Scala的XML流，用于处理大型（千兆字节及以上）XML文件.
...
* [Scala Exercises](http://scala-exercises.47deg.com/)   - 将流行的斯卡拉Koans到网上.  提供数百种可解决的练习，这些练习分为42类，涵盖了Scala语言的基础.
...
* [Beard ★ 67 ⧗ 3](https://github.com/zalando/beard) - 通过胡须的启发轻巧logicless模板引擎
* [Scalatags ★ 492 ⧗ 3](https://github.com/lihaoyi/scalatags) -将HTML编写为scala代码，并让您的IDE语法对其进行检查.
...
* [rtree2d ★ 27 ⧗ 1](https://github.com/Sizmek/rtree2d) -  RTree2D是2D不可变的R-树与STR（排序瓦片递归）填料用于超快速最近和交叉点的查询上平面和球面
