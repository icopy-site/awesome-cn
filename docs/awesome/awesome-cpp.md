 ...
 * [PDCurses](https://github.com/wmcbrine/PDCurses)  -公共域curses库，提供源代码和预编译的库.  [公共区域]
...
* [Cpp-Taskflow](https://github.com/cpp-taskflow/cpp-taskflow)  -具有任务依赖性的快速C ++并行编程.  [麻省理工学院]
...
* [Grit](http://www.gritengine.com/)  -社区项目，以构建一个免费游戏引擎来实施开放世界3D游戏.  [麻省理工学院]
...
* [Ogre 3D](http://www.ogre3d.org/)  ：zap：-用C ++编写的面向场景的实时灵活3D渲染引擎（与游戏引擎相对）.  [麻省理工学院]
...
* [json](https://github.com/nlohmann/json)  ：zap：-JSON用于现代C ++.  [麻省理工学院]
...
* [ChakraCore](https://github.com/Microsoft/ChakraCore)  -Microsoft提供的JavaScript引擎，可以嵌入到nodejs中.  [麻省理工学院]
