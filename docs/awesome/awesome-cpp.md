...
* [Loki](http://loki-lib.sourceforge.net/)  -一个C ++设计库，其中包含常见设计模式和惯用语的灵活实现.  [麻省理工学院]
...
* [plf::stack](https://github.com/mattreecebentley/plf_stack) <i>- A replacement container for the std::stack container adaptor, with better performance than any std container in a stack context.</i> <b>-std :: stack容器适配器的替换容器，在堆栈上下文中比任何std容器都有更好的性能。</b> <i>[zLib]</i> <b>[zLib]</b> [website](http://www.plflib.org/stack.htm)
...
* [robin-map](https://github.com/Tessil/robin-map)  -使用罗宾汉哈希来实现快速哈希图和哈希集.  [麻省理工学院]
...
* [SQLite](http://www.sqlite.org/)  -完全嵌入的，功能全面的关系型数据库，只需几万个就可以直接包含到您的项目中.  [公共区域]
...
* [backward-cpp](https://github.com/bombela/backward-cpp)  -用于C ++的漂亮堆栈跟踪漂亮打印机.  [麻省理工学院]
...
* [doctest](https://github.com/onqtam/doctest)  -最轻便的功能丰富的C ++单头测试框架.  [麻省理工学院]
...
* [Grit](http://www.gritengine.com/)  -社区项目，以构建一个免费游戏引擎来实施开放世界3D游戏.  [麻省理工]
...
* [Magic Enum](https://github.com/Neargye/magic_enum)  -仅标头的C ++ 17库为枚举（到字符串，从字符串，迭代）提供枚举的静态反射，可与任何枚举类型一起使用，而无需任何宏或样板代码.  [麻省理工学院]
...
* [cppcodec](https://github.com/tplgy/cppcodec)  -仅标头的C ++ 11库，以一致，灵活的API编码/解码base64，base32和hex.  [麻省理工学院]
...
* [Kangaru](https://github.com/gracicot/kangaru)  -C ++ 11和C ++ 14的依赖项注入容器.  [麻省理工学院]
...
* [stdman](https://github.com/jeaye/stdman)  格式化的C ++ 11/14 stdlib手册页（来自cppreference）.  [麻省理工学院]
...
* [Conan](https://conan.io/)  -C / C ++程序包管理器，开源.  [麻省理工学院]
