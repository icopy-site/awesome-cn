...
* [nope.c](https://github.com/riolet/nope.c)   - 基于AC语言的超轻型软件平台，适用于可扩展的服务器端和网络应用.  想想C程序员的node.js.  [GPL2]
...
## Contributing
请参阅 [CONTRIBUTING](https://github.com/fffaraz/awesome-cpp/blob/master/CONTRIBUTING.md) 详情.
