...
* [C++ Standard Library](https://en.wikipedia.org/wiki/C%2B%2B_Standard_Library) - 类和函数的集合，它们以核心语言编写，是C ++ ISO标准本身的一部分.
...
* [APR](http://apr.apache.org/)   -  Apache Portable Runtime.  另一个跨平台实用程序函数库.  [Apache2的]
* [ASL](http://stlab.adobe.com/)   -  Adob​​e Source Libraries提供经过同行评审的可移植C ++源代码库.  [MIT]
* [Boost](https://github.com/boostorg)  ：zap： - 一大堆通用C ++库.  [促进] [website](http://www.boost.org/)
* [BDE](https://github.com/bloomberg/bde)   - 彭博实验室的BDE开发环境.  [Apache2的]
* [Cinder](https://libcinder.org/)   - 社区开发的免费开源图书馆，专业品质的创意编码.  [BSD]
* [Cxxomfort](http://ryan.gulix.cl/fossil.cgi/cxxomfort/)   - 一个小的，仅限标头的库，它将各种设施从最新的C ++标准向后移植到C ++ 03及更高版本.  [MIT]
* [Dlib](https://github.com/davisking/dlib)  ：zap： - 使用契约编程和现代C ++技术设计的通用跨平台C ++库.  [促进] [website](http://dlib.net/)
...
* [FunctionalPlus](https://github.com/Dobiasd/FunctionalPlus)   -  C ++函数式编程库.  编写简洁易读的C ++代码.  [MIT]
...
* [Veles](https://github.com/Samsung/veles)   - 用于快速深度学习应用程序开发的分布式平  [阿帕奇]
...
* [promise-cpp](https://github.com/xhawk18/promise-cpp)   - 仅实现Promise / A +标准的头文件库.  [防996]
* [uvw](https://github.com/skypjack/uvw)   - 用于libuv的C ++包装器.  [MH]

## Audio
*音频，声音，音乐，数字化语音库*

* [KFR](https://www.kfrlib.com/)   - 快速，现代的C ++ DSP框架，FFT，FIR / IIR滤波器，采样率转换.  [GPL /商业]
* [libsndfile](https://github.com/erikd/libsndfile/)   - 带有C ++包装器的C库，用于通过一个标准库接口读取和写入包含采样声音的文件.  [LGPL-2.1] [website](http://www.mega-nerd.com/libsndfile/)
...
* [Speex](http://www.speex.org/)   - 免费语音编解码器.  Opus废弃.  [BSD]
...
* [libtorrent](https://github.com/arvidn/libtorrent)  （又名libtorrent-rasterbar） - 一个有效的功能完整的C ++ bittorrent实现.  [BSD]
* [LibTorrent](https://github.com/rakshasa/libtorrent)  （又名libtorrent-rakshasa） -  BitTorrent库.  [GPL]
...
* [inih](https://github.com/benhoyt/inih)   -  C语言中的简单.INI文件解析器，适用于嵌入式系统.  [BSD -3-第]
* [inih](https://github.com/jtilly/inih) - 单头只有C ++版本 [inih](https://github.com/benhoyt/inih) .  [BSD -3-第]
* [iniparser](https://github.com/ndevilla/iniparser)   - 这个解析器文件.  [MIT]
* [libconfig](https://github.com/hyperrealm/libconfig)   - 用于处理结构化配置文件的C，C ++库.  [LGPL-2.1] [website](https://hyperrealm.github.io/libconfig/)
* [libconfuse](https://github.com/martinh/libconfuse) -  C的小配置文件解析器库.[ISC]
* [simpleini](https://github.com/brofield/simpleini)   - 跨平台C ++库，提供读取和写入INI样式配置文件的简单API.  [MIT]
...
* [upscaledb](https://upscaledb.com)   - 具有内置查询接口的嵌入式“类型”键/值存储.  [GPLv3的]

## Debug
*调试库，内存泄漏和资源泄漏检测，单元测试*

* [backward-cpp](https://github.com/bombela/backward-cpp)   - 适用于C ++的漂亮堆栈跟踪漂亮打印机.  [MIT]
* [benchmark](https://github.com/google/benchmark)   - 谷歌提供小型微基准支持库.  [Apache2的]
* [Boost.Test](http://www.boost.org/doc/libs/master/libs/test/doc/html/index.html)   -  Boost测试库.  [促进]
* [check](https://github.com/libcheck/check) -  Check是C的单元测试框架.[LGPL-2.1] [website](https://libcheck.github.io/check/)
* [doctest](https://github.com/onqtam/doctest)   - 最轻的功能丰富的C ++单头测试框架.  [MIT]
* [Catch](https://github.com/philsquared/Catch)   - 用于单元测试，TDD和BDD的现代C ++原生，仅限标头的框架.  [促进]
* [Catch2](https://github.com/catchorg/Catch2)   - 用于单元测试，TDD和BDD的现代C ++原生，仅限标头的测试框架.  [BSL-1.0]
...
* [Allegro](http://liballeg.org/)   - 一个跨平台的图书馆，主要针对视频游戏和多媒体节目.  [ZLIB]
...
* [toy engine](https://github.com/hugoam/toy) - 玩具是一种简单的模块化c ++游戏引擎，提供简单的表达式c ++习语，可以快速迭代设计全功能的2D或3D游戏.
...
* [QwtPlot3D](http://qwtplot3d.sourceforge.net/)   - 一个功能丰富的基于Qt / OpenGL的C ++编程库，基本上提供了一堆3D小部件.  [ZLIB]
* [Sciter](http://sciter.com/)   -  Sciter是一个可嵌入的HTML / CSS /脚本引擎，旨在用作现代桌面应用程序的UI层.  [免费/商业]
* [wxWidgets](http://wxwidgets.org/)   - 一个C ++库，允许开发人员使用单一代码库为Windows，Mac OS X，Linux和其他平台创建应用程序.  [自己的LGPL]
...
* [LLGL](https://github.com/LukasBanana/LLGL)   - 低级图形库（LLGL）是现代图形API的精简抽象层.  [BSD -3-第]
...
* [Leptonica](https://github.com/DanBloomberg/leptonica)   -  Leptonica是一个开源库，包含对图像处理和图像分析应用程序广泛使用的软件.  [BSD-2-第] [website](http://leptonica.org/index.html)
...
* [cJSON](https://github.com/DaveGamble/cJSON) -  ANSI C中的超轻量级JSON解析器.[MIT]
* [frozen](https://github.com/cesanta/frozen)   - 用于C / C ++的JSON解析器和生成器.  [GPL和GPL2]
* [Jansson](https://github.com/akheron/jansson)   - 用于编码，解码和操作JSON数据的C库.  [MIT]
...
* [Boost.Multiprecision](http://www.boost.org/doc/libs/master/libs/multiprecision/doc/html/index.html)   - 在C ++，仅头文件或GMP / MPFR / LibTomMath后端中提供更高范围/精度的整数，有理和浮点类型.  [促进]
...
* [tgc](https://github.com/orangeduck/tgc)   - 用于写入\ ~500 LOC的C的微小垃圾收集器.  [BSD]
...
* [Restinio](https://github.com/Stiffstream/restinio)   - 仅限标头的C ++ 14库，为您提供嵌入式HTTP / Websocket服务器.  [BSD]
...
* [cpp-netlib/uri](https://github.com/cpp-netlib/uri) - 用于C ++的URI解析器/构建器库，与RFC 3986和RFC 3987兼容.[BSL-1.0]
...
* [DPDK](https://github.com/DPDK/dpdk)   - 数据平面开发套件，用于快速数据包处理的库和驱​​动程序.  [BSD-3-Clause＆GPL-2.0] [website](https://www.dpdk.org/)
...
* [Seasocks](https://github.com/mattgodbolt/seasocks)   - 支持WebSockets的简单，小型，C ++可嵌入Web服务器.  [BSD]
* [Silicon](http://siliconframework.org)   - 一个高性能，面向中间件的C ++ 14 http Web框架.  [MIT]
* [Tufão](https://github.com/vinipsmaker/tufao)   - 基于Qt构建的C ++异步Web框架.  [LGPL2]
* [uriparser](https://github.com/uriparser/uriparser)   - 严格遵循RFC 3986的URI解析和处理库.  [BSD -3-第]
* [uWebSockets](https://github.com/uNetworking/uWebSockets)   - μWS是可用的最轻量，高效和可扩展的WebSocket和HTTP服务器实现之一.  [zlib的]
...
* [magic_get](https://github.com/apolukhin/magic_get)   -  std :: tuple like用户定义类型的方法，没有任何宏或样板代码.  [促进]
...
* [djinni](https://github.com/dropbox/djinni)   - 用于生成跨语言类型声明和接口绑定的工具.  [Apache2的]
* [Duktape](https://github.com/svaarala/duktape)   - 嵌入式占用空间的嵌入式Javascript引擎.  [MIT] [website](http://duktape.org)
* [JavaCpp](https://github.com/bytedeco/javacpp)   -  Java和本机C ++之间缺失的桥梁.  [Apache2的]
...
* [SWIG](https://github.com/swig/swig)   - 一个包装器/接口生成器，可以将c ++代码链接到Javascript，Perl，PHP，Python，Tcl和Ruby.  [GPL /输出未获许可] [website](http://www.swig.org/)
* [V7](https://github.com/cesanta/v7)   - 嵌入式JavaScript引擎.  [GPL2]
* [V8](https://v8.dev)   -  Google提供的快速JavaScript引擎，可嵌入任何C ++应用程序中.  [BSD]
* [ChakraCore](https://github.com/Microsoft/ChakraCore)   -  Microsoft的JavaScript引擎，可以嵌入到nodejs中.  [MIT]
...
* [Civetweb](https://github.com/civetweb/civetweb)   - 提供易于使用，功能强大的C / C ++嵌入式Web服务器，支持可选的CGI，SSL和Lua.  [MIT]
...
* [YouCompleteMe](https://github.com/ycm-core/YouCompleteMe) -  YouCompleteMe是Vim的快速，类型，模糊搜索代码完成引擎.
...
* [Premake](http://premake.github.io) - 配置了Lua脚本的工具，可以在Windows，Mac OS X和Linux上为Visual Studio，GNU Make，Xcode，Code :: Blocks等生成项目文件.
* [Vcpkg](https://github.com/microsoft/vcpkg)   - 适用于Windows，Linux和MacOS的C ++库管理器.  [MIT]
...
* [C++ Dos and Don'ts](http://www.chromium.org/developers/coding-style/cpp-dos-and-donts) -  Chromium项目&gt;面向开发人员&gt;编码风格&gt; C ++ Dos and Don&#39;ts.
...
* [CppChat](http://cpp.chat) - 每周（有时）看一下C ++世界中与社区客人聊天的情况.
...
* [C++ Awesome Pack](https://github.com/juniandotnet/cpp-awesome-pack) - 包含一些很棒的c ++代码，包含在一个代码中.
...
* [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) - 精彩绝伦的精选列表.
* [awesome](https://github.com/sindresorhus/awesome) ：zap： - 精选列表的精选列表.
* [C++ links](https://github.com/MattPD/cpplinks) -  C ++资源的分类列表.
* [Awesome C++](https://getawesomeness.herokuapp.com/get/cpp) -  getAwesomeness（）的镜子.
