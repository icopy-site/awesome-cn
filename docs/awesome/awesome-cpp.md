...
* [Cxxomfort](http://ryan.gulix.cl/fossil.cgi/cxxomfort/)  -一个小的，仅标头的库，它将各种功能从最新的C ++标准向后移植到C ++ 03及更高版本.  [麻省理工学院]
...
* [SWIG](https://github.com/swig/swig)  -包装器/接口生成器，可让您将c ++代码链接到Javascript，Perl，PHP，Python，Tcl和Ruby.  [GPL /输出未获得许可] [website](http://www.swig.org/)
...
* [MessagePack](https://github.com/msgpack/msgpack-c)  -C和C ++的高效二进制序列化格式“如JSON”.  [Apache2] [website](http://msgpack.org/)
...
## XML
 * XML是废话.  真.  没有任何借口.  XML对于人类来说很讨厌解析，即使对于计算机也无法解析.  那个可怕的废话根本没有理由存在.  -Linus Torvalds *
...
* [mio](https://github.com/mandreyel/mio)  -用于内存映射文件IO的跨平台C ++ 11纯标题库.  [麻省理工学院]
...
* [Try It Online](https://tio.run/) -TIO是一系列在线口译员，可提供越来越多的实用和休闲编程语言.
...
* [C++ Hints](http://cpphints.com/) -每个工作日都会提示PVS-Studio团队最常出现的C ++错误以及解决方法.
...
* [awesome-algorithms](https://github.com/tayllan/awesome-algorithms) -精选的很棒的学习和/或练习算法的地方列表.
