...
* [Boost](https://github.com/boostorg)  :zap: - 大量通用 C++ 库.  [促进] [website](https://www.boost.org)
...
* [Dlib](https://github.com/davisking/dlib)  :zap: - 一个用于在 C++ 中制作真实世界机器学习和数据分析应用程序的工具包.  [促进] [website](http://dlib.net/)
 ...
 * [Clara](https://github.com/catchorg/Clara)  - 一个简单易用、可组合的命令行解析器，适用于 C++ 11 及更高版本.  [促进]
...
* [bzip2](http://www.bzip.org/)  - 免费、无专利、高质量的数据压缩器.  [BSD]
...
* [Boost.Compute](https://github.com/boostorg/compute)  - 用于 OpenCL 的 C++ GPU 计算库.  [促进] [website](https://boost.org/libs/compute)
...
* [Quantum](https://github.com/bloomberg/quantum) - 一个强大的 C++ 协程调度程序框架，构建在 [Boost.Coroutine2](https://boost.org/libs/coroutine2).
* [RaftLib](http://raftlib.io/)  - RaftLib C++ 库，通过 C++ iostream 类运算符实现流/数据流并发.  [阿帕奇2]
...
* [ini-cpp](https://github.com/SSARCandy/ini-cpp) - 单头 C++ 版本，带有一些方便的读/写接口，扩展自 [inih](https://github.com/benhoyt/inih) .  [BSD-3-条款] [website](https://ssarcandy.tw/ini-cpp/index.html)
...
* [Kvrocks](https://github.com/apache/incubator-kvrocks)  - 一个分布式键值NoSQL数据库，使用RocksDB作为存储引擎，兼容Redis协议.  [阿帕奇2]
...
* [LMDB](https://www.symas.com/lmdb)  - 具有完整 ACID 语义的非常快速的嵌入式键/值存储.  [OpenLDAP]
...
* [μt](https://github.com/boost-experimental/ut)  - C++20 单头/单模块，无宏 μ(micro)/单元测试框架.  [促进]
...
* [Natural Docs](https://github.com/NaturalDocs/NaturalDocs)  - Natural Docs 是一种用于多种编程语言的开源文档生成器.  [AGPL/商业] [website](https://www.naturaldocs.org)
...
* [FreeType](https://www.freetype.org/)  - FreeType 是一个免费提供的字体渲染软件库.  [FTL 和 GPLv2]
...
* [Torque2D](https://github.com/TorqueGameEngines/Torque2D)  - 为 2D 游戏开发而构建的开源跨平台 C++ 引擎.  [麻省理工学院] [website](https://torque3d.org/torque2d)
* [Torque3D](https://github.com/TorqueGameEngines/Torque3D)  - 为 3D 游戏开发构建的开源 C++ 引擎.  [麻省理工学院] [website](https://torque3d.org/torque3d)
...
* [MyGUI](https://github.com/MyGUI/mygui)  - 快速、灵活和简单的 GUI.  [麻省理工学院]
...
* [GLFWPP](https://github.com/janekb04/glfwpp)  - 用于 GLFW 的精简的现代 C++17 标头包装器.  [麻省理工学院]
...
* [Ogre 3D](https://github.com/OGRECave)  :zap: - 用 C++ 编写的面向场景的、实时的、灵活的 3D 渲染引擎（与游戏引擎相对）.  [麻省理工学院] [website](https://www.ogre3d.org)
...
* [Partio](https://github.com/wdas/partio)  - 处理粒子数据的库，支持最常见的文件格式.  [修改后的 BSD]
...
* [BitmapPlusPLus](https://github.com/baderouaich/BitmapPlusPlus)  - 简单快速的标头仅位图 C++ 库.  [麻省理工学院]
...
* [uni-algo](https://github.com/uni-algo/uni-algo)  - C/C++ 的 Unicode 算法实现.  [未授权或 MIT]
...
* [Boost.Interprocess](https://github.com/boostorg/interprocess)  - 仅标头的 Boost 库支持内核级共享内存和内存映射文件，具有内置同步机制（信号量、互斥量等）.  [促进] [website](https://boost.org/libs/interprocess)
...
* [Boost.PropertyTree](https://github.com/boostorg/property_tree)  - 可用于解析 XML/JSON/INI/Info 文件的属性树解析器/生成器.  [促进] [website](https://boost.org/libs/property_tree)
...
* [json](https://github.com/nlohmann/json)  :zap: - 用于现代 C++ 的 JSON.  [麻省理工学院] [website](https://json.nlohmann.me)
...
* [jsonParse](https://github.com/liufeigit/jsonParse) - ANSI C 中的一个简单的 JSON 解析器. [MIT]
...
* [RapidJSON](https://github.com/miloyip/rapidjson)  :zap: - 用于 C++ 的快速 JSON 解析器/生成器，具有 SAX/DOM 样式 API.  [麻省理工学院] [website](https://rapidjson.org)
...
* [UltraJSON](https://github.com/ultrajson/ultrajson) - 用 C 编写的超快速 JSON 解码器和编码器. [BSD-3-Clause]
...
* [Boost.Log](https://github.com/boostorg/log)  - 设计为非常模块化和可扩展的.  [促进] [website](https://boost.org/libs/log)
...
* [Boost.Multiprecision](https://github.com/boostorg/multiprecision)  - 在 C++ 中提供更高范围/精度的整数、有理数和浮点类型，仅标头或 GMP/MPFR/LibTomMath 后端.  [促进] [website](https://boost.org/libs/multiprecision)
...
* [MatX](https://github.com/NVIDIA/MatX)  - 一个 GPU 加速的 C++17 数值计算库，具有类似 MATLAB/Python 的语法.  [BSD 3 子句]
...
* [Boost.Beast](https://github.com/boostorg/beast)  :zap: - HTTP 和 WebSocket 在 C ++ 11 中基于 Boost.Asio 构建.  [促进] [website](https://www.boost.org/libs/beast)
...
* [TSMP](https://github.com/fabian-jung/tsmp)  - 用于静态反射的无入侵和无宏的 C++20 库. 它使用 libclang 从您的源代码中提取反射数据，并通过模板专业化使其可用.  [麻省理工学院]
* [visit_struct](https://github.com/cbeck88/visit_struct)  - 用于 C++ 中结构域反射的微型库.  [促进]
...
* [PCL](https://github.com/PointCloudLibrary/pcl)  - Point Cloud Library 是一个独立的、大规模的、开放的 2D/3D 图像和点云处理项目.  [BSD] [website](http://www.pointclouds.org/)
...
* [Boost.Python](https://github.com/boostorg/python)  - 一个 C++ 库，可实现 C++ 和 Python 编程语言之间的无缝互操作性.  [促进] [website](https://boost.org/libs/python)
...
* [pocketpy](https://github.com/blueloveTH/pocketpy)  - 用于游戏脚本的 C++17 头文件 Python 解释器.  [麻省理工学院] [website](https://pocketpy.dev/)
...
* [Boost.Serialization](https://github.com/boostorg/serialization)  - 提升序列化库.  [促进] [website](https://boost.org/libs/serialization)
* [Cap'n Proto](https://github.com/capnproto/capnproto)  - 快速数据交换格式和基于能力的 RPC 系统.  [麻省理工学院] [website](https://capnproto.org/)
...
* [Kaitai Struct](http://kaitai.io)  - 描述各种二进制数据结构的声明性语言和生成 C++ 解析器代码的编译器.  [GPLv3+][麻省理工学院][Apache2]
...
* [Boost.Signals2](https://github.com/boostorg/signals2)  - 托管信号和插槽系统的实现.  [促进] [website](https://boost.org/libs/signals2)
* [Cheat Sheets of HackingCPP](https://hackingcpp.com/cpp/cheat_sheets.html) - 用于算法、视图、容器、随机性等的酷备忘单和信息图表.
...
* [{fmt}](https://github.com/fmtlib/fmt)  :zap: - 用于 C++ 的小型、安全和快速的格式化库.  [简化的 BSD] [website](https://fmt.dev)
* [FastFormat](http://www.fastformat.org)  - 受 log4j 和 Pantheios 启发的快速、安全的 C++ 格式化.  [简化的 BSD]
...
* [stdman](https://github.com/jeaye/stdman) - 一个解析归档 HTML 文件的工具 [cppreference](https://cppreference.com) 并为基于 Unix 的系统生成 groff 格式的手册页.  [麻省理工学院]
...
* [Programiz](https://www.programiz.com/cpp-programming/online-compiler) - 面向学习者和开发者的在线编译器.
...
* [Microsoft Visual Studio Code](https://github.com/microsoft/vscode)  :zap: - 来自 Microsoft 的开源 IDE.  [麻省理工学院] [website](https://code.visualstudio.com)
* [NetBeans](https://netbeans.org/) - 一个主要使用 Java 进行开发的 IDE，但也可以使用其他语言进行开发，尤其是 PHP、C/C++ 和 HTML5.
* [Qt Creator](https://github.com/qt-creator/qt-creator)  :zap: - 一个跨平台的 C++、JavaScript 和 QML IDE，它是 Qt SDK 的一部分.  [GPL3 有例外] [website](https://www.qt.io/product/development-tools)
...
* [waf](https://gitlab.com/ita1024/waf)  - 基于 Python 的框架，用于配置、编译和安装应用程序.  [BSD] [website](https://waf.io/)
...
* [C++ reference](https://cppreference.com) - C 和 C++ 语言和标准库的完整在线参考.
...
* [PVS-Studio’s challenge](https://quiz.pvs-studio.com) - PVS-Studio 的 C++ 测验，要求您在开源项目的代码片段中查找错误.
...
* [cppexpert.online](https://cppexpert.online) - 通过改进有问题或不良做法的代码片段来学习最佳 C++ 实践.
...
## Contributing
Please take a quick gander at the [contribution guidelines](https://github.com/fffaraz/awesome-cpp/blob/master/CONTRIBUTING.md) 了解详情.
