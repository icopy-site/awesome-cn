...
* [C POSIX library](https://en.wikipedia.org/wiki/C_POSIX_library) -POSIX系统的C标准库的规范.
...
* [APR](http://apr.apache.org/)  -Apache可移植运行时.  另一个跨平台实用程序函数库.  [Apache2的]
* [ASL](http://stlab.adobe.com/)  -Adobe Source Libraries提供了经过同行评审的可移植C ++源库.  [MIT]
* [Boost](https://github.com/boostorg)  ：zap：-大量的通用C ++库.  [促进] [website](http://www.boost.org/)
* [BDE](https://github.com/bloomberg/bde)  -彭博实验室的BDE开发环境.  [Apache2的]
* [Cinder](https://libcinder.org/)  -社区开发的免费开放源代码库，用于提供专业质量的创意编码.  [BSD]
* [Cxxomfort](http://ryan.gulix.cl/fossil.cgi/cxxomfort/)  -一个小型的仅标头的库，它将各种功能从最新的C ++标准向后移植到C ++ 03及更高版本.  [MIT]
...
* [ETL](https://github.com/ETLCPP/etl)  -嵌入式模板库.  [MIT]
* [ffead-cpp](https://github.com/sumeetchhetri/ffead-cpp)  -企业应用程序开发框架.  [Apache2的]
* [Folly](https://github.com/facebook/folly)  -在Facebook开发和使用的开源C ++库.  [Apache2的]
* [FunctionalPlus](https://github.com/Dobiasd/FunctionalPlus)  -C ++的功能编程库.  编写简洁易读的C ++代码.  [MIT]
...
* [Loki](http://loki-lib.sourceforge.net/)  -一个C ++设计库，其中包含常见设计模式和惯用语的灵活实现.  [MIT]
...
* [tbox](https://github.com/tboox/tbox)  -类似于glib的多平台c库.  [Apache2的] [website](http://tboox.org/)
...
* [Yomm2](https://github.com/jll63/yomm2)  -快速，正交，开放式多种方法.  取代版本 [Yomm11](https://github.com/jll63/yomm11) [促进]
...
* [frugally-deep](https://github.com/Dobiasd/frugally-deep)  -仅标题的库，用于在C ++中使用Keras模型.  [MIT]
...
* [libev](http://libev.schmorp.de/)  -一个功能齐全的高性能事件循环，在libevent之后进行松散建模，但没有限制和错误.  [BSD和GPL]
* [libevent](http://libevent.org/)  -事件通知库.  [BSD]
* [libuv](https://github.com/libuv/libuv)  -跨平台异步I / O.  [BSD]
* [promise-cpp](https://github.com/xhawk18/promise-cpp)  -实现Promise / A +标准的仅标头库.  [防996]
...
* [libsoundio](https://github.com/andrewrk/libsoundio)  -用于跨平台实时音频输入和输出的C库.  [MIT] [website](http://libsound.io/)
...
* [PortAudio](http://www.portaudio.com/)  -PortAudio是一个免费的，跨平台的开源音频I / O库.  [MIT]
* [SELA](https://github.com/sahaRatul/sela)  -简单的无损音频.  [MIT]
* [SoLoud](https://github.com/jarikomppa/soloud)  -简单，便携式的游戏音频引擎.  [ZLIB]
* [Speex](http://www.speex.org/)  -用于言论自由的免费编解码器.  被Opus淘汰.  [BSD]
* [Tonic](https://github.com/TonicAudio/Tonic)  -在C ++中轻松高效地进行音频合成.  [授予许可]
...
* [Vcflib](https://github.com/ekg/vcflib)  -一个C ++库，用于解析和处理VCF文件.  [MIT]
* [Wham](https://github.com/zeeev/wham)  -通过直接将关联测试应用于BAM文件，实现基因组中的结构变异（SV）.  [MIT]
...
* [libutp](https://github.com/bittorrent/libutp)  -uTorrent传输协议库.  [MIT]

## CLI
*控制台/终端用户界面，命令行界面*

 * [Argh!](https://github.com/adishavit/argh)  -极简，无挫折，仅标头的参数处理程序.  [BSD]
 * [Taywee/args](https://github.com/taywee/args)  -一个简单的仅标头C ++参数解析器库.  [MIT]
 * [Boost.Program_options](http://www.boost.org/doc/libs/1_57_0/doc/html/program_options.html)  -通过常规方法（例如命令行和配置文件）获取程序选项的库.  [促进]
 ...
 * [docopt.cpp](https://github.com/docopt/docopt.cpp)  -从文档字符串生成选项解析器的库.  [MIT /升压]
 * [gflags](https://gflags.github.io/gflags/)  -C ++的命令行标志模块.  [BSD]
 * [linenoise](https://github.com/antirez/linenoise)  -替代readline和libedit的小型独立设备.  [BSD-2-第]
 ...
 * [PDCurses](https://github.com/wmcbrine/PDCurses)  -公共领域的curses库，提供源代码和预编译的库.  [公共区域]
 * [replxx](https://github.com/AmokHuginnsson/replxx)  -支持UTF-8，语法高亮显示，提示的readline和libedit替换，可在Unix和Windows上使用.  [BSD]
...
* [bit7z](https://github.com/rikyoz/bit7z)  -一个C ++静态库，为7-zip DLL提供一个简洁的接口.  [GPL第二]
* [Brotli](https://github.com/google/brotli)  -Brotli压缩格式.  由Google开发.  [MIT]
* [bzip2](http://www.bzip.org/)  -免费提供，无专利的高质量数据压缩器.  [BSD]
...
* [KArchive](https://quickgit.kde.org/?p=karchive.git)  -一个用于创建，读取，编写和处理zip和tar等文件档案的库.  它还通过QIODevice的子类使用gzip之类的格式提供透明的数据压缩和解压缩.  [LGPL]
...
* [miniz](https://github.com/richgel999/miniz)  -具有Zlib兼容API，ZIP存档读取/写入，PNG写入的单个C源文件Deflate / Inflate压缩库.  [MIT]
...
* [Async++](https://github.com/Amanieu/asyncplusplus)  -受Microsoft PPL库和N3428 C ++标准建议启发的C ++ 11轻量级并发框架.  [MIT]
...
* [concurrentqueue](https://github.com/cameron314/concurrentqueue)  -用于C ++ 11的快速多生产者，多消费者，无锁定并发队列.  [BSD，提升]
...
* [Intel Games Task Scheduler](https://github.com/GameTechDev/GTS-GamesTaskScheduler)  -专为游戏开发人员需求而设计的任务计划框架.  [MIT]
* [Intel Parallel STL](https://github.com/intel/parallelstl)  -C ++ 11及更高版本的C ++ 17 STL的英特尔®实现.  [Apache2的]
...
* [Libclsph](https://github.com/libclsph/libclsph)  -基于OpenCL的GPU加速的SPH流体模拟库.  [MIT]
...
* [libmill](https://github.com/sustrik/libmill/) -在C.中引入Go风格的并发.
...
* [Thrust](http://thrust.github.io/)  -类似于C ++标准模板库（STL）的并行算法库.  [Apache2的]
...
* [VexCL](https://github.com/ddemidov/vexcl)  -用于OpenCL / CUDA的C ++向量表达模板库.  [MIT]
...
* [inih](https://github.com/benhoyt/inih)  -用C语言编写的简单.INI文件解析器，非常适合嵌入式系统.  [BSD -3-第]
* [inih](https://github.com/jtilly/inih) -仅单头C ++版本 [inih](https://github.com/benhoyt/inih) .  [BSD -3-第]
* [iniparser](https://github.com/ndevilla/iniparser)  -此解析器文件.  [MIT]
...
* [simpleini](https://github.com/brofield/simpleini)  -跨平台的C ++库，提供简单的API来读取和写入INI样式的配置文件.  [MIT]

## Containers

* [C++ B-tree](https://code.google.com/p/cpp-btree/)  -模板库，基于B树数据结构实现有序的内存中容器.  [Apache2的]
...
* [dynamic_bitset](https://github.com/pinam45/dynamic_bitset)  -C ++ 17仅限标头的动态位集.  [MIT]
* [Forest](https://github.com/xorz57/forest)  -实现AVL，二进制搜索，KD和四叉树的模板库.  [MIT]
* [Hashmaps](https://github.com/goossaert/hashmap)  -在C ++中实现开放式地址哈希表算法.  [MIT]
* [Hopscotch map](https://github.com/Tessil/hopscotch-map)  -快速的仅标头哈希映射，它使用跳房子哈希来解决冲突.  [MIT]
...
* [ring_span lite](https://github.com/martinmoene/ring-span-lite)  -Arthur O&#39;Dwyer的ring_span实现的简化实现.  循环缓冲区视图.  [MIT]
* [robin-hood-hashing](https://github.com/martinus/robin-hood-hashing)  -基于C ++ 14的基于Robin Hood哈希的快速且内存高效的哈希表.  [MIT]
* [robin-map](https://github.com/Tessil/robin-map)  -使用罗宾汉哈希来实现快速哈希图和哈希集.  [MIT]
...
* [GnuPG](https://www.gnupg.org/)  -完全免费的OpenPGP标准实施.  [GPL]
...
* [libsodium](https://github.com/jedisct1/libsodium)  -基于NaCl的P（或可购买的）加密库，自以为是且易于使用.  [ISC]
...
* [retter](https://github.com/MaciejCzyzewski/retter) -散列函数，密码，工具，库和与密码学有关的材料的集合.
* [s2n](https://github.com/awslabs/s2n)  -TLS / SSL协议的实现.  [阿帕奇]
* [sha1collisiondetection](https://github.com/cr-marcstevens/sha1collisiondetection)  -用于检测文件中SHA-1冲突的库和命令行工具.  [MIT]
...
* [Themis](https://github.com/cossacklabs/themis)  -用于移动和服务器平台的无痛数据安全加密库，提供对称和非对称加密，具有前向保密性的安全套接字.  [Apache2的]

## CSV
*用于解析逗号分隔值（CSV）文件的库*

* [csv](https://github.com/p-ranav/csv)  -CSV用于现代C ++.  [MIT]
* [Fast C++ CSV Parser](https://github.com/ben-strasser/fast-cpp-csv-parser)  -小型，易于使用且快速的仅标头库，用于读取CSV文件.  [BSD -3-第]
* [Vince's CSV Parser](https://github.com/vincentlaucsb/csv-parser)  -快速，自包含的，流式C ++ 17 CSV解析器，具有可选的类型转换和统计信息.  [MIT]
...
* [nanodbc](https://github.com/nanodbc/nanodbc)  -用于本机C ODBC API的小型C ++包装器.  [MIT]
* [ODB](https://www.codesynthesis.com/products/odb/)  -用于C ++的开源，跨平台和跨数据库对象关系映射（ORM）系统.  [GPL第二]
* [redis3m](https://github.com/luca3m/redis3m)  -带有清晰C ++接口的hiredis包装器，支持哨兵并准备使用模式.  [Apache2的]
...
* [SQLite](http://www.sqlite.org/)  -完全嵌入的，功能全面的关系型数据库（只需几万个）就可以直接包含到您的项目中.  [公共区域]
* [SQLiteC++](https://github.com/SRombauts/SQLiteCpp)  -SQLiteC ++（SQLiteCpp）是一个聪明且易于使用的C ++ SQLite3包装器.  [MIT]
* [sqlite_modern_cpp](https://github.com/SqliteModernCpp/sqlite_modern_cpp)  -围绕sqlite库的仅标头C ++ 14包装器.  [MIT]
* [sqlite_orm](https://github.com/fnc12/sqlite_orm)  -适用于现代C ++的SQLite ORM light header only库.  [BSD -3-第]
* [sqlpp11](https://github.com/rbock/sqlpp11)  -一种用于SQL查询和C ++结果的类型安全的嵌入式域特定语言.  [BSD-2-第]
* [TileDB](https://github.com/TileDB-Inc/TileDB)  -快速密集和稀疏多维阵列DBMS.  [MIT] [website](https://tiledb.io/)
* [upscaledb](https://upscaledb.com)  -具有内置查询界面的嵌入式“类型化”键/值存储.  [GPLv3的]

## Debug
*调试库，内存泄漏和资源泄漏检测，单元测试*

* [backward-cpp](https://github.com/bombela/backward-cpp) - A beautiful stack trace pretty printer for C++. [MIT]
* [benchmark](https://github.com/google/benchmark)  -Google提供了小型的微基准支持库.  [Apache2的]
...
* [doctest](https://github.com/onqtam/doctest)  -最轻便的功能丰富的C ++单头测试框架.  [MIT]
...
* [Celero](https://github.com/DigitalInBlue/Celero)  -C ++基准测试框架.  [Apache2的]
* [CppUTest](https://github.com/cpputest/cpputest)  -C / C ++的单元测试和模拟框架.  [BSD -3-子句]
* [CUTE](http://cute-test.com)  -C ++单元测试更容易.  [LGPL3]
* [CMocka](https://cmocka.org/)  -支持模拟对象的C单元测试框架.  [Apache2的]
...
* [dbg-macro](https://github.com/sharkdp/dbg-macro)  -C ++的dbg（…）宏.  [MIT]
* [Deleaker](http://www.deleaker.com) -用于资源泄漏检测的工具，包括内存，GDI和处理泄漏.
* [fff](https://github.com/meekrosoft/fff)  -用于创建伪C函数的微框架.  [MIT]
...
* [MinUnit](https://github.com/siu/minunit)  -用于C的最小单元测试框架，包含在单个头文件中.  [MIT]
...
* [Remotery](https://github.com/Celtoys/Remotery)  -带有Web Viewer的单个C文件分析器.  [Apache2的]
...
* [otfcc](https://github.com/caryll/otfcc)  -用于解析和写入OpenType字体文件的AC库和实用程序.  [Apache的2.0]
...
* [GamePlay](https://github.com/gameplay3d/GamePlay)  -跨平台的本机C ++游戏框架，用于创建2D / 3D移动和桌面游戏.  [Apache2的]
* [Godot](https://github.com/godotengine/godot)  -MIT许可的功能齐全的开源游戏引擎.  [MIT]
* [Grit](http://www.gritengine.com/)  -社区项目，以构建一个免费游戏引擎来实施开放世界3D游戏.  [MIT]
* [Halley](https://github.com/amzeratul/halley)  -用C ++ 14编写的轻量级游戏引擎，带有“真实的”实体组件系统.  [Apache 2.0]
* [KlayGE](https://github.com/gongminmin/KlayGE)  -具有基于插件的体系结构的跨平台开源游戏引擎.  [GPL第二] [website](http://www.klayge.org/)
* [OpenXRay](https://github.com/OpenXRay/xray-16)  -STALKER游戏系列中使用的社区修改X射线引擎.  [修改后的BSD /非商业用途]
...
* [Polycode](https://github.com/ivansafrin/Polycode)  -用于C ++中的创意代码的跨平台框架（带有Lua绑定）.  [MIT] [website](http://polycode.org/)
* [raylib](https://github.com/raysan5/raylib)  -一个简单易用的库，可享受电子游戏编程的乐趣.  [ZLIB /的libpng] [website](http://www.raylib.com/)
* [Spring](https://github.com/spring/spring)  -强大的免费跨平台RTS游戏引擎.  [在GPLv2 / GPLv3的] [website](https://springrts.com/)
...
* [toy engine](https://github.com/hugoam/toy) -玩具是一个瘦小的模块化c ++游戏引擎，并提供简单的表达性c ++惯用法来快速迭代设计功能齐全的2D或3D游戏.
* [Urho3D](https://urho3d.github.io/)  -用C ++实现的免费轻量级，跨平台2D和3D游戏引擎.  受到OGRE和Horde3D的极大启发.  [MIT]
...
* [QCustomPlot](http://qcustomplot.com/)  -Qt绘图小部件，无需进一步依赖.  [GPLv3的]
...
* [assimp](https://github.com/assimp/assimp)  -开放资产导入库（assimp）是跨平台的3D模型导入库，旨在为不同的3D资产文件格式提供通用的API.  [BSD -3-第] [website](http://www.assimp.org)
* [bgfx](https://github.com/bkaradzic/bgfx)  -跨平台渲染库.  [BSD]
* [Blend2D](https://github.com/blend2d/blend2d)  -由JIT编译器提供支持的2D矢量图形引擎.  [zlib的] [website](https://blend2d.com/)
* [bs::framework](https://github.com/GameFoundry/bsf)  -用于实时图形应用程序开发的现代C ++ 14库.  [MIT]
* [Cairo](http://www.cairographics.org/)  -支持多个输出设备的2D图形库.  [LGPL2或Mozilla MPL]
* [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine)  -现代的跨平台低级3D图形库.  [Apache2的]
* [DirectXTK](https://github.com/Microsoft/DirectXTK)  -一组用于用C ++编写DirectX 11.x代码的帮助程序类.  [MIT]
...
* [Ion](https://github.com/google/ion)  -小型高效的库集，用于构建使用3D图形的跨平台客户端或服务器应用程序.  [Apache2的] [website](https://google.github.io/ion/)
* [Irrlicht](http://irrlicht.sourceforge.net/)  -用C ++编写的高性能实时3D引擎.  [ZLIB]
* [libigl](https://github.com/libigl/libigl)  -简单的C ++几何处理库.  [MPL2]
* [LLGL](https://github.com/LukasBanana/LLGL)  -低级图形库（LLGL）是现代图形API的薄抽象层.  [BSD -3-第]
* [magnum](https://github.com/mosra/magnum)  -用于游戏和数据可视化的轻量级模块化C ++ 11 / C ++ 14图形中间件.  [MIT] [website](http://magnum.graphics)
* [NanoVG](https://github.com/memononen/nanovg)  -OpenGL上的抗锯齿2D矢量绘图库，用于UI和可视化.  [zlib的]
* [Ogre 3D](http://www.ogre3d.org/)  ：zap：-用C ++编写的面向场景的实时灵活3D渲染引擎（与游戏引擎相对）.  [MIT]
...
* [TinySpline](https://github.com/msteinbeck/tinyspline)  -一个小型但功能强大的ANSI C库，用于插值，转换和查询任意NURBS，B样条曲线和Bézier曲线.  [MIT]
* [urho3d](https://github.com/urho3d/Urho3D)  -跨平台渲染和游戏引擎.  [很多不同，主要是麻省理工学院]
* [Yocto/GL](https://github.com/xelatihy/yocto-gl)  -用于数据驱动的基于物理的图形的微型C ++库.  [MIT]
...
* [Leptonica](https://github.com/DanBloomberg/leptonica)  -Leptonica是一个开放源代码库，其中包含对图像处理和图像分析应用程序广泛有用的软件.  [BSD-2-第] [website](http://leptonica.org/index.html)
* [libfacedetection](https://github.com/ShiqiYu/libfacedetection)  -用于图像中人脸检测的开源库.  人脸检测速度可以达到1500FPS.  [BSD]
...
* [Simd](https://github.com/ermig1979/Simd)  -使用SIMD的C ++图像处理库：SSE，SSE2，SSE3，SSSE3，SSE4.1，SSE4.2，AVX，AVX2，AVX-512，VMX（Altivec）和VSX（Power7），NEON for ARM.  [MIT]
...
* [TinyEXIF](https://github.com/cdcseacave/TinyEXIF)  -JPEG符合ISO的微小C ++ EXIF和XMP解析库.  [MIT]
...
* [utf8.h](https://github.com/sheredom/utf8.h)  -用于C和C ++的单头utf8字符串函数.  [授予许可]
* [utf8proc](https://github.com/JuliaStrings/utf8proc)  -一个干净的C库，用于处理UTF-8 Unicode数据.  [MIT]
...
* [gRPC](https://github.com/grpc/grpc)  -高性能，开源通用RPC框架.  [BSD] [website](http://www.grpc.io/)
...
* [nanomsg](https://github.com/nanomsg/nanomsg)  -几个“可伸缩性协议”的简单高性能实现.  [MIT] [website](http://nanomsg.org/)
* [nng](https://github.com/nanomsg/nng)  -nanomsg-下一代，轻量级的无代理消息传递库.  [MIT] [website](https://nanomsg.github.io/nng/)
* [rpclib](https://github.com/rpclib/rpclib)  -现代的C ++ msgpack-RPC服务器和客户端库.  [MIT]
...
* [cJSON](https://github.com/DaveGamble/cJSON) -ANSI C中的超轻量JSON解析器.[MIT]
* [frozen](https://github.com/cesanta/frozen)  -用于C / C ++的JSON解析器和生成器.  [GPL和GPL2]
* [Jansson](https://github.com/akheron/jansson)  -C库，用于编码，解码和处理JSON数据.  [MIT]
...
* [json](https://github.com/nlohmann/json)  ：zap：-JSON用于现代C ++.  [MIT]
...
* [RapidJSON](https://github.com/miloyip/rapidjson)  ：zap：-具有SAX / DOM样式API的C ++快速JSON解析器/生成器.  [MIT]
* [sajson](https://github.com/chadaustin/sajson)  -用于C ++ 11的轻量级，高性能的JSON解析器.  [MIT]
* [simdjson](https://github.com/lemire/simdjson)  -极快的JSON库，每秒可以解析千兆字节的JSON.  [Apache的2.0]
* [taoJSON](https://github.com/taocpp/json)  -零依赖性C ++仅标头JSON库.  [MIT]
* [ujson](https://bitbucket.org/awangk/ujson)  -µjson是一个小型C ++ 11，UTF-8，JSON库.  [MIT]
* [YAJL](https://github.com/lloyd/yajl) -C中的快速流式JSON解析库.[ISC]

## Logging

* [Blackhole](https://github.com/3Hren/blackhole)  -基于属性的日志记录框架，该框架旨在快速，模块化和高度可定制.  [MIT]
* [Boost.Log](http://www.boost.org/doc/libs/1_56_0/libs/log/doc/html/index.html)  -设计成非常模块化和可扩展的.  [促进]
* [Easylogging++](https://github.com/easylogging/easyloggingpp)  -用于C ++ 11（或更高版本）应用程序的超轻量级高性能日志记录库.  [MIT] [website](https://muflihun.github.io/easyloggingpp)
...
* [reckless](https://github.com/mattiasflodin/reckless)  -用于C ++的低延迟，高吞吐量的异步日志记录库.  [MIT]
...
* [Dlib](https://github.com/davisking/dlib)  ：zap：-现代C ++ 11机器学习，计算机视觉，数值优化和深度学习工具包.  [促进] [website](http://dlib.net/)
* [Fido](https://github.com/FidoProject/Fido)  -用于嵌入式电子和机器人技术的高度模块化的C ++机器学习库.  [MIT] [website](http://fidoproject.github.io/)
* [flashlight](https://github.com/facebookresearch/flashlight)  -来自Facebook AI Research的快速，灵活的机器学习库，完全基于C ++编写，并基于ArrayFire张量库.  [BSD -3-第] [website](https://fl.readthedocs.io/en/latest/)
* [libsvm](https://github.com/cjlin1/libsvm)  -支持向量机的简单，易用，高效的库.  [BSD -3-第] [website](https://www.csie.ntu.edu.tw/~cjlin/libsvm/)
* [MeTA](https://github.com/meta-toolkit/meta)  -现代的C ++数据科学工具包.  [MIT] [website](https://meta-toolkit.org/)
* [Minerva](https://github.com/dmlc/minerva)  -快速，灵活的深度学习系统.  [Apache2的]
...
* [RNNLIB](https://github.com/szcom/rnnlib)  -RNNLIB是用于序列学习问题的循环神经网络库.  [GPLv3的]
* [SHOGUN](https://github.com/shogun-toolbox/shogun)  -Shogun机器学习工具箱.  [GPLv3的]
* [sofia-ml](https://code.google.com/p/sofia-ml/)  -用于机器学习的快速增量算法套件.  [Apache2的]
* [VLFeat](https://github.com/vlfeat/vlfeat)  -VLFeat开源库实现了流行的计算机视觉算法，这些算法专门用于图像理解以及局部特征提取和匹配.  [BSD-2-第] [website](http://www.vlfeat.org/)
* [xgboost](https://github.com/dmlc/xgboost)  -适用于Python，R，Java，Scala，C ++等的可扩展，便携式和分布式梯度增强（GBDT，GBRT或GBM）库.  在单机，Hadoop，Spark，Flink和DataFlow上运行.  [Apache2的]

## Math

* [Apophenia](https://github.com/b-k/apophenia) -统计和科学计算交流图书馆[GPL2]
* [Armadillo](https://gitlab.com/conradsnicta/armadillo-code)  -用于线性代数和科学计算的快速C ++库.  [Apache2的] [website](http://arma.sourceforge.net/)
...
* [ExprTK](http://www.partow.net/programming/exprtk/)  -C ++数学表达式工具包库（ExprTk）是易于使用，易于集成且运行效率极高的运行时数学表达式解析器和评估引擎.  [MIT]
* [Geometric Tools](https://www.geometrictools.com)  -C ++库，用于数学，图形，图像分析和物理学领域的计算.  [促进] [website](https://www.geometrictools.com)
* [GLM](https://github.com/g-truc/glm)  -仅标题的C ++数学库，可与OpenGL的GLSL数学匹配并互操作.  [MIT] [website](https://glm.g-truc.net/)
...
* [linalg.h](https://github.com/sgorsten/linalg)  -单头，公共领域，C ++的短向量数学库.  [授予许可]
* [MIRACL](https://github.com/CertiVox/MIRACL)  -多精度整数和有理数算法密码库.  [AGPL]
* [muparser](http://beltoforion.de/article.php?a=muparser)  -muParser是用C ++编写的可扩展高性能数学表达式解析器库.  [MIT]
...
* [StatsLib](https://github.com/kthohr/stats)  -统计分布函数的C ++仅标头库.  [Apache2的] [website](https://www.kthohr.com/statslib.html)
...
* [memory](https://github.com/foonathan/memory)  -兼容STL的C ++内存分配器库.  [zlib的]
* [memory-allocators](https://github.com/mtrebi/memory-allocators)  -自定义内存分配器，以提高动态内存分配的性能.  [MIT]
* [mimalloc](https://github.com/microsoft/mimalloc)  -具有出色性能的紧凑型通用分配器.  [MIT]
...
* [cpp-httplib](https://github.com/yhirose/cpp-httplib)  -单个文件C ++ 11-only-Header HTTP / HTTPS服务器库.  [MIT]
...
* [cpr](https://github.com/whoshuu/cpr)  -具有简单但功能强大的界面的现代C ++ HTTP请求库.  模仿Python Requests模块.  [MIT] [website](https://whoshuu.github.io/cpr/)
...
* [Dyad.c](https://github.com/rxi/dyad) -C的异步网络.[MIT]
...
* [librdkafka](https://github.com/edenhill/librdkafka)  -适用于C和C ++的Apache Kafka客户端库.  [BSD-2-第]
...
* [Onion](https://github.com/davidmoreno/onion)  -C语言中的HTTP服务器库设计为轻量级且易于使用.  [Apache2的/ GPL2]
* [PF_RING™](https://github.com/ntop/PF_RING)  -高速数据包处理框架.  [LGPL-2.1] [website](https://www.ntop.org/products/packet-capture/pf_ring/)
* [PicoHTTPParser](https://github.com/h2o/picohttpparser)  -小型，原始，快速的HTTP请求/响应解析器.  [MIT]
...
* [restclient-cpp](https://github.com/mrtazz/restclient-cpp)  -适用于C ++的简单REST客户端.  它包装libcurl用于HTTP请求.  [MIT]
* [Seasocks](https://github.com/mattgodbolt/seasocks)  -具有WebSockets支持的简单，小型，C ++可嵌入式Web服务器.  [BSD]
* [Silicon](http://siliconframework.org)  -面向中间件的高性能C ++ 14 http Web框架.  [MIT]
* [Tufão](https://github.com/vinipsmaker/tufao) - An asynchronous web framework for C++ built on top of Qt. [LGPL2]
* [uriparser](https://github.com/uriparser/uriparser)  -严格符合RFC 3986的URI解析和处理库.  [BSD -3-第]
* [uWebSockets](https://github.com/uNetworking/uWebSockets)  -µWS是最轻便，高效和可扩展的WebSocket和HTTP服务器实现之一.  [zlib的]
* [WAFer](https://github.com/riolet/WAFer)  -基于AC语言的超轻型软件平台，用于可扩展的服务器端和网络应用程序.  为C程序员考虑一下node.js.  [GPL2]
* [Wangle](https://github.com/facebook/wangle)  -客户端/服务器应用程序框架，用于构建异步的，事件驱动的现代C ++服务.  [Apache的2.0]
* [wdt](https://github.com/facebook/wdt)  -可嵌入式库（和命令行工具），旨在通过多个TCP路径尽可能快地在2个系统之间传输数据.  [BSD -3-第]
* [WebSocket++](https://github.com/zaphoyd/websocketpp)  -基于C ++ / Boost Asio的websocket客户端/服务器库.  [BSD]
* [PcapPlusPlus](https://github.com/seladb/PcapPlusPlus)  -多平台C ++网络嗅探和数据包解析与制作框架.  [授予许可]
...
* [Box2D](https://github.com/erincatto/Box2D)  -游戏的2D物理引擎.  [BSD-等]
* [Bullet](https://github.com/bulletphysics/bullet3)  -游戏的3D物理引擎.  [ZLIB] [website](http://bulletphysics.org)
* [Chipmunk](https://github.com/slembcke/Chipmunk2D)  -快速，轻量的2D游戏物理库.  [MIT] [website](https://chipmunk-physics.net/)
* [LiquidFun](https://github.com/google/liquidfun)  -游戏的2D物理引擎.  [BSD-等]
...
* [PhysX](https://github.com/NVIDIAGameWorks/PhysX-3.4)  -由Nvidia作为Nvidia GameWorks软件套件的一部分开发的开源实时物理引擎中间件SDK.  [BSD -3-第] 
* [Project Chrono](https://github.com/projectchrono/chrono)  -开源的多物理场仿真引擎.  [BSD -3-第] [website](https://projectchrono.org/)
* [Simbody](https://github.com/simbody/simbody)  -高性能C ++多体动力学/物理库，用于仿真铰接式生物力学和机械系统，例如车辆，机器人和人体骨骼.  [Apache2的]
* [Quantum++](https://github.com/vsoftco/qpp)  -现代的C ++ 11量子计算库.  [MIT]
...
* [visit_struct](https://github.com/cbeck88/visit_struct)  -在C ++中用于结构域反射的微型库.  [BSL-1.0]

## Regular Expression

* [CppVerbalExpressions](https://github.com/VerbalExpressions/CppVerbalExpressions)  -C ++正则表达式变得简单.  [MIT]
* [CTRE](https://github.com/hanickadot/compile-time-regular-expressions)  -编译时PCRE（几乎）兼容的正则表达式匹配器.  [MIT]
...
* [SLRE](https://github.com/cesanta/slre)  -适用于C / C ++的Super Light Regexp引擎.  [在GPLv2 /商业]
* [sregex](https://github.com/openresty/sregex)  -基于NFA / DFA的非回溯的Perl兼容正则表达式引擎库，用于匹配大型数据流.  [BSD]

## Robotics

* [MOOS-IvP](http://moos-ivp.org) -一组开放源代码的C ++模块，用于在机器人平台（特别是自动驾驶的海上航行器）上提供自治.
...
* [Robotics Library (RL)](http://www.roboticslibrary.org/)  -完整的C ++库，用于机器人运动学，运动计划和控制.  [BSD]
* [RobWork](https://gitlab.com/sdurobotics/RobWork)  -一组用于仿真和控制机器人系统的C ++库.  [Apache2的] [website](http://www.robwork.dk/)
* [ROS](http://wiki.ros.org/)  -机器人操作系统提供了库和工具来帮助软件开发人员创建机器人应用程序.  [BSD]

## Scientific Computing

* [AMGCL](https://github.com/ddemidov/amgcl)  -仅标头的C ++库，用于使用代数多重网格解决大型稀疏线性系统.  [MIT]
* [FFTW](http://www.fftw.org/)  -用于在一维或多维中计算DFT的AC库.  [GPL]
* [GSL](http://www.gnu.org/software/gsl/)  -GNU科学图书馆.  [GPL]
* [TileDB](https://github.com/TileDB-Inc/TileDB)  -快速密集和稀疏多维阵列DBMS.  [MIT] [website](https://tiledb.io/)
* [Trilinos](https://github.com/trilinos/Trilinos)  -高性能PDE求解器.  [BSD]
* [Torch](https://github.com/torch/torch7)  -具有广泛支持机器学习算法的科学计算框架，该技术将GPU放在首位.  [BSD -3-第] [website](http://torch.ch/)
...
* [ctypes.sh](https://github.com/taviso/ctypes.sh)  -bash的外部功能接口.  [MIT]
* [Cython](https://github.com/cython/cython)  -Cython是针对Python编程语言和扩展的Cython编程语言（基于Pyrex）的优化静态编译器.  它使为Python编写C扩展与Python本身一样容易.  [阿帕奇] [website](http://cython.org/)
* [djinni](https://github.com/dropbox/djinni)  -生成跨语言类型声明和接口绑定的工具.  [Apache2的]
* [Duktape](https://github.com/svaarala/duktape)  -占用空间小的嵌入式Javascript引擎.  [MIT] [website](http://duktape.org)
* [JavaCpp](https://github.com/bytedeco/javacpp)  -Java和本机C ++之间缺少的桥梁.  [Apache2的]
...
* [LuaBridge](https://github.com/vinniefalco/LuaBridge)  -轻量级，无依赖的库，用于将Lua绑定到C ++.  [MIT]
* [luacxx](https://github.com/dafrito/luacxx)  -用于创建Lua绑定的C ++ 11 API.  [MIT]
* [nbind](https://github.com/charto/nbind)  -神奇的标头，可从JavaScript访问C ++库.  [MIT]
* [PHP-CPP](https://github.com/CopernicaMarketingSoftware/PHP-CPP)  -一个库，用于使用C ++构建PHP扩展.  [Apache2的] [website](http://www.php-cpp.com/)
...
* [sol2](https://github.com/ThePhD/sol2)  -具有高级功能和一流性能的C ++ &lt;-&gt; Lua API包装器.  [MIT]
...
* [ChakraCore](https://github.com/Microsoft/ChakraCore)  -Microsoft提供的JavaScript引擎，可以嵌入到nodejs中.  [MIT]
...
* [FlatBuffers](https://github.com/google/flatbuffers)  -内存有效的序列化库.  [Apache2的]
* [MessagePack](https://github.com/msgpack/msgpack-c)  -适用于C和C ++的高效二进制序列化格式“如JSON”.  [Apache2的] [website](http://msgpack.org/)
...
* [SimpleBinaryEncoding](https://github.com/real-logic/simple-binary-encoding)  -以低延迟应用程序的二进制格式编码和解码应用程序消息.  [Apache2的]
...
* [Timsort](https://github.com/gfx/cpp-TimSort)  -模板化的稳定排序功能，其性能优于基于快速排序的算法（包括std :: sort），适用于反向或半排序数据.  [MIT]
...
* [libde265](https://github.com/strukturag/libde265)  -打开h.265视频编解码器实施.  [LGPL] [website](http://www.libde265.org/)
* [x265](https://bitbucket.org/multicoreware/x265/wiki/Home)  -打开h.265视频编解码器实施.  [GPL2] [website](https://x265.readthedocs.io/en/default/)
...
* [CarpVM](https://github.com/tekknolagi/carp)  -C语言中的“有趣” VM.让我们看看这是怎么回事.  [GPLv3的]
* [MicroPython](https://github.com/micropython/micropython)  -旨在在微控制器上实现Python 3.x的实现.  [MIT]
* [TinyVM](https://github.com/jakogut/tinyvm) -用纯ANSI C编写的小型，快速，轻巧的虚拟机.

## Web Application Framework

* [Civetweb](https://github.com/civetweb/civetweb)  -提供易于使用，功能强大的C / C ++嵌入式Web服务器，并具有可选的CGI，SSL和Lua支持.  [MIT]
...
* [facil.io](https://github.com/boazsegev/facil.io)  -事件丰富的高性能C Web框架，支持HTTP，WebSocket，SSE等.  [MIT] [website](http://facil.io)
...
* [oat++](https://github.com/oatpp/oatpp)  -轻巧，零依赖的框架可创建高性能的Web服务.  [Apache的2.0] [website](https://oatpp.io/) 
* [Pistache](http://pistache.io/)  -Pistache是​​一个用纯C ++ 11编写的C ++ REST框架，没有外部依赖性.  [Apache2的]
...
* [libxml++](http://libxmlplusplus.sourceforge.net/)  -C ++的XML解析器.  [LGPL2]
* [Mini-XML](https://github.com/michaelrsweet/mxml) -用ANSI C编写的小型XML解析库.[LGPL2除外]
* [PugiXML](http://pugixml.org/)  -具有XPath支持的C ++轻巧，简单，快速的XML解析器.  [MIT]
* [RapidXml](http://rapidxml.sourceforge.net/)  -尝试创建最快的XML解析器，同时保留可用性，可移植性和合理的W3C兼容性.  [促进]
* [TinyXML](http://sourceforge.net/projects/tinyxml/)  -一个简单，小型，最小的C ++ XML解析器，可以轻松集成到其他程序中.  [ZLIB]
* [TinyXML2](https://github.com/leethomason/tinyxml2)  -一个简单，小型，高效的C ++ XML解析器，可以轻松集成到其他程序中.  [ZLIB]
* [TinyXML++](https://github.com/rjpcomputing/ticpp)  -TinyXML的全新接口，使用了许多C ++优势.  模板，异常和更好的错误处理.  [MIT]
...
* [{fmt}](https://github.com/fmtlib/fmt)  ：zap：-C ++的小型，安全，快速格式化库.  [简体BSD]
* [FastFormat](http://www.fastformat.org) -受log4j和Pantheios启发的快速，安全的C ++格式[简体BSD]
* [casacore](https://code.google.com/p/casacore/)  -一组从aips ++派生的c ++核心库.  [LGPL]
* [QtVerbalExpressions](https://github.com/VerbalExpressions/QtVerbalExpressions)  -此Qt库基于C ++ VerbalExpressions库.  [MIT]
* [cxx-prettyprint](https://github.com/louisdx/cxx-prettyprint)  -一个漂亮的C ++容器打印库.  [促进]
* [icecream-cpp](https://github.com/renatoGarcia/icecream-cpp)  -用于调试目的的小型打印库.  [MIT]
* [gcc-poison](https://github.com/leafsr/gcc-poison) -一个简单的头文件，供开发人员禁止应用程序中不安全的C / C ++函数.
* [Kangaru](https://github.com/gracicot/kangaru)  -C ++ 11和C ++ 14的依赖项注入容器.  [MIT]
* [Klib](https://github.com/attractivechaos/klib)  -通用算法和数据结构的小型轻量级实现.  [MIT]
* [libsigc++](http://libsigc.sourceforge.net/)  -用于标准C ++的类型安全的回调系统.  [LGPL]
...
* [libnih](https://github.com/keybuk/libnih)  -轻量级的C函数和结构库.  [GPL2.1]
* [libusb](https://libusb.info/)  -通用USB库，允许便携式访问USB设备.  [LGPL2]
* [Mach7](https://github.com/solodon4/Mach7)  -用于C ++的模式匹配库.  [BSD]
* [mio](https://github.com/mandreyel/mio)  -用于内存映射文件IO的跨平台C ++ 11仅限标头的库.  [MIT]
* [PEGTL](https://github.com/taocpp/PEGTL)  -解析表达式语法模板库.  [MIT]
* [Remote Call Framework](http://www.deltavsoft.com/)  -C ++的进程间通信框架.  [GPL2 /商业]
* [Scintilla](http://scintilla.org/)  -一个免费的源代码编辑组件.  [MIT]
...
* [Tulip Indicators](https://tulipindicators.org)  -超过100种财务技术分析指标的AC库.  [LGPL]
* [ub-canaries](https://github.com/regehr/ub-canaries) -一组试图使编译器利用未定义行为的C / C ++程序.
...
* [ZXing](https://github.com/zxing/zxing/)  -用Java实现的开源，多格式1D / 2D条码图像处理库，并带有其他语言的端口.  [阿帕奇]
...
* [c](https://github.com/ryanmjacobs/c)  -一次性编译并执行C“脚本”！  [MIT]
* [Clang](http://clang.llvm.org/)  -LLVM的AC编译器.  支持C ++ 11/14 / 1z C11.  由LLVM团队开发.  [NCSA]
...
* [LLVM](http://llvm.org/) -集合了可重复使用的模块化编译器和工具链技术.
* [Microsoft Visual C++](https://msdn.microsoft.com/en-us/vstudio/hh386302.aspx) -MSVC，由Microsoft开发.
* [Open WatCom](https://github.com/open-watcom)  -Watcom C，C ++和Fortran交叉编译器和工具.  [Sybase Open Watcom公共许可证]
* [Oracle Solaris Studio](http://www.oracle.com/technetwork/server-storage/solarisstudio/overview/index.html)  -用于SPARC和x86的C，C ++和Fortran编译器.  支持C ++ 11  在Linux和Solaris上可用.  [OTN开发人员许可证]
...
* [Ideone](http://ideone.com/) -在线编译器和调试工具，可让您编译源代码并以60多种编程语言在线执行.
...
* [Comparison of debuggers](https://en.wikipedia.org/wiki/Comparison_of_debuggers) -维基百科的调试器列表.
* [GDB](https://www.gnu.org/software/gdb/) -GNU调试器.
* [LLDB](http://lldb.llvm.org/) -LLDB调试器.
* [Metashell](https://metashell.readthedocs.org) -交互式模板元编程外壳，其中包括MDB元调试器.
* [Valgrind](http://valgrind.org/) -用于内存调试，内存泄漏检测和性能分析的工具.
...
* [AppCode](http://www.jetbrains.com/objc/) -在JetBrains的IntelliJ IDEA平台上构建的，用于Objective-C，C，C ++和JavaScript开发的IDE.
* [Cevelop](https://www.cevelop.com) -基于Eclipse CDT的跨平台C和C ++ IDE，带有附加插件.
...
* [color_coded](https://github.com/jeaye/color_coded)  -用于基于libclang突出显示的vim插件.  [MIT]
...
* [IBM VisualAge](http://www-03.ibm.com/software/products/en/visgen) -IBM提供的一系列计算机集成开发环境.
* [Irony-mode](https://github.com/Sarcasm/irony-mode) -由libclang支持的Emacs的AC / C ++次要模式.
* [juCi++](https://gitlab.com/cppit/jucipp)  -具有libclang集成的跨平台，轻量级C ++ IDE.  [MIT]
...
* [YouCompleteMe](https://github.com/ycm-core/YouCompleteMe) -YouCompleteMe是用于Vim的快速，按需输入，模糊搜索代码完成引擎.
...
* [Bear](https://github.com/rizsotto/Bear)  -生成用于clang工具的编译数据库的工具.  [GPLv3的]
* [Buck](https://github.com/facebook/buck)  -快速构建系统，鼓励通过各种平台和语言（包括在Facebook开发和使用的C ++）创建小的可重用模块.  用Java编写.  [阿帕奇]
* [clib](https://github.com/clibs/clib)  -C编程语言的程序包管理器.  [MIT]
...
* [Conan](https://conan.io/)  -C / C ++程序包管理器，开源.  [MIT]
...
* [Hunter](https://www.github.com/ruslo/hunter)  -CMake驱动的C ++跨平台软件包管理器.  [BSD-2]
* [MesonBuild](http://mesonbuild.com) -一个开放源码的构建系统，它不仅要非常快，而且更重要的是要尽可能地方便用户使用.
* [Ninja](https://ninja-build.org/) -注重速度的小型构建系统.
* [Scons](http://www.scons.org/) -使用Python脚本配置的软件构建工具.
* [Sconsolidator](http://www.sconsolidator.com/) -Scons为Eclipse CDT构建系统集成.
* [Spack](https://spack.io/)  -灵活的软件包管理器，支持多个版本，配置，平台和编译器.  [Apache的2.0 / MIT]
...
* [XMake](https://xmake.io/)  -基于Lua的AC / C ++跨平台构建实用程序.  [阿帕奇]
...
* [List of tools for static code analysis](https://en.wikipedia.org/wiki/List_of_tools_for_static_code_analysis#C.2FC.2B.2B) -维基百科上用于静态代码分析的工具列表.
...
* [EditorConfig](https://editorconfig.org/) -EditorConfig有助于在不同的编辑器和IDE之间保持一致的编码样式.
...
* [C++Now 2018 Presentations](https://github.com/boostcon/cppnow_presentations_2018) -在C ++ Now 2018上展示的演示材料.
* [C++Now 2017 Presentations](https://github.com/boostcon/cppnow_presentations_2017) -在C ++ Now 2017上展示的演示材料.
* [C++Now 2016 Presentations](https://github.com/boostcon/cppnow_presentations_2016) -在C ++ Now 2016上展示的演示材料.
...
* [C++Now 2013 Presentations](https://github.com/boostcon/cppnow_presentations_2013) -在C ++ Now 2013上展示的演示材料.
...
* [C++ Core Guidelines](https://github.com/isocpp/CppCoreGuidelines) -由C ++作者审查的“官方” C ++准则集.
* [C++ Dos and Don'ts](http://www.chromium.org/developers/coding-style/cpp-dos-and-donts) -Chromium项目&gt;对于开发人员&gt;编码样式&gt; C ++注意事项.
* [google-styleguide](https://github.com/google/styleguide) -源自Google的开源项目的样式指南.
...
* [CppChat](http://cpp.chat) -（有时）每周查看C ++世界中与社区中的来宾聊天的情况.
...
* [Hi Def [HD]中很棒的C编程教程]（https://www.youtube.com/playlist?list=PLCB9F975ECF01953C）-面向初学者和新程序员的详细C编程语言教程的集合.
...
* [C++ Programming Tutorials from thenewboston](https://www.youtube.com/playlist?list=PLF541C2C1F671AEF6) -这些都是newboston的C ++编程教程.
* [C++ GUI with Qt Playlist](https://www.youtube.com/playlist?list=PLD0D54219E5F2544D) -带有Qt教程的newboston C ++ GUI的官方播放列表.
* [C Programming Tutorials](https://www.youtube.com/playlist?list=PL78280D6BE6F05D34) -TheNewBoston的所有C编程教程都在这里.
* [Bo Qian's playlist](https://www.youtube.com/user/BoQianTheProgrammer/playlists) -Boost库，C ++标准库，现代C ++，高级C ++，高级STL，...
...
* [C++ FQA Lite](http://yosefk.com/c++fqa/) -C ++经常被质疑的答案.
* [Guru of the Week](http://www.gotw.ca/gotw/) -由Herb Sutter创建和编写的一系列常规C ++编程问题.
* [Meeting C++](http://meetingcpp.com/)
* [C++ Quiz](http://q.viva64.com/) -C ++测验，其中您建议在开源项目的代码片段中查找错误.
* [Udemy C++ Courses and Tutorials](https://www.udemy.com/topic/C-plus-plus-tutorials/)
* [C++ Hints](http://cpphints.com/) -每个工作日都会提示PVS-Studio团队最常出现的C ++错误和解决方法.
* [C++ tutorial](https://hackr.io/tutorials/learn-c-plus-plus) -用户对在线教程银行站点进行排名，该站点显示了多个课程以学习C ++.

## Weblogs
*有用的C或C ++相关博客.*

* [Coding For Speed](https://codingforspeed.com/) -编码速度DOT COM，减少执行时间.
...
* [C++ Awesome Pack](https://github.com/juniandotnet/cpp-awesome-pack) -包含一些很棒的c ++代码，打包在一起.
* [30 Seconds of C++](https://github.com/Bhupesh-V/30-seconds-of-cpp)

## Other Awesome Lists
*其他很棒的清单*

* [lists](https://github.com/jnv/lists) -在GitHub上策划的（很棒的）列表列表.
* [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) -精选的超赞精选列表.
...
* [Awesome Modern C++](https://github.com/rigtorp/awesome-modern-cpp) -有关现代C ++的资源的集合.
* [AwesomePerfCpp](https://github.com/fenbf/AwesomePerfCpp) -精选的C / C ++性能优化资源清单.
* [free-programming-books](https://github.com/vhf/free-programming-books) -免费提供的编程书籍清单.
* [Inqlude](http://inqlude.org/) -Qt库存档.
* [papers-we-love](https://github.com/papers-we-love/papers-we-love) -来自计算机科学界的论文，以供阅读和讨论.
* [awesome-algorithms](https://github.com/tayllan/awesome-algorithms) -精选的学习和/或练习算法的地方列表.
* [awesome-talks](https://github.com/JanVanRyswyck/awesome-talks) -很多屏幕录像，用户组聚会和会议演讲的录音.
* [Projects](https://github.com/karan/Projects) -任何人都可以用任何编程语言解决的实际项目列表.
* [Awesome interview questions](https://github.com/MaximAbramchuck/awesome-interviews) -包括C和C ++在内的最流行技术的面试问题列表.
