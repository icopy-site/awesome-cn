...
此页面为考虑使用软件测试和正式方法的任何人收集资源. 

 有许多轴可以组织这样的列表，例如目标受众的专业水平（从专家到公众）或学科定位（计算机科学，数学，数学逻辑等）.  在这里，我选择按主题类型对材料进行分类.
    
如果你想添加一些东西，只需发送你希望它出现在estetus@gmail.com的文本，最好已在markdown中格式化.

**[Subscribe](https://github.com/ligurio/awesome-software-quality/subscription) 收到通知.**
...
* [The "A" Word](https://leanpub.com/TheAWord) - 艾伦佩奇
* [Professional Software Development](http://mixmastamyk.bitbucket.org/pro_soft_dev/) （章节：“5.软件质量”） -  Mike G. Miller
...
* [Code Coverage Analysis](http://www.bullseye.com/coverage.html) - 史蒂夫科内特
* [Practical Software Testing](http://www.softwaretestinghelp.com/practical-software-testing-new-free-ebook-download/) -  STH与Chindam Damodar联合
...
* [Software Testing: A Comprehensive Approach](https://github.com/laboon/ebook) - 比尔拉孔
...
* [.NET Performance Testing and Optimization - The Complete Guide](http://download.red-gate.com/ebooks/DotNet/Perf_Test_and_opt_eBook.zip) （拉链） -  RedGate，Paul Glavich和Chris Farrell
...
* [PropEr Testing](http://propertesting.com/) - 弗雷德赫伯特

#### Formal methods

* [Learn TLA+](https://learntla.com) -  Hillel Wayne @hwayne
* [Specifying Systems](http://lamport.azurewebsites.net/tla/book.html) - 莱斯利兰普特
* [The TLA+ Hyperbook](http://lamport.azurewebsites.net/tla/hyperbook.html) - 莱斯利兰普特
...
* [ML for the Working Programmer, 2nd Edition](https://www.cl.cam.ac.uk/~lp15/MLbook/pub-details.html) - 劳伦斯C.保尔森
...
* [Is Parallel Programming Hard, And, If So, What Can You Do About It?](https://github.com/paulmckrcu/perfbook/) （章节“验证”和“正式验证”） -  Paul E. McKenney @paulmckrcu
...
*软件开发流程： [Part 1](https://www.youtube.com/playlist?list=PLAwxTw4SYaPkNAtqsKcFkUGpf4j67NBaz), [Part 2](https://www.youtube.com/playlist?list=PLAwxTw4SYaPm8PAGH7ov2Bj-nG4sXgCtJ), [Part 3](https://www.youtube.com/playlist?list=PLAwxTw4SYaPkoQFThzsc9e7Fe3QV_KJCs)
...
* [A survey of automated theorem proving](https://www.youtube.com/playlist?list=PL-_cKNuVAYAW9pBFvmGr37foLBDIRGxMi) - 约翰哈里森
...
* [Software foundations in Coq 0.1](https://www.youtube.com/watch?v=KKrD4JcfW90&list=PLGCr8P_YncjUT7gXUVJWSoefQ40gTOz89) - 本杰明皮尔斯
...
* [Software Verification](https://www.youtube.com/playlist?list=PL-_cKNuVAYAUsh0QIh_zd58V4Ekmer23D) - 娜塔莎Sharygina
...
* [Основы программной инженерии](https://compscicenter.ru/courses/seintro/2012-spring/), [Youtube](https://www.youtube.com/playlist?list=PL-_cKNuVAYAWPPoDKwsZJcyOWmNiVPT4D) -  Vladimir Itsykson
...
* [Верификация параллельных и распределенных программных систем](https://www.lektorium.tv/course/22862?id=22862) ([PDF](http://is.ifmo.ru/present/2012/20120218_model_che%D1%81king_karpov_lecture01.pdf)), [Youtube](https://www.youtube.com/playlist?list=PL-_cKNuVAYAUw3pNeradNr8zwOXKQ1IZA) - 尤里卡尔波夫
...
- [SecLists](https://github.com/danielmiessler/SecLists) - 收集在一个地方收集的安全评估期间使用的多种类型的清单.
