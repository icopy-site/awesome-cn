...
* [Path Finding](https://qiao.github.io/PathFinding.js/visual/) -直观表示算法，例如A \ *，IDA \ *，广度优先搜索，最佳优先搜索以及其他算法如何描述两点A和B之间的路径.
...
- [McConnell. Analysis of Algorithms](https://www.amazon.com/Analysis-Algorithms-Jeffrey-McConnell/dp/0763707821) -一本有关算法分析的非常方便且简短的书，其中包含已实现的代码.
- [Vrajitoru & Knight. Practical Analysis of Algorithms](https://www.amazon.com/Practical-Analysis-Algorithms-Undergraduate-Computer/dp/331909887X) -一本有关算法分析的非常方便且简短的书，其中包含已实现的代码.
...
* [ShareCode.io ](https://sharecode.io/) -在线裁判和比赛主持人在存档中有很多算法问题，需要练习.
...
* [UVA](https://uva.onlinejudge.org/) -数以百计的问题（来自以前的ACM-ICPC地区，世界总决赛等）.
