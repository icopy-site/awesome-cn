...
- [Mixcloud](https://www.mixcloud.com/) -音频托管，可无限上传和嵌入播放器.
- [Spotify](https://www.spotify.com/) -您可以将任何歌曲，专辑或播放列表嵌入其中 [Spotify Play Button](https://developer.spotify.com/technologies/widgets/spotify-play-button/).
...
- [Mapbox](https://www.mapbox.com/) -看起来非常漂亮的可嵌入地图.
...
- [Vimeo](https://vimeo.co/) -付费-无广告的可嵌入视频.
- [Vevo](http://www.vevo.com/) -可嵌入的音乐视频.
- [Wistia](http://wistia.com/) -免费方案最多只能有25个视频.

### Code

- [Codepen](http://codepen.io/) -大量可嵌入的前端代码示例.
...
- [1Backend](https://1backend.com)  -在几秒钟内部署您的后端.  包括免费套餐.  开源.
- [AWS Lambda](https://aws.amazon.com/lambda/)  -AWS Lambda允许您运行代码而无需置备或管理服务器.  您只需为您消耗的计算时间付费
- [Google Cloud Functions](https://cloud.google.com/functions/) -创建可响应云事件的单一用途的独立功能，而无需管理服务器或运行时环境
...
- [IronWorkers](https://www.iron.io/platform/ironworker/) -作者：Iron.io-在多语言容器化环境中运行代码，规模不受限制，定价简单
- [IronFunctions](http://open.iron.io/) -Iron.io-IronFunctions是适用于任何云（私有，公共或混合）的开源无服务器计算平台.
- [OpenWhisk by IBM](https://console.ng.bluemix.net/openwhisk/) -BlueMix托管平台和开放源代码的一部分，与它们的Watson AI生态系统很好地联系在一起
- [StackPath EdgeEngine](https://www.stackpath.com/products/edgeengine/)  -以您选择的语言编写功能即服务，并将其部署到全球数据中心网络.  所有网络，包括智能路由和负载平衡，都由StackPath通过专用骨干网进行管理.
...
- [IntenseDebate Comments](http://www.intensedebate.com/) -具有嵌套答复，多种登录方法和电子邮件通知的可嵌入评论.
- [LiveFyre](http://web.livefyre.com/apps/comments/) -实时评论，经过SEO优化，具有社交功能，在台式机和移动设备上均美观.
...
- [GitHub Issues](https://help.github.com/articles/about-issues/)  -这是开发人员获得评论/问题的一种有趣方式.  看到 [github.com/sindresorhus/ama](https://github.com/sindresorhus/ama) 举个例子
...
- [jivochat](https://www.jivochat.com/) -JivoSite是专门用于网站的专业实时聊天，旨在增加您的在线销售.
...
- [tawk.co](https://www.tawk.to/) -可让您监控网站上的访问者并与之聊天.
...
- [Google Forms](https://www.google.co.nz/forms/about/) -您可以将Google表单用于调查或网站上的表单.
...
- [Payhip](https://payhip.com/) -出售数字下载和会员的嵌入式方法
- [Moltin](https://moltin.com/) -向任何事物添加电子商务功能.
