...
- [Azure Functions](https://azure.microsoft.com/en-us/services/functions/) -由Microsoft-与Azure云上的Lambda相同
- [IronWorkers](https://www.iron.io/platform/ironworker/) -by Iron.io-在多语言容器化环境中运行代码，规模不受限制，定价简单
- [IronFunctions](http://open.iron.io/) -Iron.io-IronFunctions是适用于任何云（私有，公共或混合）的开源无服务器计算平台.
- [OpenWhisk by IBM](https://console.ng.bluemix.net/openwhisk/) -BlueMix托管平台和开放源代码的一部分，很好地与Watson AI生态系统联系在一起
...
- [Zeit Now](https://zeit.co/now#features) -Zeit Now使人们可以使用他们选择的语言将功能作为服务编写，并作为monorepo的一部分进行部署.
...
- [Formester](https://www.formester.com) -带有集成的表格和电子邮件营销（线索收集，电子邮件活动和新闻通讯）.
...
- [jivochat](https://www.jivochat.com/) -JivoSite是专门用于网站的专业在线聊天，旨在增加您的在线销售.
...
- [elasticlunr](http://elasticlunr.com/docs/index.html) -使用JavaScript开发的轻量级全文本搜索引擎，用于基于Lunr.js的浏览器搜索和离线搜索
...
- [Algolia](https://www.algolia.com/) -托管的搜索API，可从第一次击键中立即提供相关结果.
