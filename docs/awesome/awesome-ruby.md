...
* [Grape](http://www.ruby-grape.org) -在Ruby中创建类似REST的API的自以为是的微框架.
...
* [credit_card_validations](https://github.com/didww/credit_card_validations) -红宝石，用于验证信用卡号，生成有效号，Luhn会检查.
