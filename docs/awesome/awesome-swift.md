...
* [API Design Guidelines](https://swift.org/documentation/api-design-guidelines/) -官方的Swift API设计指南.
...
* [Google](https://google.github.io/swift/) -该样式指南基于Apple出色的Swift标准库样式，并且还结合了Google中多个Swift项目使用情况的反馈.
...
* [StateViewController](https://github.com/davidask/StateViewController) -有状态的UIVIewController组成-用于Massive View Controllers的MVC解决方案.
...
* [ChainPageCollectionView](https://github.com/jindulys/ChainPageCollectionView) -精美的两级收藏视图布局和动画.
...
* [Guaka](https://github.com/nsomar/Guaka) ：penguin：-精巧美观（符合POSIX）的命令行框架.
...
### Device
*用于识别您的设备的库的集合.* [back to top](#readme) 
...
* [SourceDocs](https://github.com/eneko/SourceDocs/) -生成代码随附的Markdown参考文档.
...
* [OpenCombine](https://github.com/broadwaylamb/OpenCombine) -Apple的Combine框架的开源实现，用于随着时间的推移处理价值.
...
* [Tokamak](https://github.com/swiftwasm/Tokamak) -类似React的声明性API，可通过易于使用的单向数据绑定构建本机UI组件.
...
* [SwiftGen-Assets](https://github.com/SwiftGen/SwiftGen#assets-catalogs) -一种从资产目录自动为所有UIImages生成枚举的工具.
...
* [EZLayout](https://github.com/alexliubj/EZAnchor) -编写自动布局的更简便，更快捷的方法.
* [KVConstraintKit](https://github.com/keshavvishwkarma/KVConstraintKit) -适用于iOS，tvOS和OSX的令人印象深刻的自动布局DSL.
* [MisterFusion](https://github.com/marty-suzuki/MisterFusion) -用于自动版面设计的DSL，支持尺寸等级.
...
* [BlueSocket](https://github.com/IBM-Swift/BlueSocket) -IBM的跨平台底层套接字框架.
...
#### Webserver
 *您要在设备中托管网络服务器吗？  在这里您可以找到方法*. [back to top](#readme) 
...
* [Kitura](https://github.com/IBM-Swift/Kitura) ：penguin：-IBM的Web框架和Web服务服务器.
...
* [Swift for Scripting](https://github.com/artemnovichkov/Swift-For-Scripting) -精心挑选的有用且内容丰富的脚本材料集合.
...
* [keychain-swift](https://github.com/evgenyneu/keychain-swift) -辅助功能，可在iOS，OS X，tvOS和watchOS中安全地将文本保存在钥匙串中.
...
* [Erik](https://github.com/phimage/Erik) -无头浏览器，可使用javascript进行功能测试，以访问和操作网页.
...
* [Regex by crossroadlabs](https://github.com/crossroadlabs/Regex)  ：penguin：-具有丰富功能的正则表达式库非常易于使用.  具有运算符`=〜`和基于方法的API.  涵盖了单元测试.
...
* [Elissa](https://github.com/KitchenStories/Elissa) -在UITabBarItem或任何UIView锚点视图的顶部显示通知，以显示其他信息.
...
* [HidesNavigationBarWhenPushed](https://github.com/gontovnik/HidesNavigationBarWhenPushed) -一个库，它增加了通过hidesNavigationBarWhenPushed标志按下视图控制器时隐藏导航栏的功能.
...
* [InstantSearch iOS](https://github.com/algolia/instantsearch-ios) -在Windows上构建即时搜索功能的小部件和帮助程序库.
...
* [Spots](https://github.com/hyperoslo) -Spots是一个视图控制器框架，可以使您的设置和未来的开发快速地进行.
...
* [UIPheonix](https://github.com/MKGitHub/UIPheonix) -简单，灵活，动态和高度可扩展的UI框架+可重用的组件/控件驱动的应用程序的概念.
...
#### Alert
*显示警报，操作表，通知，弹出框的库. [back to top](#readme) 
...
* [VerticalCardSwiper](https://github.com/JoniVR/VerticalCardSwiper) -Shazam Discover用户界面和Tinder之间的结合，该界面由UICollectionView构建.
...
* [SwiftForms](https://github.com/ortuman/SwiftForms) -表格现在很容易像1-2-3.
...
* [Pagemenu](https://github.com/PageMenu/PageMenu) -支持分页的视图控制器.
...
* [VKPinCodeView](https://github.com/Sunspension/VKPinCodeView) -用于输入PIN的简洁美观的UI组件.
...
* [HGPlaceholders](https://github.com/HamzaGhazouani/HGPlaceholders) -不错的库，用于显示项目中任何UITableView / UICollectionView的占位符和空状态.
...
* [Focus](https://github.com/typelift/Focus) -受Haskell的镜头库启发的光学库（包括镜头，棱镜和Isos）.
...
* [SwiftRater](https://github.com/takecian/SwiftRater) -一种实用程序，可提醒您iPhone应用程序的用户查看该应用程序.
