...
* [Translatio](https://github.com/andrealufino/Translatio) -超轻量级的库，可帮助您甚至在情节提要中直接定位字符串.
...
* [OverlayContainer](https://github.com/applidium/OverlayContainer) -OverlayContainer使开发基于叠加层的界面（如Apple Maps或Stocks应用程序中显示的界面）变得更加容易.
...
* [StarryStars](https://github.com/peterprokop/StarryStars) -显示和编辑评级，可以从界面构建器完全自定义.
...
* [SwiftyUI](https://github.com/haoking/SwiftyUI) -高性能和轻量级的UIView，UIImage，UIImageView，UIlabel，UIButton等.
...
* [KDEDateLabel](https://github.com/delannoyk/KDEDateLabel) -一个UILabel子类，它可以自我更新以简化时间格式.
...
* [CircleMenu](https://github.com/Ramotion/circle-menu) -CircleMenu是一个简单而优雅的UI菜单，具有圆形布局和材质设计动画.
...
* [UITextField-Navigation](https://github.com/T-Pham/UITextField-Navigation)  -UITextField-Navigation在UITextField的键盘上添加了下一个，上一个和完成按钮.  高度可定制的.
...
* [GravitySlider](https://github.com/ApplikeySolutions/GravitySlider) -替代标准UICollectionView流布局的漂亮选择.
...
* [PrivacyFlash Pro](https://github.com/privacy-tech-lab/privacyflash-pro) -根据其代码为Swift iOS应用生成隐私政策.
...
* [WeakableSelf](https://github.com/vincent-pradeilles/weakable-self) -将[弱自我]和保护语句封装在闭包中的微框架.
