...
* [Indie iOS Focus Weekly](https://indieiosfocus.com) -策划每周发布的iOS新闻.
...
* [Swift Web Weekly](http://swiftwebweekly.com) -每周一在您的收件箱中免费获得的精选最佳Swift Web开发人员链接列表.
...
* [Colorify](https://github.com/czater/Colorify) -Colorify-简单但功能强大的颜色库.
...
* [Palau](https://github.com/symentis/Palau) -使用自定义规则的Typesafe NSUserDefaults.
...
* [XMLCoder](https://github.com/MaxDesiatov/XMLCoder) -来自标准库的基于Codable协议的XMLEncoder和XMLDecoder
...
* [Tokamak](https://github.com/MaxDesiatov/Tokamak) -类似React的声明性API，可通过易于使用的单向数据绑定构建本机UI组件.
...
* [SwiftIcons](https://github.com/ranesr/SwiftIcons) -字体图标库：dropicons，表情符号，超赞字体，icofont，iononicons，线性图标，地图图标，材质图标，打开图标，状态，天气.
...
* [FMPhotoPicker](https://github.com/tribalmedia/FMPhotoPicker) -具有优雅且可自定义的图像编辑器的现代，简单和零依赖性照片选择器
...
* [ManualLayout](https://github.com/isair/ManualLayout)  -易于使用且适用于iOS 8+的灵活自动布局替代.  支持AsyncDisplayKit.
...
* [Locksmith](https://github.com/matthewpalmer/Locksmith) -强大的，面向协议的库，可与iOS钥匙串配合使用.
...
* [Chronos](https://github.com/comyar/Chronos-Swift) -中央调度实用程序.
...
* [CFNotify](https://github.com/hallelujahbaby/CFNotify) -可定制的框架，用于创建可拖动的警报视图.
...
* [FloatLabelFields](https://github.com/FahimF/FloatLabelFields) -文本输入控件，其中包含内置的标题/标签，因此您不必为每个字段添加单独的标题.
...
* [Popsicle](https://github.com/DavdRoman/Popsicle) -令人愉快的，可扩展的值插值框架.
