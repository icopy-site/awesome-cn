...
* [gami](https://github.com/bit4bit/gami) - 用于 Asterisk Manager 界面的 Go 库.
...
* [libgoffi](https://github.com/clevabit/libgoffi) - Library adapter toolbox for native [libffi](http://sourceware.org/libffi/) 一体化
