...
Please take a quick gander at the [contribution guidelines](https://github.com/avelino/awesome-go/blob/master/CONTRIBUTING.md)  第一.  谢谢大家 [contributors](https://github.com/avelino/awesome-go/graphs/contributors) ;  你摇滚！
...
* [flac](https://github.com/eaburns/flac) -简洁的本机Go FLAC解码器，可将FLAC文件解码为字节片.
...
* [termtables](https://github.com/apcera/termtables) -转到Ruby库的端口 [terminal-tables](https://github.com/tj/terminal-table) 用于简单的ASCII表生成以及提供markdown和HTML输出.
...
* [remember-go](https://github.com/rocketlaunchr/remember-go) -用于缓存数据（redis，内存，memcached等）的通用接口.
...
* [gormigrate](https://github.com/go-gormigrate/gormigrate) -数据库架构迁移有助于Gorm ORM.
...
* [goweek](https://github.com/grsmv/goweek) -在golang中与周实体一起使用的库.
...
* [gorse](https://github.com/zhenghaoz/gorse) -基于Go协同过滤的高性能推荐系统软件包.
...
* [goreq](https://github.com/smallnest/goreq) -增强的基于gorequest的简化HTTP客户端.
...
* [dataframe-go](https://github.com/rocketlaunchr/dataframe-go) -用于机器学习和统计的Go数据框（类似于熊猫）.
...
* [abutil](https://github.com/bahlo/abutil) -收集常用的Golang助手.
...
* [xml2map](https://github.com/sbabiv/xml2map) -XML至MAP转换器编写的Golang.
