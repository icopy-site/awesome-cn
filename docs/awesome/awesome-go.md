...
* [gorocksdb](https://github.com/kapitan-k/gorocksdb) -Gorocksdb是一个包装器 [RocksDB](https://rocksdb.org) written in Go.
...
*关系数据库
    ...
    * [go-adodb](https://github.com/mattn/go-adodb) -用于使用数据库/ sql的Microsoft ActiveX Object DataBase驱动程序.
