...
- [Temporal](https://github.com/temporalio/sdk-go) - 使代码具有容错性和简单性的持久执行系统.
...
- [oops](https://github.com/samber/oops) - 使用上下文、堆栈跟踪和源代码片段进行错误处理.
...
- [jsonvalue](https://github.com/Andrew-M-C/go.jsonvalue) - 一个用于非结构化 JSON 数据的快速且方便的库，取代了 `encoding/json`.
...
- [slog-formatter](https://github.com/samber/slog-formatter) - 用于构建您自己的 slog 和助手的通用格式化程序.
...
- [tint](https://github.com/lmittmann/tint) - 一个写有色日志的 slog.Handler.
...
- [go-module](https://github.com/octomation/go-module) - 在 Go 上编写的典型模块的模板.
...
- [go-sse](https://github.com/lampctl/go-sse) - HTML 服务器发送事件的客户端和服务器实现.
...
- [httpretry](https://github.com/ybbus/httpretry) - 通过重试功能丰富默认的 go HTTP 客户端.
...
- [gograph](https://github.com/hmdsefi/gograph) - 提供数学图论和算法的 golang 通用图形库.
...
- [walker](https://github.com/cyucelen/walker)  - 从任何来源无缝获取分页数据. 包括简单和高性能的 API 抓取.
...
- [openaigo](https://github.com/otiai10/openaigo) - 用于 Go 的 OpenAI GPT3/GPT3.5 ChatGPT API 客户端库.
...
- [wuid](https://github.com/edwingeng/wuid) - 一个非常快速的全球唯一号码生成器.
...
- [GoFrame](https://github.com/gogf/gf) - GoFrame 是 golang 的模块化、全功能和生产就绪的应用程序开发框架.
...
- [Pnutmux](https://gitlab.com/fruitygo/pnutmux)  - Pnutmux 是一个强大的 Go web 框架，它使用正则表达式来匹配和处理 HTTP 请求. 它提供诸如 CORS 处理、结构化日志记录、URL 参数提取、中间件和并发限制等功能.
...
- [usestdlibvars](https://github.com/sashamelentyev/usestdlibvars) - 检测使用来自 Go 标准库的变量/常量的可能性的 linter.
- [vaccum](https://github.com/daveshanley/vacuum) - 超超快速、轻量级的 OpenAPI linter 和质量检查工具.
...
- [coc-go language server extension for Vim/Neovim](https://github.com/josa42/coc-go) - This plugin adds [gopls](https://github.com/golang/tools/blob/master/gopls/README.md) Vim/Neovim 的特性.
...
- [textra](https://github.com/ravsii/textra) - 提取 Go struct 字段名称、类型和标签以进行过滤和导出.
...
- [gobrew](https://github.com/kevincobain2000/gobrew)  - 转到版本管理器. 安装和管理 Go 版本的超级简单工具. 安装 go 无需 root.  Gobrew 不需要 shell rehash.
...
- [tf-profile](https://github.com/datarootsio/tf-profile)  - Terraform 运行的分析器. 生成全局统计数据、资源级统计数据或可视化.
...
- [zs](https://git.mills.io/prologic/zs) - 一个极小的静态站点生成器.
...
- [Go Faster](https://leanpub.com/gofaster) - 本书旨在缩短你的学习曲线，帮助你更快地成为一名熟练的 Go 程序员.
...
- [A Comprehensive Guide to Structured Logging in Go](https://betterstack.com/community/guides/logging/logging-in-go/) - 深入研究 Go 中结构化日志记录的世界，特别关注最近接受的 slog 提案，该提案旨在将具有级别的高性能结构化日志记录引入标准库.
...
- [The Go Developer Roadmap](https://roadmap.sh/golang) - 新的 Go 开发人员可以遵循的视觉路线图，以帮助他们学习 Go.
