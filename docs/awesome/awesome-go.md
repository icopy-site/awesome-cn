...
* [go-restful-api](https://github.com/qiangxue/go-restful-api) -遵循SOLID原则和Clean Architecture的通用Go RESTful API入门套件，具有通用的项目布局.
...
* [Razor](https://github.com/sipin/gorazor) - 为Golang的Razor视图引擎.
