...
* [Glue](https://github.com/desertbit/glue) -健壮的Go和Javascript套接字库（可替代Socket.io）.
...
* [GoStats](https://github.com/OGFris/GoStats) -GoStats是一个用于数学统计的开源GoLang库，主要用于机器学习领域，它涵盖了大多数统计度量功能.
