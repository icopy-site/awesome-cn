...
<b>一个开放的、源代码可用的软件许可和分发 API.</b><br/>
...
- [regatta](https://github.com/jamf/regatta) - 为云原生时代打造的快速、简单、地理分布的 KV 存储.
...
- [pushover](https://github.com/gregdel/pushover) - 转到 Pushover API 的包装器.
