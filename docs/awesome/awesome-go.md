...
* [nutsdb](https://github.com/xujiajun/nutsdb)   -  Nutsdb是一个用纯Go编写的简单，快速，可嵌入，持久的键/值存储.  它支持完全可序列化事务，许多数据结构，如列表，设置，分类设置.
...
* [gosl](https://github.com/cpmech/gosl) - 转到科学库线性代数，FFT，几何，NURBS，数值方法，概率，优化，微分方程等.
