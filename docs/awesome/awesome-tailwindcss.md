...
-  [Repository](https://github.com/tailwindcss/tailwindcss) -官方Tailwind CSS存储库.
...
-  [Scroll Snap](https://github.com/innocenzi/tailwindcss-scroll-snap) -添加了“滚动捕捉”实用程序.
...
**图例**：官方资源·示例·设置教程·视频教程·组件或页面教程·演员表
