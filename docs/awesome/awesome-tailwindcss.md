...
- [Heroicons](https://heroicons.com/) - 美丽的、手工制作的 SVG 图标.
...
- [Tailwind Weekly](https://tailwindweekly.com/) - 有关 Tailwind CSS 的所有内容的每周时事通讯.
...
- [LSP support for Emacs](https://github.com/merrickluo/lsp-tailwindcss) - Emacs 的 LSP 支持.
...
- [CSS to TailwindCSS converter for Code](https://github.com/Jackardios/vscode-css-to-tailwindcss) - 适用于 Visual Studio Code 的 CSS 到 Tailwind CSS 转换器扩展.

## Plugins

**图例**：官方插件·主题·实用程序·变体·组件·已弃用

- [Typography](https://github.com/tailwindlabs/tailwindcss-typography) - 添加一个“prose”类以实现漂亮的默认排版.
...
- [Theming](https://github.com/innocenzi/tailwindcss-theming) - 使用 CSS 变量进行主题化，并支持深色模式.
...
- [Theme Swapper](https://github.com/crswll/tailwindcss-theme-swapper) - 使用 CSS 变量进行主题化，并支持媒体查询.
- [Themeable](https://github.com/upupming/tailwindcss-themeable) - 添加对 Tailwind CSS 的多个主题支持.
- [Themer](https://github.com/RyanClementsHax/tailwindcss-themer) - 使用 CSS 变量和变体添加对 Tailwind CSS 的主题支持.
- [Tailwind Elements](https://tailwind-elements.com/) - 使用 500 多个交互式组件（日期选择器、模态、表单、表格、暗模式）扩展 Tailwind CSS.
- [Accent](https://github.com/enjidev/tailwindcss-accent) - 添加“强调色”以实现更加动态和灵活的颜色利用.
- [Radix](https://github.com/ecklf/tailwindcss-radix) - 添加用于样式化 Radix UI 状态的实用程序和变体.
...
- [Writing Mode](https://github.com/magicspon/tailwindcss-writing-mode) - 添加“书写模式”实用程序.
- [Hyphens](https://github.com/vivgui/tailwindcss-hyphens) - 添加“连字符”实用程序.
- [Border Gradients](https://github.com/cossssmin/tailwindcss-border-gradients) - 添加“边框图像”渐变实用程序.
...
- [CSS Logical Properties](https://github.com/omarkhatibco/tailwind-css-logical-properties) - 生成 CSS 逻辑属性的实用程序.
...
- [Bidirectional](https://github.com/yassinebridi/tailwind-direction) - 替换核心实用程序以实现双向兼容.
...
- [Scrollbar Hide](https://github.com/reslear/tailwind-scrollbar-hide) - 添加“scrollbar-hide”类以可视化隐藏滚动条.
- [Downwind CSS Easings](https://github.com/downwindcss/easings) - 扩展“转换计时功能”实用程序.
- [Content Placeholder](https://github.com/javisperez/tailwindcontentplaceholder) - 添加内容占位符图像的实用程序.
- [No Scrollbar](https://github.com/redwebcreation/tailwindcss-no-scrollbar) - 暴露“scrollbar-none”以在视觉上隐藏滚动条.
- [Fluid Type](https://github.com/davidhellmann/tailwindcss-fluid-type) - 添加流体类型（“字体大小”）实用程序.
- [Grid Areas](https://github.com/SavvyWombat/tailwindcss-grid-areas) - 添加“网格区域”和“网格区域”实用程序.
- [Full Bleed Background and Borders](https://github.com/dgknca/tailwindcss-full-bleed) - 提供扩展背景和边框的实用程序.
- [CSS Filter Order](https://github.com/joshdavenport/tailwindcss-filter-order) - 添加“filter-order”实用程序，用于更改生成的 CSS 中过滤器的顺序.
- [TailwindCSS 3D](https://github.com/sambauers/tailwindcss-3d) - 添加 3D“变换”实用程序和动画.
- [Claymorphism](https://github.com/dulltackle/tailwindcss-claymorphism) - 添加“clay”实用程序来创建粘土形态风格.
...
- [Marker](https://github.com/RadishIO/tailwindcss-marker)  - 提供用于样式列表和`<summary>  ` 标记.
...
- [FormKit](https://github.com/formkit/formkit/tree/master/packages/tailwindcss) - 添加 FormKit 输入和表单状态的变体.
...
- [Responsive Embed](https://github.com/drdogbot7/tailwindcss-responsive-embed) - 添加“响应式嵌入”组件.
...
- [Skip link](https://github.com/opdavies/tailwindcss-skip-link) - 添加_Skip to main content_可访问组件.
...
&gt; - _下面的插件提供的功能现已在 Tailwind CSS 中全部或部分实现._
...
- [benface's gradients](https://github.com/benface/tailwindcss-gradients) - 添加梯度实用程序.
...
- [glhd's transitions](https://github.com/glhd/tailwindcss-plugins) - 添加基本的转换实用程序.
- [Cursor Extended](https://github.com/hacknug/tailwindcss-cursor-extended) - 扩展“光标”实用程序.
- [Font Variant Numeric](https://github.com/philippbosch/tailwindcss-font-variant-numeric) - 添加“字体变体数字”实用程序.
- [Filters](https://github.com/benface/tailwindcss-filters) - 添加“过滤器”实用程序.
- [CSS Filters](https://github.com/Larsklopstra/tailwindcss-css-filters) - 添加默认的“filter”和“backdrop-filter”实用程序.
...
- [Scroll Snap](https://github.com/innocenzi/tailwindcss-scroll-snap) - 添加“滚动捕捉”实用程序.
...
- [Text Decoration Color](https://github.com/ahmadawais/tailwind-text-decoration-color) - 添加“文本装饰颜色”实用程序.
...
- [Line Clamp](https://github.com/tailwindlabs/tailwindcss-line-clamp) - 提供用于在固定行数后直观地截断文本的实用程序.
...
- [CSS Alpha Colors](https://github.com/soueuls/tailwind-color-alpha) - 向现有颜色添加不透明度变体.
- [Pseudo](https://github.com/Log1x/tailwindcss-pseudo) - 向 Tailwind CSS 配置添加自定义变体.
- [Spinner](https://github.com/aniftyco/tailwindcss-spinner) - 添加旋转组件.
...
- [Tailwind Color Shades](https://javisperez.github.io/tailwindcolorshades) - Tailwind CSS 的色调生成器.
...
- [Tints](https://www.tints.dev/) - Tailwind CSS 的调色板生成器和 API.
- [Tailwind CSS v2 colors](https://www.figma.com/community/file/905719775911766776) - Figma 库，带有 Tailwind CSS v2 颜色.
- [Colorkraken](https://github.com/Bouhoum/colorkraken) - Tailwind CSS 的色调生成器.
- [babel-plugin-tailwind-dark](https://github.com/wowlusitong/babel-plugin-tailwind-dark) - Babel 插件，用于在使用 Babel 编译代码时添加自定义暗类.
- [Twind](https://github.com/tw-in-js/twind) - 编译器功能可在运行、服务和构建时将 Tailwind 的类转换为 CSS.
- [GPT-3 Tailwind CSS code generator](http://gpt-tailwind.com/) - OpenAI GPT-3 支持的 Tailwind CSS 代码生成器.
- [Stitches](https://stitches.hyperyolo.com/) - 带 Tailwind 的模板生成器（在线）.
...
- [Windframe](https://www.devwares.com/windframe/) - Tailwind CSS 拖放构建器可快速构建网站和原型网站.
- [Typography Playground](https://tailwind-typography-playground.vercel.app/) - 用于尝试使用 Tailwind CSS Typography 插件的不同 Google 字体组合的工具.
- [Play](https://play.tailwindcss.com/) - Tailwind CSS 的高级在线游乐场.
...
- [Gatsby Plugin](https://github.com/muhajirframe/gatsby-plugin-tailwindcss) - 针对 Gatsby 的 Tailwind CSS 集成.
...
- [vue-cli-plugin-tailwind](https://github.com/forsartis/vue-cli-plugin-tailwind) - Vue CLI 插件，可将 Tailwind CSS 添加到项目中.
- [Tailwind CSS Figma Kit](https://github.com/ecklf/tailwindcss-figma-kit) - Tailwind CSS 的 Figma 套件.
- [Tailwind CSS Figma UI Design Kit](https://flowbite.com/figma/) - Tailwind CSS 的 Figma UI 设计套件.
- [Tailwind CSS Figma Plugin](https://github.com/ecklf/tailwindcss-figma-plugin) - Figma 插件集成了 Tailwind CSS.
- [@nuxtjs/tailwindcss](https://github.com/nuxt-community/tailwindcss-module) - NuxtJS 的 Tailwind CSS 模块，带有 PurgeCSS 和现代 CSS（预设环境 1）.
- [preact-cli-tailwind](https://github.com/agneym/preact-cli-tailwind) - Preact 的 Tailwind CSS 集成.
- [tailwind-classes-sorter](https://github.com/Acidic9/tailwind-classes-sorter) - NPM 库提供了对 Tailwind CSS 类进行排序的实用程序.
- [prettier-plugin-tailwind](https://github.com/Acidic9/prettier-plugin-tailwind) - 更漂亮的插件，可对班级列表进行排序.
- [tailwindcss-rails](https://github.com/rails/tailwindcss-rails) - Gem 用于将 Tailwind CSS 与 Rails 的资产管道结合使用.
- [Zeplin Config & Class generator](https://extensions.zeplin.io/5ae2d20017c57fd249c9876f) - Zeplin 扩展可生成 Tailwind 配置.
- [@tailwindcssinjs/macro](https://github.com/Arthie/tailwindcssinjs) - Babel 宏将 Tailwind CSS 类转换为 CSS-in-JS 库的对象.
...
- [tailwindcss-vite-plugin](https://github.com/await-ovo/tailwindcss-webpack-plugin/tree/main/packages/vite-plugin) - Tailwind CSS 的 Vite 插件，支持“Design in Devtools”模式并可视化 Tailwind CSS 配置.
...
- [Gust](https://www.getgust.com) - WordPress 的拖放页面构建器.
- [clb](https://github.com/crswll/clb) - clb（类列表构建器）是一个实用程序函数，它基于 [Stitches](https://stitches.dev/) 像API一样.
- [react-with-class](https://github.com/antomics/react-with-class) - 用于使用一组类、道具或变体创建原始 React 组件的实用函数.
- [Inspect Flow](https://inspectflow.io) - Tailwind CSS 的完整开发者工具.
- [twined-components](https://github.com/lowfront/twined-components) - 样式组件的扩展组件，它优先考虑在 Tailwind CSS 中使用的类名称.
- [Tails Devtools](https://github.com/vechai/tails-devtools) - Tailwind CSS 的一体化浏览器扩展.
- [Impulse.dev](https://impulse.dev) – Tailwind CSS 和 React 的 UI 编辑器，可编辑您的代码.
- [Tailiscope.nvim](https://github.com/danielvolchek/tailiscope.nvim) - Tailwind CSS 备忘单集成在 Neovim 中.
...
- [Tailwind Cheat Sheet](https://github.com/LeCoupa/awesome-cheatsheets/blob/master/frontend/tailwind.css) - Tailwind CSS 类名位于一个文件中.
...
- [Loopple Builder](https://www.loopple.com/theme/soft-ui-dashboard-tailwind) - Tailwind CSS 的仪表板拖放构建器.
- [Tailwind Grid Generator](https://www.tailwindgen.com/) - 拖放 Tailwind CSS 网格生成器.
...
- [Xtend UI](https://xtendui.com/) - Tailwind CSS 组件具有高级交互和动画.
...
- [Built At Lightspeed](https://www.builtatlightspeed.com/) - 包含 500 多个 Tailwind 模板、入门工具和 UI 套件的海量目录.
- [Statichunt](https://statichunt.com/tailwind-templates) - 精心挑选的免费和优质 Tailwind 模板和 Starters 的开源目录.
- [Tailkits](https://tailkits.com/) - 精选的 Tailwind CSS 组件、模板、UI 套件、资源、工具等.
...
- [Meraki UI Components](https://merakiui.com) - 支持 RTL 语言的漂亮 Tailwind CSS 组件.
- [Tailwind Cards](https://github.com/hasinhayder/tailwind-cards) - 不断增加的文本/图像卡收藏.
...
- [themes.dev](https://www.themes.dev/) - 手工制作、免费且优质的 Tailwind CSS 主题和组件.
- [Kutty](https://kutty.netlify.app) - Web 应用程序中常用的可访问且可重用的组件.
...
- [Windstrap](https://windstrap.netlify.app) - Tailwind CSS 与 Bootstrap JS.
...
- [Kometa UI Kit](https://kitwind.io/products/kometa/components) - 免费的多功能 UI 套件，使用 Tailwind CSS 构建.
...
- [Tailwind Datepicker](https://github.com/themesberg/tailwind-datepicker) - 添加使用 Tailwind CSS 和 vanilla JavaScript 构建的日期选择器组件.
...
- [RippleUI](https://www.ripple-ui.com) - 干净、现代、美观的 Tailwind CSS 组件.
- [Wind UI](https://wind-ui.com) - 采用 React 和 HTML 精心制作、响应灵敏、可访问的组件，可随时在您的网站或应用程序上使用.
- [Pines UI](https://devdojo.com/pines) - Alpine 和 Tailwind CSS UI 库.
- [NativeWind](https://www.nativewind.dev) - NativeWind 使用 Tailwind CSS 作为脚本语言，为 React Native 创建通用样式系统.
- [Vue Notus](https://www.creative-tim.com/product/vue-notus) - 开源 Tailwind CSS 和 Vue.js UI 套件.
- [Red Pixel Themes](https://redpixelthemes.com/) - 使用 Tailwind CSS 制作的付费、开发人员友好的模板.
...
- [Tailwind Admin](https://github.com/tailwindadmin/admin) - 使用 Tailwind CSS 的管理面板模板.
- [Landing Gradients](https://landing-gradients.netlify.app) - 使用渐变的登陆页面模板（1.7+）.
- [Resume](https://github.com/mohusman360/mohusman360.github.io) - 使用 Tailwind CSS 进行简单的简历.
...
- [Create React App with TypeScript](https://github.com/dance2die/cra-template-tailwindcss-typescript) - CRA 模板支持 Tailwind CSS 和 TypeScript.
- [Next.js PWA](https://github.com/msaaddev/create-next-pwa) – CLI 生成 Next.js PWA 的样板代码以及 Tailwind CSS 集成.
...
- [Gatsby Starter](https://github.com/taylorbryant/gatsby-starter-tailwind) - 使用 Tailwind CSS 的 Gatsby 入门程序.
- [Gatsby Starter Simplicity](https://github.com/PlanFlowDev/Simplicity-Itself-Gatsby-Tailwind-Starter-Theme) - 使用 Tailwind CSS 的 Gatsby 入门程序.
- [Gatsby Starter + TypeScript](https://github.com/ecklf/gatsby-typescript-tailwind) - 使用 Tailwind CSS 和 TypeScript 的 Gatsby 入门程序.
- [Gatsby Starter + Emotion JS](https://github.com/muhajirframe/gatsby-tailwind-emotion-starter) - 使用 Tailwind CSS 和 Emotion JS 的 Gatsby 入门程序.
- [Gatsby Starter Opinionated](https://github.com/mjsarfatti/gatsby-starter-tailwind-opinionated) - Gatsby 初学者使用 Tailwind CSS 和固执己见的好东西.
...
- [Dogpatch](https://github.com/jack-pallot/dogpatch) - 使用 Webpack、Vue、Babel 和 Tailwind CSS 的 WordPress 入门程序.
...
- [Eleventy Starter](https://github.com/ixartz/Eleventy-Starter-Boilerplate/) - 使用 Tailwind CSS 进行生产准备、SEO 友好的博客启动器.
...
- [Jekyll Landing Website Starter](https://github.com/abhinavs/cookie) - 使用 Jekyll 和 Tailwind CSS 进行生产准备、SEO 友好、高性能的登陆网站样板.
- [Next JS Boilerplate](https://github.com/ixartz/Next-js-Boilerplate) - Next.js 和 Tailwind CSS 的样板.
- [Vitailse](https://github.com/zynth17/vitailse) - 使用 Vue 3、TypeScript 和 Tailwind CSS 的自以为是的 Vite 入门模板.
- [Vite-Boot](https://github.com/kirklin/vite-boot) - Vite + Vue3 + TypeScript + Vue-Router4 + Pinia + Tailwind CSS + VueUse 模板.
- [AstroWind](https://github.com/onwidget/astrowind) - 生产就绪且 SEO 友好的模板，可使用 Astro 和 Tailwind CSS 启动网站.
...
- [Tailwind sites](https://tailwindsites.com) - 为您的下一个项目提供免费的 Tailwind CSS 网站模板.
...
**图例**：官方资源·示例·设置教程·视频教程·组件或页面教程·Cast
...
- [“Open” landing page](https://github.com/michelegera/tailwindcss-open-template/) - 由 Cruip 使用 Tailwind CSS Boilerplate 构建的“打开”登陆页面模板.
...
- [Tailwind CSS with CSS-in-JS](https://medium.com/@AndrewDelPrete/using-tailwindcss-with-css-in-js-32ae6796f95c) - 如何将 Tailwind CSS 与 CSS-in-JS 结合使用.
...
- [Vue.js Modal](https://nick-basile.com/blog/post/build-a-customizable-vuejs-modal-with-tailwind-css) - 使用 Tailwind CSS 和 Vue.js 构建可定制的模式.
