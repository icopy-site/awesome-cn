...
- [oclint](http://oclint.org) -静态源代码分析工具，可提高质量并减少C，C ++和Objective-C的缺陷.
...
- [gulp-bootlint](https://github.com/tschortsch/gulp-bootlint) ：warning：-的gulp包装器 [Bootlint](https://github.com/twbs/bootlint)，用于Bootstrap项目的HTML linter.
