...
* [FSharpLint](https://github.com/fsprojects/FSharpLint) -棉绒工具#
...
* [coffeelint](https://github.com/clutchski/coffeelint) -样式检查器，有助于使CoffeeScript代码保持干净和一致.
...
* [phpdcd](https://github.com/sebastianbergmann/phpdcd) -适用于PHP代码的死代码检测器（DCD）.
...
* [radon](https://github.com/rubik/radon) -一个Python工具，可根据源代码计算各种指标
...
<h2 id="pythonwrapper"> Python包装器</h2>
...
* [tslint-clean-code](https://github.com/Glavin001/tslint-clean-code) -受《清洁规范》手册启发的一组TSLint规则.
...
* [Project Wallace CSS Analyzer](https://github.com/projectwallace/css-analyzer) -CSS的分析，属于 [Project Wallace](https://www.projectwallace.com)
...
* [Attackflow Extension](https://www.attackflow.com/Extension) -Visual Studio的Attackflow插件，使开发人员无需任何先验知识就可以在源代码中实时发现关键的安全错误.
...
* [Codeac](https://www.codeac.io?ref=awesome-static-analysis)  -自动代码审查工具与GitHub，Bitbucket和GitLab（甚至是自托管）集成.  适用于JavaScript，TypeScript，Python，Ruby，Go，PHP，Java，Docker等.  （免费开源）
...
* [CodePatrol](https://cyber-security.claranet.fr/en/codepatrol) -由安全性驱动的自动SAST代码审查，支持15种以上的语言，并包括安全培训.
...
* [Sider](https://sider.review)  -自动代码审查工具.  提高开发人员的生产力.
* [Snyk](https://snyk.io/) -漏洞扫描程序，用于依赖node.js应用程序（开放源代码项目免费）
* [SonarCloud](https://sonarcloud.io)  -基于多语言云的静态代码分析.  历史，趋势，安全热点，请求请求分析等.  免费开源.
* [Teamscale](http://www.teamscale.com/)  -静态和动态分析工具，支持超过25种语言并直接集成了IDE.  可根据要求免费托管开源项目.  提供免费的学术许可证.
...
* [languagetool](https://github.com/languagetool-org/languagetool)  -25种以上语言的样式和语法检查器.  它会发现许多简单的拼写检查器无法检测到的错误.
...
* [proselint](https://github.com/amperser/proselint/) -英文散文短篇小说，着重于写作风格而不是语法.
