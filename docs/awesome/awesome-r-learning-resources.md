...
- [TidyX](https://www.youtube.com/channel/UCP8l94xtoemCH_GxByvTuFQ)  -TidyX是一个屏幕广播，主持人可以在其中从TidyTuesday项目中选择代码，然后逐行查看其代码，以说明它们的工作方式以及所使用的功能如何工作. 他们还分解了他们创建的可视化，并讨论了如何将类似的方法应用于其他数据集. 目的是帮助更多的人学习R，并参与TidyTuesday社区.
