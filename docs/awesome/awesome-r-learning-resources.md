...
&gt;有用的“ R”学习资源旨在帮助所有技能水平和背景的用户加深对“ R”的理解，从而形成知识渊博的编程人群，并使所有相关人员受益.
...
- [Tutorials Point](https://www.tutorialspoint.com/r/index.htm) -这些教程分为几类（R教程，R数据接口，R图表和图形，R统计示例，R有用资源），涵盖了深入学习开始学习R编程语言的所有基本需求.

### Functions

- [stat.berkeley - Introduction to Functions](https://www.stat.berkeley.edu/~statcur/Workshop2/Presentations/functions.pdf) -将计算集成到统计课程（UC Berkeley）的组织者对R语言功能的介绍.

### Generative Art

- [12 Months of aRt](https://www.williamrchase.com/work/art/) -在2019年，威廉·蔡斯（William Chase）开始一个项目，每月制作完全由R制作的新作品系列.在该项目中，他探索了不同的技术，开发了算法并提供了详细的帖子，详细介绍了每月的开发过程.

### Joining Data

- [Joining Data in R with dplyr](https://rpubs.com/williamsurles/293454)  -DataCamp上的“使用dplyr在R中联接数据”课程的课程笔记. 主题包括变异联接，过滤联接和设置操作，组装数据，高级联接. 作者：William Surles.

### Math

- [Descriptive Statistics](https://rcompanion.org/handbook/C_02.html)  -描述性统计信息教程，用于汇总数据，以提供对数据中包含的信息的洞察力. 作者：Salvatore S. Mangiafico.
- [Essential Math for Data Science](https://medium.com/s/story/essential-math-for-data-science-why-and-how-e88271367fbd)  -一篇文章，讨论了关键的数学主题，以掌握如何成为一名更好的数据科学家. 作者：Tirthajyoti Sarkar.
...
- [Getting latitude & longitude for any address](https://discourse.looker.com/t/get-latitude-longitude-for-any-location-through-google-sheets-and-plot-these-in-looker/5402) -作者：Brecht Vermeire.
- [Map Plots Created With R And Ggmap](https://www.littlemissdata.com/blog/maps) -作者：劳拉·埃利斯（Laura Ellis）.
- [Plot Spatial Data / Shapefiles in R](https://www.youtube.com/watch?v=uZtto0cYjZM) -来自“ math et al” YouTube频道.
...
- [From Data to Viz](https://www.data-to-viz.com/)  -从数据到可视化将引导您找到最适合您数据的图形. 作者：Yan Holtz.
- [ggplot2 extensions - gallery](https://exts.ggplot2.tidyverse.org/gallery/) -由Daniel Emaasit维护.
- [ggplot2 - Modify components of a theme](https://ggplot2.tidyverse.org/reference/theme.html)  -如何在ggplot2中修改主题的组件. 作者：Tidyverse的开发人员.
- [Graphics in R with ggplot2](https://www.statsandr.com/blog/graphics-in-r-with-ggplot2/)  -有关在ggplot2中使用图形的详细指南. 作者：Antoine Soetewey.
- [htmlwidgets for R](https://www.htmlwidgets.org/) -您可以使用R构建各种交互式Web可视化的展示和画廊. 
- [r-color-palettes](https://github.com/EmilHvitfeldt/r-color-palettes)  -r中提供的调色板的完整列表. 作者：Emil Hvitfeldt.
- [The Data Visualization Catalogue](https://datavizcatalogue.com/index.html) -数据可视化目录是Severino Ribecca开发的一个项目，用于创建不同信息可视化类型的库.
- [The Graphic Continuum](https://www.informationisbeautifulawards.com/showcase/611-the-graphic-continuum)  -图形连续体显示了我们编码和显示数据时可以使用的许多不同类型的可视化. 作者：乔纳森·施瓦比什（Jonathan Schwabish）和塞韦里诺·里贝卡（Severino Ribecca）.
- [The R Graph Gallery](https://www.r-graph-gallery.com/)  -用R编程语言制作的图表集合. 作者：Yan Holtz.
- [Time Based Heatmaps in R](https://www.littlemissdata.com/blog/heatmaps) -作者：劳拉·埃利斯（Laura Ellis）.
- [Top 50 ggplot2 Visualizations - The Master List (With Full R Code)](http://r-statistics.co/Top50-Ggplot2-Visualizations-MasterList-R-Code.html)  -本教程可帮助您选择适合特定目标的图表类型，以及如何使用ggplot2在R中实现图表. 作者：Selva Prabhakaran.
...
- [Data Wrangling Part 1: Basic to Advanced Ways to Select Columns](https://suzan.rbind.io/2018/01/dplyr-tutorial-1/) -作者：苏珊·贝特（Suzan Baert）.
- [Data Wrangling Part 2: Transforming your columns into the right shape](https://suzan.rbind.io/2018/02/dplyr-tutorial-2/) -作者：苏珊·贝特（Suzan Baert）.
- [Data Wrangling Part 3: Basic and more advanced ways to filter rows](https://suzan.rbind.io/2018/02/dplyr-tutorial-3/) -作者：苏珊·贝特（Suzan Baert）.
- [Data Wrangling Part 4: Summarizing and slicing your data](https://suzan.rbind.io/2018/04/dplyr-tutorial-4/) -作者：苏珊·贝特（Suzan Baert）.
...
- [Syntax equivalents: base R vs Tidyverse](https://tavareshugo.github.io/data_carpentry_extras/base-r_tidyverse_equivalents/base-r_tidyverse_equivalents.html)  -基本R和tidyverse的详细比较. 作者：雨果·塔瓦雷斯（Hugo Tavares）.
- [The ultimate R data.table cheat sheet](https://www.infoworld.com/article/3575086/the-ultimate-r-datatable-cheat-sheet.html)  -在R data.table和Tidyverse代码的可搜索备忘单中查找数十个数据任务的代码. 作者：莎朗·马克斯（Sharon Machlis）.


## Blogs

- [Alex Cookson](https://www.alexcookson.com/)  -Alex Cookson喜欢对R概念进行漂亮的可视化和易于阅读的演练. 他对书籍，电影和音乐剧等媒体数据特别感兴趣.
- [Avery Robbins](https://www.avery-robbins.com)  -艾弗里·罗宾斯（Avery Robbins）喜欢学习和分享有益于他的个人有益或令人敬畏的事物. 该网站是他积极从事此工作的工具：分享有用的知识，想法和技巧.
...
- [Data meets Narrative](http://www.rebeccabarter.com/blog/)  -丽贝卡·易货（Rebecca Barter）喜欢理解复杂，凌乱且有时是无意义的数据集，例如电子健康记录和保险索赔. 她的双重热情是用通俗易懂的英语向其他人解释“看似复杂”的概念，并探索和发现构成复杂数据集的故事.
- [HighlandR](https://johnmackintosh.net/) -约翰·麦金托什（John Mackintosh）的博客是一个展示演示或研讨会的地方，他在工作中学到的知识，图表改造以及他目前不使用的技术和技巧.
- [Julia Silge](https://juliasilge.com/blog/)  -朱莉娅·席尔格（Julia Silge）是RStudio的数据科学家和软件工程师，她在研究开源建模工具. 她热衷于制作精美的图表，统计编程语言R，简·奥斯丁，黑咖啡和红酒.
- [Musings on R](https://martinctc.github.io/blog/)  -Martin Chan发表的有关R和数据科学的博客. 涵盖的主题包括比较dplyr和data.table，Shiny应用程序，ggplot，数据清理，使用RStudio，与其他R用户/数据科学家的访谈以及网络抓取.
- [rweekly](https://rweekly.org/about) -整个R社区的每周更新，包括Bruce Zhao，Colin Fay，Eric Nantz，Hao Zhu，Jon Calder，Jonathan Carroll，MaëlleSalmon，Ryo Nakagawara和Wolfram Qin.
- [r-bloggers](https://www.r-bloggers.com/)  -R-Bloggers.com由Tal Galili创建，是博客撰写者的博客内容，这些博客作者撰写了有关R（英文）的文章. 该站点可帮助R博客作者和用户联系并关注R博客圈.
- [Ryo Nakagawara](https://ryo-n7.github.io/) -Ryo Nakagawara是一名数据科学家，并且一直作为报告分析师以及R和SQL的软件开发人员来改善ACDI和VOCA数据管道，创建R包，可再现的报告，仪表板和Shiny应用程序以交流他的项目的方式全球范围内都在进步.
- [Statistics Globe](https://statisticsglobe.com/) -Joachim Schork启动了该平台，与其他统计学家和程序员进行讨论，以分享他的统计学知识并提高自己的统计学技能.
- [Stats and R](https://www.statsandr.com/) -通过他的博客，Antoine Soetewey（统计博士学位）旨在帮助研究数据的学者和专业人员掌握重要的统计概念，并展示如何在R中应用它们.
...
- [Mastering Shiny](https://mastering-shiny.org/)  -这是Mastering Shiny的在线版本，目前正在早期开发中，计划于2020年下半年发布. 这本书是对 [Shiny online documentation](https://shiny.rstudio.com/) 旨在帮助应用程序作者更深入地了解Shiny. 作者：Hadley Wickham.
- [Modern R with the tidyverse](https://b-rodrigues.github.io/modern_R/)  -第1至第7章的想法是使您尽快使用R，特别是如果您已经具有编程知识的话. 从第8章开始，您将学习更多高级主题，尤其是使用R进行编程.作者：Bruno Rodrigues.
- [Practical Data Science with R](https://github.com/louisville-rstats/ebooks/blob/master/Practical%20Data%20Science%20with%20R%20-%20Nina%20Zumel%20John%20Mount.pdf)  -本书的目的是从务实，面向实践的角度介绍数据科学. 本书着重于数据科学的过程，从项目的计划阶段到数据收集和探索，再到建模，最后到部署和结果共享. 作者：Nina Zumel和John Mount.
...
- [Practicals and Exercises](http://www.columbia.edu/~cjd11/charles_dimaggio/DIRE/resources/R/practicalsBookNoAns.pdf) -这一系列练习回顾了作者演讲期间讨论的一些内容，并介绍了有关在R中处理数据的其他一些基本概念.作者：Charles DiMaggio，PhD.
- [Quantitative Politics with R](http://qpolr.com/qpolr.pdf) -本书的目的是为R提供易于访问的R简介.
收集，研究和展示不同类型的政治数据. 作者：Erik Gahner Larsen和ZoltánFazekas.
- [R Cookbook, 2nd Edition](https://rc2e.com/index.html)  -本书包含如何使用的食谱，每种食谱都可以解决特定的问题. 该食谱包括对该解决方案的快速介绍，然后进行讨论，旨在对解决方案进行解压缩，并为您提供有关其工作原理的一些见解. 作者：James（JD）Long和Paul Teetor.
- [R for Data Science](https://r4ds.had.co.nz/) -本书将教您如何使用R进行数据科学.您将学习如何将数据导入R，如何将其转化为最有用的结构，对其进行转换，对其进行可视化和建模. [Exercise Solutions](https://jrnold.github.io/r4ds-exercise-solutions/) 作者：Garrett Grolemund和Hadley Wickham.
- [R Packages](http://r-pkgs.had.co.nz/)  -在本书中，您将学习如何将代码转换成其他人可以轻松下载和使用的程序包. 作者：Hadley Wickham.
...
- [Statistical Inference via Data Science](https://moderndive.com/)  -旨在以温和的方式介绍如何使用数据科学家，统计学家，数据记者和其他研究人员的方式来分析数据和使用数据回答问题. 作者：Chester Ismay和Albert Y. Kim.
...
- [The Book of R](https://web.itu.edu.tr/~tokerem/The_Book_of_R.pdf) -《 R之书：编程和统计学第一门课程》的目的是提供相对温和但内容丰富的统计软件环境R知识，以及一些常见的统计分析，以便读者可能有扎实的基础，最终可以成为专家. [Exercise solutions](https://nostarch.com/bookofr) 作者：Tilman M. Davies.
- [The R Inferno](http://www.burns-stat.com/pages/Tutor/R_inferno.pdf) -关于R中的故障点，奇数，陷阱和故障的书.作者：Patrick Burns.
- [The R Language](https://stat.ethz.ch/R-manual/R-patched/doc/html/) -由R语言作者撰写的R简介.
- [Tidy Modeling with R](https://www.tmwr.org/) -本书是使用R编程语言的新软件集进行模型构建的指南.

## Communities of Practice

&gt;实践社区是一群对自己所做的事情有关注或热情并在与他人定期互动时学习如何做得更好的人.

- [TidyTuesday](https://github.com/rfordatascience/tidytuesday) -TidyTuesday是针对R生态系统的每周数据项目，重点在于理解如何汇总和排列数据以制作有意义的图表.
- [R for Data Science (R4DS) Online Learning Community](https://www.rfordatasci.com/)  -由Jessie Mostipak（@kierisi）创立，旨在为学习者和导师创建一个支持性和响应性的在线空间，以供Garrett Grolemund和Hadley Wickham通过R for Data Science本书收集和工作. 成长为各个技能水平的R学习者社区，共同努力以提高他们的技能.
...
- [Ben Stenhaug](https://www.youtube.com/user/benastenhaug/videos) -主题包括保存和读取数据，purrr中的地图功能，t检验，项目响应理论以及R和tidyverse的基础.
- [Colin Quirk](https://www.youtube.com/channel/UC-vtwz7ueU2dtnHk5e-WblA) -主题包括正则表达式，数据类型，Shiny和gganimate.
...
- [Lander Analytics](https://www.youtube.com/channel/UC2-hKemnrmVCH_29duyJ26A/videos) -不同专家就各种主题进行深入的讨论.
...
- [StatistikinDD](https://www.youtube.com/c/StatistikinDD/featured) -关于高效R编程（例如，并行运行R代码），可视化，回归分析的播放列表.
- [StatQuest with Josh Starmer](https://www.youtube.com/playlist?list=PLblh5JKOoLUJJpBNfk8_YadPwDTO2SCbx) -R播放列表中的“统计和机器学习”处理主成分分析，随机森林，回归，ROC和AUC以及岭，套索和弹性网.
- [TidyX](https://www.youtube.com/channel/UCP8l94xtoemCH_GxByvTuFQ)  -TidyX是一个屏幕截图，主持人可以在其中从TidyTuesday项目中选择代码，然后逐行查看其代码，以说明它们的工作方式以及所使用的功能如何工作. 他们还分解了他们创建的可视化，并讨论了如何将类似的方法应用于其他数据集. 目的是帮助更多的人学习R，并参与TidyTuesday社区.

## Contributing
 -我们欢迎您的贡献！ 请访问我们 [contributing.md](https://github.com/iamericfletcher/r-learning-resources/blob/main/contributing.md) 了解如何为该列表做出贡献.
