...
* [SonosRemote](https://github.com/foosel/SonosRemote) - 用于在 ESP8266 上运行并使用 Sonos HTTP API 的 Sonos 安装的遥控器.
...
* [framebuf2](https://github.com/peter-l5/framebuf2) - MicroPython FrameBuffer 扩展：更大和旋转的字体、三角形和圆形.
...
* [micropython-i2c-lcd](https://github.com/brainelectronics/micropython-i2c-lcd) - 通过 I2C 控制 HD44780 LCD 显示器 1602 和 2004 的 MicroPython 包.
...
* [st7789py_mpy](https://github.com/devbis/st7789py_mpy) - 慢速 MicroPython 驱动程序，用于 240x240 ST7789 显示器，不带来自全球速卖通的 CS 引脚，用 MicroPython 编写.
...
* [micropython-tm1638spi](https://gitlab.com/robhamerling/micropython-tm1638spi) - 用于具有 8 个 7 段数字、8 个独立 LED 和 8 个由 TM1638 控制的按钮的流行板的 MicroPython 库.
...
* [micropython-8encoder](https://github.com/HowManyOliversAreThere/micropython-8encoder) - I2C 的驱动程序 [M5Stack 8-Encoder Unit](https://shop.m5stack.com/products/8-encoder-unit-stm32f030)
...
* [micropython-stepper](https://github.com/redoxcode/micropython-stepper) - 以整洁的方式控制常见步进驱动器的库.
...
* [MicroPython-LIS3DH](https://github.com/tinypico/tinypico-micropython/tree/master/lis3dh%20library) - 用于 LIS3DH 3 轴加速度计的 I2C 驱动程序.
...
* [micropython-as7341](https://gitlab.com/robhamerling/micropython-as7341) - 用于 AS7341 的 MicroPython 库.
...
* [MicroPython_SCD4X](https://github.com/peter-l5/MicroPython_SCD4X) - 用于 Sensirion SCD40 和 SCD41 CO2 传感器的 MicroPython I2C 驱动程序.
...
* [micropython-eeprom](https://github.com/brainelectronics/micropython-eeprom) - 用于 AT24Cxx EEPROM 的 MicroPython 驱动程序.
...
* [micropython-stubber](https://github.com/Josverl/micropython-stubber) - 为不同的 MicroPython 固件生成和使用存根，以与 Visual Studio Code 或任何 IDE 和 linter 一起使用.
