...
## Design and UI
  ...
  * [blocks.so](https://blocks.so) — A set of clean, modern building blocks to copy and paste into your apps. Works with all frameworks
...
HTML Themes and UI Kits to create your applications faster!
  ...
  * [It tools](https://github.com/ripienaar/free-for-dev/blob/master/it-tools.tech) - Useful tools for developer and people working in IT.
