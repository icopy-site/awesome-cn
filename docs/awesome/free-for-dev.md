...
> [Deta](https://deta.sh/?ref=freedev) 是来自德国的 100% 免费云提供商.  Deta 也在 Slack 和 Discord 上提供友好且快速的支持.  
&gt; __Deta Micros__：无限和 0 停机时间的 Node.js 和 Python 托管.  
&gt; __Deta Base__：为您的下一个项目提供无限量的生产就绪 NoSQL 数据库.  
&gt; __Deta Drive__：适用于所有应用的可扩展云文件存储.
...
## Source Code Repos
  ...
  * [codeberg.org](https://codeberg.org/) - 无限的公共和私人 Git 存储库
...
## APIs, Data and ML
  ...
  * [Apify](https://www.apify.com/)  — 网页抓取和自动化平台，可让您创建提取网站数据的 API. 免费层，每月抓取 1 万次，数据保留 7 天.
  ...
  * [ETF Data API](https://etf-data.com/)  - 优质的欧洲 ETF、ETN 和 ETC 数据，每日更新.  API 提供完整的概览，包括行业、国家、因素、股息收益率和估值. 另外基本信息，如住所、跟踪指数、资产类别、费用、货币、复制方法、分配类型和频率. 每天 50 次免费 API 调用.
  ...
  * [QuickMocker](https://quickmocker.com/)  — 在您自己的子域下管理在线虚假 API 端点，将请求转发到 localhost URL 以进行 webhooks 开发和测试，使用 RegExp 和多种 HTTP 方法作为 URL 路径，优先端点，100 多个短代码（动态或虚假响应值）用于响应模板，从 OpenAPI (Swagger) 规范中导入 JSON 格式、代理请求、通过 IP 地址和授权标头限制端点. 免费帐户提供 1 个随机子域、10 个端点、5 个 RegExp URL 路径、每个端点 50 个短代码、每天 100 个请求、请求日志中的 50 个历史记录.
 ...
 * [packagecloud.io](https://packagecloud.io) — 易于使用的存储库托管：Maven、RPM、DEB、PyPi 和 RubyGem 包（有免费层）.
...
## Tools for Teams and Collaboration
  ...
  * [featurepeek.com](https://featurepeek.com)  - 内置团队协作工具的与云提供商无关的前端功能环境. 适用于静态和 Dockerized 前端. 免费用于公共存储库.
  ...
  * [GitDuck](https://gitduck.com/)  — 分布式团队的私人实时编码和远程结对编程. 开源工具
...
## CI and CD
  ...
  * [shippable.com](https://app.shippable.com/) — 150 次私有构建/月，1 个构建容器、私有和公共存储库免费
...
## Monitoring
  ...
  * [amixr.io](https://amixr.io/)  - 具有出色的 Slack 集成、API 和 Terraform 的开发人员友好警报和呼叫管理. 免费电话、短信、电报、Slack 和电子邮件套餐.
...
## Email
  ...
  * [mailazy.com](https://mailazy.com/) — 250 封电子邮件/天免费
...
## CDN and Protection
  ...
  * [cdnjs.com](https://cdnjs.com/) — 用于 JavaScript 库、CSS 库、SWF、图像等的 CDN.
  ...
  * [jsdelivr.com](https://www.jsdelivr.com/) — 面向开发者和站长的 OSS（JS、CSS、字体）的 CDN，接受 PR 添加更多
  ...
  * [staticaly.com](https://staticaly.com/) — 用于 Git 存储库（GitHub、GitLab、Bitbucket）、WordPress 相关资产和图像的 CDN
...
## PaaS
  ...
  * [Deta](https://www.deta.sh)  – 免费部署无限数量的 Node.js 和 Python 应用程序，每月最多 50k 次请求. 包括免费数据库、身份验证和电子邮件.
  ...
  * [gearhost.com](https://www.gearhost.com/pricing)  — .NET 和 PHP 应用程序的平台. 在资源有限的共享服务器上免费获得 256 MB RAM
  ...
  * [fly.io](https://fly.io/)  - Fly 是一个适用于需要在全球范围内运行的应用程序的平台. 它在靠近用户的地方运行您的代码，并在您的应用程序最繁忙的城市扩展计算. 编写您的代码，将其打包到 Docker 映像中，将其部署到 Fly 的平台，然后让其完成所有工作，以保持您的应用程序快速运行. 副项目免费，每月 10 美元的服务信用自动适用于任何付费服务. 如果您运行非常小的虚拟机，积分将大有帮助.
...
## BaaS
  ...
  * [getstream.io](https://getstream.io/) — 在几小时而不是几周内构建可扩展的新闻提要和活动流，每月免费更新 300 万次提要
  ...
  * [pusher.com](https://pusher.com/beams)  — 每月 2000 名活跃用户的免费、无限制推送通知. 适用于 iOS 和 Android 设备的单一 API.
...
## Web Hosting
  ...
  * [000WebHost](https://www.000webhost.com/) — 使用 Apache、PHP、MySQL、cPanel 的零成本网站托管，每个页面底部都有广告！
  ...
  * [Byet](https://byet.host) — Byet 为您提供大量免费、无广告、负载均衡的免费网络托管服务，包括 PHP、MySQL、FTP、Vistapanel 等！...
  ...
  * [InfinityFree](https://infinityfree.net/) - 使用 MySQL、cPanel 和无广告的免费 PHP 网站托管.
  ...
  * [pony.icu](https://pony.icu/)  — 来自 PonyICU 的无限磁盘空间、无限带宽和无限网站的免费虚拟主机. 包括 PHP 和 MySQL.
  ...
  * [0hi.me](https://0hi.me/)  — 为您的小项目提供免费的 PHP 和 MySQL 虚拟主机.  SSL/TLS 和 CDN 也可免费使用.
...
## DNS
  ...
  * [freenom.com](https://freenom.com/)  — 免费域名提供商. 免费获取 FQDN.
...
## Issue Tracking and Project Management
   ...
   * [Issue Embed](https://issueembed.dev/)  - 网站的错误报告工具，可直接进入您的 Github 问题. 个人存储库的免费计划，每月最多 500 个问题和 10,000 次页面查看/月.
...
## Design and UI
  ...
  * [Adobe XD](https://www.adobe.com/products/xd.html)  - 类似于 Sketch 的线框和原型制作工具. 免费计划涵盖：1 个有效的共享设计规范、Adobe Fonts Free（有限的字体集）、2GB 的云存储.
...
## IDE and Code Editing
   ...
   * [repl.it](https://repl.it/) — 适用于各种程序语言的云编码环境.
