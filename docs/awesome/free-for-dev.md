...
此列表是 1100 多人的合并请求、评论、想法和工作的结果. 你也可以通过发送来帮助 [Pull Requests](https://github.com/ripienaar/free-for-dev) 添加更多服务或删除其产品已更改或已停用的服务.
...
## Major Cloud Providers
  ...
  * [Amazon Web Services](https://aws.amazon.com)
    ...
    * [EBS](https://aws.amazon.com/ebs/) - 每月 30GB 的通用 (SSD) 或磁性 (12mo)
...
## Cloud management solutions
  ...
  * [scalr.com](https://scalr.com/)  - Scalr 是 Terraform 自动化和协作 (TACO) 产品，用于更好地协作和自动化 Terraform 管理的基础设施和配置. 完全支持 Terraform CLI，与 OPA 集成和分层配置模型. 没有 SSO 税. 所有功能都包括在内. 每月最多免费运行 50 次.
...
## APIs, Data and ML
  ...
  * [LoginLlama](https://loginllama.app)  - 用于检测欺诈和可疑登录并通知您的客户的登录安全 API. 每月 1,000 次免费登录.
  ...
  * [News API](https://newsapi.org)  — 使用代码在网络上搜索新闻，获取 JSON 结果. 开发人员每月可免费获得 3,000 次查询.
  ...
  * [PromptLeo](https://promptleo.com/)  - 为创作者和开发者提供的即时工程平台. 它提供了提示工程库、提示表单和提示工程API. 免费计划提供 1 个提示表单、1 个提示 API 端点和每月 30 代.
...
## Tools for Teams and Collaboration
  ...
  * [Pumble](https://pumble.com)  - 免费的团队聊天应用程序. 无限的用户和消息历史记录，永远免费.
  ...
  * [robocorp.com](https://robocorp.com)  - 用于支持自动化操作的开源堆栈. 免费试用云功能并实施简单的自动化. 机器人每月工作 240 分钟，10 次助手运行，100 MB 的存储空间.
...
## CMS
  ...
  * [kontent.ai](https://www.kontent.ai)  - 一个内容即服务平台，可为您提供所有无头 CMS 优势，同时为营销人员提供支持.  Developer plan 为 2 个用户提供无限项目，每个项目有 2 个环境、500 个内容项、2 种语言以及交付和管理 API，以及自定义元素支持. 更大的计划可满足您的需求.
  ...
  * [Hygraph](https://hygraph.com/)  - 为小型项目提供免费套餐.  GraphQL 第一个 API. 从遗留解决方案转向 GraphQL 原生 Headless CMS - 并首先提供全渠道内容 API.
...
## Code Generation
  ...
  * [Appinvento](https://appinvento.io/)  — AppInvento 是一款免费的无代码应用程序构建器. 在自动生成的后端代码中，用户可以完全访问源代码以及无限的 API 和路由，从而实现广泛的集成. 免费计划包括三个项目、五个表格和一个 Google 插件.
...
## Testing
  ...
  * [Applitools.com](https://applitools.com/)  — 用于网络、本机移动和桌面应用程序的智能视觉验证. 与几乎所有自动化解决方案（如 Selenium 和 Karma）和远程运行器（Sauce Labs、Browser Stack）集成. 免费开源. 单个用户的免费套餐，每周检查点有限.
  ...
  * [Bird Eats Bug](https://www.birdeatsbug.com/)  — 更快（更好）地报告错误. 使用 Bird 浏览器扩展录制您的屏幕，它会自动捕获工程师需要调试的技术数据. 适用于小型团队的免费套餐.
  ...
  * [tesults.com](https://www.tesults.com)  — 测试结果报告和测试用例管理. 与流行的测试框架集成. 开源软件开发人员、个人、教育工作者和入门的小团队可以申请基本免费项目以外的折扣和免费产品.
...
## Security and PKI
  ...
  * [Infisical](https://infisical.com/)  — 开源平台，可让您跨团队和基础架构管理开发人员机密：从本地开发到暂存/生产第 3 方服务的任何地方. 最多 5 名开发人员免费.
  ...
  * [opswat.com](https://www.opswat.com/) — 计算机、设备、应用程序、配置的安全监控……免费 25 位用户和 30 天的历史用户.
...
## Authentication, Authorization and User Management
  ...
  * [PropelAuth](https://propelauth.com) — A 只需几行代码即可立即销售给任何规模的公司，免费提供多达 200 名用户和 10,000 封交易电子邮件（带有水印品牌：“由 PropelAuth 提供支持”）.
...
## Messaging and Streaming
  ...
  * [eyeson API](https://developers.eyeson.team/)  - 基于WebRTC（SFU、MCU）构建视频平台的视频通信API服务. 允许实时数据注入、视频布局、录音、功能齐全的托管 Web UI（快速入门）或自定义 UI 包. 有一个 [free tier for developers](https://apiservice.eyeson.com/api-pricing) with 1000 meeting minutes a month.
...
## Monitoring
  ...
  * [netdata.cloud](https://www.netdata.cloud/)  — Netdata 是一个开源工具，旨在收集实时指标.伟大的快速增长的产品. 在github中也可以找到！
  ...
  * [robusta.dev](https://home.robusta.dev/)  — 强大的 Kubernetes 监控，基于 Prometheus. 带上您自己的 Prometheus 或安装一体化捆绑包. 免费层包括最多 20 个 Kubernetes 节点. 通过 Slack、Microsoft Teams、Discord 等发出警报. 与 PagerDuty、OpsGenie、VictorOps、DataDog 和许多其他工具集成. 
...
## Crash and Exception Handling
  ...
  * [exceptionless](https://exceptionless.com)  — 实时错误、功能、日志报告等. 每月 3k 个事件/1 个用户免费. 开源且易于自托管以供无限使用.
...
## Email
  ...
  * [Imitate Email](https://imitate.email)  - 沙盒电子邮件服务器，用于测试跨构建/质量保证和 ci/cd 的电子邮件功能. 免费帐户永远每天收到 15 封电子邮件.
  * [ImprovMX](https://improvmx.com) – 免费电子邮件转发
  * [EForw](https://www.eforw.com)  – 1 个域的免费电子邮件转发. 从您的域接收和发送电子邮件.
  ...
  * [Mailcheck.ai](https://www.mailcheck.ai/) - 防止用户使用临时电子邮件地址注册，每小时 120 个请求（每月约 86,400 个）
  ...
  * [Resend](https://resend.com)  - 面向开发人员的交易电子邮件 API.  3,000 封电子邮件/月，100 封电子邮件/天免费，1 个自定义域.
...
## Forms
  ...
  * [FabForm](https://fabform.io/)  - 为智能开发者形成后端平台. 免费计划允许每月提交 250 份表格. 友好的现代图形用户界面. 与 Google 表格、Airtable、Slack、电子邮件等集成.
...
## Web Hosting
  ...
  * [HelioHost](https://heliohost.org) — 带有 Plesk 控制面板、PHP、Node.js、Python、Django、Flask、.NET、Perl、CGI、MySQL、PostgreSQL、SQLite、IMAP/POP3/SMTP 电子邮件、无限带宽、免费子域的非营利性免费网络托管，免费提供 1000 MB 存储空间，并可选择升级.
...
## DBaaS
   ...
   * [TiDB Cloud](https://en.pingcap.com/tidb-cloud/)  — TiDB 是一个开源的 MySQL 兼容的分布式 HTAP RDBMS.  TiDB Serverless 提供 5GB 行存储和 5GB 列存储，每月免费提供 5000 万个请求单元 (RU).
   ...
   * [Neon](https://neon.tech/) — 托管 PostgreSQL，10 个分支，每个分支 3 GB 的存储空间，主要分支计算的活动时间没有限制，非主要分支计算每月（总计）100 小时的活动时间.
   ...
   * [TigerGraph Cloud](https://www.tigergraph.com/cloud/)  — 使用类似 SQL 的图形查询语言和 REST API 管理的原生图形 DBMS / 分析平台. 一个具有 2 个 vCPU、8GB 内存和 50GB 存储空间的免费实例，在闲置 1 小时后休眠.
...
## Tunneling, WebRTC, Web Socket Servers and Other Routers
   ...
   * [Pinggy](https://pinggy.io)  — 本地主机的公共 URL，只需一个命令，无需下载.  HTTPS/TCP/TLS 隧道. 免费计划有 60 分钟的隧道寿命.
   ...
   * [Tailscale](https://tailscale.com/)  — 零配置 VPN，使用开源 WireGuard 协议. 安装在 MacOS、iOS、Windows、Linux 和 Android 设备上.  100 台设备和 3 位用户的个人使用免费计划.
...
## Issue Tracking and Project Management
   ...
   * [Issue Embed](https://issueembed.dev/)  - 网站的错误报告工具可直接进入您的 Github 问题. 每月最多 500 期和 10,000 次页面浏览量的个人存储库免费计划.
   * [Jira](https://www.atlassian.com/software/jira)  — 许多公司环境中使用的高级软件开发项目管理工具. 免费计划最多 10 个用户.
   ...
   * [Kumu.io](https://kumu.io/)   — 带有动画、装饰、过滤器、聚类、电子表格导入等的关系图. 免费层允许无限制的公共项目. 图形大小无限制. 学生的免费私人项目. 如果您不想将文件公开在线（上传、编辑、下载、丢弃），则可以使用沙盒模式.
   ...
   * [Plane](https://plane.so/)  - Plane 是一个简单的、可扩展的、开源的项目和产品管理工具. 无限会员免费，最多 5MB 文件上传大小，1000 期.
...
## Design and UI
  ...
  * [Backlight](https://backlight.dev/) — Backlight 以开发人员和设计师之间的协作为核心，是一个非常完整的编码平台，团队可以在其中构建、记录、发布、扩展和维护设计系统.免费计划允许最多 3 名编辑在 1 个设计系统上工作，观众不受限制.
  ...
  * [storyset.com](https://storyset.com/) — 使用此工具为您的项目创建很棒的免费定制插图.
  ...
  * [svgrepo.com](https://www.svgrepo.com/)  - 使用种类繁多的矢量库探索、搜索和找到最适合您的项目的图标或矢量. 下载免费的 SVG 矢量用于商业用途.
  ...
  * [NextUI](https://nextui.org/)  -  自由的. 漂亮、快速和现代的 React &amp; Nxt.js UI 库.
...
## Analytics, Events and Statistics
   ...
   * [Avo](https://avo.app/)  — 简化的分析发布工作流程. 单一真实来源跟踪计划、类型安全分析跟踪库、应用程序内调试器、数据可观察性以在发布之前捕获所有数据问题.  2 个工作区成员和 1 小时的数据可观察性回顾免费.
   ...
   * [optimizely.com](https://www.optimizely.com) — A/B 测试解决方案、免费入门计划、1 个网站、1 个 iOS 和 1 个安卓应用程序
   ...
   * [Row Zero](https://rowzero.io)  - 极快的连接电子表格. 直接连接到数据数据库、S3 和 API. 立即导入、分析、绘制和共享数百万行.  3 本免费（永久）工作簿.
...
## Visitor Session Recording
   ...
   * [OpenReplay.com](https://www.openreplay.com)  - 使用用于错误再现的开发工具的开源会话重播、用于实时支持的实时会话和产品分析套件. 每月 1,000 次会话，可访问所有功能并保留 7 天.
...
## Miscellaneous
  ...
  * [Domain Forward](https://domain-forward.com/)  - 一种转发任何 URL 或域的简单工具. 每月最多释放 5 个域和 20 万个请求.
  ...
  * [Hook Relay](https://www.hookrelay.dev/)  - 毫不费力地为您的应用程序添加 webhook 支持：为您完成排队、退避重试和日志记录. 免费计划每天有 100 次交付、14 天保留和 3 个挂钩端点.
  ...
  * [kandi](https://kandi.openweaver.com/) — 快速启动应用程序开发：通过代码片段和开源库重用更快地构建自定义功能、用例和完成应用程序.
  ...
  * [snappify](https://snappify.com)  - 使开发人员能够创建令人惊叹的视觉效果. 从漂亮的代码片段到完美的技术演示. 免费计划包括一次最多 3 个 snap，无限下载和每月 5 个 AI 驱动的代码解释.
  ...
  * [Versionfeeds](https://versionfeeds.com)  — 为您喜爱的软件发布定制的 RSS 提要. 将最新版本的编程语言、库或喜爱的工具集中在一个提要中.  （前 3 个 Feed 免费）
...
## Other Free Resources
  ...
  * [ElevateAI](https://www.elevateai.com) - 每个月最多可免费获得 200 小时的音频转录.
...
HTML 主题和 UI 工具包可以更快地创建您的应用程序！
  ...
  * [OpenUtils](https://openutils.org/) - 开发人员可以使用各种免费工具，例如 HTML/CSS/JavaScript 格式化程序、缩小器、转换器、编码器/解码器等.
