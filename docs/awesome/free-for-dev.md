...
## Testing
  ...
  * [Apptim](https://apptim.com)  — 一种移动测试工具，使没有性能工程技能的人能够评估应用程序的性能和用户体验 (UX). 使用您自己的设备的桌面版是 100% 免费的，并且可以在 iOS 和 Android 上进行无限制的测试.
...
## DNS
  ...
  * [duckdns.org](https://www.duckdns.org/)  — 免费 DDNS，免费层最多包含 5 个域名. 带有各种设置的配置指南.
