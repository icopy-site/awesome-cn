...
## Code Quality
  ...
  * [beanstalkapp.com](https://beanstalkapp.com/) — 编写、审查和部署代码的完整工作流程），1 个用户的免费帐户和 1 个存储库的 100 MB 存储空间
...
## DNS
  ...
  * [cloudns.net](https://www.cloudns.net/) — 免费 DNS 托管最多 1 个域，50 条记录
...
## Storage and Media Processing
   ...
   * [internxt.com](https://internxt.com)  – Internxt Drive 是一种基于绝对隐私和不妥协安全性的零知识文件存储服务. 注册并永久免费获得 10 GB！
