...
&gt; __Deta Drive__：适用于所有应用程序的可扩展云文件存储.
...
## Code Quality
  ...
  * [SoftaCheck](https://www.softacheck.com/)  —一种在线工具，使用诸如cppcheck和clang-tidy之类的开源工具对C / C ++代码执行静态分析，并自动为使用doxygen的用户生成代码文档. 该工具是免费的. 
