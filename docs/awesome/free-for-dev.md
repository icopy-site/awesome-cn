...
此列表是请求请求，评论，想法和工作的结果，由500多个人完成，您也可以通过发送帮助 [Pull Requests](https://github.com/ripienaar/free-for-dev) 添加更多服务，或删除产品已更改或已淘汰的服务.

 *注意：*此列表仅适用于即服务产品，不适用于自托管软件.  为了使服务合格，它必须提供免费套餐，而不仅仅是免费试用.  如果免费套餐时间有限，则必须至少一年.  从安全角度来看，我们还考虑了免费层，没有SSO可以，但不会接受将TLS限制为仅付费层的服务.
...
## Major Cloud Providers
  ...
  * [Microsoft Azure](https://azure.microsoft.com)
    ...
    *通知中心-100万个推送通知
    *带宽-每月5GB出口
    * Azure Cosmos DB-5GB存储和400 RU的预配置吞吐量为1年
...
## APIs, Data and ML
  ...
  * [GeoDataSource](https://www.geodatasource.com)  —通过纬度和经度坐标查找城市名称的位置搜索服务.  免费API查询，每月多达500次.
  ...
  * [Postman](https://postman.com)  —通过用于API开发的协作平台Postman简化工作流程并更快地创建更好的API.  永久免费使用Postman App.  邮递员云功能也永久免费，并具有一定的限制.
  ...
  * [ROBOHASH](https://robohash.org/) -Web服务，可从任何文本生成唯一（酷：）图像.
  ...
  * [ScrapingDog](https://scrapingdog.com/)  — Scrapingdog可处理数百万个代理，浏览器和验证码，以在单个API调用中为您提供任何网页的HTML.  它还提供了适用于Chrome和Firefox的Web抓取工具以及可即时抓取需求的软件.  提供免费计划.
  ...
  * [ip-api](https://ip-api.com) — IP地理位置API，免费用于非商业用途，不需要API密钥，从免费计划的同一IP地址开始，限制为每分钟45 req /分钟.
...
## Tools for Teams and Collaboration
  ...
  * [Tugboat](https://tugboat.qa)  -预览每个拉动请求，自动和按需.  全部免费，非营利组织免费提供Nano层.
...
## Code Quality
  ...
  * [DeepSource](https://deepsource.io/)  -DeepSource持续分析源代码更改，并发现在安全性，性能，反模式，错误风险，文档和样式下分类的问题.  对于Python和Go.  免费开源.
  ...
  * [hiberly.com](https://hiberly.com)  -针对开发人员的技术债务工具包-每次合并后从工程师那里获取反馈，然后将其汇总以量化并突出代码库中的技术债务.  可免费使用长达12个月的回顾展.
  ...
  * [tachikoma.io](https://tachikoma.io/) — Ruby，Node.js，Perl项目的依赖更新，免费提供给开源
  * [testanywhere.co](https://testanywhere.co/) —连续不断地自动测试网站或Web应用程序，并在早期阶段发现错误，每月免费进行1,000次测试
  * [Typo CI](https://github.com/marketplace/typo-ci) — Typo CI会检查您的请求请求和拼写错误是否提交，免费提供给开源.
...
## Testing
  ...
  * [Gremlin](https://www.gremlin.com/gremlin-free-software)  — Gremlin的Chaos Engineering工具使您可以安全，安全地简单地将故障注入系统中，以在导致面向客户的问题之前发现缺陷.  Gremlin Free可以访问最多5个主机或容器上的关机和CPU攻击.
  ...
  * [reflect.run](https://reflect.run)  -针对Web应用程序的无代码自动化测试.  可以在应用程序内安排测试，也可以通过CI / CD工具执行测试.  每次测试运行都包括完整的视频记录以及控制台和网络日志.  免费套餐包括无限数量的已保存测试，每月有25次测试运行，最多3位用户.
...
## Messaging
  ...
  * [scaledrone.com](https://www.scaledrone.com/)  —实时消息服务.  免费，每天最多可同时进行20个连接和100,000个事件
  * [synadia.com](https://synadia.com/ngs) — [NATS.io](https://nats.io)  作为服务.  全局，AWS，GCP和Azure.  永久免费，每月提供4k msg大小，50个活动连接和5GB数据.
  * [cloudkarafka.com](https://www.cloudkarafka.com/) -免费共享的Kafka cluser，最多5个主题，每个主题10MB数据，数据保留28天.
...
## Email
  ...
  * [forwardemail.net](https://forwardemail.net)  —自定义域的免费电子邮件转发.  使用您的域名创建和转发不限数量的电子邮件地址.
  ...
  * [postale.io](https://postale.io/) —每个域最多可容纳5个用户的免费域电子邮件地址，无限域，启用POP3 / IMAP，无广告
...
## Forms
  ...
  * [formspark.io](https://formspark.io/) -表单到电子邮件服务，免费计划允许无限制表单，每月500次提交，并获得客户支持团队的支持.
...
## PaaS
  ...
  * [Okteto Cloud](https://okteto.com)  -专为开发人员设计的托管Kubernetes服务.  免费的开发人员帐户带有4GB的RAM，2个CPU和10GB的磁盘空间.
...
## Web Hosting
  ...
  * [Amezmo](https://www.amezmo.com)  —为开发人员提供MySQL托管的PHP.  基于Docker容器  现代PHP 7，带有Git的自动部署，针对自定义域的免费SSL.
  ...
  * [raidboxes.io](https://raidboxes.io/)  -具有许多随附功能的托管WordPress托管.  开发人员和代理机构免费，具有自定义域支持.
  ...
  * [tilda.cc](https://tilda.cc/) —一个站点，50个页面，50 MB的存储空间，只有170多个可用的主要预定义块，没有字体，没有图标，也没有自定义域
...
## DNS
  ...
  * [dns.as207960.net](https://docs.as207960.net/hexdns/) —免费DNS托管
...
## DBaaS
   ...
   * [Quickmetrics](https://www.quickmetrics.io/) —包括带有仪表板的时间序列数据库，每天最多可释放10,000个事件，并且总共提供5个指标.
...
## Issue Tracking and Project Management
   ...
   * [Ilograph](https://www.ilograph.com/)   —交互式图表，使用户可以从多个角度和细节级别查看其基础结构.  图表可以用代码表示.  免费套餐拥有无限的私人图表，最多可容纳3位观众.
   ...
   * [Kumu.io](https://kumu.io/)   —具有动画，装饰，过滤器，聚类，电子表格导入等的关系图.  免费套餐允许无限的公共项目.  图形大小不受限制.  免费的学生私人项目.  如果您不希望文件公开在线（上传，编辑，下载，丢弃），则可以使用沙盒模式.
...
## Storage and Media Processing
   ...
   * [image4.io](https://image4.io/)  —通过SDK，集成和迁移工具，可以为网站和应用程序进行图像上传，强大的处理，存储和交付.  免费套餐包括25个积分.  1个信用额度等于1 GB的CDN使用量，1GB的存储量或1000次图像转换.
...
## Design and UI
  ...
  * [Proto.io](https://www.proto.io)  -创建无需编码的完全交互式的UI原型.  免费试用期结束后提供免费套餐.  免费套餐包括：1个用户，1个项目，5个原型，100MB在线存储和proto.io应用程序中的预览.
...
## IDE and Code Editing
   ...
   * [apiary.io](https://apiary.io/) —具有即时API模拟和生成的文档的协作设计API（免费提供无限的API蓝图和具有一个管理员帐户和托管文档的无限用户）.
   ...
   * [wakatime.com](https://wakatime.com/) —使用文本编辑器插件免费获得有关您编码活动的量化自我指标，有限计划免费.
...
## Visitor Session Recording
   ...
   * [livesession.io](https://livesession.io/) — 1,000个会话/月（1个网站免费）
...
## Commenting Platforms
  ...
  * [GraphComment](https://graphcomment.com/) -GraphComment是一个评论平台，可以帮助您从网站的受众群体建立活跃的社区. 
...
## Miscellaneous
  ...
  * [newreleases.io](https://newreleases.io/) -从GitHub，GitLab，Bitbucket，Python PyPI，Java Maven，Node.js NPM，Node.js纱线，Ruby Gems，PHP Packagist，.NET NuGet，新版本发布的电子邮件，Slack，Telegram，Discord和自定义Webhooks接收有关电子邮件的通知Rust Cargo和Docker Hub.
  * [PDFMonkey](https://www.pdfmonkey.io/)  —在仪表板中管理PDF模板，使用动态数据调用API，然后下载PDF.  每月提供1000个免费文档.
  * [readme.com](https://readme.com/) —易于使用的精美文档，对于开源免费提供：请参阅 [here](https://readme.readme.io/docs/open-source).
