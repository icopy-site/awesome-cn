...
> [Deta](https://deta.sh/?ref=freedev) 是德国100％免费的云提供商.  Deta还为Slack＆Discord提供友好而快速的支持.  
&gt; __Deta Micros__：无限和零停机的Node.js和Python托管.  
&gt; __Deta Base__：下一个项目的无限制生产就绪NoSQL数据库.  
...
## Major Cloud Providers
  ...
  * [Oracle Cloud](https://www.oracle.com/cloud/)
    *计算-2个VM.Standard.E2.1.Micro 1GB RAM，4个基于Arm的Ampere A1内核和24 GB内存（可用作一个VM或最多4个VM）
    *块卷-2个卷，总计200 GB（用于计算）
    *对象存储-10 GB
    *负载平衡器-1个实例的10 Mbps
    *数据库-2个DB，每个20 GB
...
## APIs, Data and ML
  ...
  * [DeepAR](https://developer.deepar.ai)  —具有一个SDK的任何平台的增强现实面部过滤器. 免费计划可提供多达10个每月活跃用户（MAU）并跟踪多达4张面孔
  ...
  * [Glitterly](https://glitterly.app/)  -以编程方式从基本模板生成动态图像. 宁静的API和nocode集成. 免费套餐每月提供50张图片和5个模板.
  ...
  * [ipapi](https://ipapi.co/)  -由Kloudend，Inc提供的IP地址位置API-基于AWS的可靠地理定位API，受财富500强公司信任.免费套餐提供每月30k的查询，无需注册. 请与我们联系以获取更高限度的试用计划.
  ...
  * [BigDataCloud](https://www.bigdatacloud.com/) -为现代网络提供快速，准确和免费（无限或每月多达10K-5K）的API，例如IP地理位置，反向地理编码，网络见解，电子邮件和电话验证，客户信息等.
  ...
  * [WebScraping.AI](https://webscraping.ai)  -带有内置解析，Chrome渲染和代理的简单Web Scraping API. 每月2000次免费API调用.
...
## Tools for Teams and Collaboration
  ...
  * [Filestash](https://www.filestash.app) —类似Dropbox的文件管理器，可连接到各种协议和平台：S3，FTP，SFTP，Minio，Git，WebDAV，Backblaze，LDAP等.
  ...
  * [twist.com](https://twist.com)  —异步友好的团队交流应用程序，其中的对话保持井井有条，并保持话题性. 提供免费和无限计划. 为符合条件的团队提供折扣.
  ...
  * [zdoo.co](https://www.zdoo.co)  —借助CRM，OA和项目管理套件，zdoo对于团队协作是如此强大. 提供有限用户和空间的免费云版本，高级版本提供为期一个月的免费试用.
  * [Zulip](https://zulip.com/)  —通过独特的类似电子邮件的线程模型进行实时聊天. 免费计划包括10,000条搜索历史记录消息和高达5 GB的文件存储空间. 它还提供了可自我托管的开源版本.
  * [Automate.io](https://automate.io)  -具有200多个应用程序集成的简单和复杂的自动化工作流工具.  300个每月动作和5个机器人程序是免费
  * [robocorp.com](https://robocorp.com)  -用于为Automation Ops供电的开源堆栈. 试用云功能并免费实施简单的自动化. 机器人工作240分钟/月，运行10次助手，存储100 MB. 
...
## Code Quality
  ...
  * [SoftaCheck](https://www.softacheck.com/)  —一种在线工具，该工具使用诸如cppcheck和clang-tidy之类的开源工具对C / C ++代码执行静态分析，并自动为使用doxygen的用户生成代码文档. 该工具是免费的. 
...
## Security and PKI
  ...
  * [Protectumus](https://protectumus.com)  -免费的PHP网站安全检查，站点防病毒和服务器防火墙（WAF）. 免费版中注册用户的电子邮件通知.
...
## Management System
  ...
  * [Miradore](https://miradore.com)  —设备管理服务. 随时了解设备群的最新信息，并免费保护不限数量的设备. 免费计划提供基本功能.
...
## Monitoring
  ...
  * [OnlineOrNot.com](https://onlineornot.com/)  -10个正常运行时间的监视器，间隔为5分钟； 1个页面速度的监视器，间隔为12小时. 通过Slack和电子邮件的免费警报.
  ...
  * [pingpong.one](https://pingpong.one/)  -具有监控功能的高级状态页面平台. 免费套餐包括一个带有SSL子域的公共可自定义状态页面.  Pro计划免费提供给开源项目和非营利组织.
...
## Email
  ...
  * [forwardemail.net](https://forwardemail.net)  —针对自定义域的免费电子邮件转发. 使用您的域名创建和转发不限数量的电子邮件地址（**注意**：如果您使用.casa，.cf，.click，.email，.fit，.ga，.gdn，.gq， .loan，.london，.men，.ml，.pl，.rest，.ru，.tk，.top，.work TLD（由于垃圾邮件））
  ...
  * [Tempmailo](https://tempmailo.com/)  -无限的免费临时电子邮件地址. 两天内自动过期.
  ...
  * [Zoho](https://www.zoho.com)  —最初是作为电子邮件提供商，但现在提供了一套服务，其中一些服务有免费计划. 有免费计划的服务清单：
     ...
     - [Wiki](https://zoho.com/wiki) — 3位用户免费使用，具有50 MB存储空间，无限制页面，zip备份，RSS和Atom提要，访问控制和可自定义CSS.
...
## CDN and Protection
  ...
  * [Cloudflare](https://www.cloudflare.com/)
    ...
    * [Cloudflare Pages](https://pages.cloudflare.com/)  —免费的虚拟主机（JAMstack平台），供前端开发人员协作和部署网站. 一次1个版本，每月500个版本，无限制的站点，无限制的请求，无限制的带宽.
    * [Cloudflare Workers](https://workers.cloudflare.com/)  -在Cloudflare的全球网络上免费部署无服务器代码. 每天使用worker.dev子域的100,000个免费请求.
...
## PaaS
  ...
  * [anvil.works](https://anvil.works)  -仅使用Python即可进行Web应用程序开发. 免费套餐，无限制的应用程序.
  ...
  * [Koyeb](https://www.koyeb.com)  -Koyeb是一个开发人员友好的无服务器平台，可在全球范围内部署应用程序. 通过基于git的部署，本机自动缩放，全局边缘网络以及内置服务网格和发现，无缝运行Docker容器，Web应用程序和API.  Koyeb提供两项Nano服务，以其永久性的层来运行您的应用程序，还赞助具有免费资源的开源项目.
  * [Railway](https://railway.app)  -铁路是一个基础架构平台，您可以在其中配置基础架构，在本地使用该基础架构进行开发，然后部署到云中. 免费提供3个项目，2个插件/项目，2个环境/项目，3个实时部署/环境.
...
## BaaS
  ...
  * [darklang.com](https://darklang.com/)  -与编辑器和基础结构相结合的托管语言. 在测试期间免费，计划在测试之后提供免费的免费套餐.
  * [Firebase](https://firebase.com)  — Firebase可帮助您构建和运行成功的应用程序.  Free Spark Plan提供身份验证，托管，Firebase ML，实时数据库，云存储，Testlab.  A / B测试，分析，应用程序分发，应用程序索引，云消息传递（FCM），崩溃分析，动态链接，应用程序内消息传递，性能监控，预测和远程配置始终是免费的.
  ...
  * [Supabase](https://supabase.io)  —用于构建后端的开源Firebase替代方案.  Free Plan提供身份验证，实时数据库和对象存储.
...
## Web Hosting
  ...
  * [netlify.com](https://www.netlify.com/) —免费构建，部署和托管100 GB数据和100 GB /月的带宽的静态站点/应用程序.
  ...
  * [render.com](https://render.com) —一个统一的平台，用于构建和运行所有应用程序和Web应用程序，其中包括免费的SSL，全局CDN，专用网络和来自Git的自动部署，而对于静态网页则免费.
  * [sourceforge.net](https://sourceforge.net/) —免费查找，创建和发布开源软件
  * [Stormkit](https://stormkit.io/)  —将构建，部署和托管与JAMStack或Node.JS应用的git流无缝集成. 每月50 GB带宽和1000万个免费请求（包括免费SSL）.
...
## DNS
  ...
  * [nextdns.io](https://nextdns.io) -基于DNS的防火墙，每月300K免费查询
...
## Issue Tracking and Project Management
   ...
   * [Backlog](https://backlog.com)  —您的团队在一个平台上发布出色项目所需的一切. 免费计划提供1个可容纳10位用户和100MB存储空间的项目.
   ...
   * [saas.zentao.pm](https://saas.zentao.pm/) -还提供用于问题跟踪和项目管理的应用程序生命周期管理解决方案，本地版本和开源版本.
   * [SpeedBoard](https://speedboard.app) -敏捷和Scrum回顾委员会-免费.
   * [Shake](https://www.shakebugs.com/)  -适用于移动应用的应用内错误报告和反馈工具. 免费方案，每个应用程序/每月10个错误报告. 
   ...
   * [Wikifactory](https://wikifactory.com/)  —包含项目，VCS和问题的产品设计服务. 免费计划提供无限的项目和协作者以及3GB的存储空间.
...
## Design and UI
  ...
  * [Ant Design Landing Page](https://landing.ant.design/)  -Ant Design Landing Page提供了由Ant Motion的运动组件构建的模板. 它具有丰富的首页模板，可以下载模板代码包，并且可以快速使用. 您还可以使用编辑器快速构建自己的专用页面.
  ...
  * [Responsively App](https://responsively.app) -一个免费的开发工具，可用于更快，更准确地响应Web应用程序开发.
...
## Data Visualization on Maps
   ...
   * [developers.arcgis.com](https://developers.arcgis.com)  —用于Web，台式机和移动设备上的地图，地理空间数据存储，分析，地理编码，路由等的API和SDK.  2,000,000个免费底图图块，20,000个未存储的地理编码，20,000个简单路线，5,000个行驶时间计算，每月5GB的免费图块+数据存储.
   ...
   * [http://maps.stamen.com/](http://maps.stamen.com/) -免费地图瓷砖和瓷砖托管.
...
## IDE and Code Editing
   ...
   * [BlueJ](https://bluej.org)  —专为初学者设计的免费Java开发环境，全球已有数百万人使用. 由Oracle和简单的GUI提供支持，可帮助初学者.
   ...
   * [cocalc.com](https://cocalc.com/)  —（以前是位于cloud.sagemath.com的SageMathCloud）—在云中进行协作计算. 浏览器可访问具有内置协作功能的完整Ubuntu，并提供许多用于数学，科学，数据科学的免费软件，并且预装了以下软件：Python，LaTeX，Jupyter Notebooks，SageMath，scikitlearn等.
   ...
   * [jetbrains.com](https://jetbrains.com/products.html) -生产力工具，IDE和部署工具（aka [IntelliJ IDEA](https://www.jetbrains.com/idea/), [PyCharm](https://www.jetbrains.com/pycharm/) ， 等等）. 为学生，教师，开放源代码和用户组提供免费许可证.
   ...
   * [Katacoda](https://katacoda.com) —面向软件工程师的交互式学习和培训平台，可帮助开发人员进行学习并提高公司的采用率.
...
## Analytics, Events and Statistics
   ...
   * [Branch](https://branch.io)  —移动分析平台. 免费套餐可为多达1万名移动应用用户提供深层链接和其他服务.
   * [Clicky](https://clicky.com)  —网站分析平台.  1个网站的免费计划，具有3000次浏览量分析.
   * [Databox](https://databox.com)  —通过结合其他分析和BI平台进行业务洞察和分析.  Free Plan提供3个用户，仪表板和数据源.  1100万历史数据记录.
...
## Visitor Session Recording
   ...
   * [UXtweak.com](https://www.uxtweak.com/)  —记录并观看访问者如何使用您的网站或应用程序. 免费享受小型项目的无限时间
...
## Docker Related
  ...
  * [TreeScale.com](https://treescale.com/)  —使用组权限托管和管理容器映像. 免费套餐为私有存储库提供1 GB的存储空间.
...
## Privacy Management
  * [Bearer](https://www.bearer.sh/)  -通过审核和连续的工作流程帮助设计实现隐私，从而使组织遵守GDPR和其他法规. 免费套餐仅限于较小的团队和SaaS版本. 
  * [Osano](https://www.osano.com/)  -同意的管理和合规平台，包括GDPR表示到Cookie标语的所有内容. 免费套餐提供基本功能.
  * [Iubenda](https://www.iubenda.com/)  -隐私权和Cookie政策以及同意管理. 免费套餐提供有限的隐私和Cookie政策以及Cookie标语.
  * [Cookiefirst](https://cookiefirst.com/)  -Cookie标语，审核和多语言同意管理解决方案. 免费套餐提供一次性扫描和单个横幅.
  * [Ketch](https://www.ketch.com/)  -同意的管理和隐私框架工具. 免费套餐提供大多数功能，但访问者数量有限.
...
## Miscellaneous
  ...
  * [datelist.io](https://datelist.io)  -在线预订/约会安排系统. 每月最多可进行5笔预订，其中包括1个日历
  ...
  * [fullcontact.com](https://www.fullcontact.com/developer/pricing/)  —通过将社交个人资料添加到您的应用中，帮助您的用户更多地了解他们的联系人. 每月500次免费的人API匹配
  ...
  * [redirect.pizza](https://redirect.pizza/)  -通过HTTPS支持轻松管理重定向. 免费计划包括每月10个来源和100.000个匹配项.
  ...
  * [Format Express](https://www.format-express.dev) -用于JSON / XML / SQL的即时在线格式化程序.
...
## Other Free Resources
  ...
  * [SnapShooter](https://snapshooter.com/)  —用于DigitalOcean，AWS，LightSail，Hetzner和Exoscale的备份解决方案，支持将数据库，文件系统和应用程序直接备份到基于s3的存储. 提供免费计划，其中包含一项资源的每日备份.
