...
您可以在以下位置找到列表 [GitHub](https://github.com/ripienaar/free-for-dev) 或在专用网站上 [free-for.dev](https://free-for.dev/).
...
## Major Cloud Providers
  ...
  * [Microsoft Azure](https://azure.microsoft.com)
    ...
    *功能-每月一百万个请求
    * DevTest Labs-支持快速，轻松和精益的开发测试环境
...
## Source Code Repos
  ...
  * [github.com](https://github.com/) —无限的公共存储库和无限的私人存储库（最多3个合作者）
  * [bitbucket.org](https://bitbucket.org/) —带有CI / CD管道的多达5个用户的无限公共和私人存储库（Git和Mercurial）
  * [gitlab.com](https://about.gitlab.com/) -无限的合作者，无限的公共和私人Git仓库
  * [chiselapp.com](http://chiselapp.com/) -无限的公共和私人化石仓库
  * [Azure DevOps](https://azure.microsoft.com/services/devops/) —最多5个用户/团队的无限私人存储库（Git和TFS）
...
## APIs, Data and ML
  ...
  * [IP Geolocation](https://ipgeolocation.io/) — IP地理位置API-每月30k请求（每天（k / day）限制）的开发人员永久免费的计划.
  * [RequestBin.com](https://requestbin.com)  —创建一个免费的端点，可以向其发送HTTP请求.  发送到该端点的所有HTTP请求都将与相关的有效负载和标头一起记录，因此您可以观察来自Webhooks和其他服务的请求.
  * [MailboxValidator](https://www.mailboxvalidator.com)  —使用真实邮件服务器连接的电子邮件验证服务，以确认有效的电子邮件.  免费API计划每月有300个验证.
  ...
  * [Releaseflags](https://releaseflags.com)  -功能标记应该以低成本提供给每个开发人员.  Releaseflags为单个开发人员提供免费的releaseflags，并为创业公司提供了低成本的计划.
...
## Tools for Teams and Collaboration
  ...
  * [scinote.net](https://scinote.net)  —科学的数据管理和团队协作.  一个团队，拥有无限数量的用户，备份和1 GB的存储空间
  ...
  * [typetalk.com](https://www.typetalk.com/) -通过Web或移动设备上的即时消息与团队共享和讨论想法
...
## Code Search and Browsing
  ...
  * [libraries.io](https://libraries.io/) — 32个不同程序包管理器的搜索和依赖项更新通知，免费提供给开源
...
## CI / CD
  ...
  * [Azure Pipelines](https://azure.microsoft.com/services/devops/pipelines/) —针对Linux，macOS和Windows的开源软件，提供10个无限制的免费并行作业，几分钟即可完成
  ...
  * [gitlab.com](https://about.gitlab.com/product/continuous-integration/)  —使用GitLab的CI服务直接从Git存储库创建管道.  2,000min /月
...
## Automated Browser Testing
  ...
  * [browserstack.com](https://www.browserstack.com/) —手动和自动浏览器测试，对于开源免费
...
## Security and PKI
  ...
  * [duo.com](https://duo.com/)  —网站或应用程序的两因素身份验证（2FA）.  免费10位用户，所有身份验证方法，无限制，集成，硬件令牌
...
## Management System
  ...
  * [jamf.com](https://www.jamf.com/) — iPad，iPhone和Macs设备管理，免费提供3台设备
...
## Log Management
  ...
  * [logz.io](https://logz.io/) —每天最多释放1 GB，保留3天
  * [papertrailapp.com](https://papertrailapp.com/) — 48小时搜索，7天存档，100 MB /月
  * [rollbar.com](https://rollbar.com) —每月最多可举办5000个活动，保留30天
...
## Monitoring
  ...
  * [nodequery.com](https://nodequery.com/) —免费的基本服务器监视器，最多可容纳10台服务器
  ...
  * [opsdash.com](https://www.opsdash.com/) —自托管服务器，群集和服务监控，可免费使用5个服务器和5个服务
...
## Crash and Exception Handling
  ...
  * [sentry.io](https://sentry.io/)  -Sentry实时跟踪应用程序异常，有一个小的免费计划.  如果是自托管的，则可以免费，不受限制地使用

## Search

  * [algolia.com](https://www.algolia.com/)  —托管的按需输入（即时）.  免费的黑客计划最多10,000个文档和100,000个操作.  更大的免费计划可用于社区/开源项目
  * [swiftype.com](https://swiftype.com/)  —托管搜索解决方案（API和搜寻器）.  一个最多包含1,000个文档的搜索引擎免费.  免费升级到高级版开源
  * [bonsai.io](https://bonsai.io/) —释放1 GB内存和1 GB存储空间
  * [searchly.com](http://www.searchly.com/) —免费的2个索引和5 MB的存储空间
  * [cloudsh.com](https://cloudsh.com/)  —使用几行JavaScript强大地搜索您的网站.  包含300个文档的免费个人计划.  免费提供多达10,000个文档的开放源代码.

## Email

  * [mailinator.com](https://www.mailinator.com/) —免费的公共电子邮件系统，您可以在其中使用所需的任何收件箱
  * [cloudmersive.com](https://www.cloudmersive.com/email-verification-api) —针对开发人员的电子邮件验证和验证API，每月10,000个免费API请求
  * [sparkpost.com](https://www.sparkpost.com/) —每月免费发送前15,000封电子邮件
  * [mailgun.com](https://www.mailgun.com/) —每月免费发送前10,000封电子邮件
  ...
  * [mailtrap.io](https://mailtrap.io/) -用于开发的假SMTP服务器，免费计划，带1个收件箱，50条消息，无团队成员，2封电子邮件/秒，无转发规则
  * [zoho.com](https://www.zoho.com/mail/) —多达25位用户的免费电子邮件管理和协作
...
## CDN and Protection
  ...
  * [raw.githack.com](https://raw.githack.com/) -现代化的** rawgit.com **，它仅使用Clouflare托管文件
  * [developers.google.com](https://developers.google.com/speed/libraries/) — Google Hosted Libraries是最流行的开源JavaScript库的内容分发网络
  * [Microsoft Ajax](https://docs.microsoft.com/en-us/aspnet/ajax/cdn/overview) — Microsoft Ajax CDN托管了流行的第三方JavaScript库，例如jQuery，使您能够轻松地将它们添加到Web应用程序中
...
## PaaS
  ...
  * [IBM Cloud](https://cloud.ibm.com/login) — IBM PaaS，每月免费
  ...
  * [zeit.co/now](https://zeit.co/now)  —用于Node.js，静态站点和Docker部署的托管平台.  限于3个并发实例，1 GB的存储空间和1 GB的OSS项目带宽（源文件公开在公共URL上）
  * [sandstorm.io](https://sandstorm.io/)  — Sandstorm是用于个人和私有云的开源操作系统.  免费计划提供200 MB存储空间和5粒免费
  ...
  * [gigalixir.com](https://gigalixir.com/) -Gigalixir为Elixir / Phoenix应用程序提供了1个不间断的免费实例，免费的PostgreSQL数据库限于2个连接，10、000行且没有备份.
...
## BaaS
  ...
  * [layer.com](https://layer.com/) —通讯的全栈基础
  ...
  * [getstream.io](https://getstream.io/) —在数小时而不是数周内构建可扩展的新闻提要和活动流，每月免费更新300万个提要
  * [tyk.io](https://tyk.io/)  —具有身份验证，配额，监视和分析的API管理.  免费云产品
...
## Web Hosting
  ...
  * [opeNode.io](https://www.openode.io/) —用于开源项目的免费云托管.
  * [kuber.host](https://kuber.host/) -Kubernetes免费计划托管
...
## DNS
  ...
  * [cloudns.net](https://www.cloudns.net/) —免费DNS托管多达3个域，且记录不受限制
...
## DBaaS
   ...
   * [ibm.com](https://www.ibm.com/cloud/cloudant) —来自IBM的托管数据库，免费1 GB
...
## STUN, WebRTC, Web Socket Servers and Other Routers
   ...
   * [segment.com](https://segment.com/)  -转换事件并将事件路由到其他第三方服务的集线器.  每月100,000个事件免费
...
## Issue Tracking and Project Management
   ...
   * [pivotaltracker.com](https://www.pivotaltracker.com/) — Pivotal Tracker，对于公共项目免费
   * [kanbantool.com](https://kanbantool.com/)  -基于看板委员会的项目管理.  免费的付费计划，更多选择
   ...
   * [LeanBoard](https://www.leanboard.io) —带有便笺的协作白板，用于GitHub问题（用于示例映射和其他技术）
   * [huboard.com](https://huboard.com/) —针对您的GitHub问题的即时项目管理，免费提供给开源
   * [taiga.io](https://taiga.io/) —适用于初创企业和敏捷开发人员的项目管理平台，免费提供给开源
   * [jetbrains.com](https://www.jetbrains.com/youtrack/buy) —针对FOSS项目，私人项目免费托管的YouTrack（InCloud）（10个用户免费）
   * [github.com](https://github.com/) —除了其Git存储设施外，GitHub还提供基本的问题跟踪
   * [asana.com](https://asana.com/) —与合作者一起私人项目免费
   * [acunote.com](https://www.acunote.com/) —免费的项目管理和SCRUM软件，最多可容纳5名团队成员
   ...
   * [targetprocess.com](https://www.targetprocess.com/)  —从看板和Scrum到几乎所有操作过程的可视项目管理.  无限用户免费使用，最多1000个数据实体{[more details](https://www.targetprocess.com/pricing/)}
   ...
   * [ubertesters.com](https://ubertesters.com/) —测试平台，集成和人群测试人员，2个项目，5名成员
   * [jetbrains.com](https://www.jetbrains.com/youtrack/buy/#edition=incloud)  —根据时间跟踪，Agile Board上的附件和许多其他改进进行搜索.  10个用户5 GB可用空间
   * [plan.io](https://plan.io/)  —通过存储库托管和mor选项进行项目管理.  2位拥有10位客户和500MB存储空间的用户免费
...
## Storage and Media Processing
   ...
   * [transloadit.com](https://transloadit.com/)  —处理文件上传以及视频，音频，图像，文档的编码.  免费提供开源和其他功能.  商业应用程序可免费获得1 GB的测试驱动器
   ...
   * [placekitten.com](https://placekitten.com/) —快速简单的服务，用于获取小猫图片以用作占位符
...
## Design and UI
  ...
  * [landen.co](https://www.landen.co)  —为启动创建，编辑和发布漂亮的网站和登录页面.  全部没有代码.  免费套餐允许您拥有一个完全可自定义的网站，并可以在网络上发布.
  * [pixlr.com](https://pixlr.com/) —在商业级别上免费的在线浏览器编辑器
  * [imagebin.ca](https://imagebin.ca/) —图像粘贴
  * [cloudconvert.com](https://cloudconvert.com/)  —将任何东西转换为任何东西.  208种支持的格式，包括将视频转换为gif
  * [resizeappicon.com](https://resizeappicon.com/) —调整和管理应用程序图标大小的简单服务
  * [vectr.com](https://vectr.com/) —适用于Web +桌面的免费设计应用
  * [clevebrush.com](https://www.cleverbrush.com/) —免费的图形设计/照片拼贴应用程序，他们还提供付费集成作为组件
  * [walkme.com](https://www.walkme.com/) —企业级指导和参与平台，免费计划3次步行，每次步行最多5步
  * [marvelapp.com](https://marvelapp.com/) —设计，原型制作和协作，可免费用于3个项目
...
## IDE and Code Editing
   ...
   * [codenvy.com](https://codenvy.com/) —浏览器中的IDE和自动开发人员工作区，协作式Git / SVN集成，在可定制的基于Docker的运行器中构建和运行您的应用程序（免费层包括：3 GB RAM，能够同时运行多台计算机），预先集成到Google Apps
   ...
   * [fakejson.com](https://fakejson.com/)  — FakeJSON可帮助您使用其API快速生成伪造数据.  发出一个API请求，描述您想要的东西和想要的方式.  API以JSON返回所有内容.  加快进入市场的过程，寻找创意并进行伪造，直到实现为止.
   * [JSONPlaceholder](http://jsonplaceholder.typicode.com/)  一些REST API端点以JSON格式返回一些虚假数据.  如果要在本地运行服务器，也可以使用源代码.
   * [jetbrains.com](https://jetbrains.com/products.html)  —生产力工具，IDE和部署工具.  学生，老师，开源和用户组的免费许可证
...
## Analytics, Events and Statistics
   ...
   * [sematext.com](https://sematext.com/cloud/) —免费，每月最多可进行5万次操作，保留1天的数据，无限制的仪表板，用户等
...
## Payment / Billing Integration
  ...
  * [braintreepayments.com](https://www.braintreepayments.com/)  -信用卡，Paypal，Venmo，比特币，Apple Pay，...集成.  一次性和经常性付款.  首50,000美元免费
...
## Docker Related
  ...
  * [PWD](https://labs.play-with-docker.com/)  —与Docker一起玩.  一个简单，互动且有趣的游乐场，可学习Docker
...
## Miscellaneous
  ...
  * [superfeedr.com](https://superfeedr.com/)  –实时兼容PubSubHubbub的供稿，导出，分析等功能； －符合pubSubHubbube标准的实时供稿，导出与分析.（http://www.pubshubbbu.com）.（http://www1.com.cn.tw/）（https：//sub.hubb-ub//）（http）（https / support（pub）.com）（http：//support/pubs.com-pubs/communal/com/bsubsubhubb-ubs-）实时订阅.订阅（SubSub）-订阅（Find）....订阅-支持Subsub-Hubbub.--------.？？？！？！？！？？！.！.？？！.-的---！？？？？ ！！？！？？.！！！.？？？？？！.？.！.！？？ ！！？.！！？！？！！.！.？.！.？.！.？！.！？？.  免费，定制更少
  ...
  * [readme.com](https://readme.com/) -易于使用的精美文档，免费提供给开源：请参阅 [here](https://readme.readme.io/docs/open-source).
