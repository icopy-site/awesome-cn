...
- [Fund Club](http://joinfundclub.com/) -Fund Club为心理健康，多样性，包容性，抗骚扰等更多计划筹集资金.
- [Geek Girls Carrots](http://gocarrots.org) -自2011年起吸引女性加入科技领域.
- [Girl Develop It](https://www.girldevelopit.com/) -成立的非营利组织，旨在为有兴趣学习网络和软件开发的女性提供负担得起的且不受评判的机会.
...
- [Trans*H4CK](http://www.transhack.org/) -Trans \ * H4CK通过改善人们获得社会服务的机会，促进性别安全和社区可持续性，同时为跨性别*技术创新者和企业家提供可见性，为跨性别者，性别不合格者，性别和非二元人群提供支持.
...
- [Women Hack For Non-Profits](http://www.womenhackfornonprofits.com/) -一个由妇女组成的社区，致力于为非营利组织和有事业的个人建立开源项目.
...
- [ACT-W National Conference](http://www.act-w.org/) -由ChickTech主办的ACT-W National致力于为您提供有关职业发展，领导才能，技术和多样性的启发性和可行的教育.
...
支持代表性不足的小组以及您可以参加的开源项目.

- [A11y Project](https://www.a11yproject.com/) -由社区推动的努力，以简化数字无障碍获取.
- [Accessibility Cloud](https://www.accessibility.cloud/) -以标准化的，面向未来的，易于使用的方式简化了共享和获取可访问性数据.
- [CHAOSS D&I Workgroup](https://chaoss.community/metrics/) -收集项目资源以创建多样性和包容性报告.
- [Chayn](https://chayn.co/) -一个志愿者网络，通过在网上创建由幸存者主导的交叉资源，在全球范围内应对基于性别的暴力.
- [Diversity Tickets](https://diversitytickets.org/)  -帮助活动吸引了更多的受众. 并帮助您找到这些事件.
- [SignDict](https://signdict.org/) -一个开放的手语词典.
- [The Supernova Project](http://supernovaproject.org/) -旨在为解决LGBTQIA +社区内的虐待问题做出贡献的全球努力.
- [Wheelmap](https://wheelmap.org/) -世界上最大的面向轮椅可通行场所的众包和开放式数据库.
- [WikiProject Women in Red](https://en.wikipedia.org/wiki/Wikipedia:WikiProject_Women_in_Red) -通过传记和有关妇女成就的文章来增加妇女在维基百科上的代表性.
...
- [Gender Bias? A Transgender Perspective!](https://code.likeagirl.io/gender-bias-a-transgender-perspective-de27f2cd3837) -Daniela Petruzalek着.
...
- [9 Ways To Stop Hurting And Start Helping Women In Tech](https://www.youtube.com/watch?v=pUVhF3jDG08) -作者：Brianna Wu.
