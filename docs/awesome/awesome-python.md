...
* [django-grappelli](https://grappelliproject.com/) -  Django Admin-Interface的爵士皮肤.
...
* JWT
    * [pyjwt](https://github.com/jpadilla/pyjwt) -  Python中的JSON Web Token实现.
...
* [DottedDict](https://github.com/carlosescri/DottedDict) - 一个库，它提供了一种使用虚线路径表示法访问列表和dicts的方法.
...
* [HermesCache](https://pypi.org/project/HermesCache/) -  Python缓存库，具有基于标记的失效和防狗效应.
...
* [errbot](https://github.com/errbotio/errbot/) - 实现ChatOps的最简单，最流行的聊天机器人.

## Code Analysis

 *静态分析工具，linters和代码质量检查器.  另见 [awesome-static-analysis](https://github.com/mre/awesome-static-analysis).*
...
* [concurrent.futures](https://docs.python.org/3/library/concurrent.futures.html) - （Python标准库）用于异步执行callables的高级接口.
...
* [pickleDB](https://github.com/patx/pickledb) -  Python的简单轻量级键值存储.
...
* NoSQL数据库
    ...
    * [py2neo](https://py2neo.org/) -  Neo4j的restful接口的Python包装器客户端.
...
*类似pdb的调试器
    ...
    * [pdb++](https://github.com/antocuni/pdb) -  pdb的另一个替代品.
...
*追踪
    ...
    * [manhole](https://github.com/ionelmc/python-manhole) - 调试UNIX套接字连接并显示所有线程的堆栈跟踪和交互式提示.
...
* [pdoc](https://github.com/mitmproxy/pdoc) -  Epydoc替换为自动生成Python库的API文档.
...
* [youtube-dl](https://rg3.github.io/youtube-dl/) - 从YouTube下载视频的小型命令行程序.
...
* [money](https://github.com/carlospalol/money) - “Money”类，具有可选的CLDR支持的区域设置感知格式和可扩展的货币交换.
...
* [pipenv](https://github.com/pypa/pipenv) - 人类的Python开发工作流程.
* [poetry](https://github.com/sdispater/poetry) -  Python依赖管理和打包变得简单.
* [virtualenv](https://github.com/pypa/virtualenv) - 创建独立Python环境的工具.
...
* [cffi](https://pypi.org/project/cffi/) - 用于Python的外部函数接口调用C代码.
...
* [Eel](https://github.com/ChrisKnott/Eel) - 用于制作简单的类似电子离线HTML / JS GUI应用程序的库.
...
* [PyQt](https://riverbankcomputing.com/software/pyqt/intro) -  Python的绑定 [Qt](https://www.qt.io/) 跨平台应用程序和UI框架.
* [PySimpleGUI](https://github.com/PySimpleGUI/PySimpleGUI) -  tkinter，Qt，WxPython和Remi的包装.
...
* [Jython](https://hg.python.org/jython) - 为Java编写用于JVM的Python编程语言的实现.
...
- 中国人
    ...
    * [pkuseg-python](https://github.com/lancopku/pkuseg-python) - 各种领域中的中文分词工具包.
...
* [mininet](https://github.com/mininet/mininet) - 一种流行的网络模拟器和用Python编写的API.
...
* [pyzmq](https://github.com/zeromq/pyzmq) -  ZeroMQ消息库的Python包装器.
...
*关系数据库
    ...
    * [pony](https://github.com/ponyorm/pony/) - 为SQL提供面向生成器的接口的ORM.
    * [pydal](https://github.com/web2py/pydal/) - 纯Python数据库抽象层.
* NoSQL数据库
    * [hot-redis](https://github.com/stephenmcd/hot-redis) -  Redis的丰富Python数据类型.
    * [mongoengine](https://github.com/MongoEngine/mongoengine) - 用于处理MongoDB的Python Object-Document-Mapper.
...
*框架不可知
    ...
    * [hug](https://github.com/timothycrosley/hug) - 用于干净地公开API的Python 3框架.
 ...
 *科学计算的图书馆.  另见 [Python-for-Scientists](https://github.com/TomNicholas/Python-for-Scientists)*
...
* [marshmallow](https://github.com/marshmallow-code/marshmallow) - 一个轻量级库，用于将复杂对象转换为简单的Python数据类型.
...
*测试框架
    ...
    * [hypothesis](https://github.com/HypothesisWorks/hypothesis) - 假设是一种基于Quickcheck风格的高级属性测试库.
...
* GUI / Web测试
    ...
    * [Selenium](https://pypi.org/project/selenium/) -  Python绑定 [Selenium](http://www.seleniumhq.org/) 的webdriver.
...
*模拟
    ...
    * [doublex](https://pypi.org/project/doublex/) - 强大的测试加倍Python的框架.
...
* 一般
    ...
    * [textdistance](https://github.com/orsinium/textdistance) - 使用30+算法计算序列之间的距离.
...
* [moviepy](https://zulko.github.io/moviepy/) - 基于脚本的电影编辑模块，具有多种格式，包括动画GIF.
...
* [werkzeug](https://github.com/pallets/werkzeug) - 用于Python的WSGI实用程序库，可以为Flask提供支持，并且可以轻松嵌入到您自己的项目中.
...
* [feedparser](https://pythonhosted.org/feedparser/) - 通用饲料解析器.
...
* [autobahn-python](https://github.com/crossbario/autobahn-python) - 扭曲和扭曲的Python的WebSocket和WAMP [asyncio](https://docs.python.org/3/library/asyncio.html).
...
*另见 [awesome-CIandCD](https://github.com/ciandcd/awesome-ciandcd#online-build-system).*
...
## Contributing
 ...
 欢迎您的贡献！  请看看 [contribution guidelines](https://github.com/vinta/awesome-python/blob/master/CONTRIBUTING.md) 第一.

如果我不确定这些库是否真棒，我会保留一些拉请求，你可以 [vote for them](https://github.com/vinta/awesome-python/pulls)  通过添加：+ 1：给他们.  拉票请求将在他们的票数达到** ** **时合并.

- - -

如果您对此列表有任何疑问，请随时与我联系 [@vinta](https://twitter.com/vinta) 在Twitter上或在GitHub上打开一个问题.
