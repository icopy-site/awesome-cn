...
*元数据
    ...
    * [eyeD3](https://github.com/nicfit/eyeD3) -处理音频文件的工具，特别是包含ID3元数据的MP3文件.
...
* [python-modernize](https://github.com/mitsuhiko/python-modernize) -现代化Python代码，以便最终进行Python 3迁移.
...
* [pycco](https://github.com/pycco-docs/pycco) -文体编程风格的文档生成器.
...
* [alipay](https://github.com/lxneng/alipay) -适用于Python的非官方Alipay API.
...
* [merchant](https://github.com/agiliq/merchant) -一个Django应用，可以接受来自各种付款处理器的付款.
...
* [ctypes](https://docs.python.org/3/library/ctypes.html) -（Python标准库）外部函数接口，用于Python调用C代码.
...
* [Coconut](http://coconut-lang.org/) -Coconut是Python的一种变体，专为简单，优雅，Pythonic函数式编程而构建.
...
* [pyglet](https://bitbucket.org/pyglet/pyglet/wiki/Home) -适用于Python的跨平台窗口和多媒体库.
...
* [pyBarcode](https://pythonhosted.org/pyBarcode/) -在Python中创建条形码，而无需PIL.
...
* [Eliot](https://github.com/ScatterHQ/eliot) -记录复杂的分布式系统.
...
* [raven](https://github.com/getsentry/raven-python) -Sentry的Python客户端，一个用于Web应用程序的日志/错误跟踪，崩溃报告和聚合平台.
...
* [xgboost](https://github.com/dmlc/xgboost) -可扩展，便携式和分布式的梯度增强库.
...
* [pulsar](https://github.com/quantmind/pulsar) -事件驱动的Python并发框架.
...
* [mrq](https://github.com/pricingassistant/mrq) -Mr. Queue-使用Redis和gevent的Python中的分布式工作者任务队列.
...
* [annoy](https://github.com/spotify/annoy) -C ++ / Python中的近似最近邻居针对内存使用进行了优化.
...
* 烧瓶
    ...
    * [flask-api-utils](https://github.com/marselester/flask-api-utils) -注意Flask的API表示和身份验证.
...
* [SimPy](https://bitbucket.org/simpy/simpy) -基于过程的离散事件模拟框架.
...
*测试框架
    ...
    * [hypothesis](https://github.com/HypothesisWorks/hypothesis) -假设是一个基于Quickcheck样式属性的高级测试库.
...
* GUI / Web测试
    ...
    * [PyAutoGUI](https://github.com/asweigart/pyautogui) -PyAutoGUI是适用于人类的跨平台GUI自动化Python模块.
...
* 一般
    * [chardet](https://github.com/chardet/chardet) -兼容Python 2/3的字符编码检测器.
    * [difflib](https://docs.python.org/3/library/difflib.html) -（Python标准库）用于计算增量的帮助程序.
    * [ftfy](https://github.com/LuminosoInsight/python-ftfy) -使Unicode文本更容易打乱，并更加一致.
...
* [portia](https://github.com/scrapinghub/portia) -视觉刮刮.
...
* [autobahn-python](https://github.com/crossbario/autobahn-python) -适用于Twisted和Python的WebSocket和WAMP [asyncio](https://docs.python.org/3/library/asyncio.html).
* [crossbar](https://github.com/crossbario/crossbar/) -开源统一应用路由器（用于高速公路上的Python的Websocket和WAMP）.
* [django-channels](https://github.com/django/channels) -适用于Django的开发人员友好型异步.
* [django-socketio](https://github.com/stephenmcd/django-socketio) -适用于Django的WebSockets.
* [WebSocket-for-Python](https://github.com/Lawouach/WebSocket-for-Python) -适用于Python 2和3以及PyPy的WebSocket客户端和服务器库.
...
*另请参阅 [awesome-CIandCD](https://github.com/ciandcd/awesome-ciandcd#online-build-system).*
