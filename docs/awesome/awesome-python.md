...
* 声音
    ...
    * [matchering](https://github.com/sergree/matchering) -自动参考音频母带库.
...
* OAuth
    * [authlib](https://github.com/lepture/authlib) -JavaScript对象签名和加密草稿实现.
...
* [DottedDict](https://github.com/carlosescri/DottedDict) -一种库，提供一种使用点路径符号访问列表和字典的方法.
...
* [django-cacheops](https://github.com/Suor/django-cacheops) -光滑的ORM高速缓存，具有自动的粒度事件驱动的失效功能.
* [dogpile.cache](http://dogpilecache.readthedocs.io/en/latest/) -dogpile.cache是​​同一作者制作的Beaker的下一代替代产品.
* [HermesCache](https://pypi.org/project/HermesCache/) -具有基于标签的失效和防止堆效应的Python缓存库.
* [pylibmc](https://github.com/lericson/pylibmc) -围绕的Python包装器 [libmemcached](https://libmemcached.org/libMemcached.html) 界面.
 ...
 *静态分析，棉短绒和代码质量检查器的工具. 另请参阅 [awesome-static-analysis](https://github.com/mre/awesome-static-analysis).*
...
*代码分析
    ...
    * [pycallgraph](https://github.com/gak/pycallgraph) -一个可视化您的Python应用程序流程（调用图）的库.
...
*静态类型检查器，另请参阅 [awesome-python-typing](https://github.com/typeddjango/awesome-python-typing)
    ...
    * [pyre-check](https://github.com/facebook/pyre-check) -执行者类型检查.
...
* CLI增强功能
    ...
    * [iredis](https://github.com/laixintao/iredis) -具有自动补全功能和语法突出显示功能的Redis CLI.
    ...
    * [pgcli](https://github.com/dbcli/pgcli) -具有自动补全功能和语法突出显示功能的PostgreSQL CLI.
...
* [tesserocr](https://github.com/sirfz/tesserocr) -用于OCR的tesseract-ocr API的另一个简单的，对枕头友好的包装.
...
* [bqplot](https://github.com/bloomberg/bqplot) -用于Jupyter笔记本的交互式绘图库
...
* MySQL- [awesome-mysql](http://shlomi-noach.github.io/awesome-mysql/)
    * [mysqlclient](https://github.com/PyMySQL/mysqlclient-python) -具有Python 3支持的MySQL连接器（[mysql-python](https://sourceforge.net/projects/mysql-python/) 叉）.
...
* SQlite- [awesome-sqlite](https://github.com/planetopendata/awesome-sqlite)
    ...
    * [SuperSQLite](https://github.com/plasticityai/supersqlite) -内置于SQLite之上的超强SQLite库 [apsw](https://github.com/rogerbinns/apsw).
*其他关系数据库
...
* [Chronyk](https://github.com/KoffeinFlummi/Chronyk) -用于解析人类编写的时间和日期的Python 3库.
...
*追踪
    ...
    * [pyringe](https://github.com/google/pyringe) -能够附加到Python进程并向其中注入代码的调试器.
...
*个人资料
    ...
    * [py-spy](https://github.com/benfred/py-spy)  -用于Python程序的采样分析器. 写在铁锈.
    * [pyflame](https://github.com/uber/pyflame) -用于Python的跟踪分析器.
    * [vprof](https://github.com/nvdv/vprof) -视觉Python探查器.
* 其他
    * [django-debug-toolbar](https://github.com/jazzband/django-debug-toolbar) -显示Django的各种调试信息.
    * [django-devserver](https://github.com/dcramer/django-devserver) -Django的运行服务器的直接替代品.
...
* [keras](https://github.com/keras-team/keras) -高级神经网络库，能够在TensorFlow或Theano上运行.
...
*流处理
    * [faust](https://github.com/robinhood/faust) -流处理库，从中移植思想 [Kafka Streams](https://kafka.apache.org/documentation/streams/) 到Python.
...
* [pynsist](http://pynsist.readthedocs.io/en/latest/) -一种用于构建Windows安装程序的工具，安装程序将Python本身捆绑在一起.
* [shiv](https://github.com/linkedin/shiv) -命令行实用程序，用于构建完全独立的zipapp（PEP 441），但包括其所有依赖项.
...
* [akshare](https://github.com/jindaxiang/akshare) -为人类而建的财务数据接口库！
...
* [fn.py](https://github.com/kachayev/fn.py) -Python中的函数式编程：实现缺少功能以享受FP的乐趣.
...
* [Gooey](https://github.com/chriskiehl/Gooey) -将命令行程序转换为只有一行的完整GUI应用程序.
* [kivy](https://kivy.org/) -用于在Windows，Linux，Mac OS X，Android和iOS上运行的用于创建NUI应用程序的库.
...
* [tartiflette-aiohttp](https://github.com/tartiflette/tartiflette-aiohttp/) -基于Aiohttp的包装，用于Tartiflette，可通过HTTP公开GraphQL API.
...
* [PyOgre](http://www.ogre3d.org/tikiwiki/PyOgre) -Ogre 3D渲染引擎的Python绑定，可用于游戏，模拟和任何3D.
...
* [pyquery](https://github.com/gawel/pyquery) -用于解析HTML的类似jQuery的库.
* [untangle](https://github.com/stchris/untangle) -将XML文档转换为Python对象，以方便访问.
...
* [pygram](https://github.com/ajkumar25/pygram) -像Instagram一样的图像过滤器.
* [PyMatting](http://github.com/pymatting/pymatting) -用于Alpha遮罩的库.
...
* [CPython](https://github.com/python/cpython) -**使用C语言编写的Python编程语言的默认，使用最广泛的实现.**
...
* [Jupyter Notebook (IPython)](https://jupyter.org) -丰富的工具包，可帮助您充分利用交互式Python的功能.
    * [awesome-jupyter](https://github.com/markusschanta/awesome-jupyter)
* [ptpython](https://github.com/jonathanslenders/ptpython) -建立在上层的进阶Python REPL [python-prompt-toolkit](https://github.com/jonathanslenders/python-prompt-toolkit).
...
* [Plan](https://github.com/fengsp/plan) -用Python编写魅力十足的crontab文件.
* [Prefect](https://github.com/PrefectHQ/prefect) -现代的工作流程编排框架，可轻松构建，安排和监视强大的数据管道.
 ...
 *机器学习图书馆. 另请参阅 [awesome-machine-learning](https://github.com/josephmisiti/awesome-machine-learning#python).*
...
* [pythonlibs](http://www.lfd.uci.edu/~gohlke/pythonlibs/) -适用于Python扩展程序包的非官方Windows二进制文件.
...
* [WinPython](https://winpython.github.io/) -Windows 7/8的便携式开发环境.
...
* [pip](https://pip.pypa.io/en/stable/) -适用于Python的软件包安装程序.
    * [pip-tools](https://github.com/jazzband/pip-tools) -一组工具，可让您固定的Python依赖关系保持最新状态.
    * [PyPI](https://pypi.org/)
 ...
 * [Bowler](https://pybowler.io/) -用于现代Python的安全代码重构.
...
* Django
    * [django-rest-framework](http://www.django-rest-framework.org/) -强大而灵活的工具包，用于构建Web API.
 ...
 *用于科学计算的图书馆. 另请参阅 [Python-for-Scientists](https://github.com/TomNicholas/Python-for-Scientists).*

* [astropy](http://www.astropy.org/) -天文学的社区Python库.
* [bcbio-nextgen](https://github.com/chapmanb/bcbio-nextgen) -提供最佳实践流水线，用于全自动高通量测序分析.
* [bccb](https://github.com/chapmanb/bcbb) -收集与生物学分析有关的有用代码.
* [Biopython](http://biopython.org/wiki/Main_Page) -Biopython是一套免费的生物计算工具.
* [cclib](http://cclib.github.io/) -用于解析和解释计算化学程序包结果的库.
...
* [whoosh](http://whoosh.readthedocs.io/en/latest/) -快速，纯正的Python搜索引擎库.
...
* [ultrajson](https://github.com/esnme/ultrajson) -使用C编写的带有Python绑定的快速JSON解码器和编码器.
...
* 一般
    * [tablib](https://github.com/jazzband/tablib) -XLS，CSV，JSON，YAML中的表格数据集的模块.
* 办公室
...
*降价
    * [Mistune](https://github.com/lepture/mistune) -Markdown最快，功能最全的纯Python解析器.
...
*测试框架
    ...
    * [nose2](https://github.com/nose-devs/nose2) -基于`unittest2&#39;的`nose`的后继者.
...
* GUI / Web Testing
    ...
    * [Schemathesis](https://github.com/kiwicom/schemathesis) -使用Open API / Swagger规范构建的用于对Web应用程序进行基于属性的自动测试的工具.
...
* 嘲笑
    ...
    * [httmock](https://github.com/patrys/httmock) -用于Python 2.6+和3.2+的请求的模拟库.
    ...
    * [VCR.py](https://github.com/kevin1024/vcrpy) -在测试中记录并重播HTTP交互.
*对象工厂
...
* Sl
    ...
    * [unicode-slugify](https://github.com/mozilla/unicode-slugify) -一个生成器，它以Django为依赖关系生成unicode代码段.
*唯一标识符
    * [hashids](https://github.com/davidaurelio/hashids-python) - 实施 [hashids](http://hashids.org) 在Python中.
    * [shortuuid](https://github.com/skorokithakis/shortuuid) -生成器库，用于简洁，明确和URL安全的UUID.
*解析器
 ...
 *用于访问第三方服务API的库. 另请参阅 [List of Python API Wrappers and Libraries](https://github.com/realpython/list-of-python-api-wrappers).*

* [apache-libcloud](https://libcloud.apache.org/) -适用于所有云的一个Python库.
...
* [purl](https://github.com/codeinthehole/purl) -一个简单，不可变的URL类，带有用于查询和操作的干净API.
* [pyshorteners](https://github.com/ellisonleao/pyshorteners) -一个纯Python URL缩短库.
...
* [webassets](https://github.com/miracle2k/webassets) -为静态资源捆绑，优化和管理唯一的缓存无效化URL.
...
* [websockets](https://github.com/aaugustin/websockets) -一个用于构建WebSocket服务器和客户端的库，其重点是正确性和简单性.
...
* [uWSGI](https://uwsgi-docs.readthedocs.io/en/latest/) -一个项目旨在开发使用C编写的用于构建托管服务的完整堆栈.
...
永远欢迎您的贡献！ 请看看 [contribution guidelines](https://github.com/vinta/awesome-python/blob/master/CONTRIBUTING.md) 第一的.

如果不确定这些库是否很棒，我将打开一些拉取请求，您可以 [vote for them](https://github.com/vinta/awesome-python/pulls) 通过添加：+1：到他们. 当请求的投票达到** 20 **时，合并请求将被合并.
