...
* [shenv](https://github.com/shenv/shenv) -简单的外壳版本管理
...
* [boilr](https://github.com/tmrts/boilr) -极为快速的CLI工具，用于从样板模板创建项目.
...
* [fasd](https://github.com/clvv/fasd) -命令行生产力增强器，可快速访问文件和目录
...
* [how2](https://github.com/santinic/how2)  -`how2`寻找在UNIX shell中做某事的最简单方法. 就像`man`，但是您可以用自然语言查询它.
...
* [percol](https://github.com/mooz/percol) -在UNIX shell的传统管道概念中增加了交互式过滤的味道
...
* [surfraw](https://gitlab.com/surfraw/Surfraw) -浏览特定站点并从没有浏览器的终端上搜索网络.
...
* [forgit](https://github.com/wfxr/forgit) -利用模糊查找器fzf的`git`工具.
...
* [bat](https://github.com/sharkdp/bat) -有翅膀的`猫`克隆
...
* [xidel](https://github.com/benibela/xidel/) -Cli工具，用于（使用图灵完备的）XPath和XQuery来过滤，映射和创建HTML / XML / JSON数据.
...
* [pockyt](https://github.com/achembarpu/pockyt) -阅读，管理和自动化您 [Pocket](https://getpocket.com) 采集.
* [pushblast](https://github.com/alebcay/pushblast) -在Shell程序退出时获取PushBullet通知
...
* [critic.sh](https://github.com/Checksum/critic.sh) -具有覆盖率报告的Bash简陋的简单测试框架
* [esh](https://github.com/jirutka/esh) -一个简单的基于shell的模板引擎，在POSIX shell和awk的约290行中实现.
* [Fishtape](https://github.com/jorgebucaran/fishtape) -TAP生产商和鱼类测试线束
...
* [Greg Wooledge's (aka "greycat") wiki](https://mywiki.wooledge.org).
  特别 [Bash Guide](https://mywiki.wooledge.org/BashGuide), [Bash FAQ](https://mywiki.wooledge.org/BashFAQ) 和 [Bash Pitfalls](https://mywiki.wooledge.org/BashPitfalls)
