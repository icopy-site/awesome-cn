...
* [es](https://wryun.github.io/es-壳/) -基于计划9的可扩展外壳 [rc](https://github.com/rakitzis/rc) 壳
...
* [yash](https://yash.osdn.jp/) -符合POSIX的命令行外壳，内置支持基于命令历史记录的完成和预测
* [zsh](https://www.zsh.org) -强大的脚本语言外壳
...
* [bashhub](https://github.com/rcaloras/bashhub-client)  -：cloud：Bash在云端的历史记录. 索引和可搜索.
...
* [eureka](https://github.com/simeg/eureka/) -：bulb：CLI工具，用于输入和存储您的想法而无需离开终端
* [fasd](https://github.com/clvv/fasd) -命令行生产力提升器，提供对文件和目录的快速访问
...
* [k](https://github.com/supercrabtree/k) -k是一个Zsh脚本，可提高目录列表的可读性，并添加Git状态，文件重量颜色和腐烂日期
...
* [mcfly](https://github.com/cantino/mcfly)  -浏览您的shell历史记录. 伟大的苏格兰人！
...
* [pathpicker](https://github.com/facebook/PathPicker)  -接受grep，searchs，git等输入； 允许从输入结果中选择文件，然后您可以打开文件或将其提供为命令的参数.
* [pdd](https://github.com/jarun/pdd) -带有计时器的小日期，时差计算器
...
* [spark](https://github.com/holman/spark) -shell在你的壳里
...
* [surfraw](https://gitlab.com/surfraw/Surfraw) -浏览特定站点并在没有浏览器的情况下从终端搜索网络.
...
* [undollar](https://github.com/xtyrrell/undollar) -美元刚从您刚粘贴到终端的命令提示中咬掉美元符号
...
* [bashmarks](https://github.com/huyng/bashmarks) -外壳程序的目录书签
...
* [zpyi](https://github.com/sakshamsharma/zpyi) -Zsh中的Python-Shell中的简单python脚本
...
* [bash-git-prompt](https://github.com/magicmonty/bash-git-prompt) -为Git用户提供的信息丰富且新颖的Bash提示
...
* [flatui-terminal-theme](https://dribbble.com/shots/1021755-Flat-UI-Terminal-Theme) -端子颜色更好
...
* [powerlevel10k](https://github.com/romkatv/powerlevel10k) -超级灵活的电源线ZSH主题
...
* [bitwise](https://github.com/mellowcandle/bitwise) -以诅咒为基础的基于终端的交互式位操纵器.
* [bocker](https://github.com/p8952/bocker) -以100行bash实施Docker
...
* [getopts.fish](https://github.com/jorgebucaran/getopts.fish) -鱼的CLI解析器
...
* [bmon](https://github.com/tgraf/bmon) -实时网络带宽监控器和速率估计器，具有人性化的视觉输出
...
* [lnav](https://lnav.org) -小型的高级日志文件查看器
...
* [maza](https://github.com/tanrax/maza-ad-blocking)  -本地广告拦截器. 像Pi-hole一样，但在本地使用操作系统.
...
* [procdog](https://github.com/jlevy/procdog) -轻量级的命令行控制，例如服务器等长期存在的进程
...
* [bitpocket](https://github.com/sickill/bitpocket) -“ DIY Dropbox”或“ 2向目录（r）同步并正确删除”
* [Dropbox-Uploader](https://github.com/andreafabrizi/Dropbox-Uploader) -Dropbox Uploader是一个Bash脚本，可用于从Dropbox上传，下载，列出或删除文件
* [httpie](https://github.com/httpie/httpie) -HTTPie是命令行HTTP客户端，一种用户友好的cURL替代
...
* [vesper](https://github.com/chris-rock/vesper) -Vesper是用于Bash / Unix Shell的HTTP框架
* [youtube-dl](https://yt-dl.org/) -小型命令行程序，可从YouTube.com和其他视频网站下载视频
...
* [jq](https://github.com/stedolan/jq)  -通过sed获取json数据. 您可以使用它来切片和过滤以及映射和转换结构化数据
...
* [visidata](https://github.com/saulpw/visidata) -用于浏览和整理数据的终端电子表格多功能工具（csv / json / xml / xls / yaml / etc）
* [xidel](https://github.com/benibela/xidel/) -Cli工具，用于过滤，映射和创建带有（图灵完备的）XPath和XQuery的HTML / XML / JSON数据.
* [xmlstarlet](http://xmlstar.sourceforge.net/) -旧的但功能强大的工具，用于命令行XML格式设置，过滤和操作.
...
* [hn-cli](https://github.com/rafaelrinaldi/hn-cli) -在舒适的终端上浏览Hacker News
* [iponmap](https://github.com/nogizhopaboroda/iponmap) -使用IP地址在世界地图上绘制点
* [isitup](https://github.com/lord63/isitup) -检查网站是否开启或关闭
* [jrnl](https://github.com/jrnl-org/jrnl) -一个简单的命令行日志应用程序，将您的日志存储在纯文本文件中
* [kanban.bash](https://github.com/coderofsalvation/kanban.bash) -命令行ASCIII看板，用于最低限度的bash黑客（基于csv）
* [ledger](https://github.com/ledger/ledger) -命令行记帐
* [licen](https://github.com/lord63/licen)  -生成您的许可证. 另一个虱子，但使用Jinja2和docopt实施
...
* [transfer.sh](https://transfer.sh/) —快速从外壳程序上传和共享文件
...
* [minesweeper](https://github.com/feherke/Bash-script/tree/master/minesweeper) -扫雷的重击实施
* [nudoku](https://github.com/jubalh/nudoku) -用C语言编写的基于ncurses的数独游戏
* [piu-piu](https://github.com/vaniacer/piu-piu-SH) -在bash中使用多人游戏模式进行水平滚动游戏！
...
* [dotfiler](https://github.com/svetlyak40wt/dotfiler) –使用Python编写的基于Shell不可知git的dotfiles程序包管理器.
...
* [yadm](https://yadm.io/) -基于Git的dotfiles管理器，支持加密，替代和自举
...
* [bashful](https://github.com/jmcantrell/bashful) -简化了编写Bash脚本的库的集合
...
* [esh](https://github.com/jirutka/esh) -一个基于shell的简单模板引擎，在POSIX shell和awk的约290行中实现.
...
* [rerun](https://github.com/rerun/rerun) -模块化的外壳自动化框架，用于组织您的管理者脚本
