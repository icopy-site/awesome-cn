...
| [Flow](https://www.getflow.com) | [@flowapp](https://twitter.com/flowapp)  |  $ 19 / mo-$ 249 / mo |  停止从收件箱管理项目.  Flow是适用于Web和iPhone的协作式任务管理应用程序.  |
...
| [LeanKit](https://leankit.com) | [@leankit](https://twitter.com/leankit)  |  $ 15 / mo-$ 19 / mo |  即时项目可见性.  在LeanKit中，您可以将组织的流程映射到虚拟白板上.  在每个板上，过程步骤均表示为垂直和水平通道.  卡片代表工作项目，团队成员在完成工作共享时会进行全面更新和迁移.  经理和客户无需查看状态报告，而只需查看董事会即可.  董事会更新在几秒钟内在全球范围内可见，并且电子邮件警报和RSS feed可用，因此您和您的团队可以立即采取措施解决问题，直到问题变得严重为止.  |
...
| [Chartio](https://chartio.com) | [@chartio](https://twitter.com/chartio)  |  -|  使用Chartio可视化和浏览数据.  通过直观的拖放界面创建交互式图表和完善的仪表板.  一次单击即可从基本表切换到复杂的数据可视化.  强大的过滤器使您可以对数据进行切片和切块，并且无需进行任何配置即可深入了解大多数图表.  |
...
| [Google Analytics](https://marketingplatform.google.com/about/analytics/) | [@GMktgPlatform](https://twitter.com/GMktgPlatform)  |  -|  Google Analytics（分析）可让您评估广告的投资回报率，并跟踪Flash，视频以及社交网站和应用程序.  |
...
| [Localytics](https://www.localytics.com) | [@localytics](https://twitter.com/localytics/)  |  释放多达1万个MAU，月费为$ 200-高于$ 2700 / mo |  找出在您的移动或网络应用中有效的方法.  做更多.  全部集中在一处.  高级分析功能可提供数据和见解，以帮助您构建更成功的应用程序.  整合行销可协助您轻松吸引和吸引更多客户.  |
...
| [Monkey Test It](https://monkeytest.it) | [@monkeytestit](https://twitter.com/monkeytestit)  |  $ 0 /月-$ 199 /月|  自动化的网站检查工具，可在用户操作之前捕获网站上的错误（链接断开，图像丢失，JS错误等）.  与Slack，大多数CI系统，webook集成，并支持内置调度.  |
...
| [Grafana](https://grafana.com) | [@grafana](https://twitter.com/grafana)  |  $ 0-$ 90 / mo（+ 9 / user / mo）|  您所有指标的分析平台.  Grafana允许您查询，可视化，警报和了解指标，无论它们存储在哪里.  与您的团队一起创建，浏览和共享仪表板，并培养一种数据驱动的文化.  |
...
| [Stackify](https://stackify.com) | [@Stackify](https://twitter.com/Stackify)  |  $ 15 / mo |  为您连接点.  Stackify专注于应用程序运行状况，为开发人员，运营和支持团队扩大了关键见解.  |
...
| [Loader.io](https://loader.io) | [@loaderio](https://twitter.com/loaderio)  |  免费至100.00 $ /月|  Loader.io是一项免费负载测试服务，可让您通过数千个并发连接对您的Web应用/ API进行压力测试.  |
...
### Server Monitoring
 ...
 |  服务|  推特|  定价|  描述
|:--------|:--------|:--------|:------------|
| [Server Density](https://www.serverdensity.com) | [@serverdensity](https://twitter.com/serverdensity)  |  -|  高级托管网站和服务器监视工具.  您的所有活动均实时同步-从启动新实例到升级或删除旧实例.  通过Web，移动设备，API或直接与您的提供商一起在任何地方工作.  一切保持同步.  |
| [Datadog](https://www.datadoghq.com) | [@datadoghq](https://twitter.com/datadoghq)  |  $ 0 / mo-$ 15 /主机/ mo |  Datadog是为IT，运营和开发团队提供的监视服务，这些团队大规模编写和运行应用程序，并希望将其应用程序，工具和服务所产生的大量数据转化为可行的见解.  |
...
| [Groove](https://www.groovehq.com) | [@groove](https://twitter.com/groove)  |  $ 15 / mo |  为每位客户提供出色的个性化支持所需的一切.  您的客户永远不会知道您正在使用服务台.  对他们来说，您的邮件看起来像普通的电子邮件.  感觉就像是个人支持，它可以帮助您与客户建立更深的关系.  |
...
| [Get Satisfaction!](https://getsatisfaction.com/corp/) | [@getsatisfaction](https://twitter.com/getsatisfaction)  |  -|  客户社区以获得社会支持，社交营销和客户反馈-在线社区软件.  获得满意是领先的客户参与平台，可通过最佳的在线客户社区帮助公司与客户和潜在客户建立更好的关系.  |
...
| [Jitbit Helpdesk](https://www.jitbit.com/helpdesk/) | [@jitbithelpdesk](https://twitter.com/jitbithelpdesk)  |  $ 29 / mo-$ 199 / mo |  帮助台应用程序，实际上使您的工作更轻松，而不是更难.  提供托管版本和本地版本.  设计非常好，易于使用.  具有所有必备功能，不会妨碍您.  |
...
| [Drip](https://www.drip.com) | [@getdrip](https://twitter.com/getdrip)  |  免费供&lt;100个订阅者使用，付费计划从$ 49 / mo起|  具有工作流程，点滴活动，转化跟踪等的高级营销自动化.
...
### Email Collection/Landing Page Apps
 ...
 |  服务|  推特|  定价|  描述
|:--------|:--------|:--------|:------------|
| [Launchrock](https://www.launchrock.com) | [@launchrock](https://twitter.com/launchrock)  |  $ 49 / mo-$ 199 / mo |  即使您知道如何使用HTML对网页进行编码，您也将喜欢我们的目标网页构建器快得多.  加载徽标和图形资产，从品牌调色板中设置一些基本颜色并发布.  |
...
| [Streak](https://www.streak.com) | [@streak](https://twitter.com/streak)  |  -|  在Gmail中管理电子邮件支持.  Streak可让您直接从收件箱跟踪所有交易.  我们让您将来自同一客户的电子邮件分组到一个视图中，并通过该管道推送该客户.  收到新电子邮件时，您将拥有所需的所有上下文.  |
| [Base](https://getbase.com) | [@ZendeskSell](https://twitter.com/ZendeskSell)  |  $ 15 / mo-$ 125 / mo |  您的团队将实际使用的销售和CRM软件.  Base旨在显着提高团队的销售效率，并为您提供发展业务所需的核心销售工具.  您的潜在客户来自各种来源.  Base中的销售线索管理可帮助您组织销售线索并将其分配给正确的销售代表，以便对其进行跟进和快速定性.  合格后，在Base中转换潜在客户，您有关潜在客户的所有联系信息都会转移到新的客户联系卡上.  您也可以选择指定后续任务，甚至可以同时创建交易.  |
...
| [HootSuite](https://hootsuite.com) | [@HootSuite](https://twitter.com/HootSuite)  |  $ 8.99 / mo |  为您的社交媒体策略增加速度和敏捷性.  您将在一个仪表板上安排推文和Facebook帖子，监控对话等等.  当您需要证明自己的社会投资回报率时，快速创建和定制现成的分析报告.  |
...
| [Visual.ly](https://visual.ly) | [@Visually](https://twitter.com/Visually)  |  $ 195 / mo-$ 994 / mo |  品牌的原始视觉内容.  我们只会与最优秀的创意人才合作.  成千上万的设计师，新闻工作者，动画师和开发人员正站在身边，帮助您实现目标并将项目提升到新的水平.  |
...
| [PickFu](https://www.pickfu.com) | [@pickfu](https://twitter.com/pickfu)  |  $ 20 / mo-$ 299 / mo |  几分钟内即可获得真正的消费者反馈.  PickFu是一种工具，可针对您关心的问题提供即时，公正和有见地的公众舆论.  |
...
### Data
 ...
 |  服务|  推特|  定价|  描述
|:--------|:--------|:--------|:------------|
| [Factual](https://www.factual.com) | [@Factual](https://twitter.com/Factual)  |  -|  全球数据.  本地上下文.  Factual的定位平台利用确定的全球数据丰富了移动位置信号，从而实现了个性化和上下文相关的移动体验.  Factual的实时数据堆栈通过数十亿次输入建立，并不断更新数据.  |
...
### Accounting/Invoicing
 ...
 |  服务|  推特|  定价|  描述
|:--------|:--------|:--------|:------------|
| [Harvest](https://www.getharvest.com) | [@harvest](https://twitter.com/harvest)  |  $ 12 / mo-$ 99 / mo |  时间跟踪变得容易.  通过Harvest，时间跟踪非常简单，闪电般快速.  设置过程只需几秒钟，因此无需安装任何内容.  我们简化了时间表和时间表的审批流程，因此您可以专注于工作.  |
| [Ballpark](https://www.getballpark.com) | [@ballparkapp](https://twitter.com/ballparkapp)  |  $ 12 / mo-$ 99 / mo |  停止向客户发送难看的纸质发票.  今天与Ballpark一起无纸化.  我们精美的基于网络的发票和预算使您比以往任何时候都更容易获得付款并与您的客户和同事讨论项目.  |
...
| [FreshBooks](https://www.freshbooks.com) | [@freshbooks](https://twitter.com/freshbooks)  |  $ 19.95 / mo-$ 39.95 / mo |  专为您而设的会计（非会计）.  FreshBooks简单直观，因此会计工作不会令人生畏.  另外，如果您在周一至周五美东时间上午9点至下午6点有疑问，可以与真实的人交谈.  |
...
### Income Analytics
 ...
 |  服务|  推特|  定价|  描述
|:--------|:--------|:--------|:------------|
| [Baremetrics](https://baremetrics.com) | [@Baremetrics](https://twitter.com/Baremetrics)  |  $ 79 /月-$ 249 /月|  一键式操作，您将从Stripe帐户中获取许多有价值的指标|
...
| [Gumroad](https://gumroad.com) | [@gumroad](https://twitter.com/gumroad)  |  -|  看到更高的转化率，更低的费用和更多的客户控制权.  直接向观众出售电影.  创造数字产品是困难的，应该出售数字产品不应该.  我们让您在几秒钟内就开始销售下载内容.  |
...
| [Recurly](https://recurly.com) | [@Recurly](https://twitter.com/Recurly)  |  $ 99 / mo-$ 259 / mo |  订阅计费自动化.  作为领先的定期计费平台，Recurly确保设置简便，集成迅速，并且我们的服务可根据您的业务需求进行扩展.  借助Recurly，您将随时可以接受付款并专注于迅速增长销售额.  |
...
| [WePay](https://go.wepay.com) | [@wepay](https://twitter.com/wepay)  |  2.9％+ 30¢/交易.  |  WePay是第一个提供平台（市场，众筹和业务软件/工具）的支付引擎，该平台拥有客户体验的方式，同时仍能使他们免受100％的欺诈和监管风险.  |
| [Paddle](https://paddle.com) | [@PaddleHQ](https://twitter.com/PaddleHQ)  |  5％+ 50¢/交易.  |  付款处理和履行，专门用于桌面应用程序和SaaS订阅服务.  为您处理增值税和发票，因此您的会计变得更加容易.  |
| [Fattmerchant](https://fattmerchant.com/) | [@Fattmerchant](https://twitter.com/fattmerchant)  |  0％+兑换+ $ 99 + / mo |  付款统一.  |  将您的应用程序，网站，软件或硬件与Fattmerchant API集成在一起，以无缝地接受所有主要的信用卡，ACH付款等等！  面对面和在线交易的理想选择.  |
...
### User Feedback
 ...
 |  服务|  推特|  定价|  描述
|:--------|:--------|:--------|:------------|
| [Uservoice](https://www.uservoice.com/) | [@UserVoice](https://twitter.com/uservoice)  |  $ 499 / mo-$ 999 + / mo |  收集，理解并响应用户反馈.  |
...
| [Dynalist](https://dynalist.io/) | [@dynalisthq](https://twitter.com/dynalisthq)  |  免费-每月$ 8 |  大纲视图工具，笔记应用程序，清单.  |
...
| [Google Hangouts](https://hangouts.google.com/)  |  -|  免费|  Google提供的视频会议和聊天应用程序.  它基于浏览器，并且支持同一视频通话中的多个参与者.  |
...
| [Cloud Foundry](https://www.cloudfoundry.org) | [@cloudfoundry](https://twitter.com/cloudfoundry)  |  -|  您自己托管，或使用许多托管服务之一|
...
| [Amazon Web Services](https://aws.amazon.com/elasticbeanstalk/) | [@awscloud](https://twitter.com/awscloud)  |  -|  与Azure一样，它以IaaS闻名.
...
| [Dead Man's Snitch](https://deadmanssnitch.com) | [@DeadMansSnitch](https://twitter.com/deadmanssnitch)  |  免费-每月$ 49 |  监视计划的任务（例如cron）和服务心跳.  让您轻松知道何时以及为什么特定作业失败.  |
...
| [Gitprime](https://www.gitprime.com/) | [@GitPrime](https://twitter.com/GitPrime)  |  $ 749 / mo-$ 2,549 / mo |  数据驱动的工程领导者的上下文度量标准|
...
### Fundraising / Investor Relations
 |  服务|  推特|  定价|  描述
|:--------|:--------|:--------|:------------|
| [Captable.io](https://captable.io) | [@captable_io](https://twitter.com/captable_io)  |  免费|  Captable.io是一款免费的功能齐全的帽子桌管理工具，可逐步进行创建，轻松的协作和共享，可转换的便笺和选项计算器以及强大的回合建模.  |
...
| [NoteGenie](https://notegenie.io) / [SAFEGenie](https://safegenie.io) | [@ltse](https://twitter.com/ltse)  |  免费|  用于探索可转换票据和SAFE对创始人所有权的影响的计算器.  |
