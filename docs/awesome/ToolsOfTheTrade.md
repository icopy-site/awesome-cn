...
非常感谢以前的主题，包括garrettdimon，espeed，netshade和cmadan，以及我还没有提及的其他主题.
...
| [testmail.app](https://testmail.app) | [@testmailapp](https://twitter.com/testmailapp)  |  免费-$ 29 /月|  使用无限的邮箱和GraphQL API自动执行端到端电子邮件测试.  |
...
| [GitLab Issues](https://about.gitlab.com) | [@gitlab](https://twitter.com/gitlab)  |  免费|  GitLab是一种开放源代码软件，用于协作在全球超过100,000个组织中使用的代码.  在GitLab.com上或在您自己的实例中可以拥有无​​限的私人存储库.  企业版包括深层的LDAP支持.  |
...
| [Sprintly](https://sprint.ly) | [@sprintly](https://twitter.com/sprintly)  |  $ 49 / mo- $ 399 / mo |  不要问项目进展如何.  观看他们的实时情况.  使用我们优美的界面可以实时确定优先级，标记，管理，评估和衡量软件开发人员的进度.  |
| [Podio](https://podio.com) | [@Podio](https://twitter.com/Podio)  |  免费|  团队合作变得容易.  来自Podio背后的团队的新闻和观点-自2009年以来改变了世界的运作方式.
| [Flow](https://www.getflow.com) | [@flowapp](https://twitter.com/flowapp)  |  $ 19 / mo-$ 249 / mo |  停止从收件箱管理项目.  Flow是用于Web和iPhone的协作式任务管理应用程序.  |
...
| [Blossom](https://www.blossom.co) | [@blossom](https://twitter.com/blossom)  |  $ 19 / mo-$ 149 / mo |  敏捷项目管理.  Blossom为团队中的每位成员提供了清晰的概述，说明谁在做什么，为什么做，同时帮助您专注于最重要的事情.  借助Blossom，您可以一心一意地高效管理整个开发过程，并且牢记简单性.  Blossom是基于看板原理的，它是一种强调迭代交付周期并不断改善团队或组织工作流程的工作方式.  |
...
| [LeanKit](https://leankit.com) | [@leankit](https://twitter.com/leankit)  |  $ 15 / mo-$ 19 / mo |  即时项目可见性.  在LeanKit中，您可以将组织的流程映射到虚拟白板上.  在每块板上，处理步骤分别表示为垂直和水平通道.  卡片代表工作项目，团队成员在完成工作份额时会不断更新和迁移.  经理和客户无需查看状态报告，而只需查看董事会即可.  全球各地的董事会更新在几秒钟内可见，并且电子邮件警报和RSS feed可用，因此您和您的团队可以立即采取行动来解决问题，直到它们变成严重的问题.  |
| [Breeze](https://www.breeze.pm) | [@BreezeTeam](https://twitter.com/BreezeTeam)  |  $ 29 / mo-$ 129 / mo |  组织和跟踪一切.  Breeze向您显示正在处理的内容，正在处理的内容，工作流程中的位置以及花费的时间.  |
...
| [Clubhouse](https://clubhouse.io/) | [@clubhouse](https://twitter.com/clubhouse)  |  $ 0-$ 8.50 / mo |  Clubhouse是用于软件开发的协作之家，使与您的团队进行计划和构建变得更轻松，更愉快.  |

### Time Tracking

 |  服务|  推特|  定价|  描述
|:--------|:--------|:--------|:------------|
| [Toggl](https://toggl.com) | [@toggl](https://twitter.com/toggl)  |  免费-每月$ 59 |  Toggl的时间跟踪器专为提高速度和易用性而设计.  使用Toggl进行时间记录非常简单，因此您将实际使用它.  |
| [Clockify](https://clockify.me) | [@clockify](https://twitter.com/clockify)  |  免费|  Clockify是唯一100％空闲的时间跟踪软件，使您和您的团队可以一键跟踪时间.  它像Toggl一样工作，但提供了无限的功能和无限的用户.  |
...
| [Tickspot](https://www.tickspot.com/) | [@tickspot](https://twitter.com/tickspot)  |  免费-149美元/月|  简单明了的时间跟踪软件可帮助您的团队运行更多有利可图的项目.  无论您是喜欢iOS，Android，Apple Watch还是台式机，Tick都是跟踪时间的最简单方法.  |
...
| [Google Analytics](https://marketingplatform.google.com/about/analytics/) | [@GMktgPlatform](https://twitter.com/GMktgPlatform)  |  -|  Google Analytics（分析）可让您衡量广告的投资回报率，并跟踪Flash，视频以及社交网站和应用程序.  |
...
| [Wisdom](https://getWisdom.io) | [@wisdomCRM](https://twitter.com/WisdomCRM)  |  免费-每月$ 2000以上|  会话重播.  智慧是最准确的实时访客会话记录器服务.  Wisdom仅专注于会话重播，在所有选项卡上为每个访问者重建一个虚拟桌面屏幕，以捕获每个访问者体验的真实感觉.  |
...
| [Optimize by Google](https://optimize.google.com)  |  -|  免费|  通过“优化”，您可以测试网页的变体，并查看它们针对指定目标的效果.  |
...
### User Testing
 ...
 |  服务|  推特|  定价|  描述
|:--------|:--------|:--------|:------------|
| [Silverback 2.0](https://silverbackapp.com) | [@silverbackapp](https://twitter.com/silverbackapp)  |  69.95 |  游击者可用性测试软件，适用于设计人员和开发人员.  Silverback使使用Mac上已经存在的硬件，每个人都可以轻松，快速，廉价地进行游击可用性测试，而无需进行设置且没有任何费用.  |
...
### Payroll
 ...
 |  服务|  推特|  定价|  描述
|:--------|:--------|:--------|:------------|
| [Gusto](https://gusto.com) | [@gustohq](https://twitter.com/gustohq)  |  $ 29 / mo + $ 6 /用户|  以人为本的薪资和福利，易于设置，自动纳税申报和周到的支持.  |
| [WagePoint](https://wagepoint.com) | [@wagepoint](https://twitter.com/wagepoint)  |  $ 20 + $ 2 /员工|  简单，快速和友好的方式来支付您的员工.  |
...
| [Codeship](https://codeship.com) | [@codeship](https://twitter.com/codeship)  |  从100个构建/月开始免费，无限计划从49美元起|  持续交付即服务，立即开始测试和部署代码|
...
| [Semaphore](https://semaphoreci.com) | [@semaphoreci](https://twitter.com/semaphoreci)  |  $ 14 / mo-$ 899 / mo |  创建一个惊人的工作流.  Semaphore假定您的私有或开源项目在GitHub上.  没有新的依赖项，挂钩或SSH密钥可以管理.  它的工作原理没有对源代码进行任何更改.  |
| [Solano CI](https://www.solanolabs.com) | [@SolanoLabs](https://twitter.com/solanolabs)  |  $ 15 / mo-$ 100 / mo |  通过获得专利的自动并行功能，可以更快地进行持续集成和部署.  Solano CI可以在数分钟内完成持续集成，使您无需管理构建服务器，并可以安全，自动地并行运行测试，从而使软件部署速度提高了10倍至80倍.  它也使您甚至可以在使用CI之前使用我们的大规模可扩展环境.  无缝集成到现有工作流程中.  免费试用14天，无需信用卡.  以前曾被人称为tddium.  |
...
| [Bamboo](https://www.atlassian.com/software/bamboo) | [@atlassian](https://twitter.com/atlassian)  |  $ 10 / mo-$ 1000 / mo |  Bamboo不仅仅运行构建和测试.  它可以连接问题，提交，测试结果和部署，从而使整个产品团队都可以使用整个图景-从项目经理，开发人员和测试人员，再到系统管理员.  |
...
### Dashboards
 ...
 |  服务|  推特|  定价|  描述
|:--------|:--------|:--------|:------------|
| [Geckoboard](https://www.geckoboard.com) | [@geckoboard](https://twitter.com/geckoboard)  |  $ 17 / mo-$ 899 / mo |  认识壁虎板.  它是您的关键数据，放在一个地方.  Geckoboard监视您企业的生命体征-不要等待，请在业务仪表板上实时看到它.  专注于重要的事情，对重要事件做出更快的反应.  |
| [Telemetry](https://www.telemetrytv.com) | [@telemetrytv](https://twitter.com/telemetrytv)  |  $ 9 / mo-$ 749 / mo |  使用强大的可视化功能构建实时仪表板，这些可视化功能在大屏幕电视，台式计算机，移动设备和嵌入式系统上看起来都很漂亮-所有这些都使用可与所有现代语言一起使用的简单REST API.  |
...
| [CatchJS](https://catchjs.com)  |  -|  $ 49-$ 499 |  Web应用程序的JavaScript错误报告.  可以截取屏幕截图并收集点击轨迹，因此重现bug变得容易.  |
| [Crashlytics](https://try.crashlytics.com) | [@crashlytics](https://twitter.com/crashlytics)  |  免费|  崩溃报告和分组，便于分析.  基本分析和报告.  iOS和Android |
...
| [Rollbar](https://rollbar.com) | [@rollbar](https://twitter.com/rollbar)  |  $ 12 / mo-$ 1249 / mo |  控制您的错误.  Rollbar与平台无关，可以接受任何能说HTTP和JSON的数据.  您可以使用我们针对Ruby，Python，PHP，Node.js，JavaScript，Android，iOS或Flash的官方库，也可以使用我们的API自行滚动.  |
...
### Log Monitoring
 ...
 |  服务|  推特|  定价|  描述
|:--------|:--------|:--------|:------------|
| [Fluentd](https://www.fluentd.org) | [@fluentd](https://twitter.com/fluentd)  |  -|  设置一次，收集更多.  Fluentd是一个开放源代码数据收集器，旨在处理数据流.  150多个插件可让您立即存储日志管理，大数据分析等数据|
...
| [Logstash](https://www.elastic.co/products/logstash) | [@logstash](https://twitter.com/logstash)  |  -|  从任何来源发送日志，进行解析，获取正确的时间戳，对其进行索引并进行搜索.  Logstash是用于管理事件和日志的工具.  您可以使用它来收集日志，解析它们并存储它们以备后用（例如，用于搜索）.  说到搜索，Logstash带有用于搜索和钻取所有日志的Web界面.  |
| [Papertrail](https://papertrailapp.com) | [@papertrailapp](https://twitter.com/papertrailapp)  |  $ 7 / mo-$ 230 / mo |  无挫败的日志管理.  几秒钟即可上手.  使用Papertrail的省时日志工具，灵活的系统组，团队范围的访问，长期归档，图表和分析导出，监视Webhook和45秒设置.  |
...
| [Circonus](https://www.circonus.com) | [@circonus](https://twitter.com/circonus)  |  $ 15 /主机/月-$ 25 /主机/月|  Circonus将多种监视，警报，事件报告和分析工具组合到一个统一的解决方案中.  在任何应用程序中，从任何系统使用任何数据，并将其实时可视化.  |
...
| [Site24x7](https://www.site24x7.com) | [@site24x7](https://twitter.com/Site24x7)  |  $ 9 /月的入门费-$ 225 /企业
...
### Customer Support/Help Desks
 ...
 |  服务|  推特|  定价|  描述
|:--------|:--------|:--------|:------------|
| [Salesforce Desk](https://www.salesforce.com/solutions/small-business-solutions/help-desk-software/?mc=desk) | [@salesforce](https://twitter.com/salesforce)  |  $ 3 / mo-$ 50 / mo |  提供令人赞叹的客户服务.  Salesforce Desk创建了领先的客户服务应用程序，可帮助快速发展的公司提供出色的客户支持.  Salesforce Desk的直观用户界面和强大功能使整个公司更有效地解决客户的问题.  另外，Salesforce Desk是由Salesforce支持的唯一客户服务应用程序，可轻松与其他Salesforce服务集成并提供强大的安全性.  成千上万的公司使用Salesforce Desk作为他们的帮助台软件应用程序，从家喻户晓的Square和Instagram到街上的墨西哥卷饼商店.  免费试用.  |
...
| [Groove](https://www.groovehq.com) | [@groove](https://twitter.com/groove)  |  $ 15 / mo |  为每位客户提供出色的个性化支持所需的一切.  您的客户永远不会知道您正在使用服务台.  对他们来说，您的消息看起来像普通的电子邮件.  感觉就像是个人支持，可以帮助您与客户建立更深的关系.  |
...
| [Tender](https://tenderapp.com/) | [@tenderapp](https://twitter.com/tenderapp)  |  $ 9 / mo-$ 99 / mo |  更好，更简单的客户支持软件.  公开支持您的客户！  通过公共论坛，您可以为用户提供一个公共空间，以讨论常见问题并获得反馈，同时仍将某些类别保持私密状态（开票，订单等）.  高级用户可以订阅类别和新讨论，并帮助其他客户.  |
...
| [Drift](https://www.drift.com) | [@drift](https://twitter.com/drift)  |月费$ 49起|  停止浪费您的网站流量.  面向销售的实时聊天和应用内消息传递，以及聊天机器人自动化.  |
...
| [FormAPI](https://formapi.io) | [@form_api](https://twitter.com/form_api)  |  $ 49 / mo-$ 249 / mo |  开发人员PDF服务.  使程序员易于填写和签署PDF文档.  如果您需要生成大量合同，发票等，则可以节省大量开发时间.
...
### Site Search
 ...
 |  服务|  推特|  定价|  描述
|:--------|:--------|:--------|:------------|
| [Elasticsearch](https://www.elastic.co/products/elasticsearch) | [@elastic](https://twitter.com/elastic)  |  -|  端到端搜索和分析平台.  无限通用.  通过将广受欢迎的Elasticsearch，Logstash和Kibana结合起来，我们创建了一个端到端堆栈，该堆栈从几乎任何类型的结构化和非结构化数据源实时提供可操作的见解.  由每个开源产品背后的工程师构建和支持，Elasticsearch ELK堆栈使搜索和分析数据比以往任何时候都更加容易.  |
...
| [Customer.io](https://customer.io) | [@CustomerIO](https://twitter.com/CustomerIO)  |  $ 50 /月-$ 1250 /月|  根据用户在您的应用中的行为发送或不发送电子邮件.  使用Customer.io，您可以使用站点中的数据将新闻稿发送给部分客户.  |
...
| [Sendy](https://sendy.co) | [@getsendy](https://twitter.com/getSendy)  |  一次性支付59美元，托管自己或使用各种提供商提供的托管sendy实例.  |  -|
...
| [EmailOctopus](https://emailoctopus.com) | [@emailoctopus](https://twitter.com/emailoctopus)  |  最多可释放2500个订户，付费计划从$ 19 / mo起|  使用Amazon SES的低成本电子邮件营销.
...
### Email Collection/Landing Page Apps
 ...
 |  服务|  推特|  定价|  描述
|:--------|:--------|:--------|:------------|
| [Launchrock](https://www.launchrock.com) | [@launchrock](https://twitter.com/launchrock)  |  $ 49 / mo-$ 199 / mo |  即使您知道如何使用HTML对网页进行编码，您也会喜欢它的着陆页构建器快得多.  加载徽标和图形资产，从品牌调色板中设置一些基本颜色，然后发布.  |
| [Unbounce](https://unbounce.com) | [@unbounce](https://twitter.com/unbounce)  |  $ 49 / mo-$ 199 / mo |  Unbounce使营销人员能够独立于技术团队采取行动，从而提高了效率并提高了销售能力.  生成高转换目标网页，而无需处理IT瓶颈.  了解Unbounce如何增强您的广告系列并最大化您的营销支出.  |
...
| [KickoffLabs](https://kickofflabs.com) | [@kickofflabs](https://twitter.com/kickofflabs)  |  $ 29 / mo-$ 99 / mo |  停止构建登录页面.  开始制作更明智的广告系列.  将客户引导至与他们对话的定制页面.  让他们参与注册表单，新闻通讯，最重要的是，为客户推荐提供一个非常酷的独特REWARD系统.  |
...
### CRM/Sales Tools
 ...
 |  服务|  推特|  定价|  描述
|:--------|:--------|:--------|:------------|
| [Kloudless](https://kloudless.com) | [@kloudless](https://twitter.com/kloudless)  |  免费-每月$ 500 |  Kloudless允许您通过一个全面的RESTful API与多个CRM解决方案集成.  使用Kloudless CRM Unified API，您可以通过一个代码库与Salesforce，SugarCRM，Microsoft Dynamics，Zoho，Oracle Sales Cloud，HubSpot，Pipeliner等集成.  Kloudless还维护所有集成，因此您可以集中精力更快地构建出色的解决方案.  |
| [Salesforce](https://www.salesforce.com) | [@salesforce](https://twitter.com/salesforce)  |  -|  将消费者转化为所有数字渠道的客户.  基于Salesforce1平台构建的ExactTarget Marketing Cloud，营销人员可以创建前所未有的1：1广告系列.  因此，您可以将传统的数字渠道（如电子邮件，移动，社交和网络）与任何可能的IP寻址产品结合起来，以将消费者转变为客户.  |
...
| [SugarCRM](https://www.sugarcrm.com) | [@sugarcrm](https://twitter.com/sugarcrm)  |  $ 35 /月-$ 150 /月|  Sugar的开放，灵活的平台可以轻松解决实际的业务问题.  从自动化的销售，市场营销和客户支持到创建自定义CRM应用程序，我们都能满足您的需求.  通过将个人置于解决方案的中心，SugarCRM将“ i”置于CRM中，并赋予每个面向客户的个人以建立非凡的客户关系的能力.  |
...
| [Close.io](https://close.io) | [@closeio](https://twitter.com/closeio)  |  $ 59 /月-$ 299 /月|  销售交流平台.  Close.io会自动记录发送和接收的电子邮件以及潜在客户.  您可以轻松从Close.io发送/接收电子邮件.  或者，通过输入IMAP和SMTP邮件设置，Close.io可以跟踪您从Gmail或任何电子邮件客户端发送的电子邮件.  |
...
| [Base](https://getbase.com) | [@ZendeskSell](https://twitter.com/ZendeskSell)  |  $ 15 / mo-$ 125 / mo |  您的团队将实际使用的销售和CRM软件.  Base旨在显着提高团队的销售效率，并为您提供发展业务所需的核心销售工具.  您的潜在客户来自各种来源.  Base中的潜在客户管理可以帮助您组织潜在客户并将其分配给正确的销售代表，以便可以对其进行跟进和快速定性.  合格后，在Base中转换潜在客户，您有关潜在客户的所有联系信息都会转移到新的客户联系卡上.  （可选）您可以指定跟进任务，甚至可以同时创建交易.  |
...
| [HootSuite](https://hootsuite.com) | [@HootSuite](https://twitter.com/HootSuite)  |  $ 8.99 / mo |  为您的社交媒体策略增加速度和敏捷性.  您可以从一个仪表板安排推文和Facebook帖子，监控对话等等.  当您需要证明自己的社会投资回报率时，可以快速创建和定制现成的分析报告.  |
...
| [Sprout Social](https://sproutsocial.com) | [@sproutsocial](https://twitter.com/sproutsocial)  |  $ 99 /月-$ 249 /月|  强大的社交媒体软件.  Sprout可让您通过一种易于使用的消息撰写工具在Facebook，Twitter，Google +和LinkedIn上同时发布消息.  缩短链接，附加照片，在Facebook上定位目标受众，自定义帖子等等.  |
...
| [Word Safety](https://naming-tools.com/word-safety)  |  -|  免费|  Word安全工具，用于检查其他语言或其他形式的书面文字的第二含义.  |
...
### Community Tools
 ...
 |  服务|  推特|  定价|  描述
|:--------|:--------|:--------|:------------|
| [Discourse](https://www.discourse.org) | [@discourse](https://twitter.com/discourse)  |  -|  准备使用新的讨论平台了吗？  讨论软件是一群对某个共同主题感兴趣的人，他们愿意在网页上彼此键入段落.  |
...
| [Creately](https://creately.com) | [@creately](https://twitter.com/creately)  |  免费-750美元/月|  基于Web的图表工具，可快速绘制简单的图表.  支持流程图，模型，线框图，思维导图，组织结构图，网络图，AWS图，UML图和许多其他图类型.  实时协作以及创新的生产力功能，使图表创建速度提高了3倍.  |
...
| [Balsamiq](https://balsamiq.com) | [@balsamiq](https://twitter.com/balsamiq)  |  -|  对于劣质软件而言，生命太短了！  Balsamiq Mockups是一个快速的线框图工具，可帮助您更快，更聪明地工作.  它再现了在白板上但使用计算机进行素描的体验.  |
...
| [PickFu](https://www.pickfu.com) | [@pickfu](https://twitter.com/pickfu)  |  $ 20 / mo-$ 299 / mo |  几分钟内即可获得真正的消费者反馈.  PickFu是一种工具，可针对您关心的问题提供即时，公正且有见地的舆论.  |
...
### Data
 ...
 |  服务|  推特|  定价|  描述
|:--------|:--------|:--------|:------------|
| [Factual](https://www.factual.com) | [@Factual](https://twitter.com/Factual)  |  -|  全球数据.  本地上下文.  Factual的定位平台利用确定的全球数据丰富了移动位置信号，从而实现了个性化且与上下文相关的移动体验.  Factual的实时数据堆栈通过数十亿次输入建立，并不断更新数据.  |
...
### Accounting/Invoicing
 ...
 |  服务|  推特|  定价|  描述
|:--------|:--------|:--------|:------------|
| [Harvest](https://www.getharvest.com) | [@harvest](https://twitter.com/harvest)  |  $ 12 / mo-$ 99 / mo |  时间跟踪变得容易.  通过Harvest，时间跟踪非常简单，闪电般快速.  设置仅需几秒钟，因此无需安装任何内容.  我们简化了时间表和时间表的审批流程，因此您可以专注于工作.  |
...
| [PaySimple](https://paysimple.com) | [@PaySimple](https://twitter.com/PaySimple)  |  $ 34.95 / mo |  简化结算方式.  PaySimple是行业领先的支付管理解决方案提供商.  PaySimple通过使您能够自动对所有付款进行计费，收集和存款，简化了计费和收款流程.  我们的定制安全ASP解决方案包括自动循环账单，电子支票处理，直接借记和信用卡处理，且价格最低.  |
...
| [FreeAgent](https://www.Freeagent.com) | [@Freeagent](https://twitter.com/Freeagent)  |  US $ 20 / mo |  会计软件受到35,000多位自由职业者和小型企业的信任.  通过您的电子银行对帐单核对业务中的资金，并建立每月资产负债表.  |
| [Blinksale](https://www.blinksale.com) | [@blinksale](https://twitter.com/blinksale)  |  $ 15.00 |  无限介绍Blinksale.  一个计划.  一价.  无限的一切.  眨眼间可以让您看起来最好.  拥有十多种发票设计和感谢函，您一定会尽力而为.  每次.  |
| [Cashboard](https://cashboardapp.com/) | [@cashboard](https://twitter.com/cashboard)  |  $ 8.25 / mo-$ 250 / mo |  全球数千人信任的FreeLance时间跟踪和发票软件.  Cashboard是我们设计用来纠正这种情况的工具.  它适用于我们的软件咨询公司，我们认为它也适用于您.  经过数次不眠之夜的努力，我们于2007年春季推出了Cashboard.  这是第一个将估算，发票，时间跟踪和在线支付结合到一个工具中的解决方案.  |
...
### Income Analytics
 ...
 |  服务|  推特|  定价|  描述
|:--------|:--------|:--------|:------------|
| [Baremetrics](https://baremetrics.com) | [@Baremetrics](https://twitter.com/Baremetrics)  |  $ 79 /月-$ 249 /月|  只需单击一下，您就会从Stripe帐户中获取许多有价值的指标|

### Payments, Billing & Downloads

 |  服务|  推特|  定价|  描述
|:--------|:--------|:--------|:------------|
| [PayPal](https://www.paypal.com) | [@PayPal](https://twitter.com/PayPal)  |  -|  PayPal是一家国际电子商务公司，允许通过Internet进行付款和汇款.  在线汇款可以作为电子方式替代传统的纸质付款方式，例如支票和汇票|
...
| [Recurly](https://recurly.com) | [@Recurly](https://twitter.com/Recurly)  |  $ 99 /月-$ 259 /月|  订阅计费自动化.  作为领先的定期计费平台，Recurly确保设置简便，集成迅速，并且我们的服务可根据您的业务需求进行扩展.  借助Recurly，您将准备好接受付款，并专注于立即增加销售额.  |
...
| [Yeoman](https://yeoman.io/) | [@yeoman](https://twitter.com/yeoman)  |  免费|  适用于现代Web应用程序的Web脚手架工具|
...
| [Keypad by Smith.ai](https://smith.ai/keypad) | [@smithdotai](https://twitter.com/smithdotai)  |  $ 25 / mo |  适用于小型企业的最先进，最经济的云电话系统.  |
...
| [Formcarry](https://formcarry.com)  |  -|  $ 0 / mo-$ 99 / mo |  处理表单时没有一行后端代码.  |
| [FormKeep](https://formkeep.com) | [@formkeep](https://twitter.com/formkeep)  |  $ 59 / mo-$ 199 / mo |  具有内置垃圾邮件保护功能，与1000多种服务的数据集成，数据保留策略等的Premium Forms后端服务.  |
...
| [Google Maps](https://developers.google.com/maps/documentation/geocoding/intro)  |  -|  -|  Google提供的地址解析API，注册时需要信用卡.
...
| [Compose](https://www.compose.com) | [@composeio](https://twitter.com/composeio/)  |  -|  Compose是开发人员用来部署，托管和扩展数据库（Elasticsearch和MongoDB）的完全托管平台.
...
| [Ahrefs](https://ahrefs.com) | [@ahrefs](https://twitter.com/ahrefs)  |  $ 79 / mo-$ 2500 / mo |  Ahrefs提供了一个完整的数字营销套件，其中包含用于分析反向链接，分析网站，排名跟踪，内容探索等的工具.  |
...
| [Integromat](https://www.integromat.com) | [@integromat](https://twitter.com/integromat)  |  免费进行&lt;1000次操作或100 MB /月，费用从$ 9 / mo起|  自动执行任务并连接到几乎所有应用程序或服务.  非常强大的工具集，具有错误处理，迭代器，聚合器，路由器，函数，数据存储等功能.
