...
Delicious在2010年创立了Joshua Schachter， [posted the following](https://news.ycombinator.com/item?id=1769910) 黑客新闻：
...
[![instabug-github](https://user-images.githubusercontent.com/10850625/65512691-fd45f280-ded9-11e9-8921-3528b98c30a7.png)](https://instabug.com/android/sdk?utm_source=toolsofthetrade&utm_medium=spon&utm_content=banner)
 &gt; Instabug可帮助Android开发人员轻松地从Beta测试人员和用户那里收集错误和反馈，以加快迭代速度并交付高质量的应用程序.  Instabug会自动附加屏幕快照，设备详细信息，网络日志，再现步骤以及解决问题和确定产品积压需求优先级所需的大量其他关键见解.
...
| [Litmus](http://litmus.com) | [@litmusapp](https://twitter.com/litmusapp)  |  $ 79 /月-$ 159 /月| 让您在几分钟内跨30多个真实电子邮件客户端和设备预览广告系列.  |
| [Sauce Labs](https://saucelabs.com) | [@saucelabs](https://twitter.com/saucelabs)  |  $ 19 / mo-$ 298 / mo | 立即在数百种真实的浏览器和平台上运行Web和移动应用程序测试.  |
...
| [GitLab Issues](https://about.gitlab.com) | [@gitlab](https://twitter.com/gitlab)  | 免费|  GitLab是一种开放源代码软件，用于协作在全球超过100,000个组织中使用的代码. 在GitLab.com上或在您自己的实例上托管的无限私人存储库. 企业版包括深层的LDAP支持.  |
...
| [Instabug](https://instabug.com) | [@instabug](https://twitter.com/instabug)  |  $ 49 / mo- $ 349 / mo |  Instabug是针对移动应用程序的全面错误报告和应用程序内反馈工具. 收到测试人员或用户发送的每个错误报告附带的详细反馈，以更快地调试和构建更好的应用程序.  |
...
| [Sprintly](https://sprint.ly) | [@sprintly](https://twitter.com/sprintly)  |  $ 49 / mo- $ 399 / mo | 不要问项目进展如何. 观看他们的实时情况. 使用我们优美的界面可以实时对软件开发人员的进度进行优先级划分，标记，管理，评估和评估.  |
...
| [Tom's Planner](https://www.tomsplanner.com) | [@tomsplanner](https://twitter.com/tomsplanner)  |  $ 9 / mo-$ 19 / mo |  Tom&#39;s Planner是甘特图在线软件，任何人都可以通过拖放操作轻松地在线创建，协作和共享甘特图. 它基于Web，极为直观且易于使用.  |
| [LeanKit](https://leankit.com) | [@leankit](https://twitter.com/leankit)  |  $ 15 / mo-$ 19 / mo | 即时项目可见性. 在LeanKit中，您可以将组织的流程映射到虚拟白板上. 在每个板上，过程步骤均表示为垂直和水平通道. 卡片代表工作项目，团队成员在完成工作份额时会不断更新和迁移. 经理和客户无需查看状态报告，而只需查看董事会即可. 董事会更新在几秒钟内在全球范围内可见，并且电子邮件警报和RSS feed可用，因此您和您的团队可以立即采取行动解决问题，直到问题变得严重.  |
| [Breeze](https://www.breeze.pm) | [@BreezeTeam](https://twitter.com/BreezeTeam)  |  $ 29 / mo-$ 129 / mo | 组织和跟踪一切.  Breeze向您显示正在处理的内容，正在处理的内容，工作流程中的位置以及所花费的时间.  |
...
| [Slate](https://heyslate.com/) | [@_heyslate](https://twitter.com/_heyslate)  |  $ 15 / mo |  Slate是一款计划工具，适合想要在一个地方组织进度，项目和财务状况的自由设计师和开发人员.  |

### Time Tracking

 | 服务| 推特| 定价| 描述
|:--------|:--------|:--------|:------------|
| [Toggl](https://toggl.com) | [@toggl](https://twitter.com/toggl)  | 免费-每月20美元/用户|  Toggl的时间跟踪器专为提高速度和易用性而设计. 使用Toggl进行时间记录非常简单，您实际上可以使用它.  |
| [Clockify](https://clockify.me) | [@clockify](https://twitter.com/clockify)  | 免费-$ 9 /用户/月|  Clockify是唯一100％空闲的时间跟踪软件，使您和您的团队可以一键跟踪时间. 它的工作方式类似于Toggl，但提供了无限的功能和无限的用户.  |
| [Hubstaff](https://hubstaff.com) | [@hubstaff](https://twitter.com/Hubstaff)  | 免费-每月20美元/用户|  Hubstaff是时间跟踪软件，旨在使远程团队管理更加有效. 您只需要注册，下载我们直观的桌面应用程序并按“开始”按钮即可开始跟踪时间.  |
| [Tickspot](https://www.tickspot.com/) | [@tickspot](https://twitter.com/tickspot)  | 免费-149美元/月| 简单明了的时间跟踪软件可帮助您的团队运行更多有利可图的项目. 无论您是喜欢iOS，Android，Apple Watch还是台式计算机，Tick都是跟踪时间的最简单方法.  |
| [Kimai](https://www.kimai.org/) | [@kimai_org](https://twitter.com/kimai_org)  | 自托管 Kimai是一个免费的开源时间跟踪器. 它跟踪工作时间，并按需打印您的活动摘要. 每年，每月，每天，按客户，按项目，按操作等.
| [Timetrap](https://github.com/samg/timetrap)  |  -| 免费| 简单的开源命令行时间跟踪.  |
| [OfficeClip](https://www.officeclip.com/web/timesheet)  |  @OfficeClip | 免费-$ 12 /用户/月| 专为小型企业设计的时间跟踪软件. 免费提供无限的用户和无限的时间. 可作为托管和自托管形式使用|
...
| [Paddle](https://paddle.com/) | [@PaddleHQ](https://twitter.com/PaddleHQ)  |  $ 0-$ 2500 / mo | 针对移动和Web应用程序的高级自定义分析.  Paddle是一个分析平台，用于衡量用户操作而非页面浏览量. 动作可以是用户所做的任何事情：查看产品，玩手机游戏，在您的网站上购买商品等.  Paddle处理自定义事件和自定义数据的能力使其超越了更多传统分析平台.  |
| [Chartbeat](https://chartbeat.com) | [@chartbeat](https://twitter.com/chartbeat)  |  $ 9.95 / mo-$ 49.95 / mo | 为您的网站建立忠实而有价值的受众.  Chartbeat的实时流量和观众行为数据向您显示了谁在您的网站上，以及他们现在如何与您的内容互动，因此您可以在重要的时刻采取行动.  |
...
| [Clicky](https://clicky.com) | [@clicky](https://twitter.com/clicky)  |  $ 9.99 /月-$ 19.99 /月| 实时网络分析.  Clicky使您可以查看每个访问者以及他们对您的网站执行的每个操作，并可以选择向用户添加自定义数据，例如用户名或电子邮件地址. 单独分析每个访客，并查看其完整历史记录.  |
...
| [Localytics](https://www.localytics.com) | [@localytics](https://twitter.com/localytics/)  | 释放多达1万个MAU，月费为$ 200-高于$ 2700 / mo | 找出在您的移动或网络应用中有效的方法. 做更多. 全部集中在一处. 先进的分析功能可提供数据和洞察力，以帮助您构建更成功的应用程序. 整合行销可协助您轻松吸引和吸引更多客户.  |
| [Matomo](https://matomo.org) | [@matomo_org](https://twitter.com/matomo_org)  |  -| 无论您是个人博客作者，小型企业还是大型公司，Matemo都能帮助您获得宝贵的见解，以帮助您的企业或读者群增长.  |
| [Mixpanel](https://mixpanel.com) | [@mixpanel/](https://twitter.com/mixpanel)  |  $ 150 / mo-$ 2000 / mo | 动作胜于页面浏览. 多年来，公司一直将页面浏览量作为成功的主要指标. 网页浏览量之所以受欢迎，是因为它们易于报告，但最终无法告诉您访问者的参与度. 通过Mixpanel，您可以通过报告操作（而不是页面浏览量）来衡量客户在您的应用中的行为.  |
...
| [EyeQuant](https://www.eyequant.com) | [@eyequant](https://twitter.com/eyequant)  |  $ 199 / mo-$ 999 / mo | 立即了解您的访问者在您网站上的前几秒钟会看到和错过的内容，并改善了转化率. 数秒之内即可分析实时站点或模型，无需任何代码.  |
| [Optimize by Google](https://optimize.google.com)  |  -| 免费| 通过“优化”，您可以测试网页的变体，并根据指定的目标查看其效果.  |
...
### HR
 ...
 | 服务| 推特| 定价| 描述
|:--------|:--------|:--------|:------------|
| [Workday](https://www.workday.com) | [@workday](https://twitter.com/workday)  |  -| 工作日以人们工作的方式工作，无论是在旅途中还是实时协作. 浏览下面的产品预览，了解Workday如何改变您的工作方式. 凭借强大的业务应用程序和企业级软件无法比拟的用户体验，Workday为您提供了转变业务所需的一切.  |
...
| [TestDome](https://www.testdome.com/) | [@TestDome](https://twitter.com/TestDome)  |  $ 8 /候选人-$ 20 /候选人| 自动进行编程技能测试，要求应聘者在致电面试之前写真实的代码.  |
...
| [HiringPlan](https://hiringplan.io) | [@ltse](https://twitter.com/ltse)  | 免费|  HiringPlan是具有内置市场数据的初创公司的人员规划工具. 它可以帮助创始人采用结构化的薪酬计划，公平地向人们付款，并保留现金和股权.  |
...
| [WagePoint](https://wagepoint.com) | [@wagepoint](https://twitter.com/wagepoint)  |  $ 20 + $ 2 / mo /员工| 简单，快速和友好的方式来支付您的员工.  |
...
| [GitLab](https://about.gitlab.com/product/continuous-integration/) | [@GitLab](https://twitter.com/gitlab) | $0 [Community Edition](https://about.gitlab.com/pricing/)  /付费保费|  GitLab是一个开放源代码版本控制平台，具有精美的CI / CD集成.  |
...
| [Telemetry](https://www.telemetrytv.com) | [@telemetrytv](https://twitter.com/telemetrytv)  |  $ 9 / mo-$ 749 / mo | 使用功能强大的可视化工具构建实时仪表板，这些可视化工具在大屏幕电视，台式计算机，移动设备和嵌入式系统上看起来都很漂亮-所有这些都使用与所有现代语言一起使用的简单REST API.  |
| [Dashing](http://dashing.io)  |  -|  -|  Dashing是基于Sinatra的框架，可让您构建漂亮的仪表板.  |
...
### Error/Exception Handling
 ...
 | 服务| 推特| 定价| 描述
|:--------|:--------|:--------|:------------|
| [CabinJS](https://cabinjs.com) | [@niftylettuce](https://twitter.com/niftylettuce)  | 免费和开源|  Cabin是Sentry，Timber，Bugsnag等的直接替代和替代JavaScript日志记录服务. 它注重安全性，隐私性和业务成本节省. 跨所有Node版本的全面支持以及IE 10+支持.
...
| [Sentry](https://sentry.io/) | [@getsentry](https://twitter.com/getsentry)  | 开源＆$ 24 / mo-$ 199 / mo | 当用户遇到错误时，Sentry会通知您. 立即知道您的应用程序何时发生. 在有机会报告问题之前先吸引用户.  |
...
| [Rollbar](https://rollbar.com) | [@rollbar](https://twitter.com/rollbar)  |  $ 12 / mo-$ 1249 / mo | 控制您的错误.  Rollbar与平台无关，可以接受任何能说HTTP和JSON的数据. 您可以将我们的官方库用于Ruby，Python，PHP，Node.js，JavaScript，Android，iOS或Flash，也可以使用我们的API自己滚动.  |
...
### Log Monitoring
 ...
 | 服务| 推特| 定价| 描述
|:--------|:--------|:--------|:------------|
| [Fluentd](https://www.fluentd.org) | [@fluentd](https://twitter.com/fluentd)  |  -| 设置一次，收集更多.  Fluentd是设计用于处理数据流的开源数据收集器. 超过150个插件可让您立即存储日志管理，大数据分析等数据|
...
| [Logstash](https://www.elastic.co/products/logstash) | [@logstash](https://twitter.com/logstash)  |  -| 从任何来源发送日志，进行分析，获取正确的时间戳，对其进行索引并进行搜索.  Logstash是用于管理事件和日志的工具. 您可以使用它来收集日志，解析它们并存储它们以备后用（例如，用于搜索）. 说到搜索，Logstash带有用于搜索和钻取所有日志的Web界面.  |
...
| [Loader.io](https://loader.io) | [@loaderio](https://twitter.com/loaderio)  | 免费至100.00 $ /月|  Loader.io是一项免费的负载测试服务，可让您通过成千上万的并发连接对您的Web应用/ API进行压力测试.  |
...
| [Datadog](https://www.datadoghq.com) | [@datadoghq](https://twitter.com/datadoghq)  |  $ 0 / mo-$ 15 /主机/ mo |  Datadog是针对IT，运营和开发团队的监视服务，这些团队大规模编写和运行应用程序，并希望将其应用程序，工具和服务所产生的大量数据转化为可行的见解.  |
...
| [Librato](https://www.librato.com) | [@Librato](https://twitter.com/Librato)  |  $ 0.05 / metric / mo至$ 0.30 / metric / mo |  Librato提供了一个完整的解决方案，用于监视和理解在堆栈的各个级别上影响您的业务的指标.  |
...
### Customer Support/Help Desks
 ...
 | 服务| 推特| 定价| 描述
|:--------|:--------|:--------|:------------|
| [Salesforce Desk](https://www.salesforce.com/solutions/small-business-solutions/help-desk-software/?mc=desk) | [@salesforce](https://twitter.com/salesforce)  |  $ 3 / mo-$ 50 / mo | 提供令人赞叹的客户服务.  Salesforce Desk创建了领先的客户服务应用程序，可帮助快速发展的公司提供出色的客户支持.  Salesforce Desk的直观用户界面和强大功能使整个公司更有效地解决客户的问题. 此外，Salesforce Desk是由Salesforce支持的唯一客户服务应用程序，可轻松与其他Salesforce服务集成并提供强大的安全性. 成千上万的公司使用Salesforce Desk作为其服务台软件应用程序，从家喻户晓的Square和Instagram到街上的墨西哥卷饼商店. 免费试用.  |
...
| [ZenDesk](https://www.zendesk.com) | [@zendesk](https://twitter.com/zendesk)  |  $ 1 / mo-$ 195 / mo | 企业与其客户之间的关系可能很难. 更好的客户服务始于更好的沟通Zendesk将您所有的客户对话整合到一个地方.  |
| [Groove](https://www.groovehq.com) | [@groove](https://twitter.com/groove)  |  $ 15 / mo | 您需要为每位客户提供出色的个性化支持的一切. 您的客户永远不会知道您正在使用服务台. 对他们来说，您的消息看起来像普通的电子邮件. 感觉就像是个人支持，它可以帮助您与客户建立更深的关系.  |
| [Intercom](https://www.intercom.com) | [@intercom](https://twitter.com/intercom)  |  $ 49 / mo-$ 449 / mo | 与用户进行交流的最简单方法.  Intercom是一个单一平台，您可以在其中实时查看谁在使用您的产品，并根据他们的行为在合适的时间向合适的用户发送个性化消息.  |
...
| [Enchant](https://www.enchant.com) | [@enchant](https://twitter.com/enchant)  |  $ 9 / mo | 这就像类固醇上的gmail！  Enchant是一个功能强大的服务台，可帮助您的团队为每位客户提供出色的支持. 对您的客户而言，这只是电子邮件. 他们永远不会看到票号，也永远不必登录！  |
| [Freshdesk](https://freshdesk.com) | [@freshdesk](https://twitter.com/freshdesk)  |  $ 16 / mo-$ 70 / mo | 提供卓越的客户支持所需的一切.  Freshdesk使您避免盲目地处理问题，并控制您的客户支持问题.  |
...
### Transactional Email
 ...
 | 服务| 推特| 定价| 描述
|:--------|:--------|:--------|:------------|
| [Postmark](https://postmarkapp.com) | [@postmarkapp](https://twitter.com/postmarkapp)  |  $ 1.50 |  Web应用程序的电子邮件传递–正确完成. 邮戳消除了为Web应用程序传递和解析事务电子邮件的麻烦，而其设置时间却最少，维护成本为零. 我们有多年将电子邮件发送到收件箱的经验，因此您可以更轻松地工作和休息.  |
...
| [Amazon Simple Email Service](https://aws.amazon.com/ses/) | [@AWSSupport](https://twitter.com/AWSSupport)  | 您每月发送的前62,000封电子邮件为$ 0 | 适用于企业和开发人员的灵活，负担得起且高度可扩展的电子邮件发送和接收平台|
...
| [Filestack](https://www.filestack.com) | [@FileStack](https://twitter.com/FileStack)  |  $ 0 /月-$ 49 /月| 简单，强大的文件上传功能. 连接，存储和处理Internet上任何位置的任何文件|
...
| [Abstract APIs](https://www.abstractapi.com) | [@abstractapi](https://twitter.com/abstractapi)  | 免费-249美元/月| 满足日常需求（电子邮件验证，增值税计算，IP地理位置等等）的API套件.  |
...
| [Apache Solr](https://lucene.apache.org/solr/)  |  -|  -| 一个基于Apache Lucene并与它共同发行的开源搜索平台.  |
...
### Email Marketing
 ...
 | 服务| 推特| 定价| 描述
|:--------|:--------|:--------|:------------|
| [QuickChart](https://quickchart.io/)  |  | 开源，自托管. 免费托管套餐，每月40美元起| 将图表和图形图像添加到您的电子邮件中. 支持Chart.js和Google图片图表格式.  |
...
| [Customer.io](https://customer.io) | [@CustomerIO](https://twitter.com/CustomerIO)  |  $ 50 / mo-$ 1250 / mo | 根据用户在您的应用中的行为发送或不发送电子邮件.  Customer.io使您可以使用站点中的数据将新闻稿发送给部分客户.  |
...
| [MailerLite](https://www.mailerlite.com) | [@mailerlite](https://twitter.com/mailerlite)  | 免费-每月140美元| 免费计划提供许多功能|
...
### Email Collection/Landing Page Apps
 ...
 | 服务| 推特| 定价| 描述
|:--------|:--------|:--------|:------------|
| [Launchrock](https://www.launchrock.com) | [@launchrock](https://twitter.com/launchrock)  |  $ 49 / mo-$ 199 / mo | 即使您知道如何使用HTML对网页进行编码，您也会喜欢我们的目标网页构建器可以使速度更快. 加载您的徽标和图形资产，从您的品牌调色板中设置一些基本颜色，然后发布.  |
| [Unbounce](https://unbounce.com) | [@unbounce](https://twitter.com/unbounce)  |  $ 49 / mo-$ 199 / mo |  Unbounce使营销人员能够独立于技术团队采取行动，从而提高了效率和创造销售的能力. 产生高转换目标网页，而无需处理IT瓶颈. 了解Unbounce如何增强您的广告系列并最大化您的营销支出.  |
| [LeadPages](https://www.leadpages.net/) | [@Leadpages](https://twitter.com/Leadpages)  |  $ 25 / mo-$ 199 / mo | 使用行业领先的登录页面生成器以及随附的潜在客户生成和选择工具套件，可以产生潜在客户并增加收入.  |
| [Instapage](https://instapage.com/) | [@Instapage](https://twitter.com/Instapage)  |  $ 29 / mo-$ 127 / mo | 用于优化广告支出的着陆页解决方案. 建立，整合，协作和优化.  |
| [KickoffLabs](https://kickofflabs.com) | [@kickofflabs](https://twitter.com/kickofflabs)  |  $ 29 / mo-$ 99 / mo | 停止构建登录页面. 开始制作更明智的广告系列. 将客户引导至与他们交流的定制页面. 让他们参与注册表单，新闻通讯，最重要的是，为客户推荐提供一个非常酷的独特REWARD系统.  |
...
### CRM/Sales Tools
 ...
 | 服务| 推特| 定价| 描述
|:--------|:--------|:--------|:------------|
| [Kloudless](https://kloudless.com) | [@kloudless](https://twitter.com/kloudless)  | 免费-每月$ 500 |  Kloudless允许您通过一个全面的RESTful API与多个CRM解决方案集成. 使用Kloudless CRM Unified API，您可以通过单个代码库与Salesforce，SugarCRM，Microsoft Dynamics，Zoho，Oracle Sales Cloud，HubSpot，Pipeliner等集成.  Kloudless还维护所有集成，因此您可以集中精力更快地构建出色的解决方案.  |
...
| [SugarCRM](https://www.sugarcrm.com) | [@sugarcrm](https://twitter.com/sugarcrm)  |  $ 35 /月-$ 150 /月|  Sugar的开放，灵活的平台可以轻松解决实际的业务问题. 从自动化的销售，市场营销和客户支持到创建自定义CRM应用程序，我们都能满足您的需求. 通过将个人置于解决方案的中心，SugarCRM将“ i”放在CRM中，并赋予每个面向客户的个人以建立非凡的客户关系的能力.  |
| [Insight.ly](https://www.insightly.com) | [@insightly](https://twitter.com/insightly)  |  $ 7 / mo | 小型企业CRM. 管理联系人，组织，合作伙伴，供应商和供应商. 查看所有内容，包括背景，电子邮件历史记录，事件，项目或机会|
...
| [Base](https://getbase.com) | [@ZendeskSell](https://twitter.com/ZendeskSell)  |  $ 15 / mo-$ 125 / mo | 您的团队将实际使用的销售和CRM软件.  Base旨在显着提高团队的销售效率，并为您提供发展业务所需的核心销售工具. 您的线索来自多种来源.  Base中的销售线索管理可帮助您组织销售线索并将其分配给正确的销售代表，以便对其进行跟进和快速定性. 合格后，在Base中转换潜在客户，您有关潜在客户的所有联系信息都会转移到新的客户联系卡上.  （可选）您可以指定跟进任务，甚至可以同时创建交易.  |
...
| [Word Safety](https://naming-tools.com/word-safety)  |  -| 免费|  Word安全工具，用于检查其他语言或其他形式的写作中的第二含义.  |
...
| [PivotDesk](https://www.pivotdesk.com) | [@PivotDesk](https://twitter.com/PivotDesk)  |  -| 一个办公共享市场，可以帮助需要空间的创业公司找到拥有多余空间的主机公司.  |
...
### Personal Productivity
 ...
 | 服务| 推特| 定价| 描述
|:--------|:--------|:--------|:------------|
| [Tomatoes](http://www.tomato.es/) | [@tomatoesapp](https://twitter.com/tomatoesapp)  |  -| 跟踪您的时间并使用番茄技巧提高工作效率.  Tomatoes是“番茄时间跟踪器”，是番茄时间技术驱动的时间跟踪器. 使用称为“ pomodoros”的25分钟时段跟踪您的时间.  |
...
| [fman](https://fman.io) | [@m_herrmann](https://twitter.com/m_herrmann)  |  $ 14.00 | 轻松管理和传输文件. 对于Windows，Mac和Linux.  |
...
| [Creately](https://creately.com) | [@creately](https://twitter.com/creately)  | 免费-750美元/月| 基于Web的制图工具，用于快速简单绘制图表. 支持流程图，模型，线框图，思维导图，组织结构图，网络图，AWS图，UML图和许多其他图类型. 实时协作以及创新的生产力功能，使图表创建速度提高了3倍.  |
| [Keynote](https://www.apple.com/keynote/)  |  -|  $ 19.99 | 全新的Keynote可以轻松创建华丽的演示文稿，其功能强大但易于使用的工具和令人眼花effects乱的效果将使您难以采取行动. 还结帐 [Keynotopia Themes](https://github.com/cjbarber/ToolsOfTheTrade/blob/master/ https://keynotopia.com) 获取iOS，Android等的所有常见UI元素.
| [OmniGraffle](https://www.omnigroup.com/omniGraffle) | [@omniGraffle](https://twitter.com/omniGraffle)  |  $ 99.99 | 绘制价值一千个字的图表. 需要图表，流程图，快速页面布局，网站线框或图形设计吗？  OmniGraffle可以通过使线条即使在移动时也保持与形状的连接来帮助您快速制作令人眼花graphic乱的图形文档，提供强大的样式工具，只需单击一下即可神奇地组织图表. 是否需要快速|
...
| [Balsamiq](https://balsamiq.com) | [@balsamiq](https://twitter.com/balsamiq)  |  -| 对于劣质软件而言，生命太短了！  Balsamiq Mockups是一个快速的线框图工具，可帮助您更快，更聪明地工作. 它重现了在白板上但使用计算机进行素描的体验.  |
...
| [invision](https://www.invisionapp.com) | [@InVisionApp](https://twitter.com/InVisionApp)  |  $ 0 /月-$ 100 + /月| 免费的网络和移动（iOS，Android）原型设计和UI样机工具. 将您的Web和移动（iOS，Android）设计转换为可单击的交互式原型和模型. 与他人分享和协作.  |
...
| [Figma](https://www.figma.com) | [@figmadesign](https://twitter.com/figmadesign)  | 免费-$ 12 / editor / mo | 设计和原型制作工具，重点是协作和团队.  |
...
| [UXPin](https://www.uxpin.com/) | [@uxpin](https://twitter.com/uxpin)  |  $ 0-$ 23 + / mo | 全栈UX设计平台：将设计系统，原型和文档集中在一个地方.  |


 | 服务| 推特| 定价| 描述
|:--------|:--------|:--------|:------------|
| [AudienceOps](https://audienceops.com) | [@AudienceOps](https://twitter.com/AudienceOps)  |  $ 850 / mo-$ 1700 / mo |  AudienceOps处理整个内容策略，因此您可以专注于产品.  |
| [Visual.ly](https://visual.ly) | [@Visually](https://twitter.com/Visually)  |  $ 195 /月-$ 994 /月| 品牌的原始视觉内容. 我们只会与最优秀的创意人才合作. 成千上万的设计师，新闻工作者，动画师和开发人员正在为您服务，以帮助您实现目标并将您的项目提升到一个新的水平.  |
...
| [PickFu](https://www.pickfu.com) | [@pickfu](https://twitter.com/pickfu)  |  $ 50 /月-$ 299 /月| 几分钟内即可获得真正的消费者反馈.  PickFu是一种工具，可针对您关心的问题提供即时，公正和有见地的舆论.  |
| [Promoter.io](https://www.promoter.io) | [@Promoter_io](https://twitter.com/promoter_io)  |  $ 199 /月-$ 479 /月| 帮助公司快速获得由NPS（Net Promoter）驱动的预测性客户智能和见解，以增加收入并减少客户流失.  |
...
### Data
 ...
 | 服务| 推特| 定价| 描述
|:--------|:--------|:--------|:------------|
| [Factual](https://www.factual.com) | [@Factual](https://twitter.com/Factual)  |  -| 全球数据. 本地上下文.  Factual的定位平台利用确定的全球数据丰富了移动位置信号，从而实现了个性化和上下文相关的移动体验.  Factual的实时数据堆栈通过数十亿的输入构建而成，并不断更新数据.  |

### Database

 | 服务| 推特| 定价| 描述
|:--------|:--------|:--------|:------------|
| [Citus](https://www.citusdata.com) | [@citusdata](https://twitter.com/citusdata)  |  -|  Citus通过分片，复制和查询并行化来扩展PostgreSQL. 因此，您可以专注于应用程序，而不必担心数据库.  Citus可以作为开源，企业软件和完全托管的数据库即服务提供.  |
| [Bulbs](http://bulbflow.org)  |  -|  -| 用于图数据库的Python持久性框架.  |
| [Datomic](https://www.datomic.com) | [@datomic_team](https://twitter.com/datomic_team)  |  -| 完全可交易的，可用于云的，不变的数据库. 不变的数据意味着强大的一致性，水平读取扩展性以及内置缓存.  Datomic是一个分布式数据库，旨在支持在下一代云体系结构上运行的可扩展，灵活和智能的应用程序.  |
...
| [DBngin](https://dbngin.com) | [@DBngin](https://twitter.com/dbngin)  | 免费| 数据库版本管理的多合一工具. 单击它，您可以设置任何版本的本地数据库服务器.  |
...
### Accounting/Invoicing
 ...
 | 服务| 推特| 定价| 描述
|:--------|:--------|:--------|:------------|
| [Harvest](https://www.getharvest.com) | [@harvest](https://twitter.com/harvest)  |  $ 12 / mo-$ 99 / mo | 时间跟踪变得容易. 通过Harvest，时间跟踪非常简单，闪电般快速. 设置过程仅需几秒钟，因此无需安装任何内容. 我们简化了时间表和时间表批准流程，因此您可以专注于工作.  |
| [Ballpark](https://www.getballpark.com) | [@ballparkapp](https://twitter.com/ballparkapp)  |  $ 12 / mo-$ 99 / mo | 停止向客户发送难看的纸质发票. 今天，与Ballpark一起无纸化. 我们精美的基于网络的发票和预算使您比以往更容易获得付款并与您的客户和同事讨论项目.  |
| [PaySimple](https://paysimple.com) | [@PaySimple](https://twitter.com/PaySimple)  |  $ 34.95 / mo | 简化结算方式.  PaySimple是行业领先的支付管理解决方案提供商.  PaySimple通过使您能够自动对所有付款进行计费，收集和存款，简化了计费和收款流程. 我们定制的安全ASP解决方案包括自动循环账单，电子支票处理，直接借记和信用卡处理（某些可用的最低费率）.  |
| [FreshBooks](https://www.freshbooks.com) | [@freshbooks](https://twitter.com/freshbooks)  |  $ 19.95 / mo-$ 39.95 / mo | 专为您而设的会计（非会计）.  FreshBooks简单直观，因此会计工作不会令人生畏. 另外，如果您在周一至周五美国东部时间上午9点至下午6点有任何疑问，可以与真实的人交谈.  |
| [FreeAgent](https://www.Freeagent.com) | [@Freeagent](https://twitter.com/Freeagent)  |  US $ 20 / mo | 会计软件受到35,000多位自由职业者和小型企业的信赖. 通过您的电子银行对帐单核对业务中的资金，并建立每月资产负债表.  |
| [Blinksale](https://www.blinksale.com) | [@blinksale](https://twitter.com/blinksale)  |  $ 15.00 | 无限介绍Blinksale. 一个计划. 一价. 无限的一切. 眨眼间可以让您看起来最好. 拥有十多种发票设计并感谢您，您一定会尽力而为. 每次.  |
| [Cashboard](https://cashboardapp.com/) | [@cashboard](https://twitter.com/cashboard)  |  $ 8.25 / mo-$ 250 / mo | 全球数千人信任的FreeLance时间跟踪和发票软件.  Cashboard是我们设计用来纠正这种情况的工具. 它适用于我们的软件咨询公司，我们认为它也适用于您. 经过数夜不眠之夜的努力，我们于2007年春季推出了Cashboard. 这是第一个将估算，发票，时间跟踪和在线支付结合到一个工具中的解决方案.  |
| [Paydirt](https://paydirtapp.com) | [@paydirtapp](https://twitter.com/paydirtapp)  |  $ 8 / mo-$ 149 / mo | 智能时间跟踪更容易为在线付款开具发票. 在Paydirt中，您可以一键从任何页面启动计时器. 没有精美的菜单. 没有四处导航. 只是每个任务的开始按钮.  |
...
| [Fast409A](https://Fast409A.io) | [@ltse](https://twitter.com/ltse)  |  2000美元（取决于启动资金阶段）|  Fast409A.io流程融合了最好的软件和专业知识. 每次409A评估都需要花费您一个小时或更短的时间来提交，几天之内即可交付，而不是数周，并且可以根据您的新创企业的细微差别进行定制.  |
| [Runway](https://startuprunway.io) | [@ltse](https://twitter.com/ltse)  | 免费| 大多数初创公司死于现金不足. 跑道是一种简便，直观的方法，可以计划和管理您的创业公司最宝贵的资源，探索方案并跟踪计划支出与实际支出.  |
...
### Income Analytics
 ...
 | 服务| 推特| 定价| 描述
|:--------|:--------|:--------|:------------|
| [Baremetrics](https://baremetrics.com) | [@Baremetrics](https://twitter.com/Baremetrics)  |  $ 79 / mo-$ 249 / mo | 一键操作，您将从Stripe帐户中获取数十个有价值的指标|
...
| [Gumroad](https://gumroad.com) | [@gumroad](https://twitter.com/gumroad)  |  -| 看到更高的转化率，更低的费用和更多的客户控制权. 直接向观众出售电影. 创造数字产品是困难的，应该出售数字产品不是一件容易的事. 我们让您在几秒钟内就开始销售下载内容.  |
| [FetchApp](https://www.fetchapp.com) | [@fetchapp](https://twitter.com/fetchapp)  |  $ 5 / mo-$ 500 / mo | 提取的更简单方法. 简而言之，FetchApp允许您销售和以数字方式交付可下载商品|
| [Chargify](https://www.chargify.com) | [@chargify](https://twitter.com/chargify)  |  $ 459 /月-$ 65 /月| 轻松管理您的经常性收入业务. 客户注册，付款，使用优惠券，升级...您可以使用所需的任何定价模型，一次性收费，记帐卡，发送发票和提醒等方式向您收取一次性费用和经常性费用.
| [Recurly](https://recurly.com) | [@Recurly](https://twitter.com/Recurly)  |  $ 99 / mo-$ 259 / mo | 订阅计费自动化. 作为领先的定期计费平台，Recurly确保设置简便，集成迅速，并且我们的服务可根据您的业务需求进行扩展. 借助Recurly，您将随时可以接受付款，并专注于迅速增加销售额.  |
| [ChargeOver](https://chargeover.com) | [@ChargeOver](https://twitter.com/chargeover)  |  $ 65 / mo- $ 549 / mo |  ChargeOver是功能齐全的发票开发平台，支持付款计划，定期计费，一次性计费以及所有主要网关后端.  |
...
### Billing & Payment Processing
 ...
 | 服务| 推特| 定价| 描述
|:--------|:--------|:--------|:------------|
| [Braintree](https://www.braintreepayments.com) | [@braintree](https://twitter.com/braintree)  |  -| 在您的应用或网站上接受付款.  Braintree为Uber，Airbnb，HotelTonight和Fab等一些发展最快的移动公司处理交易. 借助适用于iOS，Android和Windows Phone的本机且易于遵循的SDK，您可以将本机付款快速添加到您的应用中.  |
| [Dwolla](https://www.dwolla.com) | [@dwolla](https://twitter.com/dwolla)  | 每笔交易25美分| 转移资金的最佳方法.  Dwolla，Inc.是Veridian Credit Union的代理商，与您在Dwolla网络中的帐户关联的所有资金都保存在Veridian Credit Union的合并帐户中. 这些资金不符合个人保险的资格，也可能不符合国家信用社股票保险基金的股票保险资格.  Dwolla，Inc.是软件平台的运营商，该软件平台将有关资金转账的用户指令传达给Veridian Credit Union.  |
...
| [WePay](https://go.wepay.com) | [@wepay](https://twitter.com/wepay)  |  2.9％+ 30¢/交易.  |  WePay是第一个提供平台，市场，众筹和商业软件/工具的支付引擎，这种平台拥有客户的体验，同时仍能使他们免受100％的欺诈和监管风险.  |
| [Paddle](https://paddle.com) | [@PaddleHQ](https://twitter.com/PaddleHQ)  |  5％+ 50¢/交易.  | 付款处理和履行，专门用于桌面应用程序和SaaS订阅服务. 为您处理增值税和发票，因此您的会计变得更加容易.  |
| [Fattmerchant](https://fattmerchant.com/) | [@Fattmerchant](https://twitter.com/fattmerchant)  |  0％+兑换+ $ 99 + / mo | 付款统一.  | 将您的应用程序，网站，软件或硬件与Fattmerchant API集成在一起，以无缝接受所有主要的信用卡，ACH付款等等！ 面对面和在线交易的理想选择.  |

### Boilerplates

 | 服务| 推特| 定价| 描述
|:--------|:--------|:--------|:------------|
| [Lad](https://lad.js.org) | [@niftylettuce](https://twitter.com/niftylettuce)  | 免费|  Lad支架为Node.js提供了Koa Webapp和API框架. 它还包括一个工作计划程序，自动电子邮件预览和模板等等.  |
...
### Banking
 ...
 | 服务| 推特| 定价| 描述
|:--------|:--------|:--------|:------------|
| [Simple](https://www.simple.com) | [@simple](https://twitter.com/simple)  |  -| 银行应采用的方式.  |
...
| [Dialpad](https://www.dialpad.com) | [@DialpadHQ](https://twitter.com/dialpadHQ)  |  $ 15 /用户/ mo | 以人为本的电话和会议系统，包括互联网传真，可为您跟踪工作地点|
...
| [Notion](https://www.notion.so/) | [@notionhq](https://twitter.com/notionhq)  | 免费-$ 8 /用户/月| 编写，计划，协作和组织. 一个工具即可满足您的所有需求.  |
...
| [Flowdock](https://www.flowdock.com/) | [@flowdock](https://twitter.com/flowdock)  | 最多可容纳5人的团队免费|  -|
...
| [Google Hangouts](https://hangouts.google.com/)  |  -| 免费|  Google提供的视频会议和聊天应用程序. 它基于浏览器，并支持同一视频通话中的多个参与者.  |
...
| [Typeform](https://www.typeform.com) | [@typeform](https://twitter.com/typeform)  |  $ 0 / mo-$ 25 / mo | 太好了！  Typeform使提问变得轻松，人性化和美观. 用户体验使您的问题在任何地方看起来和感觉都很棒. 受激，鼓舞，兴奋，快乐的受访者可以提高完成率. 通过集成的分析工具获得见解.  |
...
| [FormKeep](https://formkeep.com) | [@formkeep](https://twitter.com/formkeep)  |  $ 59 /月-$ 199 /月|  Premium Forms后端服务具有内置的垃圾邮件防护功能，与1000多种服务的数据集成，数据保留策略等.  |
...
### Geocoding
 ...
 | 服务| 推特| 定价| 描述
|:--------|:--------|:--------|:------------|
| [OpenCage Geocoder](https://opencagedata.com/) | [@OpenCageData](https://twitter.com/opencagedata)  |  $ 0-1000 /月| 使用开放数据的正向和反向地理编码API. 全球覆盖. 慷慨的免费试用版大多数编程语言的许多教程和库|
...
| [RedisLabs](https://redislabs.com) | [@RedisLabs](https://twitter.com/RedisLabs)  | 免费-338美元/月|  RedisLabs提供了完全托管的云服务，用于以高可用性和可扩展方式托管和运行Redis或内存缓存数据集，并具有可预测和稳定的顶级性能.  |

### Backend-aaS

 | 服务| 推特| 定价| 描述
|:--------|:--------|:--------|:------------|
| [Firebase](https://firebase.google.com) | [@Firebase](https://twitter.com/Firebase)  |  -| 强大的API，用于实时存储和同步数据. 使用客户端代码和强大的Firebase API在几分钟内构建实时移动和Web应用程序. 当数据更改时，使用Firebase构建的应用程序会在每台设备（网络或移动设备）上即时更新.  |
...
| [SpiderOak](https://spideroak.com) | [@spideroak](https://twitter.com/spideroak)  | 前2GB免费-US $ 100 / 100GB /年 [twitter](https://twitter.com/spideroak) 交易）| 商店. 同步. 分享. 私下 |
...
| [Apiary](https://apiary.io) | [@apiary](https://twitter.com/apiaryio)  | 免费-$ 99 /月| 强大的API设计栈. 专为开发人员打造. 共同努力以快速设计，原型化，记录和测试API.  |
...
| [Zapier](https://zapier.com) | [@Zapier](https://twitter.com/zapier)  |  $ 99 / mo-$ 15 / mo | 超级大国可以完成您的工作.  Zap是两个应用程序之间的链接（“触发”和“动作”）.  Zaps每隔几分钟就会在后台自动运行，以代表您移动和管理数据. 只有实时Zaps会超出您的限制-您可以根据需要选择任意数量的已暂停和未完成的Zaps. 例如，一个Zap可能是“每次收到新电子邮件时向我发送一条短信”.  |
| [Integromat](https://www.integromat.com) | [@integromat](https://twitter.com/integromat)  |  &lt;1000次操作或100 MB /月免费，费用为$ 9 /月| 自动执行任务并连接到几乎所有应用程序或服务. 非常强大的工具集，具有错误处理，迭代器，聚合器，路由器，函数，数据存储等功能.
| [Dead Man's Snitch](https://deadmanssnitch.com) | [@DeadMansSnitch](https://twitter.com/deadmanssnitch)  | 免费-每月$ 49 | 监视计划的任务（例如cron）和服务心跳. 使特定工作何时及为何失败容易知道.  |
...
| [Reveal.js](https://github.com/hakimel/reveal.js)  |  -|  -| 灵活的HTML演示框架，可创建精美的幻灯片|
| [Impress.js](https://github.com/impress/impress.js/) |  -|  -| 基于Prezi启发的CSS3转换和过渡的演示框架|
