...
- [KISSS](https://kis3.dev)  -非常简约（KISS）网站统计工具.  （[Source Code](https://github.com/kis3/kis3)）MIT``去
...
- [Anchor CMS](https://anchorcms.com/)  -免费的，轻巧的，比子弹快的简单博客系统，专为艺术指导而设计.  （[Source Code](https://github.com/anchorcms/anchor-cms)）`GPL-3.0``PHP`
...
- [golinks](https://github.com/prologic/golinks)  -Web应用程序，通过将Web浏览器的默认搜索引擎指向正在运行的实例，您可以创建智能书签，命令和别名.  与bunny1或yubnub类似.  （[Demo](https://search.mills.io)）MIT``去
...
- [SimpleLogin](https://simplelogin.io)  -开源电子邮件别名解决方案，可保护您的电子邮件地址.  随附浏览器扩展程序和移动应用程序.  （[Source Code](https://github.com/simple-login/app)）`MIT`` Docker / Python`
...
- [Dispatch](https://github.com/khlieng/dispatch)  -用Go编写的自托管Web IRC客户端.  （[Demo](https://dispatch.khlieng.com/connect)）MIT``去
...
- [Routr](https://routr.io)  -轻量级的SIP代理，位置服务器和注册器，可提供可靠且可扩展的SIP基础结构.  （[Demo](https://demo.routr.io/login), [Source Code](https://github.com/fonoster/routr)）MIT JavaScript
...
- [remark42](https://remark42.com/)  -轻巧简单的评论引擎，不会对用户构成监视.  它可以嵌入到博客，文章或读者在其中添加评论的任何其他地方.  （[Demo](https://remark42.com/demo/), [Source Code](https://github.com/umputun/remark)）MIT``去
...
- [osem](http://osem.io/) - Event management tailored to free Software conferences. ([Demo](http://demo.osem.io/), [Source Code](https://github.com/openSUSE/osem)``MIT&#39;&#39;红宝石
...
- [Directus](http://getdirectus.com/)  -Directus是一款功能强大且直观的无头CMS，用于管理具有自定义体系结构的SQL数据库.  这种分离的内容管理框架基于健壮且可扩展的API构建，非常适合网站，应用程序或多客户端项目.  （[Source Code](https://github.com/directus/directus)）`GPL-3.0``PHP`
...
- [Tiny Tiny RSS](https://tt-rss.org)  -开源的基于Web的新闻源（RSS / Atom）阅读器和聚合器.  （[Demo](http://framanews.org/), [Source Code](https://git.tt-rss.org/fox/tt-rss)）`GPL-3.0``PHP`
  ...
  - [ttrss-reader](https://github.com/kucrut/ttrss-reader)  -轻巧，响应迅速的TTRSS客户.  GPL-2.0 Javascript
...
- [RSS2EMail](https://github.com/wking/rss2email)  -提取RSS / Atom提要并将新的内容推送到任何电子邮件接收者，支持OPML.  GPL-2.0 Python
...
- [bittorrent-tracker](https://webtorrent.io/)  -简单，健壮的BitTorrent跟踪器（客户端和服务器）实施.  （[Source Code](https://github.com/feross/bittorrent-tracker)）MIT Nodejs
...
- [droppy](https://github.com/silverwind/droppy)  -droppy是一种自托管的云服务器，其界面类似于桌面文件管理器，并具有即时编辑文件以及直接在浏览器中查看和播放媒体的功能.  BSD-2-Clause NodeJS
...
- [img.bi](https://github.com/imgbi/img.bi)  -img.bi是安全的图像托管.  上传前，在浏览器中使用AES-256和随机密钥对图像进行加密.  GPL-3.0 NodeJS
...
- [Jirafeau](https://gitlab.com/mojo42/Jirafeau)  -Jirafeau是一个允许以简单的方式上传文件并提供唯一链接的网站.  （[Demo](http://jirafeau.net/)）`AGPL-3.0``PHP`
...
- [Pomf](https://github.com/Pomf/Pomf)  -简单的文件上传和共享，现在关闭的网站Pomf.se的来源.  麻省理工学院PHP
...
- [Apaxy](https://oupala.github.io/apaxy/)  -通过使用mod_autoindex Apache模块和一些CSS来覆盖目录列表的默认样式，构建了增强浏览网页目录体验的主题.  （[Source Code](https://github.com/AdamWhitcroft/Apaxy)）`Unlicense``HTML`
...
- [Encode Explorer](http://encode-explorer.siineiolekala.net/)  -Encode Explorer是一个单页文件浏览器，它既简单又实用.  （[Demo](http://encode-explorer.siineiolekala.net/explorer/index.php), [Source Code](https://github.com/marekrei/encode-explorer)）`MIT`` PHP`
- [explorer](https://soyuka.github.io/explorer/)  -使用nodejs创建的高度可配置的目录列表.  （[Source Code](https://github.com/soyuka/explorer)）MIT Nodejs
- [filebrowser](https://filebrowser.xyz/)  -Web文件管理器，可以用作中间件或独立应用程序.  （[Source Code](https://github.com/filebrowser/filebrowser)）`Apache-2.0``Go / VueJS`
...
- [Gossa](https://github.com/pldubouilh/gossa)  -Gossa是用于文件的轻便简单的Web服务器.  麻省理工学院
- [h5ai](https://larsjung.de/h5ai/)  -用于HTTP Web服务器的现代文件索引器，重点放在您的文件上.  目录以吸引人的方式显示，并且通过不同的视图，面包屑和树概述增强了浏览目录的能力.  （[Demo](https://larsjung.de/h5ai/demo/), [Source Code](https://github.com/lrsjng/h5ai)）`MIT`` PHP`
...
- [TagSpaces](https://www.tagspaces.org/)  -TagSpaces是一个脱机的跨平台文件管理器和组织器，还可以用作笔记应用程序.  该应用程序的WebDAV版本可以安装在WebDAV服务器（例如Nextcloud或ownCloud）的顶部.  （[Demo](http://demo.tagspaces.org), [Source Code](https://github.com/tagspaces/tagspaces)）`AGPL-3.0``Javascript`
...
- [SourceBans++](https://sbpp.github.io)  -用于在Source引擎上运行的游戏的管理，禁止和通讯管理系统.  （[Source Code](https://github.com/sbpp/sourcebans-pp)）`CC-BY-SA-4.0``PHP`
- [Teeworlds](https://www.teeworlds.com)  -开源2D复古多人射击游戏.  （[Source Code](https://github.com/teeworlds/teeworlds)）`BSD-3-Clause / Other``C ++`
- [TournamentMango](https://github.com/seiyria/tournamentmango)  -TournamentMango是一个开源的比赛框架和用户管理系统.  您可以建立玩家档案，并跟踪他们随时间推移的所有得分以及常规角色，游戏和别名.  MIT Javascript
...
- [IceHrm](https://icehrm.com/)  -IceHrm员工管理系统使公司可以集中员工的机密信息.  （[Demo](https://icehrm.com/demo.php), [Source Code](https://github.com/gamonoid/icehrm)）`Apache-2.0``PHP`
...
- [FHEM](https://fhem.de/fhem.html)  -FHEM用于自动化家庭中的常见任务，例如开关灯和暖气.  它也可以用来记录温度或功耗等事件.  您可以通过Web或智能手机前端，telnet或TCP / IP直接控制它.  （[Source Code](https://svn.fhem.de/trac)）`GPL-3.0` Perl
...
- [Nominatim](https://nominatim.org/)  -用于对OpenStreetMap数据进行反向地理编码（地址-&gt;坐标）的服务器应用程序.  （[Source Code](https://github.com/openstreetmap/Nominatim)）`GPL-2.0`` C`
...
- [Icecast 2](http://www.icecast.org/)  -流音频/视频服务器，可用于创建Internet广播电台或私人运行的自动点唱机，介于两者之间.  （[Source Code](https://git.xiph.org/?p=icecast-server.git;a=summary), [Clients](http://www.icecast.org/apps/)）`GPL-2.0`` C`
- [Jellyfin](https://jellyfin.media)  -具有流畅的UI和强大的转码功能的流音频/视频服务器（Emby的分叉）.  （[Source Code](https://github.com/jellyfin/jellyfin)) `GPL-2.0` `C#`
...
- [Audioserve](https://github.com/izderadicka/audioserve)  -简单的个人服务器，可提供目录（有声读物，音乐，播客等）中的音频文件.  注重简单性，并支持客户端之间的播放位置同步.  麻省理工学院
...
- [Tube](https://prologic.github.io/tube)  -用Go语言编写的类似Youtube的视频（无需审查，无需任何功能！_），它还支持自动转码为MP4 H.265 AAC，多个集合和RSS feed.  （[Demo](https://tube.mills.io), [Source](https://github.com/prologic/tube)）MIT``去
...
- [Flox](https://github.com/devfake/flox)  `⚠`-具有三分评级系统的自托管电影，电视剧和动漫观看列表.  使用电影数据库后端获取信息.  （[Demo](https://flox-demo.pyxl.dev/)）`MIT`` PHP`
...
- [How Secure Is My Password](https://github.com/howsecureismypassword/hsimp)  -我的密码有多安全，而不仅仅是说密码是“弱”或“强”？  让您的用户知道某人破解密码需要多长时间.  （[Demo](https://howsecureismypassword.net/)）MIT Javascript
- [google-webfonts-helper](https://github.com/majodev/google-webfonts-helper)  `⚠`-轻松自如地托管Google字体的方法.  获取eot，ttf，svg，woff和woff2文件以及CSS代码段.  （[Demo](https://google-webfonts-helper.herokuapp.com/)）MIT Nodejs
...
- [Economizzer](http://www.economizzer.org/)  -一个简单安全的系统，可让您管理您的个人资金并实现目标，并且可以通过计算机，平板电脑或智能手机进行访问.  （[Demo](https://github.com/gugoan/economizzer#live-demo), [Source Code](https://github.com/gugoan/economizzer)）`MIT`` PHP`
- [ExMoney](https://github.com/gaynetdinov/ex_money)  -自托管的个人理财应用程序.  `ISC``长生不老药`
- [Firefly III](https://firefly-iii.org/)  -Firefly III是一位现代财务经理.  它可以帮助您跟踪资金状况并进行预算预测.  它支持信用卡，具有高级规则引擎，可以从许多银行导入数据.  它由Laravel支持，需要PHP7.3.  （[Demo](https://demo.firefly-iii.org/), [Source Code](https://github.com/firefly-iii/firefly-iii)）`AGPL-3.0``PHP`
...
- [DocPHT](https://docpht.org/)  -使用DocPHT，您可以记笔记并快速记录所有内容，而无需使用任何数据库.  （[Demo](https://demo.docpht.org/), [Source Code](https://github.com/kenlog/docpht)）`MIT`` PHP`
...
- [turndown](https://domchristie.github.io/turndown/)  -用JavaScript编写的HTML至Markdown转换器.  （[Source Code](https://github.com/domchristie/turndown)）MIT Javascript
...
- [EtherCalc](https://ethercalc.org/)  -网络电子表格.  （[Source Code](https://github.com/audreyt/ethercalc)）CPAL-1.0 / Other` Node.js
- [EtherDraw](https://github.com/JohnMcLear/draw)  -直观的基于协作网络的绘图工具.  Apache-2.0 NodeJS
...
- [PHPOffice](https://github.com/PHPOffice)  -PHPOffice包含允许从大多数办公套件读写文件的库.  `LGPL-3.0``PHP`
...
- [Bitwarden](https://bitwarden.com/)  `⚠`-带有网络应用程序，浏览器扩展程序和移动应用程序的密码管理器.  （[Source Code](https://github.com/bitwarden/core)) `AGPL-3.0` `C#`
...
- [cryptonote](https://cryptonote.me/)  -简单的开源Web应用程序，使用户可以加密和共享只能读取一次的消息.  （[Source Code](https://github.com/alainmeier/cryptonote)``MIT&#39;&#39;红宝石
...
- [filite](https://github.com/raftario/filite)  -简单，轻巧和独立的粘贴框，URL缩短器和文件共享服务.  （[Demo](https://filite.raphaeltheriault.com)）`MIT``休息`
...
- [NoteHub](https://github.com/chmllr/NoteHub)  -用于Markdown页面的免费，轻松的Pastebin.  简单，干净，提供密码，生成短链接.  MIT`Nodejs`
...
- [Snibox](https://snibox.github.io/)  -具有吸引人的面向标签界面的代码片段管理器.  （[Demo](https://snibox-demo.herokuapp.com/), [Source Code](https://github.com/snibox/snibox)``MIT&#39;&#39;红宝石
...
- [Tipboard](http://allegro.tech/tipboard/)  -内部，美味，本地仪表板系统.  （[Source Code](https://github.com/allegro/tipboard)）`Apache-2.0`` Python`
...
- [Lychee](https://lycheeorg.github.io/)  -基于开源网格和相册的照片管理系统.  （[Source Code](https://github.com/LycheeOrg/Lychee)）`MIT`` PHP`
...
- [OwnPhotos](https://github.com/hooram/ownphotos)  -自行托管的Google Photos克隆，略微关注酷图.  麻省理工学院Python
...
- [Clerk](https://github.com/chr15m/Clerk)  -简单的事件记录器，可以跟踪发生的定期事件，习惯等.  `GPL-3.0``PHP`
...
- [PHP-Proxy](https://www.php-proxy.com/)  -专为快速，轻松修改并支持YouTube等视频网站而构建的Web代理脚本.  （[Demo](https://unblockvideos.com/), [Source Code](https://github.com/Athlon1600/php-proxy-app)）`MIT`` PHP`
- [Pomerium](https://pomerium.io)  -身份识别的反向代理，是现在已经过时的oauth_proxy的后继代理.  它在将您的请求代理到后端之前插入一个OAuth步骤，以便您可以安全地将自己托管的网站公开到公共Internet.  （[Source Code](https://github.com/pomerium/pomerium)）Apache-2.0`Go`
...
- [Squid](http://www.squid-cache.org/)  -用于支持HTTP，HTTPS，FTP等的Web缓存代理.  通过缓存和重用经常请求的网页，它减少了带宽并缩短了响应时间.  （[Source Code](https://code.launchpad.net/squid)）`GPL-2.0`` C`
- [Swiperproxy](https://swiperproxy.github.io/)  -快如闪电的开源Web代理，您可以轻松运行和自定义.  （[Source Code](https://github.com/swiperproxy/swiperproxy)）`MIT`` Python`
...
- [grocy](https://grocy.info/)  -冰箱外的ERP-grocy是基于Web的自托管杂货和家庭管理解决方案.  （[Demo](https://en.demo.grocy.info/), [Source Code](https://github.com/grocy/grocy)）`MIT`` PHP`
...
- [MeiliSearch](https://meilisearch.com)  -超相关，即时且可输入错误的全文搜索API.  （[Source Code](https://github.com/meilisearch/MeiliSearch)）`MIT``休息`
...
- [GitLab](http://gitlab.org/)  -自托管Git信息库管理，代码审查，问题跟踪，活动供稿和Wiki.  （[Demo](https://gitlab.com/), [Source Code](https://gitlab.com/gitlab-org/gitlab-ce)``MIT&#39;&#39;红宝石
...
- [Klaus](https://github.com/jonashaag/klaus)  -易于使用的简单，易于设置的Git Web查看器.  ISC Python
...
- [Leantime](https://leantime.io)  -Leantime是一个面向小型团队和初创公司的精益项目管理系统，可帮助从构思到交付管理项目.  （[Source Code](https://github.com/leantime/leantime)）`GPL-2.0``PHP`
...
- [ProjeQtOr](https://www.projeqtor.org/)  -完整，成熟的多用户项目管理系统，具有针对项目所有阶段的广泛功能.  （[Demo](https://demo.projeqtor.org/), [Source Code](https://sourceforge.net/p/projectorria/code/HEAD/tree/branches/)）`AGPL-3.0``PHP`
...
- [UVDesk](https://www.uvdesk.com/)  -UVDesk社区是面向服务的，事件驱动的可扩展开源帮助台系统，您的组织可以使用它以您想像的任何方式轻松地为您的客户提供有效的支持.  （[Demo](https://demo.uvdesk.com/), [Source Code](https://github.com/uvdesk/community-skeleton)）`MIT`` PHP`
...
- [Uier](https://github.com/sjoerdvanderhoorn/Uier)  -使用Selenium进行测试或UI自动化的无代码或低代码用户体验测试编辑和管理.  Uier往往是Applitools，Endtest，Ghost Inspector，Usetrace，Screenster和许多其他工具的免费自托管替代产品.  Apache-2.0 NodeJS
...
- [Zalenium](https://github.com/zalando/zalenium)  -允许任何人拥有基于Docker的一次性且灵活的Selenium Grid基础设施，该基础设施具有视频录制，实时预览和在线/离线仪表板.  Apache-2.0 Java /外壳
...
- [Kanbana](https://github.com/SrGMC/kanbana)  -创建公告板以从纯减价文件跟踪用户和项目.  由Crepido`MIT` Nodejs`分叉
- [Kanboard](http://kanboard.net/)  -简单和开源的视觉任务板.  （[Source Code](https://github.com/kanboard/kanboard)）`MIT`` PHP`
...
- [gShort](https://github.com/someone-stole-my-name/gShort)  -隐私友好的自托管URL缩短器.  （[Demo](http://gshort.christiansegundo.com/)）`GPL-3.0``Go`
...
- [liteshort](https://github.com/132ikl/liteshort)  -用户友好的，实际上是轻量的，可配置的URL缩短器.  （[Demo](https://ls.ikl.sh)）`MIT`` Python`
- [Lstu](https://github.com/ldidry/lstu)  -_让我们减少网址_-轻型URL缩短器.  `WTFPL``Perl`
...
- [Shlink](https://shlink.io)  -带有REST API和命令行界面的URL缩短器.  包括官方渐进式Web应用程序和Docker映像.  （[Source Code](https://github.com/shlinkio/shlink), [Clients](https://shlink.io/apps)）`MIT`` PHP`
...
- [Cowyo](https://github.com/schollz/cowyo)  -Cowyo是极简主义者的功能丰富的Wiki.  （[Demo](https://cowyo.com)）MIT``去
...
- [Wiki.js](https://wiki.js.org/)  -建立在NodeJS，Git和Markdown上的现代，轻巧且功能强大的Wiki应用程序.  （[Demo](https://docs.requarks.io)）`AGPL-3.0`` Nodejs`
...
- [Piratebox](https://github.com/PirateBox-Dev)  -使用免费软件和廉价的现成硬件构建的DIY匿名离线文件共享和通信系统.  GPL-3.0 Python /其他
...
- [Awesome Sysadmin](https://github.com/n1trux/awesome-sysadmin) -精选的令人敬畏的开源sysadmin资源列表.
