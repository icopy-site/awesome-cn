...
自我托管是在本地托管和管理应用程序的一种做法，而不是从 [SaaSS](https://www.gnu.org/philosophy/who-does-that-server-really-serve.html) 供应商.
...
- [Fathom Analytics](https://usefathom.com)  -简单可靠的网站分析.  （[Source Code](https://github.com/usefathom/fathom)）`MIT`` Go`
...
- [Open Web Analytics](http://www.openwebanalytics.com/)  -Google Analytics（分析）和Piwik替代品.  （[Source Code](https://github.com/padams/Open-Web-Analytics)）`GPL-2.0`` PHP`
...
- [Metabase](http://www.metabase.com/)  -简单的仪表板和GUI查询工具，每夜电子邮件和带有PostgreSQL，MySQL，Redshift和其他数据库的Slack集成.  （[Source Code](https://github.com/metabase/metabase)）`AGPL-3.0``Clojure`
...
- [Socioboard](https://socioboard.org/)  -`⚠`社交媒体管理，分析和报告平台，支持九个现成的社交媒体网络.  （[Source Code](https://github.com/socioboard/Socioboard-Core-3.0)) `GPL-3.0` `C#/JavaScript`
...
- [ArchiveBox](https://archivebox.io/)  -自托管的“回溯机器”，可根据您的书签，浏览历史记录，RSS提要或其他来源创建网站的HTML和屏幕快照存档.  （[Demo](https://archive.sweeting.me), [Source Code](https://github.com/pirate/bookmark-archiver)）`MIT`` Python`
...
- [HRConvert2](https://www.honestrepair.net/index.php/hrconvert2/)  -具有基于会话的身份验证，自动临时文件维护和日志记录功能的拖放式文件转换服务器.  （[Demo](https://www.honestrepair.net/index.php/convert/), [Source Code](https://github.com/zelon88/HRConvert2)）`GPL-3.0`` PHP`
...
- [WTFDYUM](https://www.wtfdyu.me/)  `⚠`-为什么他妈的要取消关注我-在Twitter上找出谁停止关注您.  （[Source Code](https://github.com/jchampemont/WTFDYUM)）Apache-2.0 Java
...
- [Plume](https://joinplu.me/)  -基于ActivityPub的联合博客引擎.  （[Source Code](https://github.com/Plume-org/Plume)）`AGPL-3.0``Ruby`
...
- [Firefox Auth Server](https://docs.services.mozilla.com/howtos/run-fxa.html)  -该项目实现了Firefox帐户的核心服务器端API.  （[Source Code](https://github.com/mozilla/fxa-auth-server)）`MPL-2.0``Nodejs`
  - [Firefox Content Server](https://docs.services.mozilla.com/howtos/run-fxa.html)  -托管Firefox帐户的静态服务器注册，登录，电子邮件验证等流程.  （[Source Code](https://github.com/mozilla/fxa-content-server)）`MPL-2.0``Java`
...
- [Hubl.in](https://hubl.in/)  -由WebRTC驱动的视频会议，聊天和协作编辑器.  （[Source Code](https://github.com/linagora/hublin)）`AGPL-3.0`` Nodejs`
...
- [Zulip](https://zulip.org)  -Zulip是功能强大的开源群聊应用程序.  （[Source Code](https://github.com/zulip/zulip)）`Apache / Other`Python`
...
- [MailCatcher](http://mailcatcher.me/)  -Ruby gem，它部署简单的SMTP MTA网关，该网关接受所有邮件并在Web界面中显示.  对于调试或开发很有用.  （[Source Code](https://github.com/sj26/mailcatcher)）`MIT`` Ruby`
...
- [Wazo](http://wazo.community/)  -在Asterisk上构建的功能齐全的IPBX解决方案，具有集成的Web管理界面和REST-ful API.  （[Source Code](https://github.com/wazo-pbx)）GPL-3.0`` Python / PHP`
...
- [Buddycloud](http://buddycloud.com/)  -工具，库，服务和社区，可将用户对用户，群组和社交消息传递构建到您的应用中.  节省时间.  扩大规模.  支持你.  （[Source Code](https://github.com/buddycloud)）Apache-2.0 Java
...
- [Commento](https://gitlab.com/commento/commento-ce)  -Commento是一个讨论平台，您可以将其嵌入博客，新闻文章以及希望读者添加评论的任何地方.  麻省理工学院
...
- [Lemmy](https://dev.lemmy.ml/#/) - A link aggregator / reddit clone for the fediverse. Reddit alternative built in Rust. ([Source Code](https://github.com/dessalines/lemmy)）`AGPL-3.0``休息`
...
- [Thredded](https://thredded.org)  -论坛，功能丰富且简单.  （[Demo](https://thredded.org/thredded), [Source Code](https://github.com/thredded/thredded)）`MIT`` Ruby`
...
- [Noosfero](http://noosfero.org/)  -Noosfero是社交和团结经济网络的Web平台，在同一系统中具有博客，e-Portfolios，CMS，RSS，主​​题讨论，事件议程和集体智慧的集体智慧.  （[Source Code](https://gitlab.com/noosfero/noosfero)）`AGPL-3.0``Ruby`
...
- [Osclass](https://osclass.org/)  -建立您自己的分类广告市场的一站式商店.  （[Source Code](https://github.com/osclass/Osclass)）`Apache-2.0``PHP`
...
- [Newspipe](http://newspipe.io/)  -Newspipe是网络新闻聚合器和阅读器.  （[Demo](https://www.newspipe.org/signup), [Source Code](https://github.com/newspipe/newspipe)）`AGPL-3.0``Python`
...
- [battlecraft](https://github.com/jbreindel/battlecraft)  -完全分布式的多人浏览器游戏.  （[Demo](http://battlecraft.online)）`Apache-2.0``Erlang`
...
- [GoTTY](https://github.com/yudai/gotty)  -简单的命令行工具，可将CLI工具转换为Web应用程序.  麻省理工学院
...
- [HRCloud2](https://www.honestrepair.net/index.php/hrcloud2/)  -功能齐全的家用托管云驱动器，个人助手，应用启动器，文件转换器，流媒体，共享工具等.  （[Source Code](https://github.com/zelon88/HRCloud2)）`GPL-3.0`` PHP`
...
- [Openmeetings](https://openmeetings.apache.org/index.html)  -Openmeetings使用Red5 Streaming Server的API功能提供视频会议，即时消息，白板，协作文档编辑和其他组件软件工具，以进行远程处理和流传输.  （[Source Code](https://openmeetings.apache.org/scm.html)）Apache-2.0 Java
...
- [RELATE](https://documen.tician.de/relate/)  -RELATE是一个基于Web的课件，包括以下功能：灵活的规则，统计信息，多课程支持，课程日历.  （[Source Code](https://github.com/inducer/relate)）`MIT`` Python`
...
- [mpd](http://www.musicpd.org/)  -守护程序，用于远程播放音乐，流音乐，处理和组织播放列表.  许多客户可用.  （[Source Code](https://github.com/MusicPlayerDaemon/MPD), [Clients](https://www.musicpd.org/clients/)）`GPL-2.0`` C ++`
...
- [Odd Networks](http://oddnetworks.com)  -用于集合和视频的开源视频管理系统（VMS）和API，以及用于Roku，Apple iOS / tvOS，Google Android和Amazon FireTV的支持SDK.  （[Source Code](https://github.com/oddnetworks/oddworks)）MIT Nodejs
- [Open Streaming Platform](https://gitlab.com/Deamos/flask-nginx-rtmp-manager)  -Twitch和Youtube Live的自托管替代方案，用于实时和点播视频流.  （[Demo](https://osptest.divby0.net)）`MIT`` Python`
...
- [Anchr](https://anchr.io)  -Anchr是一个工具箱，用于执行Internet上的微小任务，包括书签集合，URL缩短和（加密的）图像上传.  （[Source Code](https://github.com/n1try/anchr)）`GPL-3.0``Nodejs`
...
- [Benedetto](https://github.com/arecker/bennedetto)  -Bennedetto是一个简单的，基于回合制的预算管理应用程序.  GPL-3.0 Python
...
- [Firefly III](https://firefly-iii.org/)  -Firefly III是一位现代财务经理.  它可以帮助您跟踪资金状况并进行预算预测.  它支持信用卡，具有高级规则引擎，可以从许多银行导入数据.  它由Laravel驱动，需要PHP7.2.  （[Demo](https://demo.firefly-iii.org/), [Source Code](https://github.com/firefly-iii/firefly-iii)）`GPL-3.0`` PHP`
...
- [Paperwork](http://paperwork.rocks)  -Evernote，Microsoft OneNote和Google Keep的OpenSource笔记和存档替代品.  （[Source Code](https://github.com/twostairs/paperwork)）`MIT`` PHP`
...
- [bin](https://github.com/w4/bin)  -一个粘贴容器.  （[Demo](https://bin.doyle.la)）`WTFPL / 0BSD``Rust`
...
- [simple-dash](https://github.com/Swagielka/simple-dash)  -一个简单，响应迅速的仪表板，可以转发到您选择的服务.  （[Demo](https://swagielka.github.io/simple-dash/)）MIT Javascript
...
- [Squid](http://www.squid-cache.org/)  -支持HTTP，HTTPS，FTP等的Web缓存代理.  它通过缓存和重用频繁请求的网页来减少带宽并缩短响应时间.  （[Source Code](https://code.launchpad.net/squid)）`GPL-2.0`` C`
...
- [Grocy](https://grocy.info/)  -grocy是适用于您的家庭的基于Web的自托管杂货管理解决方案，提供英语，德语，意大利语和挪威语版本.  （[Demo](https://demo-en.grocy.info/stockoverview), [Source Code](https://github.com/berrnd/grocy)）`MIT`` PHP`
...
- [LedgerSMB](https://ledgersmb.org/)  -适用于中小型企业的集成会计和ERP系统，具有双重条目会计，预算，发票，报价，项目，订单和库存管理，运输等.  （[Demo](https://demo.cloud.efficito.com/erp/1.5/login.pl), [Source Code](https://github.com/ledgersmb/LedgerSMB)）`GPL-2.0`` Perl`
...
- [Babelfish](https://doc.bblf.sh)  -用于源代码解析的自托管服务器.  它可以使用任何支持的语言解析任何文件，从中提取一个抽象语法树，并将其转换为通用抽象语法树，从而可以进行进一步的分析和转换.  （[Source Code](https://github.com/bblfsh/bblfshd)）GPL-3.0` Go
...
- [Microglark](http://micro.glark.io)  -Hacky简约远程对编程编辑器.  （[Source Code](https://github.com/Bluefinch/microglark)）`AGPL-3.0`` Nodejs`
...
- [Zalenium](https://github.com/zalando/zalenium)  -允许任何人拥有基于Docker的一次性且灵活的Selenium Grid基础架构，该基础架构具有视频录制，实时预览和在线/离线仪表板.  Apache-2.0 Java /外壳
...
- [tasks.php](https://github.com/RaymiiOrg/tasks.php)  -简单的任务/待办事项列表管理器.  麻省理工学院PHP
...
- [devShort](https://github.com/flokX/devShort)  -适用于Web开发人员，管理员和所有专业人员的简单且易于隐私的URL缩短器.  （[Demo](https://devshort.florian-kaldowski.de)）`MIT`` PHP`
...
- [Simple-URL-Shortener](https://github.com/azlux/Simple-URL-Shortener)  -公共或私人（带帐户）的KISS URL缩短器.  极简和轻巧.  没有依赖.  （[Demo](https://u.azlux.fr)）`MIT`` PHP`
...
- [Realms](http://realms.io/)  -受Gollum启发的Git支持的Wiki.  （[Source Code](https://github.com/scragg0x/realms-wiki)）`GPL-2.0`` Python`
...
- [Piratebox](https://piratebox.cc/start)  -使用免费软件和廉价现成硬件构建的DIY匿名离线文件共享和通信系统.  （[Source Code](https://github.com/PirateBox-Dev) ）.  GPL-3.0 Python /其他
...
可以找到贡献准则 [here](https://github.com/Kickball/awesome-selfhosted/blob/master/.github/CONTRIBUTING.md).
