...
### [Mansions of Madness, 2nd ed](https://wikipedia.org/wiki/Mansions_of_Madness)
 ...
 &gt; 一款完全合作的、应用程序驱动的恐怖和神秘棋盘游戏，适合一到五名玩家，发生在与 Eldritch Horror 和 Elder Sign 相同的宇宙中. 探索印斯茅斯隐蔽的街道和阿卡姆被诅咒的豪宅闹鬼的走廊，在调查四个恐惧和神秘的场景时寻找答案. 收集武器、工具和信息，解决复杂的谜题，与怪物、精神错乱和死亡作斗争.
...
### [Chinese Checkers](https://en.wikipedia.org/wiki/Chinese_checkers)
 ...
 &gt; Sternhalma，俗称中国跳棋或中国跳棋，是一种源自德国的策略棋盘游戏，可以两人、三人、四人或六人一起玩，可以单独玩，也可以与伙伴一起玩. 该游戏是豪迈游戏的现代简化变体.
...
&gt; Cyanide &amp; Happiness 的创作者推出了一款纸牌游戏，玩家可以在其中竞争完成一部糟糕的连环画.
...
### [Secret Hitler](https://boardgamegeek.com/boardgame/188834/secret-hitler)
 ...
 &gt; Secret Hitler 是一款以 20 世纪 30 年代德国为背景的政治阴谋和背叛的戏剧性游戏. 每个玩家都被随机秘密地分配为自由主义者或法西斯主义者，其中一名玩家是秘密希特勒. 法西斯分子协调散布不信任并安插他们的冷血领导人； 自由主义者必须在为时已晚之前找到并阻止秘密希特勒. 自由派总是占多数.
...
### [Abalone](https://boardgamegeek.com/boardgame/526/abalone)
 ...
 &gt; 这块美观实用的棋盘可容纳两组大弹珠. 玩家轮流将弹珠推到棋盘周围，目标是将对方玩家的 6 个弹珠推离棋盘. 中心思想是一列弹珠的重量由排成一行的弹珠数决定. 有人需要用一组较重的弹珠来推动柱子沿该轴移动. 然而，有六个可能的方向，很难完美地保护自己. 此外，购买补充弹珠套装后，最多可与 6 名玩家一起玩游戏.
...
### [Nine Men's Morris](https://en.wikipedia.org/wiki/Nine_men's_morris)
 ...
 &gt; 棋盘由带有二十四个交叉点或点的网格组成. 每个玩家有九个棋子，或“人”，通常是黑色和白色. 玩家尝试组成“磨坊”——三个自己的人水平或垂直排列——允许玩家将对手的人从游戏中移除. 玩家通过将对手减少为两块（他们无法再形成磨坊因此无法获胜）或让他们没有合法的举动来获胜.
...
### [Scrabble](https://boardgamegeek.com/boardgame/320/scrabble)
 ...
 &gt; 在这个经典的文字游戏中，玩家使用他们绘制的七个字母块在游戏板上组成单词. 布置的每个单词都会根据所用字母的共性获得积分，某些棋盘空间会提供奖励. 但是一个单词只有在使用至少一个已经播放过的方块或添加到一个已经播放过的单词时才能播放. 这会导致略带战术性的游戏，因为潜在的词会被拒绝，因为它们会给对手太多进入更好奖励空间的机会.
...
&gt; 就6个字达成一致！
 &gt; 一张牌放在桌子中央. 在那一刻，每个玩家都在他的记事本上写下受主题启发的文字. 让您的灵感指引您……但要小心，无论您做什么，都不要原创. 唯一重要的答案是与其他玩家相同的答案！
...
### [Small World](https://boardgamegeek.com/boardgame/40692/small-world)
 ...
 &gt; 一款区域控制游戏，玩家可以使用一组独特的能力控制不同的奇幻种族. 目标是征服和控制尽可能多的玩家图板，并阻止对手的扩张. 当你的种族无法进一步扩张时，你就让它陷入衰退，并选择一个新的种族来继续追求统治地位.
...
&gt; 作为 Monopoly Deal 的衍生产品，Singaporean Dream 是一款互动式纸牌游戏，您可以在其中破坏、抱怨和支付自己成为完美新加坡人的方式.
...
### [Battleship](https://board-games-galore.fandom.com/wiki/Battleship)
 ...
 &gt; 在这个双人战略游戏中，玩家秘密地将他们的船只排列在带有字母和数字的 10x10 网格上，然后尝试定位并摧毁对手的舰队. 每个玩家有两个网格. 一个网格用于放置您自己的船只并跟踪针对您的命中，而第二个网格用于标记针对您的对手的命中. 通过调出网格的一个绘图点轮流射击. 如果命中没有击中船只，则视为未命中并与白色棋子挂钩. 如果命中与船只接触，则该命中会被标记为红色. 每种船只在沉没前可以承受的撞击次数各不相同. 经过一些初步的探索性射击后，您可能会开始弄清楚对手船只的位置并开始进行致命打击. 这是公海之战！
...
### [Say What? Shiok Food Card Game](https://www.saywhatwithfriends.com/shop/say-what-singapores-shiok-food-card-game)
 ...
 &gt; 喜欢新加坡的当地美食？ 这款美食纸牌游戏包含 50 种当地菜肴供您猜，猜得最多的人将是获胜者.
...
### [Ayoayo](https://en.wikipedia.org/wiki/Ayoayo)
 ...
 &gt; Ayoayo（约鲁巴语：Ayò Ọlọ́pọ́n）是尼日利亚约鲁巴人演奏的一种传统宝石棋. 它与随着大西洋奴隶贸易传到美洲的Oware游戏非常接近. 在最常源自 Warri 的现代曼卡拉中，Kalah 是一个著名的曼卡拉，其规则与 Ayoayo 基本相同.
 &gt; 在非洲其他地区也有相同规则的游戏. 一种这样的游戏是肯尼亚和坦桑尼亚的马赛人玩的 Endoi.
...
### [Condottiere](https://boardgamegeek.com/boardgame/112/condottiere)
 ...
 &gt; Condottiere 的目标是在文艺复兴时期的意大利获得四个相连的省份. 为此，玩家在棋盘上拍卖不同的省份，并用代表雇佣兵、季节、稻草人和政治人物的手牌对这些省份进行投标. 然而，与标准拍卖不同的是，在 Condottiere 中，每个玩家都失去了他们的出价. 
&gt; 实际上，玩家是在竞标他们愿意为赢得一个省份而损失的军队数量.
...
### [Decrypto](https://boardgamegeek.com/boardgame/225694/decrypto)
 ...
 &gt; 在 Decypto 中，两支由 2 到 4 名玩家组成的队伍进行比赛. 你的目标是将代码传输给你的队友，而不让对方拦截他们. 因此，你的沟通应该足够清晰，让你的团队能够理解，但又要模糊到让你的对手感到困惑. 您还试图拦截对手的代码.
...
### [Hidden Leaders](https://boardgamegeek.com/boardgame/320718/hidden-leaders)
 ...
 &gt; 奥什拉岛一片混乱. 皇帝死后，山地部落与帝国军队之间的冲突升级. 当水人试图在老对手之间保持平衡时，不死族则试图让战争升级. 所有的希望都寄托在皇帝的六个孩子身上：他们中的谁会继承王位？ 在 Hidden Leaders 中，您将扮演六位秘密领袖之一的角色，他们中的每一位都与四个派系/颜色中的两个结盟. 通过公开或秘密地在你的画面中扮演英雄，你可以影响冲突的结果. 游戏结束时，四个派系之一获胜：红色领先&gt;红色胜利绿色领先&gt;绿色胜利红绿平局&gt;蓝色胜利战区红绿&gt;黑色胜利每个与获胜者对齐的玩家派系可以取得胜利. 但是，他们必须拥有比任何竞争对手都多的这种颜色的英雄.  Hidden Leaders 是一款快速、轻便的策略纸牌游戏，玩家可以直接互动. 它结合了画面构建和演绎元素及其独特的获胜机制. 这是一款非常紧张的游戏，没有停机时间，很快就能学会. 其独特的艺术作品和角色名称会让您微笑.
...
&gt; Muse 是一款竞争性或合作性派对游戏，您可以在其中使用富有想象力的线索来激发您的队友让他们正确猜出杰作. 
 &gt; 作为缪斯女神，你需要发挥创造力，提供正确的线索，带领你的团队完成他们的杰作. 作为艺术家，您需要相互合作来破译这条线索，并从阵容中正确选择杰作.
...
### [Jackal](https://boardgamegeek.com/boardgame/42702/jackal)
 ...
 &gt; 在 Jackal 中，玩家将指挥在金银岛登陆的海盗团伙. 每个玩家每轮可以移动他们选择的海盗一次. 玩家们探索岛屿寻找宝藏以装载到他们的船上，同时尝试从彼此手中夺回宝藏. 游戏的目标是在您的船上装载比任何其他玩家更多的黄金.
...
&gt; 在这个合作的电子游戏中，玩家扮演不同的角色——Money Man、Hacker、Lookout 或 Explosives Expert——一起合作打开一个电子保险箱并一路抢走 5000 万美元的冷硬现金.
...
欢迎和鼓励您的贡献！ 首先阅读[贡献指南][contrib-guide].
