...
## Courses
* [Blazor and Razor Components in a nutshell](https://www.udemy.com/course/blazor-and-razor-components-in-a-nutshell/) -了解如何使用一个框架，该框架允许您在WebAssembly（这是Udemy的一门课程）顶部的浏览器中直接运行编译的代码.
