...
* [Melody](https://melody.sensiolabs.org/) -建立一个文件Composer脚本的工具.
...
* [Spatie Open Source](https://spatie.be/open-source) -开源PHP和Laravel软件包的集合.
* [Symfony Components](https://symfony.com/components) -组成Symfony的组件.
...
* [Couscous](http://couscous.io)  -Couscous将Markdown文档变成漂亮的网站. 这是类固醇的GitHub Pages.
...
* [Goutte](https://github.com/FriendsOfPHP/Goutte) -一个简单的网络刮板.
...
* [PHP-DI](https://php-di.org/) -支持自动装配的依赖项注入容器.
...
* [Faker](https://github.com/fakerphp/faker) -伪造的数据生成器库.
...
* [ParaTest](https://github.com/paratestphp/paratest) -用于PHPUnit的并行测试库.
...
* [Jenkins](https://www.jenkins.io/) -具有以下功能的持续集成平台 [PHP support](https://www.jenkins.io/solutions/php/).
...
* [Better Reflection](https://github.com/Roave/BetterReflection) -基于AST的反射库，可以分析和处理代码
...
* [Porter](https://github.com/ScriptFUSION/Porter) -数据导入抽象库，用于使用Web API和其他数据源.
...
* [PCOV](https://github.com/krakjoe/pcov) -自包含代码覆盖范围兼容的驱动程序.
...
* [Symfony VarDumper](https://github.com/symfony/var-dumper) -变量转储器组件.
...
* [Spot2](https://github.com/spotorm/spot2) -一个MySQL数据文件夹ORM.
...
* [ElasticSearch PHP](https://github.com/elastic/elasticsearch-php) -的官方客户端库 [ElasticSearch](https://www.elastic.co/).
...
* [Rocketeer](https://github.com/rocketeers/rocketeer) -PHP世界的快速简便的部署者.

### Internationalisation and Localisation
*国际化（I18n）和本地化（L10n）库.*

* [Aura.Intl](https://github.com/auraphp/Aura.Intl) -提供国际化（I18N）工具，特别是面向包的按语言环境的消息翻译.
...
* [CakePHP Utility](https://github.com/cakephp/utility) -实用程序类，例如Inflector，String，Hash，Security和XML.
...
* [Expose](https://github.com/beyondcode/expose) -开源的PHP隧道服务.
...
* [PHP-ML](https://github.com/jorgecasas/php-ml) -使用PHP进行机器学习的库.
...
* [Modern PHP New Features and Good Practices](https://www.oreilly.com/library/view/~/9781491905173/) -Josh Lockhart撰写的有关PHP新功能和最佳做法的书.
...
* [PHP Roundtable](https://www.phproundtable.com/) -PHP圆桌会议是由开发人员组成的临时聚会，讨论PHP书呆子关心的主题.
...
* [PHP Weekly](http://www.phpweekly.com/) -有关PHP的每周新闻.
...
*收集垃圾： [1](https://www.php.net/manual/en/features.gc.refcounting-basics.php) [2](https://www.php.net/manual/en/features.gc.collecting-cycles.php) [3](https://www.php.net/manual/en/features.gc.performance-considerations.php) -有关PHP垃圾回收内部原理的系列文章.
