...
## Books
  ...
  1. [Distributed Teams](https://oduinn.com/book/).
     约翰·奥杜因（John O&#39;Duinn），2018年.
  1. [Remote: Office Not Required](https://37signals.com/remote).
     Jason Fried和David Heinemeier Hansson（37signals），2013年.
...
## Job boards
  ...
  1. [GraphQL Jobs](https://graphql.jobs/r/remote) -在现代的创业公司中使用GraphQL.
  ...
  1. [Ruby On Remote](https://rubyonremote.com/) -所有红宝石远程工作集中在一处
  ...
  1. [Upwork](https://www.upwork.com) -查找任何类别的远程作业
  1. [Virtual Vocations](https://www.virtualvocations.com/)
  1. [Vue.js Jobs](https://vuejobs.com/) 在全球范围内查找Vue.js职位-单击“远程”选项卡.
...
## Job boards aggregators
  1. [Bergamot](https://bergamot.io/)  -通过监视超过150,000家公司的职业页面，提供最广泛的远程技术工作选择. 全文搜索和内置AI支持的地理过滤器. 免费，无需注册.
  1. [Career Vault](https://www.careervault.io)  -每天从数千个公司的职业页面中添加数百个远程工作. 免费，无需注册.
  ...
  1. [Work Remotely](https://workremotely.io/) -抓取并整理许多工作板供稿以用于偏远位置
  1. [Workaline](https://workaline.com/)  -远程作业聚合器. 前身为阿尔弗雷德（Alfred）.
  1. [Wrk.ist](https://wrk.ist/) -控制台中的最新远程作业（curl）

## Housing
  1. [Agora space](http://www.agora-space.com/) -中国上海的联合办公空间
  1. [bedndesk](https://www.bedndesk.com/) -西班牙马略卡岛的接班和大棚作业空间
  1. [Common](https://www.hicommon.com/) -纽约的寄宿房
  ...
  1. [Work From Curacao](http://www.workfromcuracao.com/) -库拉索岛的集体生活空间
  1. [Worldpackers](https://www.worldpackers.com) -住房/工作交流
  1. [Anceu](https://anceu.com) -西班牙加利西亚的乡村寄宿及办公空间
...
## Interviewing
  ...
  3. [adaface.com/pair-pro](https://www.adaface.com/pair-pro) -具有共享编辑器，代码编译器和视频会议的远程对编程采访工具
  4. [interviewing.io](https://interviewing.io/) -在技术面试中表现出色
  5. [karat.io](https://karat.com/) -与专业面试官进行免费的编程编码面试
  6. [pramp](https://pramp.com) -与其他候选人练习编码面试（在桌子的两面）
  7. [remoteinterview.io](https://www.remoteinterview.io/) -编码测试和配对编程面试工具
  8. [skillmeter.com](https://skillmeter.com/) -招聘人员和公司的在线技能测试平台
  9. [hackerrank.com](https://www.hackerrank.com/) -还可以在线学习代码并提供工作机会
...
## Newsletters
  ...
  1. [Making Remote Work](https://www.mailerlite.com/remote-newsletter) -MailerLite的每月远程通讯，分享最佳实践，错误和学习，世界观（从字面上看）以及远程职位空缺.
  ...
  1. [Remotive - productive remote workers](https://remotive.io/) -每周向10,000多名远程工作者发送有关远程提示和工作的新闻通讯
...
## Podcasts
  1. [Building Remote Teams](https://www.buildingremoteteams.com/) -针对已经在远程工作的人员，并专注于远程工作中细微的挑战.
...
## Companies with "remote DNA"
  ...
  1. [Authentic F & F](https://authenticff.com/) -设在丹佛和明尼苏达州的独立设计和技术工作室
  ...
  1. [Baselayer](https://www.baselayer.com/company/careers/) -数据中心和基础架构管理软件.
  1. [BeBanjo](https://bebanjo.com/careers/)  -软件即服务，用于按需管理视频.  Ruby / Rails，Elasticsearch，Sidekiq.
  1. [Bluespark Labs](https://www.bluespark.com/careers)  -WebDev咨询和Roomify的制造商. 在北卡罗来纳州罗利和意大利设有总部的远程团队.  Drupal.
  ...
  1. [Chef](https://www.chef.io/careers/)  -我们全都致力于提高速度和性能的IT自动化.  Ruby，JavaScript和Shell脚本. 西雅图总部，但我们在美国各地都有员工.
  ...
  1. [CRO Metrics](https://crometrics.com/careers/) -数据驱动的到期和增长计划.
  ...
  1. [DataStax](https://www.datastax.com/company/careers) -基于Apache Cassandra的咨询.
  ...
  1. [Gitee](https://gitee.com) -中国的GitHub替代方案.
  ...
  1. [Hanzo](https://www.hanzo.co/about-us/careers-uk)  -Web存档公司. 完全远程.  Python，AWS.
  1. [Harvest](https://www.getharvest.com/careers) -时间跟踪软件.
  1. [HashiCorp](https://www.hashicorp.com/jobs.html)  -用于自动化现代数据中心的开源工具. 转到，Ruby，Rails，Ember，JavaScript.
  1. [HE:labs](https://helabs.com/us/)
  1. [Healthfinch](https://www.healthfinch.com/careers)  -使医疗保健系统更加可用. 美国威斯康星州麦迪逊市总部.  Ruby，JavaScript.
  ...
  1. [Help Scout](https://www.helpscout.net/careers/) -适用于坚持提供令人愉快的客户体验的团队的服务台.
  ...
  1. [Linaro](https://www.linaro.org/careers/) -ARM上的开源工程.
  1. [Lincoln Loop](https://lincolnloop.com) -WebDev商店.
  1. [Litmus](https://litmus.com/careers)  -针对电子邮件专业人员的优化工具. 在波士顿和伦敦设有办公室，但近50％的团队在远程工作.
  1. [LiveChat](https://www.livechat.com/careers/jobs/) -带有在线聊天，服务台软件和Web分析的在线客户服务软件
  1. [LivingSocial](https://jobs.groupon.com/)  -公司范围内对经验丰富的远程开发人员团队的支持. 很多自主权.
  ...
  1. [Mobile Jazz](https://mobilejazz.com/)  -我们是一支由高素质的工程师，设计师和市场营销专家组成的敬业团队，其使命是建立一个更加美丽的数字世界. 我们是一家远程友好的公司，总部位于巴塞罗那.
  1. [Modern Tribe](https://tri.be/careers)  -具有现代特色的数字代理商. 所有自由职业者. 所有专家.
  1. [MODLR](https://modlr.co) -MODLR是用于关联财务计划流程的业务建模和协作计划工具
  ...
  1. [MVP Space](https://mvp-space.com/) -与目标受众一起测试商业创意，或向投资者展示其潜力.
  ...
  1. [Netlandish](https://www.netlandish.com/)  -适用于各种规模企业的软件开发.  Python，Django，DevOps.  100％远程.
  1. [Netsparker](https://www.netsparker.com/jobs/) -Web应用程序安全扫描程序.
  1. [Next Big Sound](https://www.nextbigsound.com/about) -音乐行业的分析和见解.
  1. [NinjaCat](https://www.ninjacat.io/jobs) -领先的数字代理商的报告，监控和呼叫跟踪平台.
  1. [Niteo](https://niteo.co/careers) -拥有10年历史的SaaS工作室充满创意，可构建智能解决方案以在线支持小型企业.
  1. [NodeSource](https://nodesource.com/about) -NodeSource致力于为Node.js创建可持续发展的生态系统.
  1. [Nozbe](https://nozbe.com/careers) -适用于Mac，Windows，Linux，Android，iPad和iPhone的GTD应用程序.
  1. [ofri](https://www.ofri.ch/job_openings) -瑞士的在线市场，可将房主与优质的家居装饰专业人员联系起来.
  1. [Olark](https://www.olark.com/jobs) -聊天支持渠道.
  1. [onTheGo Systems](https://www.onthegosystems.com/jobs/) -WordPress开发人员，支持人员和市场营销职位.
  1. [OpenCraft](https://opencraft.com/) -开放edX开发（自由软件MOOC项目）.
  ...
  1. [Patients Know Best](https://patients.workable.com/) -使患者能够管理自己的护理，使专业人员能够共享信息，同时提高付款人的效率.
  ...
  1. [Pleo](https://careers.pleo.io/) -Pleo是公司支付卡解决方案，可自动执行费用报告并简化公司支出.
  1. [Precision Nutrition](https://www.precisionnutrition.com/) -在线营养辅导和认证.
  ...
  1. [Sangoma](https://www.sangoma.com/)  -在提供全球可扩展的本地和基于云的IP语音电话系统方面值得信赖的领导者.  C，PHP，Python，JavaScript，Linux，FreePBX，VoIP.
  ...
  1. [Signal](https://www.signal.org/workworkwork/) -这些人太棒了 [Signal app](https://www.signal.org) . 仅限美国.
  1. [Simple](https://www.simple.com/careers)
  1. [Skyscrapers](https://skyscrapers.eu/jobs/)  -云托管服务和管理. 与多个云提供商（AWS，Digital Ocean，Linode等）合作.  100％远程.
  1. [SoftwareMill](https://softwaremill.com/join-us/)
  1. [Soshace](https://soshace.com/) -Angular / React / Vue.js / Java / Python远程开发公司
  1. [Songspace](https://songspace.com) 帮助音乐创作者与其专业团队进行协作，编目和共享作品
  1. [Soostone](http://www.soostone.com/careers)
  1. [Sourcegraph](https://github.com/sourcegraph/careers)  -团队（自托管，OSS）的代码搜索和导航. 完全远程（跨时区）.
  ...
  1. [SuperOrbital](https://superorbit.al) -Kubernetes工程和培训.
  1. [Surevine](https://www.surevine.com/jobs/)
  1. [Surge](https://www.surgeforward.com/careers/) -100％的远程咨询公司，主要在Node.JS，iOS，.NET，PHP和Android中工作
  1. [Square](https://careers.squareup.com/us/en/jobs?location%5B%5D=Remote)  -Square帮助数以百万计的卖家开展业务-从安全的信用卡处理到销售点解决方案. 产品：Square和Cash App.
  1. [Sysdig Cloud](https://sysdig.com/jobs/)
  1. [Taskade](https://www.taskade.com/contact/) -远程团队为团队建立实时协作和协作编辑.
  1. [TaxJar](https://www.taxjar.com/jobs/) -消除营业税问题.
  1. [Teamed.io](https://www.teamed.io/)
  1. [TeamSnap](https://www.teamsnap.com/about/careers)  -TeamSnap是在线体育团队管理的第一名.  80％的远程员工
  1. [TED](https://www.ted.com/about/our-organization/jobs-at-ted)  -技术团队支持ted.com和内部工具. 所有工程师都是远程的.  Ruby on Rails，JavaScript，Ember.js
  1. [Teleport](https://teleport.org/jobs/)
  1. [Tesera](https://tesera.com/)  -我们破坏了常规思维，以扩大可能的范围. 在共同的未来中，我们将引发变化.
  1. [The Grid](https://thegrid.io/)  -AI网站建设者.  100％分散的团队.
  1. [Thermeon](https://thermeon.com/vacancies/) -租车软件-100％远程技术团队
  ...
  1. [Tipe](https://tipe.io)  -带有GraphQL或REST API的下一代API优先CMS. 使用Nuxt.js，无服务器，AWS构建.  25％偏远
  1. [Toggl](https://jobs.toggl.com/)
  1. [Toptal](https://www.toptal.com/careers) -100％的远程开发公司，解决了全球人才短缺的问题
...
1. [Hacker Paradise](https://www.hackerparadise.org/) -出差的远程工作人员.
1. [Remote Year](https://www.remoteyear.com/) -旅行技术人员1年.
...
## Conferences
 ...
 1. [Yonder](https://www.yonder.io/events) -圆桌会议，将分布式公司的领导人召集在一起.
 1. [9punto5](https://www.9punto5.cl/) -拉丁美洲的远程工作会议.
 1. [Git Commit Show](https://gitcommit.show/) -来自全球的开发人员大会，旨在促进远程工作的教育

## Tools

#### HR
  1. [Remoteteam.com](https://www.remoteteam.com) –自动化的薪资，休假，人力资源工具以及对远程公司的合规性.
...
#### Communication
  ...
  1. [PukkaTeam](https://www.pukkateam.com) -通过定期的自动自拍照和一键式视频通话实现真正的团队存在
  ...
  1. [Krisp](https://krisp.ai/) -在任何通讯应用程序中静音背景噪音.

#### Project Management
  1. [Asana](https://asana.com/) -项目管理有利于分散的团队.
  ...
  1. [Notion](https://www.notion.so/) -全部集中在一个工作区中，以编写，计划，协作和组织起来.
...
#### Others
  ...
  1. [Fiverr](https://www.fiverr.com/) -Fiverr是面向精益企业家的全球最大的自由职业服务市场，您可以在这里雇用远程工人为您完成一些小任务.
  1. [EasyRetro](https://easyretro.io) -EasyRetro是针对分布式团队的回顾性在线董事会.
...
## Law & Finance
  1. [1099 contractors](https://www.wisegeek.com/what-is-a-1099-contractor.htm) –美国公司可以雇用远程工人.
  1. [Transferwise](https://transferwise.com/gb/business/international-payroll-via-batch-payments) -支付远程员工的简便方法.

## Others
  1. [awesome-digital-nomads](https://github.com/cbovis/awesome-digital-nomads) -精选的“数字游牧民族”资源列表.
  1. [Best Remote](https://bestremote.work/) -有关当今顶级远程公司的精选参考.
  ...
  1. [NODESK](https://nodesk.co/) -3000多篇针对数字游牧民和远程工作者的文章，远程工作，资源和工具.
  1. [Nomad List](https://nomadlist.io/) -比较不同城市的生活成本和生活质量.
  1. [Regus USA](https://www.regus.com/) -行政套房，虚拟办公室和会议室.
  1. [Remote Companies on Careers SO](https://stackoverflow.com/jobs/companies?q=&l=&r=true)
  1. [Remote Working](https://github.com/greatghoul/remote-working) -中文的远程工作资源列表.
  1. [Remoter.com](https://www.remoter.com/) -正在进行的有关创建远程工作教育平台的倡议.
