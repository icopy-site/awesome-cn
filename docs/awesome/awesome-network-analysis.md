...
-   _[Networks, Crowds, and Markets: Reasoning About a Highly Connected World](http://www.cs.cornell.edu/home/kleinber/networks-book/)_, by David Easley and Jon Kleinberg - Full pre-publication draft ([review](http://bactra.org/reviews/networks-crowds-markets.html)<i>;</i> <b>;</b> <i>2010).</i> <b>2010）。</b>
...
- 使用R / igraph_进行网络分析，GaborCsárdi，Thomas Nepusz和Eduardo M. Airoldi（准备中）.
- 使用Python / igraph_进行网络分析，Thomas Nepusz，GaborCsárdi和Eduardo M. Airoldi（准备中）.
...
-   [NetSci - International School and Conference on Social Networks](http://www.netscisociety.net/) - 由网络科学协会（NetSci）组织.
    -   [Large-scale Structures in Networks: Hidden Communities and Latent Hierarchies](http://danlarremore.com/CommunityDetection_and_Ranking_Larremore_2019.pdf) - 说说 [Dan Larremore](http://danlarremore.com/) 在NetSci 2019年.
...
-   [Networks, Complexity and Its Applications (Media Arts and Sciences)](http://ocw.mit.edu/courses/media-arts-and-sciences/mas-961-networks-complexity-and-its-applications-spring-2011/)，作者：Cesar Hidalgo（麻省理工学院，2011年）.
-   [Networks, Crowds and Markets](https://www.edx.org/course/networks-crowds-markets-cornellx-info2040x-2)，David Easley，Jon Kleinberg和Eva Tardos（[presentation](https://www.cornell.edu/video/cornellx-networks-crowds-and-markets) ;  康奈尔大学，edX，2016）.
-   [Networks (Economics)](https://ocw.mit.edu/courses/economics/14-15j-networks-spring-2018/)，由Mardavij Roozbehani和Evan Sadler（麻省理工学院，2018年）.
    -   [Networks (Economics)](https://hdl.handle.net/1721.1/119628)，由Daron Acemoglu和Asu Ozdaglar（麻省理工学院，2009年）.
-   [Network Science (Computer Science)](http://www.cc.gatech.edu/~dovrolis/Courses/NetSci/)，Constantine Dovrolis  - 大多数开放获取读数（Georgia Tech，2015）.
-   [Network Science (Physics)](https://www.barabasilab.com/course)，Albert-LászlóBarabási，Sean Cornelius和Roberta Sinatra（东北大学，2015）.
-   [Political Networks: Methods and Applications](http://vanity.dss.ucdavis.edu/~maoz/networks/Spring%202011/pol279-11.htm)，Zeev Maoz（加州大学戴维斯分校，2012年）.
-   [Social and Economic Networks: Models and Analysis](https://www.coursera.org/course/networksonline)，Matthew O. Jackson（斯坦福大学，Coursera，2015）.
-   [Social Network Analysis](https://www.coursera.org/course/sna)，由Lada Adamic（密歇根大学通过Coursera，尚未运行）.
...
-   [The Structure of Information Networks](https://www.cs.cornell.edu/Courses/cs6850/2008fa/)，Jon Kleinberg  - 链接到许多不同的读物（康奈尔大学，2008年）.
...
-   [KONECT - The Koblenz Network Collection](http://konect.uni-koblenz.de/) - 除其他外，包括DBpedia和Wikipedia，GitHub中的协作网络（[companion handbook](http://arxiv.org/abs/1402.5500)).
-   [James H. Fowler’s Cosponsorship Network Data Page](http://jhfowler.ucsd.edu/cosponsorship.htm).
-   [Linton Freeman’s Network Data](http://moreno.ss.uci.edu/data.html) - 超过300种各种类型的数据集，采用UCINET格式.
-   [Mangal](http://mangal.io/) - 在线平台分析，存档和共享生态网络数据（[preprint](http://biorxiv.org/content/early/2015/02/24/002634), [Python package](https://github.com/mangal-wg/pymangal), [R package](https://github.com/mangal-wg/rmangal)).
...
-   [SocioPatterns Datasets](http://www.sociopatterns.org/datasets/) - 通过网络获得的网络数据 [SocioPatterns](http://www.sociopatterns.org/) 传感平台.
...
## Journals
 ...
 &gt;未完全开放访问的期刊标记为“门控”.  另请注意，下面列出的部分发布商是 [deeply hurting](https://twitter.com/costofknowledge) 科学出版.
...
-   [APSA Political Networks](http://www.polinetworks.org/)   - 美国政治科学协会（APSA）的组织部门.  推特： [@PolNetworks](https://twitter.com/PolNetworks).
-   [ECPR Political Networks SG](https://politicalnetsecpr.wordpress.com/)   - 欧洲政治研究联合会常设小组.  推特： [@politicalnets](https://twitter.com/politicalnets).
...
&gt;以网络为中心的研究中心，（阅读）团体，研究所，实验室 - 您的名字 - 总部设在美国.

-   [Annenberg Networks Network (ANN)](http://uscann.tumblr.com/) - 研究小组在南加州大学学习社交网络.
-   [Center for Applied Network Analysis (CANA)](https://usccana.github.io/) - 南加州大学医学院的研究小组.
-   [Channing Division of Network Medicine](http://www.brighamandwomens.org/research/depts/medicine/channing/default.aspx) - 布莱根妇女医院医学系的研究部门.
-   [Complex Human Networks Reading Group (CoHN)](http://alumni.media.mit.edu/~tanzeem/cohn/CoHN.htm) -  2001-2在麻省理工学院举办的研讨会上的阅读清单.
...
-   [Network Science IGERT at the University of California at Santa Barbara (UCSB)](http://networkscience.igert.ucsb.edu/) - 特色 [NSF-funded](http://www.igert.org/) 研究生课程.
...
&gt;以网络为中心的研究中心，（阅读）团体，研究所，实验室 - 您的名字 - 来自美国以外的地区.
...
-   [Center for Network Science, Central European University, Budapest](http://cns.ceu.edu/) - 拥有网络科学博士学位课程.
-   [Complex Networks](http://www.complexnetworks.fr/) - 总部设在巴黎的研究小组.
-   [Cx-Nets](http://www.cxnets.org/) - 四个复杂网络研究小组之间的虚拟合作.
-   [Data Science Group](http://datasciencegroup.pl/) - 弗罗茨瓦夫的研究小组，研究复杂网络和其他网络相关主题.
-   [Digital Humanities](http://cmb.huma-num.fr/) - 柏林Marc Bloch中心的跨学科研究小组，拥有许多网络科学项目.
...
&gt;另见参考书目 [by Claire Lemercier and Claire Zalc](http://www.quanti.ihmc.ens.fr/Analyse-de-reseaux-bibliographie.html) （关于“结构研究”的部分）， [by the Historical Network Research Group](http://historicalnetworkresearch.org/resources/bibliography/)，和 [by Tom Brughmans](https://archaeologicalnetworks.wordpress.com/network-science-bibliography/).

-   [Analyse de réseaux et histoire](https://www.cairn.info/revue-d-histoire-moderne-et-contemporaine-2005-2-page-88.htm)，法语（_回顾现代和当代历史_，2005）.
-   [Analyser les réseaux du passé en archéologie et en histoire](https://journals.openedition.org/nda/2300)，用法语（_The Archaeology_，2014）.
  -  [历史上网络分析的形式化方法：为什么以及如何？  （（Http://www.studienverlag.at/data.cfm?vpath=openaccess/oezg-12012-lemercier&amp;download=yes），德语：在网络历史记录[为什么和如何形式化方法][preprint in English](http://halshs.archives-ouvertes.fr/halshs-00521527) ;  _ÖsterreichischeZeitschriftfürGeschichtswissenschaften_，2012）.
...
-   [Assessing Impact and Quality from Local Dynamics of Citation Networks](http://www.sciencedirect.com/science/article/pii/S1751157711000770) （_Informetrics_Journal，2012）.
...
-   [Extracting Citation Networks from Publications in Classics](https://zenodo.org/record/46328) （_Digital Humanities Quarterly_，即将出版）.
...
-   [Socio-Semantic Frameworks](http://www.worldscientific.com/doi/abs/10.1142/S0219525913500136) ([preprint](http://camille.roth.free.fr/travaux/roth--sociosemantic-systems-acs-proofs.pdf) ;  _复杂系统进展_，2013）.
...
-   [Biological Networks](http://kops.uni-konstanz.de/handle/123456789/25907) （_图形绘制与可视化手册_，2014）.
-   [Interactome Networks and Human Disease](http://barabasi.com/f/326.pdf) （_Cell_，2011）.
-   [Network Analysis: An Integrative Approach to the Structure of Psychopathology](http://www.annualreviews.org/doi/full/10.1146/annurev-clinpsy-050212-185608) （_临床心理学年度评论_，2013）.
-   [Network Biology: Understanding the Cell’s Functional Organization](http://barabasi.com/f/147.pdf) - （蜂窝）网络分析的可访问介绍（_Nature Reviews Genetics_，2004）.
-   [Network Medicine: A Network-based Approach to Human Disease](http://barabasi.com/f/320.pdf) （_Nature Review Genetics_，2011）.
-   [Social Networks and the Spread of Infectious Diseases: the AIDS Example](http://www.sciencedirect.com/science/article/pii/0277953685902692) （_社会网络_，1985年）.
...
-   [The Architecture of Complexity](http://barabasi.com/f/226.pdf) - 从网络理论到复杂性理论（_IEEE Con​​trol Systems Magazine_，2007）.
-   [Complex Systems and Networks](http://science.sciencemag.org/content/325/5939) （_Science_特刊，2009）.
-   [Multilayer Networks in a Nutshell](https://doi.org/10.1146/annurev-conmatphys-031218-013259) （_Condensed Matter Physics的年度评论_，2019年）.
-   [Statistical Mechanics of Complex Networks](http://barabasi.com/f/103.pdf) （_现代物理评论，2002）.
...
- 浏览用于推理网络分析的统计工具范围（_American Journal of Political Science_，即将出版2016）.
-   [Positional Analysis and Blockmodeling](http://link.springer.com/referenceworkentry/10.1007%2F978-1-4614-1800-9_138) (<!-- [preprint](http://patrickdoreian.com/NEW/wp-content/papers_resources/chapters/Positional_Analysis_and_Blockmodeling.pdf) ;   - &gt; _ Computational Complexity_，2012）.
...
-   [A Survey of Statistical Network Models](https://dl.acm.org/citation.cfm?id=1734795) - 书评（[preprint](http://arxiv.org/abs/0912.5410) ;  _机器学习的基础和趋势_，2010）.
...
-   [Explorations into the Visualization of Policy Networks](https://www.academia.edu/17565685/Explorations_into_the_Visualization_of_Policy_Networks) （_理论政治学刊，1999年）.
-   [Graphical Techniques for Exploring Social Network Data](http://moreno.ss.uci.edu/87.pdf) （_社会网络分析中的模型和方法_，2005）.
...
-   [Social Networks](http://moreno.ss.uci.edu/93.pdf) （_图形绘制与可视化手册_，2013）.
...
-   [A propos de la notion de rôle dans l’analyse des relations sociales](https://journals.openedition.org/msh/11969) （_数学与人文科学_，2011）.
...
-   [Network Analysis and Political Science](http://www.annualreviews.org/doi/abs/10.1146/annurev.polisci.12.040907.115949) （_ _政治学年度评论_，2011）.
...
-   [The Social and the Sexual: Networks in Contemporary Demographic Research](http://repository.upenn.edu/psc_working_papers/41/) （PSC工作论文系列，2013年）.
-   [Social Network Analysis in the Study of Terrorism and Political Violence](http://journals.cambridge.org/article_S1049096510001848) ([preprint](http://opensiuc.lib.siu.edu/cgi/viewcontent.cgi?article=1048&context=pn_wp) ;  _PS：政治科学与政治_，2011）.
-   [Social Networks and Crime: Pitfalls and Promises for Advancing the Field](https://doi.org/10.1146/annurev-criminol-011518-024701) （_年度犯罪学评论_，2019年）.
- 城市社交网络：一些方法论问题和可能性（[_The Small World_](https://www.worldcat.org/title/small-world/oclc/925078340&referer=brief_results), 1989).

## Selected Papers

 &gt;自愿短暂的应用，认识论和方法论文章，其中许多已成为网络分析课程的经典读物.  面向具有高度积极性的社会科学学生，几乎没有接触过网络分析.
...
-   [GraphX](https://spark.apache.org/graphx/) - [Apache Spark](https://spark.apache.org/) 用于执行与图形相关的并行计算的模块.
...
-   [Network Canvas](http://networkcanvas.com/) - 用于收集个人网络数据的工具集（在早期开发中）.
...
-   [PNet](http://www.swinburne.edu.au/fbl/research/transformative-innovation/our-research/MelNet-social-network-group/PNet-software/index.html) - 用Java编写的用于Windows的（单模和多级）指数随机图模型（ERGM）的模拟和估计.
-   [Polinode](https://www.polinode.com/) - 基于Web的平台，既可以分析网络数据，也可以通过基于关系的调查收集网络数据.
-   [PUCK - Program for the Use and Computation of Kinship data](http://www.kintip.net/) - 用于谱系网络分析的跨平台Java程序.
-   [Radatools](http://deim.urv.cat/~sergio.gomez/radatools.php) - 用于分析复杂网络的工具集，建立在 [Radalib](http://deim.urv.cat/~sergio.gomez/radalib.php)，一个用Ada写的图书馆.
-   [SageMath](http://www.sagemath.org/) - 广泛的免费开源数学软件 [graph capabilities](http://doc.sagemath.org/html/en/reference/graphs/index.html).
-   [Segrada](http://segrada.org/) - 跨平台工具，用于构建和可视化语义图数据库.
-   [Siena](http://www.stats.ox.ac.uk/~snijders/siena/)   - 经验网络分析的模拟研究.  以前是一个Windows程序，现在开发为RSiena R包.
-   [SocNetV - Social Network Visualizer](http://socnetv.sourceforge.net/) - 跨平台计划，包括一个 [simple Web crawler](http://socnetv.sourceforge.net/news/?post=socnetv-v16-released-with-a-working-web-crawler) 构建超链接网络.
-   [SoNIA - Social Network Image Animator](http://web.stanford.edu/group/sonia/)   - 可视化动态或纵向网络数据的工具.  以前是 [Java program](https://sourceforge.net/projects/sonia/) ([example movies](http://www.soc.duke.edu/~jmoody77/NetMovies/index.htm)），现在开发为ndtv R包.
-   [SparklingGraph](https://sparkling-graph.github.io/)   - 使用Apache Spark的GraphX模块执行大规模分布式网络计算的跨平台工具;  用Java和Scala编写.
-   [SPaTo Visual Explorer](http://www.spato.net/) - 用于可视化和探索复杂网络的跨平台计划.
-   [StOCNET](http://www.gmw.rug.nl/~stocnet/StOCNET.htm) - 与锡耶纳同一团队开发的几个Windows程序.
...
&gt;网络布局和社区检测算法，不适合任何下一小节.  
&gt;另见 [Awesome Algorithms](https://github.com/tayllan/awesome-algorithms) 和 [Awesome Algorithm Visualization](https://github.com/enjalot/algovis) 列出更多的算法awesomess.

-   [algo.graph](https://github.com/clojure/algo.graph) - 用Clojure编写的基本图论算法.
-   [CONGA and CONGO](http://gregory.org/research/networks/software/conga.html) - 用Java编写的检测网络中重叠社区的算法.
-   [ForceAtlas2](https://gephi.wordpress.com/2011/06/06/forceatlas2-the-new-version-of-our-home-brew-layout/) -  Gephi中包含的强制定向布局（[paper](http://journals.plos.org/plosone/article?id=10.1371/journal.pone.0098679)).
-   [Linkcomm - Link Communities in Complex Networks](https://github.com/bagrow/linkcomm) - 社区检测算法，提供C ++，Python [and R](https://cran.r-project.org/package=linkcomm).
...
&gt;有关更棒的C / C ++内容，请参阅 [Awesome C](https://github.com/aleks和ar-todorovic/awesome-c) 和 [Awesome C / C++](https://github.com/fffaraz/awesome-cpp) 名单.

-   [Benchmark Graphs to Test Community Detection Algorithms](https://sites.google.com/site/santofortunato/inthepress2) - 用于生成加权和未加权图形的C ++代码.
-   [BGL - Boost Graph Library](http://www.boost.org/doc/libs/1_60_0/libs/graph/doc/) -  C ++库，提供访问图结构的通用接口.
-   [igraph](http://igraph.org/)   -  C网络分析工具库;  也作为Python和R的包存在.
-   [MapEquation](http://www.mapequation.org/) - 用于多级社区检测的Infomap方法的C ++代码.
...
- [Mixer](https://github.com/keith-turner/mixer) - 展示如何使用的原型 [Apache Fluo](https://fluo.apache.org/) 连续地将多个大图合并为单个派生图.

### JavaScript

&gt;有关更多精彩的JavaScript库，请参阅 [Awesome JavaScript](https://github.com/sorrycc/awesome-javascript) 名单.
...
-   [greuler](https://mauriciopoppe.github.io/greuler/)   - 可视化库，通过简单的API构建和操作图形.  由d3.js和.提供支持 [WebCola](http://marvl.infotech.monash.edu/webcola/).
-   [jLouvain](https://github.com/upphiminn/jLouvain) -  Jv的Louvain社区检测（[example](http://bl.ocks.org/emeeks/125db75c9b55ddcbdeb5)).
-   [Popoto.js](http://www.popotojs.com/) - 基于d3.js的库，提供基于图形的搜索界面.
-   [Sigma](http://sigmajs.org/) - 专用于图形绘制的JavaScript库.
...
&gt;另请参阅中列出的webweb工具 [Python](#python) 部分.

-   [Brain Connectivity Toolbox](https://sites.google.com/site/bctnet/) - 用于结构和功能性大脑连接数据的复杂网络分析的工具箱，以及与许多相关项目的链接.
...
-   [MatlabBGL](http://dgleich.github.io/matlab-bgl/) - 基于C ++ Boost图库的图形库.
-   [MATLAB RBN Toolbox](http://www.teuscher.ch/rbntoolbox/index.htm) - 随机布尔网络的模拟和可视化.

### Python

> Many items below are from [a Google spreadsheet](https://docs.google.com/spreadsheets/d/1vJILk2EW1JnR3YAwTSSqAV5mPkeXaezy45wOoafBpfU/edit#gid=0) 由MichałBojanowski和其他人.  
...
-   [dash-cytoscape](https://github.com/plotly/dash-cytoscape) -  Python中的交互式网络可视化库，由Cytoscape.js和Dash提供支持
-   [graph-tool](http://graph-tool.skewed.de/) - 用于网络操作和分析的Python模块，主要以C ++编写，以提高速度.
-   [graphviz](https://pypi.python.org/pypi/graphviz) - 用于DOT图形绘制语言的Python渲染器.
-   [hiveplot](https://pypi.python.org/pypi/hiveplot) - 用于在matplotlib上绘制网络作为hive图的Python实用程序，这是一种更全面的网络可视化.
...
-   [webweb](https://webwebpage.github.io/) - 使用d3.js生成交互式网络可视化的MATLAB / Python库.

### R

&gt;有关更多令人敬畏的R资源，请参阅 [Awesome R](https://github.com/qinwf/awesome-R) 和 [Awesome R Books](https://github.com/RomanTsegelskyi/rbooks)  名单.  也可以看看 [this Google spreadsheet](https://docs.google.com/spreadsheets/d/1CoFGtrW85D9FsVcAE5-bcXVl6QOTncwXjFBYp4u2WgE/edit?usp=sharing) by Ian McCulloh 和 others.  
&gt;要将许多不同的网络模型结果转换为整洁的数据框，请参阅 [broom](https://CRAN.R-project.org/package=broom)  包.  要将许多不同的网络模型结果转换为LaTeX或HTML表，请参阅 [texreg](https://CRAN.R-project.org/package=texreg) 包.
...
-   [concoR](https://github.com/aslez/concoR) - 实施CONCOR网络块模型算法（[blog post](http://badhessian.org/2015/05/concor-in-r/)).
...
-   [networkDynamic](https://CRAN.R-project.org/package=networkDynamic) - 支持动态，（内部）时间网络.
-   [networksis](https://CRAN.R-project.org/package=networksis) - 用于模拟具有固定和指定的节点度的二分网络图的工具.
-   [PAFit](https://CRAN.R-project.org/package=PAFit) - 时间复杂网络中优先附着和节点适应度的非参数估计.
-   [PCIT](https://CRAN.R-project.org/package=PCIT) - 实现与信息理论的部分相关性，以识别加权网络中的有意义的相关性，例如基因共表达网络.
...
-   [sna](https://CRAN.R-project.org/package=sna) - 基本网络构建器，度量和可视化工具.
...
-   [xergm](https://CRAN.R-project.org/package=xergm) - 指数随机图模型的扩展（ERGM，GERGM，TERGM，TNAM和REM）.
...
-   [SNA with Stata](http://www.rensecorten.org/index.php/category/sna-with-stata/) - 博客记录netplot Stata包的使用.

### Syntaxes

&gt;旨在供多个程序使用的通用图形语法.

-   [DOT](http://www.graphviz.org/doc/info/lang.html) -  Graphviz软件使用的图形绘制语法.
-   [GEXF](https://gephi.org/gexf/format/) -  Gephi软件使用的文件格式.
-   [GraphML](http://graphml.graphdrawing.org/) - 图形的全面且易于使用的文件格式（[handbook chapter](https://www.uni-konstanz.de/mmsp/pubsys/publishedFiles/BrEiLe10.pdf)).
...
-   [Interactive and Dynamic Network Visualization in R](http://curleylab.psych.columbia.edu/netviz/) 和JavaScript库（2016）.
-   [Nodegoat and Palladio: Introductory Workshop](https://www.academia.edu/11450425/Nodegoat_and_Palladio_Introductory_Workshop_by_Emmanuelle_Chaze) - 针对人文主义者（2015年）.
-   [Static and Dynamic Network Visualization with R](http://kateto.net/network-visualization) - 涵盖igraph，网络，ggraph，网络，networkD3，ndtv，threejs和visNetwork包（2019）.
...
-   [Awesome graph classification](https://github.com/benedekrozemberczki/awesome-graph-classification) - 图表嵌入论文的完整列表，包括标题，作者，论文链接和参考实现.
...
-   [Convert Between Graph Formats](http://awesome.cs.jhu.edu/graph-services/convert/) - 在线服务转换为/到许多不同的常见图形格式.
-   [David Knoke on Network Analysis](https://thesocietypages.org/methods/2015/01/30/david-knoke-on-network-analysis/) -  20分钟的访谈，讨论了网络分析的用途和好处，借鉴了诺克对恐怖网络的研究.
-   [Glossary of Terms for Statistical Network Models](https://statnet.org/trac/raw-attachment/wiki/Resources/glossary.pdf).
-   [Linton C. Freeman’s Social Network Research Publications](http://moreno.ss.uci.edu/pubs.html)，从1955年到今天.
...
-   [Mixed-Method Approaches to Social Network Analysis](https://www.youtube.com/playlist?list=PL3zdEY084WkQD79mR00RSt8j5RuyPwMJE) - 米德尔塞克斯大学法学院会议录像（2014年）.
-   [Modeling Complex Social Networks: Challenges and Opportunities for Statistical Learning and Inference](https://www.youtube.com/watch?v=1xLjYc7EUEU) - 普渡大学Jennifer Neville研讨会演讲视频（2011年）.
-   [NetSciEd - Network Science in Education](https://sites.google.com/a/binghamton.edu/netscied/home) - 旨在提高网络素养的国际倡议.
-   (@) [Network Fact](https://twitter.com/networkfact) - 关于网络，图论和相关主题的Twitter帐户.
-   [Network Map of Knowledge and Art](https://paolonegrini.wordpress.com/2012/11/19/network-map-of-knowledge-and-art/) - 使用SPARQL和Gephi的DBPedia派生的网络，由谁来影响他们的直接联系.
-   (@) [Network Science](https://twitter.com/Ognyanova/lists/network-science/members) -  Twitter帐户的主题列表，由.策划 [Katherine Ognyanova](https://twitter.com/Ognyanova).
...
-   [The Networks Network](https://groups.google.com/forum/?hl=en-GB#!forum/the-networks-network) - 邮件列表（主要是来自HNR网络的历史学家）.
-   [New Perspectives for Relational Learning](http://www.birs.ca/events/2015/5-day-workshops/15w5080/videos) - 班夫国际研究站（BIRS）（2015年）研讨会的视频（及更多）.
-   [Open Graph protocol](http://ogp.me/) - 将任何网页转换为“社交图形对象”的建议标准.
...
-   [The Small World of Psychopathology](http://journals.plos.org/plosone/article?id=10.1371/journal.pone.0027407) - 关于精神症状如何相互连接的论文（[code, data and graphs](https://sites.google.com/site/dsmgraphs/Home/files)).
-   [Social Network Analysis in DBpedia](http://othes.univie.ac.at/12285/1/2010-10-14_0703857.pdf) - 高度教学硕士论文，展示如何使用SPARQL和Pajek.
...
-   [Networks Demystified](http://scottbot.net/tag/networks-demystified/)，Scott B. Weingart的一系列博客文章.
-   [Netze und Netzwerke](http://netzeundnetzwerke.de/)，英文和德文 - 网络分析历史博客，作者：SebastianGießmann（[old blog](http://www.netzeundnetzwerke.de/old/)).
...
-   [Analyzing Networks of Characters in _Love Actually_](http://varianceexplained.org/r/love-actually-network/) - 具有聚类分析和a [Shiny app](https://dgrtwo.shinyapps.io/love-actually-network/) （使用R + Shiny）.
-   [Character Co-Occurrences in Victor Hugo’s _Les Misérables_](http://bokeh.pydata.org/en/latest/docs/gallery/les_mis.html)，绘制为邻接矩阵，用Python（+ Javascript）编写.
...
-   [A Twenty-First Century Science](http://www.nature.com/nature/journal/v445/n7127/full/445489a.html) -  Duncan J. Watts的散文.
-   [What is Network Science?](http://journals.cambridge.org/repo_A88Sa8AHdt4SoI) - 最近_Network Science_期刊的第一篇社论.

### Small Worlds

&gt;专注于（类似）的链接 [Stanley Milgram’s small-world experiment](https://en.wikipedia.org/wiki/Small-world_experiment).
...
-   [L’analyse des graphes bipartis](https://halshs.archives-ouvertes.fr/FMR/halshs-00794976)，法文（2013年）.
