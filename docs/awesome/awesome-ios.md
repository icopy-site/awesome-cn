...
* [JOEmojiableBtn](https://github.com/lojals/JOEmojiableBtn) - 像Facebook Reactions这样的表情符号选择器.
...
## User Consent
* [SmarltookConsentSDK](https://github.com/smartlook/ios-consent-sdk) - 开源SDK，提供可配置的控制面板，用户可以在其中选择隐私选项并存储应用程序的用户首选项.
