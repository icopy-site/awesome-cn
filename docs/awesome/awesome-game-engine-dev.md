...
- 教育门户网站
    ...
    - [Lighthouse3d.com](http://www.lighthouse3d.com/tutorials/) - OpenGL、GLSL 和其他图形主题的教程集合.
...
- C：图形 - 3D
    - [Sokol Gfx](https://github.com/floooh/sokol/blob/master/sokol_gfx.h) - 跨平台、单文件图形. [[Examples](https://floooh.github.io/sokol-html5/) | [LearnOpenGL](https://www.geertarien.com/learnopengl-examples-html5/)]
...
- C++：音频
    ...
    - [PortAudio](https://github.com/PortAudio/portaudio) - 跨平台、开源、音频库.
- C++：跨平台
...
- C++：游戏框架
    ...
    - ⭐ [Ouzel](https://github.com/elnormous/ouzel) - 公共领域，针对 2D 游戏的开发.
...
- JavaScript：跨平台
    ...
    - [React Native](https://github.com/facebook/react-native) - 使用 React 构建本机应用程序的框架. [[Website](https://reactnative.dev/)]
...
- JavaScript：游戏框架
    ...
    - [LittleJS](https://github.com/KilledByAPixel/LittleJS) - 带有 WebGL 渲染的轻量级 2D 框架.
...
- JavaScript：图形 - Three.js
    ...
    - [Sketchbook](https://github.com/swift502/Sketchbook) - 基于 Three.js 和 Cannon.js 构建的 3D 游乐场.
...
### Python
- [Awesome Python](https://github.com/vinta/awesome-python) - 很棒的 Python 框架、库、软件等列表.
- [Python.org](https://www.python.org) - 让您快速工作的编程语言. [[Docs](https://www.python.org/doc/)]
- Python：应用程序框架
    - [Pyglet](https://github.com/pyglet/pyglet) - 用于游戏开发的窗口和多媒体库.
- Python：跨平台
    - [Anvil](https://anvil.works) - 仅使用 Python 的全栈 Web 应用程序.
    - [Brython](https://github.com/brython-dev/brython) - Python 3 在浏览器中运行.
- Python：游戏框架
    - [Arcade](https://github.com/pythonarcade/arcade) - 易于使用的库，用于创建 2D 街机游戏.
    - [Panda3D](https://github.com/panda3d/panda3d) - 强大、成熟的游戏引擎，由迪士尼和卡耐基梅隆大学开发. [[Website](https://www.panda3d.org)]
    - [Pygame](https://github.com/pygame/pygame) - 游戏和多媒体应用程序框架，基于 _SDL_ 构建.
    - [Pygcurse](https://github.com/asweigart/pygcurse) - [Curses-like](https://en.wikipedia.org/wiki/Curses_%28programming_library%29) 文本冒险/类 Rogue 游戏库. [[Website](http://inventwithpython.com/pygcurse/)]
- Python：图形用户界面
    - [Kivy](https://github.com/kivy/kivy) - 跨平台图形用户界面框架. [[Website](https://kivy.org/)]

### Ruby
- [Awesome Ruby](https://github.com/markets/awesome-ruby) - 很棒的 Ruby 库、工具、框架和软件的集合.
- [Ruby](https://www.ruby-lang.org/en/) - 动态编程语言，注重简单性/生产力. [[GitHub](https://github.com/ruby/ruby)]
- 红宝石：框架
    - [Ruby on Rails](https://github.com/rails/rails) - 网络应用程序框架. [[Website](https://rubyonrails.org)]
- Ruby：游戏框架
    - [Ruby 2D](https://github.com/ruby2d/ruby2d) - 制作跨平台 2D 应用程序.
- 红宝石：图形 - 3D
    - [Mittsu](https://github.com/danini-the-panini/mittsu) - 很大程度上基于 _Three.js_ 的 3D 图形库.
红宝石：桂
    - [Glimmer](https://github.com/andyobtiva/glimmer) - Gui 库和 DSL（领域特定语言）框架.
    - [Shoes](https://github.com/shoes/shoes4) - 跨平台 GUI 库. [[Website](http://shoesrb.com/)]

### Rust
- [Awesome Rust](https://github.com/rust-unofficial/awesome-rust) - Rust 代码和资源的精选列表.
- [Rust](https://www.rust-lang.org) - 使每个人都能构建高质量的软件. [[Docs](https://www.rust-lang.org/learn) | [GitHub](https://github.com/rust-lang)]
- Rust：应用程序框架
    - [Makepad](https://github.com/makepad/makepad) - 软件开发平台和本机渲染 GUI 框架. [[Editor](https://makepad.dev/)]
    - [Tao](https://github.com/tauri-apps/tao) - 跨平台窗口. [[Docs](https://docs.rs/tao/latest/tao/)]
- 铁锈：音频
    - [Kira](https://github.com/tesselode/kira) - 为游戏创建富有表现力的音频.
- Rust：带编辑器的游戏引擎
    - [Fyrox](https://github.com/FyroxEngine/Fyrox)  - 带编辑器的 2D/3D 游戏引擎. 以前是_Rg3d_. [[Website](https://fyrox.rs/)]
- Rust：游戏框架
    - [Ambient](https://github.com/AmbientRun/Ambient) - 多人游戏引擎.
    - [Amethyst](https://github.com/amethyst/amethyst) - 数据驱动的 2D/3D 游戏引擎旨在快速且可配置.
    - [Bevy](https://github.com/bevyengine/bevy) - 令人耳目一新的简单数据驱动 2D/3D 游戏引擎. [[Website](https://bevyengine.org)]
    - [Macroquad](https://github.com/not-fl3/macroquad) - 易于使用的游戏库，深受 RayLib 的启发.
- Rust：图形 - 3D
    - [Kiss3D](https://github.com/sebcrozet/kiss3d) - 保持简单，愚蠢的 3D 图形引擎.
- Rust: Gui
    - [Azul](https://github.com/fschutt/azul) - 桌面图形用户界面框架.
    - [Dioxus](https://github.com/dioxuslabs/dioxus) - 跨平台、类似 React 的 gui 库.
    - [Druid](https://github.com/linebender/druid) - 数据优先的 GUI 设计工具包.
    - [egui](https://github.com/emilk/egui)  - 易于使用的即时模式图形用户界面. 在网络和本机上运行. [[Demo](https://www.egui.rs/)]
    - [Slint](https://github.com/slint-ui/slint)  - 用于嵌入式/桌面的 GUI 工具包. 以前是_SixtyFPS_. [[Website](https://slint-ui.com/)]
- 铁锈：物理
    - [Rapier](https://github.com/dimforge/rapier) - 注重性能的 2D/3D 物理引擎. [[Docs](https://rapier.rs)]

### Zig
- [Awesome Zig](https://github.com/nrdmn/awesome-zig) - Zig 代码和资源的精选列表.
- [Zig](https://ziglang.org/) - 通用语言和工具链. [[Docs](https://ziglang.org/documentation/master/) | [GitHub](https://github.com/michal-z/zig)]
- [Zig Learn](https://ziglearn.org/) - 优秀的 Zig 语言资源.
- [Ziglings](https://github.com/ratfactor/ziglings) - 通过修复微小的损坏程序来学习 Zig 编程语言.
- Zig：应用程序框架
    - [Upaya](https://github.com/prime31/zig-upaya) - 用于创建游戏工具和帮助应用程序的框架.
- Zig: File System
    - [Known Folders](https://github.com/ziglibs/known-folders) - 提供对多个操作系统中众所周知的文件夹的访问.
- Zig：带编辑器的游戏引擎
    - [Mach](https://github.com/hexops/mach) - 游戏引擎和图形工具包. [[Examples](https://machengine.org/gpu/)]
- Zig：游戏框架
    - [Zig-Gamedev Project](https://github.com/michal-z/zig-gamedev) - 使用 DirectX 12 的示例应用程序和库.
- Zig：图形 - 2D
    - [Mini Pixel](https://github.com/fabioarnold/MiniPixel) - 微型像素艺术编辑器. [[Download](https://fabioarnold.itch.io/mini-pixel)]
    - [Pixi](https://github.com/foxnne/pixi) - 像素艺术编辑器.
- Zig：脚本
    - [Cyber](https://github.com/fubark/cyber) - 快速、高效、并发的脚本语言.

<br />
<br />

## Open Source Games
_成功的开源视频游戏可供挑选并获取知识._

### C
- [Doom](https://github.com/id-Software/DOOM) - _id Software_ 于 1993 年原创的 3D 杰作.
- [Gish](https://github.com/blinry/gish) - 屡获殊荣的物理平台游戏的开源版本. [[Steam](https://store.steampowered.com/app/9500/Gish/)]
- [Handmade Hero](https://handmadehero.org/) - 从头到尾制作游戏的视频，源代码 15 美元.

### C++
- [Doom 3](https://github.com/id-Software/DOOM-3) - 《毁灭战士 3》GPL 源代码发布.
- [Dungeon Crawl: Stone Soup](https://github.com/crawl/crawl) - 经典的 Roguelike 冒险. [[Play](https://crawl.develz.org/)]
- [Etheral Legends](https://github.com/Soverance/EtherealLegends) - 使用 _Unreal Engine 4_ 构建的独立动作角色扮演游戏. [[Steam](https://store.steampowered.com/app/428980/Ethereal_Legends/)]
- [OpenLara](https://github.com/XProger/OpenLara) - 经典的古墓丽影开源引擎. [[Play](http://xproger.info/projects/OpenLara/)]
- [TeeWorlds](https://github.com/teeworlds/teeworlds) - 复古多人射击游戏. [[Website](https://teeworlds.com/)]
- [zDoom](https://github.com/coelckers/gzdoom) - 适用于所有 Doom 引擎游戏的现代、以功能为中心的端口. [[Website](https://zdoom.org/index)]

### Java
- [Pixel Dungeon](https://github.com/watabou/pixel-dungeon) - 传统的 Roguelike 游戏，具有像素艺术图形和简单的界面.

<br />
<br />

## Specialty Topics
_探索专业游戏引擎/游戏开发主题和功能._

### AI / Pathfinding
- [Intro to AI](https://www.raywenderlich.com/2808-introduction-to-ai-programming-for-games) - RayWenderlich.com 游戏人工智能编程简介.
- [Beginner's Guide to Game AI](https://www.gamedev.net/tutorials/programming/artificial-intelligence/the-total-beginners-guide-to-game-ai-r4942/) - 游戏人工智能中使用的概念介绍.

### Animation Info
- [Skeletons and Inverse Kinematics](https://venturebeat.com/2017/08/09/character-animation-skeletons-and-inverse-kinematics/) - 使用 IK 骨骼进行动画的原则.

### Color Manipulation
- [How to Choose Colors Procedurally](http://devmag.org.za/2012/07/29/how-to-choose-colours-procedurally-algorithms/) - 程序调色板以及如何生成它们.
- [Red, Yellow, and Blue](https://daveeddy.com/2014/07/01/red-yellow-and-blue/) - 将颜色从油漆色轮转换为 RGB 空间. [[Source](https://github.com/bahamas10/ryb)]

### Entity Component Systems
- [A Simple Entity Component System](https://austinmorlan.com/posts/entity_component_system/) - C++ ECS 的基础.
- [Evolve Your Hierarchy](https://cowboyprogramming.com/2007/01/05/evolve-your-heirachy/) - ECS 概述以及为何使用它们，位于 [Cowboy Programming](https://cowboyprogramming.com).
- [Intro to Component-Based Architecture in Games](https://www.raywenderlich.com/2806-introduction-to-component-based-architecture-in-games) - 基于组件的架构.
- [Nomad Game Engine](https://savas.ca/nomad) - 使用 C++ 从头开始​​构建 ECS 的文章. [[Source](https://github.com/taurheim/NomadECS)]
- [What's an Entity System](http://entity-systems.wikidot.com) - ECS 概述，以及它们如何在游戏开发中使用.
...
### Geometry
- 算法
    - [Practical Geometry Algorithms](http://geomalgorithms.com/index.html) - 几何形状、凸包、折线简化等等.
- CSG（构造立体几何）
    - [Constructive Solid Geometry](https://en.wikipedia.org/wiki/Constructive_solid_geometry) - 使用布尔运算组合原始对象的技术.
    - [csg.js](https://github.com/evanw/csg.js/) - 实现 CSG 的 JavaScript 库. [[Examples](https://evanw.github.io/csg.js/)]
    - [three-bvh-csg](https://github.com/gkjohnson/three-bvh-csg) - 基于三网状 BVH 的快速动态 CSG.
    - [three-csgmesh](https://github.com/manthrax/THREE-CSGMesh) - 转换 csg.js 库以与 Three.js 一起使用.
- 网格
    - [Mesh Transforms](https://ciechanow.ski/mesh-transforms/) - Apple 用于操作 UIView 网格的私有 API. [[Source](https://github.com/olegtyshcneko/CAMeshTransform)]
- 平滑
    - [Laplacian Smoothing](http://rodolphe-vaillant.fr/entry/70/laplacian-smoothing-c-code-to-smooth-a-mesh) - 使用 C++ 代码草稿注释，用于网格的拉普拉斯平滑.
    - [Subdivision at Matt's Webcorner](http://graphics.stanford.edu/~mdfisher/subdivision.html) - 使用细分曲面进行平滑.
    - [Subdivision Surfaces](http://www.holmes3d.net/graphics/subdivision/) - 细分曲面中使用的不同方案的说明.

### Hair
- [Fuzzy Meshes](https://medium.com/@Zadvorsky/fuzzy-meshes-4c7fd3910d6f) - 用锥体和重力模拟毛皮. [[Source](https://github.com/zadvorsky/three-fuzzy-mesh)]

### Lighting / Shadows
- 伽玛
    - [What Every Coder Should Know About Gamma](https://blog.johnnovak.net/2016/09/21/what-every-coder-should-know-about-gamma/) - 光发射与感知亮度.
- 灯光 2D
    - [Gleaner Heights: 2D Lighting](http://gleanerheights.blogspot.com/2017/05/lighting-in-2d-games-shader-glsl.html?m=1) - 使用 GLSL 简单介绍游戏中的 2D 光照.
- 灯光3D
    - [Basic Lighting](https://learnopengl.com/Lighting/Basic-Lighting) - LearnOpenGL 的 3D 光照文章.
    - [Forward Rendering vs. Deferred Rendering](https://gamedevelopment.tutsplus.com/articles/forward-rendering-vs-deferred-rendering--gamedev-12342) - 处理许多灯的技术.
    - [Forward+ Rendering / Tiled Forward Shading](https://www.3dgep.com/forward-plus/) - 使用平铺光剔除进行前向渲染.
- 阴影 2D
    - [2D Pixel Perfect Shadows](https://github.com/mattdesl/lwjgl-basics/wiki/2D-Pixel-Perfect-Shadows) - 使用着色器实现 2D 像素完美灯光/阴影的方法.
    - [2D Visibility](https://www.redblobgames.com/articles/visibility/) - 关于 2D 可见性的优秀交互式教程.
    - [Fast 2D shadows in Unity](https://www.gamedeveloper.com/programming/fast-2d-shadows-in-unity-using-1d-shadow-mapping) - 采用 3D 渲染技术来实现快速 2D 阴影.
    - [Sight & Light](https://ncase.me/sight-and-light/) - 如何为您的游戏创建 2D 可见性/阴影效果. [[Source](https://github.com/ncase/sight-and-light)]
    - [Symmetric Shadowcasting](https://www.albertford.com/shadowcasting/) - 计算视场的常用技术.
- 阴影 3D
    - [Efficient Soft-Edged Shadows](https://developer.nvidia.com/gpugems/gpugems2/part-ii-shading-lighting-and-shadows/chapter-17-efficient-soft-edged-shadows-using) - GPU 宝石 2 第 17 章.
    - [Screen Space Shadows](https://panoskarabelas.com/posts/screen_space_shadows/) - 对屏幕空间阴影的伟大探索.
    - [Shadow Mapping](https://en.m.wikipedia.org/wiki/Shadow_mapping) - 阴影贴图以及用于实现它的技术.
- 体积
    - [Threex Volumetric Spotlight](http://jeromeetienne.github.io/threex.volumetricspotlight/examples/basic.html) - 使用 Three.js 进行体积照明的绝佳示例. [[Source](https://github.com/jeromeetienne/threex.volumetricspotlight)]
    - [Volumetric Light Approximation](http://bkcore.com/blog/3d/webgl-three-js-volumetric-light-godrays.html) - 使用 Three.js 进行体积光近似（godrays）.

### Network
- [Source Multiplayer Networking](https://developer.valvesoftware.com/wiki/Source_Multiplayer_Networking) - Valve 的 Source Engine 多人游戏系统.

### Particles
- [Particles](https://learnopengl.com/In-Practice/2D-Game/Particles) - LearnOpenGL 的文章.
- [Soft Particles](https://keaukraine.medium.com/implementing-soft-particles-in-webgl-and-opengl-es-b968d61133b0) - 在 WebGL 中实现软粒子.

### Physics
- [Fix Your Timestep!](https://gafferongames.com/post/fix_your_timestep/) - 如何通过可变的 fps 保持物理稳定.
- [Game Physics from Scratch](https://brm.io/game-physics-for-beginners/) - 游戏物理的起始资源.
- [Intro to Physics](https://www.toptal.com/game/video-game-physics-part-i-an-introduction-to-rigid-body-dynamics) - 第一部分：刚体动力学简介.
- [Open Source Physics Engines](https://www.tapirgames.com/blog/open-source-physics-engines) - 开源物理引擎列表.
- 平台游戏
    - [2D Physics Games](https://www.gamedeveloper.com/design/how-to-create-2d-physics-games-with-box2d-library) - 使用 Box2D 处理水、绳索、重力、线路、车辆等.
    - [Basic 2D Platformer Physics](https://gamedevelopment.tutsplus.com/series/basic-2d-platformer-physics--cms-998) - 如何为平台游戏创建物理系统.
    - [Ledge Grabbing](https://gamedevelopment.tutsplus.com/tutorials/basic-2d-platformer-physics-part-4--cms-26046) - 2D 平台物理中壁架抓取的教程.
- 绳索/链条
    - [Draw SVG rope using JavaScript](https://muffinman.io/blog/draw-svg-rope-using-javascript/) - SVG 路径矢量绳索绘图.
    - [Ropes in Contraption Maker](https://www.gamedeveloper.com/design/ropes-in-contraption-maker) - 在 Contraption Maker 中实现绳索的物理原理.
    - [Matter.js: Chains](https://brm.io/matter-js/demo/#chains) - 使用 Matter.js 进行链演示. [[Source](https://github.com/liabru/matter-js/blob/master/examples/chains.js)]
- 柔软的身体
    - [Blob Physics](https://cowboyprogramming.com/2007/01/05/blob-physics/) - 使用 Verlet 物理学来模拟 2D 斑点.
    - [Oryol: Bullet Cloth](https://floooh.github.io/oryol-samples/wasm/BulletPhysicsCloth.html) - 使用 Oryol 游戏框架的子弹物理 3D 布料. [[Source](https://github.com/floooh/oryol-samples/blob/master/src/BulletPhysicsCloth/BulletPhysicsCloth.cc)]
    - [Three.js: Ammo Volume](https://threejs.org/examples/?q=physics#physics_ammo_volume) - 使用 Ammo.js 和 Three.js 的 3D 软体体积. [[Source](https://github.com/mrdoob/three.js/blob/master/examples/physics_ammo_volume.html)]
- 韦尔莱特物理学
    - [Making a Verlet Physics Engine](https://medium.com/m/global-identity?redirectUrl=https%3A%2F%2Fbetterprogramming.pub%2Fmaking-a-verlet-physics-engine-in-javascript-1dff066d7bc5) - 在 JavaScript 的 2D 物理引擎的引擎盖下.
- 水/浮力
    - [2D Water](https://prime31.github.io/water2d-part1/) - 用泉水模拟二维水.

### Rendering
- [GPU Driven Rendering](https://vkguide.dev/docs/gpudriven/gpu_driven_engines/) - 在计算着色器中计算 GPU 上的渲染.
- [Model Batching](https://webglfundamentals.org/webgl/lessons/webgl-qna-drawing-many-different-models-in-a-single-draw-call.html) - 在一次绘制调用中绘制许多不同的模型.

### Scripting
- [Adding Languages to Game Engines](https://www.gamedeveloper.com/programming/adding-languages-to-game-engines) - 向游戏添加脚本的故事.
- [Implementing a Scripting Engine](https://www.flipcode.com/archives/Implementing_A_Scripting_Engine-Part_1_Overview.shtml) - 从头开始​​编写脚本引擎.
- [Embedded Scripting Languages](https://caiorss.github.io/C-Cpp-Notes/embedded_scripting_languages.html) - 脚本语言和引擎可作为库使用.
- [List of Embedded Scripting Languages](https://github.com/dbohdan/embedded-scripting-languages) - 在您的应用程序/游戏中使用的脚本语言.
- [Scriptorium](https://github.com/r-lyeh-archived/scriptorium) - 游戏脚本语言进行基准测试.

### Shaders
- [3D Game Shaders For Beginners](https://lettier.github.io/3d-game-shaders-for-beginners/index.html) - 着色器来改善你的游戏. [[Source](https://github.com/lettier/3d-game-shaders-for-beginners)]
- [Book of Shaders](https://thebookofshaders.com) - 逐步指导 [Fragment Shaders](https://www.khronos.org/opengl/wiki/Fragment_Shader). [[Source](https://github.com/patriciogonzalezvivo/thebookofshaders)]
- [CrossShader](https://github.com/alaingalvan/CrossShader) - GLSL、HLSL、Metal 等之间交叉编译着色器. [[Online Tool](https://alain.xyz/libraries/crossshader)]
...
- 布鲁姆
    - [LearnOpenGL Tutorial](https://learnopengl.com/Advanced-Lighting/Bloom) - 用于光晕照明的技术，以 OpenGL 形式呈现.
    - [Three.js: Bloom Example](https://threejs.org/examples/?q=bloom#webgl_postprocessing_unreal_bloom) - 使用 Three.js 进行 WebGL 布隆后处理. [[Source](https://github.com/mrdoob/three.js/blob/master/examples/webgl_postprocessing_unreal_bloom.html)]
    - [Unity Tutorial](https://catlikecoding.com/unity/tutorials/advanced-rendering/bloom/) - 如何添加对绽放效果的支持.
- 移位
    - [Basic GLSL Displacement Shader](http://benchung.com/basic-glsl-displacement-shader-three-js/) - 使用 Three.js 的基本顶点位移着色器.
- 火
    - [Fire Shader in GLSL](https://clockworkchilli.com/blog/8_a_fire_shader_in_glsl_for_your_webgl_games) - 使用噪声纹理和掩蔽的火焰介绍着色器.
    - [Simplex 3D Noise](https://www.shadertoy.com/view/MllfDn) - ShaderToy 的单纯形噪声火灾模拟着色器.
- 线路
    - [Drawing Lines](https://mattdesl.svbtle.com/drawing-lines-is-hard) - 2D/3D 线条渲染技术.
- 噪音
    - [Book of Shaders: Noise](https://thebookofshaders.com/11/) - Book of Shaders 撰写的优秀 GLSL 噪声文章.
    - [Color Banding](https://shader-tutorial.dev/advanced/color-banding-dithering/) - 使用噪声/抖动来改善绘图渐变.
    - [Psrdnoise](https://github.com/stegu/psrdnoise/) - 在 2D/3D 中平铺单纯形流噪声.
    ...
    - [WebGL Noise](https://github.com/stegu/webgl-noise/) - 保留了原始 Ashima Arts 2D、3D 和 4D 噪声功能的分支.
- 轮廓
    - [Fast Solid 2D Outline](https://www.shadertoy.com/view/XdV3Dc) - 在 2D 图像的 Alpha 通道上绘制轮廓.
    - [Let it glow!](http://blogs.love2d.org/content/let-it-glow-dynamically-adding-outlines-characters) - 包含有关向角色动态添加轮廓的着色器代码的文章.
    - [Outline Shader](https://www.reddit.com/r/godot/comments/8g067a/the_perfect_outline_shader_atleast_close/) - 漂亮的轮廓着色器. [[Source](https://github.com/steincodes/godot-shader-tutorials)]
    - [Outlines w/Surface IDs](https://omar-shehata.medium.com/better-outline-rendering-using-surface-ids-with-webgl-e13cdab1fd94) - 结合深度、法线和表面 ID 的技术. [[Source](https://github.com/OmarShehata/webgl-outlines)]
    - [Sketchy Outling](https://lettier.github.io/3d-game-shaders-for-beginners/outlining.html) - 关于生成粗略轮廓外观的文章.
- 像素化
    - [Pixel Art Shaders](https://alaingalvan.tumblr.com/post/79829067408/glsl-pixel-art-shaders) - 适用于像素艺术游戏的有用 GLSL 后处理着色器.
    - [Three.js: Pixelation Example](https://threejs.org/examples/?q=pixel#webgl_postprocessing_pixel) - 使用 Three.js 进行 WebGL 像素化后处理. [[Source](https://github.com/mrdoob/three.js/blob/master/examples/webgl_postprocessing_pixel.html)]
- 后期处理
    - [Image Editor Effects](https://alain.xyz/blog/image-editor-effects) - WebGL 图像过滤器/效果着色器. [[Source](https://github.com/alaingalvan/image-editor-effects)]
- Upscaling
    - [How do I perform an xBR or hqx filter in XNA?](https://gamedev.stackexchange.com/questions/87275/how-do-i-perform-an-xbr-or-hqx-filter-in-xna/87821#87821) - 升级着色器代码.
    - [hqx](https://en.wikipedia.org/wiki/Hqx) - 关于 Maxim Stepin 开发的 hqx 像素艺术升级算法的维基百科文章.
- 水/折射
    - [2D Water Shader](https://rotatingcanvas.com/fragment-shader-to-simulate-water-surface-in-libgdx/) - GLSL 片段着色器在 libGDX 中模拟 2D 水面.
- 线框
    - [Flat and Wireframe Shading](https://catlikecoding.com/unity/tutorials/advanced-rendering/flat-and-wireframe-shading/) - 使用重心坐标的平面着色/线框.

### Signed Distance Fields
- [2D SDFs](https://iquilezles.org/www/articles/distfunctions2d/distfunctions2d.htm) - 基本 2D 图元的有符号距离函数.
- [3D SDFs](https://iquilezles.org/www/articles/distfunctions/distfunctions.htm) - 基本 3D 图元的有符号距离函数.
- [CSG w/SDFs](https://jasmcole.com/2019/10/03/signed-distance-fields/) - 使用圆形 SDF 通过 CSG 构建 3D 对象. [[Source](https://github.com/jasmcole/Blog/tree/master/CSG)]
- [Basic 2D SDFs](https://www.ronja-tutorials.com/post/034-2d-sdf-basics/) - 在着色器中使用 SDF 渲染 2D 形状的基础知识.
- [Bezier Strokes](https://vladjuckov.github.io/beziers-sdf/) - 关于使用 SDF 渲染贝塞尔曲线的博客文章.
- [Signed Distance Field Resources](https://github.com/CedricGuillemet/SDF) - 教程、论文、软件、演示、讨论等.
- [SDF Mesh Generation](https://github.com/fogleman/sdf) - 使用 SDF 生成 3D 网格的 Python API.

### Tiling
- [Auto-Tile](https://gamedevelopment.tutsplus.com/tutorials/how-to-use-tile-bitmasking-to-auto-tile-your-level-layouts--cms-25673) - 如何使用平铺位掩码自动平铺您的关卡布局.
- [Blob Tileset](http://www.cr31.co.uk/stagecast/wang/blob.html) - 2D 边缘和角匹配图块集的教程.
- [List of Eucliden Uniform Tilings](https://en.wikipedia.org/wiki/List_of_Euclidean_uniform_tilings) - 维基百科关于均匀平铺、空间填充多边形的文章.
- [Space-Filling Polyhedron](https://mathworld.wolfram.com/Space-FillingPolyhedron.html) - [Polyhedra](https://en.wikipedia.org/wiki/Category:Space-filling_polyhedra)，填充空间的 3D 多边形. [[5 Space-Filling Polyhedra](https://www.steelpillow.com/polyhedra/five_sf/five.html)]

### Transparency
- [Depth Peeling](https://developer.download.nvidia.com/assets/gamedev/docs/OrderIndependentTransparency.pdf) - 与顺序无关的透明度的方法.
- [Intro to Order-Independent Transparency](https://learnopengl.com/Guest-Articles/2020/OIT/Introduction) - LearnOpenGL 的文章.
- [Weighted, Blended](http://casual-effects.blogspot.com/2015/03/implemented-weighted-blended-order.html) - 与顺序无关的透明度的方法.
...
### 2D Game Dev
- [ShoeBox](http://renderhjs.net/shoebox/) - 用于精灵表、位图字体、纹理撕裂、平铺地图等的拖放工具.
- [Sprite Illuminator](https://www.codeandweb.com/spriteilluminator) - 在游戏引擎中使用 2D 精灵创建令人惊叹的灯光效果.
- [Texture Packer](https://www.codeandweb.com/texturepacker) - 创建精灵表并优化您的游戏图形.
- [Tiled](https://www.mapeditor.org) - 适用于所有基于图块的游戏的通用图块地图编辑器. [[Source](https://github.com/mapeditor/tiled)]
...
### Audio Tools
- 音乐
    - [Ardour](https://ardour.org) - 录音、编辑和混音. [[Source](https://github.com/Ardour/ardour)]
    - [Audacity](https://www.audacityteam.org) - 多轨音频编辑器和录音机. [[Source](https://github.com/audacity/audacity)]
    - [Bosca Ceoil](https://boscaceoil.net) - 易于使用的音乐创作工具.
    - [Cakewalk](https://www.bandlab.com/products/cakewalk) - 完整的音乐制作包.
    - [FamiStudio](https://famistudio.org) - 针对芯片音乐艺术家和 NES 家庭酿酒师的音乐编辑器. [[Source](https://github.com/BleuBleu/FamiStudio)]
    - [fmod](https://www.fmod.com) - 流行的游戏音频软件（Hades、Celeste、Untitled Goose Game）.
    - [LMMS](https://lmms.io) - 跨平台音乐制作软件. [[Source](https://github.com/lmms/lmms)]
    - [PixiTracker](https://warmplace.ru/soft/pixitracker/) - 快速创建音乐草图、芯片音乐和声音实验.
    - [Sound Box](https://sb.bitsnbites.eu) - 在浏览器中创作合成音乐，适合小型演示. [[Source](https://github.com/mbitsnbites/soundbox)]
    - [SunVox](https://warmplace.ru/soft/sunvox/) - 强大 [modular synthesizer](https://en.wikipedia.org/wiki/Modular_synthesizer) 与基于模式的音序器（[tracker](https://en.wikipedia.org/wiki/Music_tracker)).
    - [ZzFXM](https://keithclark.github.io/ZzFXM/tracker/) - 用于小型 JavaScript 应用程序的音乐生成器. [[Source](https://github.com/keithclark/ZzFXM)]
- 声音特效
    - [Bfxr](https://www.bfxr.net)  - 经典的. 用于为游戏制作简单的音效. [[Source](https://github.com/increpare/bfxr)]
    - [ChipTone](https://sfbgames.itch.io/chiptone) - 用于生成声音效果的工具.
    - [sfxia](https://rxi.itch.io/sfxia) - 微型声音发生器.
    - [ZzFX](https://killedbyapixel.github.io/ZzFX/) - 微型 JavaScript 音效系统 / Zuper Zmall Zound Zynth. [[Source](https://github.com/KilledByAPixel/ZzFX)]

### Color / Palettes
- [Colormind](http://colormind.io) - 配色方案生成器，可以从照片、艺术等中学习色彩风格.
- [COLOURlovers](https://www.colourlovers.com) - 分享颜色、调色板和图案.
- [Coolors](https://coolors.co) - 快速调色板生成器.
- [Huemint](https://huemint.com) - 使用机器学习生成图形设计的颜色.
- [Paletton](https://paletton.com) - 探索色轮上的互补色.

### Generative Art
- 影像学
    - [DALL·E 2](https://openai.com/dall-e-2/) - 从自然语言创建逼真的图像.
    - [Disco Diffusion](http://discodiffusion.com/) - AI 艺术和动画的笔记本、模型和技术.[[Source](https://github.com/alembics/disco-diffusion)]
    - [Midjourney](https://www.midjourney.com/home/) - 通过 Discord 访问图像生成.
    - [Replicate](https://replicate.com/) - 使用云 API 运行开源模型.
    - [Stable Diffusion](https://github.com/CompVis/stable-diffusion) - 潜在文本到图像扩散模型.
- 建模
    - [Dream Fusion](https://dreamfusion3d.github.io/) - 使用 2D 扩散将文本转为 3D.
    - [GET3D](https://nv-tlabs.github.io/GET3D/) - _NVIDIA_ 根据图像生成 3D 形状模型. [[Source](https://github.com/nv-tlabs/GET3D)]
    - [Magic3D](https://research.nvidia.com/labs/dir/magic3d/) - 高分辨率文本转 3D 内容创建.
    - [NeRF](https://www.matthewtancik.com/nerf) - 将场景合成视为神经辐射场. [[Source](https://github.com/bmild/nerf)]
    - [Shap-e](https://github.com/openai/shap-e) - 生成以文本或图像为条件的 3D 对象.
- 声音
    - [Dittytoy](https://dittytoy.net/) - 使用简单的 JavaScript API 创建生成音乐.
    - [Sonic Pi](https://github.com/sonic-pi-net/sonic-pi) - 一种可以用来编码音乐的乐器.

### Image Editors
- [GIMP](https://www.gimp.org) - GNU 图像处理程序，开源图像编辑器. [[Source](https://github.com/GNOME/gimp)]
- [Photopea](https://www.photopea.com) - 强大的在线照片编辑器.

### Level Editors
- [Radiant](https://icculus.org/gtkradiant/) - 跨平台关卡编辑器 [idTech](https://en.wikipedia.org/wiki/Id_Tech) 游戏. [[Source](https://github.com/TTimo/GtkRadiant)]
- [TrenchBroom](https://trenchbroom.github.io) - 雷神之锤引擎游戏的关卡编辑器. [[Source](https://github.com/TrenchBroom/TrenchBroom)]

### Materials / Textures
- [ArmorLab](https://armorlab.org) - 通过拖放照片生成 PBR 材料. [[Source](https://github.com/armory3d/armorlab)]
- [Filter Forge](https://www.filterforge.com) - 照片效果、逼真的纹理和可视化编辑器.
- [JSplacement](https://windmillart.net/?p=jsplacement) - 跨平台伪随机位移图生成器.
- [Material Maker](https://www.materialmaker.org) - 程序性 [physically-based rendering](https://en.wikipedia.org/wiki/Physically_based_rendering) 材料制造商. [[Source](https://github.com/RodZill4/material-maker)]
- [Materialize](http://boundingboxsoftware.com/materialize/) - 用于从游戏中使用的图像创建材料的工具. [[Source](https://github.com/BoundingBoxSoftware/Materialize)]
- [PixPlant](https://www.pixplant.com/index.php) - 允许简单创建平铺 3D 材质的工具.
- [TexaTool](https://kronbits.itch.io/texatool) - 通过移动滑块生成可平铺纹理的在线工具.
- [Texgen.js](https://texgenjs.org) - JavaScript 纹理生成器工具. [[Source](https://github.com/mrdoob/texgen.js)]
- [TexTools for Blender](http://www.renderhjs.net/?doc=texToolsBlender) - Blender 的 UV 和纹理工具. [[Source](https://bitbucket.org/renderhjs/textools-blender/src/master/)]

### Modeling Tools
- [3DS Max](https://www.autodesk.com/products/3ds-max/) - 用于 3D 建模和渲染的经典软件.
- [ArmorPaint](https://armorpaint.org) - 基于物理的纹理绘画，放入 3D 模型并进行绘画. [[Source](https://github.com/armory3d/armorpaint)]
- [Asset Forge](https://assetforge.io) - 使用构建块创建 3D 模型和 2D 精灵.
- [Blender](https://www.blender.org) - 开源 3D 建模标准. [[Source](https://github.com/blender/blender)]
- [Meshroom](https://alicevision.org/#meshroom) - 3D重建，用 [AliceVision](https://github.com/alicevision/AliceVision) 框架. [[Source](https://github.com/alicevision/meshroom)]
- [ZBrush Core Mini](https://zbrushcore.com/mini/index.php) - 简单易用的 3D 雕刻工具.

### Particle Tools
- [Particle Designer](https://www.71squared.com/particledesigner) - 专为 macOS 设计的强大粒子效果编辑器.
- [TimelineFX](https://www.rigzsoft.co.uk) - 为您的游戏、应用程序和网页创建令人惊叹的粒子效果.
...
- [PixaTool](https://kronbits.itch.io/pixatool) - 通过转换图像、精灵或视频来创建像素艺术.
- [Pixel FX](https://codemanu.itch.io/particle-fx-designer) - 创建像素艺术粒子效果并将其渲染为精灵表.
- [Smear FX](https://codemanu.itch.io/smear-fx) - 通过添加一些涂抹，让您的 2D 动画变得生动有趣.

### Vector Editors
- [Inkscape](https://inkscape.org) - 跨平台、开源矢量图形编辑器. [[Source](https://github.com/inkscape/inkscape)]
- [Krita](https://krita.org/en/) - 专业品质，开源绘画. [[Source](https://github.com/KDE/krita)]
- [Vec Maker](https://kronbits.itch.io/vecmaker) - 易于使用的矢量设计.

### Voxel
- [Ken Shape](https://tools.kenney.nl/kenshape/) - 以 2D 方式绘制，设置每个像素的深度并生成 3D 模型！
- [IsoVoxel](https://github.com/tommyettinger/IsoVoxel) - 从 MagicaVoxel .vox 文件生成等距像素艺术.
- [MagicaVoxel](https://ephtracy.github.io) - 轻量级体素艺术编辑器.
- [Qubicle](https://www.getqubicle.com) - 流行（Crossy Road、Pacman 256）体素编辑器，轻松创建 3D 模型.

<br />
<br />

## Video Game Assets
_帮助视频游戏和游戏引擎焕发活力的资源._

### Audio Assets
- 音乐
    - [BandLab Sounds](https://www.bandlab.com/sounds/home) - 用于音乐创作的高品质循环和包.
    - [Bensound](https://www.bensound.com/royalty-free-music)  - 原创音乐曲目，免费且有归属. 非常适合游戏.
    - [Incompetech](https://incompetech.com/wordpress/)  - 精美的游戏曲目集合. 需要购买或归属.
    - [Melody Loops](https://www.melodyloops.com/music/free/) - 免费且价格实惠的音乐循环的完美组合.
    - [Royalty Free Music Clips](https://www.royaltyfreemusicclips.com/pir/free_music_loops.shtml) - 大量免费和付费免版税音乐曲目.
    - [Soundimage](https://soundimage.org/looping-music/)  - 视频游戏的循环音乐曲目. 需要购买或归属.
- 声音特效
    - [Freesound](https://freesound.org/browse/) - 基于社区的免费音效档案.
    - [Free Sound Effects](https://www.freesoundeffects.com/) - 大量音效集合.
    - [Soundsnap](https://www.soundsnap.com) - 基于订阅的专业音效库.

### Graphic Assets
- [Flaticon](https://www.flaticon.com) - 质量矢量图标和贴纸.
- [Freepik](https://www.freepik.com) - 插图、照片、图标和演示模板.
- [Kenny](https://www.kenney.nl/assets) - 2D/3D CC0 1.0 游戏图形和其他资产.
- [Open Game Art](https://opengameart.org) - 免费/公共领域在线游戏艺术门户.
- [Shutterstock](https://www.shutterstock.com) - 数以百万计的图像、视频和音乐曲目.
- [Top Free Game Assets](https://itch.io/game-assets/free) - itch.io 上列出的顶级免费游戏资产.

### Material Assets
- [AmbientCG](https://ambientcg.com) - 用于基于物理的渲染的公共领域材料.
- [Pmndrs Materials](https://market.pmnd.rs/materials) - 公共领域材料的收集.

### Model Assets
- [3D Models CC0](https://www.3dmodelscc0.com) - 公共领域 3D 模型.
- [Pmndrs Market](https://market.pmnd.rs) - 公共领域模型的集合.
- [Poly Pizza](https://poly.pizza) - 使用数千个免费的低多边形模型构建美丽的东西.
- [Quaternius](https://quaternius.com) - CC0 1.0 3D 模型集合.
- [Retro3DGraphicsCollection](https://github.com/Miziziziz/Retro3DGraphicsCollection) - 无归属，复古（PS1 风格）3D 图形资源.
- [Sketchfab](https://sketchfab.com) - 庞大的 3D 资源库.
...
_已删除的死链接保留在 [Archive](https://github.com/stevinz/awesome-game-engine-dev/blob/master/ARCHIVE.md)._
