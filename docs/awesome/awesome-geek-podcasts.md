...
* [/dev/hell](http://devhell.info/) 克里斯·哈特斯（Chris Hartjes）和埃德·芬克勒（Ed Finkler）被困在Development Hell中，他们主要谈论PHP，Web，他们的开发经验以及特别邀请.
* [a16z Podcast](https://a16z.com/podcasts/) -播客讨论技术和文化趋势，新闻和未来.
* [Accidental Tech Podcast](http://atp.fm/) -三个书呆子讨论技术，苹果，编程和松散相关的问题.
* [Ada Lovelace Day](https://findingada.com/) [iTunes](https://podcasts.apple.com/gb/podcast/ada-lovelace-day-podcast/id1119310112) -妇女在科学，技术，工程和数学方面的成就.
* [Android Developers Backstage](http://androidbackstage.blogspot.com/)  -Android Backstage，这是由Android开发人员提供的播客. 该节目由Android工程团队的开发人员主持，涵盖了Android程序员感兴趣的主题，并与Google Android团队的工程师进行了深入的讨论和访谈.
* [Around IT In 256 Seconds](https://256.nurkiewicz.com/)  -面向开发人员，测试人员，SRE以及他们的经理的播客. 我清楚地解释了复杂而复杂的技术，避免了流行语和炒作. 请勿超过4分16秒.
* [Ask Noah](https://www.jupiterbroadcasting.com/show/asknoah/) -诺亚（Noah）回答有关技术，业务，社区和Linux的问题
...
* [Azure Friday](https://channel9.msdn.com/Shows/Azure-Friday)  -Scott Hanselman和实际的工程师坐在一起，他们在学习如何对云进行编程的过程中建立了Azure. 没有市场营销，没有BS，只有两名工程师和一小段可管理的笔记本电脑.
...
* [Citizen Cosmos](https://www.citizencosmos.space/) -播客，发现Cosmos区块链生态系统和web3的策划者. 
* [Cloudcast](http://www.thecloudcast.net/) -屡获殊荣的播客，包括云计算，AWS生态系统，OpenSource，DevOps，AppDev，SaaS和SDN.
...
* [Command Line Heroes](https://www.redhat.com/en/command-line-heroes) -关于从命令行转换技术的人员的新播客.
* [Complete Developer Podcast](https://completedeveloperpodcast.com/)  -关于语言和编码的播客很多. 我们使用Complete Developer Podcast进行的工作是涵盖生活的其他领域. 例如，我们的第一集是关于与客户，老板以及其他与开发人员互动的人（不是开发人员）进行交谈.
* [Composers Play](https://www.youtube.com/playlist?list=PL05Yj9M-fWdJUySLU5fJ8Lg6h6t43_0nf) -经常在玩游戏时，与视频作曲家讨论其标志性游戏的配乐，例如《质量效应》，《毁灭公爵II》，《毁灭战士》和《系统冲击》.
* [CppCast](http://cppcast.com/) -C ++开发人员针对C ++开发人员的第一个播客.
* [Creative Coding Podcast](http://creativecodingpodcast.com/) -关于视觉和创意应用程序的编程.
* [Curious Minds](https://www.cmpod.net/)  -《好奇心》是有关科学，技术和历史的播客. 每个插曲都会带来来自许多主题的有趣故事：从物理和天文学到医学，艺术和科幻小说.
...
* [Defensive Security Podcast](https://defensivesecurity.org/category/podcast/) -防御性安全是一个网络安全播客，内容涵盖违规行为和防御策略.
...
* [DevelopersHangout](http://www.developershangout.io/)  -每隔2周，两名开发人员谈论他们遇到的挑战，文章，新闻，书籍和其他播客.  Laravel，PHP是两个关键主题，而其他出色的播客也类似于上面列出的播客.
...
* [Elixir Outlaws](https://elixiroutlaws.com) -关于Elixir开发中及其周围主题的小组讨论.
...
* [Entreprogrammers](http://entreprogrammers.com/)  -从4位开发者转变为企业家的过程中获得飞速发展的视野，因为他们在与企业的斗争中艰难地学习课程. 这是每周一次的策划者.
...
* [Hackable?](https://hackablepodcast.com)  -在一个我们痴迷于保持联系的世界中，我们如何确保我们不会让自己变得脆弱. 主持人Geoff Siskind进行了现场演示，展示了每一集中一些很棒的骇客技巧.
...
* [Harry Potter and the methods of rationality](http://www.hpmorpodcast.com/)  -这是另一个宇宙的故事，矮牵牛嫁给了一位科学家. 哈利带着启蒙理想和实验精神进入巫师世界.
...
* [Houston We Have a Podcast](https://www.nasa.gov/johnson/HWHAP/)  -约翰逊太空中心NASA的官方播客. 每周举办一次，其主题一般是关于太空和国际空间站.
...
* [Iron Sysadmin](https://www.ironsysadmin.com/) -真实世界系统管理员的播客，适用于真实世界系统管理员.
...
* [Javascript Jabber](https://devchat.tv/podcasts/js-jabber/) -在前端和后端每周进行有关Javascript的播客讨论.
...
* [Land of Giants](https://www.vox.com/land-of-the-giants-podcast)  - Facebook. 苹果. 亚马逊.  Netflix. 谷歌. 该播客检查了它如何发挥作用，如何使用它以及将来会发生什么.
...
* [Linux For Everyone](https://linuxforeveryone.fireside.fm/)  -关于台式机Linux，开放源代码软件以及创建它的社区的激动人心的世界的展示. 对于初学者和退伍军人都一样！ 由《福布斯》的Jason Evangelho和朋友主持.
...
* [Makers](https://crew.co/) -意外的生活瞬间影响了当今最有影响力和实验性的制造商.
* [Mastering Embedded Systems](https://embeddedsuccess.com/podcast/)  -我已经发现掌握嵌入式系统的四个主要问题：1.专家不足；  2.设计不充分，故障检测不力；  3.强制性的多站点方法失败；  4.虚拟团队管理中的严重错误我将教你一些知识和克服这些挑战的工具.
* [Mind the Cloud Podcast](http://mindthecloud.com) -关于使用云创建未来的开发人员和公司的播客.
* [MS Dev Show](https://msdevshow.com/)  -适用于Microsoft开发人员的播客.  Jason Young和Carl Schweitzer讨论了开发人员新闻中的最新消息，这些新闻涉及诸如Azure云，Windows，Windows Phone，Visual Studio和使用Microsoft平台的跨平台开发之类的主题.
* [New Rustacean](https://newrustacean.com/) -这是一个有关从头开始学习编程语言Rust的播客.
...
* [Office 365 Developer Podcast](https://www.microsoft.com/en-us/microsoft-365/blog/) -唯一针对Office 365开发的展览，我们与来自世界各地的专家就Office 365平台上的编码进行了交谈.
* [On the Metal](https://oxide.computer/blog/categories/on-the-metal/) -硬件/软件界面的故事：“地球上最令人讨厌的播客”.
...
* [PHP Round Table](https://www.phproundtable.com/) -PHP圆桌会议是由开发人员组成的临时聚会，讨论PHP书呆子关心的主题.
* [PHP Town Hall](http://phptownhall.com/) -Town Hall，一种供PHP开发人员提出有关PHP社区中当前事件（或即将发生的事情）的问题的方式，每周有不同的来宾.
* [Podcast.\__init__](https://www.pythonpodcast.com/) -关于Python以及使之变得出色的人们的播客.
...
* [Reactive](http://reactive.audio/) -播客，它合并，过滤，扫描和映射有关软件工程，文化和技术的思想流.
* [React Podcast](https://reactpodcast.com/) -关于React.js的播客
* [Reasonably Sound](http://reasonablysound.com/) -对音频的复杂性和令人敬畏度以及周围和周围各种文化的背景，解释和一些庆祝.
...
* [Rocket Ranch](https://www.nasa.gov/kennedy/rocketranch/) -来自NASA肯尼迪航天中心的官方播客.
...
* [Second Career Devs](https://secondcareerdevs.com/) -Second Career Devs播客的每一集都针对一位在上一个职业之后成为软件工程师的来宾.
* [Security Now!](https://www.grc.com/securitynow.htm)  -现在安全！ 由史蒂夫·吉布森（Steve Gibson）和里奥·拉波特（Leo Laporte）之间的讨论组成，内容涉及计算机安全性以及相反的不安全性.
* [Security Weekly](https://securityweekly.com) -关于安全和信息安全的每周播客.
* [Semaphore Uncut](https://semaphoreci.com/podcast) -软件行业的专家讨论了他们正在使用的产品正在解决的问题.
* [Self Hosted](https://selfhosted.show/)  -发现新的软件和硬件，以充分利用网络，控制智能设备，并保护云服务上的数据安全. 自托管是克里斯和亚历克斯两个长期的“自托管者”之间的聊天节目，他们共享课程并带您踏上新旅程.  Linux Academy播客，展示了您可以托管的免费和开源技术.
* [ShopTalk Show](https://shoptalkshow.com/) -关于前端网页设计，开发和UX的播客.
...
* [Surveillance Report](https://techlore.tech)  -每周进行一次安全和隐私新闻汇总，以使您及时了解我们数字世界中的重要更新. 每个周末都上载！
* [Sword & Laser](http://swordandlaser.com/) -剑与激光（S＆L）是科幻小说和幻想主题的读书俱乐部，视频节目和播客，由维罗妮卡·贝尔蒙特（Veronica Belmont）和汤姆·梅里特（Tom Merritt）创立.
...
* [Talking Kotlin](http://talkingkotlin.com/) -关于科特林的双月播客，更多由哈迪·哈里里（Hadi Hariri）主持.
...
* [Teaching Python](https://www.teachingpython.fm/) -两名中学教师学习和教授Python.
* [TechStuff](https://www.stuffmedia.com/techstuff-podcast.htm)  -TechStuff的主题涉及从基本电子产品到大型强子对撞机以及介于两者之间的所有内容.  TechStuff致力于揭开技术及其在我们社会和文化中的作用的神秘面纱.
...
* [The Accidental Engineer](https://theaccidentalengineer.com/) -采访工程师，介绍他们的职业生涯
* [The Agile Coffee Podcast](http://agilecoffee.com/) -AgileCoffee聚集了一批对敏捷方法论和精益实践充满热情的从业人员.
* [The Amp Hour](https://theamphour.com/) -在一个小时左右的每周表演中讨论电子设计的世界.
...
* [The Bike Shed](http://bikeshed.fm/) -在“自行车棚”上，主持人Derek Prior，Sean Griffin，Laila Winner和嘉宾讨论了他们在Ruby，Rails，JavaScript等方面的开发经验和挑战，以及本周引起人们注意，钦佩或不满的任何其他内容.
* [The Bug Bounty Podcast](https://anchor.fm/bugbountypodcast)  -有关错误，赏金及其研究人员的播客. 由Fisher托管.
...
* [The CyberWire Daily](https://thecyberwire.com/podcasts/daily-podcast)  -每天的网络安全新闻和分析行业领导者都依赖. 该计划在每个工作日发布，还包括来自世界各地的行业，学术界和研究组织的众多专家的访谈.
* [The Cybrary Podcast](https://www.cybrary.it/info/cybrary-podcast/) -它从网络安全和IT领域的各个方面讨论了行业领导者和专业人员，从而深入了解了他们如何到达今天的位置以及应该注意哪些新兴技术.
* [The Distributed Data Show](https://www.datastax.com/resources/distributed-data-show)  -每周最新消息和技术专长，以帮助构建大型分布式系统. 由DataStax技术推广人员团队带队，与DataStax工程师和来自更广泛数据社区的特别嘉宾深入探讨. 每个星期二有新剧集.
...
* [The Hackersploit Podcast](https://www.listennotes.com/podcasts/the-hackersploit-podcast-alexis-rwTafnO1K9c/) -HackerSploit播客旨在培养对Infosec，Hacking或Cyber​​security感兴趣的任何人. 
...
* [The Web Platform Podcast](http://thewebplatform.libsyn.com/) -每周一次的节目，深入探讨了今天构建平台的开发人员对Web的所有关注.
* [This Developer's Life](http://thisdeveloperslife.com/) -关于开发人员及其生活的播客.
* [Thoughtbot](https://thoughtbot.com/podcasts) -我们记录并发布每周来自设计的Thoughtbot，Ruby on Rails，iOS，正在运行的软件公司以及保持工作/生活平衡的播客.
* [ThoughtWorks](https://soundcloud.com/thoughtworks) -一个充满热情的个人社区，其目的是在倡导积极的社会变革的同时彻底改变软件设计，创建和交付.
* [Three Devs and a Maybe](https://threedevsandamaybe.com/)  -关于Web开发所有事物的每周讨论播客. 主题包括开发人员的日常生活，PHP，框架，测试，良好的软件设计以及我们使用许多其他编程语言的经验.
* [Toolsday Podcast](https://spec.fm/podcasts/toolsday) -在星期二2点播出一个20分钟的播客，其中包含最新的技术工具，技巧和窍门！
...
* [Laravel Portugal Live](https://laravel.pt)  -Laravel葡萄牙成员聚在一起谈论Laravel，PHP，葡萄牙语社区，想法等.  @joselaborges
* [Ubuntu Portugal (podcast)](https://ubuntu-pt.org/)  -Ubuntu葡萄牙社区（Ubuntu-PT）是支持GNU / Linux，Ubuntu发行的葡萄牙社区. 这个社区由一群人组成，他们不仅致力于推广Ubuntu操作系统和一般自由软件的使用，而且还为该GNU / Linux发行版的葡萄牙语用户提供支持.
* [10deploys](https://www.10deploys.com/) -讨论了DevOps背后的起源，趋势，影响和概念，以帮助组织成为高绩效的组织.
* [99Vidas](http://99vidas.com.br/) -怀旧，有趣和对电子游戏的很多见解.
* [Acabou o café](https://www.listennotes.com/podcasts/acabou-o-caf%C3%A9-archcode-3DQw-pYW_dx/) -关于ArchCode系统开发和技术的播客.
* [Amarelo Criativo](https://soundcloud.com/amarelocriativo)  -来自Amarelo Criativo的所有播客. 整个星期有不同的计划，以提供有关创意市场，极客世界和非常黄的情绪的信息.
* [CapyCast](https://soundcloud.com/rdshipit/) -与Resultados Digitais的产品团队一起播客，介绍他们在开发和设计方面的经验.
* [Chama o Suporte](https://open.spotify.com/show/5NR3iBbF3aRUP2gEDRzjGo) -坎皮纳格兰德联邦大学计算机科学课程的监护人小组播客.
* [DatabaseCast](https://imasters.com.br/perfil/databasecast/) -数据库上的第一个巴西播客.
* [DevDrops](https://anchor.fm/devdrops) -您的软件开发播客.
* [DataHackers](https://datahackers.com.br/podcast) -每月播客，可让数据科学专业人士谈论就业市场，职业和新闻.
* [DevNaEstrada](https://devnaestrada.com.br/) -关于Web开发的每周播客，带有幽默感.
* [Elemencast](https://elemencast.github.io) -建议将听众关于前端Universe，NodeJ，函数式编程等各种内容的内容带给听众.
* [Enciclopédia do Teatro Impossível](https://open.spotify.com/show/36EnYAg6C1szSmbryeavXb?si=Htx1pbzGSp61pqyVvxbrRw)  -不可能的剧院百科全书是巴西剧院的平行历史，从它的失败中可以看出. 有报道说部分虚构的部分关于不可能的戏剧作品的现实.
* [FalaDev](https://anchor.fm/faladev) -大部分时间都花在编写代码上，现在是时候聚在一起讨论编程领域了.
...
* [Hipsters ponto Tech](https://hipsters.tech/) -有关启动，编程，UX，小工具和最新技术趋势的Caelum播客.
* [Knowledge Cast](https://open.spotify.com/show/06fPDUqQapNcfIE01IQHhE?si=stsjeebMRQeH3ROpCeEYcw) -K21敏捷播客
* [Lambda3 Podcast](https://www.lambda3.com.br/category/podcast/) -Lambda3播客
* [Lídercast Café Brasil](http://www.portalcafebrasil.com.br/todos/lidercast/) -有关领导力和企业家精神等主题的访谈.
* [Like a Boss](https://www.likeaboss.com.br)  -Like Boss播客是企业家的播客. 成功的初创企业和公司的领导者和创始人与该计划的两位主持人坐下来.
* [Mamilos](https://www.b9.com.br/shows/mamilos/) -坦诚的新闻
* [MovileCast](https://movile.blog/tag/podcast/) -Movile公司生态系统的技术播客.
* [Naruhodo!](https://www.b9.com.br/podcasts/naruhodo/) -播客有一个提案，建议解释几个主题，使用科学，哲学，历史等方法来支持答案.
* [NerdCast](https://jovemnerd.com.br/nerdcast/) -JovemNerd门户的播客，内容涉及书呆子，理论和rpg
* [PHP Do Jeito Certo](http://phpdojeitocerto.tumblr.com/) -面向经验丰富的开发人员和初学者的有关PHP新闻的新闻.
...
* [PODebug](http://www.podebug.com/) -通常以幽默和轻松的方式进行软件和技术开发.
* [PodProgramar](https://podprogramar.com.br/) -Jessi Zanelato和Ana Eliza主持的有关技术开发命令的播客，内容涉及初学者和高级话题.
* [PodTag](https://podtag.com.br/) -由路易斯·贡萨尔维斯（LuizGonçalves）主持的播客命令，涉及从职业到技术人员的各种技术话题，并邀请了几位不同的嘉宾.
* [Quebradev](https://quebradev.com.br/) -外围起源的播客，并注定要起源.
* [Rapadura Cast](https://cinemacomrapadura.com.br/cat/rapaduracast-podcast/) -带有rapadura的电影播客，今天被认为是巴西流行文化的参考.
* [Rede Geek](http://www.redegeek.com.br/podcast/) -播客针对技术，科学，历史和其他方面的极客观众.
* [Reloading](http://reloading.com.br/) -每周播客，其中包含视频游戏世界中最重要的新闻，事件和好奇心.
* [Souforce.cloud](https://souforce.cloud/podcast/) -第一个播客以葡萄牙语为焦点，聚焦于Salesforce世界，在这里我们进行了有关开发，平台管理，Salesforce产品以及诸如Careers等主题的聊天.
* [Start Coding](https://anchor.fm/start-coding)  -开始编码是一项在线计划，目的是让女性参与技术领域. 播客介绍了该地区的计算和性别平等主题.
...
* [Zeno Overflow](https://soundcloud.com/zenorocha) -有关巴西境外技术，职业和生活的一系列现场问答.
* [Zone Of Front-Enders](https://zofe.com.br/) -专注于前端Web开发的播客.  
* [Dragões de Garagem](http://dragoesdegaragem.com/) -科学传播的播客，渴望以一种容易获得和轻松的方式谈论科学，鼓励好奇心和批判性思维.
* [Opencast](https://anchor.fm/opencast) -轻松聊天中的技术，免费软件和创新，其中充斥着关于类Unix世界的参考.
...
* [Basta ya de picar](http://www.bastayadepicar.com/) -播客，讨论各种编程问题和程序员的生活.
* [CAChemE](https://cacheme.org/podcast/) -科学与工程应用程序（主要是Python）.
* [El gato de Turing](https://elgatodeturing.com/) -科技新闻播客.
* [Fallo de sistema](http://www.rtve.es/alacarta/audios/fallo-de-sistema/) -科普，科幻小说和视频游戏的普及计划.
* [Ideas ágiles](https://dosideas.com/podcast/ideasagiles/) -关于软件开发人员生活的讲座，访谈和体验的播客.
* [Nación Lumpen](https://www.nacionlumpen.com/) -类似于“已经足够剁碎”.
* [Python en español](https://podcast.jcea.es/python/) -用您的语言编写的Python
...
* [Bricolabs Podcast](https://archive.org/details/BricolabsPodcast) -Bricolabs协会组织的创客世界，免费软件和硬件，项目，活动和事件.
* [Compilando Podcast](https://compilando.audio) -有关GNU / Linux和自由软件的采访和新闻.
* [Davidochobits podcast](https://www.ochobitshacenunbyte.com/category/miscelaneos/) -免费软件，GNU和Linux.
* [deployando.me](https://deployando.me/) -系统管理员和开发人员的技术播客.
* [Eduardo Collado](https://www.eduardocollado.com/)  -网络管理. 人不仅生活在主机和网络上.
* [GNU/Linux Valencia](https://gnulinuxvalencia.org/category/podcasts) -从首都图里亚（Turia）进入GNU / Linux世界的方法.
* [Home Studio Libre: el Podcast](https://www.ivoox.com/podcast-home-studio-libre-podcast_sq_f1614625_1.html) -在这里，您可以找到西班牙语的有关音频和视频制作以及使用免费工具进行后期制作的信息.
* [La Pingüina Increíblemente Curiosa](https://podcast.voidnull.es/) -有关LPIC的播客，认证内容以及要研究的章节的说明.
* [Maratón Linuxero](https://maratonlinuxero.org) -由播客和GNU / Linux侦听器创建的项目，他们希望通过免费软件应用程序和服务来进行现场活动.
* [Más Allá de la Innovación](https://masalladelainnovacion.com) -OpenExpo技术面试.
* [Mosqueteroweb Tecnología](https://www.ivoox.com/podcast-mosqueteroweb-tecnologia_sq_f1248962_1.html) -对技术，计算机，chromebook，智能手机，平板电脑，软件，操作系统的思考：Linux，Windows等以及应用程序.
* [NeoSiteLinux Podcast](https://www.neositelinux.com/tags/#podcasts) -主要是自由软件，GNU / Linux和技术.
* [NOlegaltech Radio](https://www.ivoox.com/podcast-nolegaltech-radio_sq_f1446265_1.html) -法律世界一点都不酷... 10分钟内即可获得技术和法律服务.
* [Podcast Linux](https://avpodcast.net/podcastlinux) -针对家庭桌面用户的GNU / Linux世界播客.
  * [Linux Express, de Podcast Linux](https://podcastlinux.gitlab.io) -Podcast Linux的更多个人摘要.
* [Podcast oficial KDE España](https://www.ivoox.com/podcast-podcast-kde-espana_sq_f1249423_1.html) -由KDE西班牙文化协会播客.
...
* [HangOps.Ru](https://www.youtube.com/channel/UCr5mwN4AKxiYxysr8PeQdaA/feed) -在YouTube上播客+直播有关DevOps的话题.
* [Podlodka](http://podlodka.io)  -关于软件开发的每周音频节目. 采访软件开发行业和其他相关领域的专业人员.
* [UnderJS Podcast](https://underjs.ru/) -有关JS，React Native，Nodejs的播客.
* [linkmeup](https://linkmeup.ru/) -关于网络，电信和其他IT的播客.
* [RadioDotNet](https://radio.dotnet.ru) -与.NET相关的所有内容的播客：新闻，文章，库，事件.
* [DotNet & More](https://more.dotnet.ru)  -有关.NET开发以及更多内容的播客. 由主办 [Aleksandr Kugushev](https://github.com/kugushev) and [Artem Akulyakov](https://github.com/oxffaa).
...
* [Le comptoir sécu](https://www.comptoirsecu.fr/)  —关于安全性的双向播客，欢迎每个主题的专家. 主持人：贾斯汀·加尼维特（Justin Ganivet），摩根·霍顿尼尔（Morgan Hotonnier），尤恩·皮奥莱特（Youenn Piolet），洛伊斯·萨曼（LoïsSamain）.
* [Les Cast Codeurs](https://lescastcodeurs.com)  —由开发人员提供或为开发人员提供的播客. 总体上有关Java生态系统和开发的最新消息. 由Emmanuel Bernard（JBoss，Hibernate），ArnaudHéritier（CloudBees，Jenkins），Guillaume Laforge（Google，Groovy），Antonio Goncalves（自由职业者，auteur），Vincent Massol（XWiki，Maven），Audrey Neveu（Saagie，Devoxx4Kids）主持.
* [Le podcast AWS en français](https://aws.amazon.com/fr/blogs/france/podcasts/) -用法语谈论AWS的播客.
...
* [Electro Monkeys](https://electro-monkeys.fr/)  -每周一次的法国播客，Electro Monkeys是云原生技术上地球上最另类的播客！ 由StéphaneBeuret主持.

## In German

* [Apfelfunk](https://apfelfunk.com/) -每周播客有关与Apple相关的所有内容的播客.
...
* [Methodisch inkorrekt](http://minkorrekt.de/) -对论文进行幽默的评论4.两个星期几乎都发布了
...
* [Teahour](http://teahour.fm/) -由主持的播客 [Terry Tai](https://github.com/poshboytl), [Dingding Ye](https://github.com/sishen) and [Daniel Lv](https://github.com/lgn21st)，大多数主题与软件开发，启动等有关.

## In Polish

* [DevTalk](https://devtalk.pl/)  -热情的开发人员的技术播客. 与开发相关的所有主题：体系结构，语言，工具，库，会议，社区，职业规划...由Maciej Aniserowicz主持.
* [Just4Fun](https://just4fun.io/)  -由Rafal Warzycha和Piotr Leszczynski主持的双周技术播客. 主要主题是JavaScript和前端.
* [ChwastIT](https://chwast.it//)  -波兰最差的节目播客. 随便，难以忍受甚至可能对软件工程大肆挥霍. 和 [@kwasniew](https://twitter.com/kwasniew), [@kubek2k](https://twitter.com/kubek2k), [@peel](https://twitter.com/peel) 和他们的客人-波兰IT的杂草.

## In Turkish

* [devPod](https://devpod.org/) -土耳其播客，谈论现代软件技术，编程语言，会议，Linux，Unix，iOS，MacOS，Python，Ruby，Git等. [Uğur Özyılmazel(Vigo)](https://github.com/vigo) and [Üstün Özgür](https://github.com/ustun).
...
* [Met Nerds om Tafel](https://www.metnerdsomtafel.nl/)  -每周的播客，书呆子在其中喝Spa Red并谈论技术话题. 有定期的书呆子和定期的书呆子Daniel Kegel，Floris Diemel，Joost Schellevis，Jurian Ubachs和Randal Peelen.
...
* [Null++](https://nullplus.plus)  -由开罗的Facebook开发者圈联合领导人提供支持的埃及阿拉伯播客. 该播客旨在为MENA的软件专业人员提供宝贵的技术支持，并帮助他们进一步发展自己的职业.
...
* [Essam Cafe](https://essamcafe.com/) -每周与人聚会，也许我们同意或不同意，重要的是要从Twitter提名的随机主题中学习和受益于每周的一小部分.
* [Tech Tracks](https://podu.me/shows/show/77/tech-tracks) 埃及阿拉伯播客讨论技术新闻.
* [Khedr W Business](https://castbox.fm/channel/id2453686?country=us) -主题有两个方向：1-管理和企业家精神，以及与投资，运营，市场营销，合伙企业等相关的事物.2-生活，关系，成功和方法，以及我们的生活方式一种确保与自己和解的方式.
* [State of E-commerce](https://podcasts.google.com/feed/aHR0cHM6Ly9mZWVkcy5idXp6c3Byb3V0LmNvbS8xMTA1ODk1LnJzcw?sa=X&ved=2ahUKEwixm-6X7ITsAhUR_hoKHTmpBaMQjs4CKAB6BAgBEBA) -电子商务，企业和市场营销的阿拉伯语播客，可帮助企业所有者衡量，理解和发展其在线销售.

### Tooling

* [Pocket Casts](https://www.pocketcasts.com/)
* [Overcast](https://overcast.fm) -适用于iOS和网络的优雅播客跟踪器
* [AntennaPod](http://antennapod.org) -（Android和开放源代码）
* [Soundwaves](https://github.com/bottiger/SoundWaves) -（Android和开放源代码）
...
* [Podcast Addict](https://podcastaddict.com/app) -Android播客播放器
