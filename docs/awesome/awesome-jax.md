...
- [MLP Mixer (Flax)](https://github.com/SauravMaheshkar/MLP-Mixer) - 最小的实现 [MlP Mixer](https://arxiv.org/abs/2105.01601)
- [gMLP](https://github.com/SauravMaheshkar/gMLP) - 实施 [Pay Attention to MLPs](https://arxiv.org/abs/2105.08050).
