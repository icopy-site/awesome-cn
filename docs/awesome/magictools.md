...
- ：自由的： [420 Pixel Art Icons for RPGs](http://7soul1.deviantart.com/art/420-Pixel-Art-Icons-for-RPG-129892453) - 一套 420 个 RPG 图标，可免费用于商业用途.
...
- ：自由的： [OpenGameArt](http://opengameart.org/) - 旨在与免费软件游戏项目一起使用的媒体存储库.
...
- ：自由的： [Poly Pizza](https://poly.pizza) - 6000 多个免费低多边形模型
...
- ：自由的： [TextureHaven](https://texturehaven.com/)  - 免费纹理和附加贴图，如置换贴图和凹凸贴图. 还有 HDRI.
...
- ：自由的： [Live Normal](https://tenebrislab.github.io/livenormal/)  - 一款用于随时随地生成无缝材料的 Android 和 iOS 应用程序. 您拍摄一张照片，Live Normal 创建可平铺的纹理并生成纹理贴图，为您选择的 PBR 引擎做好准备.
...
- ：自由的： [Multipaint](http://multipaint.kameli.net) - 跨平台（Win、Linux、Mac）图像编辑器/画家，涵盖 8 位机器（如 C64、ZX Spectrum 等）的颜色限制
...
- ：自由的： [project one](http://p1.untergrund.net)  - 适用于 Commodore 64 的图片转换器和编辑器，涵盖本计算机的不同图形模式. 仅限 Windows
...
- ：自由的： [Timanthes](http://csdb.dk/release/?id=75871) - 用于在 Windows 上运行的 Commodore 64 计算机的像素艺术编辑器
- [Charas](http://charas-project.net/index.php) - Charas 是 RPG Maker 的字符集生成器.
- ：自由的： [Spritemate](http://www.spritemate.com) - Commodore 64 精灵的在线编辑器
...
- ：自由的： [Lumberyard](https://aws.amazon.com/lumberyard/) - Amazon Lumberyard 是一个深度集成的免费 AAA 游戏引擎
...
- ：自由的： [Mini Micro](https://miniscript.org/MiniMicro/) - Mini Micro 是一款梦幻电脑，用于制作、播放和分享以现代语言编写的 2D 游戏和程序 [MiniScript](https://miniscript.org) 语言.
...
- ：自由的： [Octave](http://raisedbeaches.com/octave/index.html) - 免费的用户界面声音库.
- ：自由的： [PacDV](http://www.pacdv.com/sounds/index.html) - 免版税的声音集合.
...
- ：自由的： [Audiosauna](http://www.audiosauna.com/) - 将您的网络浏览器转变为具有内置合成器和现场效果器的快速灵活的音乐制作工作室.
- ：自由的： [Audiotool](http://www.audiotool.com/app) - 在线音乐制作人.
- ：自由的： [Bfxr](https://www.bfxr.net/) - 为电脑游戏制作音效的工具.
- ：自由的： [Bosca Ceoil](http://boscaceoil.net/)  - 由 Terry Cavanagh 制作的在线（以及桌面）音乐制作人. 简单、直观，具有独特的复古风格.
...
- ：自由的： [SunVox](http://www.warmplace.ru/soft/sunvox/) - 一款小巧、快速且功能强大的模块化合成器，带有基于模式的音序器（跟踪器）.
