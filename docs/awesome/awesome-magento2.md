...
## Tools
- [n98-magerun2](http://magerun.net/) - 用于Magento 2的CLI Swiss Army Knife.
- [Documentation Search for Alfred](https://github.com/DavidLambauer/Alfred-Workflow-Magento-2-DevDocs-Search) - 轻松将官方Magento 2搜索集成到您的Alfred工作流程中.
- [Tablerates Generator](https://elgentos.nl/tablerates/) - 使用在线工具生成表格.
...
- [Magento 2 Docker](https://hub.docker.com/r/rafaelcgstz/magento2/) - 专注于开发过程，在Mac和Linux上相当快.
...
- [Whoops Exceptions](https://github.com/yireo/Yireo_Whoops) -  Magento 2中酷孩子的PHP例外.
- [Magento Cache Clean](https://github.com/mage2tv/magento-cache-clean) - 更换bin / magento缓存的速度更快：使用Vinai Kopp的文件观察器清理]（https://twitter.com/vinaikopp）
...
- [Magento 2 Dockerize](https://github.com/arvatoSCM/dockerize-magento2) - 用于停泊Magento 2的作曲家包.
- [Mage2 Vagrant](https://github.com/rgranadino/mage2_vagrant) - 简单的Magento 2 Vagrant Box.
- [frontools](https://github.com/SnowdogApps/magento2-frontools) - 基于Gulp.js的Magento 2前端工具集.
- [Scopehints](https://github.com/avstudnitz/AvS_ScopeHint2) - 在“商店配置”中显示其他信息 [Andreas von Studnitz](https://commercehero.io/avstudnitz).
- [PreferencesInfoCommand](https://github.com/dmanners/DavidAndVinai_PreferencesInfoCommand) -  bin / magento命令显示类或接口的已配置首选项
- [m2install](https://github.com/yvoronoy/m2install) -  Magento 2 Bash安装/恢复脚本
- [Magento 2 Configurator](https://github.com/ctidigital/magento2-configurator) - 最初由CTI Digital创建的Magento模块，用于使用文件创建和维护数据库变量.
...
- [MUP](https://github.com/npoole81/MUP)   - 从简单配置文件生成的bash菜单UI.  专为Magento 2而设，但不限于此.
...
- [Magento 2 Deployment Tool](https://github.com/staempfli/magento2-deployment-tool) - 具有PHing的Magento2部署工具 [Juan Alonso](https://commercehero.io/juan.alonso).
...
- [Magento 2 Deployer Plus](https://github.com/jalogut/magento2-deployer-plus) - 基于deployer.org的工具，可以实现Magento 2项目的零停机部署.
...
- [de_CH](https://github.com/staempfli/magento2-language-de-ch)  - 瑞士语套餐.
- [fr_FR](https://github.com/Imaginaerum/magento2-language-fr-fr) ：fr： - 法语语言包.
- [da_DK](https://magentodanmark.dk/)  - 丹麦语言套餐.
...
- [pt_BR](https://github.com/rafaelstz/traducao_magento2_pt_br)  - 葡萄牙巴西语言套餐.
- [it_IT](https://github.com/mageplaza/magento-2-italian-language-pack) ：它： - 意大利语.
- [nl_NL](https://github.com/ho-nl/magento2-nl_NL) [alt.](https://bitbucket.org/creaminternet/language-nl_nl.git)  - 荷兰语语言包.
...
- [ro_RO](https://github.com/EaDesgin/magento2-romanian-language-pack)  - 罗马尼亚语言套餐.
- [fi_FL](https://github.com/mageplaza/magento-2-finnish-language-pack)  - 芬兰语语言包.
- [ko_KR](https://github.com/mageplaza/magento-2-korean-language-pack)  - 韩语套餐.
- [sk_SK](https://github.com/mageplaza/magento-2-slovak-language-pack)  - 斯洛伐克语言套餐.
- [sl_SI](https://github.com/symfony-si/magento2-sl-si)  - 斯洛文尼亚语言套餐.
- [en_GB](https://github.com/cubewebsites/magento2-language-en-gb) ：gb： - 英国语言套餐.

### Catalog & Checkout

- [Donation Product Module](https://github.com/experius/Magento-2-Module-Experius-DonationProduct) - 整合捐赠给慈善机构.
- [Clean Checkout](https://github.com/danslo/CleanCheckout) -  Magento 2 Checkout替代品的下降.
...
- [FastSimpleImport2](https://github.com/firegento/FireGento_FastSimpleImport2) - 用于Magento 2 ImportExport功能的包装器，用于从阵列导入产品和客户.

### CMS

- [Mageplaza Blog Extension](https://github.com/mageplaza/magento-2-blog-extension) - 简单，但工作良好的博客扩展.
- [Magento 2 Blog Extension by Magefan](https://github.com/magefan/module-blog) -  Magento 2的免费博客模块，无限的博客文章和类别，SEO友好，懒惰负载和AMP支持.
...
- [MagePlaza Seo](https://github.com/mageplaza/magento-2-seo-extension) - 记录良好的多用途SEO扩展.
- [Magemonkey Mailchimp Integration](https://github.com/ebizmarts/magento2-magemonkey) - 即插即用Mailchimp集成.
- [Magento 2 PDF](https://github.com/staempfli/magento2-module-pdf) - 基于PDF的PDF生成器 [wkhtmltopdf](http://wkhtmltopdf.org/).
- [Magento 2 SEO](https://github.com/staempfli/magento2-module-seo) -  Staempfli的Sweet＆Simple SEO模块.
- [Google Tag Manager](https://github.com/magepal/magento2-google-tag-manager) - 带有Magento2数据层的Google跟踪代码管理器（GTM）.

### Adminhtml / Backend

- [Customer Force Login](https://github.com/bitExpert/magento2-force-login) - 出于支持原因以客户身份登录.
- [Checkout Tester](https://github.com/yireo/Yireo_CheckoutTester2) - 扩展以快速测试Checkout更改.
...
- [FireGento Fast Simple Import](https://github.com/firegento/FireGento_FastSimpleImport2) - 用于Magento 2 ImportExport功能的包装器，用于从阵列导入产品和客户
- [Magento 2 Import Framework](https://github.com/techdivision/import) - 支持通用Magento 2导入功能的库
- [Image Resizer](https://github.com/staempfli/magento2-module-image-resizer) -  Magento 2模块，可在所有块和.phtml模板中添加简单的图像大小调整功能 [Staempfli](https://commercehero.io/staempfli).
- [Excel Spreadsheet](https://github.com/staempfli/magento2-module-spreadsheet) -  Magento 2模块，用于从Excel解析xlsx，xlsm和csv文件 [Staempfli](https://commercehero.io/staempfli).
...
- [Secure Password Hashing](https://bitbucket.org/creaminternet/module-securepasswords) - 改进Magento 2的密码哈希.
- [2FA](https://github.com/magespecialist/m2-MSP_TwoFactorAuth) -  Magento 2的双因素身份验证.
- [Maleware Scanner](https://github.com/gwillem/magento-malware-scanner) - 用于检测Magento恶意软件的规则和示例集合.
...
- [Magento React Native](https://github.com/troublediehard/magento-react-native) - 针对Magento 2的React Native移动应用程序模板.
...
- [Magicento](http://magicento.com/) - [PHPStorm](https://www.jetbrains.com/phpstorm/) 添加Magento 2相关功能的插件.
- [Kraken.io](https://github.com/kraken-io/kraken-magento) - 作为SaaS集成的高质量图像缩减服务.
...
- [The Magento 2 Beginner Tutorial Class](https://www.youtube.com/playlist?list=PLtaXuX0nEZk9eL59JGE3ny-_GAU-z5X5D&utm_content=buffer797bf&utm_medium=social&utm_source=twitter.com&utm_campaign=buffer) - 免费的YouTube系列学习Magento 2.
- [Vinai Kopp Mage2Katas](https://www.youtube.com/channel/UCRFDWo7jTlrpEsJxzc7WyPw)
- [Mage2.tv](https://www.mage2.tv) -  Vinai Kopp的Magento 2开发者截屏视频

---

### Platforms

- [Commercehero.io](https://commercehero.io/) - 找到一个优秀的Magento开发人员变得更加容易.
...
- [Magento Forum](https://community.magento.com/) -  Magento的社区论坛.
- [Magento Github Repository](https://github.com/magento/magento2) -  Github存储库.
- [Magento PHP CS Fixer](https://github.com/magento/marketplace-eqp) - 针对Magento 2的CS Fixer.
...
- [Mageres](https://github.com/aleron75/mageres) -  Alessandro Ronchi的Magento 1和Magento 2的资源清单.
- [Awesome PHP](https://github.com/ziadoz/awesome-php) - 精选的PHP资源列表.
- [Awesome Magento](https://github.com/sunel/awesome-magento) - 一个混合M1和M2内容的令人敬畏的Magento列表 [sunel](https://github.com/sunel).
- [Headless Magento 2](https://github.com/sitewards/headless-magento2-resources) - 关于运行Magento 2无头的资源列表 [Sitewards](https://commercehero.io/sitewards)
...
在法律允许的范围内，David Lambauer已放弃对此作品的所有版权及相关或相邻权利.
...
Thanks [MageTitans](http://www.magetitans.co.uk/) 在YouTube上分享会谈.
