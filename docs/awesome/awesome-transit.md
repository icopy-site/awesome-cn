...
- [Transport Operator Mobility-as-a-service Provider (TOMP)-API](https://github.com/TOMP-WG/TOMP-API) -荷兰的工作组，旨在开发一个API，供运输运营商和移动即服务提供商使用，以进行运营商发现，行程计划，最终用户交互，预订和付款.
