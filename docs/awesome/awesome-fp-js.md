...
* [Ramda](https://github.com/ramda/ramda)  – JavaScript的实用功能库，专门为功能编程风格设计.  一种易于创建功能管道且从不更改用户数据的样式.  + TS.
...
* [bluebird-promisell](https://github.com/zhangchiqing/bluebird-promisell) -实用的函数式编程库，可实现承诺.
* [prelude.ls](http://gkz.github.io/prelude-ls/)  –面向功能的实用程序库，该程序库基于Haskell的Prelude模块.  -TS.
...
* [fun-task](https://github.com/rpominov/fun-task)  –用于管理JS中的异步代码的抽象.  任务与Promise相似，主要区别在于Tasks可以代表计算，而Promises只能代表计算结果.  附带流类型定义.
...
* [Tifi](https://github.com/mobily/tifi)  -Tifi是用于TypeScript中的函数式编程的库.  它解决了同时存在“未定义”和“空”的问题.  Tifi的灵感来自OCaml / Reason实用程序的选项数据类型.  + CT，+ TS.
...
* [scriptum](https://github.com/kongware/scriptum/blob/master/README.md) -简洁的功能性编程库和基于该库的在线课程
...
* [A Monad in Practicality: First-Class Failures](http://robotlolita.me/2013/12/08/a-monad-in-practicality-first-class-failures.html) –遍历JavaScript中特定单子结构的一些实际用例：使用Maybe单子来处理简单的故障案例，并通过“ Either”单子或“ Validation”应用函子对更复杂的场景建模.
...
* [You don't (may not) need loops ➿](https://github.com/you-dont-need/You-Dont-Need-Loops) -循环是初级程序员学习的第一种构造，但是循环会在软件开发过程中造成许多潜在的问题，在许多情况下可以避免.
