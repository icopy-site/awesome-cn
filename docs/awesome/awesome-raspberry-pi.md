...
- [Sonus](https://github.com/evancohen/sonus) - 使用可自定义的离线热词检测功能为您的Pi（以及其他所有内容）设置Node.js语音控制.
...
- [Waves](https://github.com/euniceylee/waves) - 通过麦克风，波形和热敏打印机将语音词的短暂性转换为具体和物理的东西.
