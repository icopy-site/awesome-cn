...
* [mahaul](https://github.com/emadalam/mahaul)  - 在 Elixir 中增强您的环境变量. 使用编译时访问保证、默认值、回退和应用程序预启动验证进行解析和验证.
...
* [rediscl](https://github.com/akdilsiz/elixir-rediscl) - 带有连接池和管道查询生成器的最小 redis 客户端.
