...
* [tradehub](https://github.com/anhmv/tradehub-elixir) -用于Tradehub区块链的Elixir客户端库.
...
* [uef-lib](https://github.com/DOBRO/uef-lib)  -有用的Erlang函数库，提供用于处理列表，二进制文件，地图，数字，日期和时间的模块. 它包含一些针对特定情况下的性能进行优化的功能（例如，针对文件I / O操作或二进制转换）.
