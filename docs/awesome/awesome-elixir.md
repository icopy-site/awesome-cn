...
* [zipper_tree](https://github.com/Dkendal/zipper_tree) -带有长生不老药的拉链的可变轴心树.
...
* [Startup Job](https://github.com/tsurupin/job_search) -一个伞式项目，用于搜索从用Elixir / Phoenix和React / Redux编写的网站中抓取的启动工作.
...
* [guardian_db](https://github.com/ueberauth/guardian_db)  -Guardian的扩展，可跟踪应用程序数据库中的令牌以防止播放.  （[Docs](https://hexdocs.pm/guardian_db/readme.html)).
* [guardian_redis](https://github.com/alexfilatov/guardian_redis)  -Guardian DB的Redis存储库.  （[Docs](https://hexdocs.pm/guardian_redis/readme.html)).
...
* [sass_elixir](https://github.com/zamith/sass_elixir) -用于Elixir项目的sass插件.
...
* [scribe](https://github.com/codedge-llc/scribe)  -Elixir结构和贴图的漂亮表格. 受hirb启发.
...
* [calendarific](https://github.com/Bounceapp/elixir-calendarific) -Calendarific是节日API Calendarific的包装.
...
* [gatling](https://github.com/hashrocket/gatling) -收集混合任务以自动从git创建一个exrm版本，并在您的服务器上启动/升级它.
...
* [ex_doc](https://github.com/elixir-lang/ex_doc) -ExDoc是用于为Elixir项目生成文档的工具.
...
* [crudex](https://github.com/bitgamma/crudex) -适用于Phoenix和Ecto的CRUD实用程序.
...
* [http_router](https://github.com/sugar-framework/elixir-http-router) -具有各种宏的HTTP路由器，可帮助您开发应用程序和组织代码.
...
* [phoenix_linguist](https://github.com/jxs/phoenix_linguist)  -该项目将Phoenix与Linguist集成在一起，提供了即插即用的帮助程序. 它看起来像被遗弃了：它的最后一次提交是在2015年，其CI运行Elixir 1.0.3.
...
* [phx_component_helpers](https://github.com/cblavier/phx_component_helpers) -可扩展的live_components，无需样板.
...
* [bunyan](https://github.com/bunyan-logger/bunyan) -Bunyan：Elixir伐木机.
...
* [youtrack_logger_backend](https://github.com/unifysell/youtrack_logger_backend) -一个记录器后端，它将消息发布到 [YouTrack](https://www.jetbrains.com/youtrack/) （由JetBrains制造的问题跟踪器）.
...
* [eventsourced](https://github.com/slashdotdash/eventsourced) -建立功能性的，基于事件的领域模型.
...
* [Apex](https://github.com/bjro/apex) -超凡脱俗的长生不老药.
...
* [erlang_term](https://github.com/okeuday/erlang_term) -提供Erlang术语在内存中的大小，而忽略它们的存储位置.
...
* [ex_rated](https://github.com/grempe/ex_rated) -简单灵活的API或其他内容的速率限制.
...
* [Jisho-Elixir](https://github.com/nbw/jisho_elixir)  -日语在线词典Jisho.org的API包装器. 允许用户按单词，符号和/或标签（请参阅文档）进行搜索.
...
* [vessel](https://github.com/whitfin/vessel) -Elixir MapReduce与Hadoop Streaming集成接口.
...
* [sshkit](https://github.com/bitcrowd/sshkit.ex) -在Erlang的SSH应用程序之上构建的Elixir工具箱，用于在一个或多个服务器上执行任务.
...
* [amnesia](https://github.com/meh/amnesia) -lix药的Mnesia包装纸.
...
* [defql](https://github.com/fazibear/defql) -以SQL为主体创建长生不老药功能.
...
* [ecto_rut](https://github.com/sheharyarn/ecto_rut) -简单而强大的Ecto快捷方式可简化并加快开发速度.
...
* [ecto_validation_case](https://github.com/danielberkompas/ecto_validation_case)  -简化您的Ecto模型验证测试. 受到斗牛匹配者的启发而宽松，但更简单.
* [ectophile](https://github.com/gjaldon/ectophile) -Ecto扩展可立即支持模型中的文件上传.
* [elastic](https://github.com/radar/elastic) -通过HTTPotion的瘦手，可帮助您与Elastic Search进行对话.
...
* [github_ecto](https://github.com/wojtekmach/github_ecto) -适用于GitHub API的Ecto适配器.
...
* [mongodb_driver](https://github.com/zookzook/elixir-mongodb-driver) -MongoDB的替代驱动程序，支持MongoDB的最新版本和全面的功能列表.
...
* [msgpax](https://github.com/lexmag/msgpax) -Elixir的MessagePack（反）序列化器实现.
...
* [dbus](https://github.com/aforward/sadbus) -一个哑消息总线，用于在使用Redis解耦的微服务之间共享数据.
...
* [kaffe](https://github.com/spreedly/kaffe) -Elixir的Kafka客户端库.
...
* [opq](https://github.com/fredwu/opq) -一个简单的内存队列，在Elixir中具有工作人员池和速率限制.
...
* [mix_docker](https://github.com/Recruitee/mix_docker) -将您的Elixir应用程序生产版本放入最小的Docker映像中.
* [relex](https://github.com/yrashk/relex) - Erlang/Elixir Release Assembler.
* [renew](https://github.com/Nebo15/renew) -混合任务以创建内置于Docker容器中的混合项目.
...
* [code_signing](https://github.com/benknowles/code_signing) -使用Ed25519签名对BEAM文件进行签名和验证.
* [Ockam](https://github.com/ockam-network/ockam) -一套工具，编程库和基础架构，可轻松构建与云服务和其他设备进行安全，私密和可信任的通信的设备. [Docs](https://www.ockam.io/learn/concepts/) .
...
* [blogit](https://github.com/meddle0x53/blogit) -OTP应用程序，用于从包含markdown文件的git存储库中生成博客.
...
* [double](https://github.com/sonerdy/double) -创建存根依赖关系以进行测试，而无需覆盖全局模块.
...
* [ignorant](https://github.com/campezzi/ignorant) -部分“地图”比较，可确保在不考虑字段值的情况下显示字段.
...
* [markdown_test](https://github.com/MainShayne233/markdown_test) -一个库，可让您测试Markdown文件中的Elixir代码.
* [meck](https://github.com/eproxus/meck) -用于Erlang的模拟库.
...
* [caustic](https://github.com/agro1986/caustic)  -用于比特币，以太坊和其他区块链的Elixir加密货币库包括密码学，数论（素数，全等）和用于探索性数学的通用数学库.
...
* [haikunator](https://github.com/knrz/Haikunator) -生成类似Heroku的令人难忘的随机名称，以在您的应用程序或其他任何地方使用.
...
* [RandomStringGenerator](https://github.com/caioceccon/random_string_generator) -用于根据给定的字符串模式生成随机字符串的模块.
...
* [bitpay](https://github.com/bitpay/elixir-client) -Elixir核心库，用于连接到bitpay.com.
...
* [currently](https://github.com/chatgris/currently) -一种显示Trello中当前分配的卡的工具.
...
* [mixpanel_data_client](https://github.com/jeregrine/mixpanel_data_client) -用于与Mixpanel数据导出API进行交互的客户端.
...
* [semver](https://github.com/lee-dohm/semver) -用于处理与semver.org兼容的版本字符串的实用程序.
...
* [sparkpost](https://github.com/SparkPost/elixir-sparkpost) -一个Elixir库，用于使用SparkPost发送电子邮件.
...
* [telegex](https://github.com/Hentioe/telegex) -Elixir的电报bot库.
...
* [exkanji](https://github.com/ikeikeikeike/exkanji)  -一个Elixir库，可在平假名，片假名，罗马字和汉字之间进行翻译. 它使用Mecab.
...
* [linguist](https://github.com/change/linguist) -Elixir国际化库.
...
* [trans](https://github.com/belaustegui/trans) -一个Elixir库，用于利用PostgreSQL JSONB数据类型将嵌入的翻译管理到模型中.
...
* [fitex](https://github.com/timdeputter/FitEx) -FitEx是一个宏模块，为函数定义提供了一些帮助.
* [global](https://github.com/mgwidmann/global) -Erlang`：global`模块的包装.
* [mandrake](https://github.com/mbasso/mandrake) -Mandrake是一个函数式编程库，在长生不老药中带来了其他神奇的东西.
...
* [uef-lib](https://github.com/DOBRO/uef-lib)  -有用的Erlang函数库，提供用于处理列表，二进制文件，地图，数字，日期和时间的模块. 它包含一些针对特定情况下的性能进行了优化的功能（例如，针对文件I / O操作或二进制转换）.
...
* [exop](https://github.com/madeinussr/exop) -一个库，它可以封装业务逻辑并使用预定义的合同来验证参数.
...
* [skooma](https://github.com/bcoop713/skooma) -简单的数据验证库，用于描述和验证数据结构.
...
* [Adopting Elixir](https://pragprog.com/book/tvmelixir/adopting-elixir)  -根据建立Elixir并成功成功使用Elixir的人们的现实生活策略，将Elixir引入您的公司. 本书提供了将应用程序从概念应用到生产所需的所有信息（2017年）.
* [Craft GraphQL APIs in Elixir with Absinthe](https://pragprog.com/book/wwgraphql/craft-graphql-apis-in-elixir-with-absinthe) -将您的Web API升级到GraphQL，利用其灵活的查询来赋予您的用户权力，并利用其声明性结构来简化您的代码（2017）.
* [Create a cryptocurrency trading bot in Elixir](https://www.elixircryptobot.com)  -寻找现实世界中的Elixir / OTP项目来获得动手经验吗？ 本书将带您探索在Elixir中创建加密货币交易机器人的过程. 您将能够直接了解如何设计和开发复杂的系统，以及我们如何将它们共同构建！  （2021年）.
* [Elixir Cookbook](https://www.packtpub.com/application-development/elixir-cookbook) -本书是按保罗·佩雷拉（Paulo A Pereira）（2015）的主题分组的一组食谱.
...
* [Phoenix for Rails Developers](http://www.phoenixforrailsdevelopers.com)  -本书展示了Rails开发人员如何从他们现有的知识中受益，以学习Phoenix. 艾尔维奥·维科萨（Elvio Vicosa）（2017）.
...
* [Phoenix Inside Out](https://shankardevy.com/phoenix-book/)  -本系列的目标是使您成为有信心的Phoenix开发人员. 共有3个不同版本，可满足进入Phoenix的开发人员的各种需求.
...
* [The Little Elixir & OTP Guidebook](https://www.manning.com/books/the-little-elixir-and-otp-guidebook) -由Benjamin Tan Wei Hao（2014）通过中小型项目学习Elixir和OTP的书.
...
* [Elixir Forum](https://elixirforum.com/) -社区经营的讨论会，讨论Elixir的所有问题.
...
* [Alchemist](https://github.com/tonini/alchemist.el) -将Elixir工具集成到Emacs中.
* [Alchemist-Server](https://github.com/tonini/alchemist-server) -独立于IDE的Editor / IDE后台服务器，以通知有关Elixir混合项目的信息.
...
## Other Awesome Lists
*其他令人惊讶的超赞列表可以在以下位置找到 [jnv/lists](https://github.com/jnv/lists#lists-of-lists) 或者 [bayandin/awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness#awesome-awesomeness).*
...
* [Alchemist Camp](https://alchemist.camp) -Alchemist.Camp有许多小时的免费的基于项目的Elixir学习截屏视频.
...
* [Elixir Sips](http://elixirsips.com/) -用于学习Elixir的小屏幕视频.
* [ElixirCasts.io](https://elixircasts.io/) -简单的截屏视频可帮助您学习Elixir和Phoenix.
* [ExCasts](https://excasts.com) -针对所有技能水平的圣灵和凤凰卫视截屏.
* [Frathon's YouTube Channel](https://www.youtube.com/c/Frathon) -专门用于推广功能编程的YouTube频道，在Elixir中发布“现实世界”编程视频，例如“在Elixir中创建加密货币交易机器人”系列.
...
* [Elixir Flashcards](https://elixircards.co.uk/)  -抽认卡是提高您的知识水平的有力方法.  Elixircards是手工制作的，专业印刷的抽认卡，用于升级Elixir.
* [Elixir Fountain](https://soundcloud.com/elixirfountain) -每周播客，直播由Elixir社区周围的新闻和访谈，由以下机构主持 [Johnny Winn](https://twitter.com/johnny_rugger).
* [Elixir Github Repository](https://github.com/elixir-lang/elixir) -项目存储库.
* [Elixir Github Wiki](https://github.com/elixir-lang/elixir/wiki) -该项目的Wiki，其中包含许多有用的信息.
...
* [Hashrocket Today I Learned - Elixir](https://til.hashrocket.com/elixir) -来自Hashrocket团队的有关Elixir的小帖子.
