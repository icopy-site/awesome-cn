...
* [combination](https://github.com/seantanly/elixir-combination) -Elixir库，可从Enumerable集合生成组合和排列.
...
* [monad](https://github.com/rmies/monad) -Haskell以Elixir时尚的语法启发了单子.
...
* [Exon](https://github.com/tchoutri/Exon)  -用Elixir开发的“消息管理器”，提供了一个简单的API来管理和记录您的内容.  （[Docs](https://hexdocs.pm/exon/readme.html)).
...
* [Stabby Flies](https://meaty-spiffy-hermitcrab.gigalixirapp.com) -用Elixir，Phoenix和Pixi构建的多人格斗游戏.
...
* [erlaudio](https://github.com/asonge/erlaudio) -Erlang端口音频绑定.
...
* [shield](https://github.com/mustafaturan/shield) -Phoenix框架的OAuth 2.0提供程序库和实现.
...
* [ueberauth_facebook](https://github.com/ueberauth/ueberauth_Facebook) -用于Überauth的Facebook OAuth2策略.
...
* [Exscript](https://github.com/liveforeverx/exscript) -Elixir脚本库.
...
* [rebar3_protobuffs](https://github.com/benoitc/rebar3_protobuffs) -使用来自Basho的probbuff的rebar3 probbuffs提供程序.
...
* [libcluster](https://github.com/bitwalker/libcluster) -Elixir应用程序的自动簇形成/修复.[Docs](https://hexdocs.pm/libcluster/readme.html)).
...
* [weave](https://github.com/GT8Online/weave) -与Kubernetes和Docker Swarm一起使用的JIT配置加载器.
...
* [ntru_elixir](https://github.com/alisinabh/ntru_elixir)  -libntru的长生不老药包装.  后量子密码系统.
...
* [filtrex](https://github.com/rcdilorenzo/filtrex) -一个用于执行和验证来自客户端的类似SQL的复杂过滤器（例如，智能过滤器）的库.
* [good_times](https://github.com/DevL/good_times) -富有表现力且易于使用的日期时间功能.
* [jalaali](https://github.com/jalaali/elixir-jalaali) -用于Jalaali日历实现的Elixir.
...
* [timelier](https://github.com/ausimian/timelier) -Elixir的cron式调度程序.
...
* [rexbug](https://github.com/nietaki/rexbug) -Elixir包装器，用于`redbug`易于生产的Erlang跟踪调试器.
* [visualixir](https://github.com/koudelka/visualixir) -远程BEAM节点的过程可视化器.

## Deployment
*在其他计算机上自动安装和运行代码.*

* [akd](https://github.com/annkissam/akd) -Capistrano一样，可配置，并且易于设置Elixir部署自动化框架.
...
* [exreleasy](https://github.com/miros/exreleasy) -用于发布Elixir应用程序的简单易用且易于混合的工具.
...
* [phoenix_gon](https://github.com/khusnetdinov/phoenix_gon) -允许您将Phoenix环境或控制器变量毫无问题地传递给JavaScript.
...
* [swoosh](https://github.com/swoosh/swoosh) -使用SMTP，Sendgrid，Mandrill，Mailgun，Postmark和Phoenix适配器与邮箱预览，在Elixir中轻松撰写，传递和测试您的电子邮件.
...
* [event_bus](https://github.com/mustafaturan/event_bus) -简单的事件总线实现，带有主题过滤功能以及内置的事件存储和事件观察器.
...
* [elixir_koans](https://github.com/elixirkoans/elixir-koans) - [Elixir koans](http://elixirkoans.io/) 是一种使用Elixir编程语言轻松有趣的方法.
...
* [feedx](https://github.com/erneestoc/feedx)  -向当前应用程序添加社交Feed功能.  举例说明OTP伞式应用程序，其中包含3个应用程序.  瘦凤凰控制器.
...
* [lolcat](https://github.com/restartr/ex-lolcat)  -这是busyloop / lolcat的副本.  但它不支持动画和原始功能.
...
* [portal](https://github.com/josevalim/portal) -用于Elixir中分布式门户数据传输应用的射击容错门.
...
* [rubix](https://github.com/YellowApple/Rubix) -用于Elixir的非常简单（且几乎不起作用）的Ruby运行程序.
...
* [atomex](https://github.com/Betree/atomex) -ATOM提要构建器，重点关注标准合规性，安全性和可扩展性.
...
* [arc](https://github.com/stavro/arc) -灵活的Elixir文件上传和附件库.
...
* [phoenix_linguist](https://github.com/jxs/phoenix_linguist) -一个将Phoenix与Linguist集成在一起的项目，提供了即插即用的帮助程序.
...
* [phoenix_pubsub_postgres](https://github.com/opendrops/phoenix-pubsub-postgres) -Phoenix应用程序的Postpubsql PubSub适配器.
...
* [scrivener_html](https://github.com/mgwidmann/scrivener_html) -与Scrivener的页面结构配合使用的帮助程序，可以轻松为各种CSS框架构建HTML输出.
...
* [weebo](https://github.com/stevenschobert/weebo) -Elixir的XML-RPC解析器/格式器，完全支持数据类型映射.
...
* [phoenix](https://github.com/phoenixframework/phoenix) -具有实时功能的Elixir Web Framework，其目标是功能齐全的容错应用程序.
...
* [segseg](https://github.com/pkinney/segseg_ex) -段-段相交分类器和计算器.
...
* [mochiweb](https://github.com/mochi/mochiweb) -MochiWeb是用于构建轻量级HTTP服务器的Erlang库.
...
* [spell](https://github.com/MyMedsAndMe/spell) - Spell is a [Web Application Messaging Protocol](http://wamp-proto.org/) （WAMP）Elixir中的客户端实现.
...
* [appsignal-elixir](https://github.com/appsignal/appsignal-elixir/) -从Elixir应用程序中收集错误和性能数据并将其发送到 [AppSignal](https://appsignal.com/).
...
* [prometheus-plugs](https://github.com/deadtrickster/prometheus-plugs) -为prometheus.ex插入仪器/出口商.
* [prometheus.ex](https://github.com/deadtrickster/prometheus.ex) -灵丹妙药 [Prometheus.io](https://prometheus.io) 监视系统和时间序列数据库客户端.
* [prometheus_process_collector](https://github.com/deadtrickster/prometheus_process_collector) -Prometheus收集器，可导出过程度量的当前状态，包括CPU，内存，文件描述符使用情况和本机线程计数以及过程启动和启动时间.
...
* [world_json](https://github.com/camshaft/world_json_ex) -tolixjson lix剂/ erlang的国家和州/省的集合.
...
* [lager_logger](https://github.com/PSPDFKit-labs/lager_logger) -更大的后端，可将所有日志消息转发到Elixir的Logger.
...
* [slack_logger_backend](https://github.com/craigp/slack_logger_backend) -记录器后端，用于将错误发布到Slack.
...
* [youtrack_logger_backend](https://github.com/unifysell/youtrack_logger_backend) -一个记录器后端，它将消息发布到 [YouTrack](https://www.jetbrains.com/youtrack/) （JetBrains制造的问题跟踪器）.
...
* [crudry](https://github.com/gabrielpra1/crudry) -Crudry是Elixir库，用于Phoenix Context和Absinthe Resolvers的CRYING CRUD.
...
* [named_args](https://github.com/mgwidmann/named_args) -在Elixir中允许命名的arg样式参数.
...
* [pipe_to](https://github.com/taiansu/pipe_to) -可以指定目标位置的增强型管道操作器.
* [pipes](https://github.com/batate/elixir-pipes) -使用Elixir Pipe运算符可以更灵活地进行宏编写.
* [pit](https://github.com/vic/pit) -当值在管道内流动时对其进行转换.
* [rebind](https://github.com/camshaft/rebind) -为Erlang重新绑定解析转换.
* [rulex](https://github.com/awetzel/rulex) -使用Elixir模式匹配的简单规则处理程序.
* [shorter_maps](https://github.com/meyercm/shorter_maps)  -〜M sigil为地图速记.  〜M {id name}〜&gt;％{id：id，name：name}.
...
* [Countries](https://github.com/SebastianSzturo/countries) -国家/地区是ISO 3166标准中每个国家/地区收集的各种有用信息的集合.
...
* [exsync](https://github.com/falood/exsync) -另一个Elixir重新加载器.
...
* [porcelain](https://github.com/alco/porcelain) -瓷器采用了更明智的方法来启动Elixir的外部OS进程并与之通信.
* [presentex](https://github.com/Cobenian/Presentex) -基于HTML / JavaScript的Elixir演示框架.
* [ratekeeper](https://github.com/whitered/ratekeeper) -限速器和限速动作调度器.
...
* [nifty](https://github.com/rossjones/nifty) -用于编写NIF时所需样板的帮助程序脚本.
* [Rustler](https://github.com/hansihe/Rustler)  -用于在Rust中安全地为Erlang或Elixir编写NIF的库.  没有段错误.

## Natural Language Processing (NLP)
*使用人类（自然）语言的工具和库.*

* [gibran](https://github.com/abitdodgy/gibran) - Gibran is an Elixir port of [WordsCounted](https://github.com/abitdodgy/words_counted)，一种自然语言处理器，可从文本中提取有用的统计信息.
* [Paasaa](https://github.com/minibikini/paasaa) -Elixir的自然语言检测.
* [Petrovich](https://github.com/petrovich/petrovich_elixir) -Elixir库可以使用俄语的名字，姓氏和中间名.
...
* [sockerl](https://github.com/Pouriya-Jahanbakhsh/sockerl) -Sockerl是用于TCP协议的高级Erlang / Elixir套接字库，并提供用于实现服务器，客户端和客户端连接池的快速，有用且易于使用的API.
...
* [xlsxir](https://github.com/kennellroxco/xlsxir)  -Xlsx文件解析器，支持ISO 8601日期格式.  数据被提取到Erlang Term Storage（ETS）表中，并通过各种功能进行访问.

## ORM and Datamapping
*实现对象关系映射或数据映射技术的库.

* [amnesia](https://github.com/meh/amnesia) -nes药的Mnesia包装纸.
...
* [barrel_ex](https://github.com/jxub/barrel_ex.git) - [Barrel-db](https://barrel-db.org/) Elixir中的分布式面向文档的数据库REST客户端.
...
* [diver](https://github.com/novabyte/diver) -使用Jinterface和Asynchbase Java客户端查询数据库的Erlang / Elixir HBase驱动程序.
...
* [ecto_fixtures](https://github.com/DockYard/ecto_fixtures) -使用Ecto的Elixir应用程序的夹具.
...
* [elastic](https://github.com/radar/elastic) -通过HTTPotion的瘦手，可帮助您与Elastic Search对话.
...
* [level](https://github.com/gausby/level) -Level for Elixir实现了各种帮助程序功能和数据类型，以与Googles Level数据存储一起使用.
...
* [pdf_generator](https://github.com/gutschilla/elixir-pdf-generator) -wkhtmltopdf（HTML到PDF）的简单包装，用于Elixir项目.
...
* [mqs](https://github.com/synrc/mqs) -RabbitMQ客户端库，路由键，基于MQ的RPC和其他内容.
* [oban](https://github.com/sorentwo/oban) -由Elixir和现代PostgreSQL支持的强大的异步作业处理器.
* [opq](https://github.com/fredwu/opq) -在Elixir中具有工作池和速率限制的简单内存队列.
* [pqueue](https://github.com/okeuday/pqueue) -Erlang优先队列实施.
* [que](https://github.com/sheharyarn/que) -与Mnesia一起进行简单的后台作业处理.
...
* [distillery](https://github.com/bitwalker/distillery) -Erlang VM的发行包功能的纯Elixir实现.
...
* [relex](https://github.com/yrashk/relex) -Erlang / Elixir发行汇编程序.
...
* [maru](https://github.com/falood/maru) -葡萄的Elixir副本，用于创建类似REST的API.
...
## Search
*与搜索索引，搜索算法和搜索客户端有关的库.

* [elasticsearch](https://github.com/infinitered/elasticsearch-elixir) -用于Elixir的简单，精悍的Elasticsearch库.
...
* [blogit](https://github.com/meddle0x53/blogit) -一个OTP应用程序，用于从包含markdown文件的git存储库中生成博客.
...
* [mtx](https://github.com/synrc/mtx) -MTX支持用于跟踪直方图，仪表，计数器，仪表，计时键的前端API.
...
* [bbmustache](https://github.com/soranoba/bbmustache) -用于Erlang / OTP的基于二进制模式匹配的Moustache模板引擎.
* [calliope](https://github.com/nurugger07/calliope) -在Elixir HAML解析器中.
...
* [ecto_it](https://github.com/xerions/ecto_it) -具有默认配置的Ecto插件，用于通过数据库测试不同的ecto插件.
...
* [ex_machina](https://github.com/thoughtbot/ex_machina)  -灵丹妙药的灵活测试工厂.  与Ecto和Ecto关联开箱即用.
...
* [factory_girl_elixir](https://github.com/sinetris/factory_girl_elixir) -在Elixir中最少实现Ruby的factory_girl.
...
* [setup_tag](https://github.com/vic/setup_tag) -轻松混合和标记标记的功能以设置您的测试环境.
...
* [test_that_json](https://github.com/facto/test_that_json) -符合Elixir测试需求的JSON断言和帮助程序.
...
* [caustic](https://github.com/agro1986/caustic)  -用于比特币，以太坊和其他区块链的Elixir加密货币库  包括密码学，数论（素数，全等）和用于探索性数学的通用数学库.
* [ccc](https://github.com/Joe-noh/ccc) -字符代码转换器.
* [chinese_translation](https://github.com/tyrchen/chinese_translation) -根据维基百科的数据在繁体中文和简体中文之间进行翻译，并将中文单词/字符翻译成拼音（或带有或不带有音调的子弹）.
...
* [custom_base](https://github.com/igas/custom_base) -允许您在Elixir中进行自定义基础转换.
* [decimal](https://github.com/ericmj/decimal) -Elixir的任意精度十进制算法.
* [dicer](https://github.com/olhado/dicer) -骰子滚筒表情评估器.
* [eden](https://github.com/jfacorro/Eden) - [EDN](https://github.com/edn-format/edn) Elixir的编码器/解码器.
* [elixilorem](https://github.com/mgamini/elixilorem) -  Lorem存有发电机药剂.
...
* [ex_brace_expansion](https://github.com/gniquil/ex_brace_expansion) -Elixir中的sh / bash中的括号扩展.
...
* [ex_uc](https://github.com/carturoch/ex_uc) -Elixir的可扩展单位转换器.
...
* [expr](https://github.com/Rob-bie/Expr) -Elixir库，用于解析和评估数学表达式.
...
* [numero](https://github.com/alisinabh/numero) -用于在library剂中转换非英语utf-8数字的微型库.
* [palette](https://github.com/lpil/palette) -一个方便的库，用于在Elixir中为字符串着色.
* [pinyin](https://github.com/lidashuang/pinyin) -中文拼音库，用于长生不老药.
* [porterstemmer](https://github.com/frpaulas/porterstemmer) -Elixir的Porter投票.
...
* [ref_inspector](https://github.com/elixytics/ref_inspector)  -Elixir中的引用解析器库.  从网址中获取信息.
* [remove_emoji](https://github.com/guanting112/elixir_remove_emoji)  -Elixir中的Emoji文字消毒剂.  它可以删除任何表情符号.
* [secure_random](https://github.com/patricksrobertson/secure_random.ex) -便利的库，用于根据我对Ruby的SecureRandom的爱而建模的随机base64字符串.
...
* [slugger](https://github.com/h4cc/slugger) -Slugger可以根据可用于URL或文件名的给定字符串生成slug.
* [stemmer](https://github.com/fredwu/stemmer) -Elixir中的英语（Porter2）词干实现.
* [tau](https://github.com/FranklinChen/tau) -提供著名的数学常数tauτ= 6.2831 ....
...
* [assembla_api](https://github.com/Assembla/ex_assembla_api) -组装Elixir的API客户端.
...
* [exstagram](https://github.com/arthurcolle/exstagram) -Instagram v1 API的Elixir库.
* [extripe](https://github.com/princemaple/extripe) -具有完整的Stripe API包装器.
...
* [govtrack](https://github.com/walterbm/govtrack-elixir) -一个简单的Elixir包装器 [govtrack.us](https://www.govtrack.us/developers) API.
...
* [parse_client](https://github.com/elixircnx/parse_elixir_client) -parse.com REST API的Elixir客户端.
...
* [peatio_client](https://github.com/peatio/peatio-client-elixir) -与Peatio交换项目兼容的Elixir API.
* [pigeon](https://github.com/codedge-llc/pigeon) -兼容HTTP2的包装程序，用于发送iOS和Android推送通知.
* [pocketex](https://github.com/essenciary/pocketex) -Pocketex是Pocket Read之后服务的Elixir客户端 [getpocket.com](https://getpocket.com/).
* [pusher](https://github.com/edgurgel/pusher) -Elixir库，用于访问Pusher REST API.
* [qiita_ex](https://github.com/ma2gedev/qiita_ex) -用于Elixir的Qiita API v2接口.
...
* [rs_twitter](https://github.com/radzserg/rstwitter) -Elixir的低级别Twitter客户端.
...
* [sift_ex](https://github.com/C404/sift_ex) -用于Elixir的Siftscience API库.
...
* [ecto_gettext](https://github.com/exbugs-elixir/ecto_gettext) -使用Gettext的本地化Ecto验证错误的库.
* [exkanji](https://github.com/ikeikeikeike/exkanji)  -在平假名，片假名，罗马字和汉字之间进行翻译的Elixir库.  它使用Mecab.
* [exromaji](https://github.com/ikeikeikeike/exromaji) -一个Elixir库，可在平假名，片假名和罗马字之间进行翻译.
...
* [linguist](https://github.com/chrismccord/linguist) -Elixir国际化库.
...
* [async_with](https://github.com/fertapric/async_with) -Elixir的“ with”修饰符，以并行执行其所有子句.
...
* [dot-notes](https://github.com/whitfin/dot-notes-elixir) -对地图/列表进行简单的点/括号符号解析/转换.
* [dress](https://github.com/veelenga/dress) -Cli应用程序，使您的标准输出变得花哨.
* [erlang-history](https://github.com/ferd/erlang-history) -将shell历史记录添加到Erlang的shell的黑客.
...
* [retry](https://github.com/safwank/ElixirRetry) -简单的Elixir宏，可进行线性重试，指数补偿以及等待可组合的延迟.
...
* [ex_nric](https://github.com/falti/ex_nric) -验证新加坡国民注册身份证号（NRIC）.
...
* [jeaux](https://github.com/zbarnes757/jeaux) -轻巧的架构验证器.
...
* [meeseeks](https://github.com/mischov/meeseeks) -一个用于使用CSS或XPath选择器从HTML和XML解析和提取数据的库.
...
* [Adopting Elixir](https://pragprog.com/book/tvmelixir/adopting-elixir)  -将Elixir引入您的公司，并采用建立Elixir并成功成功使用Elixir的人们的现实生活策略.  本书提供了将应用程序从概念应用到生产所需的所有信息（2017年）.
...
* [Elixir Cookbook](https://www.packtpub.com/application-development/elixir-cookbook) -本书是按Paulo A Pereira（2015）的主题分组的一组食谱.
* [Elixir do zero à concorrência](https://www.casadocodigo.com.br/products/livro-elixir) -（葡萄牙语）这本书由Tiago Davi（2014年）提供了使用Elixir进行功能和并发编程的介绍.
* [Elixir in Action](https://www.manning.com/books/elixir-in-action-second-edition) -语言的简要介绍，然后由SašaJurić（2015）详细介绍了Elixir中的生产就绪系统.
* [Erlang and Elixir for Imperative Programmers](https://leanpub.com/erlangandelixirforimperativeprogrammers) -Wolfgang Loder（2016）在功能概念的上下文中介绍了Erlang和Elixir.
* [Erlang in Anger](http://www.erlang-in-anger.com/) -本书旨在为弗雷德·赫伯特（Fred Hebert）（2014）在战时如何成为Erlang军医提供一些指导.
* [Functional Web Development with Elixir, OTP, and Phoenix](https://pragprog.com/book/lhelph/functional-web-development-with-elixir-otp-and-phoenix) -开启强大的新技术之门，这将使您以全新的方式思考Web开发（2017年）.
...
* [benjamintanweihao/elixir-cheatsheets](https://github.com/benjamintanweihao/elixir-cheatsheets/) -GenServer和Supervisor备忘单.
...
* [elixir-lang-core](https://groups.google.com/d/forum/elixir-lang-core) -用于Elixir Core开发的邮件列表，使用“对话”来提问和进行一般讨论.
...
* [Elixir Digest](http://elixirdigest.net) -每周通讯，其中包含有关Elixir和Phoenix的最新文章.
...
* [Elixir for Programmers](https://codestool.coding-gnome.com/courses/elixir-for-programmers) -功能，并行，可靠（有趣！），由Dave Thomas教授.
* [Elixir Sips](http://elixirsips.com/) -学习Elixir的小屏幕视频.
* [ElixirCasts.io](https://elixircasts.io/) -简单的截屏视频可帮助您学习Elixir和Phoenix.
* [ExCasts](https://excasts.com) -针对所有技能水平的圣灵和凤凰卫视截屏.
...
* [Meet Elixir](https://www.pluralsight.com/courses/meet-elixir) -通过JoséValim了解Elixir的一些功能和概念.
...
* [Elixir Fountain](https://soundcloud.com/elixirfountain) -每周播客，播客包括Elixir社区周围的新闻和访谈 [Johnny Winn](https://twitter.com/johnny_rugger).
...
* [How I start - Elixir](http://howistart.org/posts/elixir/1) -何塞·瓦里姆（JoséValim）的解释和介绍.
