...
* [bpe](https://github.com/spawnproc/bpe)  -Erlang中的业务流程引擎.  （[Doc](https://bpe.n2o.space)).
...
* [ExChat](https://github.com/tony612/exchat) -Elixir，Phoenix和React（redux）开发的类似Slack的应用程序.
