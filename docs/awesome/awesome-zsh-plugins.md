...
* [exa](https://github.com/DarrinTisdale/zsh-aliases-exa) - 启用多个扩展别名 [exa](https://the.exa.website), the modern replacement for `ls`.
...
* [undollar](https://github.com/zpm-zsh/undollar) -  ZStrips从终端提示开始的美元符号.
