...
* [purify (kyoz)](https://github.com/kyoz/purify)  -干净生动的主题，最好在深色背景上使用. 包括`git`状态装饰.
...
这些插件中的大多数都可以通过将zgen load githubuser / reponame添加到您的.zshrc文件中来进行安装，其功能与您执行其他zgen load调用相同的功能. `zgen save`.
