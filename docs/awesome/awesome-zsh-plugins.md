...
* [superconsole](https://github.com/alexchmykhalo/superconsole) -仅Windows.
  ...
  *由于使用了agkozak-zsh-prompt，因此可以无阻塞地更新ZSH提示符
...
* [fz](https://github.com/changyuheng/fz) -无缝地将模糊搜索添加到 [z](https://github.com/rupa/z)'s tab completion and lets you easily jump around among directories in your history.
...
* [interactive-cd](https://github.com/changyuheng/zsh-interactive-cd) -类似于cd的鱼形交互式选项卡完成.
