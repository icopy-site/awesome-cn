...
- [powermore](https://github.com/primejade/powermore-zsh) - 分叉自 [powerless](https://github.com/martinrotter/powerless). Simple prompt that shows `git` status and current directory.
