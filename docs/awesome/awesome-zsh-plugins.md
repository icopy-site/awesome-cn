...
* [atom-plugin](https://github.com/CorradoRossi/oh-my-zsh-atom-plugin) - 一个oh-my-zsh插件，可以让你启动文件或文件夹 [Atom](https://atom.io) 从 [iTerm 2](https://iterm2.com) .  它基于Sublime插件.  仅支持macOS.
