...
* [HSLUV](https://github.com/hsluv/hsluv-lua) -Lua实施HSLuv（HSLuv的人性替代）
...
* [hump](https://github.com/vrld/hump)  -用LÖVE开发游戏的工具集合（游戏状态，计时器/补间，向量，类，信号，摄像机）.  回购处于非活动状态，但正在改进 [this fork](https://github.com/HDictus/hump/tree/temp-master) （分支临时主）
...
* [30log](https://github.com/Yonaba/30log)  -Lua中面向对象的精简框架.  它具有命名（和未命名）的类，单一继承以及对mixin的基本支持
...
* [trickle](https://github.com/bjornbytes/trickle) -专注于网络高压缩的比特流库
...
* [Luassert](https://github.com/Olivine-Labs/luassert) -通过其他可自定义的测试扩展`assert（）`
...
* [ShakeDetectorLua](https://github.com/azoyan/ShakeDetectorLua) -将加速度计数据用于Lua编写的震动设备检测
