...
- [Todo List](https://github.com/lesnitsky/todolist_flutter) [149⭐] –分步教程，如何通过Flutter构建待办事项列表 [Andrei Lesnitsky](https://twitter.com/lesnitsky_a)
...
- [Rendering Pipeline](https://www.youtube.com/watch?v=UUfXWzp0-DU) [428]-Adam Barth的引擎架构.
...
- [Flutter Examples](https://github.com/nisrulz/flutter-examples) [4176⭐]-由开发人员开发的简单的基本隔离应用程序 [Nishant Srivastava](https://github.com/nisrulz).
- [Flutter Catalog](https://github.com/X-Wei/flutter_catalog) [891⭐]-展示Flutter组件的应用程序，并排显示了源代码 [X-Wei](https://github.com/X-Wei).
...
- [StaggeredGridView](https://github.com/letsar/flutter_staggered_grid_view) [1221⭐]-带有可变大小的图块的GridView [Romain Rastel](https://github.com/letsar).
- [Radial Menu](https://github.com/xqwzts/flutter_radial_menu) [283⭐]-动画径向菜单 [Victor Choueiri](https://github.com/xqwzts).
- [Tinder Cards](https://github.com/Ivaskuu/tinder_cards) [384⭐]-像火种卡刷卡效果 [Ivascu Adrian](https://github.com/Ivaskuu).
- [Flip Panel](https://github.com/hnvn/flutter_flip_panel) [288⭐]-具有内置动画的翻转面板 [HungHD](https://github.com/hnvn).
- [Facebook Reactions](https://github.com/duytq94/facebook-reaction-animation) [153⭐]-Facebook的响应小部件 [Duy Tran](https://github.com/duytq94).
- [Flushbar](https://github.com/AndreHaueisen/flushbar) [479⭐]-高度可配置的小吃店 [Andre Haueisen](https://github.com/AndreHaueisen).
- [Stepper Touch](https://github.com/Rahiche/stepper_touch) [139⭐]-横向价值步进器很好地由 [Raouf Rahiche](https://github.com/Rahiche).
- [Typeahead](https://github.com/AbdulRahmanAlHamali/flutter_typeahead) [294⭐]-向用户显示重叠建议，方法是： [Abdul Rahman Al Hamali](https://github.com/AbdulRahmanAlHamali).
- [Snaplist](https://github.com/ariedov/flutter_snaplist) [231⭐]-通过创建快照列表视图 [David Leibovych](https://github.com/ariedov).
- [Pin Code](https://github.com/LiewJunTung/pin_code_text_field) [100⭐]-动画和可自定义的个人识别码，用于登录和通过 [Liew Jun Tung](https://github.com/liewjuntung).
- [Folding Cell](https://github.com/faob-dev/folding_cell) [211⭐]-折叠您的小部件 [Faob](https://github.com/faob-dev).
- [Liquid Pull To Refresh](https://github.com/aagarwal1012/Liquid-Pull-To-Refresh) [490⭐]-美观且自定义的刷新指示器 [Ayush Agarwal](https://github.com/aagarwal1012/).
...
- [Rubber Bottom Sheet](https://github.com/mcrovero/rubber) [249⭐]-弹性材料底片 [Mattia Crovero](https://github.com/mcrovero).
...
- [Before After](https://github.com/xsahil03x/before_after) [289⭐]-漂亮的滑块，通过它可以更轻松地显示两个图像之间的差异 [Sahil Kumar](https://github.com/xsahil03x).
...
- [Beautiful_Popup](https://github.com/jaweii/Flutter_beautiful_popup) [139⭐]-通过以下方法美化您的应用程序弹出窗口 [jaweii](https://github.com/jaweii).

#### Sticky Headers

- [Sticky Infinite List](https://github.com/TatsuUkraine/flutter_sticky_infinite_list) [73⭐]-带有粘性标题的高度可配置的多向无限列表 [TatsuUkraine](https://github.com/TatsuUkraine).
- [Sticky Header](https://github.com/letsar/flutter_sticky_header) [423⭐]-基于银条的粘性标头 [Romain Rastel](https://github.com/letsar).
- [Sticky Headers](https://github.com/slightfoot/flutter_sticky_headers) [448⭐]-通过配置可配置标头 [Simon Lightfoot](http://www.devangels.london/).
...
- [Fancy Bottom Navigation](https://github.com/tunitowen/fancy_bottom_navigation) [304⭐]-动画底部导航 [Tony Owen](https://github.com/tunitowen).
...
- [Bottom Navy Bar](https://github.com/pedromassango/bottom_navy_bar) [375⭐]-美丽多彩的动画底部导航栏，由 [Pedro Massango](https://github.com/pedromassango).
- [Titled Navigation Bar](https://github.com/pedromassango/titled_navigation_bar) [111⭐]-动画底部导航栏，可通过以下方式在图标和标题之间切换 [Pedro Massango](http://github.com/pedromassango).

#### Sliders

- [RangeSlider](https://github.com/boeledi/RangeSlider) [201⭐]-2拇指可配置RangeSlider，由 [Didier Boelens](https://www.didierboelens.com).
- [Fluid Slider](https://github.com/rvamsikrishna/flutter_fluid_slider) [180⭐]-具有最小设计和流畅动画效果的滑块 [Vamsi Krishna](https://github.com/rvamsikrishna).
...
- [Reorderables](https://github.com/hanshengchiu/reorderables) [191⭐]-拖放表，行，列，Wrap（Grid）和SliverList元素 [Hansheng Chiu](https://github.com/hanshengchiu).
- [Liquid Pull To Refresh](https://github.com/aagarwal1012/Liquid-Pull-To-Refresh) [490⭐]-美观且自定义的刷新指示器 [Ayush Agarwal](https://github.com/aagarwal1012/).
- [Infinite Listview](https://github.com/fluttercommunity/flutter_infinite_listview) [100⭐]-双向无限滚动 [Simon Lightfoot](https://github.com/slightfoot).
- [Offline](https://github.com/jogboms/flutter_offline) [432⭐]-Tidy实用程序，可通过以下方式处理脱机/在线连接 [Jeremiah Ogbomo](https://twitter.com/jogboms).
- [Scroll To Index](https://github.com/quire-io/scroll-to-index) [128⭐]-滚动到具有给定索引的SliverList / ListView的指定子元素 [Jerry Chen](https://github.com/jerrywell/).
...
- [Snap](https://github.com/aliyigitbireroglu/flutter-snap) [49⭐]-工具/小部件，用于广泛的快照管理和小部件之间的快照 [Ali Yigit Bireroglu](https://github.com/aliyigitbireroglu).
...
- [ShowCaseView](https://github.com/simformsolutions/flutter_showcaseview) [250⭐]-通过以下方式在iOS和Android上展示您的应用功能 [Simform](https://github.com/simformsolutions).
...
- [Material Color Picker](https://github.com/long1eu/material_color_picker) [83⭐]-基于Google Docs颜色选择器 [Lung Razvan](https://github.com/long1eu).
- [Unicorn Speed Dial](https://github.com/tiagojencmartins/unicornspeeddial) [184⭐]-带有快速拨号的浮动操作按钮 [Tiago Martins](https://github.com/tiagojencmartins).
- [Slidable](https://github.com/letsar/flutter_slidable) [1072⭐]-具有左右滑动操作的可滑动列表项 [Romain Rastel](https://github.com/letsar).

#### Cupertino Design

- [Peek & Pop](https://github.com/aliyigitbireroglu/flutter-peek-and-pop) [75⭐]-基于iOS功能的Peek＆Pop实现 [Ali Yigit Bireroglu](https://github.com/aliyigitbireroglu).
...
- [Parallax](https://github.com/FlutterRocks/page-transformer) [524⭐]-ViewPager由 [Iiro Krankka](https://github.com/roughike).
- [Shimmer](https://github.com/hnvn/flutter_shimmer) [767⭐]-内容加载时的闪光效果 [HungHD](https://github.com/hnvn).
- [Wave](https://github.com/i-protoss/wave) [333⭐]-通过显示自定义颜色，持续时间，浮动和模糊效果的一些波形 [RockerFlower](https://github.com/RockerFlower).
...
- [PhotoFilters](https://github.com/skkallayath/photofilters) [119⭐]-将滤镜应用于图像 [Sharafudheen KK](https://github.com/skkallayath).
- [Shine](https://github.com/JonathanMonga/flutter_shine.dart) [76⭐]-动态光位置的漂亮阴影 [Jonathan Monga](https://github.com/JonathanMonga/).
...
- [Login Animation](https://github.com/GeekyAnts/flutter-login-home-animation) [750⭐]-从登录到首页的平滑动画 [Ruchika Gupta](https://github.com/geekruchika).
- [Flutter Login](https://github.com/NearHuscarl/flutter_login) -从头到尾的带有光滑动画的登录小部件 [NearHuscarl](https://github.com/NearHuscarl).

#### Backend-Driven

- [Dynamic Widget](https://github.com/dengyin2000/dynamic_widget) [388⭐]-使用json构建动态UI，并且json格式与flutter小部件代码非常相似，方法是 [Denny Deng](https://github.com/dengyin2000).
...
- [Carousel Slider](https://github.com/serenader2014/flutter_carousel_slider) [602⭐]-轮播滑块控件，支持无限滚动和自定义子控件 [serenader](https://github.com/serenader2014).
- [Parallax Image](https://github.com/pulyaevskiy/parallax-image) [182⭐]-图像视差由 [Anatoly Pulyaevskiy](https://github.com/pulyaevskiy).
- [Photo View](https://github.com/renancaraujo/photo_view) [801⭐]-通过加载占位符的可伸缩图像视图 [Renan C. Araújo](https://github.com/renancaraujo).
- [SVG](https://github.com/dnfield/flutter_svg) [635⭐]-SVG解析，渲染和小部件库 [Dan Field](https://github.com/dnfield).
- [Image Cropper](https://github.com/hnvn/flutter_image_cropper) [509⭐]-裁剪图像支持率，旋转，缩放 [HungHD](https://github.com/hnvn).
- [Cached Network Image](https://github.com/renefloor/flutter_cached_network_image) [1023⭐]-显示来自互联网的图像，并将其保存在缓存目录中.
- [Multi Image Picker](https://github.com/Sh1d0w/multi_image_picker) [595⭐]-通过显示多图像选择器 [Radoslav Vitanov](https://github.com/Sh1d0w).
- [Lottie](https://github.com/CameronStuartSmith/flutter_lottie) [118⭐]-使用airbnb的流行 [After Effects Animation library](https://airbnb.design/lottie/) 通过 [Cameron Smith](https://github.com/CameronStuartSmith).
- [Bitmap](https://github.com/renancaraujo/bitmap) [63⭐]-在Dart FFI的帮助下，执行位图操作（例如，对比度和曝光） [Renan C. Araújo](https://github.com/renancaraujo).
- [Crop](https://github.com/xclud/flutter_crop) [8⭐]-通过以下方式裁剪Android，iOS，Web和桌面中的任何小部件/图像： [Mahdi K. Fard](https://github.com/xclud/).

### Map

- [Google Map View](https://github.com/apptreesoftware/flutter_google_map_view) [392⭐]-通过显示Google Map插件 [AppTree Software](https://www.linkedin.com/company/apptree-software/).
- [GeoCoder](https://github.com/aloisdeniel/flutter_geocoder) [91⭐]-通过进行正向和反向地理编码 [Aloïs Deniel](https://aloisdeniel.github.com).
- [Map](https://github.com/apptreesoftware/flutter_map) [36⭐]-基于的解决方案 [Leaflet](http://leafletjs.com/) 和可定制 [AppTree Software](https://github.com/apptreesoftware).
...
- [Circular Chart](https://github.com/xqwzts/flutter_circular_chart) [278⭐]-动画的径向图和饼图 [Victor Choueiri](https://github.com/xqwzts).
...
- [Sparkline](https://github.com/xqwzts/flutter_sparkline) [175⭐]-迷你图 [Victor Choueiri](https://github.com/xqwzts).
- [Charts](https://github.com/google/charts) [1348⭐]-由Google Charts Team提供.
- [Flutter Plot](https://github.com/RCHowell/flutter_plot) [26⭐]-漂亮的阴谋 [R. C. Howell](https://github.com/RCHowell/).
- [Candlesticks](https://github.com/trentpiercy/flutter-candlesticks) [233⭐]-OHLC和贸易量图表 [Trent Piercy](https://github.com/trentpiercy).
- [FCharts](https://github.com/thekeenant/fcharts) [301⭐]-精美，反应灵敏的动画图表，作者 [Keenan Thompson](https://keenant.com).
- [FL Chart](https://github.com/imaNNeoFighT/fl_chart) [1242⭐]-在Flutter中绘制奇妙的图表 [Iman Khoshabi](http://www.ikhoshabi.com).
- [Bezier Chart](https://github.com/aeyrium/bezier-chart) [212⭐]-颤动的精美贝塞尔曲线折线图小部件，具有高度的交互性和可配置性 [Diego Velasquez](https://twitter.com/diegoveloper).
...
- [Login](https://github.com/AppleEducate/flutter_login) [443⭐]-FaceID，TouchID和指纹读取器 [Rody Davis](http://appleeducate.com).
...
- [Facebook Login](https://github.com/roughike/flutter_facebook_login) [304⭐]-通过本机Android和iOS Facebook登录SDK进行身份验证 [Iiro Krankka](https://github.com/roughike).
- [Apple Sign-In](https://github.com/tomgilder/flutter_apple_sign_in) [83⭐]-Apple登录者 [Tom Gilder](https://github.com/tomgilder).
- [OAuth](https://github.com/hitherejoe/FlutterOAuth) [131⭐]-Buffer，Strava，Unsplash，Github OAuth，作者： [Joe Birch](http://www.hitherejoe.com).
...
- [SimpleAuth](https://github.com/Clancey/simple_auth) [207⭐]-Azure Active Directory，Amazon，Dropbox，Facebook，Github，Google，Instagram，已链接，Microsoft Live Connect，Github，OAuth，基本身份验证 [James Clancey](https://github.com/Clancey).
- [Flutter AppAuth](https://github.com/MaikuB/flutter_appauth) [63⭐]-插件通过以下方式为AppAuth iOS和Android SDK提供了包装器 [Michael Bui](https://github.com/MaikuB).


- [Markdown](https://github.com/flutter/flutter_markdown)  [454⭐]-Flutter的Markdown渲染器.  它支持原始格式，但不支持内联html.
...
- [Zefyr](https://github.com/memspace/zefyr) [1050⭐]-通过编辑柔和的富文本格式 [Memspace](https://github.com/memspace/zefyr).
- [AutoSizeText](https://github.com/leisim/auto_size_text) [740⭐]-自动调整文本大小以使其完全适合其范围 [Simon Leier](https://github.com/leisim).
- [Parsed Text](https://github.com/fayeed/flutter_parsed_text) [63⭐]-基于内容识别的交互式文本，还通过以下方式支持Regex [Fayeed Pawaskar](https://github.com/fayeed/).

### Analytics

- [Usage](https://github.com/dart-lang/usage) [81⭐]-命令行，Web和Flutter应用程序的Google Analytics（分析）包装.
...
- [Flutter Translate](https://github.com/bratan/flutter_translate) [131⭐]-国际化（i18n）库 [Florin Bratan](http://bratan.me).
...
- [Flutterial](https://github.com/rxlabz/flutterial) [664⭐]-Flutter材质主题浏览器，由 [Erick Ghaumez](https://twitter.com/rxlabz).
- [Pigment](https://github.com/bregydoc/pigment) [125⭐]-简单但有用的软件包，用于在抖动中使用颜色.
...
- [Flutter Sound](https://github.com/dooboolab/flutter_sound) [270⭐]-一方面通过Flutter录音机和播放器 [dooboolab](https://github.com/dooboolab).

#### Video

- [WebRTC](https://github.com/cloudwebrtc/flutter-webrtc) [923⭐]-适用于iOS / Android的WebRTC插件，作者： [CloudWebRtc](https://github.com/cloudwebrtc).
- [Chewie](https://github.com/brianegan/chewie) [743⭐]-通过以下方式提供对视频播放的低级访问 [Brian Egan](https://github.com/brianegan).

#### Voice

- [Speech Recognition](https://github.com/rxlabz/speech_recognition) [233⭐]-发短信给by [Erick Ghaumez](https://twitter.com/rxlabz).
...
- [Secure Storage](https://github.com/mogol/flutter_secure_storage) [341⭐]-钥匙串和密钥库的存储方式 [German Saprykin](https://github.com/mogol).
...
- [Square In-App Payments SDK](https://github.com/square/in-app-payments-flutter-plugin) [164⭐]-通过在您的应用中嵌入卡片输入表单来进行付款，该表单会通过以下方式从客户提供的卡片信息或数字钱包中产生随机数 [Square](https://github.com/orgs/square).

## Templates

- [Movie Details](https://github.com/FlutterRocks/movie-details-ui) [310⭐]-电影详细信息页面 [Iiro Krankka](https://github.com/roughike).
- [Mates](https://github.com/CodemateLtd/FlutterMates) [375⭐]-如何从randomuser.me API和一个不错的配置文件详细信息页面加载配置文件 [Iiro Krankka](https://github.com/roughike).
...
- [TodoMVC](https://github.com/brianegan/flutter_architecture_samples) [4580⭐]-准备使用不同口味的TODO应用程序：Vanilla，Redux，built_redux由 [Brian Egan](https://github.com/brianegan).
- [Restaurant Menu](https://github.com/braulio94/menu_flutter) [466⭐]-餐厅菜单 [Braulio Cassule](https://github.com/braulio94).
- [UI Challenges](https://github.com/tomialagbe/flutter_ui_challenges) [977⭐]-个人资料，旅行，美食应用作者 [Tomi Alagbe](https://github.com/tomialagbe).
- [Cupertino Settings](https://github.com/matthinc/flutter_cupertino_settings) [100⭐]-iOS设置 [Matthias Rupp](https://github.com/matthinc).
- [Music Player](https://github.com/thosakwe/flutter_music_player) [151⭐]-音乐播放器组件 [Tobe O](https://thosakwe.com/).
- [Dashboard](https://github.com/Ivaskuu/dashboard) [586⭐]-仪表板和商店商品 [Ivascu Adrian](https://github.com/Ivaskuu).
- [Todo](https://github.com/littlemarc2011/FlutterTodo) [386⭐]-来自Dribble的Todo模板 [Marc L](https://www.marc-little.com/).
- [Card Swipe Animation](https://github.com/geekruchika/FlutterCardSwipe) [315⭐]-通过刷卡模板 [Ruchika Gupta](https://github.com/geekruchika).
- [UI Kit](https://github.com/iampawan/Flutter-UI-Kit) [4197⭐]-通过以下方式在UIKit中收集有用的UI [Pawan Kumar](https://github.com/iampawan).
- [Book](https://github.com/putraxor/flutter-book-app) [240⭐]-书架 [Ardiansyah Putra](https://github.com/putraxor).
- [The Gorgeous Login](https://github.com/huextrat/TheGorgeousLogin) [1031⭐]-通过设计和平滑登录模板 [Hugo Extrat](https://github.com/huextrat).
- [Liquid Pay Payment App](https://github.com/longhoang2984/flutter_payment_app_ui) [169⭐]-流动支付应用程序概念 [Long Hoang](https://github.com/longhoang2984).
...
- [Starter Kit](https://github.com/KingWu/flutter_starter_kit)  [398⭐]-App Store实现，以学习Bloc，RxDart，Sqflite，Fluro和Dio.  通过 [King Wu](https://github.com/KingWu).
- [Feather](https://github.com/jhomlala/feather)  [289⭐]-美丽的天气应用程序.  应用程序包括RxDart，Dio，BLoC，i18n，单元和小部件测试.  通过 [Jakub Homlala](https://github.com/jhomlala).
- [Clone UI Challenges](https://github.com/javico2609/flutter-challenges) [730⭐]-通过收集有用的UI克隆 [Javier González](https://github.com/javico2609).
- [FlutterFoodybite](https://github.com/JideGuru/FlutterFoodybite) [550⭐]-精美的食品应用UI模板，作者 [JideGuru](https://github.com/JideGuru).
...
- [GitTouch](https://github.com/pd4d10/git-touch) [244⭐]-开源GitHub客户 [Rongjian Zhang](https://github.com/pd4d10).

### Machine Learning

- [MLKit](https://github.com/azihsoyn/flutter_mlkit) [275⭐]-通过的Firebase机器学习套件 [Naoya Yoshizawa](https://github.com/azihsoyn).
...
- [ML Vision Camera Stream](https://github.com/santetis/flutter_camera_ml_vision) [99⭐]-实时摄像机流对ML视觉识别（QR码，面部...） [Aumard Jimmy](https://github.com/jaumard) 和 [Santetis](https://github.com/santetis).
- [Google Mobile Vision](https://github.com/edufolly/flutter_mobile_vision) [307⭐]-Google移动视觉 [Eduardo Folly](https://github.com/edufolly).

#### Augmented Reality

- [ARKit Plugin](https://github.com/olexale/arkit_flutter_plugin) [314⭐]-ARKit包装器-苹果的iOS增强现实平台，作者： [Olexandr Leuschenko](https://github.com/olexale).
- [ARCore Plugin](https://github.com/giandifra/arcore_flutter_plugin) [106⭐]-通过ARCore平台增强现实 [Gian Marco Di Francesco](https://github.com/giandifra).
...
- [WebView](https://github.com/dart-flitter/flutter_webview_plugin) [1014⭐]-通过 [Hadrien Lejard](https://twitter.com/HadrienLejard).
- [Location](https://github.com/Lyokone/flutterlocation) [405⭐]-处理位置，处理回调以获取连续位置 [Lyokone](https://github.com/Lyokone).
...
- [Local Notifications](https://github.com/MaikuB/flutter_local_notifications) [757⭐]-用于通过以下方式显示本地通知的插件 [Michael Bui](https://github.com/MaikuB).
...
- [UDID](https://github.com/GigaDroid/flutter_udid) [115⭐]-跨应用重新安装的持久性UDID [Leon Kukuk](https://kukuk.me).
- [Downloader](https://github.com/hnvn/flutter_downloader) [368⭐]-通过创建和管理下载任务 [HungHD](https://github.com/hnvn).
- [InAppWebView](https://github.com/pichillilorenzo/flutter_inappwebview) [542⭐]-通过以下方式添加内联WebView小部件或打开应用内浏览器窗口 [Lorenzo Pichilli](https://github.com/pichillilorenzo).
- [AppAvailability](https://github.com/pichillilorenzo/flutter_appavailability) [35⭐]-列出，启动和检查已安装的应用程序 [Lorenzo Pichilli](https://github.com/pichillilorenzo).
...
- [File Picker](https://github.com/miguelpruivo/plugins_flutter_file_picker) [226⭐]-本机文件浏览器通过以下方式加载绝对文件路径 [Miguel Ruivo](https://github.com/miguelpruivo).
...
- [QR Code Reader](https://github.com/villela/flutter_qrcode_reader) [168⭐]-的QR Code阅读器插件 [Matheus Villela](https://github.com/villela).
- [Fast QR Reader View](https://github.com/facundomedica/fast_qr_reader_view) [207⭐]-实时多码阅读器 [Facundo Medica](https://github.com/facundomedica).

#### Bluetooth / NFC / Beacon

- [Blue](https://github.com/pauldemarco/flutter_blue) [1066⭐]-蓝牙 [Paul DeMarco](https://github.com/pauldemarco).
- [Beacons](https://github.com/loup-v/beacons) [58⭐]-Flutter beacons插件，作者： [Loup](http://intheloup.io).
- [NFC Reader](https://github.com/matteocrippa/flutter-nfc-reader) [156⭐]-适用于iOS和Android的NFC阅读器插件，作者： [Matteo Crippa](https://github.com/matteocrippa).
- [Beacon broadcast](https://github.com/pszklarska/beacon_broadcast) [41⭐]-通过以下方式将手机变成信标的库 [Paulina Szklarska](https://github.com/pszklarska/).
- [Reactive Ble](https://github.com/PhilipsHue/flutter_reactive_ble) [18⭐]-通过以下方式处理多个设备的BLE操作 [Philips Hue](https://github.com/PhilipsHue).

### Storage

- [Sqflite](https://github.com/tekartik/sqflite) [1414⭐]-通过的SQLite flutter插件 [Alexandre Roux](https://www.linkedin.com/in/alextekartik/).
- [Hive](https://github.com/leisim/hive) [867⭐]-由纯Dart编写的轻量级且功能强大的快速键值存储，作者为 [Simon Leier](https://github.com/leisim).

### Services

- [Dialogflow](https://github.com/VictorRancesCode/flutter_dialogflow) [121⭐]-插件可通过以下方式轻松与dialogflow集成 [Victor Rances](https://github.com/VictorRancesCode/).
- [Intercom](https://pub.dev/packages/intercom) [23⭐]-通过以下方式将对讲集成添加到您的应用中 [Maido Kaara](https://github.com/v3rm0n).
- [OneSignal](https://github.com/OneSignal/OneSignal-Flutter-SDK) [287⭐]-通过推送通知服务 [OneSignal](https://github.com/OneSignal).
...
- [Catcher](https://github.com/jhomlala/catcher) [259⭐]-自动捕获错误并通过 [Jakub Homlala](https://github.com/jhomlala).
- [Logger](https://github.com/leisim/logger) [312⭐]-易用且精美的日志 [Simon Leier](https://github.com/leisim).
...
- [Bloc](https://github.com/felangel/bloc) [3585⭐]-有助于通过以下方式实现BLoC设计模式的软件包的集合 [Felix Angelov](https://github.com/felangel).
- [MobX](https://github.com/mobxjs/mobx.dart)  [1099⭐]-通过透明功能响应式编程（TFRP）增强应用程序中的状态管理.  来自Js / React土地的MobX港口.
...
- [Hooks](https://github.com/rrousselGit/flutter_hooks) [860⭐]-小部件之间的高级代码共享 [Remi Rousselet](https://github.com/rrousselGit).
- [Functional widget](https://github.com/rrousselGit/functional_widget) [229⭐]-代码生成器将小部件作为带有注释的函数编写 [Remi Rousselet](https://github.com/rrousselGit).

### Data

- [Graphql](https://github.com/zino-app/graphql-flutter) [1606⭐]-GraphQL规范的实现 [Zino App B.V.](https://github.com/zino-app).
...
- [SpinKit](https://github.com/jogboms/flutter_spinkit) [1445⭐]-通过动画加载指标 [Jeremiah Ogbomo](https://twitter.com/jogboms).
- [Villains](https://github.com/Norbert515/flutter_villains) [253⭐]-的页面过渡动画 [Norbert Kozsir](https://twitter.com/norbertkozsir).
- [AnimatedTextKit](https://github.com/aagarwal1012/Animated-Text-Kit) [552⭐]-一组很酷的文字动画，由 [Ayush Agarwal](https://github.com/aagarwal1012/).
...
- [Flame](https://github.com/luanpotter/flame) [2187⭐]-极简主义游戏引擎 [Luan Nico](https://github.com/luanpotter).
- [SpriteWidget](https://github.com/spritewidget/spritewidget) [927⭐]-用于构建复杂的高性能动画和2D游戏的工具包，作者： [Viktor Lidholt](https://github.com/vlidholt).

### Misc

- [Cache Manager](https://github.com/renefloor/flutter_cache_manager) [289⭐]-通用缓存管理器，由 [Rene Floor](https://github.com/renefloor).
...
- [Ozzie](https://github.com/jorgecoca/ozzie.flutter) [0⭐]-只要您需要，Ozzie就会在集成测试期间截取屏幕截图 [Jorge Coca](https://github.com/jorgecoca).
- [Flutter Gherkin](https://github.com/jonsamwell/flutter_gherkin) [56⭐]-功能齐全的Gherkin解析器和UI自动测试运行器，作者： [Jon Samwell](https://github.com/jonsamwell).
...
- [History Of Everything](https://github.com/2d-inc/HistoryOfEverything) [4430⭐]-人类的垂直动画时间表 [2D, Inc](https://www.2dimensions.com/).
- [Developer Quest](https://github.com/2d-inc/developer_quest)  [2347⭐]-成为技术负责人， [2D, Inc](https://www.2dimensions.com/).

### Top

- [Flutter Team Samples](https://github.com/flutter/samples) [5896⭐]-的示例集合（包括地图，json，Material和Cupertino） [Flutter team](https://github.com/orgs/flutter/people).
...
- [Meme Chat](https://github.com/efortuna/memechat) [427⭐]-Flutter上的聊天应用程序，使用Firebase，Google登录和Google团队的设备摄像头集成.
...
- [Lime](https://github.com/fablue/lime-flutter) [308⭐]-Sebastian Sellmair的Lime社交网络.
- [Planets](https://github.com/sergiandreplace/flutter_planets_tutorial) [572⭐]-通过以下方式展示丰富的用户界面的星球探索 [Sergi Martínez](http://sergiandreplace.com).
- [NewsBuzz](https://github.com/theankurkedia/NewsBuzz) [381⭐]-Firebase支持的新闻阅读器，使用的是News API [Ankur Kedia](https://github.com/theankurkedia).
- [DroidKaigi2018-flutter](https://github.com/konifar/droidkaigi2018-flutter) [457⭐]-DroidKaigi 2018 Tokyo的非正式会议应用，作者： [konifar](https://github.com/konifar).
- [Music Player](https://github.com/iampawan/Flutter-Music-Player) [896⭐]-的全功能音乐播放器 [Pawan Kumar](https://about.me/imthepk).
- [WhatTodo](https://github.com/burhanrashid52/WhatTodo) [660⭐]-Todoist喜欢UI [Burhanuddin Rashid](https://about.me/burhanrashid52).
- [FlutterGram](https://github.com/mdanics/fluttergram) [974⭐]-基于Firestore和Google Functions的完整Instagram [MDanics](https://github.com/mdanics).
- [BookSearch](https://github.com/Norbert515/BookSearch) [378⭐]-通过阅读获得的数字书架 [Norbert515](https://github.com/Norbert515).
- [Cinematic](https://github.com/aaronoe/FlutterCinematic) [649⭐]-Movie DB Public API的UI [Aaron Oertel](https://github.com/aaronoe).
- [Beer-Me-Up](https://github.com/benoitletondor/Beer-Me-Up) [308⭐]-精心设计的啤酒追踪 [Benoit Letondor](https://github.com/benoitletondor).
- [Trace](https://github.com/trentpiercy/trace) [455⭐]-现代而强大的加密货币投资组合和市场探索者 [Trent Piercy](https://github.com/trentpiercy).
- [Taskist](https://github.com/huextrat/Taskist) [410⭐]-Taskist是“任务管理”的待办事项列表应用，由 [Hugo EXTRAT](https://github.com/huextrat).
- [Tourism](https://github.com/bluemix/tourism-demo) [172⭐]-基于带有动画和i18n的redux的旅游应用 [blueMix](https://github.com/bluemix/tourism-demo).
- [Trinity Orientation @ Univ Toronto](https://github.com/matthewtory/trinity-orientation-2018) [363⭐]-密歇根大学三一学院的迎新周 [Matthew Tory](https://github.com/matthewtory).
- [Transform Widget](https://github.com/DrPaulT/flutter-engine-test) -通过3D游戏引擎精灵生成的图像小部件 [Paul Thomas](https://github.com/DrPaulT).
- [Deer](https://github.com/aleksanderwozniak/deer) [176⭐]-极简主义者Todo Planner使用BLoC模式构建， [Aleksander Woźniak](https://github.com/aleksanderwozniak).
- [TailorMade](https://github.com/jogboms/tailor_made) [165⭐]-通过结合使用ReBLoC和Firebase Cloud Store和功能来管理时装设计师的日常工作 [Jeremiah Ogbomo](https://twitter.com/jogboms).
- [Instory](https://github.com/InvertedX/instory) [139⭐]-具有漂亮UI的Instgram故事下载器 [Sarath](https://twitter.com/_sarath_kumar).
- [Spacex-Go](https://github.com/jesusrp98/spacex-go) [351⭐]-简单但功能强大的开源SpaceX启动跟踪器. [jesusrp98](https://twitter.com/jesusrp98).
...
- [Reply](https://github.com/flschweiger/reply) [422⭐]-通过“回复”材料设计案例研究 [Frederik Schweiger](https://github.com/flschweiger).
...
- [Timy Messenger](https://github.com/janoodleFTW/timy-messenger) [1123⭐]-群组消息传递应用程序，其重点是通过 [Miguel Beltran](https://github.com/miquelbeltran) 和 [Franz Heinfling](https://github.com/fheinfling).

### Games

- [Flip](https://github.com/RedBrogdon/flutterflip) [157⭐]-黑白棋游戏， [Andrew Brogdon](https://github.com/RedBrogdon).
- [2048](https://github.com/anuranBarman/2048) [110⭐]-2048个游戏 [Anuran Barman](https://github.com/anuranBarman).
- [TRex](https://github.com/renancaraujo/trex-flame) [207⭐]-著名的Chrome浏览器Trex游戏的移植方 [Renan C. Araújo](https://github.com/renancaraujo).
- [Crush](https://github.com/boeledi/flutter_crush) [267⭐]-如何制作Math-3游戏，例如Candy Crush，由Bejeweled [Didier Boelens](https://didierboelens.com).
- [Slide Puzzle](https://github.com/kevmoo/slide_puzzle) [66⭐]-的经典幻灯片（15）拼图 [Kevin Moore](https://github.com/kevmoo).
- [Tetris](https://github.com/boyan01/flutter-tetris) [697⭐]-俄罗斯方块游戏 [YangBin](https://github.com/boyan01).
...
- [Redux Starter/Code Generator](https://github.com/hillelcoren/flutter-redux-starter) [238⭐]-具有Redux支持的Starter项目和代码生成器 [Hillel Coren](https://twitter.com/hillelcoren).
- [FlutterIcon](http://fluttericon.com/) [162⭐]-图标集生成器 [Mike Hoolehan](https://github.com/ilikerobots).
- [FVM](https://github.com/leoafarias/fvm) [171⭐]-Flutter版本管理：管理Flutter SDK版本的简单CLI.
...
- [Enhancement_Suite](https://github.com/marius-h/flutter_enhancement_suite) [81⭐]-搜索pub.dev库，更新版本，Bloc，Snippet等 [Marius Höfler](https://github.com/marius-h).


### Desktop

- [Desktop Embedding](https://github.com/google/flutter-desktop-embedding) [6230⭐]-Google的Flutter嵌入API的桌面实现.
- [Golang Desktop Embedder](https://github.com/go-flutter-desktop/go-flutter) [3574⭐]  - 通过Golang嵌入桌面 [Pierre Champion](https://github.com/pchampio).
- [Rust Desktop Embedder](https://github.com/gliheng/flutter-rs) [959⭐]-用于桌面的Rust嵌入器，作者： [juju](https://github.com/gliheng).
