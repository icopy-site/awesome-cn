...
- **[Game Boy Programming Manual](https://archive.org/download/GameBoyProgManVer1.1/GameBoyProgManVer1.1.pdf)**-任天堂官方的Game Boy编程和硬件手册.
- [Pan Docs](http://gbdev.gg8.se/wiki/articles/Pan_Docs) -历史全面的技术参考，经过确认，更正和更新.
...
- [GB ASM Tips](https://raw.githubusercontent.com/gb-archive/salvage/master/txt-files/gb-asm-tips.txt) -Jeff Frohwein编写的一些汇编技巧.
...
- [Game Boy Crib Sheet](https://github.com/gb-archive/salvage/blob/master/misc/GBCribSheet000129.pdf) -带有ASM操作码，内存位置以及更多内容的方便打印的参考表（[repository](https://github.com/JustinLloyd/Gameboy-Cribsheet)).
...
- [Game Boy Text Tools](https://github.com/raphaklaus/gameboy-text-tools) -用于NodeJS编写的Game Boy ROM的文本处理和翻译的工具集
...
- [ASMSchool](http://gameboy.mongenel.com/asmschool.html) -Duo的一组关于在GB / GBC中进行汇编编码和反汇编的课程.
...
- [rgbds-mode](https://github.com/japanoise/rgbds-mode) -Emacs RGBDS组装的主要模式.

### C

- [8-Bit Wonderland](http://belial.blarzwurst.de/gbpaper/paper.pdf) -关于Game Boy的工作原理以及如何开始为其开发有效代码的介绍性文档.
...
- [waveform-gb](https://github.com/dannye/waveform-gb)  -程序可视化波浪通道使用的波形.  波形可以自由编辑，波形回放立即更新.
...
- [GBVideoPlayer](https://github.com/LIJI32/GBVideoPlayer) -一个技术演示，演示了如何破解Game Boy LCD控制器，以使Game Boy Color播放彩色全动态视频以及音乐.
...
- [Disassembling Link's Awakening](http://kemenaran.winosx.com/posts/category-disassembling-links-awakening/) -一系列有关拆卸Link的Awakening DX的博客文章.
...
- [Piglet](https://github.com/danShumway/Piglet)  -由LUA驱动的AI，可以通过实验来玩经典的Game Boy彩色游戏.  在积极发展中.
...
- [The Game Boy Archive](https://github.com/gb-archive)  -与Game Boy相关的软件，硬件和资料库.  旨在反映和保留过去三十年中陈旧而零散的贡献.
