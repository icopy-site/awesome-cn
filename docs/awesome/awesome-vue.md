...
- [Blazing-Fast Vue 和 GraphQL 与 Gridsome [视频]](https://www.packtpub.com/in/web-development/blazing-fast-vue-and-graphql-with-gridsome-video?utm_source=vue .js.org&amp;utm_medium=referal&amp;utm_campaign=OutreachV15688) 作者：Reed Barger, Packt
...
- [vue-memo](https://github.com/akifo/vue-memo) 使用 Vue.js(&gt;2.x.)、vue-router(&gt;2.x.)、vuex(&gt;2.x.)、vuex-router-sync@next(&gt;3.x.) 进行简单的演示构建和 Firebase(&gt;3.6.x) [akifo](https://github.com/akifo)
...
- [vue-todo-list](https://github.com/alexander-elgin/vue-todo-list) 基于 Vue + Vuex + Vuetify + Vee-Validate 的待办事项列表示例应用程序
...
- [**Vue 3 example without Webpack**](https://github.com/arijs/vue-next-example)  - 示例说明如何使用 Vue-Router 构建 Vue 应用程序，而不需要 Webpack 或任何其他构建工具. 包括使用 Vue Server Renderer 预渲染组件和页面的能力.
...
- [Vue3-Starter](https://github.com/cerino-ligutom/Vue3-Starter) 一个样板，其中包含一些关于如何构建文件/文件夹的意见，其中包含一些示例，例如 **Vue Router** 导航防护、使用 **TailwindCSS** 进行主题化、使用 **Vuelidate** 进行表单验证、使用 ** 进行本地化流利**等
...
- [Book-Trading-Club](https://github.com/mubaidr/Book-Trading-Club)  - 与您所在地区的其他图书读者交易或借阅书籍. 使用nodejs和vuejs2构建
...
- [Sheiley Shop](https://github.com/itsalb3rt/sheiley_shop_app) - PWA 跟踪个人购买情况，不再需要纸和笔去超市 Vue 和 Vuetify
...
- [Roozame روزامه](http://www.roozame.com) - Roozame 是波斯语智能新闻媒体服务.
...
- [JSON Schema Editor](https://json-schema-editor.tangramjs.com) - 使用 Vue.js 和 Firebase 构建的直观 JSON 架构编辑器.
...
- [vue-video-section](https://github.com/johndatserakis/vue-video-section)  - Vue 的简单视频标题/部分组件. 适合视频背景和在其上叠加内容.
- [vue-waveform](https://github.com/chenqiaoen521/vue-waveform) -它使用画布波形音频播放器wavesurfer组件包含Vue 2.x的时间线条线
- [vue-responsive-video-background-player](https://github.com/avidofood/vue-responsive-video-background-player) - 以不同的分辨率在后台响应式地播放您自己的视频.
- [vue-h5-audio-controls](https://github.com/cycjimmy/vue-h5-audio-controls) - 一个简单的 Vue h5 音乐控制器.
- [xns-audio-player-simple](https://github.com/xinnks/xns-audio-player-simple) - 一个轻量且可定制的 Vue 2.x 音频播放器，由 HTMLAudioElement 驱动.
...
- [vue-soundcloud-player](https://github.com/matswainson/vue-soundcloud-player) - 支持单轨和播放列表的自定义 Soundcloud 播放器
...
- [vue-vision-camera](https://github.com/xulihang/vue-vision-camera) - Vue 3 的相机组件.我们可以使用该组件执行计算机视觉任务，例如条形码/QR 码扫描、文本识别等.
- [1llest-waveform-vue](https://github.com/codeacme17/1llest-waveform-vue) - 一个轻量级、可控的音频可视化vue3插件.
...
- [@egjs/vue-infinitegrid](https://github.com/naver/egjs-infinitegrid/blob/master/packages/vue-infinitegrid/) - 根据各种布局类型（例如 Vue.js 2 的砌体）排列无限卡片元素.
- [@grafikri/vue-infinite-scroll](https://github.com/grafikri/vue-infinite-scroll) - Vue 的基本无限滚动
- [vinscroll](https://github.com/logustra/vinscroll) - 极简的无限滚动组件
- [virtual-list](https://github.com/phphe/virtual-list)  - 虚拟列表组件. 功能：Vue2、Vue3、TypeScript、SSR、水平列表、虚拟表格.

#### Pull-to-refresh

- [vue-pull-refresh](https://github.com/lakb248/vue-pull-refresh) - Vue.js 2.0 的拉动刷新组件.
...
- [vue-simple-markdown](https://github.com/Vivify-Ideas/vue-simple-markdown) - 适用于 Vue 的简单高速 Markdown 解析器.
- [vue-simplemde](https://github.com/F-loat/vue-simplemde) - 一个包装纸 [simplemde](https://github.com/sparksuite/simplemde-markdown-editor) . 对于初学者和专家来说都是令人愉快的编辑. 具有内置自动保存和拼写检查功能.

#### PDF

- [vue-pdf](https://github.com/FranckFreiburger/vue-pdf) - 基于 mozilla 的 PDF.js 的 pdf 查看器
- [pdfvuer](https://github.com/arkokoley/pdfvuer) - 使用 Mozilla 的 PDF.js 的 Vue PDF 查看器，支持 Vue2 和 Vue3 的文本. [Demo](https://arkokoley.github.io/pdfvuer/)
...
- [liquor-tree](https://github.com/amsik/liquor-tree) - 令人惊叹的 Vue 树组件
...
- [plantain-00/tree-component](https://github.com/plantain-00/tree-component) - 一个reactjs、Angular 和Vuejs 树组件.
- [sl-vue-tree](https://github.com/holiber/sl-vue-tree) - Vue.js 的简单可定制可拖动树组件
- [he-tree-vue](https://github.com/phphe/he-tree-vue)  - 一个可拖动可排序的 vue 树组件，具有拖动占位符、类型定义.  gzip 压缩后大小为 14 KB.
- [vuejs-tree](https://github.com/scalia/vuejs-tree) - 高度可定制的 VueJs 树查看器
- [vue-jstree](https://github.com/zdy1988/vue-jstree) - Vue2 的树插件，具有漂亮的图标和拖放功能
- [vue-vtree](https://github.com/XAHTEP26/vue-vtree) - Vue.js 的通用且灵活的树组件
- [vue-json-component](https://github.com/tylerkrupicka/vue-json-component) - 无依赖关系的 JSON 树视图、TypeScript 支持且易于定制.
- [vue-tree-list](https://github.com/ParadeTo/vue-tree-list) - 一个用于树结构的vue组件
- [vue-finder](https://github.com/jledentu/vue-finder) - 显示分层数据的组件，具有选择、过滤和拖放功能
- [vue3-router-tree](https://github.com/boussadjra/vue3-router-tree) - 该组件基于 Vue.js 3，它以树视图的形式表示您的路线或项目.
- [object-visualizer](https://github.com/iendeavor/object-visualizer) - Vue 3 JSON 检查器，具有类似 Chrome 的主题.
- [vue-virtual-tree](https://github.com/lycHub/vue-virtual-tree) - 基于Vue3的大数据树组件.
- [vue-json-viewer](https://github.com/chenfengjw163/vue-json-viewer) - 基于 Vue2 和 Vue3 的 JSON 树视图支持增量更新组件.

#### Graph

- [vue-pipeline](https://github.com/jinfang134/vue-pipeline) - 一个易于使用的组件，可显示漂亮的响应式管道，如詹金斯蓝海插件.
...
- [coya](https://github.com/AlexanderMykulych/coya) - 图表绘制库（仅vue3）
- [vue-skia](https://github.com/rustq/vue-skia)  - 基于 Skia 的 2d 图形 vue3 渲染库. 它基于 Rust 来实现软件光栅化来执行渲染.

#### Social Sharing

- [vue-social-sharing](https://github.com/nicolasbeauvais/vue-social-sharing) - 用于共享社交网络链接的无渲染 Vue.js 组件，与 SSR 兼容
- [vue-goodshare](https://github.com/koddr/vue-goodshare)  - 用于社交分享的 Vue.js 组件，具有漂亮的按钮设计. 简单的安装、广泛的文档、开发人员支持、SEO 友好、干净的代码（无需脚本跟踪页面上的用户活动）、高速. 使用 Vue.js 2.x.
- [vue-socialmedia-share](https://github.com/mbj36/vue-socialmedia-share) - 用于与 Vue 2.X 共享社交网络链接的 Vue.js 组件
- [vue-picture-sharesheet](https://github.com/Onatcer/vue-picture-sharesheet) - 一个 Vue 图片共享表组件，很大程度上受到 Apple 新闻编辑室中的图像共享表的启发
- [vue-twitter](https://github.com/chiaweilee/vue-twitter) - 用于嵌入 Twitter 小部件的 Vue.js 组件（例如时间线、按钮）
- [vue-share-buttons](https://github.com/Alexandrshy/vue-share-buttons) - Vue.js 组件，用于在项目中放置按钮，您可以使用它来共享任何内容
- [vue-share-it](https://github.com/thisDOTname/vue-share-it) - 用于共享社交网络链接的 Vue.js 组件
- [vuesocial](https://github.com/growthbunker/vuesocial) - ‍♀️‍♂️ 一款易于使用的 Vue.js 按钮组件，拥有超过 65 个社交网络.
- [vue-socials](https://github.com/webistomin/vue-socials) - Vue.js 的社交媒体共享按钮和计数.
- [vue-share-modal](https://github.com/sttatusx/vue-share-modal) - Vue 3 的纯粹、轻量级且美观的共享模式.
...
- [vue-qrcode-reader](https://github.com/gruhn/vue-qrcode-reader) - 一组用于检测和解码 QR 码的 Vue.js 组件.
- [vue3-qr-reader](https://github.com/HJ29/vue3-qr-reader)  - Vue 3 QR 阅读器组件. 重构 vue-qrcode-reader 以实现 vue 3 兼容性.
...
- [vue-twentytwenty](https://github.com/mhayes/vue-twentytwenty) - 图像比较组件，与 Vue.js 2.x 配合使用
- [vue-cookie-law](https://github.com/apertureless/vue-cookie-law) - Vue.js 2.x 的 Cookie 信息插件
- [vue-gravatar](https://github.com/JiriChara/vue-gravatar) - Vue.js 2.x 的极其简单的头像组件
- [vue-clipboard2](https://github.com/Inndy/vue-clipboard2) - Vue.js 2.x 的易于使用的 Clipboard.js 绑定
- [vue-flashcard](https://github.com/cuduy197/vue-flashcard) - Vue.js 2.x 的带动画的 FLashcard 组件：bulb：
- [vue-truncate-collapsed](https://github.com/kavalcante/vue-truncate-collapsed) - 一个简单的组件，可以截断文本并为 Vue.js 2.x 添加可点击的“阅读更多/显示更少”
- [vue-kanban](https://github.com/BrockReece/vue-kanban) - 灵活的拖放看板组件
- [vue-letter-avatar](https://github.com/aidewoode/vue-letter-avatar) - vue.js 简洁优雅的字母头像组件
- [vue-highlightjs](https://github.com/metachris/vue-highlightjs) - 使用highlight.js 进行语法高亮显示
- [v-clipboard](https://github.com/euvl/v-clipboard) - 简单、小巧且易于使用的指令，可将模型保存到剪贴板（缩小后小于 2kb，无依赖项）
- [vue-invisible-recaptcha](https://github.com/MicroDroid/vue-invisible-recaptcha) - 超级简单地集成 Google 的 Invisible reCAPTCHA
- [vue-embed](https://github.com/Gomah/vue-embed) - Embed 组件基于 Vue 2.x 的 embed.js，该组件嵌入表情符号、媒体、地图、推文、要点、代码、服务和 Markdown.
- [vue-particles](https://github.com/creotip/vue-particles) - 用于粒子背景的 Vue.js 组件
- [vue-uniq-ids](https://github.com/termosa/vue-uniq-ids) - Vue.js 2.x 插件，有助于使用 id 相关的属性，没有副作用
- [vue-multivue](https://github.com/drewjbartlett/vue-multivue) - 在同一页面上使用同一类的多个vue应用程序.
- [vue-affix](https://github.com/eddiemf/vue-affix) - 一个 Vue.js 2.x 插件，可在滚动时在窗口中附加一个元素，类似于 Bootstrap Affix，但更简单、更智能
...
- [v-offline](https://github.com/vinayakkulkarni/v-offline) - 简单、小巧且易于使用的 Vue 应用离线和在线事件检测（缩小后小于 390b）
...
- [vue-easteregg](https://github.com/ddgll/vue-easteregg) - 轻松将 eastereg 添加到您的 vue 应用程序（默认使用 konami 代码）
...
- [vue-drag-verify](https://github.com/AshleyLv/vue-drag-verify) - 这是一个vue组件，滑动解锁进行登录或注册.
...
- [v-rating](https://github.com/vinayakkulkarni/v-rating) - ⭐️ 使用 VueJS 制作的 Semantic-UI 中的评级组件（压缩后 &lt; 500B，速度极快）
- [vue-content-placeholders](https://github.com/michalsnik/vue-content-placeholders) - 用于在 vue 中渲染虚假（渐进式）内容（如 facebook）的可组合组件
- [vue-page-designer](https://github.com/fireyy/vue-page-designer) - 用于拖放来设计和构建移动网站的 Vue 组件.
...
- [vue-google-adsense](https://github.com/mazipan/vue-google-adsense) - Vue.js Google Adsense 组件，支持 InFeed 和 InArticle 广告
- [emoji-vue](https://github.com/shershen08/emoji-vue) - Vue.js 项目的表情符号下拉列表
- [vue-chessboard](https://github.com/vitogit/vue-chessboard) - Chessboard vue 组件用于加载位置、创建位置并查看威胁.
- [vue-mindmap](https://github.com/anteriovieira/vue-mindmap) - Mindnode 地图的 Vue 组件.
...
- [vue-e164](https://github.com/evildvl/vue-e164) - 可定制的电话格式化程序，支持 E.164 标准
- [vue-pgn](https://github.com/deemaagog/vue-pgn) - 用于以pgn格式查看国际象棋游戏的Vue.js组件
- [vue-avatar-editor](https://github.com/fpluquet/vue-avatar-editor) - 使用清晰的用户界面调整大小、旋转和裁剪您上传的头像.
...
- [vue2-heropatterns](https://github.com/JustSteveKing/vue2-heropatterns) - Vue2 实现允许您将流行的英雄模式添加到任何 Div 上
- [vue-link](https://github.com/Developmint/vue-link) - 一个组件即可链接所有链接（将外部链接和内部链接视为相同）
...
- [vue-if-bot](https://github.com/Developmint/vue-if-bot) - 一个轻量级组件，用于基于用户代理向客户端隐藏/显示内容
- [vue-clampy](https://github.com/clampy-js/vue-clampy) - Vue.js (2+) 指令，如果内部内容太长，则通过添加省略号来限制元素的内容.
- [vue-cookie-accept-decline](https://github.com/promosis/vue-cookie-accept-decline)  - 在页面上显示带有文本的横幅、拒绝按钮和接受按钮. 使用 cookie 记住选择. 在创建时发出当前选择的事件. 适合 GDPR 要求.
...
- [v-show-slide](https://github.com/phegman/v-show-slide) - 一个 Vue.js 指令，用于使元素在高度之间产生动画效果：自动滑动.
- [vue-swipe-actions](https://github.com/eCollect/vue-swipe-actions) - Vue.js 的 iOS 风格滑动操作
- [vue-friendly-iframe](https://github.com/officert/vue-friendly-iframe) - 一个 Vue js 组件，用于创建超快速加载、非阻塞 iframe.
- [vue-beautiful-chat](https://github.com/mattmezza/vue-beautiful-chat) - 一个简单而美丽的 Vue 聊天组件，与后端无关，完全可定制和可扩展.
...
- [vue-tags-ball](https://github.com/yanthems/vue-tags-ball) - 使用此插件创建美丽的球形标签
...
- [vue-resize-text](https://github.com/JayeshLab/vue-resize-text) - 一个 vue 指令，根据元素宽度自动调整字体大小.
- [vue-github-profile](https://github.com/GabrielBibiano/vue-github-profile) - 一个 vue 组件，用于查看确定用户的个人资料和存储库
- [vue-niege](https://github.com/P3trur0/vue-niege) - 单文件 Vue 组件可通过画布添加暴风雪.
- [vue-dynamic-star-rating](https://github.com/JonathanDn/vue-stars-rating) - 高度动态的 vue 星级评分组件，如 google play 评分 ⭐️ ⭐️ ⭐️ ⭐️ ⭐️
...
- [vue-command](https://github.com/ndabAP/vue-command) - 一个完全工作的 Vue.js 终端模拟器
- [vue-ribbon](https://github.com/P3trur0/vue-ribbon) - GitHub 功能区的 Vue 组件
- [avatio-avatar](https://github.com/trunda/avatio-avatar) - 用于插图化身的 Vue 组件 - 使用者 [Avatio](https://avatio.cool)
- [vue-jazzicon](https://github.com/man15h/vue-jazzicon) - Vue 的极其简单的 Jazzicon 组件.
- [vue-star-rating](https://github.com/craigh411/vue-star-rating) - 一个简单、高度可定制的星级评分组件⭐️ ⭐️ ⭐️
- [vue-fixed-header](https://github.com/potato4d/vue-fixed-header) - 由 TypeScript 编写的用于 Vue.js 的简单且跨浏览器友好的固定标头组件.
- [vue-particle-effect-buttons](https://github.com/dreambo8563/vue-particle-effect-buttons)爆炸粒子效果按钮组件.
...
- [vue-twemoji-picker](https://github.com/kevinfaguiar/vue-twemoji-picker) - 适用于 Vue 的快速即插即用 Twemoji 选择器（+用于 Twemoji 渲染的文本区域）.
...
- [vue-aspect-ratio](https://github.com/albertodeago/vue-aspect-ratio) - 一个微小的组件，可以轻松处理纵横比.
- [query-builder-vue](https://github.com/rtucek/vue-query-builder) - 查询构建器库，用于通过可拖动的重新排序构建复杂和嵌套的查询.
...
- [vue-web-cam](https://github.com/VinceG/vue-web-cam) - VueJ 的网络摄像头组件.
- [vue-cursor-fx](https://github.com/LuXDAmore/vue-cursor-fx) - 用于导航、画廊和轮播等交互元素的动画自定义光标效果.
- [vuetimeline](https://github.com/growthbunker/vuetimeline) - 一个易于使用的组件，可构建漂亮的响应时间线.
- [v-emoji-picker](https://github.com/joaoeudes7/v-emoji-picker) - :star2：Vue 中使用表情符号原生（unicode）的轻量级且可定制的表情符号选择器包.
- [learnawesome-flashcard](https://github.com/learn-awesome/flashcard) - 通过 localStorage 进行间隔重复的抽认卡：bulb：
- [vue-portfolio-viewer](https://github.com/MelihAltintas/vue-portfolio-viewer.git) - vue js 的滚动动画作品集查看器组件：bulb：
- [vue-text-middle-ellipsis](https://github.com/Tardigrada777/vue-text-middle-ellipsis) - 一个简单的 vue 指令（2+），如果内部内容太长，则将内容夹在元素中间.
- [vuesence-book](https://github.com/altrusl/vuesence-book) - 文档/帮助系统组件.
- [vue-turnjs](https://github.com/Reidond/vue-turnjs) - 一个组件库，可将书籍体验添加到您的应用程序中.
- [vuesence-sliding-header](https://github.com/altrusl/vuesence-sliding-header) - 顶部导航栏的滑动标题.
- [tsParticles](https://github.com/matteobruni/tsparticles) - 一个轻量级的 Javascript 库，可轻松创建高度可配置和交互式的粒子动画
...
- [vue-visual-filter](https://github.com/obadakhalili/vue-visual-filter) - ️‍♂️ 用于 Vue 2 和 3 的无主见的高级视觉过滤组件.
- [vue-easter-egg-trigger](https://github.com/webdevnerdstuff/vue-easter-egg-trigger) - 这个包可以让您轻松轻松地将复活节彩蛋触发器添加到您的 Vue 2 站点. [Vue 3](https://github.com/webdevnerdstuff/vue3-easter-egg-trigger) 版本也可用.
...
- [vite-plugin-vue-preview](https://github.com/liting-yes/vite-plugin-vue-preview) - 一个用于代码预览的vite插件，当然你也可以单独使用该组件
- [vue3-calendar-heatmap](https://github.com/razorness/vue3-calendar-heatmap) - 基于 SVG 构建的轻量级日历热图 Vue 3 组件
- [vue3-code-block](https://github.com/webdevnerdstuff/vue3-code-block) - Vue 3 CodeBlock - 使用由 PrismJS 或 Highlight.js 提供支持的语法突出显示组件轻松突出显示您的代码.
- [v-image-magnifier](https://github.com/fchancel/v-image-magnifier)  - 一个 Vue 3 插件，提供交互式图像缩放功能. 允许用户通过将鼠标悬停在图像上来放大图像，从而提供图像相应部分的放大视图. 
- [Everright-filter](https://github.com/Liberty-liu/Everright-filter)  - Vue3 的查询构建器组件. 支持多种数据类型的过滤，包括字符串、数字、下拉列表、级联、区域、日期和时间.
- [@kolirt/vue-web3-auth](https://github.com/kolirt/vue-web3-auth) - 基于 WalletConnect v2 和 wagmi 的 Vue3 应用程序的 Web3 身份验证

#### Tabs

- [vue-tabs](https://github.com/cristijora/vue-tabs) - 简单的药片和药丸.
...
- [vue-k-tabs](https://github.com/kevindesousa/vue-k-tabs) - 采用 Gitlab 设计的简单选项卡组件.
- [vue-tabs-with-active-line](https://github.com/karambafe/vue-tabs-with-active-line) - 简单的 Vue 2 组件，允许您制作带有移动底线的选项卡
- [vue-tabs-chrome](https://github.com/viewweiwu/vue-tabs-chrome) - 类似 Chrome 选项卡的 Vue 组件.
- [vue-tiny-tabs](https://github.com/mevinoth/vue-tiny-tabs) - 一个简约的选项卡组件，作为tinytabs Vuejs 包装器（大小&lt; 3.1kb）
- [vue-lumino](https://github.com/tupilabs/vue-lumino) - 将 Vue.js 与 Jupyter Lumino (PhosphorJS) 结合使用的组件，通过事件监听器和 Vue 反应系统集成 DOM 和 VDOM.
- [vue-router-tab](https://github.com/bhuh12/vue-router-tab) - Vue.js 选项卡组件，基于 Vue Router.
- [vue3-tabs](https://github.com/HJ29/vue3-tabs) - vue 3 的触摸滑动选项卡组件
- [vue3-tabs-chrome](https://github.com/viewweiwu/vue3-tabs-chrome) - 用于类似 Chrome 选项卡的 Vue3 组件.
...
- [vue-phone-number-input](https://github.com/LouisMazel/vue-phone-number-input) - 漂亮的格式输入和有效的电话号码以及国家/地区代码：fire：
...
- [vue-fontawesome-picker](https://github.com/zolamk/vue-fontawesome-picker) - Vue 2.x 的很棒的字体图标选择器组件.
- [vue3-scroll-picker](https://github.com/HJ29/vue3-scroll-picker) - Vue 3 的滚动选择器组件.
- [vue-wheel-picker](https://github.com/vanishmax/vue-wheel-picker) - 可定制的选取器，带有 3D 滚轮和 Vue 2 支持的所有手势.
...
- [vue-form-json](https://github.com/14nrv/vue-form-json) - 从 json 生成带有验证和 bulma 风格的 vue 表单
...
- [Laraform](https://github.com/laraform/laraform) - 支持 Laravel 的 Vue.js 高级表单构建器
...
- [vue-form-builder](https://github.com/openfext/vue-form-builder) - 使用 JSON schema 和合成 api 构建强大的 vue 表单，支持 Element UI、View UI、Ant Design Vue 等流行的 ui 框架. [Online Demo](https://openfext.github.io/vue-form-builder)
- [vue-dynamic-inputs](https://github.com/taverasady/vue-dynamic-inputs) - 使用 json 中的 buefy 创建动态表单 [Online Demo](https://codepen.io/taverasady/pen/LYVzevo)
...
- [vue3-otp-input](https://github.com/ejirocodes/vue3-otp-input) - 一款完全可定制的 OTP（一次性密码）输入组件，使用 Vue 3.x 和 Vue Composition API 构建.
...
- [vue2-timepicker](https://github.com/phoenixwong/vue2-timepicker)  - Vue 2.x 的下拉时间选择器（小时|分钟|秒），具有灵活的时间格式支持.  ：clock7：（2019 年返回并充电：电池：）
- [vuejs-datepicker](https://github.com/charliekassel/vuejs-datepicker)  - 一个简单的 Vue.js 日期选择器组件. 支持禁用日期、内联模式、翻译.
- [vuedt](https://github.com/nkoehring/vuedt) - 疯狂的轻量级（&lt;5kb！）Vuejs 日期和时间选择器组件，具有 i18n 支持，漂亮的动画，没有太多模糊.
...
- [vue-hotel-datepicker](https://github.com/krystalcampioni/vue-hotel-datepicker) - 响应式日期范围选择器，显示所选的住宿天数，允许自定义入住/退房规则、阻止日期、本地化支持等.
- [vue2-persian-datepicker](https://github.com/dyonir/vue2-persian-datepicker)  - 一个很棒的 vue 波斯语日期选择器组件. 用于视图的日期选择组件.
- [vue-datetime](https://github.com/mariomka/vue-datetime)  - 适用于 Vue 的移动设备友好日期时间选择器. 支持日期、日期时间和时间模式、i18n 和禁用日期.
- [vue-rangedate-picker](https://github.com/bliblidotcom/vue-rangedate-picker) - 使用简单的范围日期选择器
- [v2-datepicker](https://github.com/dwqs/v2-datepicker) - 一个基于 Vue 2.x 的简单日期选择器组件.
- [vue-datepicker-local](https://github.com/weifeiyue/vue-datepicker-local) - Vue2 的一个漂亮的日期选择器组件.
- [vue-airbnb-style-datepicker](https://github.com/MikaelEdebro/vue-airbnb-style-datepicker)  - 一个 Vue 日期选择器，其外观和功能与流行的 AirBnb 日期选择器类似. 轻量级、可配置且良好的浏览器支持！
...
- [vue-datepicker-mobile](https://github.com/ikarosu/vue-datepicker-mobile)  - 适用于 vue2 的移动设备友好日期选择器.  :cn：选择一天或日期范围并根据需要进行自定义.
- [vue-draggable-cal](https://github.com/liloow/vue-draggableCal)  - 不是普通的日期选择器. 一个 Vuejs 可拖动日期选择器，具有全新的响应式设计、移动就绪和 0 依赖项，压缩后 17kb.
...
- [material-vue-daterange-picker](https://github.com/ly525/material-vue-daterange-picker) - Vuejs 2.x 的 Material Design 风格的日期范围选择器，与 vuetify 兼容并且对移动设备友好.
- [vue-datepicker](https://github.com/mathieustan/vue-datepicker)  - 一个干净且响应灵敏的日期选择器，具有 Vuejs 2.x 的材料设计风格.  （日期/月/季度&amp;&amp;日期范围选择器）：新：
- [@alireza-ab/vue-persian-datepicker](https://github.com/alireza-ab/vue-persian-datepicker)  - 用于选择波斯日期的日期选择器组件.  **（单个和范围选择、选择日期和时间、使用键盘选择、可定制样式、本地化）**
- [vue-easy-range-date-picker](https://github.com/HC200ok/vue-easy-range-date-picker) - 一个简单易用的 VueJS (2.x) 组件，用于选择日期范围
- [@vuepic/vue-datepicker](https://github.com/Vuepic/vue-datepicker) - Vue 3 最完整的日期选择器解决方案
- [vue-datepicker-next](https://github.com/mengxiong10/vue-datepicker-next) - 用于日期选择器/时间选择器/日期时间选择器/日历的Vue 3.x组件

##### Select

- [vue-select](https://github.com/sagalbot/vue-select) - 原生 Vue.js 组件，提供与 Select2 类似的功能，而无需 jQuery 的开销.
- [vue-multiselect](https://github.com/monterail/vue-multiselect) - Vue.js 的通用选择/多选/标记组件.
- [stf-vue-select](https://github.com/stfalcon-studio/stf-vue-select) - 最灵活和定制化选择Vue2
- [vue-select-image](https://github.com/mazipan/vue-select-image) - 用于从列表中选择图像的 Vue 2 组件
- [@riophae/vue-treeselect](https://github.com/riophae/vue-treeselect) - 具有 Vue.js 嵌套选项支持的多选组件.
- [@k186/pd-select](https://github.com/k186/pd-select) - 移动 UI 组件，例如 Vue 2.x 的 IOS 选择器，可以轮式选择您定义的任何内容.
- [vue-dropdowns](https://github.com/mikerodham/vue-dropdowns) - 如果使用 vue2.x 对象，则显示选择框的简约且适应性强的方式
- [v-cascade](https://github.com/zanseven007/v-cascade) - Vue 2.x 的一个可爱的级联选择器组件（支持 PC 和移动设备）
- [vue-multi-select](https://github.com/IneoO/vue-multi-select) - 用于为 Vue2 进行选择/多选的自定义组件.
- [v-region](https://github.com/TerryZ/v-region) - 简单的地区选择器，提供中国行政区划数据.
- [v-selectpage](https://github.com/TerryZ/v-selectpage) - 强大的Vue2选择器，列表或表格视图分页，使用标签进行多重选择，i18n和服务器端资源支持.
- [vue-cool-select](https://github.com/iliyaZelenko/vue-cool-select) - Bootstrap / Material Design 主题，支持插槽、自动完成、事件、验证等.
- [@myena/advanced-select](https://github.com/myENA/advanced-select) - 带搜索的单/多选组件、用于（取消）全选的控制和 Bootstrap 3 主题
...
- [vue-search-select](https://github.com/moreta/vue-search-select) - 可搜索的选择组件和语义用户界面的下拉列表兼容.
- [vue-gridmultiselect](https://github.com/ProticM/vue-gridmultiselect) - 简单的多选组件，其中的项目显示在类似 UI 的表格中
- [vue-select-sides](https://github.com/juliorosseti/vue-select-sides) - Vue.js 选择双面数据（2-side）的组件.
- [vue-selectize](https://github.com/isneezy/vue-selectize) - Selectize.js 的 Vue.js 组件包装器，一个普通的 js 选择组件
...
- [vue-histogram-slider](https://github.com/oguzhaninan/vue-histogram-slider) - Vue.js 的带有直方图的范围滑块
- [xns-seek-bar](https://github.com/xinnks/xns-seek-bar) - Vue 2.x 的可搜索进度插件.
- [@vueform/slider](https://github.com/vueform/slider) - Vue 3 滑块组件，具有多手柄、工具提示合并和格式设置.

##### Drag and Drop

- [vuedraggable](https://github.com/SortableJS/Vue.Draggable)  - Vue 组件允许与视图模型同步拖放排序. 基于Sortable.js.
- [vue-dragula](https://github.com/Astray-git/vue-dragula) - 拖放如此简单，令人心痛.
...
- [vue-drag-drop](https://github.com/cameronhimself/vue-drag-drop) - HTML5 拖放 API 的最小且轻量级的包装器.
- [vue-swing](https://github.com/goweiwen/vue-swing) - 可滑动的卡片界面，如 Jelly 和 Tinder 等应用程序中所示.
- [vue-slicksort](https://github.com/Jexordexan/vue-slicksort) - 一组无依赖的 mixin，用于动画、触摸友好、可排序列表
...
- [vue-drag-resize](https://github.com/kirillmurashov/vue-drag-resize) - 一个无依赖的 Vue 组件，用于可拖动和可调整大小的元素，具有长宽比、反应性道具等
- [vue-drag-it-dude](https://github.com/Esvalirion/vue-drag-it-dude) - Vue2 组件，允许您将对象拖动到任何您想要的位置.
- [vue-draggable](https://github.com/Vivify-Ideas/vue-draggable)  - Vue 拖放库，无需任何依赖. 简单易用.
...
- [vue-card-swipe](https://github.com/eshengsky/vue-card-swipe) - vue.js的触摸滑块，支持任意方向滑动切换卡片，兼容PC端和移动端.
- [vue-drag-n-drop](https://github.com/smaharj1/vue-drag-and-drop-kanban) - 一个简单的看板，可以将项目从列表拖放到看板上.
- [vue-card-stack](https://github.com/rodleviton/vue-card-stack) - 可堆叠、可滑动、可调整的 Vue 卡组件.
- [vue-drag-drop-snap](https://github.com/mrfade/vue-drag-drop-snap) - 一个无依赖的 Vue 组件，用于通过捕捉进行拖放.
- [vue3-dnd](https://github.com/hcg1023/vue3-dnd) - Composition API 实现中的 React DnD，使用 Composition API 进行可排序和自由拖动，支持 Vue2、Vue3.
...
- [vue-auto-complete](https://github.com/charliekassel/vuejs-autocomplete)  - Vue2 自动完成. 适用于对象或 api 调用.
- [vue-autosuggest](https://github.com/Educents/vue-autosuggest) - WAI-ARIA 完整的自动建议组件，可完全自定义渲染和样式.
- [v-autosuggest](https://github.com/soraino/v-autosuggest) - 一个简单的模块化 Vuejs 组件，可自动建议动态或静态数据查询的输入.
...
- [v-suggest](https://github.com/TerryZ/v-suggest) - 一个Vue2输入内容建议插件，支持键盘快速选取.
...
- [vue-combo-blocks](https://github.com/sssmi/vue-combo-blocks) - 适用于 Vue 的小型、可访问、可定制且“无渲染”自动完成组件.

##### Type Select

_让用户在输入时选择一个标签/某些内容_

- [vue-input-tag](https://github.com/matiastucci/vue-input-tag) - Vue.js 2.0 输入标签组件.
- [v-distpicker](https://github.com/jcc/v-distpicker) 一个灵活、高度可用的地区选择器，用于为 Vue.js 2.x 选择中国的省份、城市和地区.
...
- [v-image](https://github.com/vinayakkulkarni/v-image) :camera: 用于输入类型=文件的小组件（&lt; 1kb，gzipped）
...
- [radial-color-picker](https://github.com/radial-color-picker/vue-color-picker) - 简约的颜色选择器，注重尺寸、可访问性和性能.
- [vue-color-picker-board](https://github.com/shlomnissan/vue-color-picker-board) - Vue Color Picker 组件专为人类设计！
...
- [vue-enhanced-check](https://github.com/Keiwen/vue-enhancedCheck) - 用于重新设计/标记复选框/单选按钮的 Vue 组件，包括切换/切换按钮.
- [pretty-checkbox-vue](https://github.com/hamed-ehtesham/pretty-checkbox-vue) - 实施 [pretty checkbox 3](https://lokesh-coder.github.io/pretty-checkbox/)（一个用于美化复选框和单选按钮的纯 CSS 库）Vue.js 2.2+ 的组件.
- [vue2-collapse](https://github.com/roszpun/vue-collapse/) - Vue Collapse 是一个灵活的内容切换插件，用于手风琴列表或任何其他条件内容渲染.
- [vue-badger-accordion](https://github.com/vanderb/vue-badger-accordion) - Vue.js 2.0+ 的 Badger Accordion 的包装组件
...
- [vue-tristate-checkbox](https://github.com/hartwork/vue-tristate-checkbox) - 循环三态复选框，支持表单提交
- [vue-toggles](https://github.com/juliandreas/vue-toggles) - 高度可定制且可访问的切换组件
- [@vueform/toggle](https://github.com/vueform/toggle) - Vue 3 切换组件，带有标签、自定义插槽和样式选项.
- [vue-collapsed](https://github.com/smastrom/vue-collapsed)  - Vue 3 CSS 高度从any 过渡到auto，反之亦然. 手风琴准备好了. 
...
- [vue-numeric](https://github.com/kevinongko/vue-numeric) - 基于Vue的输入字段组件显示货币值.
- [awesome-mask](https://github.com/moip/awesome-mask) - 基于纯粹且简单的 VanillaJS 实现的 Mask 指令
- [v-money](https://github.com/vuejs-tips/v-money) - 货币的微小（&lt;2k gzipped）输入/指令掩码
- [vue-autonumeric](https://github.com/autoNumeric/vue-autoNumeric) - 一个包含了很棒的内容的 Vue.js 组件 [AutoNumeric](http://autonumeric.org/) 输入格式化程序库
...
- [vue-input-facade](https://github.com/RonaldJerez/vue-input-facade) - 专门为 Vue 创建的轻量级且无依赖的输入屏蔽库，最初是著名的 _vue-text-mask_ 的分支，但得到了积极维护，并在之后进行了许多改进.
...
- [vue-mce](https://github.com/Eazymov/vue-mce) - VueJS 的tinymce 编辑器组件.
...
- [vue-easy-tinymce](https://github.com/m3esma/vue-easy-tinymce) - 一个简单而强大的包，可以在 Vue.js 项目中轻松使用tinymce.
- [vue-highlightable-input](https://github.com/SyedWasiHaider/vue-highlightable-input) - 在输入时突出显示文本并设置文本样式
...
- [element-tiptap](https://github.com/Leecason/element-tiptap) 使用 Tiptap 和 Vue.js 的 Element UI 的所见即所得富文本编辑器
- [@mycure/vue-wysiwyg](https://github.com/mycurelabs/vue-wysiwyg) - 34Kb 轻量级所见即所得编辑器，无第 3 方插件.
- [ckeditor4-vue](https://github.com/ckeditor/ckeditor4-vue) - Vue.js 的官方 CKEditor 4 富文本编辑器组件.
- [vue-quill](https://github.com/vueup/vue-quill) - ✒️ 一个基于 Quill Editor 的 Vue 3 富文本编辑器组件.

##### Image Manipulation

_编辑图像_

- [vue-core-image-upload](https://github.com/Vanthink-UED/vue-core-image-upload) - 一个用于图像裁剪和上传的 vue 插件.
- [vue-croppa](https://github.com/zhanziyang/vue-croppa) - 适用于 Vue 2.0 的简单、直接、可定制、轻量级、适合移动设备的图像裁剪器.
...
- [vue-slim-cropper](https://github.com/wannaxiao/vue-slim-cropper) - 适用于 Vue 2.x 的简单而优雅的移动图像裁剪上传组件.
- [vue-advanced-cropper](https://github.com/Norserium/vue-advanced-cropper) - 先进的裁剪机，让您有机会创建几乎任何您想要的裁剪机
- [vue-anka-cropper](https://github.com/e-anka/vue-anka-cropper) - 图像裁剪和上传，矩形和圆形裁剪，可定制CSS
- [vue-picture-cut](https://github.com/987153776/vue-picture-cut) - 图像裁剪：缩放、翻转、旋转、边缘检查、矩形裁剪、椭圆形裁剪
- [vue-img-cutter](https://github.com/acccccccb/vue-img-cutter) - 一款vue图片切割工具插件，使用非常方便.

_显示图像_

- [vue-cloudinary](https://github.com/diegopamio/vue-cloudinary) - 一个 vue (2.0) 插件，提供可重用指令，通过动态操作（调整大小/裁剪/效果/水印/缩放/格式化）和优化（webp/png/auto）从 Cloudinary (https://cloudinary.com) 获取图像质量/自动视网膜）.
...
- [vue-image-kit](https://github.com/guastallaigor/vue-image-kit) - Vue.js 图像套件组件，内置延迟加载和响应式图像.
...
- [TwicPics](https://github.com/TwicPics/components) - 使用延迟加载、CLS 优化和开箱即用的渐进式加载替换 img 和视频标签的组件，并支持媒体优化和操作.  

##### Video Manipulation

- [vue-playlist](https://github.com/MishaPetrov/vue-playlist)  - 一个轻量级的 vue (2.0) 组件，没有依赖项，提供真正无缝的 html5 视频播放. 这是唯一一个使用 vanilla JS 实现无缝视频播放的有效解决方案. 它需要一系列视频并将它们拼接成一个视频.
...
- [vue2-multi-uploader](https://github.com/updivision/vue2-multi-uploader)  - 使用 Vue.js v2 和 Axios 的拖放式多文件上传器组件. 上传器显示添加的文件的文件名、大小和总大小. 它还允许设置上传所需的最小文件数量.
- [vue-dropzone](https://github.com/rowanwins/vue-dropzone) - Dropzone.js 的 Vue.js (vue2) 组件 - 带有图像预览的拖放文件上传实用程序.
- [vue-transmit](https://github.com/alexsasharegan/vue-transmit) - 一个纯粹的 Vue.js 拖放上传器组件，基于 Dropzone.js，适用于 Vue 2.0
- [vue-upload-component](https://github.com/lian-yue/vue-upload-component)  - Vue上传组件，多文件上传，上传目录，拖拽上传，拖拽目录. 支持 Vue &gt;= 2.0
- [vue-uploader](https://github.com/simple-uploader/vue-uploader) - 由 simple-uploader.js 支持的 Vue.js 上传组件
- [ic-firebase-uploader](https://github.com/InCuca/ic-firebase-uploader) - 用于 Firebase 存储的干净的多文件上传组件.
- [vuejs-uploader](https://github.com/charliekassel/vuejs-uploader) - 用于上传巨大文件的可恢复分段文件上传器.
- [vue-filepond](https://github.com/pqina/vue-filepond) - FilePond 的 Vue.js 组件 - 一个文件上传库，可以上传你扔给它的任何东西.
- [v-uploader](https://github.com/TerryZ/v-uploader) - 一个Vue2插件，使文件上传变得简单和容易，您可以拖动文件或在对话框中选择文件来上传
- [vue-file-agent](https://github.com/safrazik/vue-file-agent) - 全功能拖放功能的 Vue 文件上传组件，具有预览和上传进度
- [vue-cloudinary-uploader](https://github.com/xinnks/vue-cloudinary-uploader) - VueJs 的 cloudinary 图像裁剪器和上传器组件
- [vue-dropify](https://github.com/khofaai/vue-dropify) - Vuejs 的简单图像拖放区组件
...
- [vue-simple-context-menu](https://github.com/johndatserakis/vue-simple-context-menu)  - 为 Vue 构建的简单上下文菜单组件. 左键单击和右键单击均适用.
- [vue-context-menu-popup](https://github.com/Johnathan/vue-context-menu-popup) - Vue 2 的上下文菜单弹出窗口.右键单击即可工作，也可以通过编程方式触发.
- [@kiyoaki_w/vue-context](https://github.com/Kiyoaki-w/Ki-vue-context) - 为 Vue2 构建的可定制上下文菜单组件，支持 fontawesome 图标.
- [@overcoder/vue-context-menu](https://github.com/MicroDroid/vue-context-menu) - 最小上下文菜单

##### Miscellaneous

- [vue-gmaps](https://github.com/ridermansb/vue-gmaps) - 使用 Google 地图 API 搜索地点和地址.
...
- [vue-model-autoset](https://github.com/outluch/vue-model-autoset) - 一个 Vue.js 插件，用于解决 Vue 在使用 v-model 指令观察动态添加的属性方面的限制
- [vue-submit](https://github.com/NxtChg/pieces/tree/master/js/vue/vue-submit) - Load 的简单实现（[1](http://lab.hakim.se/ladda/), [2](https://msurguy.github.io/ladda-bootstrap/)）少于 90 行代码，没有依赖关系.
- [vue-rate](https://github.com/SinanMtl/vue-rate) - Vue 的评分组件
- [vuetify-google-autocomplete](https://github.com/MadimetjaShika/vuetify-google-autocomplete) - 用于 Google Maps Places API 的 Vuetify 就绪 Vue.js (2.x) 自动建议组件.
- [vue-ripple-directive](https://github.com/PygmySlowLoris/vue-ripple-directive) - 作为 Vue 指令的材质波纹效果.
...
- [vue-diagrams](https://github.com/gwenaelp/vue-diagrams) - vue.js 的图表组件，受到 React-diagrams 的启发
- [vue-easy-polls](https://github.com/updivision/vue-easy-polls)  - 用于创建民意调查、投票和显示结果的 Vue.js 组件. 它易于实施且易于定制.
- [vue-m-button](https://github.com/mengdu/m-button) - 一个漂亮的 vue 按钮组件.
- [vue-long-click](https://github.com/ittus/vue-long-click) - vue的长按（长按）指令库，支持移动端和桌面端.
- [vue-ui-predicate](https://github.com/FGRibreau/ui-predicate/tree/master/packages/ui-predicate-vue) - 规则编辑器、通用过滤 UI、Vue JS 谓词组件.
- [vue-mobile-detection](https://github.com/ajerez/vue-mobile-detection) - Vue.js 原型函数 `this.$isMobile()` 根据用户是否使用移动设备浏览返回一个布尔值.
- [vue-input-contenteditable](https://github.com/Cobertos/vue-input-contenteditable)  - “contenteditable”的 Vue 组件包装器，具有您通常期望的所有功能. 不受 `input[type=&#39;text&#39;]` 的限制，制作漂亮的输入.
...
- [vue-interactive-paycard](https://github.com/muhammederdem/vue-interactive-paycard) - 梦幻般的信用卡形式，具有流畅而甜蜜的微交互.
...
- [vue-diagram-editor](https://github.com/max-kut/vue-diagram-editor) - 高度可定制的图表编辑器，带有基于槽的节点（vue^2.6）
- [v-use-places-autocomplete](https://github.com/wobsoriano/v-use-places-autocomplete) - Vue 可组合用于 Google 地图地点自动完成.

##### Wizard

- [vue-form-wizard](https://github.com/cristijora/vue-form-wizard) - 基于选项卡的组件，可以取代经典的 bootstrap 和 jQuery 表单向导
- [vue-stepper](https://github.com/PygmySlowLoris/vue-stepper) - 一个简单的步进器，具有简单的动作，例如下一步、后退和结束，以执行简单的形式.
- [vue-stepper-component](https://github.com/adi518/vue-stepper-component) - 完全可定制的 Stepper 组件，具有 Vuex 支持和零依赖性.
- [vue3-form-wizard](https://github.com/parsajiravand/vue3-form-wizard) - Vue3-form-wizard 是一个基于 vue 的组件，没有外部依赖，可以简化选项卡向导管理.
...
- [fastcomments-vue](https://github.com/fastcomments/fastcomments-vue) - FastComments 的 Vue 组件，实时评论系统.
...
- [vue-drawing-grid](https://github.com/MLongz/VueDrawingGrid) - 简单的绘图网格可让您使用 HTML5 画布创建像素艺术.
...
- [vue-tour](https://github.com/pulsardev/vue-tour) - 轻量级且可定制的旅游插件
...
- [vue-grid-layout](https://github.com/jbaysolutions/vue-grid-layout) - 适用于 Vue.js 的可拖动且可调整大小的网格布局.
- [vue-drag-zone](https://github.com/surmon-china/vue-drag-zone) - Vue.js(2.x) 的拖动区域组件.
- [vue-masonry](https://github.com/shershen08/vue-masonry) - 用于砖石块布局的 Vue.js 指令.
- [vue-fraction-grid](https://github.com/bkzl/vue-fraction-grid) - Vue.js 的基于 Flexbox 的响应式分数网格系统.
...
- [vue-inview](https://github.com/rachmanzz/vue-inview) - [Vue 2.x] 视口，当 DOM 元素进入或离开时收到通知.
- [dnd-grid](https://github.com/dattn/dnd-grid) - 带有可拖动和可调整大小的框的 vuejs 网格
- [vue-extend-layout](https://github.com/ktquez/vue-extend-layout) - 扩展默认布局或为 Vue.js SPA 页面创建自定义布局
...
- [v-chacheli](https://gitlab.com/shellyBits/v-chacheli) - 一个 Vue.js 组件，用于创建和显示自定义的类似仪表板的网格布局.
...
- [vue-colcade](https://github.com/alexiscolin/vue-colcade) - 一个用于将 Colcade 网格布局集成到 Vuejs 的小包装器.
...
- [splitpanes](https://github.com/antoniandre/splitpanes) - Vue JS 可靠、简单且可触摸的窗格分割器/缩放器.
- [vue-mock-layout](https://github.com/promosis/vue-mock-layout) - 轻松模拟 Vue 应用程序的布局.
- [vue-simple-drawer](https://github.com/dreambo8563/vue-simple-drawer)  - 一个带有弹跳动画的小抽屉面板，支持嵌套并定制主题. 方向：左/右/上/下
- [vue-grd](https://github.com/1000ch/vue-grd) - 用于网格布局的简单、轻量级和灵活的 Vue.js 组件.
- [vue-masonry-component](https://github.com/Guillaume69/vue-masonry-component) - 一个 Vue.js 组件包装砖石布局库.
- [vue-smart-widget](https://github.com/xiaoluoboding/vue-smart-widget) - 智能小部件是 Vue.js 2.x 的灵活且可扩展的内容容器组件.
- [vue-colrow](https://github.com/phphe/vue-colrow)  - 响应式网格布局组件：Row、Col.基于 css Flexbox. 支持SSR、固定或分数宽度、自动增长列.
- [vue-diagonal](https://github.com/albertodeago/vue-diagonal) - 用于创建对角线元素的简单且轻量级的组件.
- [vue-responsive-dash](https://github.com/bensladden/vue-responsive-dash) - 使用 vue 和 typescript 制作的响应式、可拖动和可调整大小的仪表板（网格）.
- [vue-masonry-wall](https://github.com/fuxingloh/vue-masonry-wall) - 纯 vue 响应式砌体布局，无需直接 dom 操作，ssr 友好且延迟加载.
- [vue-horizontal-list](https://github.com/fuxingloh/vue-horizontal-list) - 纯vue响应式水平列表布局，支持ssr，移动和触摸友好.
...
- [vue-re-resizable](https://github.com/tachibana-shin/vue-re-resizable)  - vue 3 插件允许调整组件大小. 重写 [re-resizable](https://github.com/bokuweb/re-resizable)
- [vue-console-feed](https://github.com/tachibana-shin/vue-console-feed) - 一个插件，允许您为 vue 显示“类似 Chrome Devtools 的控制台”.
- [vue-typed-virtual-list](https://github.com/bsssshhhhhhh/vue-typed-virtual-list) - [Vue 3.x] 小型、高效、TypeScript 友好的虚拟滚动条，用于渲染海量数据
- [fit-screen](https://github.com/jp-liu/fit-screen) - 一个基于规模大屏自适应解决方案的vue组件.
...
- [muse-ui](https://github.com/museui/muse-ui) - Vue.js 2 的材质组件库.
...
- [iview-ui](https://www.iviewui.com) - 用于网络的 Vue.js 2.0 UI 框架.
- [AT-UI](https://at.aotu.io) - 清新、扁平化的专门针对桌面应用程序的 UI-Kit，由 Vue.js 2.0 的 ♥ 制作
- [v-semantic](https://www.npmjs.com/package/v-semantic) - 实施 [semantic-ui](https://semantic-ui.com/) 对于Vue
...
- [Material Components Vue](https://github.com/matsp/material-components-vue) - 包装纸 [material-components-web](https://github.com/material-components/material-components-web) 对于 Vue.js
...
- [BalmUI](https://github.com/balmjs/balm-ui) - 基于Material Design和Vue 3.0的模块化和可定制的UI库
...
- [Framevuerk](https://github.com/framevuerk/framevuerk) - 快速、响应灵敏、无依赖、方向支持和基于 Vue.js 的可配置 UI 框架.
- [@Carbon/vue](https://github.com/carbon-design-system/carbon-components-vue) - 来自 @carbon 团队的 Carbon 设计系统组件.
- [Inkline](https://github.com/inkline/inkline/) - Inkline 是直观的 UI 组件库，为您构建 Vue.js 3 设计系统提供了开发人员友好的基础.
...
- [vue-material-adapter](https://github.com/pgbross/vue-material-adapter) - Vue.js 的 Material 组件集成遵循 Google 推荐的最佳实践：使用基础和适配器
- [PrimeVue](https://primefaces.org/primevue) - 最全的Vue UI组件库
- [CoreUI for Vue.js](https://github.com/coreui/coreui-vue) - CoreUI for Vue.js 是一个 UI 组件库，提供了一堆跨浏览器、响应式且轻量级的 Vue.js UI 组件.
- [DaoStyle](https://github.com/DaoCloud/dao-style) - 基于 Vue.js 构建的高质量组件库.
- [Chakra UI Vue](https://github.com/chakra-ui/chakra-ui-vue) - ⚡ 一个轻量级且可定制的组件库，可帮助您快速构建可访问的 Vue 应用程序和网站.
...
- [Wave UI](https://github.com/antoniandre/wave-ui)  - 一个新兴的 Vue.js UI 框架，但只有好的一面.  ☀️
- [vectre](https://github.com/vectrejs/vectre) - 一个轻量级、简单、响应式的组件框架 [Spectre CSS](https://picturepan2.github.io/spectre/)
- [element3](https://github.com/kkbjs/element3) - Vue.js 3.0 Web UI 工具包基于 element-ui
...
- [Mijin](https://github.com/lecoueyl/mijin) - 响应式 Tailwind CSS UI 组件，无依赖项
...
- [Naive UI](https://github.com/TuSimple/naive-ui) - 相当完整的 Vue 3 组件库，可定制的主题，使用 TypeScript，不太慢有点有趣
- [Element Plus](https://github.com/element-plus/element-plus) - Vue 3 UI 框架.
- [AgnosticUI](https://www.agnosticui.com/) - 可访问的 Vue 3 组件原语也适用于 React、Svelte 和 Angular！
- [Unge UI](https://github.com/UngeUI/ungeui)  - Vue 3.x 组件库. 完整的文档支持，中英文双语.
...
- [Vuetensils](https://vuetensils.com) - 一个“裸”组件库，用于构建可访问的、轻量级的、定制的应用程序.
- [Vuersatile Components](https://www.andres-brugarolas.com/vuersatile-components/) - 一个 Vue 3 组件库，集成了表单自我验证和 SCSS 框架.
...
- [vue-onsenui](https://github.com/OnsenUI/OnsenUI)  - 使用 HTML5 和 JavaScript 的移动应用程序开发框架和 SDK. 创建美观且高性能的跨平台移动应用程序. 基于 Web 组件，并提供 Angular 1、2、React 和 Vue.js 的绑定.
- [Weex](https://weex.incubator.apache.org/) - Weex 提供了跨平台发布的能力，因此 Web、Android、IOS 应用程序可以使用相同的 API 开发功能.
- [weex-eros](https://github.com/bmfe/eros-template) - [中文] Eros是一个基于Weex和Vue的应用解决方案，让您可以使用Vue的API，简单快速地开发中小型应用.
- [Ionic](https://github.com/ionic-team/ionic-framework) - 移动应用程序开发框架
- [Native script](https://github.com/nativescript-vue/nativescript-vue) - 使用 NativeScript 的本机移动应用程序
- [Vue Native](https://github.com/GeekyAnts/vue-native-core) - 使用 JavaScript 构建跨平台本机移动应用程序

_移动组件集_

- [mint-ui](https://github.com/ElemeFE/mint-ui) - Vue.js 的移动 UI 元素.
- [vant](https://github.com/youzan/vant) - 来自 YouZan 的 Vue.js 2.0 移动 UI.
- [cube-ui](https://didi.github.io/cube-ui) - 由 Vue.js 2 实现的一个很棒的移动 ui lib 实现.
- [mand-mobile](https://didi.github.io/mand-mobile) - 一款基于Vue.js 2、专为金融场景设计的移动UI工具包.
...
- [Banshee](https://github.com/banshee-ui/banshee) - 一个几乎无渲染的 Vue UI 组件和实用程序框架，不附带 CSS.
...
- [bpit/vue](https://github.com/dreambo8563/bpit-vue) - Vue 组件库，专注于效果
...
- [Tailwind Elemetns for Vue](https://tailwind-elements.com/docs/standard/integrations/vue-integration/) - Vue 与 Tailwind Elements 集成 - 一个免费的开源 UI 工具包
...
- [vue-element-admin](https://github.com/PanJiaChen/vue-element-admin) - 基于 Element UI 2.x 的神奇 vue 管理器 [Online Demo](https://panjiachen.github.io/vue-element-admin/#/dashboard)
- [D2 Admin](https://github.com/d2-projects/d2-admin) - vue构建的优雅后台模板 [Online Demo](https://d2admin.fairyever.com)
...
- [Vue Material Admin](https://github.com/tookit/vue-material-admin) - vue 材料设计管理模板 [Online Demo](http://vma.isocked.com/#/dashboard)
- [element-admin](https://github.com/codetrial/element-admin) - 一个非常简单但功能强大的 vue 管理器，带有 Vue CLI 3 和 element-ui.[Online Demo](https://element-admin.now.sh/)
- [dashboard](https://github.com/zce/dashboard) - 由 vuejs/vue-cli 4.x 创建的基于 vue.js 的仪表板脚手架. [Online Demo](https://dashboard.zce.me)
- [vue-admin-next](https://github.com/openfext/vue-admin-next) - 具有多模块设计、Vue Composition API 和友好的用户界面的专业企业应用程序. [Online Demo](https://openfext.github.io/vue-admin-next/#/table/basic/query)
...
- [Admin One Vue 3 Tailwind dashboard](https://github.com/justboil/admin-one-vue-tailwind) - Vue.js 3 Tailwind CSS 管理模板，具有深色模式.
- [Mosaic - Vue Admin TailwindCSS template](https://github.com/cruip/vuejs-admin-dashboard-template) - 一体化 Tailwind CSS 管理仪表板模板.
...
- [Saber](https://github.com/saberland/saber) - 静态网站生成器，用于使用 Vue.js 构建速度极快的网站.
...
- [îles](https://github.com/ElMassimo/iles) - 互动岛，快乐的网站生成器
...
- [Vue-Access-Control](https://github.com/tower1229/Vue-Access-Control) 基于Vue.js的前端访问控制框架 2.
...
- [Vue-Low-Code](https://github.com/KlausSchaefers/vue-low-code) - 低代码工具包，可以从 Quant-UX 原型生成 VUE 应用程序
- [Figma-Low-Code](https://github.com/KlausSchaefers/figma-low-code) - 将您的 Figma 设计转变为 VUE 应用程序.
- [vue-notion](https://github.com/janniks/vue-notion) - 非官方的 Notion 渲染器 – 使用 Notion 作为 Vue 的 CMS（例如 Nuxt）
- [Fes.js](https://github.com/WeBankFinTech/fes.js/blob/master/README.en-US.md) - 一个基于vue3的简单易用的前端应用框架.
- [petite-vue](https://github.com/vuejs/petite-vue) - Vue 的 6kb 子集针对渐进增强进行了优化.
...
- [vue-clickaway](https://github.com/simplesmiler/vue-clickaway) - 用于可重用 Vue.js 组件的可重用点击指令.
- [vue-scrollfire](https://github.com/vue-comps/vue-scrollfire) - 在特定滚动位置触发事件.
- [vue-resize-directive](https://github.com/David-Desmaisons/Vue.resize) - Vue 指令用于检测具有去抖动和限制功能的调整大小事件.
- [v-click-outside](https://github.com/ndelvalle/v-click-outside) - Vue 指令对元素外部的点击做出反应，而不停止事件传播.
- [vue-outside-events](https://github.com/nchutchind/vue-outside-events) - Vue 2.x 指令帮助指定元素侦听自身外部发生的特定事件.
- [vue-selectable](https://github.com/JSmith01/vue-selectable) - Vue 1.x/2.x 指令使项目可以通过鼠标选择.
- [vue-click-helper](https://github.com/huangshuwei/vue-click-helper) - Vue2.x 指令处理同一元素上的 click 事件和 dblclick 事件.
- [v-hotkey](https://github.com/Dafrok/v-hotkey) - 用于将热键绑定到组件的 Vue 2.x 指令.
- [vue-resize](https://github.com/Akryum/vue-resize) - Vue 2.x 组件用于检测 DOM 元素大小调整（基于事件/无 window.onresize）
...
- [vue-esc](https://github.com/ianaya89/vue-esc) - Vue.js 指令在转义按键上添加文档事件侦听器.
- [vue-global-events](https://github.com/shentao/vue-global-events/) – 使用 Vue 的事件修饰符处理全局事件（如快捷方式）的组件
- [vue-edge-check](https://github.com/gu-fan/vue-edge-check/) – 检查浏览器边缘以防止使用“vue-router”滑动边缘时奇怪地触发过渡效果
...
- [vue-visibility-trigger](https://github.com/shwilliam/vue-visibility-trigger) - 滚动到视图中时以声明方式触发方法
...
- [v-on-page-video](https://github.com/mahdikhashan/v-on-page-video) - Vue.js 指令在可见性变化时更改视频元素的状态
- [vue3-click-outside](https://github.com/mahdikhashan/vue3-click-outside) - Vue 3 的指令在绑定元素外部单击时运行方法
...
- [vue-media-query-mixin](https://github.com/jofftiquez/vue-media-query-mixin)  - Vue 2 媒体查询混合，可在组件 js 和组件模板中使用. 与 bootstrap 和 vuetify 视口兼容. 如果屏幕宽度为 xs，则“wXS”返回；如果屏幕宽度为 sm，则“wSM”返回 true，等等...
- [vue-breakpoints](https://github.com/apertureless/vue-breakpoints)  - Vue 2 最小组件，用于根据断点显示和隐藏元素. 灵感来自爱彼迎.
- [vue-mq](https://github.com/AlexandreBonaventure/vue-mq) - 提供一些有用的工具，通过语义和移动优先 API 快速设置响应式设计 (Vue 2.x)
...
- [vue-screen-size](https://github.com/johndatserakis/vue-screen-size) - 轻松、反应式地访问屏幕的宽度和高度.
...
- [vue-focus](https://github.com/simplesmiler/vue-focus) - 用于可重用 Vue.js 组件的可重用焦点指令.
...
- [vue-form-components](https://github.com/antonreshetov/vue-form-components) - 干净且最小的带有验证的 vue 表单元素
- [v-ajax-form](https://github.com/hosokawat/v-ajax-form) - vue.js组件插件，使Form标签兼容ajax请求
- [Vue Formulate](https://github.com/wearebraid/vue-formulate)  - 使用 Vue 构建表单的最简单方法. 验证、错误处理、表单生成、综合文档等等.
- [Reforms.js](https://github.com/empla/reforms)  - Vue 3 和 Bootstrap 表单和卡片生成器. 验证、多个字段、分组、模式等等.
- [FormKit](https://github.com/formkit/formkit)  - Vue 3 表单开发. 速度提高 10 倍. 表单输入、验证、提交、错误处理、生成、可访问性、主题等等.
- [vrf](https://github.com/dimailn/vrf) - 声明式可扩展的、与 ui 无关的基于标记的 Vue 表单.
...
- [vuelidate](https://github.com/monterail/vuelidate) - 针对 Vue.js 的简单、轻量级的基于模型的验证.
- [simple-vue-validator](https://github.com/semisleep/simple-vue-validator) - 一个简单而灵活的 vue.js 验证器库.
- [vue-vform](https://github.com/joseluisq/vue-vform) - Vue.js 2 表单组件，集成了 jQuery Validation 和 Axios.
- [vue-form](https://github.com/fergaldoyle/vue-form) - Vue.js 的全面表单验证.
- [vuelidation](https://github.com/cj/vuelidation) - 简单、强大、vuejs 验证.
- [laravel-vue-validator](https://github.com/val-bubbleflat/laravel-vue-validator) - 显示 Laravel 验证规则的错误
- [vue-daval](https://github.com/deulos/vue-daval)  - 超级vue数据验证器. 轻松、简单、准确.
...
- [vue-final-validate](https://phphe.github.io/vue-final-validate/) - 根据我的开发经验的Vue验证解决方案，支持嵌套，异步.
...
- [ps-validation](https://github.com/PrimitiveSocial/ps-validation) - 一个 Vue 插件，提供开箱即用的数据验证规则，很大程度上受到 Laravel 验证系统的启发.
- [vue-laravel-errors](https://github.com/Sohaib-Sherif/vue-laravel-errors) - 一个 Vue.JS 插件，添加了一个全局 mixin，可用于填充 laravel 错误响应中的错误变量并将其显示为对象或数组，也可以用作本地 mixin.
- [vue-input-validator](https://github.com/mediv0/vue-input-validator) - ️ Vue 2 的高度可扩展和可定制的输入验证器
- [@vuito/vue](https://github.com/mathix420/vuito) - 简单、轻量、同构、基于模板的验证库.
- [vue-tiny-validate](https://github.com/FrontLabsOfficial/vue-tiny-validate) - 微小（缩小为 2.5KB）Vue 验证组合.
...
- [vue-responsive-text](https://github.com/shwilliam/vue-responsive-text) - ↔ 相对于父节点宽度缩放子节点的组件
- [v-hide](https://github.com/ventralnet/v-hide)  - v-hide 指令伴随 v-if 和 v-show. 在 DOM 中保留布局空间
...
- [vue-scrollto](https://github.com/rigor789/vue-scrollTo) - 添加一个指令来侦听单击事件并滚动到元素.
- [vue-next-level-scroll](https://github.com/Developmint/vue-next-level-scroll) - 基于组件且 SSR 就绪的方法，使用现代滚动行为 API 平滑滚动
- [vue-scroll-sync](https://github.com/metawin-m/vue-scroll-sync) - 同步容器滚动位置的组件
- [v-scroll-lock](https://github.com/phegman/v-scroll-lock) - 用于主体滚动锁定的 Vue.js 指令，而不破坏目标元素的滚动
- [vue2-perfect-scrollbar](https://github.com/mercs600/vue2-perfect-scrollbar) - PerfectScrollbar 简约包装
- [vue-scroll-to](https://github.com/KevinHoughton/vue-scroll-to) - 添加一个指令来侦听单击事件并滚动到元素.
...
- [vuescroll](https://github.com/YvesCoding/vuescroll) - 一个基于Vue.js的滚动插件，用于统一PC和移动端的滚动.
...
- [vue-scrollview](https://github.com/chrishurlburt/vue-scrollview) - 使用作用域插槽来检测 vue 组件何时进入和离开视口的组件.
...
- [vue-stroll](https://github.com/xiaoluoboding/vue-stroll) - Vue.js 2.x 的一个很棒的 CSS3 列表滚动效果组件.
- [navscroll-js](https://github.com/nash403/navscroll-js)  - 滚动时突出显示菜单项，并且在单击菜单项时滚动到某个部分. 用作 vue 组件、vue 指令或与 vanilla js 一起使用.
- [vue-scrollwatch](https://github.com/Desdesdesgo/vue-scrollwatch) - 一个检测滚动事件的轻型插件，自定义元素进入视口时的回调，公开“scrollTo”API以滚动到特定元素.使用vue指令.
- [vue-check-view](https://github.com/vtimofeev/vue-check-view)  - 检查元素是否在视口中的插件. 快速、小型、无依赖性、现场演示.
...
- [vue-trip-wire](https://github.com/lorrenrules/vue-trip-wire) - 当元素到达视口中的指定点时触发函数的自定义指令，可以选择导入具有全局可访问函数的模块.
- [v-intersect](https://github.com/kholid060/v-intersect) - 一个 Vue 指令和组件，用于检测元素在视口上可见或隐藏时的情况
- [vue-scrollama](https://github.com/vgshenoy/vue-scrollama) - 一个 Vue 组件，可轻松设置滚动驱动的交互（又名滚动讲述）.
- [vue-use-active-scroll](https://github.com/smastrom/vue-use-active-scroll) - 毫不妥协地突出显示 Vue 3 菜单/侧边栏链接.
...
- [vue-smart-route](https://github.com/f/vue-smart-route) - 智能路由指令，可使用 Vue.js 制作外观智能的应用程序.
...
- [vue-pilot](https://github.com/jiangfengming/vue-pilot) - 一个基于Trie的vue路由器，具有管理history.state的能力.
- [vue-lang-router](https://github.com/adbrosaci/vue-lang-router) - Vue.js 2 & 3 language routing with (optional) URL localization.
- [vue-router-compositions](https://github.com/greenpress/vue-router-compositions) - Vue-Router 和 Vue Composition API 的 util 包.
...
- [vue-lazyload](https://github.com/hilongjw/vue-lazyload) - 一个 Vue.js 插件，用于在应用程序中延迟加载图像或组件.
...
- [v2-lazy-list](https://github.com/dwqs/v2-lazy-list/) - 一个基于 Vue 2.x 的简单延迟加载列表组件
- [pimg](https://github.com/ooade/pimg) - 一个简单的渐进式图像组件，用于延迟加载图像.
...
- [lazyload-vue](https://github.com/Kazap/lazyload-vue)- 用于普通延迟加载的 Vue 插件.
- [vue-lazy-loading](https://github.com/tolking/vue-lazy-loading) - 一个 vue 插件，可以更好地支持图像和 iframe 的本机延迟加载.
- [v-lazy-component](https://github.com/RadKod/v-lazy-component)  - Vue 组件在可见时渲染. 使用 Intersection Observer API.
...
- [vue-paginate](https://github.com/TahaSh/vue-paginate) - 一个简单的 vue.js 插件来对数据进行分页.
- [vue-pagination-2](https://github.com/matfish2/vue-pagination-2) - Vue.js 2 分页组件.
- [vuejs-uib-pagination](https://github.com/sant123/vuejs-uib-pagination)  - Vue.js 的最佳且完整的分页插件. 受到 Angular Bootstrap 分页的启发.
...
- [vue-tiny-pagination](https://github.com/coderdiaz/vue-tiny-pagination) - 用于创建小型分页的 Vue 组件.
- [laravel-vue-pagination](https://github.com/gilbitron/laravel-vue-pagination) - 用于 Laravel 分页器的 Vue.js 分页组件，可与 Bootstrap 配合使用.
...
- [vue-smart-pagination](https://github.com/grinmax/vue-smart-pagination) - 任何数据的智能分页，具有许多不错的设置.
...
- [v-pagy](https://github.com/trandaison/v-pagy) - 适用于 Vue 的轻量级且可定制的 Bootstrap 分页.
- [v-paginator](https://github.com/Sitronik/v-paginator) - 基于 html 模板并支持 ssr 的 Vue.js 简单的逐页导航.
- [vue-use-paginator](https://github.com/Sun0fABeach/vue-use-paginator)  - Vue 3 使用钩子对数据进行反应式分页并排列分页器按钮. 完全无需渲染.
- [vueginate](https://github.com/lombervid/vueginate) - Vue 3 的简单分页组件

#### Animation

- [vue2-animate](https://github.com/asika32764/vue2-animate)  - Animate.css 的 Vue.js 2.0 端口. 与 Vue 的内置过渡一起使用.
...
- [vue-mixin-tween](https://github.com/lukechinworth/vue-mixin-tween) - Mixin 工厂，将补间值添加到动画的组件上下文中
- [v-odometer](https://github.com/JefferyHus/v-odometer)  - 轻松平滑地转换数字. 使用此库可以为您的应用程序提供流畅的动画，仅适用于数字.
...
- [vue-parent-change-transition](https://github.com/inamori/vue-parent-change-transition) 使子组件能够在更改父组件时进行动画处理.
- [vue-smooth-reflow](https://github.com/guanzo/vue-smooth-reflow) 转换元素回流以响应数据更改.
- [VueTween](https://github.com/SeregPie/VueTween) 允许组件调整其属性.
...
- [vue-slide-up-down-component](https://github.com/k-okina/vue-slide-up-down-component) 这是一个简单的界面，但实现了非常灵活和强大的幻灯片动画，适用于Vue！
...
- [vue-animate-scroll](https://github.com/mike-prince/vue-animate-scroll) 当元素滚动到视图中时向元素添加 CSS 动画的超轻量级方法.
...
- [vue-flipper](https://github.com/VitorLuizC/vue-flipper) - 一个翻转孩子的组件，有一个很好的过渡.
...
- [vue-digital-transform](https://github.com/DakerHub/vue-digital-transform) 一个用于更好的数字转换动画的 vue 组件
- [vue-typical](https://github.com/Turkyden/vue-typical) Vue 动画输入约 400 字节的 JavaScript.
- [vue3-lottie](https://github.com/megasanjay/vue3-lottie) Vue 3 中导入和显示 Lottie 动画的组件
- [@morev/vue-transitions](https://github.com/morevm/vue-transitions) 适用于 Vue 2 和 3 的过渡库，无需 CSS
- [@formkit/auto-animate](https://github.com/formkit/auto-animate) 使用一行代码为您的应用程序添加动效
- [vue-contextual-transition](https://github.com/beepy/vue-contextual-transition) 具有共享元素和/或顺序的页面之间轻松的跨浏览器转换
- [blottie](https://github.com/Applelo/blottie) Vue 3 的 Lottie 组件
...
- [vue-headful](https://github.com/troxler/vue-headful)  - 设置文档`<title>视图中的 ` 和元标记.
...
- [portal-vue](https://portal-vue.linusb.org/) - 一个 Vue 插件，用于在 DOM 中的任何位置渲染组件的模板（在 virtualDOM 级别上工作，不会移动 DOM 中的节点）

#### Filters

- [vue2-filters](https://github.com/freearhey/vue2-filters) - 适合在 Vue 2._ 中使用的标准过滤器 Vue 1._ 的集合.
- [vue-morphling](https://github.com/jofftiquez/vue-morphling) - Vue 2 的标准和自定义过滤器的集合.
- [vue-currency-filter](https://github.com/mazipan/vue-currency-filter) - 轻量级且可定制的 Vue 2 货币过滤器.
- [vue-trans](https://github.com/Trekels/vue-trans) - 一个简单的过滤器，提供类似的翻译到 Symfony 翻译的方式.
- [vue-string-filter](https://github.com/mazipan/vue-string-filter) - 轻量级 Vue 2 字符串操作过滤器.
- [vue-units](https://github.com/ERPedersen/vue-units) - 用于 Vue 2 的方便的单位转换过滤器集合.
...
- [vue-content-loading](https://github.com/LucasLeandro1204/vue-content-loading) - Vue 组件可轻松构建（或使用预设）SVG 加载 Facebook 等卡片.
- [vue-annotator](https://github.com/DrSensor/vue-annotator) - 使用任何 SVG 元素（“rect”、“polygon”等，甚至是像“canvas”这样的 HTML 元素，如果包装在“foreignObject”中）来注释页面
- [vue-svg-sprite](https://github.com/thierrymichel/vue-svg-sprite) - 简单使用 SVG sprite 的插件、组件或指令（vue 3.x、vue 2.x）.
- [vue-svg-filler](https://github.com/biigpongsatorn/vue-svg-filler) - 用于自定义 svg 文件的 Vue 组件（vue 2.x）.
- [vue-inline-svg](https://github.com/shrpne/vue-inline-svg)  - Vue 组件动态加载 SVG 源并内联 `<svg>  ` 这样你就可以使用 CSS 或 JS 来操纵它的样式.  （vue 2.x、vue 3.x）

#### Miscellaneous

- [vue-resource-progressbar-interceptor](https://github.com/staskjs/vue-resource-progressbar-interceptor) - 将进度条与所有请求联系起来的拦截器，很明显某些内容正在加载.
- [vue-images-loaded](https://github.com/David-Desmaisons/Vue.ImagesLoaded) - Vue.js 2.0 指令检测图像加载.
...
- [v-aspect-ratio](https://github.com/andrewvasilchuk/v-aspect-ratio) - 用于设置宽高比的 Vue.js 指令.
- [@kooljay82/vue-m-camera](https://github.com/kooljay82/vue-m-camera) - 避免自动更改通过用户设备的相机拍摄的照片的方向.
- [v-ripple-directive](https://github.com/andrewvasilchuk/v-ripple-directive) - 用于连锁反应的 Vue.js 指令.
- [vue-material-design-ripple](https://github.com/partyka1/vue-material-design-ripple)  - 为任何元素添加材料设计波纹. 使用您想要的任何波纹颜色. 没有性能问题. 移动友好. 没有依赖性. 它就是有效的.
...
- [vue-web-otp](https://github.com/mrbilit/vue-web-otp) - Vue.js 组件与浏览器的 WebOTP API 配合使用，通过 SMS 接收 OTP
- [v-privacy](https://github.com/fchancel/v-privacy) - Vue3 插件，允许通过模糊其内容来管理 HTML 元素的隐私 
...
- [VueGL](https://github.com/vue-gl/vue-gl) - Vue.js 组件通过 Three.js 反应式渲染 3D 图形
- [vue-vr](https://github.com/imudin/vue-vr) - 使用 Vue 构建 VR 应用程序的框架
  基于 [threejs](https://threejs.org/) 和 [Panolens](https://pchen66.github.io/Panolens/)，灵感来自于 [react-vr](https://github.com/facebook/react-vr)
- [vue-displacement-slideshow](https://github.com/AlbanCrepel/vue-displacement-slideshow) - 一个 Vue.js 组件，使 Webgl 图像位移转换变得更容易.
- [vue-fake3d-image-effect](https://github.com/LuXDAmore/vue-fake3d-image-effect) - WebGL 中带有深度图的图像的交互式 3D 假效果.
- [drie](https://github.com/janvorisek/drie) - 受 React-Three Fiber 启发的 Three.js 的 Vue 3 组件库.
- [TresJs](https://github.com/tresjs/tres)：使用 Vue 组件的声明式 ThreeJS
- [Cientos](https://github.com/Tresjs/cientos)：有用的助手和功能齐全、现成的 TresJ 抽象的集合
...
- [vue-page-visibility-awesome](https://github.com/stefanodotit/vue-page-visibility-awesome) - 易于配置页面可见性 api 的 Vue 2.x 组件.
- [vue-authplugin](https://github.com/vv13/vue-authplugin) - 一个优雅的视图授权控制插件，支持指令和原型方法.

#### Printing

- [vue-html-to-paper](https://github.com/mycurelabs/vue-html-to-paper) - Vue mixin 用于将 html 元素打印到纸张上.
...
- [vue-loadable](https://github.com/VitorLuizC/vue-loadable) - 一个通过非常简单的方法、装饰器和助手来改进加载状态控制的插件.
- [vueuse](https://github.com/vueuse/vueuse) - 适用于 Vue 2.x 和 3.x 的基本 Vue Composition API 实用程序集合.
...
- [vue-use](https://github.com/openfext/vue-use) - 使用神奇的Vue Composition API提供大量可重用的逻辑，例如表单、表格和加载等.
- [vue-concurrency](https://github.com/MartinMalinda/vue-concurrency) - 用于封装异步操作并管理 Vue 和 Composition API 并发性的库.
- [vue-ics](https://github.com/evildvl/vue-ics) - 用于生成 ICalendar (.ics) 文件的 Vue.js 插件.
- [vue-use-switch-map](https://github.com/jfet97/vue-use-switch-map) - RxJS switchMap 运算符的强大功能注入到 Vue 组合世界中.
- [vue-use-infinite-scroll](https://github.com/jfet97/vue-use-infinite-scroll) - ♾️ 一个 Vue 组合功能，让无限滚动变得轻而易举.
...
- [vuse-rx](https://github.com/Raiondesu/vuse-rx) - 对 Vue 3 的完整一流 rxjs 支持
- [vue-props-validation](https://github.com/rubnvp/vue-props-validation) - 使用 Vue 本机语法提取 Vue 道具验证逻辑，用于对象和数组中的嵌套验证.
- [vue-next-rx](https://github.com/NOPR9D/vue-next-rx)  - Vue.js 的完整 RxJS 集成.  （vue-rx的更新）
- [fontawesome-autogen](https://github.com/GTANAdam/fontawesome-autogen) - 自动检测并导入您的网络应用程序中使用的精美图标.

#### Typescript

- [vue-typed](https://github.com/vue-typed/vue-typed) - 一组 ECMAScript / Typescript 装饰器，可帮助您轻松编写 Vue 组件.
- [vue-typescript](https://github.com/itsFrank/vue-typescript) - Typescript 装饰器让 vue 感觉更具 Typescript 风格.
...
- [vue-typescript-import-dts](https://github.com/locoslab/vue-typescript-import-dts) - TypeScript 声明文件，允许对 .vue 文件使用“导入”.
- [vue-ts-loader](https://github.com/HerringtonDarkholme/vue-ts-loader) - 在 vue-loader 中对脚本进行类型检查.
...
- [vue-local-storage-decorator](https://github.com/vip30/vue-local-storage-decorator) - 通过使用装饰器格式的本地存储来保存数据
- [vuex-module-decorators](https://github.com/championswimmer/vuex-module-decorators) - Typescript/ES7 装饰器使 Vuex 模块变得轻而易举
- [vuex-class-modules](https://github.com/gertqin/vuex-class-modules) - 受 vue-class-component 启发，为您的 vuex 模块引入简单的类型安全类样式语法.
- [vue-corator](https://github.com/joon610/vue-corator) -Vue typescript 装饰器实用程序
...
- [vue-resource-mock](https://github.com/noru/vue-resource-mock) - 基于 vue-resource 拦截器的模拟 http 响应的助手.
...
- [vue-async-properties](https://github.com/blainehansen/vue-async-properties) - 一个 `asyncData` 和 `asyncCompulated` 插件，支持去抖动、转换结果、错误处理程序、加载/挂起标志、惰性/急切请求.
...
- [vue-api-query](https://github.com/robsontenorio/vue-api-query) - 构建 REST API 请求的优雅而简单的方法.
...
- [rexios](https://github.com/Scrum/rexios) - 使用 Rest api 请求时，对 axios 的 url、数据、参数进行标准化.
- [vue-axillo](https://github.com/Scrum/vue-axillo) - 具有查询符号 GraphQL 的 REST API 的可组合 Axios.
...
- [vue-vroom](https://github.com/frederikbache/vue-vroom) - REST API 的插件，可让您快速生成类型安全存储和具有最少配置的模拟 API.
...
- [vue-multilanguage](https://github.com/leonardovilarinho/vue-multilanguage) - Vue.js 2 支持多种语言.
- [vue-ts-locale](https://github.com/twcapps/vue-ts-locale) - 一个用于在 Vue.js 2 中使用 Intl 实现翻译并支持打字稿的插件.
- [vue-i18next](https://github.com/panter/vue-i18next) - 支持 Vue.js 2 中翻译的 i18next 包装器.
- [vue-polyglot](https://github.com/guillaumevincent/vue-polyglot) - Vue.js 2 的基本翻译插件，具有异步加载功能.
- [v-localize](https://github.com/neetjn/v-localize) - 简单的本地化插件
  令人惊叹的 Vue.js.
- [vue-simple-i18n](https://github.com/ClassicOldSong/vue-simple-i18n) - 可能是最薄的库，将所有 Vue i18n 解决方案结束在 1kb 以内
- [template-string-i18n](https://github.com/cutsin/template-string-i18n) - 国际化使用模板字符串和自动保存/加载翻译文档.
- [vue-translations](https://github.com/owl1n/vue-translations) - 用它轻松翻译您的 vuejs 应用程序.
...
- [vue-translation-manager](https://github.com/cyon/vue-translation-manager)  - 在 Vue.js 应用程序中交互式查找和翻译字符串. 与 vue-18n 和 vuex-i18n 配合良好.
- [vue-t9n](https://github.com/Ni55aN/vue-t9n) - 翻译您的应用程序的最简单方法
- [vue-simple-inline-translation](https://github.com/alidrus/vue-simple-inline-translation) - 一个 Vue 组件，可简化文本翻译方式：通过内联翻译文本.
- [vue-i18n-extract](https://github.com/pixari/vue-i18n-extract)  - 通过静态分析管理 vue-i18n 本地化. 生成有关丢失和未使用的 i18n 条目的报告.
- [vscode-vue-i18n-ally](https://github.com/antfu/vue-i18n-ally) - VSCode 扩展以获得更好的 Vue-i18n 体验.
- [v-intl](https://github.com/vinayakkulkarni/v-intl) - 适用于您出色的 Vue 3 应用程序的 Global Intl 包装器
- [excel-vue-i18n](https://github.com/grafikri/excel-vue-i18n) - 一个插件将 excel 文件转换为 i18n json 格式以进行翻译.
- [vue-i18n-lite](https://github.com/FrontLabsOfficial/vue-i18n-lite) - 一个超轻量且最小的插件，通过简单的 API 将国际化引入您的 Vue.js 应用程序.
- [v-google-translate](https://github.com/i7eo/v-google-translate) - 使用谷歌翻译来国际化您的 Vue.js 应用程序的组件.
- [fluent-vue](https://github.com/Demivan/fluent-vue)  - Vue.js 的国际化插件（2 和 3）.  Vue.js 与 Fluent.js 的集成 - Project Fluent 的 JavaScript 实现
...
- [excel-to-json](https://github.com/Aaronlamz/excel-to-json) - 创建了一个简单的工具来将 Excel 转换为 i18n 的 JSON.
- [intlify/vue-i18n-next](https://github.com/intlify/vue-i18n-next) - 适用于 Vue 3 的 Vue I18n.
...
- [vue-bus](https://github.com/fffixed/vue-bus) - Vue.js 2 的小型简单中央事件总线插件.
...
- [vue-plugin-events](https://github.com/nolde/vue-plugin-events) - 用于具有自动订阅控制的 Vue.js 应用程序的简单全局事件总线.
- [vue3-custom-hooks](https://github.com/PoluosmakAndrew/vue3-custom-hooks) - 为 Vue.js 3 Composition API 构建自定义挂钩.
- [vue-catch-hrefs](https://github.com/Tahul/vue-catch-hrefs) - 捕获 href 链接（在 v-html 中）的点击并将其路由到 vue-router.
...
- [vue-ls](https://github.com/RobinCK/vue-ls) - Vue 插件，用于从 Vue 上下文使用 LocalStorage.
...
- [vue-universal-cookies](https://github.com/S64/vue-universal-cookies) Vue.js / Nuxt.js 的同构 cookies 插件支持 Browser、Express、http（节点）.
- [vue2-storage](https://github.com/yarkovaleksei/vue2-storage) Vue.js 应用程序的浏览器存储
- [vue-warehouse](https://github.com/bazzite/vue-warehouse) Vue.js 和 Nuxt.js 的跨浏览器存储，具有插件支持和基于 Store.js 的轻松扩展性.
...
- [vue-use-local-storage](https://github.com/HJ29/vue-use-local-storage) - 一个组合 API，用于将反应数据持久保存并补充到 vue 3 的本地存储中.
...
- [vue-ya-stash](https://github.com/qgp9/vue-ya-stash) - 另一个带有更新/补丁事件发射器的存储存储与 v-bind.sync 类似
...
- [tuex](https://github.com/Raiondesu/Tuex) - Vuex 的最合理的替代方案.
- [revuejs](https://github.com/dwqs/revuejs) - vuejs 2 的小型、轻便且方便的状态管理，编写更少的冗长代码.
- [lue](https://github.com/dwqs/lue) - 基于 Vue 和 vuex 的库，编写更少的冗长代码.
- [vuex-lite](https://github.com/rayraegah/vuex-lite) - 一个 1KB Vuex，只有状态和突变.
- [vue-shared](https://github.com/raizam/vue-shared) - vuex 的轻量且简单的替代品
- [vuex-module-generator](https://github.com/abdullah/vuex-module-generator) - 它允许您轻松创建 vuex 模块.
- [vuex-declaration](https://github.com/kbdsbx/vuex-declaration) - 像 props 一样声明状态，在组件创建时将状态动态注入到 vuex 中.
- [vuex-up](https://github.com/Hokid/vuex-up) - 将混合和服务注入器功能引入模块 vuex.
- [effector](https://github.com/zerobias/effector)  — 快速且强大的反应式状态管理器.  Effector 可让您编写简单、快速且类型安全的代码，并轻松管理反应状态.
- [nano-state-vue](https://gitlab.com/sophosoft/nano-state-vue) - 高效、有效且可扩展的状态管理：少即是多
...
- [v-bucket](https://github.com/mediv0/v-bucket) - 受 Vuex 启发，使用组合 API 构建的 Vue 3.0 的快速、简单和轻量级状态管理.
...
- [vuex-light](https://github.com/js-cosmos/vuex-light) - 具有针对 Vue 3 的强大类型的状态管理系统
...
- [vue-path-store](https://github.com/kouts/vue-path-store) - 使用点表示法路径语法的简单状态管理，还附带 Vuex 和 Pinia 插件.
- [pinia](https://github.com/posva/pinia) - 使用具有 DevTools 支持的组合 api 的直观、类型安全、轻便且灵活的 Vue 存储.
- [harlem](https://github.com/andrewcourtice/harlem) - Vue 3 的简单、无主见、轻量级且可扩展的状态管理
- [hami-vuex](https://github.com/guyskk/hami-vuex) - 哈密瓜风味的 Vuex，模块化设计，完全 TypeScript 智能，Vue.js 的状态管理.

##### Redux

- [vuedeux](https://github.com/Vuedeux/vuedeux) - Vue 和 Redux 的绑定解决方案.
  - [redux-store-mixin](https://github.com/kolesoffac/redux-store-mixin) - Mixin 用于在 vue-component 方法中集成动作创建者
  - [vue-redux-prepare-props](https://github.com/kolesoffac/vue-redux-prepare-props) - 使用 _Vuex_ 和 _Vuedeux_ 将 _Redux_ 与 _Vue.js_ 一起使用的助手
...
- [pinia-shared-state](https://github.com/wobsoriano/pinia-shared-state) - 一个轻量级插件，可跨浏览器选项卡同步您的 pinia 状态.
...
- [pinia-persistedstate](https://github.com/JD-Wang/pinia-persistedstate) - 使用 localStorage 持久保存 Vuex 状态，例如 vuex-persistedstate.
- [pinia-orm](https://github.com/CodeDredd/pinia-orm) - Pinia 插件，用于启用对 Pinia 商店的对象关系映射访问.
...
- [vue-facebook-account-kit](https://github.com/biessek/vue-facebook-account-kit) - fb 帐户工具包库的简单 vue 包装.
- [casl-vue](https://github.com/stalniy/casl/tree/master/packages/casl-vue) - 限制特定用户可以访问的资源
- [vue-google-api](https://github.com/vertcitron/vue-google-api) - 一个包装器，用于在任何 vue.js 2 项目中轻松集成 Google 的 API 客户端，基于 Promise，具有内置的 Oauth2“使用 Google 登录”设施.
- [vue-auth](https://github.com/websanova/vue-auth) - 一个简单的 Vue.js 轻量级身份验证库
- [vue-auth-plugin](https://github.com/d0whc3r/vue-auth-plugin) - 使用 typescript 的 Vue.js 的简单身份验证和授权库
- [vue-google-signin-button](https://github.com/phanan/vue-google-signin-button) - 一个简单的 Vue 插件，可将 Google 登录按钮包含到您的网络应用程序中
- [vue-facebook-signin-button](https://github.com/phanan/vue-facebook-signin-button) - 一个简单的插件，可将自定义 Facebook 登录按钮包含到您的网络应用程序中
- [vue-auth-href](https://github.com/nachodd/vue-auth-href) - 用于下载受保护路径模式下的文件的 VueJS 指令
- [vue-msal](https://github.com/mvertopoulos/vue-msal) - 用于使用 Microsoft 身份验证库 (MSAL) 的 Vue 插件
- [vue-simple-acl](https://github.com/victorybiz/vue-simple-acl) - 一个简单的无主见的 Vue 插件，用于管理用户角色和权限、访问控制列表（ACL）和基于角色的访问控制（RBAC）.
...
- [vuex-local](https://github.com/ktsn/vuex-local) - Vuex 内的本地状态管理.
- [vuex-action](https://github.com/varHarrie/vuex-action) - vuex 的实用程序可轻松创建和管理操作.
- [vuex-rest-api](https://github.com/christianmalek/vuex-rest-api)  - 一个帮助程序实用程序，用于简化 REST API 与 Vuex 的使用. 基于axios.
...
- [vuex-action-reload](https://github.com/chlab/vuex-action-reload) - 一个 vuex 插件，在满足条件时重新加载操作.
- [vuejs-storage](https://github.com/maple3142/vuejs-storage) - Vue.js 和 vuex 插件可使用 localStorage/sessionStorage 持久化数据.
...
- [Vuenut](https://github.com/lusaxweb/vuenut) - 是一个开发更快、更流畅的组件.
...
- [vuex-module-builder](https://github.com/oncebot/vuex-module-builder) - Vuex 模块构建器是一个包装器，用于通过内置的一些常用方法有效地编写 vuex 存储.
- [vuex-pagination](https://github.com/cyon/vuex-pagination)  - 在 Vue/Vuex 应用程序中轻松使用分页资源. 与大多数 Vue 分页组件配合良好.
- [vuex-easy-firestore](https://mesqueeb.github.io/vuex-easy-firestore/)  - Firebase Cloud Firestore 和 Vuex 的轻松耦合.  2 路同步，0 样板！
- [vuex-listener](https://github.com/TimurKiyivinski/vuex-listener) - 全局 Vuex 操作和突变侦听器插件
- [jsonapi-vuex](https://github.com/mrichar1/jsonapi-vuex) - 将 JSONAPI api 与 Vuex 存储结合使用，并进行客户端记录重组/规范化.
...
- [vuex-hooks](https://github.com/Goldziher/vuex-hooks) - Typescript 启用了 vuex 组合 API 挂钩.
...
- [vuex-masked-modules](https://github.com/Silksofthesoul/vuex-masked-modules)  - Vuex 插件将模块的数据结构放在 localStorage 中，能够屏蔽或加密数据以使其难以探索. 专为 Vue 3 和 Vuex 4 设计.

###### Sync Between Tabs

- [vuex-basement](https://github.com/RashadSaleh/vuex-basement) - Vuex 状态持久化以及选项卡/窗口之间的同步.
...
- [apollo-vue-devtools](https://github.com/storipress/apollo-vue-devtools) - Vue-Devtools 的 Apollo 集成，用于检查 vue-devtools 时间线中的 GraphQL 查询
...
- [vue-factory](https://github.com/ye-will/vue-factory) - Vue.js 的简单工厂/提供者扩展，就像 Angular 中的服务一样.
...
- [vue-slot-checker](https://github.com/mya-ake/vue-slot-checker) - 提供像检查道具一样检查槽位的功能.
...
- [fela-vue](https://github.com/houd1ni/fela-vue) - Vue 的 CSS-IN-JS mixin 专为灵活性和团队导向而设计.
- [j-vue](https://github.com/LongTengDao/j-vue/)
- [vue-spinners-css](https://github.com/JoshK2/vue-spinners-css) - 纯CSS vue spinners组件的集合，用于ajax的css spinners或基于loading.io的加载动画.
- [vue-css-doodle](https://github.com/LuXDAmore/vue-css-doodle) - 移植 css-doodle，这是一个使用 CSS 绘制图案的 Web 组件.

#### Asset Management

_用于构建/编译/捆绑/加载资产的实用程序_

- [vue-script2](https://github.com/taoeffect/vue-script2) - 为您的单页应用程序提供标准化、设计者友好的脚本标记行为.
...
- [vue-compiler](https://github.com/paulpflug/vue-compiler) - vue-component-compiler 周围的一个简单的 cli 包装器.
- [vue-brunch](https://github.com/nblackburn/vue-brunch) - 添加了对 Brunch 对预编译单文件 Vue 组件的支持.
...
- [vue-svg-loader](https://github.com/visualfanatic/vue-svg-loader) - webpack 加载器可让您使用 SVG 文件作为 Vue 组件
- [vue-registrar](https://github.com/AmirrezaNasiri/vue-registrar) - ☘️ 动态注册组件和 vuex 模块的包 - 使您的代码更具可读性！
- [vue-automatic-import-loader](https://github.com/hunterliu1003/vue-automatic-import-loader) - webpack 加载器，使用匹配函数自动导入 Vue 单文件组件.
- [vue-aimg-loader](https://github.com/chenxinan/vue-aimg-loader) - 一种在 Vue 模板中使用图像的简单方法，无需编写 css.
- [vite-svg-loader](https://github.com/jpkleemans/vite-svg-loader) - Vite 插件将 SVG 文件加载为 Vue 组件
- [vue-sfc-split](https://github.com/gVguy/vue-sfc-split) - 转换 SFC 以供本机浏览器使用，无需构建
...
- [vue-2-crumbs](https://github.com/Suruat/vue-2-crumbs)  - Vue.js 2 框架的面包屑插件，允许在路由元对象中选择父路由，而不需要子路由. 还允许使用动态数据.
...
- [vue-gaspard](https://github.com/lucaperret/vue-gaspard) - Vue.js 的 DOM 帮助器插件
- [vue-configuration](https://github.com/alex-oleshkevich/vue-config) - Vue.js 的静态配置对象
- [vue-lodash](https://github.com/Ewocker/vue-lodash) - 一个简单的包装器，用于将 lodash 集成到 Vue 2.
...
- [vue-messenger](https://github.com/fjc0k/vue-messenger) - 对 Vue 组件属性的一系列有用增强：转换、枚举类型、数字类型、双向数据绑定.
...
- [vue-subslot](https://github.com/privatenumber/vue-subslot) - Vue 组件可从插槽中选择您想要的内容
- [vue-timed-content](https://github.com/dannyfeliz/vue-timed-content) - 根据给定的时间范围和时区显示或隐藏内容.
- [vue-live](https://github.com/vue-styleguidist/vue-live) - 演示组件的组件，灵感来自react-live.
- [vue-safe-html](https://github.com/ecosia/vue-safe-html) - Vue.js 指令动态渲染经过净化的 HTML.
...
- [@skirtle/vue-vnode-utils](https://github.com/skirtles-code/vue-vnode-utils) - 用于在 Vue 3 渲染函数内使用插槽 VNode 的辅助函数

#### Web Workers

- [vue-worker](https://github.com/israelss/vue-worker) - 一个 Vue.js 插件，以简单的方式使用 webworkers.
- [vue-log-worker](https://gitlab.com/schoolmouv-open-source/vue-log-worker) - 一个 Vue.js 插件，用于通过网络工作者将错误和 vuex 突变记录到后端

#### JSX

- [jsx-vue-functional](https://github.com/nickmessing/babel-plugin-jsx-vue-functional) - 一个 Babel 插件，为 Vue 功能组件带来语法糖.
- [jsx-event-modifiers](https://github.com/nickmessing/babel-plugin-jsx-event-modifiers) - Babel 插件，向 JSX 添加类似于 Vue 模板的事件修饰符.
- [jsx-v-model](https://github.com/nickmessing/babel-plugin-jsx-v-model) - A Babel plugin that brings `v-model` to JSX.
- [vue-jsx-sync](https://github.com/njleonzhang/babel-plugin-vue-jsx-sync) - 一个 Babel 插件，将 vue“同步修饰符”引入 JSX.
- [vue2-jsx-runtime](https://github.com/LancerComet/vue2-jsx-runtime)  - 用于 TSC/SWC 的 Vue 2 新 JSX 转换运行时. 直接将 Vue 2 JSX 与 TSC/SWC 结合使用.
...
- [vue-socket-cluster](https://github.com/nigeltiany/vue-socket-cluster) - 通过套接字集群使用 uws（微型网络套接字）的 vue 的 Web 套接字
- [vue-native-websocket](https://github.com/nathantsoi/vue-native-websocket) - Vuejs 2 和 Vuex 的本机 websocket 实现
- [vue-socket.io-extended](https://github.com/probil/vue-socket.io-extended) - Vue.js 和 Vuex 的 Socket.io 绑定
- [vue-phoenix](https://github.com/vip30/vue-phoenix)  - vuejs 的 Elixir Phoenix Web Socket 实现. 还提供了 typescript 装饰器以更好地使用.
...
- [vue-paypal-checkout](https://github.com/khoanguyen96/vue-paypal-checkout) - 用于 paypal 结账的简单 Vue.js 包装组件.

##### Plaid

- [vue-plaid-link](https://github.com/roundupapp/vue-plaid-link) - 易于使用的 Plaid Link Vue 组件.
...
- [express-vue](https://github.com/danmademe/express-vue)  - Express.js 的 Vue 渲染引擎. 使用 res.render() 使用 .Vue 文件作为模板.
- [vue-grecaptcha](https://github.com/drozdzynski/vue-grecaptcha) - 适用于 VueJS 2 的 Google reCAPTCHA
...
- [vuefire](https://github.com/nigeltiany/vuefire) - 适用于 VueJS 和 Vuex 的 Firebase
- [vue-runkit](https://github.com/maple3142/vue-runkit) -Vue.js 的 RunKit 嵌入
- [vue-youtube](https://github.com/anteriovieira/vue-youtube) - 提供一个简单的图层供您在上面发挥您的想象力 [YouTube IFrame Player API](https://developers.google.com/youtube/iframe_api_reference) .  （兼容SSR）
...
- [vue-raven](https://github.com/anteriovieira/vue-raven) - 自动报告 vue 组件触发的未捕获的 JavaScript 异常.
...
- [vue-web3](https://github.com/morrislaptop/vue-web3) - Vue.js 的 Web3 区块链绑定（受到 Vuefire 和 Drizzle 的启发）
- [sbt-vuefy](https://github.com/GIVESocialMovement/sbt-vuefy) - Playframework 的 Vue.js 集成
- [loopback-vue-starter](https://github.com/ivandov/loopback-vue-starter) - LoopBack 和 Vue 入门模板，通过“vue-cli”和“vue ui”轻松进行插件管理.
...
- [feathers-vuex](https://github.com/feathers-plus/feathers-vuex)  - 是 Feathers 客户端和 Vuex 的一流集成. 它在底层实现了许多 Redux 最佳实践，消除了大量样板代码，并且仍然允许您轻松定制 Vuex 商店.
...
- [vue-zeye-client](https://github.com/zeye-ru/vue-zeye-client) - 一个Vue插件，方便使用 [Zeye-server](https://github.com/zeye-ru/zeye-server) 开源 mediasoup WebRTC SFU 服务器
- [vue-postgrest](https://github.com/technowledgy/vue-postgrest) - postgREST 的 Vue.js 集成：灵活、强大且易于使用.
- [Vuecket](https://github.com/OrienteerBAP/vuecket) - WebFramework 将 Vue.JS 的力量与魔法结合在一起 [Apache Wicket](https://wicket.apache.org/)
...
- [vuetube](https://github.com/webistomin/vuetube) - 一个快速、轻量级、延迟加载的 vue 组件，充当 YouTube Iframe 播放器 API 上的薄层，可快速渲染
- [vue-tweet](https://github.com/DannyFeliz/vue-tweet) - Vue 3 组件让您只需提供推文 ID 即可将推文嵌入到您的应用程序中
- [vue-dapp](https://github.com/chnejohnson/vue-dapp) - 用于使用 ethers.js 构建 Dapp 的 Vue 3 库.
- [vue3-recaptcha2](https://github.com/bbonch/vue3-recaptcha2) - 适用于 Vue 3 的 Google reCAPTCHA 2.
- [hugoVueSFC](https://github.com/indus/hugoVueSFC) - Vue 单文件组件（SFC） [Hugo](https://gohugo.io/).
...
- [vue-cli-plugin-docker-nginx](https://github.com/truefalse10/vue-cli-plugin-docker-nginx) - Vue CLI 插件，使用最小的 nginx 服务器添加 docker 部署
- [vue-cli-plugin-element](https://github.com/codetrial/vue-cli-plugin-element) - Vue CLI 插件可在几秒钟内使用 element-ui 构建企业应用程序
- [vue-cli-plugin-electron-builder](https://github.com/nklayman/vue-cli-plugin-electron-builder) - 适用于 Electron 的 Vue CLI 插件，无需使用 Electron Builder 进行配置.
...
- [vue-cli-plugin-kami](https://github.com/KamiMeow/vue-cli-plugin-kami) - Vue CLI 插件具有精心设计的架构，可快速启动您的应用程序
- [vue-cli-plugin-auto-alias](https://github.com/BryanAdamss/vue-cli-plugin-auto-alias) - Vue CLI 插件自动设置别名
- [vue-cli-plugin-clean](https://github.com/DevTony101/vue-cli-plugin-clean) - Vue CLI 插件可通过添加一些常用工具和模式来帮助您清理并快速设置 Vue 应用程序
...
- [vue-cli-plugin-chrome-extension-cli](https://github.com/sanyu1225/vue-cli-plugin-chrome-extension-cli) - Vue CLI插件生成chrome扩展模板
...
- [vue-gtm](https://github.com/mib200/vue-gtm) - Google 标签管理器的 Vue 插件
...
- [Storybook](https://storybook.js.org)  - UI 开发环境. 稍后可与 v3.2+ 配合使用.
- [Font Awesome Finder](https://chrome.google.com/webstore/detail/font-awesome-icon-finder/kjejboahkcobalmgldloeinebmbomgog) - Chrome 扩展程序可搜索、预览和选择 Font Awesome 图标，并将所选图标 HTML 代码和 Unicode 复制到剪贴板.
- [vue-dummy](https://github.com/paulcollett/vue-dummy) - 占位符文本和虚拟图像作为简单的“v-dummy”指令.
- [Bit](https://github.com/teambit/bit)  - 在项目之间管理和重用“vue”组件. 轻松隔离和共享任何项目的组件，而无需更改其源代码，组织精选的集合并安装在不同的项目中.
- [ComponentFixture](https://github.com/David-Desmaisons/ComponentFixture) - 是一个组件设计，用于开发和测试其他组件，自动绑定它们的道具.
...
- [vue-dom-hints](https://github.com/privatenumber/vue-dom-hints)  - 在 DOM 中获取提示. 最小的 Vue 开发工具替代品.
- [components-helper](https://github.com/tolking/components-helper) - 基于文档提供vue组件库的代码提示文件.
- [vue-unicorn-log](https://github.com/webdevnerdstuff/vue-unicorn-log) - 一个 Vue 2 神奇插件，使（开发工具）控制台输出的着色变得更容易、更灵活. [Vue 3 version](https://github.com/webdevnerdstuff/vue3-unicorn-log) 版本也可以..

#### Inspect

_检查与调试_

- [Vue.js devtools](https://github.com/vuejs/vue-devtools) - 用于调试 Vue.js 应用程序的 Chrome 开发工具扩展.
...
- [vue-inspector](https://github.com/calirojas506/vue-inspector) - 适用于移动设备的 Vue.js 检查器
...
- [bruit-io](https://github.com/Moventes/bruit.io) - 通过屏幕截图和技术数据收集反馈，并将其发布到 API，例如 [bruit.io](https://bruit.io).
...
- [vue-styleguidist](https://github.com/vue-styleguidist/vue-styleguidist) - Vue 组件的风格指南生成器，带有生活风格指南.
...
- [jsdoc-vue-component](https://github.com/ccqgithub/jsdoc-vue-component) - 一个 jsodc3 插件，可提取 vue SFC 信息（名称、道具、事件...）以记录.
...
- [vue-dotmd-loader](https://github.com/mengdu/vue-dotmd-loader) - 一个 webpack 加载器，用于将加载器 markdown 文件转换为 vue 文件.
...
- [vue-a2b](https://github.com/fromAtoB/vue-a2b)  - 使用 Vue.js 进行拆分测试的库（A/B 测试）. 高度可配置且小巧（1.2k gzip 压缩）.
- [vue-test-utils](https://github.com/vuejs/vue-test-utils) - 用于测试 Vue 组件的官方实用程序.
- [vue-test-actions](https://github.com/biigpongsatorn/vue-test-actions) - 使用 Jest 模拟对 Vuex 操作进行单元测试.
...
- [Vue Testing Library](https://github.com/testing-library/vue-testing-library)  - 简单而完整的测试实用程序，鼓励良好的测试实践. 基于 DOM 测试库并基于官方 Vue Test Utils 构建.
...
- [vue-node](https://github.com/knpwrs/vue-node) - 在node.js中加载vue组件.
...
- [Vim Vue](https://github.com/posva/vim-vue) - Vue.js 组件的语法突出显示.
...
- [Ionic Snippets](https://github.com/moduslabs/ionic/tree/master/packages/ionic-vetur) - Vetur 对离子组件的支持
...
_脚手架/样板/种子/入门套件/堆栈整体/Yeoman 生成器_

- [vue-cli](https://github.com/vuejs/vue-cli) - 用于搭建 Vue.js 项目的简单 CLI.
- [Vue-Django](https://github.com/NdagiStanley/vue-django) - 一个样板文件，帮助您将 VueJS 的强大功能带入 Django (Python) 应用程序中.
...
- [nuxt-seed](https://github.com/dulin666/nuxt-seed) - nuxt-seed 对于那些希望使用 Vue 和 Nuxt 启动并运行的人来说是最小的种子
- [rails_vue_melt](https://github.com/midnightSuyama/rails_vue_melt) - 使用 webpack=vue 优化器的 Rails 视图.
- [vue-starter](https://github.com/rohitkrai03/vue-starter) - Vue.js 入门套件，可让您专注于更多编程和更少配置.
- [vuejs-wordpress-theme-starter](https://github.com/EvanAgee/vuejs-wordpress-theme-starter) - 一个 WordPress 主题，去掉了内容并用 Vue 取代
- [Cordovue](https://github.com/TheMushrr00m/cordovue) - 使用 Vue 的示例 Apache Cordova 应用程序.
- [Cookiecutter-Django-Vue](https://github.com/vchaptsev/cookiecutter-django-vue) - Django+VueJS+Docker 可定制项目生成器，具有大量设置/集成
- **[iBiu](https://github.com/bobiscool/iBiu)** 一个可视化 CLI，可在 2 秒内搭建大型 Vue 项目.
...
- [vue-firebase-element-ui-scaffold](https://scaffoldhub.io/vue-firebase) - 在线和可视化 Vue 2、Element-UI 和 Firebase 脚手架/生成器，具有 CRUD、身份验证、文件/图像上传、活动日志等.
- [vuesion](https://github.com/vuesion/vuesion) - Vuesion 是一个样板文件，可以帮助产品团队比以往更快地构建，减少麻烦，并提供跨工程和设计的现代最佳实践.
- [vue-vuex-typescript-webpack-seed](https://github.com/IsraelZablianov/vue-vuex-typescript-webpack-seed) - 一个带有 Vue、Vuex、Typescript、Scss 和 Webpack 的种子项目，具有热重载功能
...
- [Huncwot](https://github.com/zaiste/huncwot) - Vue.js 样板与 Node.js，用于使用“包含电池”方法构建现代 JavaScript 应用程序.
- [wemake-vue-template](https://github.com/wemake-services/wemake-vue-template)  - 前沿的 vue 模板专注于代码质量和开发人员的幸福感. 特色：nuxt、flow 和 jest.
...
- [vue-enterprise-boilerplate](https://github.com/chrisvfritz/vue-enterprise-boilerplate) - 使用 Vue CLI 3 为新的 Vue SPA 项目提供不断发展、非常固执的架构和开发环境.
...
- [vuejs-vuetify-structured-template boilerplate](https://github.com/huogerac/crud-vuetify-structured-template) - 用于功能齐全的 Vuejs + Vuetify 的 vue-cli 模板 + 出色的结构 + API Ready
- [vue-component-starter](https://github.com/peterroe/vue-component-starter) - 帮助您创建 vue3.x 组件的模板.
- [Vue3-SPA-starter-template](https://github.com/M-Media-Group/Vue3-SPA-starter-template) - 入门套件，包含 Router、Pinia、i18n、Stripe、Event Bus、SEO 元和模式标签处理等.
...
- [Vue Settler](https://github.com/weavingbird/vue-settler) - 一个固执己见的 Vue 2.0 SPA 入门者.
- [vue-multiple-pages](https://github.com/Plortinus/vue-multiple-pages) - 使用 Vue 2、Webpack2 和 Element-UI 的现代 Vue.js 多页面启动器
- [vue-typescript-boilerplate](https://github.com/twcapps/vue-typescript-boilerplate) - 带有 Vue 2、Vue Typed、Vuex、Vue Router 和本地化的 Vue.js typescript SPA 入门程序
...
- [Friendly Vue Starter](https://github.com/mcongy/friendly-vue-starter) - 一个功能齐全的 Vue.js 入门项目，通过 Apollo 客户端提供 GraphQL 支持（Vuex、Vue-router、Vue-i18n、Webpack 3、Eslint、Prettier...）
...
- [vue-cli-template-github-pages](https://github.com/julon/vue-cli-template-github-pages) - 使用 travisCI 进行 Github 页面部署的全功能 Webpack + vue-loader 设置.
...
- [**vue-auth-boilerplate**](https://github.com/VPetar/vue-auth-boilerplate)  - 具有 Router/Vuex/CLI3 和身份验证功能的 Vue SPA 样板（看起来很酷的注册和登录）. 开箱即用，只需最少的设置即可使用 [**laravel-api-boilerplate-jwt**](https://github.com/VPetar/laravel-api-boilerplate-jwt).
- [**vue-atomic-design**](https://github.com/alexander-elgin/vue-atomic-design) - 基于原子设计方法的 Vue 前端样板.
- [vue3-compact-template](https://github.com/upupming/vue3-compact-template) - ⚡️ 一个简单紧凑的 vue 3 模板，具有当前最先进的前端技术.

#### Universal

_将 Vue 应用程序渲染为服务器上的 HTML 和浏览器中的 DOM_

- [SPA Starter Kit](https://github.com/codecasts/spa-starter-kit) - 一个备受好评的入门套件，用于使用 Laravel 和 Vue.js 构建单页应用程序.
...
- [Vueniverse](https://github.com/rlindskog/vueniverse) - 一个功能齐全的通用 Vue 模板，适用于基于用户的应用程序，由 Nuxt.js 和 Express 提供支持.
- [vue-preload](https://github.com/shershen08/vue-preload) - 一个用于添加`的插件Vue
- [Vue.js/Nuxt.js full-featured boilerplate](https://github.com/GrabarzUndPartner/gp-vue-boilerplate) - 专业机构前端模板，用于通过 vuejs/nuxtjs 构建快速、强大且适应性强的 Web 应用程序或网站.
...
- [vue-apollo-connector-kit](https://github.com/ecerroni/apollo-connector-kit)  - 使用 2 种不同策略（localStorage 和 httpOnly cookie）的 JWT 身份验证. 使用自定义指令授权（apollo）.
...
- [isomor-vue-app](https://github.com/apiel/isomor#getting-started-with-vue) - 使用Vue和isomor搭建工作环境，通过自动生成API来统一前后端.

#### Electron

- [Electron Vue](https://github.com/SimulatedGREG/electron-vue) - Electron 和 Vue.js 快速启动样板，包含 vue-cli 脚手架、常见 Vue 插件、电子打包器/电子构建器、单元/e2e 测试、vue-devtools 和 webpack.
- [VuePack](https://github.com/egoist/vuepack) - 使用 Vue 2、Vuex、Vue-router 和 Webpack 2（甚至 Electron）的现代入门程序.
- [vue-flexible-link](https://github.com/saintplay/vue-flexible-link)  - Electron 的微型 Vue 组件，用于在浏览器中打开链接. 跨环境应用程序（Web 和本机）的理想选择
- [vuelectron](https://github.com/rachmanzz/vuelectron) - vue 的 electrojs 入门套件.
...
- [electron-vue3-flask](https://github.com/megasanjay/electron-vue3-flask) - Electron 和 Vue.js 应用程序启动模板，通过 Flask 使用 python 后端进行桌面应用程序构建.
- [electron-vite-template](https://github.com/umbrella22/electron-vite-template)  - 使用 Vue 3、Vite 和 Electron 的现代桌面应用程序项目模板.  **它很快！**
- [Vitectron](https://github.com/hyroge/vite-vue-electron) - 功能强大且现代的 Vue 桌面应用程序模板，带有 TypeScript 和 JSX + Vue 3.x + Vite 2.x + Pinia 2.x + Vue-Router 4.x.
...
- [vue-component-generator](https://github.com/lakb248/vue-component-generator) - vue组件生成器，支持Vue1.X和Vue2.X.
...
- [vue-component-boilerplate](https://github.com/codetheorist/vue-component-boilerplate) - 用于生成 VueJS 组件样板代码的模板，带有预安装的构建脚本和测试.
...
- [vue-prerender](https://github.com/eldarc/vue-prerender) - 一个 Vue.js 定制插件，它实现了使用 headless chrome 预渲染 Vue.js 页面的三种策略.
- [Rendora](https://github.com/rendora/rendora) - 使用无头 Chrome 的动态 SSR（服务器端渲染）轻松解决现代 javascript 网站的 SEO 问题
- [pre-vue](https://github.com/mtlynch/pre-vue) - 一个样板 Vue + Nuxt 项目，为 OpenGraph 标签、Google Analytics、站点地图和 robots.txt 提供内置支持.
- [ssr-vuejs-nodejs](https://github.com/gustavoSoriano/ssr-vuejs-nodejs) - 服务器端使用nodejs渲染vuejs，无需Nuxt.
