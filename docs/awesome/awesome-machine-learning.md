...
* [DeepDetect](https://github.com/jolibrain/deepdetect)   - 用C ++ 11编写的机器学习API和服务器.  它使最先进的机器学习易于使用并集成到现有的应用程序中.
* [Distributed Machine learning Tool Kit (DMTK)](http://www.dmtk.io/)   -  Microsoft的分布式机器学习（参数服务器）框架.  在多台计算机上启用大型数据集的培训模型.  与之捆绑的当前工具包括：LightLDA和分布式（多重）字嵌入.
...
* [LKYDeepNN](https://github.com/mosdeo/LKYDeepNN)   - 仅限标头的C ++ 11神经网络库.  低依赖，原生传统中文文件.
...
* [snowball](https://github.com/tebeka/snowball) - 围棋投票.
...
* [go-ngram](https://github.com/Lazin/go-ngram)   - 带压缩的内存n-gram索引.  * [已过时] *
* [paicehusk](https://github.com/Rookii/paicehusk)   -  Golang实现Paice / Husk词干算法.  * [已过时] *
...
* [leaves](https://github.com/dmitryikh/leaves) -  GBRT预测部分的纯Go实现，包括XGBoost和LightGBM.
...
* [go-geom](https://github.com/twpayne/go-geom) - 去库处理几何.
* [gogeo](https://github.com/golang/geo) -  Go中的球形几何体.
...
* [gonum/stat](https://godoc.org/gonum.org/v1/gonum/stat) - 统计库.
...
* [GoCV](https://github.com/hybridgroup/gocv) - 使用OpenCV 4及更高版本的计算机视觉包. 
...
* [ZingChart](https://www.zingchart.com/) - 在Vanilla JS上编写的用于大数据可视化的库.
...
* [Brain.js](https://github.com/BrainJS/brain.js) -  JavaScript中的神经网络 - 继续的社区分支 [Brain](https://github.com/harthur/brain).
...
* [stdlib](https://github.com/stdlib-js/stdlib)   -  JavaScript和Node.js的标准库，重点是数值计算.  该库为数学，统计，流，实用程序等提供了一系列强大的高性能库.
...
* [Flux](https://fluxml.ai/)  - 放松！  Flux是ML库，不会让你张紧
...
* [Word Tokenizers](https://github.com/JuliaText/WordTokenizers.jl) - 朱莉娅自然语言处理的标记符
* [Corpus Loaders](https://github.com/JuliaText/CorpusLoaders.jl) -  julia包为各种NLP语料库提供各种装载机.
* [Embeddings](https://github.com/JuliaText/Embeddings.jl) - 用于加载各种字嵌入的函数和数据依赖性
* [Languages](https://github.com/JuliaText/Languages.jl) -  Julia包，用于处理各种人类语言
* [WordNet](https://github.com/JuliaText/WordNet.jl) - 普林斯顿WordNet的Julia软件包
...
* [Torch7](http://torch.ch/)
  ...
  * [vowpalwabbit](https://github.com/clementfarabet/vowpal_wabbit)   - 火炬的旧vowpalwabbit接口.  ** [已过时] **
...
* [DeepPavlov](https://github.com/deepmipt/DeepPavlov/) - 具有许多预训练俄罗斯NLP模型的会话AI库.
...
* [Pebl](https://github.com/abhik/pebl/)   - 贝叶斯学习的Python环境.  ** [已过时] **
...
* [visualize_ML](https://github.com/ayush1997/visualize_ML)   - 用于数据探索和数据分析的python包.  ** [已过时] **
* [scikit-plot](https://github.com/reiinakano/scikit-plot) - 可视化库，用于快速轻松地生成数据分析和机器学习中的常用图.
* [Bowtie](https://github.com/jwkvam/bowtie) - 用于交互式可视化的仪表板库，使用烧瓶socketio并做出反应.
* [lime](https://github.com/marcotcr/lime)   -  Lime是关于解释机器学习分类器（或模型）正在做什么.  它能够解释任何具有两个或更多类的黑盒分类器.
* [PyCM](https://github.com/sepandhaghighi/pycm) -  PyCM是一个用Python编写的多类混淆矩阵库，支持输入数据向量和直接矩阵，是支持大多数类和整体统计参数的分类后模型评估的合适工具
* [Dash](https://github.com/plotly/dash) - 用于创建基于Plotly.js，React和Flask的分析Web应用程序的框架
* [Lambdo](https://github.com/asavinov/lambdo) - 通过在一个分析管道中组合来解决机器学习问题的工作流引擎（i）特征工程和机器学习（ii）模型训练和预测（iii）通过用户定义（Python）函数的表格填充和列评估.
* [TensorWatch](https://github.com/microsoft/tensorwatch)   - 用于机器学习和数据科学的调试和可视化工具.  它广泛利用Jupyter Notebook在运行过程（如机器学习培训）中显示数据的实时可视化.
...
* [scikit-learn tutorials](https://github.com/GaelVaroquaux/scikit-learn-tutorial) - 用于学习scikit-learn的笔记本系列.
* [sentiment-analyzer](https://github.com/madhusudancs/sentiment-analyzer) - 推文Sentiment Analyzer
* [sentiment_classifier](https://github.com/kevincobain2000/sentiment_classifier) - 使用词义消歧的情感分类器.
* [group-lasso](https://github.com/fabianp/group_lasso) - 使用（稀疏）Group Lasso模型中使用的坐标下降算法进行的一些实验.
* [jProcessing](https://github.com/kevincobain2000/jProcessing)   - 汉字/平假名/片假名到罗马字转换器.  Edict字典和平行句子搜索.  两个JP句子之间的句子相似性.  日本文本的情感分析.  在Python中运行Cabocha（ISO  -  8859-1配置）.
* [mne-python-notebooks](https://github.com/mne-tools/mne-python-notebooks) - 使用mne-python进行EEG / MEG数据处理的IPython笔记本.
* [Neon Course](https://github.com/NervanaSystems/neon_course) - 关于理解Nervana霓虹灯的完整课程的IPython笔记本.
...
* [Allen Downey’s Data Science Course](https://github.com/AllenDowney/DataScience) -  2014年春季奥林学院数据科学代码.
* [Allen Downey’s Think Bayes Code](https://github.com/AllenDowney/ThinkBayes) -  Think Bayes的代码库.
* [Allen Downey’s Think Complexity Code](https://github.com/AllenDowney/ThinkComplexity) -  Allen Downey的书Think Complexity的代码.
...
* [wiki challenge](https://github.com/hammer/wikichallenge) - 戴尔张解决维基百科对Kaggle的参与挑战的解决方案.
...
* [kaggle-cifar](https://github.com/zygmuntz/kaggle-cifar) -  Kaggle的CIFAR-10比赛代码使用cuda-convnet.
...
* [Kaggle Dogs vs. Cats](https://github.com/kastnerkyle/kaggle-dogs-vs-cats) -  Kaggle Dogs vs. Cats比赛代码.
* [Kaggle Galaxy Challenge](https://github.com/benanne/kaggle-galaxies) - 在Kaggle上获得Galaxy Challenge的解决方案.
* [Kaggle Gender](https://github.com/zygmuntz/kaggle-gender) -  Kaggle比赛：根据笔迹区分性别.
* [Kaggle Merck](https://github.com/zygmuntz/kaggle-merck) - 默克在Kaggle挑战.
* [Kaggle Stackoverflow](https://github.com/zygmuntz/kaggle-stackoverflow) - 预测Stack Overflow上的封闭式问题.
* [kaggle_acquire-valued-shoppers-challenge](https://github.com/MLWave/kaggle_acquire-valued-shoppers-challenge) -  Kaggle的代码获得了有价值的购物者挑战.
* [wine-quality](https://github.com/zygmuntz/wine-quality) - 预测葡萄酒质量.

<a name="python-reinforcement-learning"></a>
#### Reinforcement Learning
* [DeepMind Lab](https://github.com/deepmind/lab)   -  DeepMind Lab是一个3D学习环境，基于id Software的Quake III Arena，通过ioquake3和其他开源软件.  其主要目的是充当人工智能研究的试验平台，尤其是深层强化学习.
* [Gym](https://github.com/openai/gym) -  OpenAI Gym是一个用于开发和比较强化学习算法的工具包.
* [Serpent.AI](https://github.com/SerpentAI/SerpentAI)   -  Serpent.AI是一个游戏代理框架，允许您将您拥有的任何视频游戏转换为沙箱，以开发AI和机器学习实验.  对于研究人员和业余爱好者. 
* [ViZDoom](https://github.com/mwydmuch/ViZDoom)   -  ViZDoom允许开发仅使用可视信息（屏幕缓冲区）播放Doom的AI机器人.  它主要用于机器视觉学习和深度强化学习的研究.
* [Roboschool](https://github.com/openai/roboschool) - 用于机器人模拟的开源软件，与OpenAI Gym集成.
* [Retro](https://github.com/openai/retro) - 健身房的复古游戏
* [SLM Lab](https://github.com/kengz/SLM-Lab) -  PyTorch中的模块化深度强化学习框架.
* [Coach](https://github.com/NervanaSystems/coach) - 英特尔®AI实验室的强化学习教练可以使用最先进的强化学习算法轻松进行实验
...
* [Awesome NLP with Ruby](https://github.com/arbox/nlp-with-ruby) -  Ruby中实用自然语言处理的策划链接列表.
...
* [Arel](https://github.com/nkallen/arel) ** [已过时] **

<a name="ruby-misc"></a>
#### Misc

* [Big Data For Chimps](https://github.com/infochimps-labs/big_data_for_chimps)
* [Listof](https://github.com/kevincobain2000/listof)   - 基于社区的数据收集，包装在宝石中.  获取txt，json或hash中几乎所有内容（停用词，国家/地区，非单词）的列表. [Demo/Search for a list](http://kevincobain2000.github.io/listof/)
...
#### General-Purpose Machine Learning
* [deeplearn-rs](https://github.com/tedsta/deeplearn-rs) -  deeplearn-rs提供简单的网络，在MIT许可下使用矩阵乘法，加法和ReLU.
* [rustlearn](https://github.com/maciejkula/rustlearn) - 一个机器学习框架，具有逻辑回归，支持向量机，决策树和随机森林.
* [rusty-machine](https://github.com/AtheMathmo/rusty-machine) - 纯粹的机器学习库.
...
* [RustNN](https://github.com/jackm321/RustNN)   -  RustNN是一个前馈神经网络库.  ** [已过时] **
* [RusticSOM](https://github.com/avinashshenoy97/RusticSOM) - 自组织地图（SOM）的Rust库.
...
* [ahaz](https://cran.r-project.org/web/packages/ahaz/index.html)   -  ahaz：半参数加性危险回归的正则化.  ** [已过时] **
...
* [bmrm](https://cran.r-project.org/web/packages/bmrm/index.html) -  bmrm：规范风险最小化包的捆绑方法.
...
* [caret](https://topepo.github.io/caret/index.html) - 分类和回归训练：R中~150 ML算法的统一接口
* [caretEnsemble](https://cran.r-project.org/web/packages/caretEnsemble/index.html)   -  caretEnsemble：用于拟合多个插入符号模型以及创建此类模型的集合的框架.  ** [已过时] **
* [CatBoost](https://github.com/catboost/catboost) - 决策树库上的通用梯度增强，具有开箱即用的分类特征支持.
...
* [CoxBoost](https://cran.r-project.org/web/packages/CoxBoost/index.html) -  CoxBoost：通过基于可能性的单一生存终点提升或竞争风险的Cox模型** [已弃用] **
* [Cubist](https://cran.r-project.org/web/packages/Cubist/index.html) - 立体主义：基于规则和实例的回归建模.
...
* [elasticnet](https://cran.r-project.org/web/packages/elasticnet/index.html) -  elasticnet：用于稀疏估计和稀疏PCA的弹性网络.
* [ElemStatLearn](https://cran.r-project.org/web/packages/ElemStatLearn/index.html) -  ElemStatLearn：书中的数据集，函数和例子：Trevor Hastie，Robert Tibshirani和Jerome Friedman的“统计学习，数据挖掘，推理和预测的要素”，作者：Trevor Hastie，Robert Tibshirani和Jerome Friedman.
* [evtree](https://cran.r-project.org/web/packages/evtree/index.html) -  evtree：全球最优树的进化学习.
* [forecast](https://cran.r-project.org/web/packages/forecast/index.html) - 预测：使用ARIMA，ETS，STLM，TBATS和神经网络模型进行时间序列预测.
* [forecastHybrid](https://cran.r-project.org/web/packages/forecastHybrid/index.html) -  forecastHybrid：来自“预测”包的ARIMA，ETS，STLM，TBATS和神经网络模型的自动集合和交叉验证.
* [fpc](https://cran.r-project.org/web/packages/fpc/index.html) -  fpc：灵活的群集程序.
* [frbs](https://cran.r-project.org/web/packages/frbs/index.html)   -  frbs：基于模糊规则的分类和回归任务系统.  ** [已过时] **
* [GAMBoost](https://cran.r-project.org/web/packages/GAMBoost/index.html)   -  GAMBoost：基于可能性增强的广义线性和附加模型.  ** [已过时] **
* [gamboostLSS](https://cran.r-project.org/web/packages/gamboostLSS/index.html) -  gamboostLSS：GAMLSS的推进方法.
...
* [maptree](https://cran.r-project.org/web/packages/maptree/index.html)   -  maptree：映射，修剪和绘制树模型.  ** [已过时] **
...
* [penalized](https://cran.r-project.org/web/packages/penalized/index.html) - 惩罚：在GLM和Cox模型中L1（套索和融合套索）和L2（脊）惩罚估计.
...
* [rdetools](https://cran.r-project.org/web/packages/rdetools/index.html)   -  rdetools：特征空间中的相关维度估计（RDE）.  ** [已过时] **
* [REEMtree](https://cran.r-project.org/web/packages/REEMtree/index.html)   -  REEMtree：具有纵向（面板）数据随机效应的回归树.  ** [已过时] **
* [relaxo](https://cran.r-project.org/web/packages/relaxo/index.html)   -  relaxo：轻松的套索.  ** [已过时] **
...
* [Rmalschains](https://cran.r-project.org/web/packages/Rmalschains/index.html) -  Rmalschains：使用Me中的局部搜索链（MA-LS-Chains）进行连续优化.
* [rminer](https://cran.r-project.org/web/packages/rminer/index.html)   -  rminer：在分类和回归中更简单地使用数据挖掘方法（例如NN和SVM）.  ** [已过时] **
* [ROCR](https://cran.r-project.org/web/packages/ROCR/index.html)   -  ROCR：可视化评分分类器的性能.  ** [已过时] **
...
* [spectralGraphTopology](https://cran.r-project.org/web/packages/spectralGraphTopology/index.html) -  spectralGraphTopology：通过光谱约束从数据中学习图形.
...
* [XGBoost.R](https://github.com/tqchen/xgboost/tree/master/R-package) - 用于极限渐变增强（树）库的R绑定.
* [Optunity](https://optunity.readthedocs.io/en/latest/)   - 一个专用于自动超参数优化的库，它具有简单，轻量级的API，便于直接替换网格搜索.  Optunity是用Python编写的，但与R无缝连接.
...
* [Visual Data Mining and Machine Learning](https://www.sas.com/en_us/software/visual-data-mining-machine-learning.html)   - 从数据准备到部署，使用最新的机器学习算法和端到端分析环境进行交互式，自动化和程序化建模.  免费试用.
* [Enterprise Miner](https://www.sas.com/en_us/software/enterprise-miner.html) - 使用GUI或代码创建可部署模型的数据挖掘和机器学习.
* [Factory Miner](https://www.sas.com/en_us/software/factory-miner.html) - 使用GUI自动在众多市场或客户群中创建可部署的机器学习模型.

<a name="sas-data-analysis"></a>
#### Data Analysis / Data Visualization

* [SAS/STAT](https://www.sas.com/en_us/software/stat.html) - 进行高级统计分析.
* [University Edition](https://www.sas.com/en_us/software/university-edition.html)  - 自由！  包括数据分析和可视化所需的所有SAS软件包，并包括在线SAS课程.
...
* [enlighten-integration](https://github.com/sassoftware/enlighten-integration) - 示例代码和材料，说明了在Java，PMML，Python和R中集成SAS与其他分析技术的技术.
* [enlighten-deep](https://github.com/sassoftware/enlighten-deep) - 示例代码和材料，说明在SAS中使用具有多个隐藏层的神经网络.
* [dm-flow](https://github.com/sassoftware/dm-flow) -  SAS Enterprise Miner流程图库，可帮助您通过示例了解特定的数据挖掘主题.
...
* [Summing Bird](https://github.com/twitter/summingbird) - 用烫伤和风暴流式传输MapReduce.
* [Algebird](https://github.com/twitter/algebird) -  Scala的抽象代数.
* [xerial](https://github.com/xerial/xerial)   -  Scala的数据管理实用程序.  ** [已过时] **
* [PredictionIO](https://github.com/apache/predictionio) -  PredictionIO，一款面向软件开发人员和数据工程师的机器学习服务器.
* [BIDMat](https://github.com/BIDData/BIDMat) -  CPU和GPU加速矩阵库旨在支持大规模探索性数据分析.
* [Flink](https://flink.apache.org/) - 用于分布式流和批量数据处理的开源平台.
* [Spark Notebook](http://spark-notebook.io) - 使用Scala和Spark的交互式和反应式数据科学.

<a name="scala-general-purpose"></a>
#### General-Purpose Machine Learning

* [DeepLearning.scala](https://deeplearning.thoughtworks.school/) - 从面向对象和函数编程结构创建静态类型的动态神经网络.
* [Conjecture](https://github.com/etsy/Conjecture) - 在烫伤中可扩展的机器学习.
* [brushfire](https://github.com/stripe/brushfire) -  Scala中的分布式决策树集成学习.
* [ganitha](https://github.com/tresata/ganitha)   - 烫机动力机器学习.  ** [已过时] **
...
* [H2O Sparkling Water](https://github.com/h2oai/sparkling-water) -  H2O和Spark互操作性.
* [FlinkML in Apache Flink](https://ci.apache.org/projects/flink/flink-docs-master/dev/libs/ml/index.html) -  Flink中的分布式机器学习库.
* [DynaML](https://github.com/transcendent-ai-labs/DynaML) - 用于机器学习研究的Scala Library / REPL.
* [Saul](https://github.com/CogComp/saul) - 灵活的基于声明学习的编程.
* [SwiftLearner](https://github.com/valdanylchuk/swiftlearner/) - 简单编写的算法，以帮助研究ML或编写自己的实现.
...
* [layer](https://github.com/cloudkj/layer) - 来自命令行的神经网络推断，实现于 [CHICKEN Scheme](https://www.call-cc.org/).
...
* [swix](https://github.com/stsievert/swix)   - 一个裸骨库，包含一般矩阵语言，并包含一些OpenCV用于iOS开发.  ** [已过时] **
* [AIToolbox](https://github.com/KevinCoble/AIToolbox) - 用Swift编写的AI模块的工具箱框架：图形/树，线性回归，支持向量机，神经网络，PCA，KMeans，遗传算法，MDP，高斯混合.
* [MLKit](https://github.com/Somnibyte/MLKit)   - 一个用Swift编写的简单机器学习框架.  目前具有简单线性回归，多项式回归和岭回归的特征.
* [Swift Brain](https://github.com/vlall/Swift-Brain)   - 用Swift编写的第一个神经网络/机器学习库.  这是一个用于iOS和OS X开发的Swift中AI算法的项目.  该项目包括侧重于贝叶斯定理，神经网络，SVM，矩阵等的算法......
* [Perfect TensorFlow](https://github.com/PerfectlySoft/Perfect-TensorFlow)   -  TensorFlow的Swift语言绑定.  在macOS / Linux上使用原生TensorFlow模型.
* [PredictionBuilder](https://github.com/denissimon/prediction-builder-swift) - 用于机器学习的库，使用线性回归构建预测.
* [Awesome CoreML](https://github.com/SwiftBrain/awesome-CoreML-models) - 训练有素的CoreML模型的精选列表.
...
#### Neural Networks
* [layer](https://github.com/cloudkj/layer) - 来自命令行的神经网络推断

<a name="tools-misc"></a>
#### Misc
* [ML Workspace](https://github.com/ml-tooling/ml-workspace)   - 用于机器学习和数据科学的一体化基于Web的IDE.  工作空间被部署为docker容器，并预装有各种流行的数据科学库（例如，Tensorflow，PyTorch）和开发工具（例如，Jupyter，VS Code）.
* [Notebooks](https://github.com/rlan/notebooks)   - 用于Jupyter笔记本和机器学习的入门套件.  Companion docker图像包含python版本，机器学习框架（Keras，PyTorch和Tensorflow）和CPU / CUDA版本的所有组合.
* [DVC](https://github.com/iterative/dvc)   -  Data Science Version Control是一个开源版本控制系统，用于支持管道的机器学习项目.  它使ML项目具有可重复性和可共享性.

<a name="credits"></a>
## Credits

*一些python库是剪切和粘贴 [vinta](https://github.com/vinta/awesome-python)
* Go的参考文献大多是剪切和粘贴 [gopherdata](https://github.com/gopherdata/resources/tree/master/tooling)
