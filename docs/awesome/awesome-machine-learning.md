...
* [cONNXr](https://github.com/alrevuelta/cONNXr)  -用纯C（99）编写的“ ONNX”运行时，零相关性集中在小型嵌入式设备上.  无论您使用哪种框架训练，都可以对机器学习模型进行推断.  易于安装并在任何地方编译，即使在非常旧的设备中也是如此.
...
* [VIGRA](https://github.com/ukoethe/vigra) -VIGRA是通用的跨平台C ++计算机视觉和机器学习库，用于使用Python绑定的任意维度的卷.
...
* [CatBoost](https://github.com/catboost/catboost)  -带有分类功能的决策树库具有通用梯度提升功能，开箱即用.  它易于安装，包含快速推理实现，并支持CPU和GPU（甚至是多GPU）计算.
* [CNTK](https://github.com/Microsoft/CNTK) -Microsoft Research的计算网络工具包（CNTK）是一个统一的深度学习工具包，该工具包通过有向图将神经网络描述为一系列计算步骤.
...
* [DSSTNE](https://github.com/amznlabs/amazon-dsstne) -亚马逊创建的软件库，用于使用GPU训练和部署深度神经网络，该软件库着重于速度和可扩展性，而不是实验灵活性.
...
* [MLDB](https://mldb.ai)  -机器学习数据库是设计用于机器学习的数据库.  通过RESTful API发送命令以存储数据，使用SQL探索数据，然后训练机器学习模型并将其公开为API.
...
* [Hopsworks](https://github.com/logicalclocks/hopsworks)  -业界首个开放源代码功能存储，用于AI的数据密集型平台.  Hopsworks Feature Store既提供了用于基于Apache Hive进行培训和批处理的功能库，又为在线应用程序提供了基于MySQL Cluster的功能服务数据库.
...
* [ucto](https://github.com/LanguageMachines/ucto)  -基于Unicode的正则表达式标记器，适用于各种语言.  工具和C ++库.  支持FoLiA格式.
...
* [word-embedding](https://github.com/ynqa/word-embedding) -单词嵌入：在Go中全面实现word2vec和GloVe.
* [sentences](https://github.com/neurosnap/sentences) -Punkt句子标记器的实现.
...
* [Stanford Topic Modeling Toolbox](https://nlp.stanford.edu/software/tmt) -适用于社会科学家和其他希望对数据集进行分析的人员的主题建模工具.
...
* [aerosolve](https://github.com/airbnb/aerosolve) -由Airbnb设计的机器学习库，从头开始设计为人性化.
...
* [LBJava](https://github.com/CogComp/lbjava) -基于学习的Java是一种用于快速开发软件系统的建模语言，可直接根据程序员应用程序中的对象为分类器和约束定义提供便捷的声明式语法.


<a name="java-speech-recognition"></a>
#### Speech Recognition
* [CMU Sphinx](https://cmusphinx.github.io) -完全基于Java语音识别库的开源语音识别工具包.
...
* [Clustering.js](https://github.com/emilbayes/clustering.js)  -针对Node.js和浏览器以Javascript实现的聚类算法.  ** [不推荐使用] **
...
* [Bayesian-Bandit](https://github.com/omphalos/bayesian-bandit.js)  -Node和浏览器的Bayesian强盗实现.  ** [不推荐使用] **
...
* [kalman](https://github.com/itamarwe/kalman)  -适用于Javascript的Kalman过滤器.  ** [不推荐使用] **
...
* [regression-js](https://github.com/Tom-Alexander/regression-js) -一个javascript库，其中包含用于在一组数据中查找趋势的最小二乘拟合方法的集合.
...
* [Half Beer](https://github.com/sta-ger/HalfBeer) -使用创建的啤酒杯分类器 [Synaptic](https://github.com/cazala/synaptic).
...
* [Distributions](https://github.com/JuliaStats/Distributions.jl) -用于概率分布和相关功能的Julia软件包.
...
* [Torch7](http://torch.ch/)
  ...
  * [autograd](https://github.com/twitter/torch-autograd)  -Autograd自动区分本地Torch代码.  受原始Python版本启发.
...
* [Optunity](https://optunity.readthedocs.io/en/latest/)  -专门用于自动超参数优化的库，具有简单，轻量级的API，可方便地替换网格搜索.  机会是用Python编写的，但是可以与MATLAB无缝连接.
* [MXNet](https://github.com/apache/incubator-mxnet/)  -具有动态，可感知突变的Dataflow Dep Scheduler的轻型，便携式，灵活的分布式/移动深度学习；  适用于Python，R，Julia，Go，Javascript等.
* [Machine Learning in MatLab/Octave](https://github.com/trekhleb/machine-learning-octave) -流行的机器学习算法的示例（神经网络，线性/逻辑回归，K-Means等），并在其后解释了代码示例和数学.
...
* [BPN-NeuralNetwork](https://github.com/Kalvar/ios-BPN-NeuralNetwork)  -它实现了3层神经网络（输入层，隐藏层和输出层），并将其命名为反向传播神经网络（BPN）.  该网络可用于产品推荐，用户行为分析，数据挖掘和数据分析.  ** [不推荐使用] **
* [Multi-Perceptron-NeuralNetwork](https://github.com/Kalvar/ios-Multi-Perceptron-NeuralNetwork) -它基于反向传播神经网络（BPN）实施了多感知器神经网络（ニューラルネットワーク），并设计了无限隐藏层.
...
* [python-zpar](https://github.com/EducationalTestingService/python-zpar) -的Python绑定 [ZPar](https://github.com/frcchang/zpar), a statistical part-of-speech-tagger, constiuency parser, and dependency parser for English.
* [colibri-core](https://github.com/proycon/colibri-core) -与C ++库的Python绑定，以快速且节省内存的方式提取和使用基本语言结构（例如n-gram和skipgram）.
...
* [Auto_ViML](https://github.com/AutoViML/Auto_ViML)  -&gt;快速自动构建变体可解释的ML模型！  Auto_ViML的发音是“ auto vimal”，它是一个全面且可扩展的Python AutoML工具箱，具有不平衡的处理，集合，堆栈和内置功能选择.  在<a href="https://towardsdatascience.com/why-automl-is-an-essential-new-tool-for-data-scientists-2d9ab4e25e46?source=friends_link&sk=d03a0cc55c23deb497d546d6b9be0653">中型文章</a>精选.
...
* [auto_ml](https://github.com/ClimbsRocks/auto_ml)  -用于生产和分析的自动化机器学习.  让您专注于ML的有趣部分，同时输出可用于生产环境的代码以及对数据集和结果的详细分析.  包括对NLP，XGBoost，CatBoost，LightGBM以及不久的深度学习的支持.
...
* [Hydrosphere Mist](https://github.com/Hydrospheredata/mist) -用于将Apache Spark MLLib机器学习模型部署为实时，批处理或反应式Web服务的服务.
* [scikit-learn](https://scikit-learn.org/) -基于SciPy构建的Python机器学习模块.
...
* [pyhsmm](https://github.com/mattjj/pyhsmm) -用于贝叶斯隐马尔可夫模型（HMM）和显性持续时间隐半马尔可夫模型（HSMM）中的近似无监督推理的库，重点关注贝叶斯非参数扩展，HDP-HMM和HDP-HSMM，主要具有弱极限近似.
* [mrjob](https://pythonhosted.org/mrjob/) -让Python程序在Hadoop上运行的库.
* [SKLL](https://github.com/EducationalTestingService/skll) -围绕scikit-learn的包装，使进行实验变得更加简单.
...
* [Optunity](https://optunity.readthedocs.io/en/latest/) -专门用于自动超参数优化的库，具有简单，轻量级的API，可方便地替换网格搜索.
...
* [TPOT](https://github.com/EpistasisLab/tpot)  -使用基因编程自动创建和优化机器学习管道的工具.  将其视为您的个人数据科学助手，可以使机器学习的繁琐工作自动化.
...
* [rgf_python](https://github.com/RGF-team/rgf) -正规化贪婪森林（树）库的Python绑定.
...
* [CatBoost](https://github.com/catboost/catboost)  -带有分类功能的决策树库具有通用梯度提升功能，开箱即用.  它易于安装，文档完善，并支持CPU和GPU（甚至是多GPU）计算.
...
* [StellarGraph](https://github.com/stellargraph/stellargraph)：图上的机器学习，这是一个用于对图结构化（网络结构）数据进行机器学习的Python库.
* [BentoML](https://github.com/bentoml/bentoml)：用于打包和部署机器学习模型以在生产中使用的工具包
* [MiraiML](https://github.com/arthurpaulino/miraiml)：用于实时使用的连续和自主机器学习的异步引擎.
...
* [Numba](https://numba.pydata.org/) -Cython和NumPy的开发人员针对科学Python编写的针对LLVM的Python JIT（及时）编译器.
...
* [lime](https://github.com/marcotcr/lime)  -Lime旨在解释机器学习分类器（或模型）的功能.  它能够用两个或多个类来解释任何黑匣子分类器.
...
* [sentiment-analyzer](https://github.com/madhusudancs/sentiment-analyzer) -推文情感分析器
...
* [climin](https://github.com/BRML/climin) -优化库专注于机器学习，梯度下降的pythonic实现，LBFGS，rmsprop，adadelta等.
...
* [Dive into Machine Learning  with Python Jupyter notebook and scikit-learn](https://github.com/hangtwenty/dive-into-machine-learning) -“我是通过首先黑客学习而学习Python的，后来变得更认真.我想通过机器学习来做到这一点.如果这是您的风格，请加入我的行列，以超越自己.”
...
* [Homemade Machine Learning](https://github.com/trekhleb/homemade-machine-learning) -解释了流行的机器学习算法的Python示例，其中包含交互式Jupyter演示和数学解释
...
* [Data Driven Code](https://github.com/atmb4u/data-driven-code) -在python中使用假人非常简单地实现神经网络，而无需使用任何库，并带有详细注释.
...
#### Reinforcement Learning
* [DeepMind Lab](https://github.com/deepmind/lab)  -DeepMind Lab是一个基于3D学习环境，基于id软件的Quake III Arena通过ioquake3和其他开源软件进行.  其主要目的是充当人工智能（尤其是深度强化学习）研究的测试平台.
...
* [Raspel](https://sourceforge.net/projects/raspell/)  -raspell是红宝石的界面绑定.  ** [不推荐使用] **
...
* [bmrm](https://cran.r-project.org/web/packages/bmrm/index.html) -bmrm：正则化风险最小化软件包的捆绑方法.
* [Boruta](https://cran.r-project.org/web/packages/Boruta/index.html) -Boruta：用于所有相关特征选择的包装器算法.
...
* [CatBoost](https://github.com/catboost/catboost) -带有决策功能的决策树库上的通用梯度提升为R提供了现成的支持.
...
* [lasso2](https://cran.r-project.org/web/packages/lasso2/index.html) -lasso2：L1受约束的估计，也称为“套索”.
...
* [party](https://cran.r-project.org/web/packages/party/index.html) -派对：递归派对的实验室.
* [partykit](https://cran.r-project.org/web/packages/partykit/index.html) -partykit：递归派对的工具包.
...
* [REEMtree](https://cran.r-project.org/web/packages/REEMtree/index.html)  -REEMtree：纵向（面板）数据具有随机效应的回归树.  ** [不推荐使用] **
...
* [RWeka](https://cran.r-project.org/web/packages/RWeka/index.html) -保存：R /设置界面.
...
* [Optunity](https://optunity.readthedocs.io/en/latest/)  -专门用于自动超参数优化的库，具有简单，轻量级的API，可方便地替换网格搜索.  机会是用Python编写的，但与R无缝连接.
...
* [dplyr](https://www.rdocumentation.org/packages/dplyr/versions/0.7.8) -数据处理程序包，可帮助解决最常见的数据处理问题.
...
* [shiny](https://shiny.rstudio.com/) 是R中真正的交互式显示和仪表板的基础.但是，可以使用 [htmlwidgets](https://www.htmlwidgets.org/) 将JavaScript库带到R.其中包括， [plotly](https://plot.ly/r/), [dygraphs](http://rstudio.github.io/dygraphs), [highcharter](http://jkunst.com/highcharter/)，以及其他几个.
...
* [Smile](https://haifengl.github.io/smile/) -统计机器智能和学习引擎.
...
* [Swift for Tensorflow](https://github.com/tensorflow/swift) -新一代的机器学习平台，结合了机器学习，编译器，可区分编程，系统设计等方面的最新研究成果.
...
* [Perfect TensorFlow](https://github.com/PerfectlySoft/Perfect-TensorFlow)  -TensorFlow的Swift语言绑定  在macOS / Linux上都使用本机TensorFlow模型.
...
* [Notebooks](https://github.com/rlan/notebooks)  -适用于Jupyter笔记本和机器学习的入门套件.  随附的docker映像包含python版本，机器学习框架（Keras，PyTorch和Tensorflow）和CPU / CUDA版本的所有组合.
...
* [MLFlow](https://mlflow.org/)  -管理机器学习生命周期的平台，包括实验，可重复性和部署.  与语言无关的框架，请看一下所有内置集成.
*更多改善ML生命周期的工具： [Catalyst](https://github.com/catalyst-team/catalyst), [PachydermIO](https://www.pachyderm.io/) .  以下是类似Github的目标团队 [Weights & Biases](https://www.wandb.com/), [Neptune.Ml](https://neptune.ml/), [Comet.ml](https://www.comet.ml/), [Valohai.ai](https://valohai.com/).
...
* Go的参考大部分是从 [gopherdata](https://github.com/gopherdata/resources/tree/master/tooling)
