...
* [rgenoud](https://cran.r-project.org/web/packages/rgenoud/index.html) -  rgenoud：使用衍生物进行GENetic优化的R版本
...
*我发现的少数参考资料来自哪里 [this page](https://github.com/golang/go/wiki/Projects)
