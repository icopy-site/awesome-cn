...
&gt;用于构建不同应用程序和功能的技术堆栈.
 ...
 Awesome Stacks是一个社区策划的技术堆栈列表，用于构建不同的应用程序和功能.  它是开源的，并受到原始的启发 [awesome list](http://awesome.re/).

 列表中的每个堆栈都有一些名称，描述以及一些关键工具和技术的列表.  可选地，它链接到教程，入门套件或样板，使其易于入门.

 有一堆你认为是一种很好的构建方式吗？  请编辑此文件并添加它！  查看 [https://github.com/stackshareio/awesome-stacks/blob/master/CONTRIBUTING.md](https://github.com/stackshareio/awesome-stacks/blob/master/CONTRIBUTING.md) 欲获得更多信息.

#### Browsing the stacks

可以在README和on上的两个位置浏览堆栈 [awesomestacks.dev](https://awesomestacks.dev/) .  该站点使用Gatsby和React构建，通过从GitHub和StackShare API中提取数据，显示README中列出的每个工具的徽标和指标.
...
React Starter Kit是一个基于Node.js，Express，GraphQL和React构建的基于Web开发的固定样板，包含现代Web开发工具，如Webpack，Babel和Browsersync. 
...
- [GraphQL](https://graphql.org/) - [🛠](https://stackshare.io/graphql) - [🐙](https://github.com/graphql/graphql-js) -  API的查询语言和用于使用现有数据完成这些查询的运行时.
- [Babel](https://babeljs.io/) - [🛠️](https://stackshare.io/babel) - [🐙](https://github.com/babel/babel)   -  JavaScript编译器;  今天使用下一代JavaScript.
...
Firebase的React Starter Kit是一个流行的项目模板（又名样板，用于构建具有React，Relay和GraphQL的现代可扩展Web应用程序），使用Google Cloud提供的无服务器基础架构（Cloud SQL，云功能，CDN托管和文件存储） .

- [Firebase](https://firebase.google.com/) - [🛠️](https://stackshare.io/firebase) - 云托管的NoSQL数据库，可让您实时存储和同步用户之间的数据.
...
- [Material UI](https://material-ui.com/) - [🛠️](https://stackshare.io/material-ui) - [🐙](https://github.com/mui-org/material-ui) - 实施Google Material Design的React组件.
...
### vue-starter [↗](https://awesomestacks.dev/vue-starter)
 ...
 生产就绪的PWA最完整的样板.  专注于性能，开发速度和最佳实践.

- [Vue.js](https://vuejs.org/) - [🛠️](https://stackshare.io/vue-js) - [🐙](https://github.com/vuejs/vue) - 一个易于使用的核心库，仅关注视图层.
- [TypeScript](https://www.typescriptlang.org/) - [🛠️](https://stackshare.io/typescript) - [🐙](https://github.com/Microsoft/TypeScript) -  JavaScript的类型超集，可编译为纯JavaScript.
- [Jest](https://jestjs.io/) - [🛠️](https://stackshare.io/jest) - [🐙](https://github.com/facebook/jest) - 全面，愉快的JavaScript测试解决方案.
- [Prettier](https://prettier.io/) - [🛠️](https://stackshare.io/prettier) - [🐙](https://github.com/prettier/prettier) - 固定代码格式化程序.
- [Vuex](https://vuex.vuejs.org/) - [🐙](https://github.com/vuejs/vuex) -  Vue.js的集中状态管理
- [Vue Router](https://router.vuejs.org/) - [🐙](https://github.com/vuejs/vue-router) -  Vue Router是Vue.js的官方路由器.
...
使用Vue CLI 3的新Vue SPA项目的不断发展和固执的架构和开发环境.

- [Vue.js](https://vuejs.org/) - [🛠️](https://stackshare.io/vue-js) - [🐙](https://github.com/vuejs/vue) - 一个易于使用的核心库，仅关注视图层.
- [Vuex](https://vuex.vuejs.org/) - [🐙](https://github.com/vuejs/vuex) -  Vue.js的集中状态管理
- [Vue Router](https://router.vuejs.org/) - [🐙](https://github.com/vuejs/vue-router) -  Vue Router是Vue.js的官方路由器.
- [Vue CLI](https://cli.vuejs.org/) - [🐙](https://github.com/vuejs/vue-cli) - 一个易于使用的核心库，仅关注视图层.
- [Babel](https://babeljs.io/) - [🛠️](https://stackshare.io/babel) - [🐙](https://github.com/babel/babel)   - 编写下一代JavaScript的编译器;  Babel会将您的ES6 +代码转换为ES5友好代码，因此您可以立即开始使用它而无需等待浏览器支持.
- [Sass](https://sass-lang.com) - [🛠️](https://stackshare.io/sass) - [🐙](https://github.com/sass/sass)   -  Sass是CSS3的扩展，添加了嵌套规则，变量，mixins，选择器继承等.  它使用命令行工具或web框架插件转换为格式良好的标准CSS.
...
使用一些优秀的现代技术构建简单的轮询渐进式Web应用程序.

- [Gatsby](https://gatsbyjs.org/) - [🛠](https://stackshare.io/gatsbyjs) - [🐙](https://github.com/gatsbyjs/gatsby) - 盖茨比是React的一个超快的现代网站生成器.
- [Cloud Firestore](https://firebase.google.com/docs/firestore/) - [🛠️](https://stackshare.io/cloud-firestore) - 一个noSQL云数据库，用于公开事件监听器以进行实时更新.
- [Netlify](https://netlify.com/) - [🛠️](https://stackshare.io/netlify) -  Netlify是一个全球性的CDN，只需点击几下即可实现持续部署.
- [styled components](https://www.styled-components.com/) - [🛠](https://stackshare.io/styled-components) - [🐙](https://github.com/styled-components/styled-components) - 特定于反应的css-in-js解决方案.
- [Contentful](https://www.contentful.com/) - [🛠](https://stackshare.io/contentful) - [🐙](https://github.com/contentful)   -  Contentful是一个灵活且面向未来的内容平台，可帮助编辑管理和开发人员将内容提供给移动或Web应用程序.  最后但并非最不重要的是与盖茨比合作的强者.
...
### Victor Hugo boilerplate [↗](https://awesomestacks.dev/victor-hugo-boilerplate)
 ...
 用于创建真正史诗网站的Hugo样板.  这是一个使用Hugo作为静态站点生成器和Webpack作为资产管道的样板.
...
流血边缘vue模板专注于代码质量和开发人员的快乐.

为小型和企业级应用程序提供完整的设置.

- [Nuxt](https://nuxtjs.org/) - [🛠](https://stackshare.io/nuxt) - [🐙](https://github.com/nuxt/nuxt.js) -  Vue.js Meta Framework，可快速创建复杂，快速和通用的Web应用程序.
- [TypeScript](https://www.typescriptlang.org/) - [🛠️](https://stackshare.io/typescript) - [🐙](https://github.com/Microsoft/TypeScript) -  JavaScript的类型超集，可编译为纯JavaScript.
- [Sass](https://sass-lang.com) - [🛠️](https://stackshare.io/sass) - [🐙](https://github.com/sass/sass)   -  Sass是CSS3的扩展，添加了嵌套规则，变量，mixins，选择器继承等.  它使用命令行工具或web框架插件转换为格式良好的标准CSS.
- [Jest](https://jestjs.io/) - [🛠️](https://stackshare.io/jest) - [🐙](https://github.com/facebook/jest) - 全面，愉快的JavaScript测试解决方案.
- [eslint](https://eslint.org/) - [🛠️](https://stackshare.io/eslint) - [🐙](https://github.com/eslint/eslint) - 适用于JavaScript和JSX的可插入linting实用程序.
- [stylelint](https://stylelint.io/) - [🛠️](https://stackshare.io/stylelint) - [🐙](https://github.com/stylelint/stylelint) - 强大的现代短绒，可帮助您避免错误并在您的风格中强制执行约定.
- [Docker](https://www.docker.com/) - [🛠](https://stackshare.io/docker) - [🐙](https://github.com/docker/docker) 用于在容器内创建，部署和运行应用程序的工具.
...
闪电快速启动博主，内容创作者，以及任何想要摆脱WordPress的人. 

- [GraphCMS](https://graphcms.com/) - [🛠️](https://stackshare.io/graphcms) -  GraphCMS为您的应用提供后端，为您提供管理内容的工具.
- [Create React App](https://facebook.github.io/create-react-app/) - [🛠](https://stackshare.io/create-react-app) - [🐙](https://github.com/facebook/create-react-app) - 通过运行一个命令设置现代Web应用程序.
- [Apollo](https://www.apollographql.com/) - [🛠️](https://stackshare.io/apollo) - [🐙](https://github.com/apollographql/apollo-client) -  Apollo Client是使用GraphQL构建客户端应用程序的最佳方式.
...
### Strapi CMS with Gatsby [↗](https://awesomestacks.dev/strapi-cms-with-gatsby)
 ...
 使用Strapi CMS来维护和管理您的Gatsby静态站点.  部署到Heroku.

- [Strapi CMS](https://strapi.io) - [🐙](https://github.com/strapi/strapi) -  Strapi是无头CMS开发者喜爱的.
- [Gatsby](https://gatsbyjs.org/) - [🛠](https://stackshare.io/gatsbyjs) - [🐙](https://github.com/gatsbyjs/gatsby) - 盖茨比是React的一个超快的现代网站生成器.
- [Heroku](https://www.heroku.com/) - [🛠️](https://stackshare.io/heroku) -  Heroku是部署应用程序的强大平台.
...
通过静态网站集成或抓取内容，将搜索添加到JAMStack网站.
...
这是一个使用VueJS + ExpressJS + MongoDB的完整堆栈Web应用程序样板项目.

- [Vue.js](https://vuejs.org/) - [🛠️](https://stackshare.io/vue-js) - [🐙](https://github.com/vuejs/vue) - 一个易于使用的核心库，仅关注视图层.
- [MongoDB](https://www.mongodb.com/) - [🛠️](https://stackshare.io/mongodb) - [🐙](https://github.com/mongodb/mongo) - 文档和面向JSON的数据库.
- [Express](https://expressjs.com/) - [🛠️](https://stackshare.io/expressjs) - [🐙](https://github.com/expressjs/express) - 最小且灵活的Node.js Web应用程序框架.
- [Node.js](https://nodejs.org/en/) - [🛠️](https://stackshare.io/nodejs) - [🐙](https://github.com/nodejs/node) -  Node.js是一个基于Chrome的V8 JavaScript引擎构建的JavaScript运行时.
...
基于Rails / JavaScript的堆栈，具有现代/开发人员友好的技术
...
### Serverless Stack with React on AWS [↗](https://awesomestacks.dev/serverless-stack-with-react-on-aws)
 ...
 了解如何使用serverless-stack.com上的无服务器和React在AWS上构建一个完整的生产就绪笔记记录应用程序.  包含屏幕截图和代码示例的分步开源教程.
...
- [Electron](http://electron.atom.io/) - [🛠️](https://stackshare.io/electron) - [🐙](https://github.com/electron/electron) - 使用JavaScript，HTML和CSS构建跨平台桌面应用程序.
- [React](https://reactjs.org/) - [🛠](https://stackshare.io/react) - [🐙](https://github.com/facebook/react) - 可以在客户端和服务器端使用React组件.
- [Redux](https://redux.js.org/) - [🛠](https://stackshare.io/reduxjs) - [🐙](https://github.com/reduxjs/redux) -  JavaScript应用程序的可预测状态容器.
- [electron-builder](https://www.electron.build) - [🐙](https://github.com/electron-userland/electron-builder) - 一个完整的解决方案，打包并构建一个准备好分发的Electron应用程序，开箱即用“自动更新”支持.
...
可扩展的跨平台桌面应用程序的基础，从开发到使用Vue和Electron分发您的应用程序.
...
- [CircleCI](https://circleci.com/) - [🛠](https://stackshare.io/circleci) - 热门的托管CI服务器.
- [Codecov](https://codecov.io/) - [🛠️](https://stackshare.io/codecov) - 托管覆盖报告具有强大的功能，以增强您的CI工作流程.
- [Bash](https://www.gnu.org/software/bash/) - [🛠](https://stackshare.io/gnu-bash) -  Bourne Again SHell是一个兼容sh的shell.
- [GitHub](https://github.com/) - [🛠](https://stackshare.io/github) - 开源和私有开发项目的强大协作，审查和代码管理.
...
### Vue SPA with Laravel [↗](https://awesomestacks.dev/vue-spa-with-laravel)
 ...
 创建通用且可扩展的PHP Web应用程序的最佳方法！  它肯定会让你爱上PHP（如果没有，Laravel）.  Laravel团队与Vue有官方合作，所以Vue，Babel和Sass在您开始之前就已经集成了！

- [PHP 7](https://php.net) - [🛠](https://stackshare.io/php) - [🐙](https://github.com/php/php-src) - 一种流行的通用脚本语言，特别适用于Web开发.
- [Laravel](https://laravel.com/) - [🛠](https://stackshare.io/laravel)  - [🐙](https://github.com/laravel/laravel) - 最流行的面向对象的MVC PHP框架之一，具有优雅的语法和黄金标准软件模式.
- [Vue.js](https://vuejs.org/) - [🛠️](https://stackshare.io/vue-js) - [🐙](https://github.com/vuejs/vue) - 一个易于使用的核心库，仅关注视图层.
- [Laravel Mix](https://laravel.com/docs/5.8/mix) - [🐙](https://github.com/JeffreyWay/laravel-mix)   - 构建在webpack之上的构建工具，可轻松编译任何前端资产.  （秘密：有或没有Laravel工作）
- [Babel](https://babeljs.io/) - [🛠️](https://stackshare.io/babel) - [🐙](https://github.com/babel/babel)   - 编写下一代JavaScript的编译器;  Babel会将您的ES6 +代码转换为ES5友好代码，因此您可以立即开始使用它而无需等待浏览器支持.
- [Sass](https://sass-lang.com) - [🛠️](https://stackshare.io/sass) - [🐙](https://github.com/sass/sass)   -  Sass是CSS3的扩展，添加了嵌套规则，变量，mixins，选择器继承等.  它使用命令行工具或web框架插件转换为格式良好的标准CSS.
...
Stack用于使用Google Cloud服务部署和管理Docker容器化应用程序集群.
...
- [Stackdriver](https://cloud.google.com/stackdriver/) - [🛠️](https://stackshare.io/stackdriver) -  Stackdriver Logging允许您存储，搜索，分析，监控和警告日志数据和事件. 

### Ethereum DApp [↗](https://awesomestacks.dev/ethereum-d-app)

用于在以太坊区块链上构建分散应用程序的工具集合.

- [Solidity](https://solidity.readthedocs.io) - [🐙](https://github.com/ethereum/solidity) -  Solidity是一种面向对象的高级语言，用于实现智能合约.
- [web3.js](https://web3js.readthedocs.io) - [🐙](https://github.com/ethereum/web3.js) - 以太坊JavaScript API.
- [Truffle](https://truffleframework.com/truffle) - [🐙](https://github.com/trufflesuite/truffle) - 使用以太坊虚拟机（EVM）的区块链的世界级开发环境，测试框架和资产管道.
- [Ganache](https://truffleframework.com/ganache) - [🐙](https://github.com/trufflesuite/ganache) - 用于以太坊开发的个人区块链.
- [drizzle](https://truffleframework.com/drizzle) - [🐙](https://github.com/trufflesuite/drizzle) - 前端库的集合，使得编写dapp用户界面更容易，更可预测.
...
- [rack-mini-profiler](https://github.com/MiniProfiler/rack-mini-profiler) - [🐙](https://github.com/MiniProfiler/rack-mini-profiler) - 用于开发和生产Ruby Rack应用程序的Profiler.
- [Sqreen](https://www.sqreen.com/) - [🛠](https://stackshare.io/sqreen) - 对Ruby，PHP，Java，Go，Python和Node.js应用程序的安全监控和保护.

### User Behavior Analytics via Segment [↗](https://awesomestacks.dev/user-behavior-analytics-via-segment)

托管工具，用于分析Web应用程序的用户行为.

- [Segment](https://segment.com) - [🛠️](https://stackshare.io/segment) - 单个集线器，可通过交换机收集，转换和发送数据.
- [Google Analytics](https://marketingplatform.google.com/about/analytics/) - [🛠️](https://stackshare.io/google-analytics) - 企业级网站分析.
- [Amplitude](https://amplitude.com) - [🛠️](https://stackshare.io/amplitude) - 用户分析，以促进用户的爆炸性增长.
- [FullStory](https://www.fullstory.com/) - [🛠️](https://stackshare.io/fullstory) - 在一个功能强大，易于使用的平台上捕获所有客户体验数据.
...
自托管的开源devops和协作工具，适合企业.

- [GitLab](https://about.gitlab.com/) - [🛠](https://stackshare.io/gitlab) - [🐙](https://github.com/gitlabhq/gitlabhq) - 开源自托管Git管理软件.
- [Zulip](https://zulipchat.com) - [🛠](https://stackshare.io/zulip) - [🐙](https://github.com/zulip/zulip) - 强大的开源团队聊天.
- [Hubot](https://hubot.github.com) - [🛠](https://stackshare.io/hubot) - [🐙](https://github.com/hubotio/hubot) - 可定制的生活embetterment机器人.
- [Sentry](https://sentry.io) - [🛠](https://stackshare.io/sentry) - [🐙](https://github.com/getsentry/sentry) - 跨平台应用程序监控，重点是错误报告.
- [Taiga.io](https://taiga.io) - [🛠](https://stackshare.io/taiga) - [🐙](https://github.com/taigaio) - 考虑到Scrum的项目管理Web应用程序.
...
出血边缘Django模板侧重于代码质量和安全性.

默认情况下配置构建，测试和部署管道.

- [Python 3](https://www.python.org/) - [🛠](https://stackshare.io/python) - [🐙](https://github.com/python/cpython) - 一种可让您快速工作的编程语言.
- [Django](https://www.djangoproject.com/) - [🛠](https://stackshare.io/django) - [🐙](https://github.com/django/django) - 具有最后期限的完美主义者的Web框架.
- [Docker](https://www.docker.com/) - [🛠](https://stackshare.io/docker) - [🐙](https://github.com/docker/docker) - 在容器内创建，部署和运行应用程序的工具.
- [GitLab](https://about.gitlab.com/) - [🛠](https://stackshare.io/gitlab) - [🐙](https://github.com/gitlabhq/gitlabhq) - 开源自托管Git管理软件.
...
- [Spring Boot](https://spring.io/projects/spring-boot) - [🛠](https://stackshare.io/spring-boot) - [🐙](https://github.com/spring-projects/spring-boot) -  Spring Boot可以轻松创建独立的，生产级的基于Spring的应用程序，您可以“直接运行”.
- [Gradle](https://gradle.org/) - [🛠️](https://stackshare.io/gradle) - [🐙](https://github.com/gradle/gradle)- 构建工具，侧重于构建自动化和支持多语言开发.
- [Java](https://docs.oracle.com/javase/specs/index.html) - [🛠️](https://stackshare.io/java) -  Java是面向对象的，是世界上使用最多的编程语言之一.
...
### React Native with Expo and Hasura [↗](https://awesomestacks.dev/react-native-with-expo-and-hasura)
 ...
 Hasura是一个开源GraphQL引擎，可在任何Postgres数据库上部署即时，实时的GraphQL API.  此React Native堆栈使用在Digital Ocean上托管的Hasura水滴.

- [Hasura](https://hasura.io/) - [🛠️](https://stackshare.io/hasura) - [🐙](https://github.com/hasura/graphql-engine) - 在Postgres上实现快速，即时的实时GraphQL API，具有细粒度的访问控制.
- [React Native](https://facebook.github.io/react-native/) - [🛠️](https://stackshare.io/react-native) - [🐙](https://github.com/facebook/react-native) - 使用JavaScript和React构建本机移动应用程序.
- [Expo](https://expo.io/) - [🛠️](https://stackshare.io/expo) - [🐙](https://github.com/expo/expo) - 从相同的JavaScript代码库构建，部署和快速迭代本机iOS和Android应用程序.
- [Digital Ocean](https://www.digitalocean.com/) - [🛠️](https://stackshare.io/digitalocean) - [🐙](https://github.com/digitalocean/) - 使用专用IP和root访问，在不到55秒的时间内部署SSD云服务器.
- [Auth0](https://auth0.com/) - [🛠️](https://stackshare.io/auth0) - 适用于Web，移动和遗留应用程序的通用身份验证和授权平台.
...
Unity是一个连接到Plastic SCM的游戏引擎，用于保持版本控制和大型资产以及巨大的repo管理清洁和无摩擦. 
...
- [Plastic SCM](https://www.plasticscm.com/) - [🛠️](https://stackshare.io/plastic-scm) - [🐙](https://github.com/PlasticSCM/plastic-docker) -  PlasticSCM Docker图像.
- [TeamCity](https://www.jetbrains.com/teamcity/) - [🛠](https://stackshare.io/teamcity) -  JetBrains的基于Java的构建管理和持续集成服务器.
...
在法律允许的范围内， [StackShare](https://stackshare.io) 已放弃对此作品的所有版权及相关或相邻权利 [README](https://github.com/stackshareio/awesome-stacks/blob/master//README.md).
