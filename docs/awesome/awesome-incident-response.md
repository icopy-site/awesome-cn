...
* [TheHive](https://thehive-project.org/) -可扩展的三合一开源和免费解决方案，旨在简化SOC，CSIRT，CERT和任何需要迅速调查并采取行动的安全事件的信息安全从业人员的生活.
...
* [artifactcollector](https://github.com/forensicanalysis/artifactcollector) -artifactcollector项目提供了一种软件，该软件可以收集系统上的取证工件.
...
* [RTIR](https://www.bestpractical.com/rtir/)  -事件响应请求跟踪器（RTIR）是针对计算机安全团队的首要开源事件处理系统. 我们与世界各地的12多个CERT和CSIRT团队合作，帮助您处理不断增长的事件报告.  RTIR建立在Request Tracker的所有功能之上.
...
* [Digital Evidence & Forensics Toolkit (DEFT)](http://www.deftlinux.net/)  -用于计算机取证证据收集的Linux发行版. 它与Windows数字高级响应工具包（DART）捆绑在一起. 还提供了DEFT的轻型版本，称为DEFT Zero，其主要侧重于法医上合理的证据收集.
...
* [FastIR Collector Linux](https://github.com/SekoiaLab/Fastir_Collector_Linux) -适用于Linux的FastIR在实时Linux上收集了不同的工件，并将结果记录在csv文件中.
...
* [Memoryze for Mac](https://www.fireeye.com/services/freeware/memoryze.html)  -Mac版Memoryze是Memoryze，但Mac版则是. 但是，功能数量较少.
...
* [WindowsSCOPE](http://www.windowsscope.com/windowsscope-cyber-forensics/) -用于分析易失性内存的内存取证和逆向工程工具，可以分析Windows内核，驱动程序，DLL，虚拟和物理内存.

### Memory Imaging Tools

* [Linux Memory Grabber](https://github.com/halpomeranz/lmg/) -用于转储Linux内存和创建Volatility配置文件的脚本.
* [Magnet RAM Capture](https://www.magnetforensics.com/free-tool-magnet-ram-capture/)  -免费的成像工具，旨在捕获犯罪嫌疑人计算机的物理内存. 支持最新版本的Windows.
...
* [Fenrir](https://github.com/Neo23x0/Fenrir)  -简单的IOC扫描仪. 它允许以纯bash格式扫描所有Linux / Unix / OSX系统中的IOC. 由THOR和LOKI的创建者创建.
...
* [IR Workflow Gallery](https://www.incidentresponse.com/playbooks/)  -不同的通用事件响应工作流程，例如，针对恶意软件爆发，数据盗窃，未经授权的访问....每个工作流程都包含七个步骤：准备，检测，分析，遏制，消除，恢复，事后处理. 这些工作流程可在线获得或下载.
...
* [Metadefender Cloud](https://www.metadefender.com) -免费的威胁情报平台，可提供多扫描，数据清理和文件漏洞评估.
...
* [Highlighter](https://www.fireeye.com/services/freeware/highlighter.html)  -Fire / Mandiant提供的免费工具，它将描述日志/文本文件，该文件可以突出显示图形上与关键字或短语相对应的区域. 非常适合用于安排感染以及妥协后的工作.
...
* [Crowd Response](http://www.crowdstrike.com/community-tools/)  -轻巧的Windows控制台应用程序，旨在帮助收集系统信息以进行事件响应和安全参与. 它具有许多模块和输出格式.
