...
- [Gifski](https://github.com/sindresorhus/Gifski )   - 将视频转换为高品质的GIF.  ！[swift_icon] 
...
- [Life Saver](https://github.com/amiantos/lifesaver) - 基于Conway的生命游戏的抽象屏幕保护程序，用SpriteKit实现！[swift_icon] 
...
- [ProfileCreator](https://github.com/ProfileCreator/ProfileCreator)   -  macOS应用程序，用于创建标准或自定义配置文件.  ！[objective_c_icon] 
...
- [Rectangle](https://github.com/rxhanson/Rectangle)   -  Rectangle是一个很大程度上基于Spectacle的窗口管理器，用Swift编写.  ！[swift_icon] 
