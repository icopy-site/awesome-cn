...
- [Aural Player](https://github.com/maculateConception/aural-player)   -  Aural Player是macOS平台的音频播放器应用程序.  受到Windows经典Winamp播放器的启发，它的设计非常实用，易于使用.  ！[swift_icon] 
...
- [eqMac2](https://github.com/nodeful/eqMac2)   - 适用于Mac的系统级均衡器.  ！[cpp_icon] 
...
### Chat
- [Android Messenger Mac](https://github.com/jake-101/android-messenger-mac)   - 围绕谷歌独立Android Messenger的Mac app包装.  ！[javascript_icon] 
- [ChitChat](https://github.com/stonesam92/ChitChat)   -  WhatsApp Web的原生Mac应用程序包装器.  ！[objective_c_icon] 
- [Electronic WeChat](https://github.com/geeeeeeeeek/electronic-wechat)   - 更好的Mac OS和Linux上的微信.  ！[javascript_icon] 
- [Franz](https://github.com/meetfranz/franz)   -  Franz是WhatsApp，Slack，Messenger等服务的消息传递应用程序.  ！[javascript_icon] 
- [Google Allo for Desktop](https://github.com/kelyvin/Google-Allo-For-Desktop)   - 适用于Google Allo的原生macOS和Windows桌面应用.  ！[javascript_icon] 
- [GroupMe](https://github.com/dcrousso/GroupMe)   - 非官方GroupMe应用程序.  ！[javascript_icon]！[css_icon] 
...
- [Seaglass](https://github.com/neilalexander/seaglass) - 真正的原生 [Matrix](https://matrix.org/blog/home/)  macOS的客户端.  ！[swift_icon] 
...
### Cryptocurrency
- [AddressGenerator](https://github.com/onmyway133/AddressGenerator)   -  macOS app安全地生成加密货币地址.  ！[swift_icon] 
- [Balance Open](https://github.com/balance-io/balance-open)   - 适用于全球所有货币的应用程序.  ！[swift_icon] 
- [CoinBar](https://github.com/adamwaite/CoinBar)   - 用于跟踪加密硬币价格的macOS菜单栏应用程序.  ！[swift_icon] 
- [Crypto Bar](https://github.com/geraldoramos/crypto-bar)   - 使用Electron构建的macOS菜单栏应用程序.  ！[javascript_icon] 
- [Float coin](https://github.com/kaunteya/FloatCoin)   - 具有浮动窗口的原生菜单栏应用程序，支持许多Exchange.  ！[swift_icon] 
...
- [Trailer](https://github.com/ptsochantaris/trailer)   - 管理GitHub和GitHub企业的拉请求和问题.  ！[swift_icon] 
- [Xit](https://github.com/Uncommon/Xit)   -  Xit是一个用于处理git存储库的图形工具.  ！[swift_icon] 
...
- [vegvisir](https://github.com/ant4g0nist/vegvisir)   - 用于** LLDB **调试器的基于浏览器的GUI.  ！[javascript_icon] 

#### Web Development
- [CoreOS VM](https://github.com/TheNewNormal/coreos-osx)   -  CoreOS VM是macOS状态栏应用程序，可以轻松控制Mac上的CoreOS VM.  ！[objective_c_icon] 
...
- [stts](https://github.com/inket/stts)   - 用于监控云服务状态的macOS app.  ！[swift_icon] 
...
- [AppBox](https://github.com/vineetchoudhary/AppBox-iOSAppsWirelessInstallation)   -  iOS开发人员可以通过Dropbox帐户直接在设备上构建和部署开发，Ad-Hoc和内部（企业）应用程序的工具.  ！[objective_c_icon] 
- [AppIcons](https://github.com/kuyawa/AppIcons)   - 用于生成macOS和iOS应用程序所需的各种尺寸图标的工具.  ！[swift_icon] 
- [AppStoreReviewTimes](https://github.com/arbel03/AppStoreReviewTimes)   - 为您提供有关平均iOS / macOS应用商店审核时间的指示.  ！[swift_icon] 
- [AppleTrace](https://github.com/everettjf/AppleTrace)   - 用于iOS / macOS的跟踪工具.  ！[objective_c_icon] 
- [Asset Catalog Tinkerer](https://github.com/insidegui/AssetCatalogTinkerer)   - 允许您打开.car文件并浏览/提取图像的应用程序.  ！[objective_c_icon]！[swift_icon] 
- [Assets](https://github.com/athiercelin/Assets)   -  Assets是一个macOS应用程序，用于管理开发项目（Xcode，Web等）的资产.  ！[swift_icon] 
- [Attabench](https://github.com/attaswift/Attabench)   -  Attabench是macOS的微基准测试应用程序，旨在测量和可视化Swift代码的性能.  ！[swift_icon] 
- [Board For GitHub](https://github.com/JustinFincher/BoardForGitHub)   - 在本机macOS应用程序中监控GitHub项目网页的小应用程序：octocat：！  ！[objective_c_icon] 
- [Brisk](https://github.com/br1sk/brisk)   - 用于提交雷达的macOS应用程序.  ！[swift_icon] 
...
#### Markdown
- [Gingko](https://github.com/gingko/client)   - 用于macOS，Windows和Linux的树形结构降价编辑器.  ！[elm_icon] 
...
- [Pine](https://github.com/lukakerr/Pine)   - 现代MacOS降价编辑器.  ！[swift_icon] 

#### TeX
- [Qilin Editor](https://github.com/qilin-editor/qilin-app)   - 内置KaTeX / AsciiMath支持的精确科学文本编辑器.  ！[javascript_icon] 

#### Text
- [CotEditor](https://github.com/coteditor/CotEditor)   - 用于macOS的轻量级纯文本编辑器.  ！[swift_icon] 
...
- [SubEthaEdit](https://github.com/subethaedit/SubEthaEdit)   -  macOS的通用纯文本编辑器.  以其实时协作功能而广为人知.  ！[objective_c_icon] 
- [TextMate](https://github.com/textmate/textmate)   -  TextMate是macOS的图形文本编辑器.  ！[objective_c_icon] 
- [VimR](https://github.com/qvacua/vimr)   - 为macOS提供精致的Neovim体验.  ！[swift_icon] 

### Extensions
- [BetterPiP](https://github.com/Capevace/BetterPiP)   - 使用谷歌浏览器等HTML5视频等浏览器使用原生画中画.  ！[swift_icon] 
- [PiPTool](https://github.com/bfmatei/PiPTool)   - 在MacOS中为YouTube，Netflix，Plex和其他视频广播服务添加画中画功能.  ！[javascript_icon] 
- [PiPifier](https://github.com/arnoappenzeller/PiPifier)   -  PiPifier是一个原生的macOS 10.12 Safari扩展，可让您在画中画模式下使用每个HTML5视频.  ！[swift_icon] 

### Finder
- [Clipy](https://github.com/Clipy/Clipy)   -  Clipy是macOS的剪贴板扩展应用程序.  ！[swift_icon] 
...
- [GifCapture](https://github.com/onmyway133/GifCapture)   - 用于macOS的Gif捕获应用程序.  ！[swift_icon] 
- [Gifcurry](https://github.com/lettier/gifcurry)   - 视频到GIF制造商，具有图形界面，可以裁剪，添加文本，搜索和修剪.  ！[haskell_icon] 
- [Gifski](https://github.com/sindresorhus/gifski-app)   - 将视频转换为高品质的GIF.  ！[swift_icon] 
- [InfiniteCanvas](https://github.com/CleanCocoa/InfiniteCanvas)   - 概念验证Mac绘图应用程序.  ！[swift_icon] 
- [Material Colors Native](https://github.com/BafS/Material-Colors-native)   - 选择材料颜色并复制十六进制代码.  ！[objective_c_icon] 
...
- [ScreenToLayers for macOS](https://github.com/duyquoc/ScreenToLayers)   -  ScreenToLayers是一个macOS应用程序，可以轻松地将屏幕捕获为分层PSD文件.  ！[objective_c_icon]！[css_icon] 
- [Sketch Toolbox](https://github.com/buzzfeed/Sketch-Toolbox)   -  Sketch.app的插件管理器.  ！[objective_c_icon]！[c_icon] 
- [macSVG](https://github.com/dsward2/macSVG)   - 使用WebKit Web视图设计HTML5 SVG（可缩放矢量图形）艺术和动画的macOS应用程序.  ！[objective_c_icon] 
...
- [dejalu](https://github.com/dinhviethoa/dejalu)   - 快速简单的电子邮件客户端.  ！[cpp_icon]！[objective_c_icon] 
- [gInbox](https://github.com/chenasraf/gInbox)   -  Gmail的收件箱包装.  ！[swift_icon] 
...
- [CloudyTabs](https://github.com/josh-/CloudyTabs)   - 简单的菜单栏macOS应用程序，用于替换iCloud选项卡和阅读列表的列表.  ！[swift_icon] 
...
- [Spotify-Cli-Mac](https://github.com/ersel/spotify-cli-mac)   - 无需离开终端即可控制Spotify.  ：笔记：！[javascript_icon] 
- [YouTube-Music](https://github.com/steve228uk/YouTube-Music)   -  music.youtube.com的macOS包装器.  ！[swift_icon] 
- [iTunes Graphs](https://github.com/Zac-Garby/iTunes-Graphs)   -  macOS app将iTunes资料库可视化为图形.  ！[swift_icon] 
- [lyricsify](https://github.com/mamal72/lyricsify-mac)   -  Swift中用于macOS的简单Spotify歌词查看器菜单栏应用程序.  ！[swift_icon] 

### News
- [Diurna](https://github.com/ngquerol/Diurna)   -  Basic / Classic Hacker News应用程序，用作Cocoa和Swift学习平台.  ！[swift_icon] 
...
- [NoteTaker](https://github.com/insidegui/NoteTaker)   - 使用Realm和CloudKit进行同步的macOS和iOS简单笔记应用程序.  ！[swift_icon] 
- [Notes](https://github.com/SauvageP/Notes) -  Notes是一个macOS应用程序，用于创建笔记，使用其他格式的文本：图像，视频，联系人等等！[swift_icon] 
- [Simplenote](https://github.com/Automattic/simplenote-macos)   - 保持笔记的最简单方法.  ！[objective_c_icon] 
...
### Other
- [Cakebrew](https://github.com/brunophilipe/Cakebrew)   - 使用Cakebrew管理您的Homebrew公式.  ！[objective_c_icon] 
...
- [Keyframes Player](https://github.com/insidegui/KeyframesPlayer)   - 简单的macOS应用程序，用于预览使用Facebook的关键帧框架创建的动画.  ！[swift_icon] 
...
- [React Native Debugger](https://github.com/jhen0409/react-native-debugger)   - 用于检查React Native项目的桌面应用程序.  macOS，Linux和Windows.  ！[javascript_icon] 
...
- [RktMachine](https://github.com/woofwoofinc/rktmachine)   - 用于在macOS管理程序CoreOS VM中运行rkt的菜单栏macOS app.  ！[swift_icon] 
- [Ruby.app](https://github.com/gosu/ruby-app)   - 包含完整Ruby安装的macOS应用程序（用于Ruby / Gosu）.  ！[ruby_icon] 
- [Shuttle](https://github.com/fitztrev/shuttle)   -  macOS的简单SSH快捷菜单.  ！[objective_c_icon] 
...
- [Vagrant Manager](https://github.com/lanayotech/vagrant-manager)   - 使用Vagrant Manager for macOS在一个地方管理您的流浪汉机器.  ！[objective_c_icon] 
...
- [status-bar-todo](https://github.com/Onix-Systems/osx-status-bar-todo)   - 简单的macOS应用程序，以保持状态栏中的TODO列表.  ！[swift_icon] 
- [stretchly](https://github.com/hovancik/stretchly)   - 跨平台电子应用程序，提醒您在使用计算机时休息.  ！[javascript_icon] 

### Screensaver
- [Aerial](https://github.com/JohnCoates/Aerial)   - 用于macOS的Apple TV空中屏幕保护程序.  ！[swift_icon] 
...
- [Latest](https://github.com/mangerlahn/Latest)   - 适用于macOS的小型实用程序应用程序，可确保您了解所使用应用程序的所有最新更新.  ！[swift_icon] 
- [Loading](https://github.com/BonzaiThePenguin/Loading)   -  macOS的简单网络活动监视器.  ！[objective_c_icon] 
- [Overkill](https://github.com/KrauseFx/overkill-for-mac)   - 连接iPhone时停止打开iTunes.  ！[swift_icon] 
- [ProfileCreator](https://github.com/erikberglund/ProfileCreator)   -  macOS应用程序，用于创建标准或自定义配置文件.  ！[objective_c_icon] 
...
- [Monolingual](https://github.com/IngmarStein/Monolingual) - 从macOS中删除不必要的语言资源！[swift_icon] 
...
- [BingPaper](https://github.com/pengsrc/BingPaper)   - 使用Bing每日照片作为macOS上的壁纸.  ！[swift_icon] 
