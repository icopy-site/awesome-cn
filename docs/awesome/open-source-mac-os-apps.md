...
- [Background Music](https://github.com/kyleneideck/BackgroundMusic)  -背景音乐，一种macOS音频实用程序：自动暂停您的音乐，设置单个应用的音量并录制系统音频.  ！[cpp_icon] 
...
### Browser
- [Beaker Browser](https://github.com/beakerbrowser/beaker)  -Beaker是一种实验性的点对点Web浏览器.  ！[javascript_icon] 
...
- [Telegram Desktop](https://github.com/telegramdesktop/tdesktop)  -电报桌面消息传递应用程序.  ！[cpp_icon] 
 -[Telegram [Deprecated]]（https://github.com/overtake/telegram）-macOS版本已弃用的Telegram的源代码.  ！[objective_c_icon] 
...
- [Asset Catalog Tinkerer](https://github.com/insidegui/AssetCatalogTinkerer)  -该应用程序可让您打开.car文件并浏览/提取其图像.  ！[objective_c_icon]！[swift_icon] 
...
- [Gifcurry](https://github.com/lettier/gifcurry)  -通过图形界面向GIF制作者提供视频，该界面能够裁剪，添加文本，查找和修剪.  ！[haskell_icon] 
...
- [Oni](https://github.com/onivim/oni)  -Oni是现代的模态编辑代码编辑器，专注于开发人员的工作效率.  ！[javascript_icon]！[type_script_icon] 
...
- [Nylas Mail](https://github.com/nylas/nylas-mail)  -可扩展的邮件客户端.  ！[javascript_icon] 
...
-[Lilypond UI]（）-使用LilyPond创作优美的乐谱！[javascript_icon] 
- [Music Bar](https://github.com/musa11971/Music-Bar/)  -音乐栏是macOS应用程序，可将音乐控件直接放在菜单栏中.  ！[swift_icon] 
...
- [Letters](https://github.com/klaaspieter/letters)  -教孩子们字母和打字方法.  ！[swift_icon] 
...
- [Vagrant Manager](https://github.com/lanayotech/vagrant-manager)  -使用适用于macOS的Vagrant Manager在一个地方管理您的游民机器.  ！[objective_c_icon] 
...
- [Timer](https://github.com/michaelvillar/timer-app)  -适用于Mac的简单计时器应用程序.  ！[swift_icon] 
 -[Toggl Desktop]（）-Windows，Mac和Linux的Toggl Desktop应用程序.  ！[cpp_icon] 
...
- [Apple Juice](https://github.com/raphaelhanneken/apple-juice)  -适用于macOS的高级电池电量表.  ！[swift_icon] 
...
- [Maria](https://github.com/shincurry/Maria)  -用于aria2下载工具的macOS本机应用程序/小工具.  ！[swift_icon] 
...
- [PercentCalculator](https://github.com/cemolcay/PercentCalculator)  -用于计算百分比的菜单栏应用程序.  ！[swift_icon] 
