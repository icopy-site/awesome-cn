...
- [ShazamScrobbler](https://github.com/ShazamScrobbler/shazamscrobbler-macos)  -乱涂乙烯基，收音机，电影到Last.fm.  ！[objective_c_icon] 
...
- [eqMac2](https://github.com/nodeful/eqMac2)  -适用于Mac的系统范围均衡器.  ！[cpp_icon] 
...
- [Mockup Generator](https://github.com/andypotts/mockup-generator)  -Mockup Generator是一个使用AngularJS / Electron构建的macOS应用，位于菜单栏中，可让您捕获自己喜欢的网站的屏幕截图并将其包装在设备模型中.  ！[javascript_icon] 
...
- [Asset Catalog Tinkerer](https://github.com/insidegui/AssetCatalogTinkerer)  -可以打开.car文件并浏览/提取其图像的应用程序.  ！[objective_c_icon]！[swift_icon] 
...
- [CocoaRestClient](https://github.com/mmattozzi/cocoa-rest-client)  -本地Apple macOS应用程序，用于测试HTTP / REST端点.  ！[objective_c_icon] 
...
- [WWDC.srt](https://github.com/ssamadgh/WWDCsrt)  -强大的应用程序，可从（srt）格式下载2013年以来的每个WWDC会话视频的字幕.  ！[swift_icon] 
...
- [Sessions](https://github.com/AlexPerathoner/Sessions)  -Safari扩展以保存您的工作会话.  ！[swift_icon] 
...
- [cd to... ](https://github.com/jbtule/cdto) -Finder工具栏应用程序在终端中打开当前目录！[objective_c_icon] 
...
- [OpenRCT2](https://github.com/OpenRCT2/OpenRCT2) -重新实现了RollerCoaster Tycoon2.！[cpp_icon] 
...
- [Gifcurry](https://github.com/lettier/gifcurry)  -通过图形界面向GIF制作者提供视频，该界面可以裁剪，添加文本，查找和修剪.  ！[haskell_icon] 
...
- [Music Bar](https://github.com/musa11971/Music-Bar/)  -音乐栏是macOS应用程序，可将音乐控件直接放在菜单栏中.  ！[swift_icon] 
- [Night Shift Control](https://github.com/isaiasmatewos/night-shift-control)  -Night Shift Control是用于控制Night Shift的简单macOS菜单栏应用程序.  目的是引入f.lux中Night Shift所缺少的功能，例如为某些应用程序禁用Night Shift.  ！[swift_icon] 
...
- [ChordDetector](https://github.com/cemolcay/ChordDetector)  -微小的菜单栏应用程序，可收听iTunes和Spotify以检测歌曲的和弦！  ！[swift_icon] 
- [DeezPlayer](https://github.com/imanel/deezplayer) - Deezer Desktop app for Windows, Linux and macOS.  ![coffee_script_icon] 
 -[Lilypond UI]（）-使用LilyPond创建优美的乐谱.  ！[javascript_icon] 
- [Music Bar](https://github.com/musa11971/Music-Bar/)  -音乐栏是macOS应用程序，可将音乐控件直接放在菜单栏中.  ！[swift_icon] 
- [PlayStatus](https://github.com/nbolar/PlayStatus)  -PlayStatus是一个macOS应用程序，允许从菜单栏中控制Spotify和iTunes音乐的播放.  ！[swift_icon] 
...
### Notes
- [Boostnote](https://github.com/BoostIO/Boostnote)  -像您一样为程序员制作的笔记应用程序.  ！[javascript_icon] 
...
- [Hosts](https://github.com/specialunderwear/Hosts.prefpane)  -用于/ etc / hosts的可可GUI.  ！[objective_c_icon] 
...
- [Podlive for macOS](https://github.com/phranck/podlive-macos)  -macOS客户端以收听实时流播播客（仅）.  目前，它支持通过Ultraschall和 [Studio Link On Air](https://studio-link.de) .  ！[objective_c_icon] 
...
- [mac2imgur](https://github.com/mileswd/mac2imgur)  -简单的Mac应用程序，旨在快速轻松地将图像和屏幕截图上传到Imgur.  ！[swift_icon] 
...
- [Clean-Me](https://github.com/Kevin-De-Koninck/Clean-Me)  -充当系统清洁程序的小型macOS应用程序（日志，缓存等）.  ！[swift_icon] 
...
- [EtreCheck](https://github.com/etresoft/EtreCheck)  -EtreCheck是一个易于使用的macOS应用，可显示系统配置的重要细节，并允许您将该信息复制到剪贴板.  ！[objective_c_icon] 
...
- [Sloth](https://github.com/sveinbjornt/Sloth)  -Sloth是macOS应用程序，它显示系统上所有正在运行的应用程序正在使用的所有打开文件和套接字的列表.  ！[objective_c_icon] 
...
- [Upterm](https://github.com/railsware/upterm)  -21世纪的终端仿真器（以前为Black Screen）.  ！[javascript_icon] 
- [cd to... ](https://github.com/jbtule/cdto) -Finder工具栏应用程序在终端中打开当前目录！[objective_c_icon] 
...
- [Touch Bar Preview](https://github.com/touchbar/Touch-Bar-Preview)  -小型应用程序，可在新MacBook Pro的触摸栏上显示您的设计.  ！[swift_icon] 
...
- [Bitwarden](https://github.com/bitwarden/desktop)  -针对个人，团队和商业组织的跨平台密码管理解决方案.  ！[type_script_icon] 
...
- [Gifted](https://github.com/vdel26/gifted)  -快速，轻松地将任何短视频转换为GIF动画.  ！[objective_c_icon] 
...
- [VLC](https://github.com/videolan/vlc) -VLC是一个免费且开源的跨平台多媒体播放器！[c_icon] 
...
- [Yoda](https://github.com/whoisandy/yoda)  -漂亮的macOS应用程序，可让您浏览和下载YouTube中的视频.  ！[javascript_icon] 

### Wallpaper
- [500-mac-wallpaper](https://github.com/cuddlecheek/500-mac-wallpaper)  -状态栏的简单macOS应用程序，可将照片从500px.com自动下载到可设置为墙纸来源的本地文件夹中.  ！[swift_icon] 
...
- [Phoenix](https://github.com/kasper/phoenix)  -可通过JavaScript编写脚本的轻量级macOS窗口和应用程序管理器.  ！[objective_c_icon] 
