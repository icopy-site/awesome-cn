...
* [Apollo Client](https://github.com/apollographql/apollo-client) -适用于每个UI框架和GraphQL服务器的功能完备的生产就绪型缓存GraphQL客户端.
...
* [GRelDAL](https://gql-dal.github.io/greldal/) -用于关系数据存储和GraphQL API之间双向映射的简单微框架.

#### Miscellaneous

* [GraphQL.js](https://github.com/graphql/graphql-js) -GraphQL for JavaScript的参考实现.
* [graphql-yoga](https://github.com/prisma-labs/graphql-yoga) -功能齐全的GraphQL Server，着重于简单的设置，性能和出色的开发人员体验.
...
* [graphql-normalizr](https://github.com/monojack/graphql-normalizr) -规范GraphQL响应以持久保存在客户端缓存/状态中
...
* [graphql-anywhere](https://github.com/apollographql/graphql-anywhere) -在任何模式下针对任何数据在任何地方运行GraphQL查询.
* [graphql-tag](https://github.com/apollographql/graphql-tag) -解析GraphQL查询的JavaScript模板文字标签.
* [modelizr](https://github.com/julienvincent/modelizr) -用于简化编写GraphQL查询，模拟它们和规范其响应的过程的库.
...
* [babel-relay-plugin](https://www.npmjs.com/package/babel-relay-plugin) -Babel中继插件，用于转译GraphQL查询以与中继一起使用.
...
* [graphql-mapper](https://github.com/4rthem/graphql-mapper) （* abandoned *）-该库允许基于您的模型构建GraphQL模式.
...
* [graphql-core](https://github.com/graphql-python/graphql-core) -基于GraphQL.js v0.6.0参考实现的Python的GraphQL实现
...
* [graphene](https://github.com/graphql-python/graphene) -一个用于以Pythonic简单方式创建GraphQL模式/类型的软件包.
...
* [graphql-java-codegen-maven-plugin](https://github.com/kobylynskyi/graphql-java-codegen-maven-plugin)  -架构优先的Maven插件，用于生成Java类型和解析器接口.  与graphql-java-tools完美结合使用.  受启发 [swagger-codegen-maven-plugin](https://github.com/swagger-api/swagger-codegen/tree/master/modules/swagger-codegen-maven-plugin).
...
* [vertx-dataloader](https://github.com/engagingspaces/vertx-dataloader) -Facebook DataLoader的端口，用于在群集的GraphQL环境中进行高效的异步批处理和缓存
...
* [graphql-net](https://github.com/ckimes89/graphql-net) -GraphQL为.NET的IQueryable.
...
* [subZero](https://subzero.cloud/) -适用于您数据库的GraphQL和REST API
...
* [apollo-android](https://github.com/apollographql/apollo-android) -ðŸ“Ÿ一个用Java编写的用于Android的强类型缓存GraphQL客户端

<a name="lib-ios" />

### iOS Libraries

* [apollo-ios](https://github.com/apollographql/apollo-ios) -ðŸ“±一种用于iOS的强类型缓存GraphQL客户端，用Swift编写
...
* [graphql-client](https://github.com/tomhoule/graphql-client) -带有WebAssembly（wasm）支持的Rust的GraphQL客户端库.
* [graphql-parser](https://github.com/graphql-rust/graphql-parser) -用于GraphQL查询和Rust的模式定义语言的解析器，格式化程序和AST.
...
* [Annotated GraphQL Server](https://github.com/almilo/annotated-graphql-server) -带有注释的GraphQL的服务器，显示了如何将REST api转换为带有注释的GraphQL端点.
...
* [GraphQL Faker](https://github.com/APIs-guru/graphql-faker)  -使用伪造的数据模拟或扩展您的GraphQL API.  无需编码.
...
* [json-graphql-server](https://github.com/marmelab/json-graphql-server) -根据JSON数据文件，在不到30秒的时间内获取具有零编码的完全伪造的GraphQL API.
* [Insomnia](https://insomnia.rest/) â€“Â An full-featured API client with first-party GraphQL query editor
* [Prisma](https://github.com/prisma/prisma)  -将您的数据库转换为GraphQL API.  Prisma可让您设计数据模型，并在几分钟内就可以在线使用准备就绪的GraphQL API.
...
* [GRAPHQL DESIGNER](http://graphqldesigner.com/) -开发人员的Web应用程序工具，用于使用React快速实现GraphQL的全栈CRUD实现的原型.
* [GraphQL Inspector](https://graphql-inspector.com/)  -GraphQL工具.  比较架构，验证文档，查找重大更改，查找相似类型，架构覆盖率.
* [graphql-typed-client](https://github.com/helios1138/graphql-typed-client)  -为任何GraphQL端点生成强类型客户端库的工具.  客户端允许将GraphQL查询作为普通的JS对象编写（具有类型安全性和出色的代码完成经验）
* [OpenAPI-to-GraphQL](https://github.com/ibm/openapi-to-graphql) -使用任何OpenAPI规范（OAS）或摇摇晃晃并创建GraphQL接口-两分钟的视频和资源 [here](https://developer.ibm.com/open/projects/openapi-to-graphql/)
...
* [FaunaDB](https://fauna.com) -关系NoSQL数据库 [GraphQL schema import.](https://fauna.com/blog/getting-started-with-graphql-part-1-importing-and-querying-your-schema) 支持按每次使用无服务器定价的联接，索引和多区域ACID事务.
* [ArangoDB](https://arangodb.com/) -具有以下功能的本机多模型数据库 [GraphQL integration](https://www.arangodb.com/docs/3.4/foxx-reference-modules-graph-ql.html) 通过内置 [Foxx Microservices Framework](https://www.arangodb.com/docs/stable/foxx.html).
...
* [serverless-graphql-blog](https://github.com/serverless/serverless-graphql-blog) -利用GraphQL提供仅1个端点的REST API的无服务器博客
* [relay-cart](https://github.com/soonlive/relay-cart) -一个简单的购物车示例，将继电器和GraphQL与路由和分页结合起来.
...
* [Apollo Server tools documentation](https://www.apollographql.com/docs/apollo-server/) -用于构建GraphQL服务器以及连接到SQL，MongoDB和REST端点的文档，教程和示例.
...
* [Intuitive GraphQL Resolver Example](https://github.com/xpepermint/graphql-example) -使用GraphQL的应用示例 [contextable.js](https://github.com/rawmodel/framework).
* [GraphQL Tutorial](https://github.com/rse/graphql-tutorial) -GraphQL的分12步讲解，从简单的Hello World到带有内置GraphQL UI的基于网络的GraphQL服务器
...
* [relay-rails-blog](https://github.com/gauravtiwari/relay-rails-blog) -由graphql，继电器和标准导轨应用程序提供支持的演示Weblog.
...
* [apollo-frontpage-android-app](https://github.com/rnitame/apollo-frontpage-android-app) -ðŸ“„ Apollo“ hello world”应用程序，用于Android

<a name="example-ios" />

### iOS Examples

* [frontpage-ios-app](https://github.com/apollographql/frontpage-ios-app) -ðŸ“„ Apollo“ hello world”应用程序，适用于iOS
...
* [Fullstack GraphQL](https://www.graphql.college/fullstack-graphql) 朱利安·梅奥尔加（Julian Mayorga）
...
* [GraphQL of Thrones](https://graphql-of-thrones.herokuapp.com/)  -完整的初学者教程仅关注GraphQL，而没有所有工具.  在“学习”和“演奏”模式之间交替切换，扮演“权力的游戏”角色.
