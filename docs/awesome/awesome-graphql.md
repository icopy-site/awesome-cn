...
* [angular2-graphql-rest](https://github.com/kamilkisiela/angular2-graphql-rest)  - 一个带有 REST Api 的示例应用程序，使用带有 angular2-apollo 的 Apollo 客户端与 GraphQL 并行工作. 包括如何从 REST 迁移到 GraphQL 的分步教程.
