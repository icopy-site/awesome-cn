...
- [wagtail-readability](https://github.com/takeflight/wagtail-readability) -测试输入到Wa中的内容的可读性.
...
- [Wagtail FilePreviews](https://github.com/filepreviews/wagtail-filepreviews) -使用来自FilePreviews.io的图像预览和元数据扩展Wagtail的文档.
...
- [Wagtail Modeltranslation](https://github.com/infoportugal/wagtail-modeltranslation) -包含集成了mixin模型的简单应用 [django-modeltranslation](https://github.com/deschler/django-modeltranslation) 进入Wa面板系统.
...
- [Wagtail Simple Captcha](https://github.com/acarasimon96/wagtail-django-simple-captcha) -Wagtail ReCaptcha的自托管替代方案，可轻松集成 [django-simple-captcha](https://github.com/mbi/django-simple-captcha) 字段进入Wa形式生成器.
...
- [Wagtail Sharing](https://github.com/cfpb/wagtail-sharing) – sharing尾草稿更容易共享.
...
- [Wagtail Starter Kit](https://github.com/tkjone/starterkit-wagtail) –包括w，django布局，无业游民，预配书，前端构建系统等的切碎机！
...
- [Wagtail Tutorials: Build Blog Step by Step](https://www.accordbox.com/blog/wagtail-tutorials/) -这些教程教您如何逐步从头创建标准博客.
- [Python CMS Framework Review: Wagtail vs Django-CMS](https://www.accordbox.com/blog/python-cms-framework-review-wagtail-vs-django-cms/) -讨论Django-CMS和Wagtail（Python世界中两个最受欢迎的CMS框架）之间的区别.
...
- [DjangoCon US 2015 - Wagtail - Yet Another Django CMS](https://www.youtube.com/watch?v=6j0NVq6g4FE) 由汤姆·戴森（Tom Dyson）撰写-汤姆（Tom）将解释其机构为何决定建立一个新的CMS，分享在运行不断发展的开源项目中吸取的一些经验教训，并概述Wagtail到版本2及更高版本的路线图. [Slide deck](https://speakerdeck.com/tomdyson/wagtail-yet-another-cms-djangocon-us-2015).
...
- [Wagtail Wednesdays #03 - Using tabs to create a cleaner admin interface](https://www.youtube.com/watch?v=uZc0aZrHtQw) -克里斯通过选项卡组织字段来指导您.
- [Wagtail Wednesdays #04 - Organising Images and Documents using Wagtail Collections](https://www.youtube.com/watch?v=HGXHtFpLDCA) -Kieran会指导您完成将图像和文档组织到集合中的过程.
...
- [Wagtail Wednesdays #06 - Creating & using custom settings in your wagtail site](https://www.youtube.com/watch?v=KJWCGq3IRNc) -克里斯会指导您完成设置并使用自定义网站设置.
...
- [PyPI - Python Package Index](https://pypi.org/search/?q=Wagtail) -g包装上的on包装.
...
- [Wagtail Space](https://www.wagtail.space/)  -g培训课程，Wa谈话（闪电）和a冲刺. 从2019年3月13日至15日，Wa尾空间将在荷兰阿纳姆举行.
