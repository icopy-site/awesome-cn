...
* [ServiceStack](https://github.com/ServiceStack/ServiceStack) -为所有人精心设计，速度快，完全愉悦的Web服务
...
* [Butterfly Server .NET](https://butterflyserver.io)  -启用定义Web API和Subscription API的功能，该API可自动跨连接的客户端同步数据集.  允许以最少的精力构建实时Web应用程序和本机应用程序.
...
* [AspectCore Framework](https://github.com/dotnetcore/AspectCore-Framework)  -AspectCore框架是.NET Core和.NET Framework的基于面向方面的编程的跨平台框架.  对方面拦截器，依赖注入集成，Web应用程序，数据验证等的核心支持.
* [HopFramework](https://github.com/DiegoTondim/hop-framework) -HopFramework是一个框架，可使用“域驱动设计”和许多模式轻松创建项目，以交付更好的解决方案.
...
* [The Little ASP.NET Core Book](https://recaffeinate.co/book/) -一本基于教程的免费，开放源代码，旨在对ASP.NET Core进行简单介绍.
...
* [CacheAdapter](https://bitbucket.org/glav/cacheadapter) -另一个常见的缓存抽象层，用于使用增强的缓存API使用率进行缓存.
...
* [Piranha CMS](https://github.com/PiranhaCMS/Piranha)  -Piranha是一个有趣，快速且轻量级的.NET框架，用于额外开发基于cms的Web应用程序.  它基于ASP.NET MVC和Web页构建，并且与Visual Studio和WebMatrix完全兼容.  https://piranhacms.org
...
* [Storage.Net](https://github.com/aloneguid/storage) -适用于流行的云存储提供商（例如Amazon S3，Azure服务总线，Azure事件中心，Azure存储，Azure Data Lake Store等）的通用存储抽象和实现.
...
* [Zebus](https://github.com/Abc-Arbitrage/Zebus)  -Zebus是一种轻量级，高度通用的点对点服务总线，其设计考虑了CQRS原理.  它允许应用程序以快速简便的方式彼此通信.  大多数复杂性隐藏在库中，您可以专注于编写对自己重要的代码，而不是调试消息传递代码.  任何分布式应用程序的基础.
...
* [GitExtensions](https://github.com/gitextensions/gitextensions)  -GitExtensions是Shell扩展，Visual Studio 2008/2010/2012/2013插件和独立的Git存储库工具.  https://gitextensions.github.io/
...
* [MahApps.Metro](https://github.com/MahApps/MahApps.Metro) -用于创建Metro风格的WPF应用的工具包
...
* [Dragablz](https://github.com/ButchersBoy/Dragablz) -可拖动，可撕裂的WPF选项卡控件（类似于Chrome），支持布局且具有完整主题，包括与MahApps和Material Design兼容的布局.
...
* [UWP Community Toolkit](https://github.com/windows-toolkit/WindowsCommunityToolkit)  -UWP社区工具包是辅助功能，自定义控件和应用程序服务的集合.  它简化并演示了开发针对Windows 10的UWP应用的常见开发人员任务.
...
* [Ooui](https://github.com/praeclarum/Ooui) -一个小的跨平台UI库，它将本机UI开发的简单性带到了Web
...
* [ResX Resource Manager](https://github.com/tom-englert/ResXResourceManager) -使用基于Resx的资源本地化所有类型应用程序的最受欢迎的免费工具.
...
* [ML.NET](https://github.com/dotnet/machinelearning) -跨平台的开源机器学习框架，该框架使.NET开发人员可以访问机器学习.
...
* [FluentEmail](https://github.com/lukencode/FluentEmail) -具有Razor模板支持的System.Net.Mail的流畅包装.
...
* [GeometRi](https://github.com/RiSearcher/GeometRi.CSharp) -.Net的简单轻量级计算几何库
...
* [MSBuild ILMerge task](https://archive.codeplex.com/?p=ilmergemsbuild) -MSBuild ILMerge任务是一个NuGet程序包，它允许您在自动生成和/或Visual Studio项目中使用著名的ILMerge实用程序.
...
* [Warden](https://github.com/warden-stack/Warden)  -为您的应用程序，资源和基础架构定义“运行状况检查”.  守望守望
...
* [Caliburn.Micro](https://github.com/Caliburn-Micro/Caliburn.Micro)  -一个小而强大的框架，旨在跨所有XAML平台构建应用程序.  它对MV *模式的强大支持将使您能够快速构建解决方案，而无需牺牲代码质量或可测试性.
...
* [UpdateControls](https://updatecontrols.net/cs/)  -更新控件不需要您实现`INotifyPropertyChanged`或声明`DependencyProperty`.  它将控件直接连接到CLR属性.  这使其非常适合于Model / View / ViewModel模式.
...
* [EntityFramework.Exceptions](https://github.com/Giorgi/EntityFramework.Exceptions) -当您的SQL查询违反SqlServer，MySql，PostgreSQL或SQLite中的数据库约束时，对Entity Framework Core使用类型化异常
...
* [Fluent NHibernate](https://github.com/FluentNHibernate/fluent-nhibernate) -NHibernate的流利，少XML，可编译安全，基于约定的自动化映射.
...
* [PetaPoco](https://github.com/CollaboratingPlatypus/PetaPoco) -对于您的POCO来说，属于ORM类的小事情
...
* [Cloudmersive PDF](https://cloudmersive.com/pdf-api)  -Cloudmersive PDF是本机.NET Framework和.NET Core NuGet库和API服务，可以大规模，保真度创建，修改，加密或转换PDF文档；  并且可以免费使用且没有过期** [免费] **
* [ITextSharp](https://github.com/itext/itextsharp) -iText是一个PDF库，可让您以可移植文档格式（PDF）**创建，修改，检查和维护文档** [$] **** [OSS免费] **
...
* [Pdfium.Net SDK](https://pdfium.patagames.com/) - Advanced C# PDF library for render, create, edit, merge, split, print, and view PDFs. Open source PDF Viewer is available on [GitHub](https://github.com/patagames) .  一个 [NuGet package](https://www.nuget.org/packages/Pdfium.Net.SDK/) 也可以轻松包含到您的项目中.** [$] **
...
* [MassTransit](https://github.com/MassTransit/MassTransit) -MassTransit是一种精益服务总线实现，用于使用.NET Framework构建松耦合的应用程序.
...
* [Dynamic Data](https://github.com/reactiveui/DynamicData) -集合的反应性扩展（Rx）
...
* [Strong Namer](https://github.com/dsplaisted/strongnamer)  -自动将强名称添加到尚未具有强名称的引用程序集中.  这将允许您从使用强名称的项目中引用和使用非强名称的程序集（带有NuGet程序包）.
...
* [AutoFixture](https://github.com/AutoFixture/AutoFixture) -AutoFixture是.NET的开源框架，旨在最大程度地减少单元测试的“安排”阶段
...
* [Fluent Assertions](https://github.com/fluentassertions/fluentassertions) -一组.NET扩展方法，使您可以更自然地指定TDD或BDD样式测试的预期结果
...
* [NFluent](http://www.n-fluent.net) -NFluent是一个断言库，旨在流利您的.NET TDD经验.
...
* [ReportPortal](https://reportportal.io)  -人工智能驱动的测试自动化仪表板.  获取，汇总和分析测试报告以确定发布状况.
...
* [Open Live Writer](https://github.com/OpenLiveWriter/OpenLiveWriter)  -与WordPress，Blogger等集成的博客作者.  等  Open Live Writer使您可以轻松地编写，预览和发布到博客.  有关更多信息，请参见http://openlivewriter.org.
...
* [SmartCode](https://github.com/Smart-Kit/SmartCode)  -SmartCode = IDataSource-&gt; IBuildTask-&gt; IOutput =&gt;构建所有内容！！！  （包括[**代码生成器**]）
...
* [Git Diff Margin](https://github.com/laurentkempe/GitDiffMargin) -在Visual Studio页边距和滚动条上显示当前已编辑文件的实时Git更改
...
* [VSColorOutput](https://marketplace.visualstudio.com/items?itemName=MikeWard-AnnArbor.VSColorOutput)  -突出显示Build，Find和Debug输出窗口的颜色.  可以添加自定义匹配样式和颜色.
* [Developer Assistant](https://marketplace.visualstudio.com/items?itemName=VisualStudioPlatformTeam.DeveloperAssistant) -Visual Studio开发人员助手使开发人员可以在Visual Studio IDE中查找和重用2100万个代码段和代码示例项目.
...
* [EmbedIO](https://github.com/unosquare/embedio) -基于Mono和跨平台的Web服务器
...
* [SignalR](https://github.com/SignalR/SignalR) -ASP.NET开发人员的库，使向应用程序中添加实时Web功能变得异常简单
...
* [TopShelf](https://github.com/Topshelf/Topshelf) -使用.NET构建Windows服务的简单服务托管框架

## WPF

* [Data Grid Extensions](https://github.com/tom-englert/DataGridExtensions) -WPF DataGrid控件的模块化扩展，例如过滤，其他列事件，扩展的星形列行为等等.
...
* [Awesome .NET Performance](https://github.com/adamsitnik/awesome-dot-net-performance) -精选的.NET Performance书籍，课程，培训，会议演讲，博客和最具启发性的开源贡献者的精选列表.
