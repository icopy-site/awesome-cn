...
* [Ether.Network](https://github.com/Eastrall/Ether.Network) -Ether.Network是一个开放源代码网络库，允许开发人员通过TCP / IP协议创建简单，快速和可扩展的套接字服务器或客户端应用程序.
...
* [MVC.Template](https://github.com/NonFactors/MVC6.Template) -ASP.NET Core MVC项目入门模板.
...
* [Logibit Hawk](https://github.com/logibit/logibit.hawk/) -自动对焦# [Hawk](https://github.com/hueniverse/hawk#usage-example) 认证库
...
* [Command Line Parser](https://github.com/commandlineparser/commandline) -命令行解析器库向CLR应用程序提供了简洁的API，用于处理命令行参数和相关任务
...
* [Event Store](https://github.com/EventStore/EventStore)  -具有JavaScript中复杂事件处理功能的开源功能数据库.  https://eventstore.org/
...
* [FluentBootstrap](http://fluentbootstrap.com) -使Bootstrap CSS框架更易于从ASP.NET MVC或WebPages使用.
...
* [lamar](https://github.com/jasperfx/lamar/) -用于.Net的原始IoC / DI容器（以前为StructureMap）
* [Spring.Net](https://github.com/spring-projects/spring-net) -Spring.NET是一个开源应用程序框架，使构建企业.NET应用程序更加容易
...
* [MathNet](https://www.mathdotnet.com/) -Math.NET是一项开放源代码计划，旨在构建和维护涵盖基本数学的工具包，既针对.NET开发人员的高级需求，又满足其日常需求
...
* [ServiceStack.OrmLite](https://github.com/ServiceStack/ServiceStack.OrmLite) -轻巧，简单，快速的基于约定的POCO ORM **[[Free for OSS](https://github.com/ServiceStack/ServiceStack.OrmLite/blob/master/license.txt)]** **[$]**
...
* [Pdfium.Net SDK](https://pdfium.patagames.com/c-pdf-library/) - Advanced C# PDF library for render, create, edit, merge, split, print, and view PDFs. Open source PDF Viewer is available on [GitHub](https://github.com/patagames) .  一种 [NuGet package](https://www.nuget.org/packages/Pdfium.Net.SDK/) 也可以轻松包含到您的项目中.** [$] **
...
* [Dynamic Data](https://github.com/RolandPheasant/DynamicData) -集合的反应性扩展（Rx）
...
* [ReportPortal](http://reportportal.io)  -人工智能驱动的测试自动化仪表板.  获取，汇总和分析测试报告以确定发布状况.
...
* [Open Live Writer](https://github.com/OpenLiveWriter/OpenLiveWriter)  -与WordPress，Blogger等集成的博客作者.  人.  Open Live Writer使您可以轻松地编写，预览和发布到博客.  有关更多信息，请参见http://openlivewriter.org.
...
* [Papercut](https://github.com/ChangemakerStudios/Papercut) -Papercut是一个开放源代码（基于.NET）的测试电子邮件查看器，它通过内置的SMTP服务器在本地运行，该服务器设计用于接收和通知测试电子邮件.
...
* [Web Essentials](https://github.com/madskristensen/WebEssentials2013) -Web Essentials扩展了Visual Studio的许多新功能，这是Web开发人员多年来一直缺少的功能
...
* [SideWaffle](https://github.com/ligershark/side-waffle) -用于Visual Studio 2012/2013的项目模板的集合，使任何Web开发人员的工作变得更加轻松
