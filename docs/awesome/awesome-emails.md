...
- [Responsive Transactional HTML Email Templates](https://github.com/mailgun/transactional-email-templates) （每个模板都是响应式的，每个模板都在所有流行的电子邮件客户端中进行过测试
...
- [htmlemail](https://htmlemail.io/) - 面向初创公司和开发人员的响应式HTML电子邮件模板.
...
- [Sendgrid](https://sendgrid.com/) - 通过一个可靠的平台提供交易和营销电子邮件.
- [Postal](https://github.com/atech/postal) - 用于传入和传出电子邮件的功能齐全的开源邮件传送平台.
- [SparkPost](https://www.sparkpost.com/) - 您的应用程序的电子邮件：按时交付并发送到收件箱.
- [Mautic](https://mautic.com/)   -  Mautic营销自动化.  通过快速学习，易于使用且易于迭代的营销自动化，构建更智能的营销活动 - 并更快地构建它们.
...
- [Mailchimp Inspiration](http://inspiration.mailchimp.com/#all) -  Mailchimp精美时事例.
...
- [Building Responsive Email Templates with Ink](https://scotch.io/tutorials/building-responsive-email-templates-with-ink) - 使用Ink构建响应式电子邮件模板.
- [Litmus learning](https://litmus.com/community/learning) -  Litmus学习资源.
