...
- [fkill](https://github.com/sindresorhus/fkill-cli)   - 杀死进程.  跨平台.
...
- [exec() behavior between shells](https://github.com/isaacs/spawn-wrap#contracts-and-caveats) - 取决于所使用的shell，例如bash与dash，`child_process.exec（）`具有不一致的退出行为.
