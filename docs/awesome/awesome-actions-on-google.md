...
With [Actions on Google](https://developers.google.com/actions/) ，您可以轻松地与Google的用户接触并与之互动.  从快速命令到完整对话，“操作”可帮助您使用Google助手将内容和服务与用户联系起来.
...
- [Creating personality for your Actions](https://youtu.be/dh_mixqvrP0) -在本次播出的助理节目中，主持人Jessica Dene Early Cha和来宾Wally Brill讨论了使用角色扮演进行设计的重要性以及如何使其变得生动起来.
- [Intro to the Google Assistant: Build Your First Action (Google I/O'19)](https://youtu.be/dpNrq_wiqGs) -本简介课将介绍Google助手的基本知识以及您在未来的辅助工作中可以做什么.
...
- [Smart Home 101: How to Develop for the Connected Home (Google I/O'19)](https://youtu.be/SJ2KYVKfURA) -该会议内容涵盖了我们智能家居API的最新工具和功能的更新，以及开发人员和设备制造商如何从与Google Assistant生态系统的更深入集成中受益.
...
- [Local Technologies for the Smart Home (Google I/O'19)](https://youtu.be/Y6Ue5hQ9meM) -本次演讲将深入研究新的SDK，使开发人员可以在本地与智能设备进行通信并控制其智能设备，并提供即将发布的内容的预览.
...
- [PDPU Scheduler](https://github.com/nish17/scheduler) -这是PDPU的Google助手操作，可告诉您今天有哪些课程和实验.
...
- [Fun Tricks](https://assistant.google.com/services/a/uid/00000038e95bb789)  -通过玩笑和其他有趣的技巧减轻您的生活负担.  检查一下，总是有新尝试.
- [Google Podcasts](https://assistant.google.com/services/a/uid/000000e0ea9c992f) -通过询问助手来收听您喜欢的播客.

## Contribute

 欢迎捐款！  阅读 [contribution guidelines](https://github.com/ravirupareliya/awesome-actions-on-google/blob/master/contributing.md) 第一.
