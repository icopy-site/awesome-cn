...
<br />我们决定不在此处列出教程，资源或概念，因为已经有一个**[very good list of readings](https://github.com/mbostock/d3/wiki/Tutorials)**在那里，您可以签出并参与其中.
...
- [billboard.js](https://github.com/naver/billboard.js) -可重复使用的图表库[条形图，折线图，面积图，甜甜圈图，饼图，阶梯图，样条曲线]
- [britecharts](https://github.com/eventbrite/britecharts/) -客户端可重复使用的图表库[条，线，甜甜圈，迷你图，步骤]
- [chart-parts](https://github.com/Microsoft/chart-parts) -灵活，易于使用的图形语法，用于数据可视化
- [cirrusjs](https://github.com/planet-os/cirrusjs) -多渲染器图表库[区域，折线图，堆积图]
- [cubism](https://github.com/square/cubism) -时间序列可视化
- [c3](https://github.com/c3js/c3) -可重复使用的图表库[线，样条，步骤，面积，堆叠式，条形，饼图，甜甜圈]
...
- [d3-beeswarm](https://github.com/Kcnarf/d3-beeswarm) -可以计算蜂群排列的插件
...
- [d3-ez](https://github.com/jamesleesaunders/d3-ez) -易于重复使用的D3图表和组件[条形图，甜甜圈，派，气泡，玫瑰，热图]
...
- [d3-upset](https://github.com/chuntul/d3-upset) -绘制UpSet图的功能[upset，bar，交点，venn，关系]
- [d3-x3d](https://github.com/jamesleesaunders/d3-x3d) -带有D3和X3D的数据驱动3D图表[气泡，条形图，表面积，散点图，面积]
- [d3fc](https://github.com/d3fc/d3fc) -交互式图表组件的集合[线条，条形图，堆积图，散点图，烛台图，ohlc图]
- [d3plus](https://github.com/alexandersimoes/d3plus) -扩展库，可轻松创建可视化[散点图，堆积图，线图，条形图，饼图，网络图，气泡图，框图，地图]
- [d3panels](https://github.com/kbroman/d3panels) -带有关联刷图的交互式图表[点，散点，线，热图，直方图]
...
- [insights](https://github.com/ignacioola/insights) -可视化和导航图形的库
...
- [plotly.js](https://github.com/plotly/plotly.js/) -高级图表库[散布图，折线图，条形图，饼图，箱形图，直方图，热图]
...
- [taucharts](https://github.com/TargetProcess/tauCharts) -注重设计和灵活性的图表[线条，条形图，面积图，堆叠图]
...
- [WebCola](https://github.com/tgdwyer/WebCola) -用于图形可视化和探索的布局
- [xkcdgraphs](https://github.com/imkevinxu/xkcdgraphs) -Xkcd样式图[线]

##### Third Party

- [angular-nvd3](https://github.com/krispo/angular-nvd3) -用于AngularJS的NVd3 [线条，堆积，条形，区域，散点图，子弹，甜甜圈]
...
- [ember-charts](https://github.com/Addepar/ember-charts/) -灰烬图表[线条，条形图，堆积图，饼图，散点图]
...
- [potion](https://github.com/finnfiddle/potion) -收集React组件以组成可视化
- [react-d3](https://github.com/esbullington/react-d3) -React的图表[区域，条形图，烛台，线，饼图，散点图]
- [react-d3-components](https://github.com/codesuki/react-d3-components) -D3组件[条形图，堆积图，散点图，线图，面积图，饼图]
- [react-d3-library](https://github.com/react-d3-library/react-d3-library) -在React [区域，条形，线形，饼形，散点图]中使用D3的库
...
- [Vs](https://github.com/GopherJ/Vs) -Vue.js的声明性可视化组件[条，线，面，饼图，甜甜圈，堆叠式，sankey，时间线]
...
- [datamaps](https://github.com/markmarkoh/datamaps) -在一个文件中可自定义的地图可视化
...
- [d3-geo-voronoi](https://github.com/Fil/d3-geo-voronoi) -球的Voronoi图和Delaunay三角剖分
...
- [react-simple-maps](https://github.com/zcreativelabs/react-simple-maps) -基于d3-geo [map，geo]构建的React的SVG映射组件库
...
- [d3-annotation](https://github.com/susielu/d3-annotation) -具有内置注释类型的注释帮助器
...
- [d3-iconarray](https://github.com/tomgp/d3-iconarray) -用于在网格中对齐元素的插件
...
- [d3-loom](https://github.com/nbremer/d3-loom) -插件来创建“织机”可视化
...
- [d3-scale-cluster](https://github.com/schnerd/d3-scale-cluster) -可将数据聚类为离散组的规模
...
- [d3kit](https://github.com/twitter/d3kit) -一套可加快D3相关项目开发的工具
- [iopctrl](https://github.com/metormote/iopctrl) -用于制作简单的用户界面控件的库
...
- [dragit](https://github.com/romsson/dragit) -能够处理数据图形的工具包
...
- [d3-force-reuse](https://github.com/twosixlabs/d3-force-reuse) -通过重用力近似值来更快地实现以力为导向的图形布局
- [d3-resume](https://github.com/glena/d3-resume) -恢复可视化器
- [d3.sketchy](https://github.com/sebastian-meier/d3.sketchy) -创建粗略的背景，形状和线条
- [d3plus-text](https://github.com/d3plus/d3plus-text) -具有换行和自动字体缩放功能的智能SVG文本框
