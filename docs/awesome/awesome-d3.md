...
- [billboard.js](https://github.com/naver/billboard.js) -可重复使用的图表库[条形，折线，面积，甜甜圈，饼图，阶梯，样条线]
...
- [c3](https://github.com/c3js/c3) -可重复使用的图表库[线，样条，步，面积，堆积，条形图，饼图，甜甜圈]
...
- [d3fc](https://github.com/d3fc/d3fc) -交互式图表组件的集合[线条，条形图，堆积图，散点图，烛台图，OHLC]
...
- [plottable](https://github.com/palantir/plottable) -网络上灵活的交互式图表[区域，条形图，直线，饼图，散点图，堆积图]
...
- [taucharts](https://github.com/TargetProcess/tauCharts) -侧重于设计和灵活性的图表[线条，条形图，面积图，堆叠图]
- [techan.js](https://github.com/andredumas/techan.js) -可视化，库存图表和技术分析[烛台，ohlc]
- [uvCharts](https://github.com/imaginea/uvCharts)  -支持许多不同的图表类型[条形图，面积图，饼图，堆积图，线图，极坐标图，甜甜圈图]
...
- [ember-charts](https://github.com/Addepar/ember-charts/) -灰烬的图表[线，条，堆积，饼图，散点图]
...
- [nivo](https://github.com/plouc/nivo) -具有同构功能的React的Dataviz组件[条，线，面积，气泡，和弦，热图]
...
- [react-d3-components](https://github.com/codesuki/react-d3-components) -D3组件[条，堆叠，散布，线，面积，饼图]
- [react-d3-library](https://github.com/react-d3-library/react-d3-library) -在React [区域，条形，线形，饼形，散点图]中使用D3的库
- [react-stockcharts](https://github.com/rrag/react-stockcharts) -高度可定制的库存图表[面积，折线，散点图，气泡，条形图，堆积图，烛台]
...
- [vx](https://github.com/hshoff/vx) -用于React的可视化组件[条，线，散点图，堆积图，区域，图案，热图，饼图，径向图，地图，地理位置]
...
- [d3-composite-projections](https://github.com/rveciana/d3-composite-projections) -一起显示遥远国家的投影
...
- [d3-area-label](https://github.com/curran/d3-area-label) -用于在区域放置标签的库
...
- [d3-xray](https://github.com/vijithassar/d3-xray) -将鼠标悬停在记录数据结果的书签上
...
- [dragit](https://github.com/romsson/dragit) -启用数据图形处理的工具包
