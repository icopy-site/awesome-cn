...
- [cirrusjs](https://github.com/planet-os/cirrusjs) - 多渲染器图表库 [区域、线条、堆叠]
...
- [epoch](https://github.com/epochjs/epoch) - 一个通用的实时可视化库 [区域、条形图、线形图、饼图、散点图]
- [EventDrops](https://github.com/marmelab/EventDrops) - 基于时间/事件系列的交互式可视化
- [Fancycharts.js](https://github.com/ahoiin/Fancycharts.js) - 可视化百分比值的库 [bar, circles, donut]
...
- [peek](https://github.com/mtmacdonald/peek) - 面向对象的图表库[散点图、折线图、面积图、条形图、饼图、圆环图]
...
- [angular-nvd3](https://github.com/krispo/angular-nvd3) - AngularJS 的 NVd3 [线、堆叠、条形图、区域、散点图、项目符号、甜甜圈]
- [d3act](https://github.com/AnSavvides/d3act) - 带 React 的 d3 [条形图、气泡图、饼图]
- [d3-simpleCharts](https://github.com/mrBigJS/d3-simpleCharts) - 一个 d3 wordpress 插件
- [ember-charts](https://github.com/Addepar/ember-charts/) - Ember 图表 [折线图、条形图、堆积图、饼图、散点图]
- [Layer Cake](https://layercake.graphics/) - 一个建立在 Svelte 之上的图形框架.
- [line-chart](https://github.com/n3-charts/line-chart) - AngularJS 的折线图模块 [折线、面积、条形图]
...
- [react-d3](https://github.com/esbullington/react-d3) - React 图表 [区域、条形图、烛台、折线图、饼图、散点图]
...
- [semiotic](https://github.com/emeeks/semiotic) - 结合React &amp; D3的数据可视化框架[散点、线、面积]
...
- [mapsense.js](https://github.com/mapsense/mapsense.js) - 带 D3 的全分辨率矢量图
...
- [d3-starterkit](https://github.com/1wheel/d3-starterkit) - 辅助函数简化了常见和冗长的 d3 模式
...
- [dragit](https://github.com/romsson/dragit) - 支持数据图形操作的工具包
...
- [d3-resume](https://github.com/glena/d3-resume) - 简历可视化
...
- [d3Snippets](https://github.com/Ledragon/d3Snippets) - VS 代码片段
