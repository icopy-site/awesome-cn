...
- [football-cli](https://github.com/ManrajGrover/football-cli) - 获取几乎每场足球比赛/联赛的现场比分、赛程和排名.
...
- [Cataclysm-DDA](https://cataclysmdda.org) - 以后世界末日为背景的回合制生存游戏.
- [pokete](https://github.com/lxgr-linux/pokete) - 像口袋妖怪一样.
...
- [rebound](https://github.com/shobrook/rebound) - 获取编译器错误的堆栈溢出结果.
- [foy](https://github.com/zaaack/foy) - 轻量级通用任务运行器/构建工具.
- [just](https://github.com/casey/just) - 现代的类似 `make` 的命令运行器.
...
- [is-up-cli](https://github.com/sindresorhus/is-up-cli) - 检查域是否启动.
...
- [emacs](https://github.com/emacs-mirror/emacs) - 可扩展、可定制、免费/自由的文本编辑器——以及更多.
...
- [o](https://github.com/xyproto/o) - 免配置的文本编辑器和IDE.
...
- [pgcli](https://github.com/dbcli/pgcli) - 具有自动完成和语法突出显示功能的 Postgres 客户端.
- [sqlline](https://github.com/julianhyde/sqlline) - 用于通过 JDBC 发布 SQL 的 Shell.
...
- [npm-name-cli](https://github.com/sindresorhus/npm-name-cli) - 检查包名称是否在 npm 上可用.
...
- [pkg-dir-cli](https://github.com/sindresorhus/pkg-dir-cli) - 找到 npm 包的根目录.
...
- [scaffold-static](https://github.com/jamesgeorge007/scaffold-static) - 香草 JS 的脚手架实用程序.
...
- [HTTP Prompt](https://github.com/eliangcs/http-prompt) - 具有自动完成和语法突出显示功能的交互式 HTTP 客户端.
...
- [ipt](https://github.com/drselump14/ipt) - 关键追踪器客户端.
...
- [sncli](https://github.com/insanum/sncli) - 简单笔记客户端.
...
- [localtunnel](https://github.com/localtunnel/localtunnel) - 将您的本地主机公开给全世界，以便于测试和共享.
- [mosh](https://mosh.org/) - 允许间歇性连接漫游的远程 SSH 客户端.
- [ngrok](https://ngrok.com/) - 保护到本地主机的可自省隧道.
- [tmate](https://tmate.io/) - 即时终端 (tmux) 共享.
- [warp](https://github.com/spolu/warp) - 安全和简单的终端共享.
...
- [task-spooler](https://tracker.debian.org/pkg/task-spooler) - 线性执行队列作业.
- [undollar](https://github.com/ImFeelingDucky/undollar) - 删除复制粘贴终端命令之前的“$”.
- [pipe_exec](https://github.com/koraa/pipe_exec) - 从标准输入、管道和 ttys 运行可执行文件而不创建临时文件.
...
- [hasha-cli](https://github.com/sindresorhus/hasha-cli) - 获取文本或标准输入的散列.
...
- [nasa-cli](https://github.com/xxczaki/nasa-cli) - 下载 NASA 今日图片.
...
- [The Fuck](https://github.com/nvbn/thefuck) - 纠正您之前的控制台命令的宏伟应用程序.
- [tldr](https://github.com/tldr-pages/tldr) - 简化和社区驱动的手册页.
- [Wat](https://github.com/dthree/wat) - 即时、中央、社区构建的文档.
...
- [GROQ](https://github.com/sanity-io/groq-cli) – 具有查询和预测功能的 JSON 处理器.
- [gron](https://github.com/tomnomnom/gron) - 使 JSON 变得可读.
...
- [renameutils](https://www.nongnu.org/renameutils/) - 在你的编辑器中批量重命名.
- [diskonaut](https://github.com/imsnif/diskonaut) - 磁盘空间导航器.

### Files

- [chokidar-cli](https://github.com/open-cli-tools/chokidar-cli) - 用于监视文件系统更改的 CLI.
- [file-type-cli](https://github.com/sindresorhus/file-type-cli) - 检测文件或标准输入的文件类型.
- [bat](https://github.com/sharkdp/bat) - 带有语法高亮显示的克隆猫.
...
- [gdrive-downloader](https://github.com/Akianonymus/gdrive-downloader) - 从谷歌驱动器下载文件/文件夹.
...
- [tre](https://github.com/dduan/tre) - 具有 git 意识、编辑器别名等功能的 `tree`.
- [ll](https://github.com/antonmedv/ll) - 带有 git 状态的 `ls`.
- [lsd](https://github.com/Peltoche/lsd) - `ls` 具有许多额外的功能.
...
- [PathPicker](https://github.com/facebook/pathpicker/) - 解析命令的输出后，PathPicker 会为您提供一个漂亮的 UI 来选择您感兴趣的文件.
...
- [zoxide](https://github.com/ajeetdsouza/zoxide) - Rust 中的快速目录跳转器.

### Search

- [happyfinder](https://github.com/hugows/hf) -（另一个）命令行的模糊文件查找器.
- [find-up-cli](https://github.com/sindresorhus/find-up-cli) - 通过向上父目录查找文件.
- [ripgrep](https://github.com/BurntSushi/ripgrep) - 一种面向行的搜索工具，可递归搜索当前目录以查找正则表达式模式.
...
- [SnowFS](https://github.com/snowtrack/snowfs) - 一个快速、可扩展的二进制文件版本控制系统.
...
- [git-standup](https://github.com/kamranahmedse/git-standup) - 回忆一下你在最后一个工作日做了什么.
...
- [gita](https://github.com/nosarthur/gita) - 并排管理多个 git repos.
...
- [czg](https://github.com/Zhengqbbb/cz-git/tree/main/packages/cli) - 交互式生成标准化的提交消息.
...
- [carbon-now-cli](https://github.com/mixn/carbon-now-cli) - 为您的代码生成漂亮的图像.
...
- [pipes.sh](https://github.com/pipeseroni/pipes.sh) - 横跨屏幕的随机管道.
- [YuleLog](https://github.com/Duroktar/YuleLog) - 圣诞节 Yule 木壁炉.
...
- [dankcli](https://github.com/sggts04/dankcli) - 将文本添加到 meme 图像模板.
- [ricksay](https://github.com/roma-guru/ricksay) - 瑞克和莫蒂的名言.
- [pokeget](https://github.com/talwat/pokeget) - 显示口袋妖怪精灵.
