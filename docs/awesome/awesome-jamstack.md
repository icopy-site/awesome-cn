...
- [DatoCMS](https://datocms.com) -您的编辑会喜欢的基于API的CMS.
...
- [Flotiq](https://flotiq.com) -轻松的无头CMS.
## API
...
### Forms
- [Getform](https://getform.io)  -面向设计人员和开发人员的表单后端平台.  在几分钟之内为您的静态站点设置表单终结点，并通过Zapier集成和Webhooks支持扩展数据.
