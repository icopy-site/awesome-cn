...
- [BMW Linker](https://github.com/opp100/bmw-scriptable-widgets) - 关于您的 BMW 的信息，例如位置或里程.
...
- [ZOE-Widget.js](https://gist.github.com/mountbatt/772e4512089802a2aa2622058dd1ded7) - 有关您的 Renault Zoe 的信息，例如充电或位置.
...
- [HomeDateGreeting.js](https://gist.github.com/cassianomon/efffbe09d20013986cd4ffc0f362a3e2) - 来自 Unsplash 的日期和时间问候语背景. 
...
- [CryptoDepotWidget](https://github.com/Martlgap/CryptoDepotWidget) - 显示您的加密货币余额的小部件.
...
- [Tradegate Stock Widget](https://github.com/Chrischi-/tradegate-stock-widget-for-scriptable) - 股票小部件显示来自 Tradegate Exchange 的股票价格.

  <img src="https://user-images.githubusercontent.com/6323217/147655180-c4d3041c-58c1-4108-b001-29e01767025d.png" height="200"/>

## Food

- [scriptable-recipe](https://github.com/shfrmn/scriptable-recipe) - 打开 YouTube 上的烹饪视频的随机食物食谱小部件.
...
- [Covid iOS Widget](https://github.com/Hider-alt/covid-widget) - 选定国家/地区的 Covid-19 病例图.

  <img src="https://raw.githubusercontent.com/Hider-alt/covid-widget/main/img/Mockup.png" width="800">

- [Coronavirus.js](https://gist.github.com/planecore/e7b4c1e5db2dd28b1a023860e831355e) - 选定国家/地区的 Covid-19 病例.
...
- [telekom.js](https://gist.github.com/Sillium/f904fb89444bc8dde12cfc07b8fa8728) - 基于 Telekom.de 关税的数据消耗.
...
- [scriptable-pocket-widget](https://github.com/brianseidman/scriptable-pocket-widget) - 显示未读或收藏的 Pocket 文章.
...
- [conversable-for-scriptable](https://github.com/andyngo/conversable-for-scriptable) - 联系图标开始对话.
...
- [termiWidget.js](https://gist.github.com/spencerwooo/7955aefc4ffa5bc8ae7c83d85d05e7a4) - 用户数量的类似终端的输出.
...
- [CFBWidget](https://github.com/jaydainn/CFBWidget) - NCAA 大学橄榄球队的最新比分. 

- [fitx-widget.js](https://gist.github.com/DanielStefanK/487175b6f65ede401e37ee4848970176) - FitX 健身房的工作量.

- [nfl-team-schedule-widget](https://github.com/brianwalborn/nfl-team-schedule-widget) - NFL 球队的当前赛季时间表.
...
- [Upcoming Matches](https://gist.github.com/ilyichvismara/7895bb479e14a999f3cfd2c391f10597) - 即将到来的足球队比赛.

## Tools

- [gitlab-stats-for-scribtable](https://github.com/p0fi/gitlab-stats-for-scribtable) - 来自 GitLab 的统计数据，例如已分配合并请求的数量.
...
- [scriptable-testflight-watcher](https://github.com/FifiTheBulldog/scriptable-testflight-watcher) - 获取有关 TestFlight 测试版新地点的通知.
...
- [woocommerce-sales](https://gist.github.com/olikdesign/4c9c5549686c81e728b065286eb0e750) - 来自 WooCommerce 商店的销售统计数据.
...
- [location-location-location](https://github.com/doersino/scriptable-widgets/tree/main/location-location-location) - 显示当前位置的谷歌地图图像.

## Related

### Download helper

- [Import-Script.js](https://github.com/supermamon/scriptable-scripts/blob/master/Import-Script.js) - 将代码（即从 Pastebin、GitHub）下载到 Scriptable 中的脚本.
