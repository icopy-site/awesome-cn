...
- [EOSIO/universal-authenticator-library](https://github.com/EOSIO/universal-authenticator-library) -用于允许应用轻松使用不同身份验证提供程序的库.
...
- [eosfilestore](https://github.com/grigio/eosfilestore) -在EOSIO区块链上的不变性，抗审查性，廉价的文件存储
...
- [pEOS](https://peos.one/) -pEOS支持在EOS上进行私人的，不可追踪的交易.
