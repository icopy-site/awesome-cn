...
* [chartist-js](https://github.com/gionkunz/chartist-js) -简单的响应图.
...
* [selecting](https://github.com/EvandroLG/selecting) -一个库，可让您访问用户选择的文本.
...
* [q](https://github.com/kriskowal/q) -用于在JavaScript中进行和编写异步承诺的工具.
...
* [voix.js](https://github.com/pazguille/voix) -一个JavaScript库，用于向您的网站，应用或游戏添加语音命令.
...
* [vegas](https://github.com/jaysalvat/vegas)  -一个jQuery插件，可为您的网页添加漂亮的全屏背景.  它甚至允许幻灯片放映.
...
* [PhotoSwipe](https://github.com/dimsemenov/PhotoSwipe) -适用于移动和台式机的JavaScript图片库，模块化，独立于框架.
...
* [baguetteBox.js](https://github.com/feimosi/baguetteBox.js) -使用纯JavaScript编写的简单易用的灯箱脚本.
...
* [floatThead](https://github.com/mkoryak/floatThead)  -（jQuery插件）在主体内滚动时锁定任何表的标题.  适用于任何表，不需要自定义html或css.
...
* [Dragula](https://github.com/bevacqua/dragula/) -拖放是如此简单，很疼.
 ...
 * [FitVids.js](https://github.com/davatron5000/FitVids.js) -轻巧，易于使用的jQuery插件，用于视频宽度视频嵌入.
...
* [Effeckt.css](https://github.com/h5bp/Effeckt.css) -表演过渡和动画库
