...
该存储库的目的是创建与Python相关的，用于音频/音乐应用科学研究的Python软件/工具的全面，精选列表.
...
* [mingus](https://github.com/bspaans/python-mingus) [:octocat:](https://github.com/bspaans/python-mingus) [:package:](https://pypi.org/project/mingus) -带有MIDI文件和播放支持的高级音乐理论和注释包.
...
* [python-sounddevice](https://github.com/spatialaudio/python-sounddevice) [:octocat:](http://python-sounddevice.readthedocs.io) [:package:](https://pypi.python.org/pypi/sounddevice) -PortAudio包装器可通过NumPy提供实时音频I / O.
