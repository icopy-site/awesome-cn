...
| [Dries's dotfiles](https://github.com/driesvints/dotfiles)     |  macOS的dotfiles的简化方法  Zsh，我的Zsh，macOS，Homebrew，Mackup |
...
| [Paul's dotfiles](https://github.com/paulirish/dotfiles)  |  丰富的dotfiles，具有大量酷炫的自定义功能|  Fish，macOS，Homebrew，Custom Shell函数|
...
- [bashdot](https://github.com/bashdot/bashdot) - 完全用bash编写的极简主义dotfile管理框架.
...
- [Fisher](https://github.com/jorgebucaran/fisher) -  Fish的包管理器
...
- [A lesson in shortcuts](https://www.reddit.com/r/linux/comments/at05xh/why_do_hidden_files_in_unix_begin_with_a_dot/egyj6lr/) -  Rob Pike（最初在Google+上发布）如何产生“隐藏”或“点”文件的想法
...
- [Awesome Fish](https://github.com/jorgebucaran/awesome-fish) - 鱼壳的包装，提示和资源的精选列表.
