...
受启发 [awesome](https://github.com/sindresorhus/awesome) 列表. 随时通过以下方式改进此列表 [contributing](https://github.com/webpack-contrib/awesome-webpack/blob/master/contributing.md)!
...
- [Sean T. Larkin - @TheLarkInn](https://twitter.com/TheLarkInn) TPM在 [Microsoft](https://twitter.com/MSEdgeDev) . 开发者倡导者和webpack核心团队成员.
...
- [Responsive Loader](https://github.com/herrstucki/responsive-loader) ：用于加载响应图像的加载器.  -* Maintainer *：`Jeremy Stucki` [！[Github] [githubicon]]（https://github.com/herrstucki）
...
- [mermaid Loader](https://github.com/popul/mermaid-loader): [mermaid](https://github.com/mermaid-js/mermaid)  Webpack的加载程序模块（图）.  -* Maintainer *：`Paul Musso` [！[Github] [githubicon]]（https://github.com/popul）
...
- [C/C++ Loader](https://github.com/ClickSimply/cpp-wasm-loader) ：以最小的捆绑包加载本机C / C ++文件.  -* Maintainer *：`Scott Lott` [！[Github] [githubicon]]（https://github.com/ClickSimply）
...
- [Simple Nunjucks Loader](https://github.com/ogonkov/nunjucks-loader)  -Nunjucks模板加载器.  -* Maintainer *：`ogonkov` [！[Github] [githubicon]]（https://github.com/ogonkov）
...
- [Less Loader](https://github.com/webpack/less-loader) ：减少了Webpack的加载程序模块.  -* Maintainer *：`Webpack Team` [！[Github] [githubicon]]（https://github.com/webpack）
...
- [Minify CSS-in-JS Loader](https://github.com/zaaack/minify-cssinjs-loader) ：基于RegExp的Webpack最小化CSS-in-JS加载程序，不需要babel.  -*维护者*：`Zack Young` [！[Github] [githubicon]]（https://github.com/zaaack）[！[Twitter] [twittericon]]（https://twitter.com/ZaaackYoung）
...
- [Fengari Loader](https://github.com/fengari-lua/fengari-loader/)：使用以下命令运行Lua代码 [Fengari](https://fengari.io) .  -* Maintainer *：`Daurnimator` [！[Github] [githubicon]]（https://github.com/daurnimator）[！[Twitter] [twittericon]]（https://twitter.com/daurnimator）
...
- [esbuild Loader](https://github.com/privatenumber/esbuild-loader) -由Babel装载机，ts装载机和Terser提供动力的快速替代品 [esbuild](https://github.com/evanw/esbuild) .  -* Maintainer *：`Hiroki Osame` [！[Github] [githubicon]]（https://github.com/privatenumber/esbuild-loader）[！[Twitter] [twittericon]]（https：// twitter. com / privatenumbr）
...
- [Compression Plugin](https://github.com/webpack/compression-webpack-plugin) ：准备资产以与Content-Encoding一起使用.  -* Maintainer *：`Webpack Team` [！[Github] [githubicon]]（https://github.com/webpack）
...
- [Bundle Analyzer](https://github.com/th0r/webpack-bundle-analyzer)  -将捆绑包表示为交互式树形图的实用程序.  -* Maintainer *：`Yuriy Grunin` [！[Github] [githubicon]]（https://github.com/th0r）
...
- [FileManager Webpack Plugin](https://github.com/gregnb/filemanager-webpack-plugin) -在构建Webpack之前和之后复制，移动，删除文件和目录-* Maintainer *：`Gregory Nowakowski` [！[Github] [githubicon]]（https://github.com/gregnb）
- [Fork TS Checker Webpack Plugin](https://github.com/TypeStrong/fork-ts-checker-webpack-plugin)  -在单独的进程上运行打字稿类型检查器的Webpack插件.  -* Maintainer *：`TypeStrong Team` [！[Github] [githubicon]]（https://github.com/TypeStrong） 
- [Duplicate Package Checker Webpack Plugin](https://github.com/darrenscerri/duplicate-package-checker-webpack-plugin) -当捆绑包中存在同一软件包的多个版本时，会警告您-* Maintainer *：`Darren Scerri` [！[Github] [githubicon]]（https://github.com/darrenscerri）
...
- [webpack-inject-plugin](https://github.com/adierkens/webpack-inject-plugin)  -一个webpack插件，用于将代码动态地注入到包中.  -* Maintainer *：`Adam Dierkens` [！[Github] [githubicon]]（https://github.com/adierkens）
...
- [Htmls Webpack Plugin](https://github.com/zaaack/htmls-webpack-plugin) ：用于webpack的简单快速的多HTML生成插件.  -*维护者*：`Zack Young` [！[Github] [githubicon]]（https://github.com/zaaack）[！[Twitter] [twittericon]]（https://twitter.com/ZaaackYoung）
- [Mini css extract plugin](https://github.com/webpack-contrib/mini-css-extract-plugin):
轻量级CSS提取插件-* Maintainer *：`Webpack Contrib` [！[Github] [githubicon]]（https://github.com/webpack-contrib）
- [build-hash-webpack-plugin](https://github.com/Cosium/build-hash-webpack-plugin) 对于每个构建，Webpack都会生成一个内存中的哈希，从而可以知道两个构建输出是否相同. 该插件将描述的构建哈希写入一个单独的json文件中.  -* Maintainer *：`RédaHousni Alaoui` [！[Github] [githubicon]]（https://github.com/reda-alaoui）[！[Twitter] [twittericon]]（https://twitter.com / alaouirda）
...
- [Dynamic Vendor Webpack Plugin](https://github.com/bios21/dynamic-vendor-webpack-plugin)  -为您提供了一种通过动态变量和特定代码拆分导入供应商的方法.  -* Maintainer *`Lilian Saget-Lethias` [！[Github] [githubicon]]（https://github.com/bios21）[！[Twitter] [twittericon]]（https://twitter.com/lsagetlethias ）
...
- [Stylelint Webpack Plugin](https://github.com/webpack-contrib/stylelint-webpack-plugin) ：Webpack的Stylelint插件.  -* Maintainer *：`Ricardo Gobbo de Souza` [！[Github] [githubicon]]（https://github.com/ricardogobbosouza）
...
- [Exclude Assets Webpack Plugin](https://github.com/klaytonfaria/webpack-exclude-assets-plugin) ：一个基于路径RegExp模式从webpack输出中排除资产的插件.  -* Maintainer *：`Klayton Faria` [！[Github] [githubicon]]（https://github.com/klaytonfaria）
- [Webpack Shell Plugin Next](https://github.com/s00d/webpack-shell-plugin-next) ：插件允许您在构建Webpack之前或之后运行任何Shell命令.  -* Maintainer *：`Kuzmin Pavel` [！[Github] [githubicon]]（https://github.com/s00d）
...
- [Bytenode Plugin](https://github.com/herberttn/bytenode-webpack-plugin) ：使用bytenode将JavaScript编译为字节码.  -* Maintainer *：`Herbert Treis Neto` [！[Github] [githubicon]]（https://github.com/herberttn）


### Webpack Tools

- [Webpack Dev Middleware](https://github.com/webpack/webpack-dev-middleware) ：中间件，其中包含实时捆绑包.  -* Maintainer *：`Webpack Team` [！[Github] [githubicon]]（https://github.com/webpack）
...
- [Webpack Config Utils](https://github.com/kentcdodds/webpack-config-utils)  -实用使您的webpack配置更易于阅读.  -* Maintainer *：`Ken​​t C. Dodds` [！[Github] [githubicon]]（https://github.com/kentcdodds）[！[Twitter] [twittericon]]（https://twitter.com/ kentcdodds）
- [Angular2 Webpack Toolkit](https://github.com/AngularClass/webpack-toolkit) -Angular 2的Webpack工具和帮助程序.-* Maintainer *：`AngularClass` [！[Github] [githubicon]]（https://github.com/AngularClass）[！[Twitter] [twittericon]]（https： //twitter.com/AngularClass）
...
- [Speed Measure Plugin](https://github.com/stephencookdev/speed-measure-webpack-plugin)  -测量您的webpack插件和加载器的速度.  -* Maintainer *：`Stephen Cook` [！[Github] [githubicon]]（https://github.com/stephencookdev）
- [packtracker.io](https://packtracker.io/?utm_source=github&utm_medium=awesome-webpack&utm_campaign=social) -对每次提交进行Webpack捆绑分析，向每个请求请求报告Webpack统计信息.
...
- [Webpack Dev Server Firewall](https://github.com/funbox/webpack-dev-server-firewall) ：防止未知IP访问dev服务器.  -* Maintainer *：`Igor Adamenko` [！[Github] [githubicon]]（https://github.com/igoradamenko）[！[Twitter] [twittericon]]（https://twitter.com/igoradamenko）
...
### Articles
 ...
 -安德鲁·韦尔奇（Andrew Welch）|  18年10月23日- [An Annotated webpack 4 Config for Frontend Web Development](https://nystudio107.com/blog/an-annotated-webpack-4-config-for-frontend-web-development)
 -加博尔·索斯（GáborSoós）  2017年4月24日- [How to do proper tree-shaking in Webpack 2](https://blog.craftlab.hu/how-to-do-proper-tree-shaking-in-webpack-2-e27852af8b21)
 ...
 -肖恩·拉金（Sean T. Larkin）|  2016年7月21日- [Learn and Debug webpack with Chrome Dev Tools!.](https://medium.com/webpack/webpack-bits-learn-and-debug-webpack-with-chrome-dev-tools-da1c5b19554#.gpoentuxe)
 ...
 -安德鲁·雷|  2016年4月9日- [Webpack: When To Use and Why.](http://blog.andrewray.me/webpack-when-to-use-and-why/)
 ...
 -Grgur Grisogono |  2016年2月15日- [Webpack 2 Tree Shaking Configuration.](https://medium.com/modus-create-front-end-development/webpack-2-tree-shaking-configuration-9f1de90f3233#.5pddvz5lz)
 -伊利亚·扎亚兹（Ilya Zayats）|  2016年2月7日- [How to split your apps by routes with Webpack.](https://medium.com/@somebody32/how-to-split-your-apps-by-routes-with-webpack-36b7a8a6231#.iy99i4f7r)
 ...
 -Andy Ccs |  2016年1月2日- [Webpack and Docker for Development and Deployment.](https://medium.com/@andyccs/webpack-and-docker-for-development-and-deployment-ae0e73243db4#.2yutcm8s4)
 ...
 -Nader将|  2015年1月7日- [Beginner’s guide to Webpack.](https://medium.com/@dabit3/beginner-s-guide-to-webpack-b1f1a3638460#.xb01fcsoq)
 ...
 -Hridayesh Sharma |  20年8月18日- [Webpack Setup for a JavaScript Library](https://www.loginradius.com/engineering/blog/write-a-javascript-library-using-webpack-and-babel/)

### Videos

 -肖恩·拉金（Sean Larkin）JS大会|  2019年4月2日- [Everything’s a plugin: Understanding webpack from the inside out](https://youtu.be/H3g0BdyVVxA)
 ...
 -HalfStack2016上的杰克·富兰克林|  2016年11月18日| [Seamless client side JavaScript w/ Webpack](https://opbeat.com/community/posts/seamless-client-side-javascript-with-webpack-by-jack-franklin)
 ...
 -First Principles提供的前端中心Webpack |英特尔®开发人员专区 2016年8月22日- [Intro to Webpack](https://www.youtube.com/watch?v=WQue1AN93YU)
 ...
 -JS西部山区的杰里米·隆德（Jeremy Lund）|  2015年3月28日- [Gift Wrap Your Code with Webpack.](https://www.youtube.com/watch?v=ANMN9M9LhNQ)
...
- [Webpack 4 Fundamentals](https://frontendmasters.com/courses/webpack-fundamentals/) -关于Webpack基础的简要介绍 [Sean Larkin](https://twitter.com/thelarkinn)
- [Web Performance with Webpack](https://frontendmasters.com/courses/performance-webpack/) -通过使用Webpack解决常见的Web性能问题 [Sean Larkin](https://twitter.com/thelarkinn)
...
- [Angular and Webpack for modular applications](https://egghead.io/courses/angular-and-webpack-for-modular-applications) -Egghead.io课程由 [Kent C. Dodds](https://twitter.com/kentcdodds)
- [Using Webpack for Production JavaScript Applications](https://egghead.io/courses/using-webpack-for-production-javascript-applications) -Egghead.io课程由 [Kent C. Dodds](https://twitter.com/kentcdodds) （先进的）
...
- [Angular2 Seed](https://github.com/angular/angular2-seed/) -一个简单的入门文章，从中演示了Angular2的基本概念 [Pawel Kozlowski](https://github.com/pkozlowski-opensource).
...
- [React Cordova Boilerplate](https://github.com/unimonkiez/react-cordova-boilerplate) -TodoMVC示例，用于来自的React with Cordova [Yuval Saraf](https://github.com/unimonkiez).
