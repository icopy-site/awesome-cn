...
- [Programming a Quantum Computer with Qiskit](https://www.coursera.org/projects/programming-quantum-computer-qiskit) -2小时的指导课程，重点是学习如何利用Qiskit为Quantum Computer进行编码.
...
- [The Introduction To Quantum Computing](https://www.coursera.org/learn/quantum-computing-algorithms) -对计算的微妙介绍，其背后的数学及其量子对应物，然后深入讨论了一些量子算法.
    - [Quantum Computing. Less Formulas - More Understanding](https://www.coursera.org/learn/quantum-computing-lfmu) -与上一门课程的教授相同，这次更多地关注量子概念，而不是数学.
...
- [Amazon Braket](https://aws.amazon.com/braket/) -全面托管的服务，提供了在量子模拟器和计算机上运行量子电路的开发环境.
...
- [IBM Quantum Experience](https://quantum-computing.ibm.com) -在线量子作曲家，可以在真实的量子计算硬件上进行实验.
...
- [Strangeworks Platform](https://quantumcomputing.com/) -不可知论的硬件平台和接口，可专注于开发而不是特定的硬件解决方案构建.
- [TensorFlow Quantum](https://www.tensorflow.org/quantum) -量子机器学习库，该库将Cirq与TensorFlow集成在一起，用于对经典或量子数据的混合量子经典模型进行原型设计.
- [Tequila](https://github.com/aspuru-guzik-group/tequila) -由Alan Aspuru-Guzik小组（多伦多大学）开发的可扩展量子信息和学习体系结构.
...
- [Microsoft Quantum blog](https://cloudblogs.microsoft.com/quantum/) -Microsoft Quantum程序范围内的更新.
- [Musty Thoughts](http://mustythoughts.com) -MichałStęchły的个人博客，其中包含许多文章，供人们开始学习量子计算.
- [Qiskit blog](https://medium.com/qiskit) -有关Qiskit社区团队的量子计算的一切.
- [Quantumfy](https://quantumnews.io/) -有关最新量子计算新闻的摘录.
- [Quantum Frontiers](https://quantumfrontiers.com/) -由量子信息与物质研究所（Quantum Institute for Quantum Information and Matter）进行幕后分享研究见解.
...
## Books
- [An Introduction to Quantum Computing](https://www.amazon.com/Introduction-Quantum-Computing-Phillip-Kaye/dp/019857049X/)  -在易用性和数学严谨性之间取得良好的平衡. 适合本科生.
...
- [Learn Quantum Computation using Qiskit](http://community.qiskit.org/textbook)  -涵盖量子算法并展示如何使用Qiskit在真实硬件上运行它们的开放源代码教科书. 还介绍了先决条件.
...
- [Quantum Computing: A Gentle Introduction](http://mmrc.amss.cas.cn/tlb/201702/W020170224608150244118.pdf) -仅需具备基本的大学数学知识即可说明量子计算.
...
- [Seth Lloyd. Programming the Universe_ A Quantum Computer Scientist Takes on the Cosmos](https://www.amazon.com/Programming-Universe-Quantum-Computer-Scientist-ebook/dp/B000GCFBP6)  -如果宇宙是一台巨大的量子计算机怎么办？ 它带给读者遍历宇宙计算模型的历程及其对物理学的启示.
...
- [Circuit Sessions](https://www.youtube.com/watch?v=Omv-bPvQ3E8&list=PLOFEBzvs-VvrRlVz7wqaqmaMZj_ZK2Afe) -Qiskit系列通过学者和行业研究人员的讲座系列探讨了量子电路的价值和用途.
...
- [Quantum Computing for Computer Scientists](https://www.youtube.com/watch?v=F_Riqjdh2oM)  -面向计算机科学家的有关量子计算入门的Microsoft Research Talk. 时长：1小时28分钟.
...
- [Quantum Computing Seminar Series](https://www.youtube.com/watch?v=iKgysY097Ok&list=PLOFEBzvs-Vvr0uEoGFo08n4-WrM_8fft2) -Qiskit系列讨论最新研究.
- [Quantum Mechanics by PBS Space Time](https://www.youtube.com/playlist?list=PLsPUh22kYmNCGaVGuGfKfJl-6RdHiCjo1) -YouTube播放列表，面向广大受众，提供有关量子力学和计算的通用概念. 
...
- [Meet the meQuanics](https://soundcloud.com/mequanics) -针对非专业人士的量子计算关键人物访谈.
- [Quantum Computing Now](https://anchor.fm/quantumcomputingnow) -Ethan Hansen的播客，涵盖三个主要主题：量子计算的基础知识，访谈和最新新闻.
