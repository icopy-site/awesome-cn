...
- [slack-integrations](https://github.com/rikbosch/slack-integrations) -  Custom Slack集成脚本
...
- [markov-chainz](https://github.com/sorenmacbeth/markov-chainz) - 用Clojure编写的马尔可夫链机器人
...
- [camayak-to-slack](https://github.com/tcu360/camayak-to-slack) -  Node.js应用程序，允许Slack作为Camayak发布目的地
...
- [imma-let-you-finish](https://github.com/sparragus/imma-let-you-finish) - 随机出现在您的对话中的机器人，可以告诉每个拥有最佳评论的人
...
- [slack-assembla-plugin](https://github.com/Ramzi-Alqrainy/slack-assembla-plugin) - 观看关于Assembla的消息的Slack频道并采取相应行动
...
- [slack-clicky](https://github.com/joshfarrant/slack-clicky) -  Chrome扩展程序，只需单击即可与Slack共享链接
...
- [tourdefrance-slack-bot](https://github.com/j0k3r/tourdefrance-slack-bot) - 在2014年环法自行车赛期间的每个阶段通知Slack频道/小组
...
- [ellie-slack](https://github.com/christinac/ellie-slack) - 伊丽莎作为Slackbot的年轻，时髦，精神上友好的继任者
...
- [slackbridge](https://github.com/ossobv/slackbridge) - 公司之间的Bridge Slack渠道
...
- [slack-ruby-client](https://github.com/dblock/slack-ruby-client) -  Slack Web和RealTime Messaging API的Ruby客户端
