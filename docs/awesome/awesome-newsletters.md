...
- [Tiny React](https://tinyreact.email) .  收件箱中本周排名前3的React文章.
...
- [Unreadit/Design](https://unread.it/n/design/) .  设计灵感和伟大的设计相关内容源自最好的subreddits.
...
- [Discover dev](https://www.discoverdev.io) .  每周摘自网络上最好的工程博客. [Archive](https://www.discoverdev.io/archive).
...
- [npm Weekly](https://www.npmjs.com/npm-weekly) .  我们正在研究，思考和讨论NPM
...
- [Ruby Articles](https://thoughtbot.com/blog/tags/ruby) .  Ruby帖子 [Thoughtbot](https://thoughtbot.com)
...
- [Lua Digest](https://luadigest.immortalin.com) .  Lua编程语言的常规通讯.
...
- [The Wild Week in AI](https://www.getrevue.co/profile/wildml) .  每周AI和深度学习时事通讯. [Archive](https://www.getrevue.co/profile/wildml#archive).
...
- [The ML Engineer Newsletter](https://ethical.institute/mle.html) .  接收由机器学习专业人员策划的开源框架，教程和文章的更新.  获得有关机器学习可解释性，再现性，模型评估，特征分析等方面的最佳实践，工具和技术的见解.
...
- [Build Blockchain](https://www.buildblockchain.tech/newsletter) .  区块链技术没有公牛 - 每周一次的区块链现实剂量，对技术的偏重.
...
- [Capital minded](https://capitalminded.com) .  关于导航指数基金年龄，了解经济和黑客资本主义的每周情报简报.
- [AngelList Weekly](https://angel.co/newsletters) .  最好的创业世界，每周策划.
- [Startup Curated](https://startup.curated.co) .  创业社区的新闻通讯，其中包含创始人的最佳内容. [Archive](https://startup.curated.co/issues).
...
- [Dev Updates](https://mailchi.mp/f59beeac6b9b/devupdates) .  每周一期的时事通讯，重点介绍最新的移动，网络，人工智能，用户体验/用户体验，工作/购物者以及与开发人员和行业相关的任何内容.
