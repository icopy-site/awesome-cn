...
- [Web Development Reading List](https://wdrl.info) .  本通讯分享了Web开发中的最新文章.
...
- [The Smashing Email Newsletter](https://www.smashingmagazine.com/the-smashing-newsletter/) .  每月两次向电子通讯发送电子邮件，为设计人员和开发人员提供有用的提示，技巧和资源.
...
- [JSter](http://jster.net/blog) .  每两周一次没有任何精简的指向邮箱的JavaScript链接列表. [Subscribe](https://us7.list-manage.com/subscribe?u=ed40c0084a0c5ba31b3365d65&id=ec6f32bf5e).
...
- [React Native Newsletter](http://reactnative.cc/) .  免费提供React Native新闻，文章，问题和请求请求，库和应用程序的摘要.
- [Fullstack React](http://newsletter.fullstackreact.com/) .  关于React生态系统的新闻通讯，重点是有用的库，教程和代码. [Archive](http://newsletter.fullstackreact.com/issues).
...
- [Best in Visual Storytelling](https://us16.list-manage.com/subscribe?u=5c12dabe1e59a9fbde1174b8c&id=e27a48af53) .  过去一周的最佳数据新闻领域星期一综述.  付费版本还包括数据可视化职位发布.

### CSS

- [CSS Weekly](https://css-weekly.com/) .  每周由Zoran Jambor策划的CSS文章，教程，实验和工具的电子邮件摘要.
...
- [Web Design Weekly](https://web-design-weekly.com/) .  一周之内，只有最棒的新闻链接和最佳新闻纯正链接在互联网上.
...
- [Unreadit/Design](https://unread.it/n/design/) .  设计灵感和与最佳设计相关的丰富内容都来自最佳子目录.
...
- [Swift Weekly Brief](https://swiftweekly.github.io) .  社区推动的关于Swift.org的每周新闻.  由Jesse Squires策划，并在每个星期四免费发布.
...
- [Volt Framework](http://voltframework.com/) .  Volt是一个令人震惊的构建富数据Web应用程序的框架.
...
- [Elm Weekly](http://www.elmweekly.nl/) .  您可以在收件箱中找到Elm编程语言的美好世界.
...
- [NixOS Weekly](https://weekly.nixos.org) .  的最新消息 [NixOS](https://nixos.org)
...
- [Vim Weekly](http://www.vimweekly.com/) .  每周一，我们都会发送5条提示，这些信息可以帮助您提高vim的生产力，您可以将其视为每天的提示！
...
- [Weekly MySQL News](http://mysqlnewsletter.com/) .  非官方的每周新闻摘要MySQL的所有方面.
...
- [DevOps newsletter](https://blog.serverdensity.com/devops-newsletter/) .  将本周最好的DevOps链接发送到您的收件箱
  每个星期天以DevOps新闻的形式发布.
- [Sysadmin Casts](https://sysadmincasts.com/get-notified) .  Sysadmin Casts-一口大小的sysadmin屏幕录像（每周发布）.
- [Server Admin for Programmers](https://serversforhackers.com/) .  教您开发和生产所需的服务器技术.  消除了服务器配置的麻烦.
- [Cron.Weekly](https://www.cronweekly.com) .  每周的新闻快讯，每个星期天都会分发给您，其中包含针对Linux系统管理员的新闻和工具. [Archige](https://www.cronweekly.com/archives/).
...
- [StatusCode Weekly](https://weekly.statuscode.com/) .  每周通讯，内容涉及网络操作，基础架构，性能和工具，从浏览器到摘要.
...
- [Build Blockchain](https://www.buildblockchain.tech/newsletter) .  无需牛市的区块链技术-每周的区块链现状，对技术的偏向很大.
...
- [KickStarter](https://www.kickstarter.com/newsletters) .  我们喜欢的项目，由KickStarter存档
...
- [Handwritten newsletter](http://www.thnkclrly.com/newsletter/) .  《清晰思考》时事通讯几乎没有反射练习，对您的日常生活有帮助.  它是由爱和钦佩而创造的. [Archive](http://www.thnkclrly.com/category/thinking-clearly/).
...
- [Morning Hacked](https://morninghacked.com/) .  每个工作日的早晨（东部时间）在您收件箱中的网络安全新闻.
...
- [Changelog Nightly](https://changelog.com/nightly) .  每天晚上10点（美国东部时间），一封电子邮件，在GitHub上发布了最热门的新存储库.
