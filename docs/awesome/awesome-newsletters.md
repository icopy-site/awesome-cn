...
- [Insnippets](https://insnippets.com) . 带有TL; DR的每日新闻通讯，有关Web开发，Devops和分布式系统等有趣主题的信息.
...
- [Design Faves](https://www.designfaves.com/) . 每日帖子和独家文章结合了品牌，艺术和图形设计界的最佳现代表达和创新.
- [Hack Design](https://hackdesign.org) . 针对做奇事的人的易于理解的设计课程.
...
- [iOS Dev Weekly](https://iosdevweekly.com/) . 最好的iOS开发链接每周. [Archive](https://iosdevweekly.com/issues).
...
- [This Week in Rust](https://this-week-in-rust.org) . 随时了解Rust社区中的事件，学习资源和最新动态. [Archive](https://this-week-in-rust.org/blog/archives/index.html).
...
- [Kotlin Weekly](http://www.kotlinweekly.net/) . 面向Kotlin开发人员的每周新闻，其中包含来自Kotlin环境的文章，库，视频和播客.
...
- [Vim Weekly](http://www.vimweekly.com/) . 每个星期一，我们发送5条提示，可以帮助提高您的vim生产力，您可以将它视为每天的提示！
...
- [Redis Watch](https://redislabs.com/resources/redis-watch-archive/) . 关于Redis一切的定期新闻通讯.
...
- [Build Blockchain](https://www.buildblockchain.tech/newsletter) . 没有牛市的区块链技术-每周的区块链现状，对技术的偏向很大.
...
- [this week in security](https://twitter.us18.list-manage.com/subscribe?u=e1ad6038c994abec17dafb116&id=a2457dc8ad) . 每周tl; dr网络安全新闻通讯，包括新闻，开心角，您的每周网络猫等等. 它是每个星期天发送的.
...
- [Changelog Nightly](https://changelog.com/nightly) . 每天晚上10点CT发出的一封电子邮件，在GitHub上发布了最热门的新存储库.
...
- [Solo Founder](http://solofounder.dev/) . 每周新闻通讯主要关注由独创创始人创立的创业公司. 我们每周都会接受不同创始人的访谈，并精心策划一些工具和资源链接，以帮助创始人发展业务.
