...
- [Codrops](https://tympanus.net/codrops/) . 有关Web开发和设计中定性的新项目和库的每周新闻.
...
- [Best in Visual Storytelling](https://us16.list-manage.com/subscribe?u=5c12dabe1e59a9fbde1174b8c&id=e27a48af53) . 过去一周以来最佳数据新闻领域的周一综述. 付费版本还包括数据可视化作业过帐.
- [Generative Collective](https://generative.substack.com/) . 每周六早上，有关生成/功能艺术的新闻，教程，文章和启发.

### CSS

- [CSS Weekly](https://css-weekly.com/) .  Zoran Jambor策划的CSS文章，教程，实验和工具的每周电子邮件综述.
...
- [Web Design Weekly](https://web-design-weekly.com/) . 一周内，纯净的链接指向最佳新闻和文章，可在互联网上流行.
...
- [UI Movement](https://uimovement.com) . 仅在您的收件箱中提供最佳的UI设计灵感.
...
- [Hack Design](https://hackdesign.org) . 对于做神奇事情的人来说，这是一个易于遵循的设计课程.
...
- [Unreadit/Design](https://unread.it/n/design/) . 设计灵感和与最佳设计相关的丰富内容都来自于最佳子目录.
...
- [SVG Weekly](https://tinyletter.com/svgweekly) . 每周一封电子邮件，重点关注可缩放矢量图形（SVG），共享教程，工具，实验，演讲和数据.
...
- [Awesome iOS Newsletter](https://ios.libhunt.com/newsletter) . 精选的iOS库的精选列表，包括Objective-C和Swift Projects.
...
- [Swift Newsletter](https://swiftweekly.com/) . 代码示例，教程，截屏视频以及更多内容可用于学习Apple的新编程语言.
- [iOS Dev Weekly](https://iosdevweekly.com/) . 每周都有最佳的iOS开发链接. [Archive](https://iosdevweekly.com/issues).
- [Swift Weekly Brief](https://swiftweekly.github.io) . 社区驱动的关于Swift.org的每周新闻. 由Jesse Squires策划，并在每个星期四免费发布.
...
- [Indie iOS Focus Weekly](https://indieiosfocus.com) . 最佳的iOS开发，营销，Swift，设计和Xcode链接.
...
- [Rails Weekly](https://rails-weekly.ongoodbits.com/) . 每周内从Rails中获取有趣的提交，拉取请求和更多内容的摘要，每个星期五发送到您的收件箱中.
...
- [PHP Annotated Monthly](https://info.jetbrains.com/PHP-Annotated-Subscription.html) . 一个免费的每月新闻通讯，其中包含来自PHP社区的最新新闻和来自网络的最有趣的PHP文章. [Archive](https://blog.jetbrains.com/phpstorm/category/php-annotated-monthly/)
...
- [Perl Weekly](http://perlweekly.com/) . 每周一次的免费电子邮件汇总，内容涉及有关Perl的精选新闻和文章.
...
- [The REPL](https://www.therepl.net/) . 有关Clojure和ClojureScript的每周新闻.
...
- [This Week in Rust](https://this-week-in-rust.org) . 紧跟Rust社区中的事件，学习资源和最新动态. [Archive](https://this-week-in-rust.org/blog/archives/index.html).
...
- [Kotlin Weekly](http://www.kotlinweekly.net/) . 面向Kotlin开发人员的每周新闻通讯，其中包含来自Kotlin环境的文章，库，视频和播客.
...
- [BSD Weekly](https://bsdweekly.com/) .  BSD新闻和文章的每周一次免费电子邮件摘要.
- [MacMost](https://macmost.com/macmost-weekly-newsletter) . 每周都会在您的收件箱中提供最新的MacMost教程，技巧和新闻.
- [NixOS Weekly](https://weekly.nixos.org) . 有关的最新消息 [NixOS](https://nixos.org)

## Git

- [Git Rev News](https://git.github.io/rev_news/rev_news/) .  Git邮件列表的活动汇总，其格式适用于更广泛的技术受众.
...
- [DB Weekly](https://dbweekly.com/) . 每周一次的数据库技术新闻和文章摘要，涵盖了新的开发，SQL，NoSQL，文档数据库，图形数据库等等.

### PostgreSQL

- [Postgres Weekly](https://postgresweekly.com/) . 每周一次免费的PostgreSQL新闻和文章电子邮件摘要.
...
- [NoSQL Weekly](https://www.nosqlweekly.com/) . 一个免费的每周新闻，其中包含与NoSQL相关的精选新闻，文章，新版本，职位等.
...
- [StatusCode Weekly](https://weekly.statuscode.com/) . 每周新闻通讯，内容涉及网络操作，基础架构，性能和工具，从浏览器到摘要.
...
- [Google Cloud Weekly Newsletter](https://www.gcpweekly.com/) .  《 Google Cloud Weekly》是本周与Google Cloud生态系统相关的最新新闻，教程，视频，播客的摘要，非常值得一读.
...
- [Mobile Developers Cafe](https://mobiledeveloperscafe.com) . 面向移动开发者的每周新闻-iOS，Android，Flutter和React Native.
...
- [The Wild Week in AI](https://www.getrevue.co/profile/wildml) . 每周一次的AI和深度学习新闻通讯. [Archive](https://www.getrevue.co/profile/wildml#archive).
...
- [FBA monthly](https://www.fbamonthly.com/) .  《亚马逊物流月刊》全面总结了该月有关亚马逊业务的最重要新闻文章和博客文章. 仅提供实际新闻，解决方案，策略，卖方对卖方的提示等.
...
- [Startup Curated](https://startup.curated.co) . 创业者社区的时事通讯，其中包含来自创始人或为创始人提供的最佳内容. [Archive](https://startup.curated.co/issues).
...
- [ChangeLog Weekly](https://changelog.com/weekly) . 每周新闻通讯，涵盖所有影响开源雷达的内容.
...
- [My Morning Routine](https://mymorningroutine.com/) .  My Morning Routine是一本独立的在线杂志，每个星期三都会为您带来一个崭新的鼓舞人心的早晨活动.
- [wpMail.me](http://wpmail.me/) . 每周一次的免费WordPress新闻快讯，汇总了WordPress新闻和文章. [Archive](http://wpmail.me/newsletters/).
- [Handwritten newsletter](http://www.thnkclrly.com/newsletter/) .  《清晰思考》时事通讯为您提供很少的反思练习，可以帮助您解决日常生活中的问题. 它是用爱和钦佩而创造的. [Archive](http://www.thnkclrly.com/category/thinking-clearly/).
- [Better Dev Link](https://betterdev.link) . 每周新闻通讯收集旨在提高一般编程知识的链接. 目的不包括读者可以从Google即时搜索到的链接（例如，如何执行x，y，z），而是更多关于编程中的问题解决方法.
- [GitHub Trending Repos](https://github.com/vitalets/github-trending-repos) . 一个特殊的仓库，可以在GitHub上使用您喜欢的编程语言跟踪趋势项目. 每天或每周一次以GitHub通知的形式进行更新.
- [HN Mail](https://hnmail.io) . 可自定义的每周新闻，根据您的兴趣提供Hacker News故事.
- [Senior Mindset](https://seniormindset.com) . 以高级软件工程师的心态获取一系列精选论文.

## Resilience

- [Resilience Roundup](https://resilienceroundup.com) . 从Resilence工程研究中学习，而无需深入研究长期的学术论文.
...
- [tl;dr sec](https://tldrsec.com/) . 每周汇总最佳安全工具，博客文章和会议讨论，涵盖AppSec，云和容器安全性，DevSecOps等.

## Miscellaneous

- [Founder Weekly](http://www.founderweekly.com/) . 面向企业家的免费每周新闻通讯，精选了精选内容，必须阅读文章，指南，技巧和窍门，资源，事件等.
...
在法律允许的范围内， [Dmitry Zudochkin](https://github.com/zudochkin) 放弃了此作品的所有版权以及相关或邻近的权利.
