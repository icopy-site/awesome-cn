...
- [Elixir Digest](https://elixirdigest.net/) .  每周长生不老长寿药和凤凰药水. [Archive](https://elixirdigest.net/digests).
...
- [Docker Weekly](https://www.docker.com/newsletter-subscription) .  每周新闻通讯，其中包含来自Docker，我们的用户和生态系统的重大更新.
...
- [Security Newsletter](https://securitynewsletter.co/) .  每周的电子邮件，其中包含周四或周五的最新安全新闻.
