...
* __[Common Workflow Language](http://www.commonwl.org/)__-用于描述分析工作流和工具的规范，该分析工作流和工具在从工作站到集群，云和高性能计算（HPC）环境的各种软件和硬件环境中均可移植并且可伸缩.
...
* __[GATK](https://software.broadinstitute.org/gatk/)__-高通量测序数据中的变体发现.
