...
- [**normalize.css**](http://necolas.github.io/normalize.css/) - 支持HTML5的现代替代CSS重置.  
...
- [**modern-normalize**](https://github.com/sindresorhus/modern-normalize) - 仅针对Chrome，Firefox和Safari进行标准化（不支持Edge或Internet Explorer）.  
...
- [**Pure**](https://purecss.io) - 一组可在每个Web项目中使用的小型响应式CSS模块.  
...
- [**Picnic CSS**](https://picnicss.com) - 轻巧而美丽的图书馆.  
...
- [**Wing**](https://kbrsh.github.io/wing/) - 为极简主义者设计的漂亮的CSS框架.  
...
- [**Tacit**](https://yegor256.github.io/tacit/) - 用于虚拟人的CSS框架，没有类.  
...
- [**Chota**](https://jenil.github.io/chota/) - 非常小的CSS框架.  
...
- [**Bootstrap**](http://getbootstrap.com) - 最流行的HTML，CSS和JavaScript框架，用于在Web上开发响应式移动优先项目.  
...
- [**Semantic UI**](https://semantic-ui.com) - 用户界面是Web的语言.  
  *注意：项目似乎处于非活动状态，但有一个名为的活动分叉 [Fomantic UI](https://github.com/fomantic/fomantic-ui/).*  
...
- [**UIkit**](https://getuikit.com) - 轻量级和模块化前端框架，用于开发快速，强大的Web界面.  
...
- [**Spectre.css**](https://picturepan2.github.io/spectre/) - 轻量级，响应迅速和现代的CSS框架.  
...
- [**Tachyons**](http://tachyons.io) - 无需编写CSS即可快速构建和设计新UI.  
...
- [**Base**](http://getbase.org) - 坚如磐石，响应迅速的HTML / CSS框架.  
...
- [**Material Components Web**](https://material.io/components/web/) - 用于Web的模块化和可定制的Material Design UI组件.  
...
- [**Propeller**](https://propeller.in) - 基于Google Material Design标准和Bootstrap的前端响应式框架.  
...
- [**NES.css**](https://nostalgic-css.github.io/NES.css/) -  NES风格的CSS框架.  
...
- [**Tufte CSS**](https://edwardtufte.github.io/tufte-css/) - 像Edward Tufte的讲义一样设计您的网页.  
...
- [**Bojler**](http://bojler.slicejack.com) - 用于开发响应轻量级电子邮件模板的电子邮件框  
...
工具包更接近库而不是框架.
它们不提供实际样式，但可以在CSS预处理器中使用实用程序（例如mixins）.

- [**Bourbon**](https://www.bourbon.io/) - 轻量级Sass工具套装.  
...
没有看到任何实际开发超过一年或正式的框架已被弃用.
我们将他们留在这里作为参考/灵感，并希望复兴.
...
- [**Skeleton**](http://getskeleton.com) - 死的简单，响应式样板.  
...
- [**unsemantic**](https://unsemantic.com) - 移动，平板电脑和台式机的流体网格.  
...
- [**Kube**](https://imperavi.com/kube/) - 专业开发人员和设计人员的Web框架.  
...
- [**Scooter**](http://dropbox.github.io/scooter/) -  Dropbox web的SCSS框架和UI库.  
  ![](https://img.shields.io/github/stars/dropbox/scooter.svg?style=social&label=Star)
  [Repo](https://github.com/dropbox/scooter)

- [**Responsive Boilerplate**](http://responsivebp.com) - 强大，可访问，开发人员友好的框架，用于构建响应式网站.  
...
- [**Centurion**](https://www.centurionframework.com) - 基于Web的框架，用于快速原型设计和构建更大的Web项目.  
...
GitHub星的图像由提供 [Shields](https://github.com/badges/shields).
