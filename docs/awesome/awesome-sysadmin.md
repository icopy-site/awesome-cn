...
* [Awesome Sysadmin](#awesome-sysadmin)
  ...
  * [Web](#web)
  * Wiki软件： [see awesome-selfhosted#wikis](https://github.com/Kickball/awesome-selfhosted#wikis), Sysadmin Wikis: [see #wikis](#wikis)
* [Resources](#resources)
  * [Blogs](#blogs)
  * [Books](#books)
...
* [BorgBackup](https://github.com/borgbackup/borg) - A fork of [Attic](https://attic-backup.org) 重复数据删除用Python编写的备份程序.
...
* [Go IPFS](https://github.com/ipfs/go-ipfs) - Implementation of [IPFS](http://ipfs.io/)，一种全局的，版本化的对等文件系统，旨在将所有计算设备与相同的文件系统连接起来.
...
* [Docker](http://www.docker.com/) - 开发人员和系统管理员构建，发布和运行分布式应用程序的平台.
...
* [Software Collections](https://www.softwarecollections.org) - Community Release of [Red Hat Software Collections](https://access.redhat.com/documentation/en/red-hat-software-collections/) .  为CentOS / Scientific Linux 6.x提供Ruby，Python等的更新包.
...
This work is licensed under a [Creative Commons Attribution-ShareAlike 4.0 International](http://creativecommons.org/licenses/by-sa/4.0/) 执照.
