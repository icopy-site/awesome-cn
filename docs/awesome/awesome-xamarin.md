...
- [Newtonsoft.Json ★5,812](https://github.com/JamesNK/Newtonsoft.Json) - 适用于.NET的流行高性能JSON框架.
...
- [Calendars ★49](https://github.com/TheAlmightyBob/Calendars) -  Xamarin和Windows Phone的Calendar API插件，支持日历和事件的基本CRUD操作.
