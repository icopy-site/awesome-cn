...
* [Nextatic](https://github.com/tancredi/nextatic) -静态的网站多语言样板，带有用户可编辑的页面，并使用Netlify CMS + Next.js + SCSS + Typescript进行导航.
...
* [Next.js News](https://nextjsnews.com) -Next.js每月通讯，其中包含新功能和即将发布的功能，最佳文章，工具和插件.
