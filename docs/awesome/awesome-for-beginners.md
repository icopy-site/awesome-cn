...
如果您想贡献自己的力量，请浏览此列表，查看 [`first-timers-only` labelled open issues on Github](https://github.com/search?utf8=%E2%9C%93&q=label%3Afirst-timers-only+is%3Aissue+is%3Aopen&type=)，然后按照 [@first_tmrs_only](https://twitter.com/first_tmrs_only) 在Twitter上创建新的“仅限初学者”问题时会收到通知.
...
- [grok.net](https://github.com/Marusyk/grok.net/labels/good%20first%20issue)  _（标签：好第一期）_<br> 跨平台.NET grok实施
...
- [projectM](https://github.com/projectM-visualizer/projectm/labels/good%20first%20issue)  _（标签：好第一期）_<br> 使用OpenGL和GLSL的音乐可视化程序库. 具有使用Qt5，SDL，emscripten，iTunes，Kodi的应用程序.
...
- [Yugabyte DB](https://github.com/yugabyte/yugabyte-db/labels/good%20first%20issue)  _（标签：好第一期）_<br> 分布式SQL数据库.
- [MoveIt](https://github.com/ros-planning/moveit/labels/first-timer-only)  _（标签：仅限初学者）_<br> 易于使用的开源机器人操纵平台，用于开发商业应用，原型设计和基准测试算法.
...
- [sButtons](https://github.com/shahednasser/sbuttons/labels/good%20first%20issue)  _（标签：好第一期）_<br> 简单的按钮，可以轻松用于下一个项目.
...
- [Ecto](https://github.com/elixir-ecto/ecto/labels/Level%3AStarter)  _（标签：级别：入门者）_<br>  Ecto是Elixir的数据库包装和语言集成查询
...
- [Mattermost](https://github.com/mattermost/mattermost-server/issues?utf8=%E2%9C%93&q=is%3Aopen+label%3A%22Up+For+Grabs%22+label%3A%22Difficulty%2F1%3AEasy%22+label%3A%22Tech%2FGo%22+)  _（标签：抢劫，难度/ 1：容易，技术/执行）_<br>  Golang和React中的开源Slack替代方案
...
- [Killgrave](https://github.com/friendsofgo/killgrave/labels/good%20first%20issue)  _（标签：好第一期）_<br> 在Go中生成模拟服务器的简单方法.
...
- [JabRef](https://github.com/JabRef/jabref/labels/good%20first%20issue)  _（标签：好第一期）_<br> 使用包括JavaFX在内的现代Java功能管理文献参考的桌面应用程序. [Dedicated to code quality and constructive feedback](https://devdocs.jabref.org/getting-into-the-code/development-strategy)：两个开发人员都会审核每个请求请求，以提供高质量的反馈并确保高质量的新贡献.
...
- [SirixDB](https://github.com/sirixdb/sirix/labels/good%20first%20issue)  _（标签：好第一期）_<br>  SirixDB是一种进化的，版本化的NoSQL文档存储（XML和JSON）（主要是用Java编写）. 它使用从ZFS和Git借来的许多概念在提交期间存储压缩快照. 每个修订都已建立索引，并且可以使用临时查询来查询文档存储. 它特别适合现代硬件.
...
- [Presto](https://github.com/prestosql/presto/labels/good%20first%20issue)  _（标签：好第一期）_<br> 用于大数据的分布式SQL查询引擎. 寻求指导 [project's Slack](https://prestosql.io/slack.html).
- [appsmith](https://github.com/appsmithorg/appsmith/labels/good%20first%20issue)  _（标签：好第一期）_<br> 拖放内部工具生成器
...
- [Webpack](https://github.com/webpack/webpack/labels/D0%3A%20My%20First%20Commit%20%28Contrib.%20Difficulty%29)  _（标签：D0：我的首次提交（造成困难））_<br>  JavaScript和朋友的捆绑器.
...
- [freeCodeCamp](https://github.com/freeCodeCamp/freeCodeCamp/labels/first%20timers%20only)  _（标签：仅限首次使用）_<br> 开源代码库和课程表. 学会编码和帮助非营利组织.
...
- [keystonejs](https://github.com/keystonejs/keystone/labels/good%20first%20issue)  _（标签：好第一期）_<br> 用于在Node.js中开发数据库驱动的网站，应用程序和API的开源框架. 基于Express和MongoDB构建.
...
- [squirrelly](https://github.com/nebrelbug/squirrelly/labels/good%20first%20issue)  _（标签：好第一期）_<br>  Squirrelly是一个轻量级的模板引擎，支持辅助程序，过滤器，局部对象等.
...
- [material-ui](https://github.com/mui-org/material-ui/labels/good%20first%20issue)  _（标签：好第一期）_<br>  React组件可以更快，更轻松地进行Web开发. 建立自己的设计系统，或从材料设计开始.
- [Meteor](https://github.com/meteor/meteor/labels/good%20first%20issue)  _（标签：好第一期）_<br>  Meteor是用于构建现代Web应用程序的超简单环境.
...
- [ramda-adjunct](https://github.com/char0n/ramda-adjunct/labels/help%20wanted)  _（标签：需要帮助）_<br>  Ramda Adjunct是与Ramda一起使用的最流行和最全面的功能实用程序集，它提供各种有用的，经过良好测试的功能以及出色的文档.
...
<a href="https://sirix.io">SirixDB的</a>基于Svelte / Sapper的<a href="https://github.com/sirixdb/sirix-svelte-front-end">Web前端</a>，这是一个用Java编写的版本化NoSQL文档存储（XML和JSON）.
- [json-editor](https://github.com/json-editor/json-editor/labels/good%20first%20issue) _（标签：好第一期）_<br>
基于JSON模式的编辑器.  JSON编辑器采用JSON模式，并使用它来生成HTML表单. 它完全支持JSON Schema版本3和4，并且可以与几种流行的CSS框架（引导程序，幽灵，顺风）集成.
- [Habitica](https://github.com/HabitRPG/habitica/labels/good%20first%20issue) _（标签：好第一期）_<br>
...
- [reactjs.org](https://github.com/reactjs/reactjs.org/labels/good%20first%20issue)  _（标签：好第一期）_<br> 用于reactjs的文档网站
- [Vest](https://github.com/ealush/vest/labels/good%20first%20issue)  _（标签：好第一期）_<br> 验证框架受单元测试框架的启发.
- [Hoppscotch](https://github.com/hoppscotch/hoppscotch/labels/good%20first%20issue)  _（标签：好第一期）_<br> 一个免费，快速，美观的API请求构建器.
- [Predator](https://github.com/Zooz/predator/labels/good%20first%20issue)  _（标签：好第一期）_<br> 一个强大的开源平台，用于负载测试API.
- [Time to Leave](https://github.com/thamara/time-to-leave/labels/good%20first%20issue)  _（标签：好第一期）_<br> 基于Electron和Javascript的工作时间追踪器应用程序.
- [cypress](https://github.com/cypress-io/cypress/labels/first-timers-only)  _（标签：仅限初学者）_<br> 对浏览器中运行的所有内容进行快速，轻松和可靠的测试.
- [Vue CLI](https://github.com/vuejs/vue-cli/labels/good%20first%20issue)  _（标签：好第一期）_<br>  Vue.js开发的标准工具
- [Vue Router](https://github.com/vuejs/vue-router/labels/good%20first%20issue)  _（标签：好第一期）_<br>  Vue.js的官方路由器.
- [VuePress](https://github.com/vuejs/vuepress/labels/good%20first%20issue)  _（标签：好第一期）_<br> 简约的Vue驱动的静态站点生成器
- [appsmith](https://github.com/appsmithorg/appsmith/labels/good%20first%20issue)  _（标签：好第一期）_<br> 拖放内部工具生成器
...
- [Non-Blocking SirixDB HTTP(S)-Server](https://github.com/sirixdb/sirix/labels/good%20first%20issue)  _（标签：好第一期）_<br> 适用于<a href="https://sirix.io">SirixDB</a><a href="https://github.com/sirixdb/sirix/tree/master/bundles/sirix-rest-api">的非阻塞HTTP（S）服务器</a>，这是XML和JSON的临时性NoSQL文档存储.
- [Kotlin Libraries Playground](https://github.com/LouisCAD/kotlin-libraries-playground/labels/good%20first%20issue)  _（标签：好第一期）_<br> 一个游乐场，可以使人们对Kotlin生态系统中的图书馆有更广泛，更深入的了解. 也是gradle refreshVersions的官方示例. 


## LaTeX

- [Algorithmic Pseudocode](https://github.com/just-a-visitor/algorithmic-pseudocode/labels/good%20first%20issue)  _（标签：好第一期）_<br> 语言独立伪代码（pdf）的集合，用于面试准备和竞争性编程.
...
- [scrapy](https://github.com/scrapy/scrapy/labels/good%20first%20issue)  _（标签：好第一期）_<br> 用于Python的快速高级Web爬网和抓取框架.
...
- [pandas](https://github.com/pandas-dev/pandas/labels/good%20first%20issue)  _（标签：好第一期）_<br> 适用于Python的灵活强大的数据分析/操作库，提供与R data.frame对象，统计函数等类似的标记数据结构
...
- [matplotlib](https://github.com/matplotlib/matplotlib/labels/good%20first%20issue)  _（标签：好第一期）_<br>  Matplotlib是一个综合库，用于在Python中创建静态，动画和交互式可视化.
- [datascience](https://github.com/data-8/datascience/labels/good%20first%20issue)  _（标签：好第一期）_<br> 一个用于介绍数据科学的Jupyter笔记本Python库.
- [ArviZ](https://github.com/arviz-devs/arviz/labels/Beginner)  _（标签：初学者）_<br> 贝叶斯模型的探索性分析.
- [MindsDB](https://github.com/mindsdb/mindsdb/labels/good%20first%20issue)  _（标签：好第一期）_<br>  MindsDB是现有数据库的开源AI层.
- [Bokeh](https://github.com/bokeh/bokeh/labels/good%20first%20issue)  _（标签：好第一期）_<br>  Bokeh是用于现代Web浏览器的交互式可视化库.
- [SymPy](https://github.com/sympy/sympy/labels/Easy%20to%20Fix)  _（标签：易于修复）_<br> 用于符号数学的Python库.
- [Pytorch](https://github.com/pytorch/pytorch/labels/good%20first%20issue)  _（标签：第一期好）_<br>  PyTorch是基于Torch库的开源机器学习库，用于计算机视觉和自然语言处理等应用.
- [Sorting-Algorithms-Visualizer](https://github.com/LucasPilla/Sorting-Algorithms-Visualizer/labels/good%20first%20issue)  _（标签：好第一期）_<br> 用于可视化教育Wiki页面的排序算法的工具.
- [scikit-learn](https://github.com/scikit-learn/scikit-learn/labels/good%20first%20issue)  _（标签：好第一期）_<br>  Scikit-learn是用于Python的机器学习库.
...
- [open-build-service](https://github.com/openSUSE/open-build-service/labels/good%20first%20issue%20%3A1st_place_medal%3A)  _（标签：好第一期）_<br> 一种通用系统，可以自动，一致且可复制的方式从源构建和分发软件包.</br> 看到 ["How to contribute to open build service"](https://github.com/openSUSE/open-build-service/blob/master/CONTRIBUTING.md)
...
- [Faker](https://github.com/faker-ruby/faker/labels/good%20first%20issue)  _（标签：好第一期）_<br>  Faker是一个Ruby库，用于生成虚假数据，例如名称，地址和电话号码.
- [Matestack](https://github.com/matestack/matestack-ui-core/labels/good%20first%20issue)  _（标签：好第一期）_<br> 用纯Ruby编写动态用户界面. 建立在Vue.js之上的Rails引擎
...
- [Rustfmt](https://github.com/rust-lang-nursery/rustfmt/labels/good%20first%20issue)  _（标签：好第一期）_<br> 根据样式准则格式化Rust代码的工具.
- [Iron](https://github.com/iron/iron/labels/easy)  _（标签：简单）_<br> 用于Rust的可扩展并发Web框架
- [TiKV](https://github.com/tikv/tikv/labels/difficulty%2Feasy)  _（标签：D：困难/容易）_<br> 分布式交易关键值数据库
- [nushell](https://github.com/nushell/nushell/labels/good%20first%20issue)  _（标签：好第一期）_<br> 用Rust编写的GitHub时代的现代shell.
- [Hyper](https://github.com/hyperium/hyper/labels/E-easy)  _（标签：E-easy）_<br> 一个用于Rust的快速，安全和正确的低级HTTP库.
- [dotenv-linter](https://github.com/dotenv-linter/dotenv-linter/labels/good%20first%20issue)  _（标签：好第一期）_<br>  ⚡️.env`文件的闪电般的短毛猫. 写在锈 
...
- [Visual Studio Code](https://github.com/Microsoft/vscode/labels/good%20first%20issue)  _（标签：好第一期）_<br> 一种新型工具，结合了代码编辑器的简单性和开发人员对其核心edit-build-debug周期的需求.
...
- [Graphback](https://github.com/aerogear/graphback/labels/good%20first%20issue)  _（标签：好第一期）_<br> 一个CLI和运行时框架，可在几秒钟内生成GraphQL API.
- [LitmusChaos](https://github.com/litmuschaos/litmus/labels/good%20first%20issue)  _（标签：好第一期）_<br>  Litmus是进行云原生混沌工程的工具集.
- [Booster](https://github.com/boostercloud/booster/labels/good%20first%20issue)  _（标签：好第一期）_<br> 一个真正的无服务器框架，无需任何服务器配置文件，即可编写代码并在几秒钟内部署它.
- [tinyhttp](https://github.com/talentlessguy/tinyhttp/labels/good%20first%20issue)  _（标签：好第一期）_<br>  0旧式，小巧，快速的Web框架，用于替代Express.
