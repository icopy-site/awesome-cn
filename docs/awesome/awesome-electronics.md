...
- [Verilator](https://www.veripool.org/wiki/verilator)  -免费的开源Verilog编译器. 测试平台是C ++或SystemC. 速度非常快，但仅限于基于周期的2状态仿真和可合成代码.
- [Icarus Verilog](http://iverilog.icarus.com/)  -免费的开源verilog解释器. 测试平台采用行为验证. 仿真是4状态的，基于事件.

## Gerber Viewers

### Online
- [Tracespace Viewer](https://tracespace.io/) -Gerber查看器，使您可以检查各个图层以及板预览.
- [Gerblook](https://www.gerblook.org/) -由Gerbv支持的在线Gerber查看器.
- [Mayhew Labs 3dpcb](http://mayhewlabs.com/3dpcb) -3D Gerber查看器.
- [CircuitPeople](https://circuitpeople.com) -没有Gerbers多余的2D图层查看器，没有过多的处理.
...
- [Eagle](https://www.autodesk.com/products/eagle/overview) -由于它的免费版本（受电路板尺寸限制），因此是最受欢迎的EDA软件包之一.
...
- [PCBShopper](https://pcbshopper.com/) -比较服务，用于很多不同的PCB批处理和组装服务.
- [OSH Park](https://oshpark.com) -低成本PCB批处理服务，带有带有签名紫色丝印的高质量板.
- [Aisler](https://aisler.net) -在欧洲（德国）制造和装运的价格合理的优质电路板.
...
- [Kitspace](https://kitspace.org)  -项目共享网站，可帮助您购买零件并重建项目. 开源，真正由您开发.
...
- [Tindie](https://www.tindie.com) -供电子产品制造商销售自己设计的小批量产品的市场.
...
## Podcasts
- [The Amp Hour](https://theamphour.com/) -与Chris Gammel和Dave Jones（EEVBlog）经常进行电子聊天，并经常与客人聊天
...
- [Boldport Club](https://boldport.com/)  -对电子项目感到好奇. 作为Boldport俱乐部的成员，您每月将收到一个电子项目.
...
- [cajt/list_of_robot_electronics](https://github.com/cajt/list_of_robot_electronics) -GitHub上的机器人电子资源，项目和产品列表.
