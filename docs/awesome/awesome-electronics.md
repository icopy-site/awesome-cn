...
- [Cheatsheet](https://silica.io/wp-content/uploads/2018/06/kicad-cheatsheet.pdf) （也 [in landscape](https://silica.io/wp-content/uploads/2018/06/kicad-cheatsheet-landscape.pdf)）-简短的PDF，可用于大多数常用操作的菜单和键盘快捷键.
- [Footprint Collection](https://github.com/kitspace/kicad_footprints) -可在线收集所有KiCad脚印以及一些用于管理它们的脚本的集合.
