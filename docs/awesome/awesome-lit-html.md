...
- [@popeindustries/lit-html-server](https://www.npmjs.com/package/@popeindustries/lit-html-server) -以Node.js流的形式在服务器上渲染lit-html模板.
...
- [perlite](https://github.com/PaulMaly/perlite) -一种声明性的方式来创建考虑了服务器端应用程序的富客户端小部件.
...
- [vscode-lit-html](https://github.com/mjbvz/vscode-lit-html) -lit-html模板字符串的语法突出显示和IntelliSense.
- [vscode-lit-plugin](https://github.com/runem/lit-analyzer/tree/master/packages/vscode-lit-plugin) -lit-html的语法突出显示，类型检查和代码完成.
...
- [ts-lit-plugin](https://github.com/runem/lit-analyzer/tree/master/packages/ts-lit-plugin)  -插件，为lit-html添加类型检查和代码完成. 由`vscode-lit-plugin`使用.
- [typescript-lit-html-plugin](https://github.com/Microsoft/typescript-lit-html-plugin)  -TypeScript服务器插件，为lit-html添加了IntelliSense. 由`vscode-lit-html`使用.
...
- [lit-analyzer](https://github.com/runem/lit-analyzer/tree/master/packages/lit-analyzer) -类型的CLI，用于检查lit-html模板中的绑定.
...
- [open-wc](https://github.com/open-wc) -一组建议，可帮助您生成，测试，整理，演示和发布Web组件.
