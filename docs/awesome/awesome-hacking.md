...
如果您想对此列表做出贡献（请这样做），请向我发送请求或与我联系 [@carpedm20](https://twitter.com/carpedm20)

有关可下载的免费黑客书籍的列表，请转到 [here](https://github.com/Hack-with-Github/Free-Security-eBooks)
 ...
 * [IDA](https://www.hex-rays.com/products/ida/) -IDA是Windows，Linux或Mac OS X托管的多处理器反汇编程序和调试器
 ...
 * [ScratchABit](https://github.com/pfalcon/ScratchABit) -使用与IDAPython兼容的插件API可以轻松地重定向和破解交互式反汇编程序
 ...
 * [tcpdump](http://www.tcpdump.org/)  -强大的命令行数据包分析器；  和libpcap，用于网络流量捕获的便携式C / C ++库
 * [mitmproxy](https://github.com/mitmproxy/mitmproxy) -具有控制台界面的HTTP的交互式SSL中间人代理
 * [Charles Proxy](https://charlesproxy.com) -跨平台的GUI Web调试代理，可查看截获的HTTP和HTTPS / SSL实时流量
 ...
 * [Kaitai Struct](https://github.com/kaitai-io/kaitai_struct)  -用于以各种编程语言创建解析器的DSL.  Web IDE对反向工程特别有用.
 ...
 * [Dependencies](https://github.com/lucasg/Dependencies) -Dependency Walker的FOSS替代品.
...
## General
 * [Strong node.js](https://github.com/jesusprubio/strong-node) -详尽的清单，以帮助对node.js Web服务进行源代码安全性分析.
 ...
 * [Crackmes.de](http://crackmes.de/) -世界上第一个也是最大的社区网站，提供破解和反向链接.
