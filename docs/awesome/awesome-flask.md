...
- [Flask-Admin](https://github.com/flask-admin/flask-admin) - 功能管理面板，提供用于根据您的模型管理数据的用户界面.
...
- [Flask-Classful](https://flask-classful.teracy.org/) - 添加了对基于类的视图的支持，用于设置 RESTful API 路由端点.
...
- [Connexion](https://connexion.readthedocs.io) - 建立在 Flask 之上的开源、基于 OpenAPI 的 REST 框架.
...
- [Flask-RESTX](https://flask-restx.readthedocs.io) - 社区驱动的分支 [Flask-RESTPlus](https://flask-restplus.readthedocs.io/) 这使得使用 Flask 构建和记录 RESTful API 变得容易.

#### Swagger/OpenAPI Documentation Support

- [Flask-APISpec](https://flask-apispec.readthedocs.io/) - 自动记录 REST API.
- [SAFRS: Python OpenAPI & JSON:API Framework](https://github.com/thomaxxl/safrs) - SAFRS 是 *S*ql*A*lchemy *F*lask-*R*estful *S*wagger 的首字母缩写词，旨在帮助开发人员为 SQLAlchemy 数据库对象和关系创建自我记录的 JSON API.
...
- [Flask-User](https://flask-user.readthedocs.io) - 账户管理、认证、授权.
 ...
 &gt; 想知道 Flask-User 和 Flask-Security 之间的区别吗？ 查看烧瓶用户 [FAQ](https://flask-user.readthedocs.io/en/latest/faq.html).
...
- [Flask-JWT-Router](https://github.com/joegasewicz/flask-jwt-router) - 将授权路线添加到 Flask 应用程序.
...
- [Flask-Marshmallow](https://flask-marshmallow.readthedocs.io) - Flask 和 marshmallow 的薄集成层（一个对象序列化/反序列化库），它为 marshmallow 添加了额外的特性.
...
<!--lint ignore double-link-->
- [Flask-DB](https://github.com/nickjj/flask-db) - Flask CLI 扩展，可帮助您迁移、删除、创建和播种您的 SQL 数据库.
- [Flask-Migrate](https://flask-migrate.readthedocs.io) - 通过 Alembic 处理 SQLAlchemy 数据库迁移.

<!--lint ignore double-link-->
 &gt; 想知道 Alembic、Flask-Alembic、Flask-Migrate 和 Flask-DB 之间的区别吗？ 审查 [this item](https://github.com/nickjj/flask-db#differences-between-alembic-flask-migrate-flask-alembic-and-flask-db) 来自 Flask-DB 的常见问题解答.
...
- [Flask-DebugToolbar](https://flask-debugtoolbar.readthedocs.io) - 用于 Flask 的 Django 调试工具栏端口.
...
- [Flask Monitoring Dashboard](https://flask-monitoringdashboard.readthedocs.io) - 用于自动监控 Flask 网络服务的仪表板.
- [Sentry Python SDK](https://sentry.io/for/flask/) - 哨兵 SDK Flask 集成.
...
- [Flask-File-Upload](https://github.com/joegasewicz/flask-file-upload) - 简单的文件上传.
...
- [Project Website](https://palletsprojects.com/p/flask/) - 烧瓶官方网站.
<!--lint ignore double-link-->
...
- [Reddit](https://www.reddit.com/r/flask/) - Flask 版块.
...
- [FlaskCon](https://twitter.com/flaskcon) - 社区驱动的 Flask 活动旨在让世界各地的演讲者和与会者参与与 Flask 相关的技术和福音会议.
- [PyConWeb](https://twitter.com/pyconweb)  - 涵盖 Django、Tornado、Flask、API 框架.  AsyncIO、网络、前端、JavaScript 和网络安全.
- [Flask Conf Brazil](https://2019.flask.python.org.br/) - Flask 开发者和用户会议.
...
- [Flask](https://www.meetup.com/topics/flask/all/) - 20 个国家/地区的 40 多个群组.
- [Python Web Development](https://www.meetup.com/topics/python-web-development/all/) - 81 个国家/地区的 600 多个群组.
- [Python](https://www.meetup.com/topics/python/all/) - 100 个国家/地区的 2,400 多个群组.

### Podcasts

- [TalkPython](https://talkpython.fm/) - 领先的 Python 播客，在 Flask 上有几集.
- [Podcast Init](https://www.pythonpodcast.com/) - 一个流行的 Python 播客，偶尔会有 Flask 嘉宾.
- [Python Bytes](https://pythonbytes.fm/) - 另一个不时讨论 Flask 的 Python 播客.
- [Full Stack Python's Best Python Podcasts Page](https://www.fullstackpython.com/best-python-podcasts.html) - 活跃的特定于 Python 的播客列表.
...
- [Flask Web Development](https://www.oreilly.com/library/view/flask-web-development/9781491991725/) - 通过逐步开发一个真实世界的项目，从头开始学习框架.
...
- [uwsgi-nginx-flask-docker](https://github.com/tiangolo/uwsgi-nginx-flask-docker) - 带有 uWSGI 和 Nginx 的 Docker 图像，用于在单个容器中运行的 Python 中的 Flask 应用程序.
- [React-Redux-Flask](https://github.com/dternyak/React-Redux-Flask) - 用于 Flask JWT 后端和带有 Material UI 的 React/Redux 前端的样板应用程序.
- [Flask-Scaffold](https://github.com/Leo-G/Flask-Scaffold) - 使用 Flask 在 Angular 6、Bootstrap 4 和 REST API 中使用原型数据库驱动的 Web 应用程序.
- [Flask-VueJS](https://github.com/marcuxyz/flask-vuejs) - 将 Flask 应用程序与 VueJS 连接起来.
...
- [Redash](https://github.com/getredash/redash) - 旨在让任何人，无论技术水平如何，都能利用大小数据的力量.
...
- [SecureDrop](https://github.com/freedomofpress/securedrop) - 媒体组织可以使用开源举报人提交系统来安全地接受来自匿名来源的文件并与匿名来源进行通信.
...
&gt; **注意**：该项目由 ** 提供支持[TestDriven.io](https://testdriven.io/) **. 请购买我们的 Flask 课程之一来支持这个开源项目. 了解如何构建、测试和部署由 Docker、Flask 和 React 提供支持的微服务！
