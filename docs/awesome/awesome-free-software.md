...
- [Libre.fm](https://libre.fm/)  - 免费流式传输、下载、重新混合和共享音乐.  ([GNU AGPLv3](https://git.gnu.io/gnu/gnu-fm/blob/master/COPYING))
...
- [Nuclear Music Player](https://nuclear.js.org/)  - 自动从免费来源查找音乐的流媒体音乐播放器.  ([GNU AGPLv3](https://github.com/nukeop/nuclear/blob/master/LICENSE))
...
- [GNU stow](https://www.gnu.org/software/stow/)  - GNU Stow 是一个符号链接农场管理器，它采用位于文件系统上不同目录中的不同软件和/或数据包，并使它们看起来像是安装在同一个地方.  ([GNU GPLv3](https://github.com/ranger/ranger/blob/master/README.md))
...
- [Gajim](https://gajim.org/)  - 用于桌面的 XMPP/Jabber 客户端.  ([GNU GPLv3](https://dev.gajim.org/gajim/gajim/blob/master/COPYING))
...
- [ProtonMail](https://protonmail.com/)  - 安全的基于网络的电子邮件服务.  ([MIT](https://github.com/ProtonMail/WebClient/blob/public/license.md))
- [Ring](https://ring.cx/)  - 通过分布式服务进行电话、电话会议和媒体共享.  ([GNU GPLv3](https://ring.cx/en/about/practical))
- [Signal](https://signal.org/)  - 适用于台式机、Android 和 iOS 的私人消息和通话.  ([GNU GPLv3](https://github.com/WhisperSystems/Signal-Android/blob/master/LICENSE))
- [Tox](https://tox.chat/)  - 具有语音、视频和屏幕共享功能的加密和分布式消息传递平台.  ([GNU GPLv3](https://github.com/TokTok/c-toxcore/blob/master/COPYING))
- [Tutanota](https://tutanota.com/)  - 支持企业帐户的免费加密电子邮件.  ([GNU GPLv3](https://github.com/tutao/tutanota/blob/master/LICENSE.txt))

### File Management

- [7-Zip](http://7-zip.org/)  - 用于创建和打开压缩文件的文件归档器.  ([GNU LGPLv2.1+](http://www.7-zip.org/faq.html))
- [Filestash](http://www.filestash.app)  - 一个类似于 Dropbox 的 Web 客户端，用户可以在其中使用自己的后端（FTP、SFTP、Webdav、S3、Minio 等）.  ([GNU AGPLv3](https://github.com/mickael-kerjean/filestash/blob/master/LICENSE))
...
- [Sharry](https://eikek.github.io/sharry/)  - 方便的文件共享 Web 应用程序，允许您上传文件并获取可以共享的 URL.  ([GNU GPLv3+](https://github.com/eikek/sharry/blob/master/LICENSE.txt))

### Graphics

- [Blender](https://www.blender.org/)  - 用于建模、模拟和动画的 3D 创作套件.  ([GNU GPLv2+](https://www.blender.org/about/license/))
- [ExifCleaner](https://exifcleaner.com/)  - GUI 应用程序可通过简单的拖放操作从图像和视频中删除 exif 元数据.  ([MIT](https://github.com/szTheory/exifcleaner/blob/master/LICENSE))
...
- [Eclipse](https://www.eclipse.org/eclipseide/)  - 支持最新 Java 版本和其他语言的可扩展 IDE.  ([EPL](http://www.eclipse.org/legal/epl-v10.html))
- [IntelliJ IDEA Community Edition](https://github.com/JetBrains/intellij-community)  - Java/Android IDE，旨在最大限度地提高开发人员的生产力.  ([Apache License 2.0](https://github.com/JetBrains/intellij-community/blob/master/LICENSE.txt))
...
- [Zathura](https://git.pwmt.org/pwmt/zathura)  - 高度可定制和功能强大的文档查看器. 它提供了一个简约且节省空间的界面以及主要侧重于键盘交互的简单使用.  ([zlib License](https://git.pwmt.org/pwmt/zathura/raw/master/LICENSE))
...
- [OpenMapTiles](https://openmaptiles.org/)  - 一套用于自托管 50 多种语言的 OpenStreetMap 地图的开源工具. 它为 GIS 程序提供栅格和矢量切片、WMS 和 WMTS 服务，支持 JavaScript 查看器和移动 SDK.  ([BSD](https://github.com/openmaptiles/openmaptiles/blob/master/LICENSE.md))
- [ZeroNet](https://zeronet.io/)  - 使用比特币密码学和 BitTorrent 网络的分散式网站.  ([GNU GPLv2](https://raw.githubusercontent.com/HelloZeroNet/ZeroNet/master/LICENSE))
...
- [JabRef](https://www.jabref.org)  - 使用 BibTeX/BibLaTeX 管理参考和附加的 PDF. 包括对 LibreOffice 的支持.  ([MIT](https://github.com/JabRef/jabref/blob/master/LICENSE.md))
...
- [Emacs](https://www.gnu.org/software/emacs/)  - 可扩展、可定制、免费/自由的文本编辑器——以及更多.  ([GNU GPL](http://www.free-soft.org/gpl_history/emacs_gpl.html))
...
- [Sandman](https://alexanderepstein.github.io/Sandman/)  - 让您知道何时关闭计算机并根据计算的睡眠周期进入睡眠状态.  ([MIT](https://github.com/alexanderepstein/Sandman/blob/master/License.md))
- [Search Deflector](https://spikespaz.com/search-deflector)  - 一个小程序，它将从 Windows 开始菜单或 Cortana 进行的搜索重定向到您喜欢的任何浏览器和搜索引擎.  ([MIT](https://github.com/spikespaz/search-deflector/blob/master/LICENSE))
...
- [Cloverleaf](https://cloverleaf.app)  - 一个开源应用程序，无需在任何地方存储您的密码即可替换您的密码管理器.  ([MIT](https://github.com/cloverleaf/web/blob/master/LICENSE))
- [Dnote](https://www.getdnote.com/)  - 具有多设备同步和 Web 界面的简单命令行笔记本.  ([GNU AGPLv3](https://github.com/dnote/dnote/blob/master/licenses/AGPLv3.txt))
...
- [Lobsters](https://lobste.rs/)  - 链接聚合和讨论与否决解释.  ([BSD 3-clause](https://github.com/lobsters/lobsters/blob/master/LICENSE))
...
- [NotABug.org](https://notabug.org/)  - 自由许可项目的协作平台.  ([MIT](https://notabug.org/hp/gogs/src/master/LICENSE))
...
- [Phabricator](https://phacility.com/phabricator/)  - 用PHP构建的代码管理平台（类似于GitLab）.  ([Apache License 2.0](https://github.com/phacility/phabricator/blob/master/LICENSE))
...
- [Apache HTTP Server](https://httpd.apache.org/)  - 安全、高效且可扩展的网络服务器.  ([Apache License 2.0](http://www.apache.org/licenses/))
- [lighttpd](http://www.lighttpd.net/)  - 针对速度关键型环境进行了优化，同时保持符合标准、安全和灵活.  ([Revised BSD license](http://www.lighttpd.net/assets/COPYING))
...
- [Aleph Objects](https://www.alephobjects.com/) - Respects Your Freedom (RYF) 认证的 3D 打印机采用自由硬件和软件构建.
...
- [Vikings](https://vikings.net/) - 托管公司，由 Libreboot 固件、自由软件和绿色能源提供支持，同时也销售硬件.

### Hardware Resources

- [disaster.radio](https://disaster.radio/) - 基于免费软件和负担得起的开放硬件构建的离网太阳能远程网状网络.
- [h-node](https://h-node.org/) - 与完全免费的操作系统配合使用的硬件数据库.
- [Linux Preloaded](https://linuxpreloaded.com/) - 从许多地区精心挑选的供应商列表，这些供应商销售预装了免费软件的计算机.
- [Respects Your Freedom Hardware Certification](https://www.fsf.org/resources/hw/endorsement/criteria) - 获得自由软件基金会的 RYF 认证资格的要求.
...
- ['Libre' Software: Turning Fads into Institutions?](https://www.sciencedirect.com/science/article/pii/S0048733302000033) - 对自由软件及其可持续性进行经济分析的学术文章.
- [Software Freedom](https://devuan.org/os/free-software) - Devuan 对自由软件为何重要的简短解释.
...
- [Free GNU/Linux Distributions](https://www.gnu.org/distros/free-distros.html) - 完全免费分发.
- [freepost](https://freepo.st/) - 与自由文化有关的一切.

### Events

- [LibrePlanet](https://libreplanet.org/) - 自由软件年会.
- [Software Freedom Day](https://en.wikipedia.org/wiki/Software_Freedom_Day) - 一年一度的免费软件全球庆祝活动，旨在提高人们对免费软件及其优点的认识.

### Licensing

- [FOSSology](https://www.fossology.org/) - 软件项目的许可合规性工具包.
- [gplenforced.org](https://gplenforced.org/) - 面向社区的 GPL 实施.
...
- [Framasoft](https://framasoft.org/) - 致力于在全球范围内推广自由软件、创新项目以及共享与合作世界的网络.
- [Free Software Foundation](https://www.fsf.org/) - 以促进计算机用户自由为使命的非营利组织.
- [Free Software Movement Karnataka](https://fsmk.org/) - 在印度班加罗尔传播自由软件意识的团体.
- [Free Software Movement of India](http://fsmi.in/) - 印度自由软件组织联盟.
- [FSF India](http://gnu.org.in/) - FSF 的印度姊妹站点.
...
- [Outreachy](https://www.outreachy.org/) - 帮助来自代表性不足的背景的人在 FOSS 软件公司找到实习机会.
...
- [Software Freedom Law Center](https://www.softwarefreedom.org/) - 为免费、自由和开源软件创建者提供免费法律服务的提供商.
- [Snowdrift.coop](https://snowdrift.coop/) - 公共产品的人群匹配.
- [TuxFamily](https://www.tuxfamily.org/) - 自由项目免费托管和其他服务.
...
- [Maxime Lathuilière](https://maxlath.eu/) - 通过自由软件重组信息和资源以实现自由社会.
