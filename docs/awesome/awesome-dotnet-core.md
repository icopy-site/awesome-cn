...
* [Abp vNext](https://github.com/abpframework/abp) -  Abp vNext是下一代开源软件 [ASP.NET Boilerplate](https://github.com/aspnetboilerplate/aspnetboilerplate)  框架.  它是一个完整的架构和强大的基础架构，可以创建现代Web应用程序！
遵循最佳实践和惯例，为您提供SOLID开发体验.
...
### CMS
* [Awesome-CMS-Core](https://github.com/SaiGonSoftware/Awesome-CMS-Core) - 令人敬畏的CMS Core是一个开源CMS，使用ASP.Net Core和ReactJS构建，考虑到模块分离问题，并提供最新的技术趋势，如.Net Core，React，Webpack，SASS，后台作业，Message Queue.
...
* [IL2C](https://github.com/kekyo/IL2C) -  ECMA-335 CIL / MSIL到C语言的翻译.
...
* [SecurityDriven.Inferno](https://github.com/thangchung/awesome-dotnet-core/blob/master/github.com/sdrapkin/SecurityDriven.Inferno) - 使用.Net原语的高级加密库已经过专业审计.
...
* [StringDB](https://github.com/SirJosh3917/StringDB) -  StringDB是一个模块化的键/值对归档数据库，旨在消耗*微小*的ram并生成* tiny *数据库.
...
* [EFCorePowerTools](https://github.com/ErikEJ/EFCorePowerTools) - 实体框架核心电动工具 -  EF Core的逆向工程，迁移和模型可视化.
...
* [Polly](https://github.com/App-vNext/Polly) -  .NET 3.5 / 4.0 / 4.5 / PCL库，允许开发人员以流畅的方式表达瞬态异常和故障处理策略，如重试，重试，等待和重试或断路器
* [ProxyKit](https://github.com/damianh/ProxyKit) - 在ASP.NET Core上创建代码优先HTTP反向代理的工具包
...
* [ShellProgressBar](https://github.com/Mpdreamz/shellprogressbar) - 库在控制台程序中创建进度条
...
* [CoordinateSharp](https://github.com/Tronald/CoordinateSharp) - 可以快速格式化和转换地理坐标以及提供基于位置的太阳和月亮信息（日落，日出，月亮照明等）的图书馆. 
...
* [FluentDocker](https://github.com/mariotoffia/FluentDocker) - 用于docker，docker-compose和docker-machine的命令，服务和Fluent API，适用于win / mac / linux和本地docker.
...
* [JqueryDataTablesServerSide](https://github.com/fingers10/JqueryDataTablesServerSide) - 用于Jquery DataTables的ASP.NET核心服务器端处理库，具有多列过滤，数据库级别的排序和分页，并支持Excel Export和TagHelper.
...
* [Scriban](https://github.com/lunet-io/scriban) - 一种快速，强大，安全且轻量级的文本模板语言和.NET引擎.
...
* [Linq_Faster](https://github.com/jackmott/LinqFaster)   - 类似于Linq的扩展函数，用于Arrays，Span <T>  和列表 <T>  更快，分配更少.
...
## Roadmaps
* [ASP.NET Core Developer Roadmap](https://github.com/MoienTajik/AspNetCore-Developer-Roadmap) -  2019年成为ASP.NET核心开发人员的路线图.
...
## Sample Projects
*微服务和服务网格
  * [coolstore-microservices ](https://github.com/vietnam-devs/coolstore-microservices) - 使用Istio服务网格的基于Kubernetes的多语言微服务应用程序
...
* 基础知识
  ...
  * .NET Core和Nodejs之间的比较 [here](https://manuel-rauber.com/2016/03/07/node-js-asp-net-core-1-0-a-usage-comparison/), [here](https://gist.github.com/ilyaigpetrov/f6df3e6f825ae1b5c7e2) and [here](https://github.com/thinktecture/nodejs-aspnetcore-webapi)
