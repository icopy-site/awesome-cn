...
* [stormpath-sdk](https://github.com/stormpath/stormpath-sdk-dotnet) - 建造 [simple, secure web applications](https://github.com/stormpath/stormpath-aspnetcore) 使用 Stormpath 和 ASP.NET Core.（已弃用：加入 OKTA 后，它将在 2017 年 3 月更新） 
...
* [Dotnet outdated](https://github.com/jerriep/dotnet-outdated) - .NET Core 全局工具，用于在项目中显示过时的 NuGet 包.
...
* [PdfReport.Core](https://github.com/VahidN/PdfReport.Core) - PdfReport.Core 是代码优先的报告引擎，它建立在 iTextSharp.LGPLv2.Core 和 EPPlus.Core 库之上.
...
* [Tossit](https://github.com/turgayozgur/tossit)  - 简单易用的分布式作业/工人逻辑库. 由内置 RabbitMQ 实现处理的分布式消息.
