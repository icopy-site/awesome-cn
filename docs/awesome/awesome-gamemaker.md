...
&gt; 精选的 GameMaker 库、片段、指南和项目列表.

[GameMaker](https://gamemaker.io/) 是 YoYo Games 的用户友好型跨平台游戏引擎，它允许初学者和高级游戏开发人员为桌面、HTML5 和控制台平台创建 2D 和 3D 游戏.
...
- [Beginner GameMaker Tutorials](https://www.youtube.com/watch?v=nBCDzE9MDbk&list=PLPRT_JORnIur4v19PHXCtJ5P05vaokFdP)  - Shaun Spalding 的教程. 全面介绍 IDE 的基本功能. 如果您是初学者，强烈建议您查看完整的播放列表. ![YouTube](https://github.com/bytecauldron/awesome-gamemaker/raw/main/icons/youtube.png)
...
- 对于像素艺术， [AESprite](https://www.aseprite.org/) 是原生精灵编辑器的流行替代品.
 - 不要害怕使用其他开发者库. 其中很多都是免费的. 请注意许可证.
 - 对 IDE 和运行时的更新可能会破坏您的游戏（例如对 GML 的语法更改）. 如果您在团队中工作，请确保您在同一版本的 GMS 上运行，并且仅在收到公平警告时才进行更新. 您可以在 GMS 下载页面重新安装以前版本的 IDE.
- 除非您的游戏需要复杂的物理交互，否则通常建议避免使用 GameMaker 的内置物理系统.
 - 安排项目的例行备份. 如果您在回购协议中处理较大的媒体文件，请尝试 [Git LFS](https://git-lfs.github.com/).

## Utilities

- [gm-core](https://github.com/gm-core)  - 基础实用程序套件和新 GameMaker 项目的良好起点. 附带生活质量方法、网络工具、测试框架、增量计时等.
- [FAST](https://github.com/Hyomoto/FAST)  - 灵活的助手工具包. 类似于 gm-core 但带有输入和分辨率处理.
- [Stitch](https://www.npmjs.com/package/@bscotch/stitch)  - 管道开发工具包. 包括跨项目导入、批量创建/更新精灵和声音、纹理页面管理等. 仅在 Windows 上测试.
- [DDDEditor](https://github.com/DragoniteSpam/DDDEditorGMS2) - 通用游戏编辑器.
- [handytools](https://github.com/JujuAdams/handytools/) - 在一个方便的项目中收集 Juju 的图书馆.
...
- [wTimer](https://mors-games.itch.io/wtimer) - 警报的强大替代品.
- [FrogAlarm](https://github.com/colmeye/FrogAlarms) - GameMaker 警报的另一种简单替代方法.
- [fuwafuwa](https://github.com/kemonologic/fuwafuwa) - 易于使用的计时器系统.
- [Timer](https://github.com/nommiin/Timers) - 基于 JS 中的 setTimeout 和 setInterval 的定时器方法.
- [Broadcast](https://github.com/JulianDicken/Broadcast) - 事件处理库.
- [EventGML](https://github.com/Soves/EventGML) - 轻量级和快速的 Node.js 风格的事件库.
...
- [Promises](https://github.com/YAL-GameMaker/Promise.gml) - 对 JavaScript Promises 的改编.
- [Destructors](https://github.com/DatZach/Destructors) - 允许您在结构内部使用 ds_* 类型，例如列表和映射.
- [SNAP](https://github.com/JujuAdams/SNAP)  - 简单的数据格式保存和加载. 请注意，较新版本的 GameMaker 包含 `json_parse` 和 `json_stringify`. 但是，如果您正在转换 csv、ini、xml 等，您可能会发现这非常有用.
...
- [Trixscript](https://trixelized.itch.io/trixscript) - 用有用的功能来丰富你的游戏.
- [CoreExtension](https://github.com/blueburncz/CoreExtension) - CC0 编程库的集合.
- [Voxeledphoton's FreeGMScripts](https://github.com/vphoton/FreeGMScripts)  - 附加的 GML 辅助函数. 有些可能已与 2.3+ 语法过时.
- [ForEach](https://github.com/KeeVeeGames/foreach.gml) - 为数组、ds_lists、ds_maps、ds_stacks、ds_queues、ds_priorities 和结构添加 foreach 实现.
- [DeepCopy](https://github.com/KeeVeeGames/DeepCopy.gml) - 以任何顺序嵌套的深度克隆类实例/构造结构、匿名结构和数组！
- [Motion Scripts](https://avis.itch.io/motion-scripts) - 提供内置运动变量的替换方法.
- [Cottonwool](https://github.com/JujuAdams/Cottonwool) - 没有内存泄漏的安全表面.
- [Canvas](https://github.com/tabularelf/Canvas) - 另一个很好的表面管理解决方案.
- [zlib functions](https://yellowafterlife.itch.io/gamemaker-zlib) - 简单的压缩/解压功能.
- [Window Taskbar](https://yellowafterlife.itch.io/gamemaker-window-taskbar)  - 仅限 Windows. 闪烁游戏窗口边框和/或其任务栏按钮.
...
- [Autoframer](https://github.com/mstop4/auto-framer) - 自动处理跨不同显示和窗口大小调整游戏视图的大小.
- [gameframe](https://github.com/YAL-GameMaker/gameframe) - Windows 的自定义窗口标题和边框.
- [GML+](https://xgasoft.itch.io/gmlp) - 一个旨在“填补 GML 空白”的脚本集.
...
- [GMD3D11](https://github.com/blueburncz/GMD3D11) - 用于与 Windows Direct3D 交互的 DLL.
- [GMTimeLine](https://github.com/TimVN/GMTimeLine) - GameMaker 时间线的纯代码替代品.
- [Catspeak](https://github.com/katsaii/catspeak-lang) - 用于改装支持的跨平台编程语言.
- [GMBenchmark](https://github.com/DragoniteSpam/GMBenchmark) - 基准 GML 代码的工具.
- [Agenda](https://github.com/benal20/Agenda.gml) - 安排和延迟回调的执行.

## Debugging

- [rt-shell](https://github.com/daikon-games/rt-shell)  - 易于使用的游戏外壳. 创建您自己的命令、命令元数据、命令建议、历史等.
- [Olympus](https://github.com/bscotch/olympus#readme) - 测试框架.
- [Crispy](https://github.com/bfrymire/crispy) - GameMaker 中的单元测试.
- [Snitch](https://github.com/JujuAdams/Snitch) - 崩溃和日志记录系统.
- [DeerLog](https://mulfok.itch.io/gamemaker-deerlog) - 小型日志编写器.
...
- [Duck](https://github.com/imlazyeye/duck) - 一个快速的 GML 分析器，用于执行代码样式和检测错误.

## Input Handling

- [Input](https://github.com/JujuAdams/input) - 没有废话游戏手柄/键盘库.
- [XeroInput](https://www.reddit.com/r/gamemaker/comments/icoh6m/xeroinput_gms23_input_handler/) - 另一个处理单个动作的多个输入的库.
- [InputCandy](https://github.com/LAGameStudio/InputCandy) - 类似于 Input，因为它充当 SDL 的包装器，但也提供测试、屏幕诊断和一些与外围设备相关的其他 UI 组件.
...
- [Native Cursors](https://yellowafterlife.itch.io/gamemaker-native-cursors) - 系统级自定义游标.

## User Interface

- [Scribble](https://github.com/JujuAdams/scribble) - 高效的多效果文本渲染器.
- [Scripture](https://pixelatedpope.itch.io/scripture) - 另一个易于使用、高度兼容的文本渲染器.
- [Chatterbox](https://github.com/JujuAdams/chatterbox) - 叙事脚本工具.
- [Textboxy](https://github.com/glitchroy/textboxy) - 简单的文本框.
- [Crochet](https://github.com/FaultyFunctions/Crochet) - 适用于作家和程序员的交互式对话编辑器.
...
- [GMUI-Framework](https://github.com/AlertStudios/GMUI-Framework) - 一个纯 GML 解决方案，用于构建和控制菜单，与 .NET UI 相似.
- [GMS2-UI-Library](https://github.com/nabilatsoulcade/GMS2-UI-Library) - 一个充满有用脚本的库，用于在 GameMaker 中实现您的 UI 设计.
- [Emu UI](https://github.com/DragoniteSpam/Emu) - 通用 UI 元素（文本输入、复选框、单选按钮、对话框等）.
- [Easy And Fast Menu](https://pkgames.itch.io/easy-and-fast-menus-for-gms-23)  - 在几秒钟内启动并运行菜单的简单实现. 如果您不寻找像 GMUI 这样更大的解决方案，那么它似乎非常适合.
...
- [Smart Clickable GUI](https://www.youtube.com/watch?v=RbBgE3cUShc) - 像素教皇. ![YouTube](https://github.com/bytecauldron/awesome-gamemaker/raw/main/icons/youtube.png)
- [RTS Selection Tool](https://gentoogames.itch.io/rts-selection-tool) - 鼠标拖动功能可以在实时战略游戏中选择棋子.
- [zitk](https://github.com/TandyRum1024/zitk)  - 另一个有趣的，受 Dear ImGui 启发的 GUI 工具包. 正在开发中，但值得关注.
- [gooey](https://manta-ray.itch.io/gooey) - 用于 GameMaker LTS 的基于 Sprite 的 UI 库.

## Localization

- [polyglot](https://github.com/daikon-games/polyglot) - 本地化库.
- [gm-i18n](https://github.com/CreativeHandOficial/gm-i18n) - 使用 JSON 文件简单快速地实现文本国际化.
- [lexicon](https://github.com/tabularelf/lexicon) - 另一个专注于简化实施的本地化解决方案.
- [GMLocalize](https://github.com/DragoniteSpam/GMLocalize2)  - 不是完整的本地化解决方案. 从 GameMaker Studio 2 项目中提取用于本地化的文本字符串并将其保存到 JSON 文件中.
- [Small Pentapop Localization Tool](https://github.com/AntonBergaker/small_pp_localization_tool) - 类似于 GMLocalize 的导出工具，但导出为 csv.

## Physics

- [Loj Hadron Collider](https://github.com/Lojemiru/Loj-Hadron-Collider) - 一个强大的、像素完美的碰撞引擎.
- [On Slopes and Grids](https://forum.yoyogames.com/index.php?threads/on-slopes-and-grids-subpixel-perfect-topdown-movement-and-collision-line-without-objects.4073/) - 实施 45° 斜坡的教程.
- [GMS2 Platforming System](https://benal.itch.io/basic-modern-platforming-system) - 由 Ben Allen 实施的 GameMaker 以及对 Shaun Spalding 的原始 1.4 平台游戏教程的扩展.
- [Inverse Kinematics Extension](https://github.com/tonystr/Inverse-Kinematics-Extension-for-Gamemaker) - 用于处理反向运动学的库.
...
- [Top-Down Movement & Collision](https://pixelatedpope.itch.io/tdmc/devlog/156556/converting-tdmc-to-use-tiles) - 来自 pope 的强大的基于对象的碰撞系统.

## Sprites

- [AESnips](https://github.com/angelwire/AESnips) - 精灵播放系统.
- [phgen](https://github.com/squircledev/phgen) - 占位符资产生成.
- [Disarm](https://github.com/NuxiiGit/disarm) - 运行时的 spriter 骨骼动画.
- [Spritely](https://github.com/bscotch/spritely) - 2D 视频游戏精灵的图像校正和清理.
- [PixelUpscaler](https://github.com/JujuAdams/Pixel-Art-Upscaling) - 像素艺术升级着色器，用于 GameMaker 的笨拙分辨率.
- [ASESync](https://sahaun.itch.io/asesync) - 在 GameMaker 中自动同​​步 aesprite 文件.
- [conveyorbelt](https://github.com/imissmyfriends/conveyorbelt)  - 类似于 ASESync. 将 Aesprite 文件导出到 GameMaker 精灵.
...
- [FMODGMS](https://github.com/mstop4/FMODGMS) - 这并不支持 FMOD 必须提供的所有内容，并且项目本身已被搁置.
...
- [Phonix](https://github.com/Andre-404/Phonix/)  - 紧凑型音频系统. 非常适合动态音乐！
- [Vinyl](https://github.com/JujuAdams/Vinyl) - 实时更新音频系统.
- [LineAudio](https://github.com/WangleLine/LineAudio) - 音频助手功能.
- [Bard](https://github.com/gl326/bard-audio)  - 用于在 GameMaker 中设计和实现优质音频的引擎. 已更新以使用最新的 GameMaker 音频效果.

## Levels

- [LDtk to GMS](https://shynif.itch.io/ldtk-to-gms) - LDtk 进口商.
- [LDtkParser](https://github.com/evolutionleo/LDtkParser) - 高级 LDtk 导入器.
- [Room Data Inspector](https://github.com/heygleeson/GM-RoomInspector) - 收集房间数据并将其存储到 JSON 中供以后使用. 
- [Random Dungeon Generator](https://github.com/BlaXun/Random-Dungeon-Generator-GMS-2.3) - 结合用户定义的房间来创建地牢.
- [Random Level Generator](https://github.com/GameMakerDiscord/random-level-gen-gms2) - 使用 GameMaker 的随机关卡生成示例（类似于核王座）.
- [Wave Function Collapse](https://quadolorgames.itch.io/wfc-gml-demo) - 生成随机瓦片地图，但在其当前状态下尚未准备好生产.
- [Draw A Dungeon](https://gentoogames.itch.io/draw-a-dungeon-gamemaker) - 将您的房间布局转换为随机地牢.
- [Destructible Terrain](https://github.com/niksudan/gms2-destructible-terrain) - 在 GameMaker Studio 中使用表面和网格的可碰撞、可破坏地形示例.
...
- [Particles Wrapper](https://github.com/GamemakerCasts/particles) - 一个简单的粒子系统包装器，旨在使创建粒子变得有趣和容易.
- [Advanced Particles](https://limekys.itch.io/advanced-particle-system) - 带有它自己的增量计时方法的粒子实现.

## Lighting

- [Bulb](https://github.com/JujuAdams/Bulb) - 二维光照和阴影.
- [Lighting System 2D](https://github.com/borup3/Lighting-System-2D) - 根据回购要求 GameMaker 2.2+.
- [GameMaker Lighting Engine](https://github.com/bilouw/Gamemaker-Lighting-Engine) - 投射阴影的基于图块的照明引擎.
- [Lighting Systems](https://www.youtube.com/playlist?list=PLYVea5brHS8YHECGPoEp4_gWU-k6nWzUy) - GrizzliusMaximus 使用阴影投射实现非常快速的动态 2D 照明. ![YouTube](https://github.com/bytecauldron/awesome-gamemaker/raw/main/icons/youtube.png)

## Shaders

- [TransFX](https://short-bread.itch.io/transfx) - 过渡图书馆.
- [Post Processing Effects](https://foxyofjungle.itch.io/post-processing-fx) - 36 种高质量、可定制的效果.
- [BJRTFX](https://zikbakguru.itch.io/bjrtfx) - Zik 的 CRT 实用着色器.
- [bktGlitch](https://odditica.itch.io/bktglitch) - 毛刺着色器.
- [H O R R I - F I](https://gizmo199.itch.io/horri-fi) - VHS 着色器.
- [Cyberpunk Hologram Effect](https://gentoogames.itch.io/cyberpunk-hologram-effect) - 使用这个易于实施的资产创建和定制您自己的全息效果.
- [Depth Sorted Sillouettes](https://pixelatedpope.itch.io/depth-sorted-silhouette-example)  - 演示基于着色器的深度排序 sillouettes 的示例项目. 在 PC、Mac、HTML5 和 Android 上测试.
- [GMShaders.com](https://gmshaders.com/)  - 来自 Xor 的着色器教程. 最初托管在“xorshaders.com”.
- [1PassBlur](https://github.com/XorDev/1PassBlur/wiki) - 具有可调半径的模糊着色器.
- [Bokeh Blur](https://github.com/XorDev/Bokeh/wiki)  - 1PassBlur 的扩展，提供不同的外观. 类似于真实的镜头模糊. 尽管它比 1Pass 或 Dual-Kawase 慢得多.
- [Dual-Kawase](https://github.com/XorDev/Dual-Kawase/wiki) - 限制半径但非常有效的模糊着色器.
...
- [Jump Flooding](https://terohannula.itch.io/jump-flooding-algorithm) - 使用着色器制作的 GameMaker 跳跃泛洪算法.
...
- [Xpanda](https://github.com/GameMakerDiscord/Xpanda) - 在着色器中包含来自外部文件的代码.
- [Shadertoy to GameMaker](https://iarri.github.io/Shadertoy2GM/) - 转换 shadertoy.com GLSL 着色器以在 GameMaker 中运行.
...
- [BBMOD](https://github.com/blueburn-cz/BBMOD)  - 3D 渲染解决方案. 带有几个模块来导入 obj、3D 相机设置、与 ColMesh 的集成等.
...
- [Blender to GameMaker](https://github.com/blender-to-gmstudio) - 用于将 Blender 模型导出和导入 GameMaker 的脚本集合.
- [DmrVBM](https://github.com/Dreamer13sq/DmrVBM-blender-to-gms2) - 导入/导出工具以将顶点缓冲区数据从 Blender 加载到 GMS.
...
- [Snowy Snow](https://dragonite.itch.io/snowy-snow) - 3D雪着色器.
...
- [Beginners Guide to Sprite Stacking](https://medium.com/@avsnoopy/beginners-guide-to-sprite-stacking-in-gamemaker-studio-2-and-magica-voxel-part-1-f7a1394569c0)  - 来自 Avis 的精灵堆叠入门. 也可以从 dev_dwarf 查看第 2 部分.
...
- [EZ Networking](https://jasontomlee.itch.io/easy-gms-networking-platformer-build) - 具有聊天功能的主机/客户端实现.
- [Patchwire-GM](https://github.com/gm-core/patchwire-gm) - 如果您想在没有整个 gm-core 套件的情况下使用此实现，则来自 gm-core 的网络库.
- [GMHandshake](https://gist.github.com/nkrapivin/c73f5a962466a4ecb63187a009a300d8) - 演示网络握手的 Gist.
- [HTTP GML](https://github.com/Sidorakh/http.gml) - 以 GML 格式接收 GET 请求和上传文件.
- [GMNest](https://github.com/TimVN/GMNest) - 用于 HTML5 游戏的 Socket.IO 扩展.
...
- [NekoPresence](https://marketplace.yoyogames.com/assets/9526/nekopresence) - 糟糕，所有 Discord 集成.
- [Steamworks.gml](https://github.com/YAL-GameMaker/steamworks.gml) - 对 GameMaker: Studio 中 Steamworks SDK 支持的各种扩展.
- [Parworks](https://github.com/nkrapivin/Parworks) - YYG Steamworks 扩展的附加功能.
- [GOG.gml](https://github.com/GameMakerDiscord/GOG.gml) - GOG.com SDK 支持的本地扩展.
- [GMTwitch](https://github.com/GameMakerDiscord/GMTwitch) - 抽搐整合.
...
- [Camera System Guide](https://maddestudiosgames.com/gms2-meet-the-camera-system/) - 开始使用 GameMaker 中的相机.
- [Pixel Perfect Smooth Camera](https://github.com/YAL-GameMaker/pixel-perfect-smooth-camera) - 像素完美但流畅的相机示例.
- [Dynamic Splitscreen](https://maddestudios.itch.io/gms2-project-dynamic-splitscreen) - 本地多人分屏实现，当玩家靠近时合并相机.
...
- [Making Splash Screen Sequences](https://www.youtube.com/watch?v=hTh5UpFxx1E) - 混搭街机. ![YouTube](https://github.com/bytecauldron/awesome-gamemaker/raw/main/icons/youtube.png)

## State Machines

- [SnowState](https://github.com/sohomsahaun/SnowState) - 强大的有限状态机.
...
- [Aquila](https://dragonite.itch.io/aquila) - A* 寻路实现.
- [A-Star-Pathing](https://github.com/helloalbertdang/A-Star-Pathing) - 另一个 A* 寻路实现.
- [Grid-based Pathfinding Scripts](https://proton-squid.itch.io/pathfinding) - 具有 3 种不同算法的灵活寻路系统.

## Useful Extras

- [Animated Flag](https://github.com/Grisgram/gml-animated-flag) - 顶点动画标志.
- [Video Player Extension](https://forum.yoyogames.com/index.php?threads/video-player-for-windows-macos-and-ubuntu.77882/)  - 播放视频. 但是，最新版本的 GMS 支持视频.
- [GMESCAPI](https://marketplace.yoyogames.com/assets/9529/gmescapi) - 网络摄像头捕获.
- [Smile](https://github.com/zbanack/smile) - 情绪分析.
- [Danmaku Project](https://github.com/OmegaX1000/DanmakuProject) - 子弹地狱引擎.
- [OrbinautFramework](https://github.com/TrianglyRU/OrbinautFramework) - 制作经典索尼克游戏的准确框架.
- [Dynamic Turn System](https://gentoogames.itch.io/turn-based-combat-system-for-gamemaker) - 非常适合用作构建回合制战斗/游戏的基础.
- [Isometric Tactical RPG Framework](https://gentoogames.itch.io/isometric-tactical-rpg-framework)  - 提供入门资产来创建等距棋盘游戏. 包括动态转向系统.
- [Mouse Trail Effect](https://all-x.itch.io/gms2-mouse-trail-effect) - 展示如何使用图元追踪一条线以创建彩色轨迹.
- [Starfield Generator](https://github.com/PixelProphecy/gml_starfield_generator) - 一个用 GameMaker 的 GML 语言生成星空的脚本.
- [CleanShapes](https://github.com/JujuAdams/Clean-Shapes) - 用于 GameMaker 的抗锯齿图元库.
- [GMLScripts.com](https://www.gmlscripts.com/script/index) - 数十个帮助脚本，组织方式与官方文档类似.
- [GM48 Resources](https://gm48.net/resources) - 来自社区的免费资源，以在 GameMaker Studio、游戏开发和游戏开发中变得更好.
- [GameMakerHow](https://gamemakerhow.com/) - 另一个很棒的站点，它充当 GameMaker Q&amp;A 存储库，用于处理您可能会在 GameMaker 中提出的各种问题.
...
- [Gruvbox Theme](https://github.com/heygleeson/Gruvbox-GMTheme) - IDE 的复古风格主题.
- [2.3 Syntax in Detail](https://yal.cc/gamemaker-2-3-syntax-in-details/) - 来自 Yal 的 GML 语法特征/变化的完整指南.
- [GameMaker Garbage Collection](https://gist.github.com/DatZach/96a30d6ae4225f8ec152719e57aed26b) - 垃圾回收在 GML 中是如何工作的.
- [GitHub Yacc to GML Fix](https://www.reddit.com/r/gamemaker/comments/n5m35l/a_simple_fix_for_github_incorrectly_detecting/) - 告诉 GitHub 你的 repo 都是 GML，而不是 Yacc.
- [GameMaker Repo Badges](https://github.com/matthiaszarzecki/MadeWithGameMakerStudioBadges) - 添加到您的 README 文件中的精美徽章.
- [GameMaker Discord Community GitHub](https://github.com/GameMakerDiscord)  - 您是否制作了想要分享的游戏制作工具？ 考虑将其提交到官方 Discord 的 GitHub.
...
- [Game Resolution & Aspect Ratio Management](https://www.youtube.com/watch?v=_g1LQ6aIJFk&list=PLXkVsacazW2qvdnKNzgBLkUwlgi3FU-VO) - 像素教皇. ![YouTube](https://github.com/bytecauldron/awesome-gamemaker/raw/main/icons/youtube.png)
...
- [vim-GML](https://github.com/JafarDakhan/vim-gml) - 用于 GameMaker 的高品质 Vim 语法突出显示.
- [List of GameMaker Games](https://steamdb.info/tech/Engine/GameMaker/) - 使用 GameMaker 发布的 Steam 游戏列表.
- [Rousr Release](https://gitlab.com/rousr-release/) - Rousr 团队未维护的项目（以防有人问 OutsideTheBox/Dissonance 去了哪里）.

## Blogs

- [RefresherTowel](https://refreshertowelgames.wordpress.com/category/tutorial/) - 包含关于关卡生成的几篇文章.
- [Tony Str](https://tonystr.net/articles) - 关于使用 json、正则表达式和在 gml 中绘制圆圈的一些很棒的文章.
- [Katsaii](https://www.katsaii.com/content/blog/posts.html) - 一些关于更高级的 gml 主题的文章.

## YouTube

- [Jordan Guillou](https://www.youtube.com/channel/UCBmOLRTaPrfOxnTqpCLrwdQ) - 业余爱好者独立开发者，提供一些与 GameMaker 相关的教程.
- [DragoniteSpam](https://www.youtube.com/c/DragoniteSpam) - 涵盖 GameMaker 的高度技术元素，重点是 3D.
- [Shaun Spalding](https://www.youtube.com/c/ShaunSpalding)  - YoYo Games 的前社区经理. 拥有各种适合初学者的 GameMaker 教程和有关新 GameMaker 功能的有用更新.
- [FriendlyCosmonaut](https://www.youtube.com/c/FriendlyCosmonaut) - 关于在 GameMaker 中构建农场 RPG 以及其他几个教程的精彩播放列表.
- [PixelatedPope](https://www.youtube.com/c/PixelatedPope) - 有关 GameMaker 分辨率管理、相机、GUI 等的指南.
- [Xor](https://www.youtube.com/c/XorDev) - 以 3D 为重点的大量着色器演示.
- [GamingEngineer](https://www.youtube.com/c/GamingEngineer)  - 在社区工作多年的 GameMaker 开发者. 他们有各种各样的视频展示 GameMaker 的功能，重点是 3D.
- [TheSnidr](https://www.youtube.com/c/TheSnidr) - 许多很棒的 3D 展示和 GameMaker 教程.
- [Peyton Burnham](https://www.youtube.com/channel/UCfh2Q3TsvlxM1S2GvXQ4eeQ) - 用于自上而下射击游戏和角色扮演游戏的 GameMaker 教程.
- [Gaming Reverends](https://www.youtube.com/channel/UC7fkptPD1FHQyDc9Fnm9S_A) - 如果您想学习有关 GameMaker 着色器的基础材料，“业余程序员着色器”播放列表绝对值得一试.
- [Let's Learn This Together](https://www.youtube.com/c/LetsLearnThisTogether) - 专注于提供 GameMaker 指南的小型独立开发公司.
- [Matharoo](https://www.youtube.com/c/GameMakerStationMatharoo) - 大量免费的 GameMaker 教程和有关 GameMaker 的新闻.
- [GravityShift Games](https://www.youtube.com/c/SlasherXGAMES/) - 几个特定类型的 GameMaker 教程，将数据库集成到 GameMaker 中，等等.
- [Slyddar](https://www.youtube.com/c/Slyddar/) - 专用于 DnD 和 GML 教程的频道.
...
- 这是基于来自的列表 [GameMaker Libraries](https://github.com/FaultyFunctions/GameMakerLibraries) 以及来自 Gleb Tsereteli 的附加链接/详细信息.
 - 由于 GML 语法更改，大多数链接资源仅适用于 `GameMaker 2.3+`. 但是，如果您在 GameMaker 1.4 中工作，如果有人对他们的项目进行反向移植，大多数库创建者都会很感激.  ☺
...
有很棒的东西要分享吗？ 查看 [Contributing Guidelines](https://github.com/bytecauldron/awesome-gamemaker/blob/main/CONTRIBUTING.md).
