...
- [Web.dev](https://web.dev/) -借助来自web.dev的有用指导和分析，在自己的网站和应用程序上获得网络的现代化功能.
- [Confess](https://github.com/jamesgpearce/confess) -使用PhantomJS无头分析网页并生成清单.
- [DebugBear](https://www.debugbear.com/)  -DebugBear是基于Lighthouse的站点监视工具.  查看您的分数和指标如何随时间变化，重点是了解导致每次变化的原因.  DebugBear是具有30天免费试用版的付费产品.
...
- [Speedrank](https://speedrank.app/)  -Speedrank在后台监视您网站的性能.  它随时间显示Lighthouse报告，并提供改进建议.  Speedrank是14天试用版的付费产品.
...
- [Bundlephobia](https://bundlephobia.com/) -帮助您发现将npm软件包添加到前端捆绑包对性能的影响.
...
- [Compression webpack plugin](https://github.com/webpack-contrib/compression-webpack-plugin) -准备资产的压缩版本以通过Content-Encoding服务.
...
- [jsDelivr](https://github.com/jsdelivr/jsdelivr) -与Google Hosted Libraries类似，jsDelivr是一个开放源CDN，开发人员可以使用它托管自己的项目，任何人都可以在其站点上链接到我们托管的文件.
...
- [Cdnex](https://github.com/jsonmaur/cdnex) -为资产网址添加自定义CDN网址.
...
- [Gm](https://github.com/aheckmann/gm) -用于Node.js的GraphicsMagick和ImageMagick.
...
- [RequireJS](http://requirejs.org/)  -RequireJS是JavaScript文件和模块加载器.  它针对浏览器内使用进行了优化，但可以在其他JavaScript环境（例如Rhino和Node.js）中使用.
...
- [Showslow](http://www.showslow.com/)  -开源工具，可帮助长期监控各种站点性能指标.  它捕获YSlow，Page Speed Insights，WebPageTest和dynaTrace Ajax Edition的结果.
...
- [WebPageTest](http://www.webpagetest.org/)  -使用真实的浏览器（IE和Chrome）并以真实的消费者连接速度在全球多个位置运行免费的站点速度测试.  您可以运行简单的测试或执行高级测试，包括多步骤事务，视频捕获，内容阻止等等.  您的结果将提供丰富的诊断信息，包括资源加载瀑布图，Page Speed优化检查和改进建议.
...
- [HTMLCompressor](https://code.google.com/p/htmlcompressor/)  -HtmlCompressor是一个小型，快速且易于使用的Java库，它通过删除多余的空格，注释和其他不需要的字符，而不会破坏内容结构，从而最小化了给定的HTML或XML源.  结果，页面尺寸变小，加载速度更快.  还提供了命令行版本的压缩机.
- [Django-htmlmin](https://github.com/cobrateam/django-htmlmin)  -用于Linux的HTML压缩程序中的django-html，完全支持HTML5.它支持Django，Flask和任何其他Python网络框架.  它还提供了可用于静态站点或部署脚本的命令行工具.
...
- [Minimize](https://github.com/Swaagie/minimize)  -Minimize是基于node-htmlparser的HTML缩小器，当前，HTML缩小器仅在服务器端可用.  客户端缩小将在以后的版本中添加.
...
- [uCSS](https://github.com/oyvindeh/ucss) -uCSS用于搜寻（大）站点以查找未使用的CSS选择器，但不删除未使用的CSS.
