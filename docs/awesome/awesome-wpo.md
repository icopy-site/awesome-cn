...
- [Designing for Performance: Weighing Aesthetics and Speed](http://designingforperformance.com/) -拉拉·卡伦德·霍根
...
- [Lean sites](https://www.sitepoint.com/premium/books/lean-websites) -芭芭拉·伯姆斯
...
- [Google Developers Case Studies](https://developers.google.com/web/showcase) -了解其他开发人员为何以及如何使用网络为他们的用户创造惊人的Web体验.
...
- [PageSpeed Insights Rules](https://developers.google.com/speed/docs/insights/rules) -PageSpeed团队创建的指南.
  不推荐使用. 该版本已弃用，将于2019年5月关闭.第5版是最新版本，既提供了Chrome用户体验报告中的真实数据，又提供了Lighthouse中的实验室数据.
...
- [Velocity](http://conferences.oreilly.com/velocity) –在Velocity，Web运营，性能和DevOps专业人员学习如何构建快速，灵活且高度可用的站点和应用程序.
- [performance.now()](https://perfnow.nl/)  – Performance.now（）会议将返回阿姆斯特丹！ 我们是一个单场会议，有14位世界一流的演讲者，涵盖了当今最重要的Web性能见解.
...
- [Web.dev](https://web.dev/) -借助来自web.dev的有用指导和分析，在您自己的网站和应用上获取网络的现代化功能.
...
- [YSlow](https://github.com/marcelduran/yslow) -YSlow分析网页，并根据一套高性能网页的规则，提出改善网页性能的方法.
...
- [Web Tracing Framework](https://github.com/google/tracing-framework) -Web跟踪框架是一组用于跟踪和研究复杂Web应用程序的库，工具和可视化工具
...
- [PSI](https://github.com/addyosmani/psi) -Node.js的PageSpeed Insights-带有报告.
...
- [Timing.js](https://github.com/addyosmani/timing.js)  -Timing.js是一小组帮助程序，可与Navigation Timing API一起使用，以识别您的应用程序在哪里花费时间. 可用作独立脚本，DevTools代码段或小书签.
...
- [Yahoo YSlow for Mobile/Bookmarklet](https://developer.yahoo.com/yslow/) -YSlow分析网页，并根据一套高性能网页的规则，提出改善网页性能的方法.
...
- [Cloudflare CDN](https://www.cloudflare.com/cdn/) -内容交付网络，使用下一代技术交付快速，可靠的CDN服务
- [PageCDN](https://pagecdn.com/lib)  -最先进的开源CDN，使用brotli-11压缩，HTTP / 2服务器推送，更好的HTTP / 2复用等功能，可以进行积极的内容优化. 已经支持100多个库和2000多个WordPress主题. 易于使用，易于链接且非常快速.
- [jsDelivr](https://github.com/jsdelivr/jsdelivr) -类似于Google托管库，jsDelivr是一个开放源CDN，开发人员可以使用它托管自己的项目，任何人都可以在其站点上链接到我们托管的文件.
- [Google Hosted Libraries](https://developers.google.com/speed/libraries/) -Google托管库是内容分发网络，用于最受欢迎的开源JavaScript库.
- [CDNjs](https://cdnjs.com/) -由CloudFlare赞助的用于JavaScript和CSS的开源CDN，托管从jQuery和Modernizr到Bootstrap的所有内容.
- [jQuery](http://code.jquery.com/) -jQuery CDN –最新稳定版本，由MaxCDN提供支持.
...
&gt;要找到有用的详细信息，以便您在付费CDN之间做出正确选择，请访问 [CDNPlanet](http://www.cdnplanet.com/).
...
- [Exexif](https://github.com/h4cc/awesome-elixir) -纯e剂库，可从JPEG文件中提取tiff和exif元数据.
...
- [lozad.js](https://github.com/ApoorvSaxena/lozad.js) -纯JS中的高性能，轻量级〜0.9kb且可配置的延迟加载程序，无需依赖于响应图像，iframe等
...
- [Labjs](http://labjs.com/)  -是Getify Solutions支持的开源（MIT许可证）项目.  LABjs的核心目的是成为一个通用的按需JavaScript加载器，能够随时随地将任何JavaScript资源从任何位置加载到任何页面.
...
- [Showslow](http://www.showslow.com/)  -开源工具，可帮助长期监控各种网站性能指标. 它捕获YSlow，Page Speed Insights，WebPageTest和dynaTrace Ajax Edition的结果.
...
- [New Relic Browser Monitoring](http://newrelic.com/browser-monitoring) -实时监控浏览器端应用程序，重点关注最终用户的真实体验.
- [DareBoost](https://www.dareboost.com/)  -真正的浏览器监控. 使用YSlow，Page Speed和众多自定义提示提供有关Web性能和质量的完整报告.
- [Bytes Matter Real User Monitoring](https://www.bytesmatter.io)  -全功能的真实用户监控解决方案. 小型网站的免费套餐. 包括对Google核心网络生命周期的监控.
...
- [HTMLCompressor](https://code.google.com/archive/p/htmlcompressor/)  -HtmlCompressor是一个小型，快速且易于使用的Java库，它通过删除多余的空格，注释和其他不需要的字符，而不会破坏内容结构，从而将给定的HTML或XML源最小化. 结果，页面尺寸变小，加载速度更快. 还提供了命令行版本的压缩机.
- [Django-htmlmin](https://github.com/cobrateam/django-htmlmin)  -django-html，适用于Python的HTML压缩程序，完全支持HTML5.它支持Django，Flask和任何其他Python网络框架. 它还提供了可用于静态站点或部署脚本的命令行工具.
- [HTMLMinifier](https://github.com/kangax/html-minifier) -HTMLMinifier是一种高度可配置的，经过测试的，基于Javascript的HTML缩小器，具有类似lint的功能.
- [Grunt-contrib-htmlmin](https://github.com/gruntjs/grunt-contrib-htmlmin) -一个咕gr的插件，用于使用HTMLMinifier缩小HTML.
...
- [Html-minifier](https://github.com/deanhume/html-minifier) -一个简单的Windows命令行工具，可最小化HTML，Razor视图和Web窗体视图
...
- [Clean-css](https://github.com/jakubpawlowicz/clean-css) -适用于node.js的快速，高效且经过良好测试的CSS缩小器.
...
- [uCSS](https://github.com/oyvindeh/ucss) -uCSS用于搜寻（大）站点以查找未使用的CSS选择器，但不能删除未使用的CSS.
...
- [Lazysizes](https://github.com/aFarkas/lazysizes) -用于图像（响应和正常），iframe和脚本的高性能惰性加载器，无需配置即可检测到由用户交互，CSS或JavaScript触发的可见性更改.
...
- [AtBuild](https://github.com/jarred-sumner/atbuild)  -JavaScript代码生成工具，可让您编写输出JavaScript的JavaScript. 非常适合展开循环和编写可编译运行时的库
...
- [Grunt-svg-sprite](https://www.npmjs.com/package/grunt-svg-sprite) -SVG精灵和丰富的堆栈-Grunt插件环绕svg-sprite，可读取一堆SVG文件，对其进行优化并创建各种口味的SVG精灵和CSS资源.
...
- [ZeroSprites](http://zerosprites.com/) -ZeroSprites是CSS精灵生成器，旨在使用VLSI布局规划领域中使用的算法来最小化面积.
- [CSS Sprite Generator](http://css.spritegen.com/) -CSS精灵可让您将多个图像合并到一个文件中.
...
- [HTTPerf](https://github.com/httperf/httperf)  -httperf是用于衡量Web服务器性能的工具. 它提供了一种灵活的工具来生成各种HTTP工作负载并评估服务器性能.
...
- [CSS will-change](https://drafts.csswg.org/css-will-change/)  -此规范定义了“ will-change” CSS属性，该属性允许作者提前声明将来可能会更改的属性，因此UA可以在需要它们之前的某个时间进行适当的优化. 这样，当实际更改发生时，页面会迅速更新.
- [Resource Hints](http://www.w3.org/TR/resource-hints/)  -该规范定义了HTML链接元素（&lt;link&gt;）的dns-prefetch，preconnect，prefetch和prerender关系. 这些原语使开发人员和服务器能够生成或交付资源，从而帮助用户代理确定其应连接到哪个源，应获取和预处理哪些资源以提高页面性能的决策过程.

## Stats

- [HTTP Archive](http://httparchive.org/index.php)  -这是Web性能信息的永久性存储库，例如页面大小，失败的请求和使用的技术. 这些性能信息使我们能够了解Web的构建趋势，并提供用于进行Web性能研究的通用数据集.
