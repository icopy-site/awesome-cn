...
- [Arbore](http://arbo.re) -建立在IPFS之上的朋友间文件共享应用程序.
...
- [brig](https://brig.readthedocs.io/en/latest) -使用git之类的界面和FUSE文件系统进行文件同步. [Source](https://github.com/sahib/brig)
- [Cohort](https://github.com/zignig/cohort) -一个golang应用程序，用于预设threejs界面，并将其所有资产移出IPFS.
...
- [Discussify](https://github.com/ipfs-shipyard/discussify-browser-extension) -Discussify提供了一个实时的，对等的，永久性的讨论平台，任何人都可以加入和参与.
...
- [Peer Web Site](https://peerweb.site/)  -点对点托管的点对点网站！ 从您的浏览器发送功能齐全的HTML（包括CSS，JS）网站，并附加文件，例如. 视频，图像等 [Source](https://github.com/Weedshaker/PeerWebSite)
...
- [Temporal](https://github.com/RTradeLtd/Temporal) -Temporal是易于使用的API和平台，可将IPFS和其他分布式/分散式存储技术集成到企业应用程序中
...
- [xfce-screenshooter-ipfs-support](https://github.com/amar-laksh/xfce-screenshooter-ipfs-support) -带有IPFS支持的xfce-screenshooter的分支！
...
- [7-piece Syzygy tablebases](https://syzygy-tables.info/) -最多7件的所有国际象棋残局的解决方案. [Source](https://github.com/syzygy1/tb)
...
- [ipfs-chrome-extension](https://github.com/dylanPowers/ipfs-chrome-extension) -Chrome扩展程序可将ipfs.io流量重定向到本地网关
- [ipfs-chrome-station](https://github.com/fbaiodias/ipfs-chrome-station) -Chrome扩展程序可将ipfs.io流量重定向到本地网关
...
- [Distributed Apps with IPFS - Juan Benet at Fullstack Fest 2016](https://www.youtube.com/watch?v=jONZtXMu03w)  -本演讲将探讨如何使用CRDT，发布/订阅和漂亮的UI在IPFS之上构建动态应用程序. 它还研究了用于分布式计算的新模型，以及分布网络的伦理重要性.
- [IPFS Alpha - Why we must redistribute the web](https://www.youtube.com/watch?v=skMTdSEaCtA) 
- [IPFS Simply Explained](https://www.youtube.com/watch?v=5Uj6uR3fp-U) -让我们看一下IPFS的工作原理，如何解决诸如审查制度之类的问题，以及它是否真的可以在多个星球上运作！
- [Juan Benet at Stanford 2015](https://www.youtube.com/watch?v=HUVmypx9HGI) -演讲包括对IPFS项目的广泛了解，以及有关通过开源协议R＆D演进网络堆栈的讨论.
- [Textile Build Series - A Free Online Workshop](https://www.youtube.com/playlist?list=PLC8CEtJ9shDznO1tpvGe--BVEWmCKY9_Z)  -一项完整的培训计划，旨在教给开发人员如何构建去中心化Web. 该系列涵盖了大量内容，涉及IPFS堆栈的多个部分，并指导开发人员构建一个简单的DApp.
