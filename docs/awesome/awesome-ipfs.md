...
&gt;有用的资源 [IPFS](https://ipfs.io) 并在其之上构建事物
 ...
 _此列表适用于项目，工具或几乎所有与IPFS相关的事物，它们都很棒**.  这是针对已经非常出色的产品的-如果您计划使用IPFS做一些有趣的事情，则应该构建它，然后在此处链接它.  如果您有一个与IPFS有关的很棒的主意，可以在这里查询它的好地方 [our IPFS Discuss Forums](https://discuss.ipfs.io)._
...
- [edChain](https://www.edchain.io/)  -EdChain是一个用于教育和职业的全球网络.  它使用区块链和分布式网络技术来提供教育内容，甚至可以提供给没有宽带互联网的用户. [Source](https://github.com/edchainio/edchain-client-gui)
- [enzypt.io](https://enzypt.io/) -通过以太坊和IPFS买卖文件的网站. [Source](https://github.com/flex-dapps/enzypt)
- [Ethlance](http://ethlance.com) -第一个基于以太坊和IPFS构建的完全去中心化的就业市场平台. [Source](https://github.com/madvas/ethlance)
...
- [7-piece Syzygy tablebases](https://syzygy-tables.info/) -最多7个棋类残局的解决方案. [Source](https://github.com/syzygy1/tb)
...
- [Textile Build Series - A Free Online Workshop](https://www.youtube.com/playlist?list=PLC8CEtJ9shDznO1tpvGe--BVEWmCKY9_Z)  -一项完整的培训计划，旨在教给开发人员如何构建去中心化Web.  该系列涵盖大量内容，涉及IPFS堆栈的多个部分，并指导开发人员构建简单的DApp.
