...
&gt;有用的资源 [IPFS](https://ipfs.io) 并在其之上构建事物
 ...
 _此列表适用于项目，工具或几乎所有与IPFS相关的事物，它们都很棒**.  这是针对已经非常出色的产品的-如果您计划使用IPFS做一些有趣的事情，则应该构建它，然后在此处链接它.  如果您有一个与IPFS有关的很棒的主意，可以在这里查询它的好地方 [ipfs/apps](https://github.com/ipfs/apps) 要么 [ipfs/notes](https://github.com/ipfs/notes)._
...
- [Alexandria](http://www.alexandria.io/learn/#integrated-technologies) -分散式内容发布/营利平台.
...
- [IPFS Drive](http://ipfs-drive.ydns.eu) -在用于IPFS的浏览器文件管理器中. [Source](https://github.com/fazo96/ipfs-drive)
...
- [uport](https://uport.me/#home) -Uport是一个基于以太坊区块链的移动式，自我主权身份和密钥管理系统.
