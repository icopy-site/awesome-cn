...
* [@antirez](https://github.com/antirez), [Redis](https://github.com/antirez/redis)
  *“开源维护者的奋斗”（[post](http://antirez.com/news/129))
...
* [@bbatsov](https://github.com/bbatsov), [Rubocop](https://github.com/rubocop-hq/rubocop)
  * 《专访 Bozhidar Batsov：造物主对 RuboCop 和 Ruby 风格指南的看法》（[post](https://blog.sideci.com/interview-with-bozhidar-batsov-99b049b6fd6a))
* [@boneskull](https://github.com/boneskull), [Mocha](https://github.com/mochajs/mocha)
  *“维持一个受欢迎的项目和管理倦怠”（[interview](https://changelog.com/rfc/15))
* [@brettcannon](https://github.com/brettcannon), [Python](https://github.com/python)
  *“开源的取舍”([video](https://www.youtube.com/watch?v=y19s6vPpGXA))
...
* [@brianc](https://github.com/brianc), [node-postgres](https://github.com/brianc/node-postgres)
  *“单独创建和维护 node-postgres”([interview](https://sourcesort.com/interview/brian-carlson-on-creating-and-maintaing-node-pg-solo))
* [@BurntSushi](https://github.com/BurntSushi), [Rust libraries](https://github.com/BurntSushi?tab=repositories)
  *“我的 FOSS 故事”（[post](https://blog.burntsushi.net/foss/))
...
* [@colcarroll](https://github.com/ColCarroll), [PyMC3](https://github.com/pymc-devs/pymc3)
  *“开源两年”（[slides/post](https://colcarroll.github.io/open_source_pa/))
* [@ctb](https://github.com/ctb) & [@mr-c](https://github.com/mr-c), [khmer](https://github.com/dib-lab/khmer)
  *“引导社区对科学软件的贡献：冲刺体验”（[paper](https://doi.org/10.5334/jors.96))
  *“言出必行：在小型生物学实验室中采用和调整可持续的科学软件开发流程”（[paper](http://dx.doi.org/10.5334/jors.35))
* [@danielbachhuber](https://github.com/danielbachhuber), [wp-cli](https://github.com/wp-cli/wp-cli)
  *“实验和开源经济学”（[interview](https://changelog.com/rfc/17))
...
* [@fat](https://github.com/fat), [Bootstrap](https://github.com/twbs/bootstrap/)
   *“什么是开源，为什么我感到如此内疚？”  ([video](https://www.youtube.com/watch?v=UIDb6VBO9os), [slides](http://fat.github.io/slides-os-guilt/))
...
* [@feross](http://github.com/feross), [WebTorrent](https://github.com/webtorrent/webtorrent)
  ...
  * “我从 WebTorrent 中学到的东西：从启动和运行 P2P 开源项目中学到的经验教训”（[slides](https://speakerdeck.com/feross/what-i-learned-from-webtorrent))
...
* [@hzoo](https://github.com/hzoo), [Babel](https://github.com/babel/babel)
  *“（开放）焦虑源”（[post](https://increment.com/open-source/open-source-of-anxiety/))
...
* [@indexzero](https://github.com/indexzero), [winston](https://github.com/winston)
  *“让重要代码保持活力”([slides](https://speakerdeck.com/indexzero/keeping-important-code-alive-seattlejs-march-2015))
  *“为 node@4 现代化 winston”([video](https://www.youtube.com/watch?v=uPw7QIx3JZM), [slides](https://speakerdeck.com/indexzero/modernizing-winston-for-node-at-4))
* [@jacobian](https://github.com/jacobian), [Django](https://github.com/django/django)
   *“你不明白‘……终生’的哪一部分？”  ([video](https://www.youtube.com/watch?v=EqcuzSwySR4))
...
* [@jeresig](https://github.com/jeresig), [jQuery](https://github.com/jquery/jquery)
  *“离开你的开源项目：John Resig”（[interview](https://www.youtube.com/watch?v=K9HGec2RA-Q))
...
* [@jodosha](https://github.com/jodosha), [Hanami](https://github.com/hanami)
  *“建造 Hanami 时的经验教训”（[video](https://www.youtube.com/watch?v=0RyitUKfUFE), [slides](https://speakerdeck.com/jodosha/lessons-learned-while-building-hanami))
...
* [@Krzysztof-Cieslak](https://github.com/Krzysztof-Cieslak), [Ionide](https://github.com/ionide)
  *“OSS 和社区：故事”（[post](http://kcieslak.io/OSS-The-Story))
...
* [@mpdehaan](https://github.com/mpdehaan), [Ansible](https://github.com/ansible/ansible), [SourceOptics](https://bitbucket.org/laserllama/sourceoptics/src/master/)
  * “Michael DeHaan 谈创建 Ansible 和 SourceOptics”（[interview](https://www.sourcesort.com/interview/michael-dehaan-on-creating-ansible-and-sourceoptics))
* [@mxcl](https://github.com/mxcl), [Homebrew](https://github.com/Homebrew)
  *“制作自制软件：全球开源项目的起源和发展”（[video](https://www.youtube.com/watch?v=Q81q0LilL1s))
...
* [@pgbovine](https://github.com/pgbovine), [Python Tutor](https://github.com/pgbovine/OnlinePythonTutor)
  ...
  * 《十年近千万用户：我作为学术界开源软件独行维护者的经历》（[post](http://pgbovine.net/python-tutor-ten-years.htm))
...
* [@sebmck](https://github.com/sebmck), [Babel](https://github.com/babel/babel)
  * &quot;~2015 回顾&quot; ([post](https://medium.com/@sebmck/2015-in-review-51ac7035e272))
...
* [@sindresorhus](https://github.com/sindresorhus), [AVA](https://github.com/avajs/ava), [awesome](https://github.com/sindresorhus/awesome)
  *“在线之间：对开源开发人员 Sindre Sorhus 的采访”（[interview](https://medium.freecodecamp.org/sindre-sorhus-8426c0ed785d))
...
* [@stuarthalloway](https://github.com/stuarthalloway), [Clojure](https://github.com/clojure/clojure)
  *“切实可行的管理”（[video](https://www.youtube.com/watch?v=_sEOXNmzv4g))
...
* [@Trott](https://github.com/Trott), [slug](https://github.com/Trott/slug)
  *“在开源中一决高下”([audio](https://soundcloud.com/rich-trott/slugging-it-out-in-open-source), [transcript](https://medium.com/@Trott/slugging-it-out-in-open-source-a62f554b6e2))
* [@vjeux](https://github.com/vjeux), [React Native](https://github.com/facebook/react-native), [Prettier](https://github.com/prettier/prettier)
  *“在开源领域取得成功”([video](https://www.youtube.com/watch?v=nRF0OVQL9Nw))
...
欢迎提出其他建议！ 查看 [https://github.com/nayafia/awesome-maintainers/blob/master/CONTRIBUTING.md](https://github.com/nayafia/awesome-maintainers/blob/master/CONTRIBUTING.md) 指南.

（注意：如果您是此处列出的维护者，但想被删除，只需打开一个问题或私下给我发电子邮件.）

## License and attribution
此列表可根据 Creative Commons CC0 1.0 许可证获得，这意味着您可以出于任何商业或非商业目的自由使用它，而无需归属于我（公共领域）.  （如果您想引用我，请在这里找到我！ [@nayafia](http://twitter.com/nayafia) 但您绝对不需要这样做.）
