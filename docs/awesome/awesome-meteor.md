...
- [simple-schema](https://github.com/aldeed/simple-schema-js) -一个JavaScript模式验证包，支持对MongoDB更新修饰符对象的直接验证.
- [aldeed:collection2](https://github.com/aldeed/meteor-collection2/) -自动验证客户端和服务器上的插入和更新操作.
- [dburles:collection-helpers](https://github.com/dburles/meteor-collection-helpers/) –使用您定义的助手来转换您的收藏集.
- [matb33:collection-hooks](https://github.com/Meteor-Community-Packages/meteor-collection-hooks) -使用插入/更新/删除/查找/ findOne之前/之后的钩子扩展Mongo.Collection.
- [reywood:publish-composite](https://github.com/Meteor-Community-Packages/meteor-publish-composite) -使用反应式联接发布来自各个馆藏的一组相关文档.
...
- [aldeed:autoform](https://github.com/aldeed/meteor-autoform) -UI组件和帮助程序，可通过自动插入和更新事件以及自动反应式验证轻松创建基本表单.
- [ostrio:templatehelpers](https://github.com/VeliovGroup/Meteor-Template-helpers) -Blaze模板的实用程序帮助器.
...
- [Meteor Candy](https://www.meteorcandy.com/) -将管理面板添加到您的应用程序的最快，更简便的方法.
...
- [kschingiz:meteor-elastic-apm](https://github.com/kschingiz/meteor-elastic-apm) -基于弹性APM的流星性能监控
- [monti-apm-agent](https://github.com/monti-apm/monti-apm-agent) -流星性能监控
- [lmachens:kadira](https://github.com/lmachens/kadira) -流星性能监控

## Performance

_加速Meteor应用程序的工具_

- [cultofcoders:redis-oplog](https://github.com/cult-of-coders/redis-oplog) -Redis Oplog实现完全替代Meteor中的MongoDB Oplog
- [staringatlights:fast-render](https://github.com/abecks/meteor-fast-render) -主动渲染的前叉
...
- [artillery-engine-meteor](https://github.com/kschingiz/artillery-engine-meteor) -MeteorJS应用程序的火炮负载测试.

## Deployment

_用于部署和维护Meteor应用的工具_
...
- [antwaremx:meteorman](https://github.com/antwaremx/meteorman) -Meteorman：具有GUI的DDP客户端，用于测试Meteor方法和发布（例如Postman）.

## SEO

_搜索引擎优化工具_

- [ostrio:spiderable-middleware](https://github.com/VeliovGroup/spiderable-middleware/) -支持ES6（ECMAScript2015）的预渲染（_a.ka Spiderable_）-搜索引擎完美抓取了Meteor应用.
...
- [@reactioncommerce/file-collections](https://github.com/reactioncommerce/reaction-file-collections) -Reaction FileCollections是一组NPM软件包，它们提供支持在Node和Meteor应用程序以及浏览器JavaScript中进行文件上载，存储和下载的功能.
- [netanelgilad:excel](https://github.com/netanelgilad/meteor-excel) -解析并生成excel文件（xlsx，xls）.
- [mikkelking:slingshot](https://github.com/Back2bikes/meteor-slingshot) -将文件直接上传到AWS S3，Google Cloud Storage和流星中的其他文件.
...
- [meteor-publish-join](https://github.com/nlhuykhang/meteor-publish-join#readme) -高性能NPM软件包，用于发布非反应性值或汇总值.
...
- [okland:accounts-phone](https://github.com/okland/accounts-phone) -基于手机号码的流星登录服务.
- [okland:camera-ui](https://github.com/okland/camera-ui)  -流星包，用于通过用户界面拍照，在台式机和移动设备上进行一次功能调用. 允许在相机和手机上的照相馆之间进行选择.
- [percolatestudio/cordova-plugin-safe-reload](https://github.com/percolatestudio/cordova-plugin-safe-reload) -Cordova插件可在流星热代码推送失败后观看并恢复.
...
- [luixal:meteor-apexcharts](https://github.com/luixal/meteor-apexcharts) -为Meteor打包的反应性ApexCharts库.
...
- [meteor-devtools-evolved](https://github.com/leonardoventurini/meteor-devtools-evolved) -镀铬扩展名.
...
- [meteor-api](https://atom.io/packages/meteor-api) -Atom的流星插件.
...
- [ESLint-plugin-Meteor](https://github.com/dferber90/eslint-plugin-meteor/) -流星的ESLint插件.
...
- [Rocket.Chat](https://rocket.chat/) -使用Meteor构建的实时聊天应用程序.
- [Wekan](https://github.com/wekan/wekan) -开源的Trello式看板.
- [Unchained Shop](https://github.com/unchainedshop/unchained) -与Meteor开发的开源商务平台.
- [VulcanJS](https://github.com/VulcanJS/Vulcan) -使用React，GraphQL和Meteor快速构建应用程序的工具包.
- [Crowducate Platform](https://github.com/Crowducate/crowducate-platform) -由Meteor提供支持的开源教育平台.
...
- #### Free
  ...
  _这些免费课程大部分是由 [Scott Tolinski](https://github.com/stolinski)，请确保在签出他的一些付费物品 [leveluptutorials](https://www.leveluptutorials.com/)_
...
- [Meteor Learning](https://github.com/ericdouglas/Meteor-Learning) -学习资源清单
- [Phusion Passenger: Meteor tutorial](https://github.com/phusion/passenger/wiki/Phusion-Passenger:-Meteor-tutorial)
- [When a Meteor finally hits production](https://medium.com/@davidyahalomi/when-a-meteor-finally-hits-production-6c37b81f795b) -有关部署Meteor应用程序的博客文章
...
- [Official Guide](http://guide.meteor.com/)
- [Atmosphere](https://atmospherejs.com/) -流星软件包，资源和工具的目录.
...
- [Qualia](https://www.qualia.com/) -房地产创业
