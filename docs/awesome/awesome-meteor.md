...
- [simple-schema](https://github.com/aldeed/simple-schema-js) -一个JavaScript模式验证包，支持直接验证MongoDB更新修饰符对象.
...
- [meteor-hero](https://github.com/jkrup/meteor-hero) -利用Heroku的服务通过一个命令免费部署MeteorJS应用程序.
...
- [percolatestudio/cordova-plugin-safe-reload](https://github.com/percolatestudio/cordova-plugin-safe-reload) -Cordova插件可以在流星热代码推送失败后观看并恢复.
...
- [ostrio:cron-jobs](https://github.com/VeliovGroup/Meteor-CRON-jobs) -带有与本地`setTimeout`和`setInterval`方法类似的API的程序包，但是在所有正在运行的Meteor（NodeJS）实例之间同步.
...
- [msavin:jetsetter](https://github.com/msavin/JetSetter) -流星会话变量的可视获取/设置工具.
...
- [Svelte](https://github.com/meteor-svelte/meteor-svelte) -使用Meteor和Svelte构建网络上经过增强的网络应用程序.
...
- #### Free
  ...
  _这些免费课程大部分是由 [Scott Tolinski](https://github.com/stolinski)，请确保检查出他的一些付费物品 [leveluptutorials](https://www.leveluptutorials.com/)_
