...
- [Applied Crypto Hardening](https://bettercrypto.org/static/applied-crypto-hardening.pdf) -由 [The bettercrypto.org Team](https://bettercrypto.org/).
...
- [GraphQL NoSQL Injection Through JSON Types](https://medium.com/@east5th/graphql-nosql-injection-through-json-types-a1a0a310c759) -由 [@east5th](https://medium.com/@east5th).
...
- [AWS takeover through SSRF in JavaScript](http://10degres.net/aws-takeover-ssrf-javascript/) -由 [Gwen](http://10degres.net/).
...
- [All you need to know about SSRF and how may we write tools to do auto-detect](https://www.auxy.xyz/research/all-ssrf-knowledge/) -由 [@realAuxy233](https://twitter.com/realAuxy233).
...
- [How I hacked Google’s bug tracking system itself for $15,600 in bounties](https://medium.freecodecamp.org/messing-with-the-google-buganizer-system-for-15-600-in-bounties-58f86cc9f9a5) -由 [@alex.birsan](https://medium.freecodecamp.org/@alex.birsan).
...
- [Three roads lead to Rome](http://blogs.360.cn/360safe/2016/11/29/three-roads-lead-to-rome-2/) -由 [Luke Viruswalker](http://blogs.360.cn/360safe/author/xsecure/).
...
- [Exploit Database](https://www.exploit-db.com/) -漏洞，Shellcode和安全文件的最终存档，作者： [Offensive Security](https://www.offensive-security.com/community-projects/the-exploit-database/).
...
- [databases.today](https://www.databases.today/index.php) -由安全研究人员和新闻工作者撰写的最大的免费下载的公共网站数据库集合 [@publicdbhost](https://twitter.com/publicdbhost).
...
- [XSS Thousand Knocks](https://knock.xss.moe/index) -XSS千门-撰写者 [@yagihashoo](https://twitter.com/yagihashoo).
...
- [Browser Extension and Login-Leak Experiment](https://extensions.inrialpes.fr/) -浏览器扩展程序和登录泄漏实验.
...
- [The bug bounty program that changed my life](http://10degres.net/the-bugbounty-program-that-changed-my-life/) -由 [Gwen](http://10degres.net/).
