...
- [DNS Rebind Toolkit](https://github.com/brannondorsey/dns-rebind-toolkit) -DNS Rebind Toolkit是一个前端JavaScript框架，用于通过以下方式开发针对局域网（LAN）上易受攻击的主机和服务的DNS Rebinding攻击： [@brannondorsey](https://github.com/brannondorsey)
...
- [ntlm_challenger](https://github.com/b17zr/ntlm_challenger) -通过以下方式通过HTTP质询消息解析NTLM [@b17zr](https://github.com/b17zr).
