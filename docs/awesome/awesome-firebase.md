...
互联网必须提供的**最新**的Firebase文档，讲座，工具，示例和文章.
...
[Firebase](https://firebase.google.com) 是建立在 [Google Cloud Platform](https://cloud.google.com/products) 提供服务和跨平台的SDK！
...
-  [Stripe Firebase Extensions](https://github.com/stripe/stripe-firebase-extensions/) -官方Stripe订阅和发票扩展.
...
-  [React Redux Firebase](https://github.com/prescottprue/react-redux-firebase)  -用于Firebase的Redux绑定. 包括与React一起使用的高阶组件.
-  [GatsbyJS Firebase Data Source](https://www.gatsbyjs.org/packages/) -使用Gatsby将Firebase数据直接查询到静态生成的页面中.
-  [Apollo Link Firebase](https://github.com/Canner/apollo-link-firebase)  -为RealtimeDB提供本地GraphQL接口. 数据库在本地同步到设备，Apollo Link提供对本地数据库的查询.
...
-  [FlutterFire](https://github.com/FirebaseExtended/flutterfire) -的Firebase插件集合 [Flutter](https://flutter.io/) 应用.
-  [React Native Firebase](https://github.com/invertase/react-native-firebase)  -经过良好测试的功能丰富的模块化Firebase实施，用于React Native. 同时支持iOS和Android平台.
...
-  [Flamingo](https://github.com/hukusuke1007/flamingo) -Dart的Firebase Firestore模型框架.
...
-  [MLKit - ARCore](https://github.com/FirebaseExtended/MLKit-ARCore)  -在增强现实中检测对象并用3D标签标记它们的示例. 使用Firebase ML Kit，ARCore和Firebase RTDB.
...
-  [Express Server on Cloud Functions](https://github.com/jthegedus/firebase-gcp-examples/tree/main/functions-express) -在Cloud Functions上托管Express服务器.
...
-  [Compiled Code with Cloud Functions](https://github.com/jthegedus/firebase-gcp-examples/tree/main/functions-w-parcel) -使用Babel，TypeScript编译器或ParcelJS将Flow，TypeScript或ReasonML编译为正确的Node运行时.
...
-  [Integrify](https://github.com/anishkny/integrify) -使用预定义的Cloud Functions触发器在Firestore中加强参考和数据完整性.
...
-  [Firestore Queue System](https://github.com/sbarbat/firestore-queuer) -使用Firestore和Cloud Functions的简单队列系统.
...
-  [Firecode](https://github.com/ChFlick/firecode) -VS Code Firestore规则扩展.
...
-  [Firestore Rules Generator](https://github.com/FirebaseExtended/protobuf-rules-gen) -基于Google的协议缓冲区格式的Cloud Firestore官方（但实验性）Firebase规则生成器.
...
-  [Svarog](https://github.com/dantothefuture/svarog) -使用JSON架构生成的安全规则帮助程序功能进行Cloud Firestore架构验证.
-  [Firetable](https://github.com/AntlerVC/firetable)  -Excel / Google表格，例如Firebase / Firestore的UI. 没有更多的管理门户！
-  [VSFire](https://github.com/toba/vsfire) -已弃用〜VSCode扩展，用于使用Firestore安全规则和索引来突出显示语法和完成代码.

## Other

-  [Flank](https://github.com/flank/flank/) -适用于Firebase测试实验室的大规模并行Android和iOS测试运行程序.
...
-  [Firebase AIR Native Extension](https://github.com/myflashlab/Firebase-ANE) -Firebase ANE集合使您可以使用100％相同的ActionScript API访问Android和iOS均支持的AdobeAir项目中的Google Firebase项目.
...
-  [Flamelink](https://flamelink.io/)  -Firebase的CMS. 支持Firestore，RealtimeDatabase和存储.
...
-  [Firebase Live 2020](https://www.youtube.com/playlist?list=PLl-K7zZEsYLnw0-bXz2f9zo6745VQ_2ep) -Firebase Live是面向应用程序开发人员的网络系列，其中包括讲座，技巧和技术教程，旨在提高他们的生产力，知识和协作能力.
...
- ：火： [Firebase Developers Discord](https://discord.gg/BN2cgc3) -一个致力于Firebase及其服务的开放社区，您可以在这里与世界各地的其他Web和应用程序开发人员进行社交和帮助.
