...
* [Lapce](https://github.com/lapce/lapce)  — 具有用 Rust 编写的后端的现代编辑器. 从停产的产品中汲取灵感 [xi-editory](https://github.com/xi-editor/xi-editor).
...
* 静态站点生成器
  ...
  * [grego/blades](https://github.com/grego/blades) [[blades](https://getblades.org/)] — 超快的简单静态站点生成器.
