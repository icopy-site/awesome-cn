...
* [broot](https://github.com/Canop/broot) 一种查看和导航目录树的新方法（获得一个目录的概览，即使是一个大目录；找到一个目录然后 `cd` 到它；搜索时永远不会忘记文件层次结构；操作您的文件，...） , 延伸阅读 [dystroy.org/broot](https://dystroy.org/broot/) [![Latest Version](https://img.shields.io/crates/v/broot.svg)](https://crates.io/crates/broot)
...
* [innernet](https://github.com/tonarino/innernet) - 在引擎盖下使用 Wireguard 的覆盖或私有网状网络
...
* [Rio](https://github.com/raphamorim/rio) - 由 WebGPU 提供支持的硬件加速 GPU 终端仿真器，专注于在桌面和浏览器中运行.
...
* [madara](https://github.com/keep-starknet-strange/madara) - Kaioshin 是一个 ⚡ 超快 ⚡ Starknet 音序器，基于 substrate 并用 Rust 编写. [![GitHub Workflow Status](https://github.com/keep-starknet-strange/madara/actions/workflows/test.yml/badge.svg)](https://github.com/keep-starknet-strange/madara/actions/workflows/test.yml)
...
* [Neon](https://github.com/neondatabase/neon) 无服务器 Postgres. 我们将存储和计算分开，以提供自动缩放、分支和无限存储.
* [noria](https://github.com/mit-pdos/noria) [[noria](https://crates.io/crates/noria)] — Web 应用程序后端的动态变化的、部分状态的数据流
...
* [cristicbz/rust-doom](https://github.com/cristicbz/rust-doom) — 毁灭战士的渲染器，可能会发展成为一款可玩的游戏
* [doukutsu-rs](https://github.com/doukutsu-rs/doukutsu-rs) — 具有一些增强功能的 Cave Story 引擎的 Rust 重新实现.
* [garkimasera/rusted-ruins](https://github.com/garkimasera/rusted-ruins) — 具有像素艺术的可扩展开放世界流氓类游戏
...
* [lifthrasiir/angolmois-rust](https://github.com/lifthrasiir/angolmois-rust) — 一款支持 BMS 格式的简约音乐视频游戏
...
* [Andy-Python-Programmer/aero](https://github.com/Andy-Python-Programmer/aero) — 遵循单片内核设计的现代类 unix 操作系统.
...
* [cargo-audit](https://crates.io/crates/cargo-audit) - 审计 Cargo.lock 是否存在安全漏洞
* [cargo-auditable](https://crates.io/crates/cargo-auditable) - 使生产 Rust 二进制文件可审计
* [cargo-crev](https://crates.io/crates/cargo-crev) - 用于货物 (Rust) 包管理器的加密可验证代码审查系统.
* [cargo-deny](https://crates.io/crates/cargo-deny) - Cargo 插件可帮助您管理大型依赖关系图
* [Cherrybomb](https://github.com/blst-security/cherrybomb) - 使用 CLI 工具停止完成一半的 API 规范，该工具通过验证 API 规范帮助您避免未定义的用户行为.
* [cotp](https://github.com/replydev/cotp) - 具有导入功能的值得信赖的加密命令行 TOTP/HOTP 身份验证器应用程序.
...
* [kpcyrd/rshijack](https://github.com/kpcyrd/rshijack) — 一个 TCP 连接劫持者，shijack 的 rust 重写
...
* [hEngine](https://github.com/hashintel/hash/tree/main/apps/engine) - 一个 Rust 实现的计算模拟引擎，支持基于代理的大规模建模，具有用 JavaScript 和 Python 编写的模拟逻辑.
...
* [cantino/mcfly](https://github.com/cantino/mcfly)  - 浏览你的 shell 历史. 伟大的斯科特！
...
* [diskonaut](https://github.com/imsnif/diskonaut) — 终端视觉磁盘空间导航器
...
* [lotabout/skim](https://github.com/lotabout/skim) — 纯铁锈色的模糊取景器
* [lsd](https://github.com/lsd-rs/lsd) — 一个 ls 有很多漂亮的颜色和很棒的图标 [![build](https://github.com/lsd-rs/lsd/workflows/CICD/badge.svg?branch=master)](https://github.com/lsd-rs/lsd/actions)
* [Luminarys/synapse](https://github.com/Luminarys/synapse) — 灵活快速的 BitTorrent 守护进程.
* [m4b/bingrep](https://github.com/m4b/bingrep) — Greps 各种操作系统和架构的二进制文件，并为它们着色.
...
* [Lapce](https://github.com/lapce/lapce)  — 具有用 Rust 编写的后端的现代编辑器. 从停产的产品中汲取灵感 [xi-editor](https://github.com/xi-editor/xi-editor).
...
* [jqnatividad/qsv](https://github.com/jqnatividad/qsv) [[qsv](https://crates.io/crates/qsv) ] — 高性能 CSV 数据整理工具包. 从 xsv 分叉出来，有 34 多个额外的命令等等. [![Linux build status](https://github.com/jqnatividad/qsv/actions/workflows/rust.yml/badge.svg)](https://github.com/jqnatividad/qsv/actions/workflows/rust.yml) [![Windows build status](https://github.com/jqnatividad/qsv/actions/workflows/rust-windows.yml/badge.svg)](https://github.com/jqnatividad/qsv/actions/workflows/rust-windows.yml) [![macOS build status](https://github.com/jqnatividad/qsv/actions/workflows/rust-macos.yml/badge.svg)](https://github.com/jqnatividad/qsv/actions/workflows/rust-macos.yml)
...
* [guoxbin/dtool](https://github.com/guoxbin/dtool) — 一个有用的命令行工具集合，用于辅助开发，包括转换、编解码、散列、加密等.
* [mprocs](https://github.com/pvolok/mprocs) — 用于运行多个进程的 TUI
* [nix-community/nix-init](https://github.com/nix-community/nix-init) — 通过哈希预取、依赖关系推断、许可证检测等从 URL 生成 Nix 包 [![build-badge](https://github.com/nix-community/nix-init/actions/workflows/ci.yml/badge.svg)](https://github.com/nix-community/nix-init/actions/workflows/ci.yml)
* [nix-community/nix-melt](https://github.com/nix-community/nix-melt) — 类似游侠的 flake.lock 查看器 [![build-badge](https://github.com/nix-community/nix-melt/actions/workflows/ci.yml/badge.svg)](https://github.com/nix-community/nix-melt/actions/workflows/ci.yml)
...
* [warpdotdev/Warp](https://github.com/warpdotdev/Warp) :heavy_dollar_sign: — Warp 是一个速度极快的基于 Rust 的现代 GPU 加速终端，旨在提高您和您的团队的工作效率.
...
* [harlanc/xiu](https://github.com/harlanc/xiu) — 由纯 rust (rtmp/httpflv/hls/relay) 开发的强大而安全的实时服务器. [![crates.io](https://img.shields.io/crates/v/xiu.svg)](https://crates.io/crates/xiu)
* [vidmerger](https://github.com/TGotwig/vidmerger) — 通过 CLI 合并视频和音频文件
* [xiph/rav1e](https://github.com/xiph/rav1e) — 最快最安全的 AV1 编码器.
...
* [emanuele-em/man-in-the-middle-proxy](https://github.com/emanuele-em/man-in-the-middle-proxy)  — MITM 代理！  HTTP/1、HTTP/2 和具有 SSL/TLS 功能的 WebSockets 的工具包 [![Rust](https://github.com/emanuele-em/man-in-the-middle-proxy/actions/workflows/rust.yml/badge.svg)](https://github.com/emanuele-em/man-in-the-middle-proxy/actions/workflows/rust.yml)
...
* [clippy](https://crates.io/crates/clippy) — 锈棉绒
...
* [ptags](https://github.com/dalance/ptags) — 用于 git 存储库的并行 universal-ctags 包装器
* [Racer](https://github.com/racer-rust/racer) — Rust 的代码补全
...
* [Cargo](https://crates.io/) — Rust 包管理器
  ...
  * [cargo-ebuild](https://crates.io/crates/cargo-ebuild) — 可以使用树内 eclasses 生成 ebuilds 的货物扩展
  * [cargo-edit](https://crates.io/crates/cargo-edit) — 允许您通过从命令行读取/写入您的 Cargo.toml 文件来添加和列出依赖项
  * [cargo-generate](https://github.com/cargo-generate/cargo-generate) 通过利用预先存在的 git 存储库作为模板的 rust 项目生成器.
  * [cargo-graph](https://crates.io/crates/cargo-graph)  — 更新了带有附加功能的 `cargo-dot` 的分支. 未维护，请参阅 `cargo-deps`
  * [cargo-info](https://crates.io/crates/cargo-info) — 从命令行查询 crates.io 以获取板条箱的详细信息
  * [cargo-license](https://crates.io/crates/cargo-license) — 用于快速查看所有依赖项许可证的 cargo 子命令.
  * [cargo-limit](https://crates.io/crates/cargo-limit) — 噪音较小的货物：跳过警告，直到错误得到修复，Neovim 集成等. [![build badge](https://github.com/alopatindev/cargo-limit/actions/workflows/rust.yml/badge.svg)](https://github.com/alopatindev/cargo-limit/actions)
...
* 交叉编译
  ...
  * [japaric/xargo](https://github.com/japaric/xargo) — 轻松交叉编译 Rust 程序到自定义裸机目标，如 ARM Cortex-M
* 乐鑫
...
* C++
  ...
  * [rust-cpp](https://crates.io/crates/cpp) - 直接在 Rust 中嵌入 C++ 代码. [![Build status](https://ci.appveyor.com/api/projects/status/uu76vmcrwnjqra0u/branch/master?svg=true)](https://ci.appveyor.com/project/mystor/rust-cpp/branch/master)
...
* 网络组装
  ...
  * [rustwasm/wasm-bindgen](https://github.com/rustwasm/wasm-bindgen) — 促进 wasm 模块和 JS 之间高级交互的项目.
...
* [Bencher](https://github.com/bencherdev/bencher) - 一套连续的基准测试工具，旨在捕捉 CI 中的性能回归
...
* 代码覆盖
  * [tarpaulin](https://crates.io/crates/cargo-tarpaulin) — 为 Rust 设计的代码覆盖工具
* 持续集成
...
* 属性测试和模糊测试
  ...
  * [quickcheck](https://crates.io/crates/quickcheck) — 的 Rust 实现 [QuickCheck](https://wiki.haskell.org/Introduction_to_QuickCheck1)
...
* [zurawiki/tiktoken-rs](https://github.com/zurawiki/tiktoken-rs) [[tiktoken-rs](https://crates.io/crates/tiktoken-rs)] — Rust 库，用于使用 tiktoken 使用 OpenAI 模型对文本进行标记化. [![CI](https://github.com/zurawiki/tiktoken-rs/actions/workflows/ci.yml/badge.svg)](https://github.com/zurawiki/tiktoken-rs/actions/workflows/ci.yml)

### Astronomy

[[astronomy](https://crates.io/keywords/astronomy)]

* [cds-astro/aladin-lite](https://github.com/cds-astro/aladin-lite) - 用于可视化不同投影中的空间和行星图像调查的 Web 应用程序
* [fitsio](https://crates.io/crates/fitsio) — 适用于包装 cfitsio 的界面库
...
* [dpc/mioco](https://github.com/dpc/mioco) — 可扩展的、基于协同程序的异步 IO 处理库
* [mio](https://github.com/tokio-rs/mio) — MIO 是 Rust 的轻量级 IO 库，专注于在 OS 抽象上添加尽可能少的开销
* [rust-lang/futures-rs](https://github.com/rust-lang/futures-rs) — Rust 中的零成本期货
* [TeaEntityLab/fpRust](https://github.com/TeaEntityLab/fpRust) — Monad/MonadIO、Handler、Coroutine/doNotation、Rust 的函数式编程特性
* [Xudong-Huang/may](https://github.com/Xudong-Huang/may) — rust stackful 协程库
* [zonyitoo/coio-rs](https://github.com/zonyitoo/coio-rs) — 带有工作窃取调度程序的协程 I/O 库
...
* [RustAudio](https://github.com/RustAudio)
  ...
  * [RustAudio/rodio](https://github.com/RustAudio/rodio) — 一个 Rust 音频播放库
...
* [marcelbuesing/tokio-socketcan-bcm](https://github.com/marcelbuesing/tokio-socketcan-bcm) [[tokio-socketcan-bcm](https://crates.io/crates/tokio-socketcan-bcm)] — Linux SocketCAN BCM 支持 tokio
...
* 参数解析
  ...
  * [docopt/docopt.rs](https://github.com/docopt/docopt.rs) [[docopt](https://crates.io/crates/docopt)] — 的 Rust 实现 [DocOpt](http://docopt.org)
  ...
  * [killercup/quicli](https://github.com/killercup/quicli) [[quicli](https://crates.io/crates/quicli)] — 在 Rust 中快速构建酷炫的 CLI 应用程序
  ...
  * [TeXitoi/structopt](https://github.com/TeXitoi/structopt) [[structopt](https://crates.io/crates/structopt)] — 通过定义结构解析命令行参数
* 数据可视化
...
* 流水线
  ...
  * [oconnor663/duct.rs](https://github.com/oconnor663/duct.rs) [[duct](https://crates.io/crates/duct)] — 子流程管道和 IO 重定向的构建器
...
* 风格
  ...
  * [ogham/rust-ansi-term](https://github.com/ogham/rust-ansi-term) [[ansi_term](https://crates.io/crates/ansi_term)] — 在 ANSI 终端上控制颜色和格式
...
* TUI
  ...
  * [fdehau/tui-rs](https://github.com/fdehau/tui-rs) [[tui](https://crates.io/crates/tui)] — 受启发的 TUI 库 [blessed-contrib](https://github.com/yaronn/blessed-contrib) 和 [termui](https://github.com/gizak/termui)
  * [gyscos/Cursive](https://github.com/gyscos/Cursive) [[cursive](https://crates.io/crates/cursive)] — 构建丰富的 TUI 应用程序
  * [ivanceras/titik](https://github.com/ivanceras/titik) - 以提供交互式小部件为目标的跨平台 TUI 小部件库
  * ncurses
...
*需要
  * [alexcrichton/tar-rs](https://github.com/alexcrichton/tar-rs) — tar 存档在 Rust 中读/写
* 压缩
  * [zip-rs/zip](https://github.com/zip-rs/zip) — 读写 ZIP 档案

### Computation

* [argmin-rs/argmin](https://github.com/argmin-rs/argmin) [[argmin](https://crates.io/crates/argmin)] — 纯 Rust 优化库
...
* [mehcode/config-rs](https://github.com/mehcode/config-rs) [[config](https://crates.io/crates/config)] — Rust 应用程序的分层配置系统（对 12 因子应用程序有强大的支持）.
...
* [DaGenix/rust-crypto](https://github.com/DaGenix/rust-crypto) — Rust 中的密码算法
...
* [racum/rust-djangohashers](https://github.com/racum/rust-djangohashers) [[djangohashers](https://crates.io/crates/djangohashers) ] — Django 项目中使用的密码基元的 Rust 端口. 它不需要 Django，只根据其风格散列和验证密码.
...
* [danielpclark/array_tool](https://github.com/danielpclark/array_tool)  — Rust 的数组助手. 您将在数组上使用的一些最常用方法在向量上可用. 用于处理大多数用例的多态实现.
* [fizyk20/generic-array](https://github.com/fizyk20/generic-array) – 允许数组大小由 typenums 决定的 hack
...
* [xfix/enum-map](https://github.com/xfix/enum-map) [[enum-map](https://crates.io/crates/enum-map)] — 使用数组存储值的枚举优化映射实现.
...
* [rerun](https://github.com/rerun-io/rerun) — [[rerun](https://crates.io/crates/rerun)] — 用于记录计算机视觉和机器人数据（张量、点云等）的 SDK 与用于随时间探索该数据的可视化工具配对.
...
* 非数据库 [[nosql](https://crates.io/keywords/nosql)]
  ...
  * [Cassandra](https://cassandra.apache.org/_/index.html) [[cassandra](https://crates.io/keywords/cassandra), [cql](https://crates.io/keywords/cql)]
    * [AlexPikalov/cdrs](https://github.com/AlexPikalov/cdrs) [[cdrs](https://crates.io/crates/cdrs)] — 用 Rust 编写的本地客户端
  ...
  * 弹性搜索 [[elasticsearch](https://crates.io/keywords/elasticsearch)]
    * [benashford/rs-es](https://github.com/benashford/rs-es) [[rs-es](https://crates.io/crates/rs-es)] — 的 Rust 客户端 [Elastic](https://www.elastic.co/) 休息API
  ...
  * [PickleDB](https://pythonhosted.org/pickleDB/)
    * [seladb/pickledb-rs](https://github.com/seladb/pickledb-rs) — 一个轻量级和简单的键值存储，深受 Python 的 PickleDB 的启发.
...
* SQL [[sql](https://crates.io/keywords/sql)]
  ...
  * 数据库 [[mysql](https://crates.io/keywords/mysql)]
    ...
    * [blackbeam/rust-mysql-simple](https://github.com/blackbeam/rust-mysql-simple) [[mysql](https://crates.io/crates/mysql)] — 本机 MySql 客户端
  * 甲骨文
...
* 阿帕奇卡夫卡
  ...
  * [gklijs/schema_registry_converter](https://github.com/gklijs/schema_registry_converter) [[schema_registry_converter](https://crates.io/crates/schema_registry_converter)] — 整合 [confluent schema registry](https://www.confluent.io/product/confluent-platform/data-compatibility/)
...
* ASN.1
  * [alex/rust-asn1](https://github.com/alex/rust-asn1) — 一个 Rust ASN.1 (DER) 序列化器
* 二进制
...
* 中央银行同业拆息
  * [serde_cbor](https://crates.io/crates/serde_cbor) - CBOR 支持 serde
* 字符编码
...
* 电子数据网
  * [naomijub/edn-rs](https://github.com/naomijub/edn-rs) [[edn-rs](https://crates.io/crates/edn-rs)] — 用于解析 EDN 格式并将其发送到 Rust 类型的箱子.
...
* 网络CDF
  * [georust/netcdf](https://github.com/georust/netcdf) [[netcdf](https://crates.io/crates/netcdf)] — Rust 的中级 netCDF 绑定，允许轻松读取和写入类似数组的结构到文件.
* 质子交换膜
...
* rkyv
  * [rkyv/rkyv](https://github.com/rkyv/rkyv) [[rkyv](https://crates.io/crates/rkyv)] — rkyv (archive) 是 Rust 的零拷贝反序列化框架
* RON（生锈的对象表示法）
...
* XML
  ...
  * [media-io/yaserde](https://github.com/media-io/yaserde) — 另一个专门用于 XML 的序列化器/反序列化器
  ...
  * [tafia/quick-xml](https://github.com/tafia/quick-xml) — 高性能 XML 拉式读取器/写入器
* YAML
  * [chyh1990/yaml-rust](https://github.com/chyh1990/yaml-rust) — 缺少的 Rust YAML 1.2 实现.
  ...
  * [vitiral/stfu8](https://github.com/vitiral/stfu8) [[stfu8](https://crates.io/crates/stfu8)] — UTF-8 中的排序文本格式

### Filesystem

[[filesystem](https://crates.io/keywords/filesystem)]
* 操作
  * [ParthJadhav/Rust_Search](https://github.com/ParthJadhav/Rust_Search) [[rust_search](https://crates.io/crates/rust_search)] - 用 Rust 构建的速度极快的文件搜索库.
  ...
  * [vitiral/path_abs](https://github.com/vitiral/path_abs) [[path_abs](https://crates.io/crates/path_abs)] — 绝对可序列化路径类型和相关方法.
...
* 临时文件
  ...
  * [Stebalien/xattr](https://github.com/Stebalien/xattr) [[xattr](https://crates.io/crates/xattr)] — 列出并操作 unix 扩展文件属性
...
* [DaveKram/coord_transforms](https://github.com/DaveKram/coord_transforms) [[coord_transforms](https://crates.io/crates/coord_transforms)] — 坐标转换（2-d、3-d 和地理空间）
...
* 字体
  * [RazrFalcon/rustybuzz](https://github.com/RazrFalcon/rustybuzz) - 到 Rust 的增量 harfbuzz 端口
  * [redox-os/rusttype](https://github.com/redox-os/rusttype) — 像 FreeType 这样的库的纯 Rust 替代品
* [gfx-rs/gfx](https://github.com/gfx-rs/gfx) — 用于 Rust 的高性能、无绑定图形 API.
...
* OpenGL [[opengl](https://crates.io/keywords/opengl)]
  ...
  * [Kiss3d](http://kiss3d.org) — 绘制简单的几何图形，并用一行字来玩弄它们
...
* [PistonDevelopers/conrod](https://github.com/PistonDevelopers/conrod/) — 一个易于使用的即时模式 2D GUI 库，完全用 Rust 编写
* [Qt](https://doc.qt.io)
...
* [abonander/img_hash](https://github.com/abonander/img_hash) — 感知图像哈希和相等性和相似性比较.
* [image-rs/image](https://github.com/image-rs/image) — 基本图像处理功能和图像格式转换的方法
...
* [rbatis/fast_log](https://github.com/rbatis/fast_log) — Rust async log 高性能异步日志
...
* [slog-rs/slog](https://github.com/slog-rs/slog) — Rust 的结构化、可组合的日志记录
...
* iOS
  * [TimNN/cargo-lipo](https://github.com/TimNN/cargo-lipo) — 一个 cargo lipo 子命令，它自动创建一个通用库以供您的 iOS 应用程序使用.
...
* gRPC
  * [hyperium/tonic](https://github.com/hyperium/tonic) — 具有异步/等待支持的原生 gRPC 客户端和服务器实现 [![Crates.io](https://img.shields.io/crates/v/tonic)](https://crates.io/crates/tonic)
  * [tikv/grpc-rs](https://github.com/tikv/grpc-rs) — 基于 C Core 库和 futures 构建的 Rust gRPC 库
* HTTP
...
* IP网络
  * [achanda/ipnetwork](https://github.com/achanda/ipnetwork) — 在纯 Rust 中处理 IP 网络的库
...
* 低水平
  ...
  * [libpnet/libpnet](https://github.com/libpnet/libpnet) — 一个跨平台的低级网络
  * [smoltcp-rs/smoltcp](https://github.com/smoltcp-rs/smoltcp) — 一个独立的、事件驱动的 TCP/IP 堆栈，专为裸机、实时系统而设计
...
### Parsing
  ...
  * [freestrings/jsonpath](https://github.com/freestrings/jsonpath) — [JsonPath](https://goessner.net/articles/JsonPath/) 用 Rust 编写的引擎.  Webassembly 和 Javascript 也支持
  ...
  * [m4rw3r/chomp](https://github.com/m4rw3r/chomp) – 一个快速的 monadic 风格的解析器组合器
...
* 串行端口
  * [serialport/serialport-rs](https://github.com/serialport/serialport-rs) [[serialport](https://crates.io/crates/serialport)] — 一个提供串行端口访问的跨平台库
...
* 窗户
  * [microsoft/windows-rs](https://github.com/microsoft/windows-rs) — 适用于 Windows 的 Rust [![Actions Status](https://github.com/microsoft/windows-rs/workflows/CI/badge.svg)](https://github.com/microsoft/windows-rs/actions)
...
* [fleabitdev/gamelisp](https://github.com/fleabitdev/glsp) — 用于 Rust 游戏开发的类 Lisp 脚本语言
* [gluon-lang/gluon](https://github.com/gluon-lang/gluon) — 一种小型的、静态类型的函数式编程语言
* [KusionStack/kcl](https://github.com/KusionStack/kcl) - 一种基于约束的记录和功能语言，主要用于配置和策略场景.
...
* [mun](https://github.com/mun-lang/mun) — 一种已编译的静态类型脚本语言，具有一流的热重载支持
...
* [GuillaumeGomez/sysinfo](https://github.com/GuillaumeGomez/sysinfo) [[sysinfo](https://crates.io/crates/sysinfo)] — 用于获取系统信息的跨平台库 [![build badge](https://github.com/GuillaumeGomez/sysinfo/actions/workflows/CI.yml/badge.svg?branch=master)](https://github.com/GuillaumeGomez/sysinfo/actions/workflows/CI.yml)
...
*车把
  ...
  * [sunng87/handlebars-rust](https://github.com/sunng87/handlebars-rust) — Handlebars 模板引擎，具有继承、自定义助手支持.
* HTML
...
* [yaa110/rake-rs](https://github.com/yaa110/rake-rs) [[rake](https://crates.io/crates/rake)] — Rust 算法的多语言实现
...
* [ffmpeg-sidecar](https://github.com/nathanbabcock/ffmpeg-sidecar) — 在直观的 Iterator 界面中包装一个独立的 FFmpeg 二进制文件. [![Build Status](https://github.com/nathanbabcock/ffmpeg-sidecar/actions/workflows/rust.yml/badge.svg)](https://github.com/nathanbabcock/ffmpeg-sidecar/actions/workflows/rust.yml)
...
* [unicorn-rs/unicorn-rs](https://github.com/unicorn-rs/unicorn-rs) — 独角兽 CPU 模拟器的 Rust 绑定
...
* 客户端/WASM
  * [cargo-web](https://crates.io/crates/cargo-web) — 客户端 Web 的 Cargo 子命令
  * [leptos](https://github.com/leptos-rs/leptos) — Leptos 是一个全栈、同构的 Rust Web 框架，利用细粒度的反应性来构建声明式用户界面.[![crate](https://img.shields.io/crates/v/create-rust-app.svg)](https://crates.io/crates/leptos)
  * [sauron](https://github.com/ivanceras/sauron) - 紧密遵循 The Elm Architecture 的客户端 Web 框架.
...
* HTTP 服务器
  * [actix/actix-web](https://github.com/actix/actix-web) — 支持 websocket 的 Rust 轻量级异步 Web 框架
  ...
  * [carllerche/tower-web](https://github.com/carllerche/tower-web) [[tower-web](https://crates.io/crates/tower-web)] — 一个快速、无样板的 Rust 网络框架
  ...
  * [Gotham](https://github.com/gotham-rs/gotham) — 不牺牲安全性、安全性或速度的灵活 Web 框架.
  ...
  * [miketang84/sapper](https://github.com/miketang84/sapper) — 一个基于异步 hyper 构建的轻量级 Web 框架，用 Rust 语言实现.
  ...
  * [Rocket](https://github.com/SergioBenitez/Rocket) — Rocket 是 Rust 的 Web 框架（每晚），专注于易用性、可表达性和速度
  * [Rustless](https://github.com/rustless/rustless) — 一个类似 REST 的 API 微框架，灵感来自 [Grape](https://github.com/ruby-grape/grape) 和 [Hyper](https://github.com/hyperium/hyper)
...
* 各种各样
  ...
  * [utkarshkukreti/select.rs](https://github.com/utkarshkukreti/select.rs) [[select](https://crates.io/crates/select)] — 一个从 HTML 文档中提取有用数据的库，适用于网络抓取.
* 反向代理
...
* [WebSocket](https://datatracker.ietf.org/doc/rfc6455/)
  * [housleyjk/ws-rs](https://github.com/housleyjk/ws-rs) — 用于 Rust 的轻量级、事件驱动的 WebSockets
  * [rust-websocket](https://github.com/websockets-rs/rust-websocket) — 处理 WebSocket 连接的框架（客户端和服务器）
...
* [Cloudsmith :heavy_dollar_sign:](https://cloudsmith.com/product/formats/cargo-registry)  — 完全托管的包管理 SaaS，为公共和私人 Cargo/Rust 注册中心（以及许多其他注册中心）提供一流的支持. 有一个慷慨的免费层，也完全免费开源.
