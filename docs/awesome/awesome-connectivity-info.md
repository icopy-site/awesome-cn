...
- [Facebook/EIU Inclusive Internet Index](https://theinclusiveinternet.eiu.com/) -（2020）根据可用性，可承受性，相关性和就绪性衡量互联网连接性的指数.
...
- [BCG e-Intensity Index](https://www.bcg.com/publications/interactives/bcg-e-intensity-index.aspx) -（2015）波士顿咨询集团开发的指数，它基于以下三个向量来考察85个互联网经济体的成熟度：赋能，参与度和支出.
...
- [Telegeography 2018 Submarine Cable Map](http://submarine-cable-map-2018.telegeography.com/) -（2018）海底光缆在线也可购买.
...
- [GSMA Mobile Network Coverage Maps](https://www.mobilecoveragemaps.com) -（2019）提供最准确的移动覆盖图，目前覆盖加纳，尼日利亚，卢旺达，乌干达，坦桑尼亚和赞比亚.
...
- [RIA Africa Mobile Pricing (RAMP) Indices Portal](https://researchictafrica.net/ramp_indices_portal/) -（2018年第三季度）有关语音/ SMS购物篮，1GB数据购物篮和超值套装的定价信息.
...
- [Open Signal - State of Mobile Networks Reports](http://opensignal.com/reports/) -报告涵盖了基于OpenSignal数据收集的各个国家.
...
- [Global Stats by StatCounter](http://gs.statcounter.com/) -按时间，浏览器，地区和操作系统分类的浏览器市场份额.
