...
- [Whales](https://github.com/Gueils/whales) -一种工具，可通过 [@icalialabs](https://github.com/IcaliaLabs).
...
- [batect](https://github.com/batect/batect) -将构建和测试环境作为代码工具：Dockerized的构建和测试环境使 [@charleskorn](https://github.com/charleskorn)
