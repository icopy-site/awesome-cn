...
- [Invidious](https://liberapay.com/omarroth/) -YouTube的替代网络前端.
...
- [Lollipop Cloud](https://opencollective.com/lollipop-cloud-team) -面向所有人的便宜，易用，自托管的云.
...
- [Open Source BIM Collective](https://opencollective.com/opensourcebim) -用于建立信息模型的工具.
...
- [PHPUnit](https://github.com/sponsors/sebastianbergmann) -PHPUnit和相关项目.
...
- [V Programming Language](https://www.patreon.com/vlang), [#2](https://www.paypal.com/donate/?token=u2pjZRmcQ2ZHaiP2Ce_wYNgGYrjrOL0xc_1zq9iDrO0uElfo24bMYFuSh48Hrpgm_66GF0&country.x=US&locale.x=US) -受Oberon，Rust，Swift影响的类似于Go的静态类型的编译程序语言.
- [VideoLAN](http://www.videolan.org/contribute.html#paypal) -VLC视频播放器的制造商.
- [Vim-Go](https://www.patreon.com/bhcleek) -Go插件为VIM.
...
- [ApexCharts](https://www.patreon.com/junedchhipa), [#2](https://opencollective.com/apexchartsjs) -JavaScript图表库.
...
- [Hapi.js](https://opencollective.com/hapijs) -Node.js框架.
...
- [Johann-S](https://github.com/sponsors/Johann-S) -引导JavaScript开发人员以及各种插件和项目.
...
- [Raph Levien](https://github.com/sponsors/raphlinus) -德鲁伊和其他Rust项目.
...
- [Scarlett Moore](https://www.patreon.com/sgclark) -KDE贡献者.
...
- [skypjack](https://github.com/sponsors/skypjack) -C ++库，例如uvw和EnTT.
...
- [Kyle Simpson](https://www.patreon.com/getify)  -《您不知道JS》丛书的作者. 做文章，播客和OSS贡献.
...
- [ZeMarmot](https://www.patreon.com/zemarmot), [#2](https://www.tipeee.com/zemarmot), [#3](https://liberapay.com/ZeMarmot/)  -将在CC下发布2D动画电影项目.  GIMP来自JehanPagès，Aryeom Han的艺术和指导.
