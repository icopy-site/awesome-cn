...
&gt;精选的优秀程序员和与软件相关的Patreon帐户的清单.

 帮助个人程序员或开放源代码项目资助开发自己喜欢的软件并订阅其Patreon帐户.  回馈开源社区的切实方法.
...
- [PixelFed](https://www.patreon.com/dansup), [#2](https://opencollective.com/pixelfed), [#3](https://liberapay.com/pixelfed) -由ActivityPub协议支持的联合图像共享.
...
- [V Programming Language](https://www.patreon.com/vlang), [#2](https://www.paypal.com/donate/?token=u2pjZRmcQ2ZHaiP2Ce_wYNgGYrjrOL0xc_1zq9iDrO0uElfo24bMYFuSh48Hrpgm_66GF0&country.x=US&locale.x=US) -V是类似于Go的静态类型的编译程序语言，受Oberon，Rust和Swift的影响.
...
- [Dominik Honnef](https://www.patreon.com/dominikh) -致力于Go编程语言的工具.
