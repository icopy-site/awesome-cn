...
- [github-releases](https://github.com/Dracks/repo-download-asset) - Cli 工具，用于跟踪作为 GitHub 版本发布的应用程序（或工作流程中的资产）并下载它们.
- [HN-top](https://github.com/BafS/hn-top) - 一个简单的命令来列出来自黑客新闻的最新新闻.
...
- [symlinker](https://github.com/serkonda7/symlinker) - 一个管理符号链接的小型 Linux 工具.
- [vast](https://github.com/lydiandy/vast) - 一个简单的vlang工具，将v源文件生成为AST json文件.
- [vcli](https://github.com/changhz/vcli) - 根据以下内容生成文件夹结构的 CLI 工具 [guideline](https://blog.vlang.io/the-complete-beginners-guide-to-cli-apps-in-v/)
- [verve](https://github.com/MohammadMD1383/verve) - 简单快速的静态文件服务器.
- [vgoogle](https://github.com/changhz/vgoogle) - 在终端上进行谷歌搜索.
- [vindex](https://github.com/wenxuanjun/vindex) - 一个简单的文件列表服务器生成json字符串，与nginx的autoindex模块兼容.
...
- [2048](https://github.com/wenxuanjun/2048) - 融合了多种传统AI的2048游戏.
...
- [Kurarin](https://github.com/FireRedz/kurarin)  - 奥苏！ 用 V 制作的beatmap可视化工具. [Example video](https://p153.p0.n0.cdn.getcloudapp.com/items/6quvQjb5/ce3ea737-eb29-4b8c-a5f3-65a804a2f56f.mp4).
...
- [monkey_v](https://github.com/Delta456/monkey_v) - 实施 [Thorsten Ball's Monkey Language](https://interpreterbook.com/) 在V.
- [stas](https://github.com/l1mey112/stas/tree/0.1.0-v-compiler)  - 基于堆栈的编译编程语言. 引导编译器是用 V 编写的.
- [v](https://github.com/vlang/v)  - V本身. 用于开发可维护软件的简单、快速、安全的编译语言.
...
- [vesseract](https://github.com/barrack-obama/vesseract) - Tesseract-OCR（光学字符识别）的 V 包装.
...
- [V Earcut](https://github.com/Larpon/earcut) - 基于快速（实时）多边形三角测量库 [mapbox/Earcut](https://github.com/mapbox/earcut) 处理孔洞、扭曲多边形、简并性和自相交.
- [V_sokol_gp](https://github.com/mohamedLT/V_sokol_gp) - sokol_gp 库的 AV 包装器，可轻松快速地绘制 2D 图形.
...
- [vsl.vcl](https://github.com/vlang/vsl/tree/master/vcl#readme) - VCL 是使用 V 使用 OpenCL 编写程序的高级方式.这些是 V 的高度固执的 OpenCL 绑定.它试图通过一些糖抽象、V 的并发性和通道使 GPU 计算变得容易.
...
- [vlipboard](https://github.com/asvvvad/vlipboard) - 易于使用的剪贴板包装，支持 Wayland 和 Termux.

### Scientific computing

- [vplot](https://github.com/erdetn/vplot) - GNU Plot 的 V 包装器 (`gnuplot_i`).
- [vsl](https://github.com/vlang/vsl)  - VSL 是一个科学图书馆，具有多种不同的模块. 尽管大多数模块提供纯 V 定义，但 VSL 还提供将已知 C 库包装在其他后端中的模块，这些后端允许高性能计算作为替代方案. 还为 OpenBLAS、LAPACKE、MPI、OpenCL 等库提供固定的包装器.
...
- [vserialport](https://github.com/erdetn/vserialport) - V 型包装纸 [libserialport](https://sigrok.org/wiki/Libserialport).
...
- [slugify](https://github.com/Coachonko/slugify) - 将 Unicode 字符串转换为 URL 友好、人类可读的 ASCII 字符串.
- [strfmt](https://github.com/BenStigsen/strfmt) - 小型且快速的字符串格式化库，非常适合模板化.
- [text-processing](https://github.com/ArtemkaKun/text-processing) - V 文本处理库，包含操作文本数据的常用工具.
- [v-regex](https://github.com/spytheman/v-regex) - V 的简单正则表达式库.
- [vxml](https://github.com/walkingdevel/vxml) - 用于将 XML 解析为 DOM 的纯 V 库.
- [whisker](https://github.com/hungrybluedev/whisker) - 受小胡子启发的快速、强大的 V 模板引擎.
...
- [VWebui](https://github.com/webui-dev/v-webui) - V 库可以轻松创建 WebUI.
...
- [pico.v](https://github.com/S-YOU/pico.v) - V 中基于 picoev 和 picohttpparser 的 Web 服务器.
...
- [vxbloauth](https://github.com/WolvesFortress/vxbl-oauth) - 适用于 vweb 的简约 Xbox Live 验证器.
...
- [v-vim](https://github.com/ollykel/v-vim) - Vim 中支持 V 语法高亮显示.
...
- [IntelliJ V](https://github.com/intellij-v/intellij-v) - IntelliJ IDEA 和其他 JetBrains IDE 的插件.
...
- [MVU.v](https://github.com/ArtemkaKun/MVU.v) - 用 V 编程语言实现的 MVU 模式（Elm 架构）.
...
- [V for Node Devs](https://github.com/Thigidu/vlang-for-nodejs-developers) - 适用于 Node js 开发人员的 Vlang.
