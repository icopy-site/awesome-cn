...
标记也可以用于 [range](#ranges) .  您可能以前曾经看到过
...
3.正则表达式项目始终以“ /”开头，因此`：h / \ +`将带您进入帮助项目
 ...
 4.组合键.  它们通常以单个字母开头表示模式
   ...
   插入模式的CTRL-X命令，可用于自动完成不同
    东西.  请注意，某些键将始终被写入相同的位置，例如Control
...
在终端仿真器中使用真彩色意味着能够将24位用于RGB
 颜色.  这样就形成了16777216（2 ^ 24）种颜色，而非通常的256种颜色.
